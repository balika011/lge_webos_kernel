...
const EMMC_FLASH_DEV_T _arEMMC_DevInfo1[] =
{
  ...
  {"H26M31003FPR",             		0x4A205849, 0x4E594812, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x00000000, 0x00000006, 0x00000000,0x00000000},
  {"H26M31003GMR",             		0x4A483447, 0x31640402, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x00000000, 0x00000002, 0x0000030D,0x00000000},
  ...
  {"H26M52103FMR",             		0x4A484147, 0x32650502, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000002, 0x00040F0F, 0x00000100, 0x04150917,0x00000000},
  {"H26M41103HPR", 					0x4A483847, 0x31650502, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000002, 0x00000F0F, 0x00000000, 0x030a080f,0x00000000},
  ...
  {"KLM4G1FEPD-B001",         		0x00344650, 0x44335202, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x00000000, 0x00010E00, 0x010A000A,0x01010000},
  {"KLM8G1GEAC-B031xxx",     		0x004D3847, 0x3147430B, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000002, 0x00000F0F, 0x00000002, 0x0309090C,0x00000000},
  ...
  {"MTFC8GACAEAM-1M WT",      		0x4E52314A, 0x35354110, 0x00000000, 0x00000000, 0x00000006, 0x00000F0F, 0x00000102, 0x0000130F, 0x00000000, 0x030B090C,0x00000000},
  ...
  {"MTFC4GMVEA-1M WT(JW857)", 	0x4E4D4D43, 0x3034473A, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x0000000A, 0x00000006, 0x00000000,0x00000000},
  {"MTFC2GMVEA-0M WT(JW896)", 	0x4E4D4D43, 0x3032473A, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x0000000A, 0x00000006, 0x00000000,0x00000000},
  {"MTFC8GLCDM-1M WT(JW962)", 	0x4E503158, 0x58585814, 0x00000000, 0x00000000, 0x00000004, 0x00000000, 0x00000102, 0x0000000A, 0x00000102, 0x1800030D,0x00000000},
  {"THGBMAG6A2JBAIR",         		0x00303038, 0x47393251, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x0000130F, 0x00000002, 0x0309080C,0x00000000},
  ...
  {"THGBMBG5D1KBAIL",         		0x00303034, 0x47453000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000102, 0x0000130F, 0x00011500, 0x01150001,0x01000000},
  ...
  {"THGBMAG6A2JBAIR",       		0x00303038, 0x47393251, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x0000130F, 0x00000002, 0x0309080C,0x00000000},
  {"THGBMBG6D1KBAIL-XXX",   		0x00303038, 0x47453000, 0x00000000, 0x00000000, 0x00000006, 0x00000F0F, 0x00000102, 0x0000130F, 0x00000002, 0x0309090C,0x00000000},
};
#endif
...
const EMMC_FLASH_DEV_T _arEMMC_DevInfo1[] =
{
  ...
  {"THGBMBG5D1KBAIL",         0x00303034, 0x47453000, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x00000000, 0x00000002, 0x03090908},
  {"MTFC8GACAAAM-1M WT",      0x4E503158, 0x58585812, 0x00000000, 0x00000000, 0x00000006, 0x00000F0F, 0x00000002, 0x03000d0d, 0x00000100, 0x04080818},// JWA61
                                      ...
                                      unsigned long       timeout)
{
	...
	if(val == 1)
	{
		 ...
		 (cmd->opcode == MMC_ERASE_GROUP_START) || (cmd->opcode == MMC_ERASE_GROUP_END) || (cmd->opcode == MMC_SWITCH))
		{
			...
			if ((cmd->opcode == MMC_READ_SINGLE_BLOCK) || (cmd->opcode == MMC_READ_MULTIPLE_BLOCK))
				printk(KERN_ERR ":[EMMC Read]:  addr:0x%08x,size:0x%08x\n",cmd->arg * 512,size *512);
			if ((cmd->opcode == MMC_WRITE_BLOCK) || (cmd->opcode == MMC_WRITE_MULTIPLE_BLOCK))
				printk(KERN_ERR ":[EMMC Write]: addr:0x%08x,size:0x%08x\n",cmd->arg *512 ,size *512);
			if (cmd->opcode == MMC_ERASE_GROUP_START)
				printk(KERN_ERR ":[EMMC ERASE]:erase_start = %08x\n",erase_start * 512);
			if (cmd->opcode == MMC_ERASE_GROUP_END)
				printk(KERN_ERR ":[EMMC ERASE]:erase_end = %08x\n",erase_end * 512);
			if (cmd->opcode == MMC_SWITCH)
			{ 
				if ((size & 0xffffff00) == 0x3200100)
				printk(KERN_ERR ":[EMMC FLUSH]:0x%08x\n",size * 512); 
			}		
		}
	}
...
void msdc_smaple_delay(struct mmc_host* mmc,u32 flag)
{
    ...
    else if(mmc->ios.timing == MMC_TIMING_MMC_HS)
    {
   	  ...
   	  //  sdr_set_bits(MSDC_PAD_TUNE, 0x0<<MSDC_PAD_TUNE_CLK_XDLY_SHIFT); //clock delay 0xc 
        ...
        sdr_clr_bits(MSDC_PAD_TUNE, MSDC_PAD_TUNE_CMDRRDLY);//cmd resp rx delay
   	    sdr_set_bits(MSDC_PAD_TUNE, ((_arEMMC_DevInfo1[emmcidx].HS52Sample&0xff000000)>>24)<<MSDC_PAD_TUNE_CMDRRDLY_SHIFT); //clock delay 0xc 
   	    
   	    sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_R_SMPL);//cmd resp rx delay
   	    sdr_set_bits(MSDC_IOCON,((_arEMMC_DevInfo1[emmcidx].HS52Sample&0x00ff0000)>>16)<<MSDC_IOCON_R_SMPL_SHIFT); // 

   	    sdr_clr_bits(MSDC_PAD_TUNE, MSDC_PAD_TUNE_CMDRDLY);//cmd rx dly
   	    sdr_set_bits(MSDC_PAD_TUNE, ((_arEMMC_DevInfo1[emmcidx].HS52Sample&0x0000ff00)>>8)<<MSDC_PAD_TUNE_CMDRDLY_SHIFT); //clock delay 0xc 
    	...
    	sdr_clr_bits(MSDC_PAD_TUNE, MSDC_PAD_TUNE_DATWRDLY);
   	    sdr_set_bits(MSDC_PAD_TUNE, ((_arEMMC_DevInfo1[emmcidx].HS52Sample&0x000000ff))<<MSDC_PAD_TUNE_DATWRDLY_SHIFT); //

    	sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_W_D0SPL);
   	    sdr_set_bits(MSDC_IOCON, ((_arEMMC_DevInfo1[emmcidx].HS52Delay&0xff000000)>>24)<<MSDC_IOCON_W_D0SPL_SHIFT); //

    	sdr_clr_bits(MSDC_DAT_RDDLY0, MSDC_DAT_RDDLY0_D0);
   	    sdr_set_bits(MSDC_DAT_RDDLY0, ((_arEMMC_DevInfo1[emmcidx].HS52Delay&0x00ff0000)>>16)<<MSDC_DAT_RDDLY0_D0_SHIFT); //
        ...
        sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_D_SMPL);//read sample
   	    sdr_set_bits(MSDC_IOCON,((_arEMMC_DevInfo1[emmcidx].HS52Delay&0x00ff00)>>8)<<MSDC_IOCON_D_SMPL_SHIFT); // 
   	    
        sdr_clr_bits(MSDC_PAD_TUNE, MSDC_PAD_TUNE_DATRRDLY);//read rx delay
   	    sdr_set_bits(MSDC_PAD_TUNE, ((_arEMMC_DevInfo1[emmcidx].HS52Delay&0x000000ff))<<MSDC_PAD_TUNE_DATRRDLY_SHIFT); //clock delay 0xc  
    }
    ...
    {       
		...
		/**********************LATCH & CKGEN ****************/
		sdr_clr_bits(MSDC_PATCH_BIT0, INT_DAT_LATCH_CK_SEL);
    	sdr_set_bits(MSDC_PATCH_BIT0, ((_arEMMC_DevInfo1[emmcidx].HS200Common&0xff000000)>>24)<< INT_DAT_LATCH_CK_SEL_SHIFT);
	
	    sdr_clr_bits(MSDC_PATCH_BIT0, CKGEN_MSDC_DLY_SEL);
        sdr_set_bits(MSDC_PATCH_BIT0, ((_arEMMC_DevInfo1[emmcidx].HS200Common&0x00ff0000)>>16)<< CKGEN_MSDC_DLY_SEL_SHIFT);
        ...
        sdr_clr_bits(MSDC_PAD_TUNE, MSDC_PAD_TUNE_CMDRRDLY);//cmd resp rx delay
   	    ...
   	    sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_R_SMPL);//cmd resp rx delay
   	    sdr_set_bits(MSDC_IOCON,((_arEMMC_DevInfo1[emmcidx].HS200Sample&0x00ff0000)>>16)<<MSDC_IOCON_R_SMPL_SHIFT); // 
		...
		sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_W_D_SMPL_SEL_SEL);//bit 9	    	    	
		...
		//sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_D_DLYLINE_SEL);
    	sdr_clr_bits(MSDC_DAT_RDDLY0, MSDC_DAT_RDDLY0_D0);
