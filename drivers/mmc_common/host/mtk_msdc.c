...
const EMMC_FLASH_DEV_T _arEMMC_DevInfo1[] =
{
  ...
  {"THGBMBG5D1KBAIL",         		0x00303034, 0x47453000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000102, 0x0000130F, 0x00011500, 0x01150001},
...
sdr_clr_bits(MSDC_PAD_TUNE, MSDC_PAD_TUNE_CLKTXDLY);
    	...
    	sdr_clr_bits(MSDC_IOCON, MSDC_IOCON_W_D0SPL);
   	    sdr_set_bits(MSDC_IOCON, ((_arEMMC_DevInfo1[emmcidx].HS200Delay&0xff000000)>>24)<<MSDC_IOCON_W_D0SPL_SHIFT); //
