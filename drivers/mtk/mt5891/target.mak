...
ifndef PRJ_ROOT
	...
	export PRJ_ROOT =$(DRV_SRC_ROOT)drivers/mtk/mt5891
endif
...
TARGET_INC += -I$(X_INC_DIR)
ifdef DRV_INC_DIR
TARGET_INC += -I$(DRV_INC_DIR)
endif
AUD_ROOT = $(DRV_ROOT)/$(DRIVER_DIR)/aud2
...
DMX_ROOT =  $(DRV_ROOT)/$(DRIVER_DIR)/dmx8290
DMX_INC = -I$(DMX_ROOT) -I$(DMX_ROOT)/include -I$(DMX_ROOT)/gcpu/iram -I$(DMX_ROOT)/cypher/aes -I$(DMX_ROOT)/drm/mtk_skb_driver/ -I$(DMX_ROOT)/drm/libtomcrypt-1.16/src/headers -I$(DMX_ROOT)/drm/libtommath-0.41
...
ifeq "$(findstring 5890_MT5112EE,$(BRDCST_IF))" "5890_MT5112EE"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
DEFINES += -DCC_FEDTD
endif
ifeq "$(findstring 5890_MT5135,$(BRDCST_IF))" "5890_MT5135"
...
ifeq "$(findstring 5890DUAL,$(BRDCST_IF))" "5890DUAL"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
...
ifeq "$(findstring 5890DVBTC,$(BRDCST_IF))" "5890DVBTC"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBC
DEFINES += -DCC_DVBT_SUPPORT
endif
...
#$(error DRV_ROOT is $(DRV_ROOT))
ifeq "$(findstring VDRISDBT,$(BRDCST_IF))" "VDRISDBT"
TUNER_INC += -I$(DRV_ROOT)/3rd_party/LINUX/VDRBRDCST/VDRDemod/TC90527
endif
...
NPTV_ROOT = $(DRV_ROOT)/$(DRIVER_DIR)/nptv8290
...
VDP_ROOT = $(DRV_ROOT)/$(DRIVER_DIR)/vdp8290

VDP_INC += -I$(VDP_ROOT)

export DRIVER_INC = $(TARGET_INC) $(AUD_INC) $(D_CUST_INC) $(LINUX_INC) $(TUNER_INC) $(VDEC_INC) $(PLAYMGR_INC) $(SWDMX_INC) $(NPTV_INC) $(VDP_INC) $(DMX_INC) $(TZ_INC)

DEFINES += -D_CPU_LITTLE_ENDIAN_ -DCC_MT5890 -DCC_MT5891
