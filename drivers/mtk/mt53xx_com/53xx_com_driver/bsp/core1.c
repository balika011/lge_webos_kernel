...
#define TCM_DRAM_SIZE               (*((volatile UINT32 *)(BIM_BASE + REG_RW_GPRB7)))
...
void mt53xx_initCore1Stub(void)
{
    #if defined(CC_MT5890)||defined(CC_MT5882)
    memcpy((void *)0xF2020000, mt53xx_Core1Stub, 0x100);
    #endif // defined(CC_MT5890)
}
