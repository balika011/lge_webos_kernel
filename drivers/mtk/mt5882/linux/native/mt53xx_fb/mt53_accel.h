...
EXTERN INT32 mt53fb_lock_ex_action(void* pvArg);
EXTERN INT32 mt53fb_flush_cache_action(void* pvArg);
...
EXTERN INT32 fb_gfx_cmps_blt(struct fb_info *info, const struct mt53fb_compress *prCompress);
#ifdef CC_B2R44K2K_SUPPORT
EXTERN INT32 mt53fb_b2r_stretchblit(mt53fb_b2r_stretch_blit * pr_b2r_stretch_blit);
#endif
