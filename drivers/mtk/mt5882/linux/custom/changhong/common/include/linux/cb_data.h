...
typedef enum
{
    ...
    CB_MTAL_FVR_TRIGGER,
    // add for changhong tv 20111208 >>>
    CB_CHTV_SRC_TRIGGER,
    CB_CHTV_3D_TRIGGER,
  // add for changhong tv 20111208 <<<
     //////////////XLF  add ////////////
    CB_CHTV_ATV_CHINASCAN,
	CB_CHTV_SCALER_TRIGGER,
	CB_CHTV_AQ_TRIGGER, //add by duyw
	CB_CHTV_DB_TRIGGER, //add by wql
	CB_CHTV_VDECEX_SIG_CHG, //add by jiangtao.
    CB_CHTV_PANEL_TRIGGER,
...
/* MHF Linux - end */
    ...
    CB_DRV_VDECOMX_NFY,
    #if 1//def MTK_D_INTERFACE_CALLBACK
    CB_MTAL_DRV_MISC_NFY_3D,
    CB_MTAL_DRV_MISC_NFY_CUST1,
    CB_MTAL_DRV_MISC_NFY_CUST2,
    #endif
