...
*/
#define uprv_strcpy(dst, src) U_STANDARD_CPP_NAMESPACE  x_strcpy(dst, src)
#define uprv_strncpy(dst, src, size) U_STANDARD_CPP_NAMESPACE x_strncpy(dst, src, size)
#define uprv_strlen(str) U_STANDARD_CPP_NAMESPACE x_strlen(str)
#define uprv_strcmp(s1, s2) U_STANDARD_CPP_NAMESPACE x_strcmp(s1, s2)
#define uprv_strncmp(s1, s2, n) U_STANDARD_CPP_NAMESPACE x_strncmp(s1, s2, n)
#define uprv_strcat(dst, src) U_STANDARD_CPP_NAMESPACE x_strcat(dst, src)
#define uprv_strncat(dst, src, n) U_STANDARD_CPP_NAMESPACE x_strncat(dst, src, n)
#define uprv_strchr(s, c) U_STANDARD_CPP_NAMESPACE x_strchr(s, c)
#define uprv_strstr(s, c) U_STANDARD_CPP_NAMESPACE x_strstr(s, c)
#define uprv_strrchr(s, c) U_STANDARD_CPP_NAMESPACE x_strrchr(s, c)
