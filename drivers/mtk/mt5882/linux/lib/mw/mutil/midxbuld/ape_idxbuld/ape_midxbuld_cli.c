...
#ifdef CLI_LVL_ALL
static VOID x_midxbuld_ape_nfy (
                                HANDLE_T                  h_midxbuld, 
                                MIDXBULD_NFY_EVENT_TYPE_T e_event,  
                                const VOID*               pv_data1, 
                                const VOID*               pv_data2, 
                                const VOID*               pv_tag);
static INT32 midxbuld_cli_ape_fopen(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_ape_mopen(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_ape_close(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_ape_start_idx(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_ape_stop_idx(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_ape_alloc_range(INT32 i4_argc, const CHAR** pps_argv);
static INT32 midxbuld_cli_ape_free_range(INT32 i4_argc, const CHAR** pps_argv);


/* midxbuld command table */
static CLI_EXEC_T at_ape_midxbuld_cmd_tbl[] =
{
    {
        "fopen",       NULL,  
        midxbuld_cli_ape_fopen,        
        NULL,    
        "midxbuld_fopen",       
        CLI_SUPERVISOR
    },
...
static INT32 midxbuld_cli_ape_fopen(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    t_format.t_media_subtype.u.e_aud_subtype = MEDIA_AUD_SUBTYPE_APE;
    ...
    {
        DBG_LOG_PRINT(("midxbuld_cli_ape_fopen: ERROR!\r\n"));
...
static INT32 midxbuld_cli_ape_mopen(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    if (i4_ret != FMR_OK)
    {
        DBG_ERROR(("midxbuld_cli_ape_mopen:open file ERROR!!!\r\n"));
        return i4_ret;
    }
    ...
    else
    {
        ...
        {
            DBG_LOG_PRINT(("midxbuld_cli_ape_mopen: file is too big !!!\r\n"));
            return CLIR_CMD_EXEC_ERROR;
        }
    ...
    if (i4_ret != MIDXBULDR_OK)
    {
        DBG_LOG_PRINT(("midxbuld_cli_ape_mopen: ERROR!!!\r\n"));
        return CLIR_CMD_EXEC_ERROR;
    }
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_ape_start_idx
 *
 * Description: 
 *
 * Inputs:  i4_argc         Contains the argument count.
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_ape_stop_idx
 *
 * Description: 
 *
 * Inputs:  i4_argc         Contains the argument count.
...
/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_ape_alloc_range
 *
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
static INT32 midxbuld_cli_ape_alloc_range(INT32 i4_argc, 
                                              const CHAR** pps_argv)
{
    DBG_LOG_PRINT(("midxbuld_cli_ape_alloc_range: OK!\r\n"));
    return CLIR_OK;
}

/*-----------------------------------------------------------------------------
 * Name: midxbuld_cli_ape_free_range
 *
 * Description: This API sets the info of idx builder.
 *
 * Inputs:  i4_argc         Contains the argument count.
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
static INT32 midxbuld_cli_ape_free_range(INT32 i4_argc, 
                                             const CHAR** pps_argv)
{
    DBG_LOG_PRINT(("midxbuld_cli_ape_free_range: OK!\r\n"));
    return CLIR_OK;
}
 ...
 * Returns: 
 ----------------------------------------------------------------------------*/
INT32 ape_midxbuld_cli_init(CLI_EXEC_T **ppt_command_array)
{
#ifdef CLI_LVL_ALL

    *ppt_command_array = at_ape_midxbuld_cmd_tbl;
