 ...
 */
/*----------------------------------------------------------------------------*/
#ifndef _C_SBTL_IPCC_H_
#define _C_SBTL_IPCC_H_
#ifndef __KERNEL__
 ...
 */
/* ----------------------------------------------------------------------------*/
extern VOID c_sbtl_ipcc_set_fct(SBTL_IPCC_SET_TYPE e_set_type, VOID* pv_set_info, SIZE_T z_set_info_len);

#endif
#endif/* _C_SBTL_IPCC_H_ */
/*----------------------------------------------------------------------------*/
