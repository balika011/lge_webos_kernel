...
#ifndef _SBTL_DYNC_DYNC_UTIL_H_
#define _SBTL_DYNC_DYNC_UTIL_H_
...
typedef struct
{
    MM_SBTL_DYN_BASE_IDX_T t_base;
    UINT8*                 pui1_sample_data;
    BOOL                   b_bad_sample;
    XML_T*                 pt_xml_tree;
    HANDLE_T               h_style;
    HANDLE_T               h_region;
    ...
    UINT32                 ui4_xml_len;
    XML_NODE_T*            pt_p_nodes;
    XML_NODE_T*            pt_div_nodes;
    UINT16                 ui2_imge_num;
    MM_SBTL_IMG_INFO_T*    pt_image_table;
    
    SBTL_TTML_ATTR_LIST_T  t_common_id_attr_list;//fake to use macro SLIST_T
}MM_SBTL_M4T_IDX_INFO_T;
