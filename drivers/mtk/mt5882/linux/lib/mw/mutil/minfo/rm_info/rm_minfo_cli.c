                                 ...
                                 const CHAR** pps_argv)
{
    ...
    DBG_LOG_PRINT(("minfo_cli_rm_close \r\n"));
    ...
    DBG_LOG_PRINT(("rm closed successfully!\r\n"));
    return CLIR_OK;
}
#endif
/*-----------------------------------------------------------------------------
                                  ...
                                  const CHAR** pps_argv)
{
    ...
    if (i4_ret != MINFOR_OK)
    {
        DBG_LOG_PRINT(("rm minfo getnum FAIL!! \r\n"));
    }
    else
    {
        switch (e_info_type)
        ...
        DBG_LOG_PRINT(("rm minfo getnum OK \r\n"));
    }
    return CLIR_OK;
}
#endif
                                   ...
                                   const CHAR** pps_argv)
{
    ...
    if (i4_ret != MINFOR_OK)
    {
        DBG_LOG_PRINT(("rm minfo getinfo FAIL!! \r\n"));
    }
    else
    {
        switch (e_info_type)
        ...
        case MINFO_INFO_TYPE_GENERIC:
            ...
            DBG_LOG_PRINT(("stream index =      0x%.16x\r\n", 
                      t_minfo_rec.ui1_rec_idx));
            DBG_LOG_PRINT(("duration =          0x%llx\r\n", 
                      t_minfo_rec.u.t_general_info.ui8_pb_duration));
            DBG_LOG_PRINT(("size =              0x%llx\r\n", 
        ...
        case MINFO_INFO_TYPE_IDX_INFO:
            ...
            DBG_LOG_PRINT(("index offset =      0x%llx\r\n", 
                       t_minfo_rec.u.t_idx_info.ui8_idx_offset));
            DBG_LOG_PRINT(("index size =        0x%llx\r\n", 
                       t_minfo_rec.u.t_idx_info.ui8_idx_sz));
            DBG_LOG_PRINT(("data offset =       0x%llx\r\n", 
                       t_minfo_rec.u.t_idx_info.ui8_data_offset));
            DBG_LOG_PRINT(("data size =         0x%llx\r\n", 
        ...
        case MINFO_INFO_TYPE_META_DATA:
            ...
            DBG_LOG_PRINT(("pb_duration =       0x%llx\r\n", 
        ...
        DBG_LOG_PRINT(("rm minfo get info OK \r\n"));
    }
    return CLIR_OK;
}
#endif
...
static INT32 minfo_cli_rm_fstress(INT32 i4_argc, const CHAR** pps_argv)
{
    ...
    while (i4_loop_count--)
    {
        ...
        if (i4_ret != MINFOR_OK)
        {
            DBG_LOG_PRINT(("rm minfo get number FAIL!! \r\n"));
            x_minfo_close(gh_minfo);
            DBG_LOG_PRINT(("rm closed file! \r\n"));
            continue;
        }
        DBG_LOG_PRINT(("get video num = %u \r\n", ui2_num_recs));
        ...
        else
        {
            /*x_dbg_stmt("get video info steam id = %u \r\n", 
                      (UINT32)t_minfo_rec.u.t_stm_attribute.t_stm_id);*/
