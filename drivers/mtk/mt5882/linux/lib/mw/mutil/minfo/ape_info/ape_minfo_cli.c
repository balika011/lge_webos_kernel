...
#include "x_minfo.h"
#include "mutil/minfo/ape_info/ape_minfo.h"
...
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_fopen(INT32 i4_argc, const CHAR** pps_argv);
static INT32 minfo_cli_ape_mopen(INT32 i4_argc, const CHAR** pps_argv);
static INT32 minfo_cli_ape_close(INT32 i4_argc, const CHAR** pps_argv);
static INT32 minfo_cli_ape_getnum(INT32 i4_argc, const CHAR** pps_argv);
static INT32 minfo_cli_ape_getinfo(INT32 i4_argc, const CHAR** pps_argv);
static INT32 minfo_cli_ape_auto_test(INT32 i4_argc, const CHAR** pps_argv);
static INT32 minfo_cli_ape_stress_test(INT32 i4_argc, const CHAR** pps_argv);

/* mfmtrecg command table */
static CLI_EXEC_T at_ape_minfo_cmd_tbl[] =
{
    {"fopen",       NULL,  minfo_cli_ape_fopen,        NULL,    "minfo_fopen",      CLI_SUPERVISOR},
    {"mopen",       NULL,  minfo_cli_ape_mopen,        NULL,    "minfo_mopen",      CLI_SUPERVISOR},
    {"close",       NULL,  minfo_cli_ape_close,        NULL,    "minfo_close",      CLI_SUPERVISOR},
    {"GetRecNum",   NULL,  minfo_cli_ape_getnum,       NULL,    "minfo_getnum",     CLI_SUPERVISOR},
    {"GetRecInfo",  NULL,  minfo_cli_ape_getinfo,      NULL,    "minfo_getinfo",    CLI_SUPERVISOR},
    {"AutoTest",    NULL,  minfo_cli_ape_auto_test,    NULL,    "minfo_autotest",   CLI_SUPERVISOR},  
    {"StressTest",  NULL,  minfo_cli_ape_stress_test,  NULL,    "minfo_stresstest", CLI_SUPERVISOR},
    END_OF_CLI_CMD_TBL
};

CHAR* g_at_ape_aud_encode_info[] =
{
    ...
    "MINFO_INFO_AUD_ENC_APE"
};

CHAR* g_at_ape_vid_encode_info[] =
{
...
{    
    ...
    DBG_LOG_PRINT(("minfo_cli_ape_nfy_fct:Event type=%s\r\n", 
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_fopen(INT32        i4_argc,
                                 const CHAR** pps_argv)
{
    INT32           i4_ret;
    ...
    b_abort = FALSE;
    i4_ret = x_minfo_fopen(ps_file_path, x_ape_minfo_nfy, (VOID*) -1, &t_format, &gh_minfo_ape);
    if (MINFOR_OK != i4_ret )
    {
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_mopen(INT32        i4_argc,
                                 const CHAR** pps_argv)
{
    HANDLE_T            h_file;
    INT32               i4_ret;
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_close(INT32        i4_argc,
                                 const CHAR** pps_argv)
{
    INT32 i4_ret;
    
    i4_ret = x_minfo_close(gh_minfo_ape);
    if (MINFOR_OK != i4_ret)
    {
        DBG_ERROR(("minfo_cli_ape_close error=%d\r\n", i4_ret));
        return CLIR_CMD_EXEC_ERROR;
    }
    DBG_LOG_PRINT(("minfo_cli_ape_close successfully!\r\n"));
    return CLIR_OK;
}
#endif

/*-----------------------------------------------------------------------------
 * Name: minfo_cli_ape_getnum
 *
 ...
 *          other non values  Routine unsuccessful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_getnum(INT32        i4_argc,
                                  const CHAR** pps_argv)
{ 
    ...
    /*get minfo number*/
    i4_ret = x_minfo_get_num_recs( gh_minfo_ape,
                                   e_info_type,
                                   &ui2_num_recs);
    if (MINFOR_OK == i4_ret)
    {
...
CHAR* _mkv_get_encode_str(UINT8 ui1_encode_id, UINT8 ui1_strm_type)
{
    ...
    case 0:
        ...
        if (ui1_encode_id <= 14)
        {
            ps_info = g_at_ape_vid_encode_info[ui1_encode_id];
        }
        break;
    case 1:
        /*audio encode*/
        if (ui1_encode_id <= 12)
        {
            ps_info = g_at_ape_aud_encode_info[ui1_encode_id];
        }
        break;
    case 2:
        /*subtitle type*/
        ...
        if (ui1_encode_id <= 6)
        {
            ps_info = g_at_ape_sp_type_info[ui1_encode_id];
        }
        break;
    default:
        DBG_ERROR(("_ape_get_encode_str wrong strm type!\r\n"));
        break;
    }
    return ps_info;
}
 ...
 * Returns: NULL
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
VOID  _ape_log_minfo_rec(MINFO_INFO_T* pt_minfo_rec)
{
    MINFO_INFO_TYPE_T            e_info_type;
    ...
    {
        DBG_LOG_PRINT(("_ape_log_minfo_rec:NULL \r\n"));
        return ;
    }
    ...
    switch (e_info_type)
    {
        ...
        case MINFO_INFO_TYPE_META_DATA:
            ...
            break;
        default:
            DBG_LOG_PRINT(("_ape_log_minfo_rec:unknown\r\n"));
            DBG_LOG_PRINT(("\r\n"));
            break;
 ...
 * Returns: CLIR_OK                 Routine successful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_getinfo(INT32        i4_argc,
                                   const CHAR** pps_argv)
{
    MINFO_INFO_TYPE_T  e_info_type;
    INT32              i4_ret;
    ...
    i4_ret = x_minfo_get_info ( gh_minfo_ape,    
                                e_info_type,
                                ui2_index,          
                                (VOID*)&t_minfo_rec,       
                                &t_size);
    ...
    _ape_log_minfo_rec(&t_minfo_rec);
    return CLIR_OK;
}
#endif
 ...
 *          other non values  Routine unsuccessful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_auto_test(INT32        i4_argc,
                                     const CHAR** pps_argv)
{  
    INT32           i4_ret;
    CHAR*           ppc_argv[4];
    ...
    i4_ret = minfo_cli_ape_fopen(2, (const CHAR**)ppc_argv);
    if (MINFOR_OK != i4_ret)
    {
...
/*-----------------------------------------------------------------------------
 * Name: minfo_cli_ape_stress_test
 *
 ...
 *          other non values  Routine unsuccessful.
 ----------------------------------------------------------------------------*/
#ifdef CLI_LVL_ALL
static INT32 minfo_cli_ape_stress_test(INT32        i4_argc,
                                       const CHAR** pps_argv)
{  
 ...
 * Returns: 
 ----------------------------------------------------------------------------*/
INT32 ape_minfo_cli_init(CLI_EXEC_T **ppt_command_array)
{
#ifdef CLI_LVL_ALL

    *ppt_command_array = at_ape_minfo_cmd_tbl;
