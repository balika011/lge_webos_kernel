...
#ifndef _FLAC_PARSER_H_
#define _FLAC_PARSER_H_
...
typedef struct _FLAC_STREAM_INFO_T
{
    /*audio frame info*/
    //UINT8               ui1_version;
    //UINT8               ui1_layer;
    ...
    UINT64              ui8_cluster_leng;
    UINT8               ui1_cur_block_id;
    UINT64              ui8_index_start_pos;
    UINT64              ui4_index_leng;
    UINT32              ui4_bitrate;
...
typedef struct _MINFO_FLAC_STREAM_INFO_T
{
    CHAR*                  psz_description;
    UINT32                 ui4_element_size;
    
} MINFO_FLAC_STREAM_INFO_T;
/*-----------------------------------------------------------------------------
...
extern INT32 flac_parse_fopen (
                        CHAR*              ps_path_name,
                        VOID*              pv_obj);

/* This function open a handler for a memory buffer */
extern INT32 flac_parse_mopen (
                        VOID*              pv_mem_data,
                        SIZE_T             z_mem_leng,
                        VOID*              pv_obj);

/* This function close a handler */
extern INT32 flac_parse_close (
                        VOID*               pv_obj);

/* This function start parsing the infomation */
extern INT32 flac_parse_elements(MINFO_OBJ_T * pt_minfo_obj);
