...
typedef struct
{
    ...
    int rRet;  
}MTDRM_TZIF_HDCP2_DataDecrypt_T;


/** 
 * MTDRM_TZIF_HDCP2_GET_PROTECTED_DECRYPT_KEY : HDCP protected decrption key
 */
typedef struct
{
   unsigned char *pData;    /**< HDCP protected decrption key */
   UINT32 u4length;         /**< HDCP protected decrption key length */
   int rRet;                /**< return value for getting HDCP protected decrption key */
}MTDRM_TZIF_HDCP2_PROTECTED_DECRYPT_KEY;
...
}MTDRM_TZIF_IPTVES_time_Cleanup_T;
