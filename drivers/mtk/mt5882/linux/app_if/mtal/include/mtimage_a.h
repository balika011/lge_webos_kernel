...
typedef UINT32 (*MTIMAGE_READDATA_EX)(UINT32 u4Addr,UINT32 u4Len, VOID* pvTag);
...
EXTERN MT_RESULT_T MTIMAGE_RegReadFuc_Ex(UCHAR ucImgId,MTIMAGE_HANDLE hHandle,
                               MTIMAGE_READDATA_EX fnReadData, VOID* pv_tag, MTIMAGE_SETCINFORES fnSetCinfoRes);
#endif
