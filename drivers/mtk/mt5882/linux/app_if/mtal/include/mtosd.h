...
EXTERN MT_RESULT_T MTOSD_GPU_Get_FrameSurface_Attributes(UINT32 u4Plane, MTGAL_PLANE_ATTRIBUTE_T *pAttributes, UINT32 numAttributes, UINT32 *pValues, UINT32 numValues);

EXTERN MT_RESULT_T MTOSD_GPU_Set_FrameSurface_Attributes(UINT32 u4Plane, const MTGAL_PLANE_ATTRIBUTE_T *pAttributes, UINT32 numAttributes, const UINT32 *pValues, UINT32 numValues);
...
EXTERN MT_RESULT_T MTOSD_BASE_DisableLoaderLogo(VOID);
#ifdef __cplusplus
}
#endif
