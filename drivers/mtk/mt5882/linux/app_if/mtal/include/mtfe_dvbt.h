...
*@retval MT_NOT_OK          Fail.
*/
EXTERN MT_RESULT_T MTFE_DVBT_GetTimeOut(UINT16 *pszTimeOut);
...
/**UnRegister demod callback function.
*@param  CbId               Callback function ID.
*@param  pfCb               Callback function.
*@param  vArg               The argument of callback function.
*@retval MT_OK              Success.
...
EXTERN MT_RESULT_T MTFE_DVBT_UnRegCb(MTFE_CB_FCT pfCb);
...
*@retval MT_NOT_OK          Fail.
*/
EXTERN MT_RESULT_T MTFE_DVBT_Set_EU_Mode(VOID);
