...
EXTERN MT_RESULT_T MTPHOTO4K_VdpAllocate(UINT32 ui4Width, UINT32 ui4Height, BOOL bDoubleBuffer, UINT32*  pui4BufId);
EXTERN MT_RESULT_T MTPHOTO4K_GetVdpInfo(UINT32 ui4BufId, VDP_BUF_INFO_T* pt_info);
EXTERN MT_RESULT_T MTPHOTO4K_VdpDeallocate(UINT32 ui4BufId);
