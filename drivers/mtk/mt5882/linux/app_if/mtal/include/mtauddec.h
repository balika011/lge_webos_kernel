...
/*! \enum MTAUDDEC_SET_TYPE_T
 *  \brief set type.
 */
typedef enum
{
	MTAUDDEC_SET_NONE = 0,
	MTAUDDEC_SET_AC3_DRC_CUT_FACTOR,
	MTAUDDEC_SET_AC3_DRC_BOOST_FACTOR,
	MTAUDDEC_SET_AAC_DRC_CUT_FACTOR,
	MTAUDDEC_SET_AAC_DRC_BOOST_FACTOR,
	MTAUDDEC_SET_DTS_DRC_CUT_FACTOR,
	MTAUDDEC_SET_DTS_DRC_BOOST_FACTOR,
	MTAUDDEC_SET_DTS_LFE_DOWNMIX,
	MTAUDDEC_SET_SPK_TOPOLOGY,
    MTAUDDEC_SET_SEEK_TIME,
    
	MTAUDDEC_SET_NUM
} MTAUDDEC_SET_TYPE_T;

/*! \enum MTAUDDEC_GET_TYPE_T
 *  \brief get type.
 */
typedef enum
{
	MTAUDDEC_GET_NONE = 0,
	MTAUDDEC_GET_AC3_COMP_MODE,
	MTAUDDEC_GET_AC3_DRC_CUT_FACTOR,
	MTAUDDEC_GET_AC3_DRC_BOOST_FACTOR,
	MTAUDDEC_GET_AAC_DRC_CUT_FACTOR,
	MTAUDDEC_GET_AAC_DRC_BOOST_FACTOR,
	MTAUDDEC_GET_DTS_DRC_CUT_FACTOR,
	MTAUDDEC_GET_DTS_DRC_BOOST_FACTOR,
	MTAUDDEC_GET_DTS_LFE_DOWNMIX,
	MTAUDDEC_GET_SPK_TOPOLOGY,
	MTAUDDEC_GET_HDMI_SPK_CONFIG,
	MTAUDDEC_GET_HDMI_DOWNMIX_SETTING,
	MTAUDDEC_GET_TOTAL_SEEK_TIME,
...
typedef enum
{
    ...
    MTAUDDEC_CH_IEC_LEFT,
    MTAUDDEC_CH_IEC_RIGHT,
    MTAUDDEC_CH_BYPASS_LEFT,
    MTAUDDEC_CH_BYPASS_RIGHT,
    MTAUDDEC_CH_DMX_LEFT,
    MTAUDDEC_CH_DMX_RIGHT,
    MTAUDDEC_CH_CH1314_LEFT,
    MTAUDDEC_CH_CH1314_RIGHT,
    ...
    MTAUDDEC_CH_LFE,
    MTAUDDEC_CH_THIRD,
    MTAUDDEC_CH_INPUT_DEC,    //AUD_CH_INPUT_DEC    
    MTAUDDEC_CH_BT,           //BT     
    MTAUDDEC_CH_NUM
}MTAUDDEC_CH_T;
...
/*! \enum MTAUDDEC_SPK_TOPOLOGY_T
 *  \brief Speaker topology
 */
typedef enum
{
	MTAUDDEC_SPK_UNKNOWN = 0,
	MTAUDDEC_SPK_2_0,
	MTAUDDEC_SPK_1_1,
	MTAUDDEC_SPK_2_2,
	MTAUDDEC_SPK_2_0_MIX_SW,
	MTAUDDEC_SPK_2_1,

	MTAUDDEC_SPK_5_1,
	MTAUDDEC_SPK_7_1,

} MTAUDDEC_SPK_TOPOLOGY_T;
...
typedef struct
{
	...
	UINT32 u4BitDepth;
	UINT32 u4SampleRate;
	_AUD_TYPE_T eChannelCfg;
	UINT32 u4ChannelNum;
	UINT32 u4ChannelMask;	// bit0: L  bit1: R  bit2: C  bit3: Ls  bit4: Rs  bit5: Sub  bit6: Lss  bit7: Rss
	MTAUDDEC_FMT_T eFmt;
	UINT32 u4ChannelMapping;	// bit0~3: data0  bit4~7: data1  bit8~11: data2  bit12~15: data3
								// bit16~19: data4  bit20~23: data5  bit24~27: data6  bit28~31: data7
								// datax: 0: L/R  1: Ls/Rs  2: C/Sub  3: Lss/Rss  4: Dmx L/R  5: Bypass L/R  6: IEC L/R  7: CH1314 L/R  8: AUX L/R
} MTAUDDEC_AUD_INFO_T;
...
/*! \fn EXTERN MT_RESULT_T  MTAUD_SetStcId (UINT8 u1DecId, UINT8 u1StcId)
 *  \brief Set STC Id.
 *  \param [in] u1DecId Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
 *  \param [in] u1StcId STC Id (0~2).
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 */
EXTERN MT_RESULT_T  MTAUD_SetStcId (UINT8 u1DecId, UINT8 u1StcId);

/**Get audio decoder info.
*@param u1DecId                    Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
*@param pAudInfo            		audio info.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_GetAudInfo(UINT8 u1DecId, MTAUDDEC_AUD_INFO_T *pAudInfo);
...
/**Get AC3 compression mode.
*@param u1DecId                    Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
*@param eCompMode                  Compression mode.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetAc3CompMode (UINT8 u1DecId,
                                      MTAUDDEC_AC3_COMP_MODE_T *eCompMode);
...
/**Setup 0~100 cut factor for dynamix range compression.
*@param u1DecId                    Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
*@param u1DrcLevel                 DRC range 0~100.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetAc3DrcCutFactor(UINT8 u1DecId, UINT8 u1DrcLevel);

/**Setup 0~100 boost factor for dynamix range compression.
*@param u1DecId                    Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
*@param u1DrcLevel                 DRC range 0~100.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetAc3DrcBoostFactor(UINT8 u1DecId, UINT8 u1DrcLevel);

/**Get cut factor for dynamix range compression.
*@param u1DecId                    Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
*@param u1DrcLevel                 DRC range 0~100.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetAc3DrcCutFactor(UINT8 u1DecId, UINT8 *u1DrcLevel);

/**Get boost factor for dynamix range compression.
*@param u1DecId                    Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
*@param u1DrcLevel                 DRC range 0~100.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetAc3DrcBoostFactor(UINT8 u1DecId, UINT8 *u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetAacDrcCutFactor(UINT8 u1DecId, UINT8 u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetAacDrcBoostFactor(UINT8 u1DecId, UINT8 u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetAacDrcCutFactor(UINT8 u1DecId, UINT8 *u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetAacDrcBoostFactor(UINT8 u1DecId, UINT8 *u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetDTSDrcCutFactor(UINT8 u1DecId, UINT8 u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetDTSDrcBoostFactor(UINT8 u1DecId, UINT8 u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetDTSDrcCutFactor(UINT8 u1DecId, UINT8 *u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetDTSDrcBoostFactor(UINT8 u1DecId, UINT8 *u1DrcLevel);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetDTSLFEDownmix(UINT8 u1DecId, UINT8 u1Mode);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetDTSLFEDownmix(UINT8 u1DecId, UINT8 *u1Mode);
...
EXTERN MT_RESULT_T MTAUDDEC_GetTotalSeekTime(UINT8 u1DecId, UINT32 *pu4Millisecond);
EXTERN MT_RESULT_T MTAUDDEC_SetSeekTime(UINT8 u1DecId, UINT32 u4Millisecond);
#endif
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetMuteAll(UINT8 u1DecId, BOOL fgEnable);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetAutoMute(UINT8 u1DecId, BOOL fgEnable);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetBalanceInDB2 (UINT8 u1DecId, INT16 i2DB);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetSRSTruBass(UINT8 u1DecId, BOOL fgEnable);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetSRSTruVolume(UINT8 u1DecId, BOOL fgEnable);
...
/*! \fn EXTERN MT_RESULT_T  MTAUDDEC_SetBassBoost (UINT8 u1DecId, BOOL fgEnable)
 *  \brief Setup bass boost.
 *  \param [in] eOut Out port (MTAUD_SPEAKER, MTAUD_HEADPHONE)
 *  \param [in] fgEnable on/off.
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 */
EXTERN MT_RESULT_T  MTAUDDEC_SetBassBoostOutCtrl (MTAUD_OUT_PORT_T eOut, BOOL fgEnable);

/*! \fn EXTERN MT_RESULT_T  MTAUDDEC_SetBass (UINT8 u1DecId, INT16 i2Bass)
 *  \brief Setup bass
 *  \param [in] eOut Out port (MTAUD_SPEAKER, MTAUD_HEADPHONE)
 *  \param [in] i2Bass bass value  ( +-14 dB, with 0.5 dB/step) (for philips : +-12dB, 0.125 dB/step)
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 */
EXTERN MT_RESULT_T  MTAUDDEC_SetBassOutCtrl (MTAUD_OUT_PORT_T eOut, INT16 i2Bass);

/**Get bass.
*@param eOut Out port (MTAUD_SPEAKER, MTAUD_HEADPHONE)
*@param u1Volume                   bass value ( +-14 dB, with 0.5 dB/step) (for philips : +-12dB, 0.125 dB/step)
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetBassOutCtrl (MTAUD_OUT_PORT_T eOut, INT16 * i2Bass);
 ...
 *  \retval MTR_NOT_OK Fail.
 */
EXTERN MT_RESULT_T  MTAUDDEC_SetTrebleBoostOutCtrl(MTAUD_OUT_PORT_T eOut, BOOL fgEnable);

/**Get treble.
*@param eOut Out port (MTAUD_SPEAKER, MTAUD_HEADPHONE)
*@param u1Volume                   treble value ( +-14 dB, with 0.5 dB/step) (for philips : +-12dB, 0.125 dB/step)
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetTrebleOutCtrl(MTAUD_OUT_PORT_T eOut, INT16 * i2Treble);

/*! \fn EXTERN MT_RESULT_T  MTAUDDEC_SetTreble (UINT8 u1DecId, INT16 i2Treble)
 *  \brief Setup Treble
 *  \param [in] eOut Out port (MTAUD_SPEAKER, MTAUD_HEADPHONE)
 *  \param [in] i2Treble Treble value ( +-14 dB, with 0.5 dB/step) (for philips : +-12dB, 0.125 dB/step)
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 */
EXTERN MT_RESULT_T  MTAUDDEC_SetTrebleOutCtrl(MTAUD_OUT_PORT_T eOut, INT16 i2Treble);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetClearSound(UINT8 u1DecId, BOOL fgEnable);
...
/**Setup SPDIF Attenuation level.
*@param u1Level 				   0~8dB, 1dB/step
*@retval MTR_OK 				   Success.
*@retval MTR_NOT_OK 			   Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetSPDIFLevel(UINT8 u1Level);

EXTERN MT_RESULT_T MTAUDDEC_SetSoundBarIDData (UINT32 ID, UINT8 data, UINT8 volumeInfo); 
EXTERN MT_RESULT_T MTAUDDEC_SetSoundBar(BOOL bOnOff);
EXTERN MT_RESULT_T MTAUDDEC_GetSoundBarStatus(UINT8 *psubframe_ID, UINT8 *psubframe_data); 
...
/**Setup Speaker Topology
*@param eSpk                 	     MTAUDDEC_SPK_TOPOLOGY_T, Speaker topology
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_SetSpeakerTopology(MTAUDDEC_SPK_TOPOLOGY_T eSpk);

/**Get Speaker Topology
*@param eSpk                 	     MTAUDDEC_SPK_TOPOLOGY_T, Speaker topology
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T  MTAUDDEC_GetSpeakerTopology(MTAUDDEC_SPK_TOPOLOGY_T *eSpk);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_SetSub2LR(UINT8 u1DecId, BOOL fgEnable);
...
/*! \fn EXTERN MT_RESULT_T MTAUDDEC_SetBiquad(UINT8 u1DecId, BOOL fgEnable)
 *  \brief Setup Biquad switch on/off
 *  \param [in] u1DecId Decoder Id (AUD_DEC_MAIN or AUD_DEC_AUX).
 *  \param [in] fgEnable on/off.
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 */
EXTERN MT_RESULT_T MTAUDDEC_SetBiquad(UINT8 u1DecId, BOOL fgEnable);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_SetBiquadCfg(UINT8 u1DecId, UINT8 u1Set, UINT8 u1Ch,
...
/*! \if Android
 *  \fn EXTERN MT_RESULT_T MTAUDDEC_Record2PCM_open(void)
 *  \brief Open Audo Recoder.
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 *  \endif
 */
EXTERN MT_RESULT_T MTAUDDEC_Record2PCM_open(void);

/*! \if Android
 *  \fn EXTERN MT_RESULT_T MTAUDDEC_Record2PCM_read(UINT32 u4BufAddr, UINT32 u4BufSize, UINT32* u4ReadSize, BOOL fgBlockRead)
 *  \brief Read Recoded Audio Data.
 *  \param [in] u4BufAddr Buffer Address.
 *  \param [in] u4BufSize Buffer Size.
 *  \param [out] u4ReadSize Actually Read Size.
 ...
 *  \endif
 */
EXTERN MT_RESULT_T MTAUDDEC_Record2PCM_read(UINT32 u4BufAddr, UINT32 u4BufSize, UINT32* u4ReadSize, BOOL fgBlockRead);

/*! \if Android
 *  \fn EXTERN MT_RESULT_T MTAUDDEC_Record2PCM_close(void)
 *  \brief Close Audio Recoder.
 *  \return a MTAL error code.
 *  \retval MTR_OK Success.
 *  \retval MTR_NOT_OK Fail.
 *  \endif
 */
EXTERN MT_RESULT_T MTAUDDEC_Record2PCM_close(void);    
...
/**Get the HDMI speaker config
*@param u1SpkCfg                  Speaker config
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_GetHDMISpeakerConfig(UINT8 u1DecId, UINT8 *u1SpkCfg);

/**Get the HDMI Downmix setting
*@param u1Downmix                  Downmix setting
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_GetHDMIDownmixSetting(UINT8 u1DecId, UINT8 *u1Downmix);
...
EXTERN MT_RESULT_T MTAOMX_TrigRender(UINT8 u1DecId);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_ResAlloc(UINT8 u1DecId, BOOL *bIsFree, UINT8 *u1NumCandidateToKick, UINT8 *u1DecToKick, UINT32 u4AddInfo);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_Set(MTAUDDEC_SET_TYPE_T eSetType, UINT8 u1DecId, VOID *pInfo, SIZE_T *pSize);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTAUDDEC_Get(MTAUDDEC_GET_TYPE_T eGetType, UINT8 u1DecId, VOID *pInfo, SIZE_T *pSize);
...
/*! @} */
	...
	*/
    ...
    EXTERN MT_RESULT_T MTAUD_GetAoutBankNum(UINT8 u1DecId, unsigned int *pAoutBankNum);
    EXTERN MT_RESULT_T  MTAUDDEC_FlushAFIFO(UINT8 u1DecId);
    EXTERN MT_RESULT_T MTAUDDEC_SetUserCommand(UINT32 u4CmdType, UINT32 u4Index,
