...
typedef enum MTVDECEX_INPUT_TYPE
{
	MTVDECEX_INPUTSRC_AVD = 0,
	MTVDECEX_INPUTSRC_ADC,
	MTVDECEX_INPUTSRC_HDMI,
	MTVDECEX_INPUTSRC_VDEC,
	MTVDECEX_INPUTSRC_JPEG,
	MTVDECEX_INPUTSRC_MAX = MTVDECEX_INPUTSRC_JPEG,
	MTVDECEX_INPUTSRC_MAXN,
} MTVDECEX_INPUT_TYPE_T;
...
typedef enum 
{
	HDMI_3D_Struct_FramePacking=0,
	HDMI_3D_Struct_FieldAlternative,
	HDMI_3D_Struct_LineAlternative,
	HDMI_3D_Struct_SideBySideFull,
	HDMI_3D_Struct_LDepth,
	HDMI_3D_Struct_LDepthGraph,
	HDMI_3D_Struct_TopBottom,
	HDMI_3D_Struct_SideBySideHalf=8,
	HDMI_3D_Struct_Unknow
}HDMI_3D_FORMAT_TYPE_T;

typedef struct
{
   	INT32 format;	/**< update by LG */
	UINT16 hFreq;	/**< ... */
	UINT16 vFreq;	/**< ... */
	UINT16 hTotal;	/**< ... */
	UINT16 vTotal;	/**< ... */
	...
	HDMI_3D_FORMAT_TYPE_T full_3d_timing;	// 3D format information base on timing info

} HDMI_TIMING_INFO_T;

typedef struct
{
    UINT32 u4Height;   ///< Active Width
    UINT32 u4Width;  ///< Active Height
    UINT32 u4Interlace;
}HDMI_HWACTIVE_T;
...
EXTERN MT_RESULT_T MTVDECEX_SetVFESrcPipeline(MTVDECEX_SRC_T eSrc, UINT32 u4Port, UINT32 u4Enable, MTVDECEX_CN_T eType);
EXTERN MT_RESULT_T MTVDECEX_SetVFEAVDConnect(MTVDECEX_SRC_T eSrc, UINT32 u4Port, UINT32 u4Enable, MTVDECEX_CN_T eType);
EXTERN MT_RESULT_T MTVDECEX_SetVSCSrcPipeline(MTVDO_PATH_T ePath, MTVDECEX_INPUT_TYPE_T eSrc, UINT32 u4Enable, MTVDECEX_CN_T eType);
