...
typedef enum _MTMX_SET_TYPE_T
{
    ...
    MTMX_SET_TYPE_CONFIG_PID,                    ///< set configure pid
    MTMX_SET_TYPE_ADD_SECTION,                   ///< set add section
    MTMX_SET_TYPE_DELETE_SECTION,                ///< set delete section
    MTMX_SET_TYPE_USE_TRUSTZONE,                 ///< set use trustzone
...
MT_RESULT_T MTMX_Map(UINT16 u2CompId);

MT_RESULT_T MTMX_UnMap(UINT16 u2CompId);
