...
typedef struct
{
    ...
    UINT32 u4HSize;
    UINT32 u4VSize;
    UINT32 u4HSizeStride;
    UINT32 u4VSizeStride;
    UINT32 u4Size;
} MTVDEC_FRAME_INTO_T;
...
typedef enum
{
    ...
    MTVDEC_SET_IMGRZ_ID,            ///< VDEC Set imgrz id Msk
    MTVDEC_SET_ADD_IMGRZ_ID,        ///< VDEC Set the add imgrz id Msk
...
typedef enum
{
    ...
    MTVDEC_RM_IMGRZ_REQ,    ///< VDEC Decode RM require to add imgrz number
...
typedef struct
{
    ...
    union 
    {
        ...
        unsigned char ucReqMoreNum; //eCond == MTVDEC_RM_IMGRZ_REQ
...
typedef struct _MT_VDEC_DIRECT_VideoInfo
{
...
typedef struct 
{
    ...
    BOOL   fgPtsMached;                 /// <does PTS or Pts/stc sync now.
    ...
    UINT32 u4ErrMbCnt;                  //decode error Mb Cnt in currently frame
}MTVDEC_DEC_STATUS_T;
...
/**Set frameToUser  to VDEC module for general info callback.
*@param  ucEsId                    Es id.
*@param  fgFrameToUser            adjust fgFrameToUser.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTVDEC_SetFrameToUser(UCHAR ucEsId, BOOL fgFrameToUser);
...
/**Get one frame date from kenal to user, and could continue call it .
*@param  ucEsId                    Es id.
*@param  ucFbgId                  ucFbgId
*@param  ucFbId                    ucFbId
*@retval prFrameInfo              the frame data and param..
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_GetCurrentFrameData(UCHAR ucEsId, UCHAR ucFbgId, UCHAR ucFbId, MTVDEC_FRAME_INTO_T *prFrameInfo);

/**Getted date from kenal to user, and could continue call it .
*@param  ucEsId                    Es id.
*@param  ucFbgId                  ucFbgId
*@param  ucFbId                    ucFbId
*@param  ucFbgId                  fgGettedData
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_GettedData(UCHAR ucEsId, UCHAR ucFbgId, UCHAR ucFbId, BOOL fgGettedData);

/**set render pts from kenal to user, and could continue call it .
*@param  ucEsId                    Es id.
*@param  u4Pts                     u4Pts
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_SetRenderPts(UCHAR ucEsId, UINT32 u4Pts);

/**set render from pts from kenal to user, and could continue call it .
*@param  ucEsId                    Es id.
*@param  u4Pts                     u4Pts
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_SetRenderFromPts(UCHAR ucEsId, UINT32 u4Pts);

/**set render from first pic from kenal to user, and could continue call it .
*@param  ucEsId                           Es id.
*@param  fgRenderFromFirstPic      fgRenderFromFirstPic
*@param  u8LastRenderPos            u8LastRenderPos
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_SetRenderFromFirstPic(UCHAR ucEsId, BOOL fgRenderFromFirstPic, UINT64 u8LastRenderPos);

/**set render from pos from kenal to user, and could continue call it .
*@param  ucEsId                           Es id.
*@param  fgRenderFromPos           fgRenderFromPos
*@param  u8Pos                            u8Pos
*@param  i4TempRef                     i4TempRef
*@param  u2DecodingOrder           u2DecodingOrder
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_SetRenderFromPos(UCHAR ucEsId, BOOL fgRenderFromPos, UINT64 u8Pos, INT32 i4TempRef, UINT16 u2DecodingOrder);

/**set render from back step from kenal to user, and could continue call it .
*@param  ucEsId                           Es id.
*@param  fgRenderFromPos           fgRenderBackStep
*@param  u8Pos                            u8Pos
*@param  i4TempRef                     i4TempRef
*@param  u2DecodingOrder           u2DecodingOrder
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_SetRenderFromBackStep(UCHAR ucEsId, BOOL fgRenderBackStep, UINT64 u8Pos, INT32 i4TempRef, UINT16 u2DecodingOrder);

/**set render from pos from kenal to user, and could continue call it .
*@param  ucEsId                           Es id.
*@param  u4Pts                            u4Pts
*@param  fgRenderFromPos           fgAutoPause
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_SetRenderFromPtsAutoPause(UCHAR ucEsId, UINT32 u4Pts, BOOL fgAutoPause);

/**get colour primary from kenal to user.
*@param  ucEsId                           Es id.
*@param  pucColour                      pucColour
*@retval return                       ... ....
*/
EXTERN MT_RESULT_T MTVDEC_GetColourPrimary(UCHAR ucEsId, UCHAR *pucColour);

EXTERN MT_RESULT_T MTVDEC_GetHalParam(UCHAR ucEsId, UINT32 u4Type, UINT32 u4Param1,UINT32 u4Param2, UINT32 u4Param3);

EXTERN MT_RESULT_T MTVDEC_GetDirectVDECInfo(UCHAR ucEsId, UINT32 u4Param1);
