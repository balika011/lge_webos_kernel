...
typedef enum
{
    ...
    VDO_PQ_SET_BS_BASE,					///<BS base chekc
...
typedef enum
{
    ...
    VDO_CB_FUNC_SRC_CHG_MW_IND_EX,          ///<Source Change Notify for C++, include Object tag
    ...
    VDO_CB_FUNC_3D_MODE_CHG,
    VDO_CB_FUNC_AFTER_3D_MODE_CHGED,
    VDO_CB_FUNC_NS
...
typedef void (*MTVDO_3D_MODE_CHG_NOTIFY)(
	UINT32 u4SrcWidth,				///< new source width
	UINT32 u4SrcHeight,			///< new source height
	UINT32 u4InOutFrameRate, 			///< new frame rate
	UINT32 u1Output3DFormat, 			///< new scan mode
	UINT8  u1Input3DFormat,
	UINT8  u1ColorFormat,
	UINT8 u1ColorSpace 
);
...
typedef struct
{
    ...
    UINT32 u4HDefPorch;     ///<H default porch
    UINT32 u4VDefPorch;     ///<V default porch
    ...
    UINT32 u4SignalStatus;  ///<signal status
}MTVDO_TIMING_INFO_T;
...
/**VDO get video main loop mode change done event.
*@param eVdpId                     Video plane id.
*@param pu1VideoDone           flag to get mode change done (fgIsVideoDone)
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTVDO_GetVideoDone(MTVDO_PATH_T eVdpId, UINT8* pu1VideoDone);
...
EXTERN MT_RESULT_T MTVDO_GetTimingInfoByDec(MTVDO_DEC_TYPE_T eDecType, MTVDO_TIMING_INFO_T *prInfo);
...
EXTERN MT_RESULT_T MTVDO_3DPanelFormatChg(BOOL fgEnable);
...
EXTERN MT_RESULT_T MTVDO_SetITMFlag(MTVDO_PATH_T eVdpId, UINT32 u4Factor);
...
/**this function for cutomter ,ap set video pixel shift.
*@param eVdpId                      Video plane ID.
*@param u4Xoffset                   x offset.
*@param u4Yoffset                   y offset.
*@retval MTR_OK                     Success.
*@retval MTR_NOT_OK                 Fail
*/
EXTERN MT_RESULT_T MTVDO_SetVideoPixelShift(MTVDO_PATH_T eVdpId, UINT32 u4Xoffset,UINT32 u4Yoffset);

EXTERN MT_RESULT_T MTVDO_3DPanelFormatChg(BOOL fgEnable);

/**Interface for MW to decide to which  3D format  will be detected  by Navi
*@param mode                       detect mode.
*@retval MTR_OK                     Success.
*@retval MTR_NOT_OK                 Fail.
*/
EXTERN MT_RESULT_T MTVDO_Set3DpatternMode(UINT32 mode);
