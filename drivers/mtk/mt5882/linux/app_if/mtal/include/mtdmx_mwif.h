...
//-----------------------------------------------------------------------------
    /** MTDMX_MUL_GetTSIndex
     *  Multiple instance maanger for get TS index.
     *
     *  @param  pu1Inst         Instance ID
     *  @param  pu1TsIdx       TsIdx ID
     *  @retval MTR_OK          Success.
     *  @retval MTR_NOT_OK      Fail.
     */
//-----------------------------------------------------------------------------
    EXTERN MT_RESULT_T MTDMX_MUL_GetTSIndex(UINT8 u1Inst, UINT8 *pu1TsIdx);
...
#define MTDMX_MWIF_MUL_GETTSINDEX_ID            (6)
