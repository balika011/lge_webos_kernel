...
*@param fgSecure                  fgSecure.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTPVR_SetSecure(UCHAR ucPvrId, BOOL fgSecure);

/**Reset mpg audio info module.
*@param ucPvrId                    PVR id.
*@param fgAudioEnable           fgAudioEnable.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTPVR_ResetMpgAudioInfo(UCHAR ucPvrId);
...
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTPVR_GetSecureBuffer(UCHAR ucPvrId, UINT8 **ppu4Addr, UINT32 *pu4Size);
...
/**Put PVR secure module.
*@param ucPvrId                    PVR id.
*@param u4Size                     buffer size.
*@param pucAddr                    buffer address.
*@retval MTR_OK                    Success.
*@retval MTR_NOT_OK                Fail.
*/
EXTERN MT_RESULT_T MTPVR_PutSecureBuffer(UCHAR ucPvrId, UINT8 *pucAddr, UINT32 u4Size);
