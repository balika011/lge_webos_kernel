...
EXTERN MT_RESULT_T MTVSS_SetFrameDrop(UINT8 u1VdpId, UINT8 u1Enable, UINT8 u1DropM, UINT8 u1DropN);
EXTERN MT_RESULT_T MTVSS_SetWriteEnable(UINT8 u1Enable);
EXTERN MT_RESULT_T MTVSS_SetVSSFreeze(UINT8 u1Enable);
