 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: io_mtfe_pd_def.h,v $
 * $Revision: #1 $
 *---------------------------------------------------------------------------*/

/** @file io_mtfe_pd_def.h
 */
#ifndef IO_MTFE_PD_DEF_H
#define IO_MTFE_PD_DEF_H
//-----------------------------------------------------------------------------
// Include files
//-----------------------------------------------------------------------------
...
/*the same with mcSEMA_LOCK_MTFE, but also print out string of sema*/
#define mcSEMA_LOCK_MTFE_S(sema, str)                                               \
{                                                                           \
    x_sema_lock(sema, X_SEMA_OPTION_WAIT);                                  \
}
#define mcSEMA_UNLOCK_MTFE_S(sema, str)                                             \
{                                                                           \
    x_sema_unlock(sema);                                           \
}
