...
typedef int 	(*setenv_proc_t)(const char *name, const char *value, int overwrite);
typedef int 	(*unsetenv_proc_t)(const char *name);
typedef char  *	(*getenv_proc_t)(const char *name);
typedef mqd_t 	(*mq_open_proc_t)(const char *name, int oflag, ...);
