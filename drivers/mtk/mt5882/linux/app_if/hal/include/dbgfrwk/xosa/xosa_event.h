...
extern int osa_event_set_conattr(osa_thread_t tid, unsigned int ev);
extern int osa_event_send_timed(osa_thread_t tid, unsigned int ev);
extern int osa_event_receive_timed(unsigned int events, unsigned int *pRetEvents, int waitMs, unsigned int options);
