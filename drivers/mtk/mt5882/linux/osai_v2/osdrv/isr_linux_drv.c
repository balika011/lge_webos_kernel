...
#if defined(CC_MT5396)||defined(CC_MT5368)||defined(CC_MT5399)||defined(CC_MT5398)||defined(CC_MT5880)||defined(CC_MT5890)
...
#if defined(CC_MT5396)||defined(CC_MT5368)||defined(CC_MT5389)||defined(CC_MT5399)||defined(CC_MT5398)||defined(CC_MT5880)||defined(CC_MT5860)||defined(CC_MT5881)||defined(CC_MT5890)||defined(CC_MT5882)
IRQ_ARRAY_T rIrqs[ISR_VECTOR_SIZE] =
{
    ...
    {NULL, "PMU1"},
    {NULL, "PMU0"},
#elif defined(CC_MT5399)||defined(CC_MT5398)||defined(CC_MT5880)||defined(CC_MT5881)||defined(CC_MT5890)||defined(CC_MT5882)
    {NULL, "PMU1"},
    {NULL, "PMU0"},
#else
#error PMU IRQ array not set.
	...
	#else
    {NULL, "ZZ:RS232_0"},
    {NULL, "DRAMC_CHC:OSD_INT2"},
    {NULL, "VDEC_LAE0:OSD_INT3"},
    {NULL, "VDEC_LAE1"},
    #endif
    {NULL, "TRNG"},
    {NULL, "P_B"},
    ...
    {NULL, "PTP_THERM:THERMAL0"},
    {NULL, "PTP_FSM:THERMAL1"},
    {NULL, "SC_TIMER"},
    {NULL, "HDMIRX_20"},
    {NULL, "NULL:G3D_IRQ_PP_0"},
    {NULL, "NULL:G3D_IRQ_PP_1"},
    {NULL, "NULL:G3D_IRQ_PP_2"},
    {NULL, "NULL:G3D_IRQ_PP_3"},
    {NULL, "NULL:G3D_IRQ_PP_ALL"},
    {NULL, "NULL:G3D_IRQ_GP"},
    {NULL, "NULL:G3D_IRQ_GPMMU"},
    {NULL, "NULL:G2D_IRQ_GPMMU_0"},
    {NULL, "NULL:G1D_IRQ_GPMMU_1"},
    {NULL, "NULL:G0D_IRQ_GPMMU_2"},
    {NULL, "NULL:G1D_IRQ_GPMMU_3"},
    #elif defined(CC_MT5882)
	{NULL, "THERMAL0"},
    {NULL, "THERMAL1"},
    {NULL, "SC_TIMER"},
    ...
    {NULL, "G3D_IRQ_PP_ALL"},
    {NULL, "G3D_IRQ_PP_GP"},
    {NULL, "G3D_IRQ_PP_GPMMU"},
    {NULL, "G2D_IRQ_PP_GPMMU_0"},
    {NULL, "G1D_IRQ_PP_GPMMU_1"},
    {NULL, "G0D_IRQ_PP_GPMMU_2"},
    {NULL, "G1D_IRQ_PP_GPMMU_3"},
	#endif
    #endif
...
#if defined(CONFIG_SMP) && !defined(CONFIG_USE_OF)
