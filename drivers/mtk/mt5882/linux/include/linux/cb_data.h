...
typedef enum
{
    ...
    CB_MTIMAGE_TRIGGER_1,
	CB_MTIMAGE_MW_TRIGGER,        
    CB_SC_TRIGGER,
    ...
    CB_MTAL_FE_TUNERHAL_TRIGGER, //MTAL TUNERHAL Module
    CB_MTAL_FE_TUNERHAL_INI_THREAD_NFY, //MTAL TUNERHAL Module
    CB_MTAL_FE_TUNERHAL_TUNER_PROC_NFY, //MTAL TUNERHAL Module
    CB_MTAL_FE_NFY_TUNER_TRIGGER, //MTAL TUNERHAL Module
	
    CB_MTAL_DMX_TRIGGER,           // MTAL DMX MODULE
    CB_MTAL_DMX_MWIF_TRIGGER,      // MTAL DMX MWIF MODULE
    CB_MTAL_VDO_SRCCHG_TRIGGER,
    CB_MTAL_VDO_SRCCHG_MW_TRIGGER,
    ...
    CB_MTAL_VDO_DISPMODE_TRIGGER,
    CB_MTAL_VDO_VSS_TRIGGER,
	CB_MTAL_VSS420_TRIGGER,
    CB_MTAL_VDO_TDNAVI_CHG,
    CB_MTAL_VDO_MM_COND_TRIGGER,
    CB_MTAL_VDO_MM_STEP_FIN_TRIGGER,
    CB_MTAL_VDO_MM_SEEK_FIN_TRIGGER,
    CB_MTAL_VDO_SRC_RANGE_CHG_TRIGGER,
    CB_MTAL_VDO_OUT_RANGE_CHG_TRIGGER,    
	CB_MTAL_VDO_3D_MODE_CHG,
	CB_FUNC_AFTER_3D_MODE_CHGED,

    CB_MTAL_B2R_AUD_START_TO_PLAY,
    CB_MTAL_B2R_EOS,
    
    CB_MTAL_TVDECEX_SCART_PIN8CHG_TRIGGER,

    CB_MTAL_VDECEX_TRIGGER,            //MTAL VDEC TRIGGER
    CB_MTAL_VDECEX_SIG_CHG,
    CB_MTAL_VDECEX_SIG_CHG_2,
	CB_MTAL_VDECEX_VGA_AUTO_PRG,  //progress
    CB_MTAL_VDECEX_VGA_AUTO,
    CB_MTAL_VDECEX_AUTO_COLOR,
    CB_MTAL_VDECEX_RESOLUTION_CHG,
    CB_MTAL_VDECEX_COMP_SIG_CHG,
    CB_MTAL_VDECEX_COLOR_SYSTEM,
    CB_MTAL_VDECEX_MV_CHG,
    CB_MTAL_VDECEX_AUTO_DETECT_SRC,
    CB_MTAL_VDECEX_ANA_SIG_CHG,     //Tuner analog tvd notify

    CB_MTAL_VDEC_USRDATA_TRIGGER,
    CB_MTAL_VDEC_DECERR_TRIGGER,
    CB_MTAL_VDEC_STATUS_TRIGGER,
    CB_MTAL_VDEC_GENERAL_TRIGGER,
    CB_MTAL_VDEC_CC_TRIGGER,
    CB_MTAL_VDEC_AUTOTEST_TRIGGER,
    ...
    CB_MTAL_TVE_SIGCHG_TRIGGER,            //MTAL TVE TRIGGER

    CB_MTAL_PERIPHERAL_RTC_TRIGGER,     // RTC alert Handler
    CB_MTAL_GPIO_TRIGGER,               // GPIO event Handler

    CB_MTAL_FRAME_TRIGGER,
    CB_MTAL_STEP_FIN_TRIGGER,
    ...
    CB_MTAL_AUDDEC_COND_TRIGGER,
    CB_MTAL_AUDDEC_COMMAND_DONE_TRIGGER,
    CB_MTAL_AUDDEC_STREAM_FORMAT_CHANGE_TRIGGER,
    CB_MTAL_AUDDEC_MUTE_STATE_CHANGE_TRIGGER,
    CB_MTAL_AUDDEC_DEC_STATE_CHANGE_TRIGGER,
    CB_MTAL_AUDDEC_MEM_STATE_CHANGE_TRIGGER,
    
    CB_MTAL_AUDDEC_BLUETOOTH_DATA_ENABLE_TRIGGER,
    CB_MTAL_AUDDEC_ENC_DATA_ENABLE_TRIGGER,
    ...
    CB_MTAL_SMC_TRIGGER,
    CB_MTAL_SMC_TRIGGER_EX,
    CB_MTAL_CI_TRIGGER,
    CB_MTAL_CI_FAST_BOOT_CB_TRIGGER,
    CB_MTAL_TEMINATE_TRIGGER,
    CB_MTAL_FVR_TRIGGER,
#if 1 //def LINUX_TURNKEY_SOLUTION
    CB_RM_CALLBACK,
    CB_RM_SELECTION,
    CB_RM_MC_ADD_DEV,
    CB_RM_MC_DEL_DEV,
...
/* MHF Linux - end */
#endif
    CB_MTAL_SWDMX_DMXNFY_TRIGGER,
    CB_MTAL_FEEDER_TRIGGER,
    CB_MTAL_FEEDER_QUERYFEEDER_TRIGGER,
    CB_MTAL_FEEDER_SEEKFEEDER_TRIGGER,
    //CB_MTAL_FEEDER_CONSUMEFEEDER_TRIGGER,
    CB_MTAL_FEEDER_PUSHCONSUMEFEEDER_TRIGGER,
    CB_MTAL_FEEDER_OVERFLOWFEEDER_TRIGGER,
    CB_MTAL_FEEDER_UNDERFLOWFEEDER_TRIGGER,
    CB_MTAL_FEEDER_FLUSH_TRIGGER,
    CB_MTAL_SWDMX_VID_SCRAMBLENFY_TRIGGER,
    CB_MTAL_SWDMX_AUD_SCRAMBLENFY_TRIGGER,
    CB_MTAL_SWDMX_RANGE_EX_NFY,
    CB_MTAL_AUDDEC_AUD_MW_NFY,
    CB_MTAL_AUDDEC_AUD_MW_HEADPHONE_DETECT_NFY,
    CB_MTAL_AUDDEC_AUD_MW_UPLOAD_DATA_NFY,
    CB_MTAL_AUDDEC_AUD_MW_DMX_NFY,
    CB_MTAL_AUDDEC_AUD_MW_DMX_AUDSETCTRL,

    CB_MTAL_CEC_TX_RESULT_NFY,
    CB_MTAL_CEC_RX_RESULT_NFY,
    CB_MTAT_CEC_5V_STATUS_NFY,

    CB_MTAL_VENC_DATA_NFY,
    CB_MTAL_MX_DATA_NFY,

    CB_MTAL_VDO_PLAYDONE_NFY,    

    CB_MTAL_SWDMX_VID_CHG_NFY,
    CB_MTAL_SWDMX_AUD_CHG_NFY,
    CB_MTAL_VDO_RES_CHG_NFY,
    CB_DRV_VDECOMX_NFY,
    CB_MTAL_VDO_BIT_RATE_CHG_NFY,
    CB_MTAL_VDEC_RM_NFY,
	CB_MTAL_VDECEX_MUTE_CHG,//by luobin add
	CB_MTAL_PHOTO4K_NFY,
    CB_MTAL_VDEC_PICINFO_NFY,
 //   #ifdef CC_B2R_RM_SUPPORT
    CB_MTAL_B2R_RM_NFY,
    CB_MTAT_CEC_TX_HEADER_RESULT_NFY,
    CB_MTAL_MHL_SCRATCHPAD_DATA_NFY,
    CB_MTAL_MHL_MSC_SUBCOMMAND_NFY,
    CB_MTAL_MHL_HOT_PLUG_NFY,
    CB_MTAL_MHL_CBUS_MODE_NFY,
    CB_MTAL_MHL_VBUS_OVERCURRENT_NFY,
  //  #endif
    CB_DRV_PDWNC_RESUME_NFY,
    CB_DRV_PDWNC_STANDBY_NFY,
    CB_FCT_NUM                  // Last one, = number of items
} CB_FCT_ID_T;

typedef enum
{
    CB2_DRV_PDWNC_SUSPEND_PREPARE_NFY,
    CB2_DRV_PDWNC_POST_SUSPEND_NFY,
    CB2_DRV_PDWNC_POWER_STATE,
    CB2_FCT_NUM                  // Last one, = number of items
} CB2_FCT_ID_T;
