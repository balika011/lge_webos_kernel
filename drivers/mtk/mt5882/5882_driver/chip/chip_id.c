...
INLINE_CHIP_FUNC(IS_SupportHEVC, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_HEVC_BIT) == BOND_HEVC_BIT))
...
INLINE_CHIP_FUNC(IS_Support4K60Decode, 0)
INLINE_CHIP_FUNC(IS_Support4KDecode, 0)
