 ...
 *
 * Inputs:
 *      pv_to  memory address that date to copy to 
 *      pv_from memory address that date to copy from
 *      z_len   length of data to copy
 *
 * Outputs: -
 *
 * Returns:
 ...
 *                   already initialized.
 *---------------------------------------------------------------------------*/
 VOID* x_os_drv_memcpy_dma (VOID*        pv_to,
                                  const VOID*  pv_from,
                                  SIZE_T       z_len)
{
    return (VOID *)GDMA_MemCpy( pv_to, pv_from , z_len );    
}
