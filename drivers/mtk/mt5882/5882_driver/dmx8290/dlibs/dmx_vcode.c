...
//H265 start code
static DMX_STARTCODE_T _arH265StartCode_NoIntr[] =
{
    {0x0, 0x00000146, 0x0, 0xFFFFFF7E},
    {0x0, 0x00000148, 0x0, 0xFFFFFF7E},
    {0x0, 0x0000014C, 0x0, 0xFFFFFF7E},
    {0x0, 0x0000014E, 0x0, 0xFFFFFF7E},
    {0x0, 0x00000150, 0x0, 0xFFFFFF7E},
};

static DMX_STARTCODE_T _arH265StartCode_Intr[] =
{
	//{0x00800000, 0x00000100, 0x00800000, 0xFFFFFFC0},
	{0x00000100, 0x00800000, 0xFFFFFFC0, 0x00800000},
	{0x0, 0x00000140, 0x0, 0xFFFFFF7E},
	{0x0, 0x00000142, 0x0, 0xFFFFFF7E},
	{0x0, 0x00000144, 0x0, 0xFFFFFF7E},
	{0x0, 0x0000014A, 0x0, 0xFFFFFF7E},
};

static INT8 au1DmxVOffsetH265[10] =
                { -3, -3, -3, -3, -3, -7, -3, -3, -3, -3};

#endif  // ENABLE_MULTIMEDIA

static DMX_VIDEO_TYPE_T _au1DmxTsIdxVcodeBase[DMX_FRAMER_COUNT];
...
static BOOL _DmxSetHWVideoType(DMX_VIDEO_TYPE_T eVideoType)
{
    ...
    case DMX_VIDEO_H265:
        if(!_DMX_SetStartCodePattern_Ex((UINT8)(sizeof(_arH265StartCode_NoIntr)/sizeof(_arH265StartCode_NoIntr[0])), _arH265StartCode_NoIntr,
            (UINT8)(sizeof(_arH265StartCode_Intr)/sizeof(_arH265StartCode_Intr[0])), _arH265StartCode_Intr))
        {
            return FALSE;
        }
        break;
...
static BOOL _DmxSetTsIndexVcode(UINT8 u1TsIdx, DMX_VIDEO_TYPE_T eVideoType)
{
    ...
    if(u1TsIdx == (DMX_FRAMER_COUNT - 1))    
    {
        _DMX_Lock();
        _au1DmxTsIdxVcodeBase[u1TsIdx] = eVideoType;
        u4Reg = TS4_VIDEO_TYPE;
        u4Reg &= ~0xFF000000;
        u4Reg |= (u4Val << 24);
        TS4_VIDEO_TYPE = u4Reg;
        _DMX_Unlock();
    }
    else
#endif
 ...
 */
//-----------------------------------------------------------------------------
static BOOL _DMX_SetPidVideoType(UINT8 u1Pidx, DMX_VIDEO_TYPE_T eVideoType)
{
    UINT32 u4PidWord0, u4Val;
...
DMX_VIDEO_TYPE_T _DMX_GetPidxVideoType(UINT8 u1Pidx)
{
        ...
        prPidStruct->eInputType == DMX_IN_PLAYBACK_PS)
    {
        ...
        eVideoType = _DMX_GetVideoTypeByPidx(u1Pidx);
        if(eVideoType != DMX_VIDEO_NONE)
        {
            return eVideoType;
        }
    }
    ...
    eVideoType = _DMX_GeteVideoType(u1TsIdx);
...
BOOL _DMX_VCodeInit(void)
{
    ...
    x_memset((void*)DMX_PATTERN_MATCH_BASE0, 0, DMX_DMEM_PATTERN_MATCH_LEN * 4);
    x_memset((void*)DMX_PATTERN_MATCH_BASE1, 0, DMX_DMEM_PATTERN_MATCH_LEN * 4);
