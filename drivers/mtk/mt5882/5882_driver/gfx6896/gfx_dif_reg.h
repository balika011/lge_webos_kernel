...
#define GFX_FAST_BITBLIT_MIN_W     (0x10)
...
#define GFX_MMU_AGENT_MID5  5
#define GFX_MMU_AGENT_MID6  6
...
typedef struct _MI_DIF_FIELD_T
{
   ...
   // #if defined(CC_MT5399)||defined(CC_MT5880)||defined(CC_MT5881)
   ...
   // #endif
    ...
    UINT32 :1;
    UINT32 fg_STR_DST_HEIGHT :12;
    UINT32 :4;

    // DWORD - LEGAL_START_ADDR (4090h)
    UINT32 fg_LEGAL_START_ADDR :30;
    UINT32 :1;
    UINT32 fg_MEM_PROTECT_EN :1;

    // DWORD - LEGAL_END_ADDR   (4094h)
    UINT32 fg_LEGAL_END_ADDR :30;
    UINT32 :2;
...
typedef struct _MI_DIF_GFX_MMU_T0
{
    ...
    UINT32 :4;
    UINT32 fg_MMU_MON_PIN_SEL :3;
    UINT32 fg_MMU_MON_PIN_RD :1;
    UINT32 fg_MMU_MON_ENTRY_SEL :6;
    UINT32 fg_MMU_IOMMU_SAMPLE_HALT :1;
    UINT32 fg_MMU_IOMMU_SAMPLE_SEL :1;
    UINT32 fg_MMU_INT_HALT :1;
    UINT32 fg_MMU_INT_MASK :1;
    UINT32 :7;
    UINT32 fg_FIRE_SEL :1;
    UINT32 fg_SELF_FIRE_CLR :1;
    UINT32 fg_MMU_SELF_FIRE :1; //self fire trig
    
    UINT32 :32; //(68014h)
    UINT32 :32; //(68018h)
    UINT32 :32; //(6801ch)
    // DWORD - IO_MMU_CFG8      (68020h)
    UINT32 fg_MMU_MON_OTHER:32; //(68020h)
