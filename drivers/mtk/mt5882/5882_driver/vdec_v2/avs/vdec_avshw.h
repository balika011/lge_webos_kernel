...
//void _VDEC_AvsVLDHWReset(BOOL bIsInit); //no used in current flow, replaced by _VDEC_VLDAvsHWReset()
...
//void _VDEC_AVSAlign2Byte(UINT32* pu4BitCount); //no used in current flow

//BOOL _VDEC_AVSGetBitStreamFlg(void); //no used in current flow
