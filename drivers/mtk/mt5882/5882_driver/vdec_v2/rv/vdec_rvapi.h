...
//INT32 _VDEC_RVHdrPrsPic(UCHAR ucVdecId, UCHAR ucEsId); //no used in current flow
//INT32 _VDEC_RVHdrPrsNalu(UCHAR ucVdecId, UCHAR ucEsId); //no used in current flow
...
//void _VDEC_RVStartPTS(UCHAR ucEsId, BOOL fgEnCalPTS, UINT32 u4Pts, UINT32 u4PtsDiff); //no used in current flow
