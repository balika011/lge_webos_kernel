...
enum
{
    ...
    cOFST_DVBTC_SWITCH_STATUS = ccOFST_DMBTC_SWITCH,
    cOFST_DVBC_SWITCH_RSIZE 
};
...
enum
{
	...
	ccOFST_DTMB_GET_EARLY_BREAK_TIME_H,
	ccOFST_DTMB_GET_EARLY_BREAK_TIME_L,
...
enum
{
	...
	//ccOFST_DTMB_STATUS03,//ca state
	//ccOFST_DTMB_STATUS04,//breaktime h
	//ccOFST_DTMB_STATUS05,//breaktime l
...
#define ccCMD_ID_DTMBC_SWITCH      0x7F
enum
{
    ccOFST_DTMBC_SWITCH,
    ccOFST_DTMBC_SWITCH_SIZE,
    ccOFST_DTMBC_SWITCH_STATUS = ccOFST_DTMBC_SWITCH,
    ccOFST_DTMBC_SWITCH_RSIZE
};
...
#define ccCMD_ID_DTMB_NEWLDAGC       0xC1
enum
{
	ccOFST_DTMB_NEWLDAGC_BITSHIFT,
	ccOFST_DTMB_NEWLDAGC_GAINNORM,
	ccOFST_DTMB_NEWLDAGC_INPUTLEVEL,
	ccOFST_DTMB_NEWLDAGC_OUTPUTLEVEL,
	ccOFST_DTMB_NEWLDAGC_RSIZE
};

#define ccCMD_ID_DTMB_LDAGC_PMS       0xC2
enum
{//Confidence
	ccOFST_DTMB_LDAGC_PMS_DECISION,
	ccOFST_DTMB_LDAGC_PMS_CONFIDENCE,
	ccOFST_DTMB_LDAGC_PMS_RSIZE
};
#define ccCMD_ID_DTMB_SYNC_TIME       0xC3
enum
{
	ccOFST_DTMB_CA_TIMEH,
	ccOFST_DTMB_CA_TIMEL,
	ccOFST_DTMB_CR_TIMEH,
	ccOFST_DTMB_CR_TIMEL,
	ccOFST_DTMB_SYNC_TIME_RSIZE
};

#define ccCMD_ID_DTMB_LDAGC_LOCK_TIME	0xC4
enum
{
	ccOFST_DTMB_LDAGC_LOCK_TIME,
	ccOFST_DTMB_LDAGC_LOCK_TIME_RSIZE
};

#define ccCMD_ID_DTMB_NEW_DOPPLER1	0xC5
enum
{
	ccOFST_DTMB_NEW_DOP_PERIOD_ESTIMATE_CNT_DOWN,//0x3de
	ccOFST_DTMB_NEW_DOP_FREQUENCY,//0x381
	ccOFST_DTMB_NEW_DOP_PERIOD1,//0x3db
	ccOFST_DTMB_NEW_DOP_PERIOD2,//0x3dc
	ccOFST_DTMB_NEW_DOP_PERIOD3,//003dd
	ccOFST_DTMB_NEW_DOPPLER1_RSIZE
};

#define ccCMD_ID_DTMB_NEW_DOPPLER2	0xC6
enum
{
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF0_1,//0x3df
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF0_2,//0x3e0
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF0_3,//0x3e1
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF1_1,//0x3e2
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF1_2,//0x3e3
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF1_3,//0x3e4
	ccOFST_DTMB_NEW_DOPPLER2_RSIZE
};

#define ccCMD_ID_DTMB_NEW_DOPPLER3	0xC7
enum
{
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF2_1,//0x3e5
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF2_2,//0x3e6
	ccOFST_DTMB_NEW_DOP_MEAN_CURR_LEVEL_IN_DIFF2_3,//0x3e7
	ccOFST_DTMB_NEW_DOP_LARGE_DELAY_DIFF0_1,//0x3e8
	ccOFST_DTMB_NEW_DOP_LARGE_DELAY_DIFF0_2,//0x3e9
	//NEW_DOP_LARGE_DELAY_DIFF1
	ccOFST_DTMB_NEW_DOP_LARGE_DELAY_DIFF1_1,//0x3ea
	ccOFST_DTMB_NEW_DOP_LARGE_DELAY_DIFF1_2,//0x38f
	ccOFST_DTMB_NEW_DOPPLER3_RSIZE
};
#define ccCMD_ID_DTMB_SET_VAR 0xC8//0xCA
enum
{
	ccCMD_ID_DTMB_SET_VAR_ADDRH,
	ccCMD_ID_DTMB_SET_VAR_ADDRL,
	ccCMD_ID_DTMB_SET_VAR_VALUE,
	ccCMD_ID_DTMB_SET_VAR_RSIZE	
};

#define ccCMD_ID_DTMB_GET_VAR 0xC9
enum
{	
	ccCMD_ID_DTMB_GET_VAR_ADDRH,
	ccCMD_ID_DTMB_GET_VAR_ADDRL,
	ccCMD_ID_DTMB_GET_VAR_VALUE1,
	ccCMD_ID_DTMB_GET_VAR_VALUE2,
	ccCMD_ID_DTMB_GET_VAR_VALUE3,
	ccCMD_ID_DTMB_GET_VAR_VALUE4,
	ccCMD_ID_DTMB_GET_VAR_RSIZE
};
