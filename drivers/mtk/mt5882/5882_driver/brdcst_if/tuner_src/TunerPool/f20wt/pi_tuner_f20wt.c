...
STATIC ATD_3TapEQ_REL_REG_T arrAtd3TapEQBGRelReg[]=
{
    {0x176, 0x03},
    {0x177, 0xDA},
    {0x178, 0x02},
...
static ATD_TUNER_REL_REG_T arrAtdDeLayReg[]={
 {0x168,0x02},
 {0x169,0xc4},
 {0x00,0x00}//end flag
};  
...
// AGC para
    ...
    // init EQ script for mtk board
		...
		if(IS_IC_5860())
		{
			pF20wtEqNormal[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]  = EQF20wtBG_5860;
		    pF20wtEqNormal[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]  = EQF20wtDK_5860;
		    pF20wtEqNormal[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]   = EQF20wtI_5860;
		    pF20wtEqNormal[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN] = EQF20wtL_5860;
		    pF20wtEqNormal[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN] = EQF20wtL1_5860;
		    pF20wtEqNormal[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQF20wtM_5860;
		    pF20wtEqWeak[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]  = EQF20wtBG_5860;
		    pF20wtEqWeak[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]  = EQF20wtDK_5860;
		    pF20wtEqWeak[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]   = EQF20wtI_5860;
		    pF20wtEqWeak[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]  = EQF20wtM_5860;
		    pF20wtEqStrongChroma[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]  = EQF20wtBG_5860;
		}
		else
		{
...
INT16 F20WT_TunerOP(ITUNER_CTX_T * pTCtx, ITUNEROP_T eOperation, UINT8 SetVal,  VOID * pInOutVal){
    ...
    case itGet3TapEQRelReg://Get ATD 3Tap EQ Rel register setting
        {
            ...
            switch(subSysId)
            {
               ...
               case MOD_SECAM_L:
               case MOD_SECAM_L1:
                *(ATD_3TapEQ_REL_REG_T **)pInOutVal=arrAtd3TapEQBGRelReg;
                break;
               case MOD_NTSC_M:
    ...
    case itGetDelayLine:
        {
        *(ATD_TUNER_REL_REG_T **)pInOutVal=arrAtdDeLayReg;
        }
break;
