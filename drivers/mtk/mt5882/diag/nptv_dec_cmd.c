...
static INT32 _DecModeChange(INT32 i4Argc, const CHAR **szArgv);
...
CLI_EXEC_T arDecCmdTbl[] = {
  ...
  {"Query", "q", _bDrvDecQuery, NULL, "Query decoder information", CLI_GUEST},
  ...
  {"Decmchg", "dmc", _DecModeChange, NULL, "set decoder mode change", CLI_SUPERVISOR},
#endif
