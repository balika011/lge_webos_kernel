...
static BOOL _IsUseDigiAmpTAS5711(void)
{
    AUD_ADAC_USAGE_T* prAdacUsage;
    UNUSED(DRVCUST_OptQuery(eAudioDacUsage, (UINT32*)(void*)&prAdacUsage));
    ...
    if (prAdacUsage->eAudAmp1 == AUD_AMP_TAS5711)
    {
        return TRUE;
    }
    else
...
static void _LoadAmpTble(void)
{
    ...
    else if (_IsUseDigiAmpTAS5711())
    {
        _prAmpTbl = _AMP_GetAmpTAS5711FunTbl();
    }    
    ...
    {
#if defined(CC_MT5396) || defined(CC_MT5398) || defined(CC_MT5880) || defined(CC_MT5399) || defined(CC_MT5881) || defined(CC_MT5399)    // Add new IC define here
