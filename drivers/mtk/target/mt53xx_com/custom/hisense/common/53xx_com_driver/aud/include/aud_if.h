...
#define BASS_TREBLE_ATTN_GAIN_DB_MAX         (0*2+28) //-14dB ~0dB
...
typedef enum
{
    ...
    AUD_STREAM_FROM_LINE_IN_2,          ///< Line in2
#endif
...
#define AQ_VBASS_ITEMS 7
#define AQ_FIR_ITEMS 256
#define AQ_LOUDNESS_ITEMS 20
#ifdef CC_AUD_MTK_NEW_DRC
#define AQ_MTK_DRC_ITEMS 30
#else
#define AQ_MTK_DRC_ITEMS 22
#endif
#define AQ_STC381Coeff_ITEMS 75
...
typedef enum
{
    ...
    AUD_RAW_AC3_1,          //bsi test ac3 format 0x101
    AUD_RAW_AC3_2,          //bsi test ac3 format 0x201
    AUD_RAW_AC3_3,          //bsi test ac3 format 0x301
    AUD_RAW_AC3_4,          //bsi test ac3 format 0x401
    AUD_RAW_AC3_5,          //bsi test ac3 format 0x501
    AUD_RAW_AC3_6,          //bsi test ac3 format 0x601
    AUD_RAW_AC3_7,          //bsi test ac3 format 0x701
    AUD_RAW_NUM,
} AUD_RAW_FMT_T;
...
#define APROC_SIG_IDX_UPLOAD        APROC_SIG_IDX(0xC) //parson upload
#define APROC_SIG_IDX_SRC           APROC_SIG_IDX(0xD)
...
#define APROC_SIG_NOTIFY_INIT_AOUT2 APROC_SIG_CMD(0x5)  //pnsc_test:AOUT2 setting.
...
//
#define APROC_REGMAP_BASE 0x3b000

// all resgiters in word (4 bytes)
#define APROC_REGMAP_REGSIZE 4 // bytes

#define APROC_REGMAP_IO_ELEMENT_SIZE 8
#define APROC_REGMAP_IO_NUM 16
...
typedef enum
{
    ...
    */
    ...
    /* IO Input buffer, 0x100 ~ 0x200, 8 elements, total 32 buffers
    */
    // APROC_REG_IOBUF_IN = 0x100,
    APROC_REG_IOBUF_IN_START = 0x100,
    APROC_REG_IOBUF_IN_END,
    APROC_REG_IOBUF_IN_SIZE, // in bytes
    APROC_REG_IOBUF_IN_SI_BASE,

    // APROC_REG_IOBUF_OUTPUT = 0x108,
    APROC_REG_IOBUF_OUT_START = 0x108,
    APROC_REG_IOBUF_OUT_END,
    APROC_REG_IOBUF_OUT_SIZE, // in bytes
    APROC_REG_IOBUF_OUT_SI_BASE,

    /* Working register, 0x200 ~ 0x300
    */
    APROC_REG_POSTPROC_WORKING_VOL0 = 0x200,
    APROC_REG_POSTPROC_WORKING_VOL1,

    /* Setting register, 0x300 ~ 0x400
    */
    APROC_REG_POSTPROC_SETTING_VOL0 = 0x300,
    APROC_REG_POSTPROC_SETTING_VOL1,

    APROC_REGMAP_SIZE = 0x400
} _APROC_REGMAP_T;
...
*/
// Signal
#define APROC_A2M_SIG_REG APOLLO_RREG_AP2RC_EXTDATA0
#define APROC_A2M_DATA0_REG APOLLO_RREG_AP2RC_EXTDATA1
#define APROC_A2M_DATA1_REG APOLLO_RREG_AP2RC_EXTDATA2
#define APROC_A2M_READ_REG APOLLO_RREG_AP2RC_EXTDATA3
// Log
#define APROC_A2M_LOG_ADDR APOLLO_RREG_AP2RC_EXTDATA15
#define APROC_A2M_LOG_DATA0 APOLLO_RREG_AP2RC_EXTDATA14
#define APROC_A2M_LOG_DATA1 APOLLO_RREG_AP2RC_EXTDATA13
#define APROC_A2M_LOG_DATA2 APOLLO_RREG_AP2RC_EXTDATA12
#define APROC_A2M_LOG_DATA3 APOLLO_RREG_AP2RC_EXTDATA11
// Isr Log
#define APROC_A2M_ISR_LOG_ADDR APOLLO_RREG_AP2RC_EXTDATA10
#define APROC_A2M_ISR_LOG_DATA0 APOLLO_RREG_AP2RC_EXTDATA9
#define APROC_A2M_ISR_LOG_DATA1 APOLLO_RREG_AP2RC_EXTDATA8
#define APROC_A2M_ISR_LOG_DATA2 APOLLO_RREG_AP2RC_EXTDATA7
#define APROC_A2M_ISR_LOG_DATA3 APOLLO_RREG_AP2RC_EXTDATA6
/* Main to Audio signals
*/
#define APROC_M2A_SIG_REG APOLLO_RREG_RC2AP_EXTDATA0
#define APROC_M2A_DATA0_REG APOLLO_RREG_RC2AP_EXTDATA1
#define APROC_M2A_DATA1_REG APOLLO_RREG_RC2AP_EXTDATA2
...
#endif
#define APROC_DATAPORT_BASE 0xFA000 // hard code, fix me!!!!
#define APROC_REGMAP_BASE 0xFB000 // hard code, fix me!!!!
...
typedef enum {
    ...
    APROC_ASM_ID_NUM = 0x20    /*_to_extend_ 0x40*/
} APROC_ASM_ID_T;
...
typedef enum {
    ...
    APROC_REG_APTS_SRC1,
    APROC_REG_APTS_SRC2,
    APROC_REG_APTS_VALID_SRC0, // 9   //Valid
    APROC_REG_APTS_VALID_SRC1,
    APROC_REG_APTS_VALID_SRC2,
    ...
    APROC_REG_AVSYNC_NOTIFY_APTS_SRC0 = 0x18,
...
typedef enum {
    ...
    APROC_REG_MIXSND0_FLAG = 0x18,
    APROC_REG_MIXSND1_FLAG
} APROC_ASM_MIXSND0_T;

typedef enum {
    APROC_REG_IOBUF_UPLOAD_START = 0x0,   //parson upload
    APROC_REG_IOBUF_UPLOAD_END,
    APROC_REG_IOBUF_UPLOAD_SIZE,            // in bytes
    APROC_REG_IOBUF_UPLOAD_CH,
    APROC_REG_IOBUF_UPLOAD_ENABLE,
} APROC_ASM_CPU_T;
...
typedef enum {
    ...
    // AVC SP
    APROC_REG_AVC_SP_FLAG = 0x10,
    APROC_REG_AVC_SP_FC,

    // AVC HP
    APROC_REG_AVC_HP_FLAG = 0x18,
    APROC_REG_AVC_HP_FC,
...
typedef enum {
    ...
    // AVC HP band 0
    APROC_REG_AVC_HP_TARGET_0 = 0x10,
    ...
    // AVC HP band 1
    APROC_REG_AVC_HP_TARGET_1 = 0x18,
    APROC_REG_AVC_HP_ATTACK_1,
    APROC_REG_AVC_HP_RELEASE_1,
    APROC_REG_AVC_HP_RATIO_1,
    APROC_REG_AVC_HP_SILENCE_1,
    APROC_REG_AVC_HP_MAX_EXPAND_1,
    APROC_REG_AVC_HP_POST_GAIN_1,
    APROC_REG_AVC_HP_HOLD_1
...
typedef enum {
    ...
    // AVC HP band 0
    APROC_REG_BIQ_HP_AVC_0_TYPE_0 = 0x10,
    ...
    // AVC HP band 1
    APROC_REG_BIQ_HP_AVC_1_TYPE_0 = 0x18,
    APROC_REG_BIQ_HP_AVC_1_FC_0,
    APROC_REG_BIQ_HP_AVC_1_Q_0,
    APROC_REG_BIQ_HP_AVC_1_GAIN_0,
    APROC_REG_BIQ_HP_AVC_1_TYPE_1,
    APROC_REG_BIQ_HP_AVC_1_FC_1,
    APROC_REG_BIQ_HP_AVC_1_Q_1,
    APROC_REG_BIQ_HP_AVC_1_GAIN_1,
...
typedef enum {
    ...
    // PNSC VS
    APROC_REG_PNSCVS_FLAG = 0x10,
    APROC_REG_PNSCVS_CFG0,
    APROC_REG_PNSCVS_CFG1,
    APROC_REG_PNSCVS_COEF_BASE
...
#define APROC_DATAPORT_128FIR_BASE 0x0
#define APROC_DATAPORT_128FIR_SCALE_BASE (APROC_DATAPORT_128FIR_BASE+64)
#define APROC_DATAPORT_128FIR_SIZE 65

#define APROC_DATAPORT_DOWNMIX_TBL_BASE (APROC_DATAPORT_128FIR_BASE+APROC_DATAPORT_128FIR_SIZE)
 ...
 */
//-----------------------------------------------------------------------------
BOOL AUD_IsDSPRealPlay(UINT8 u1DecId);
 ...
 */
//-----------------------------------------------------------------------------
extern void AUD_SetCtrlType(UINT8 u1DecId, UINT32 u4MWSetCtrlType);
 ...
 */
//-----------------------------------------------------------------------------
extern void AUD_SetCtrlCmd(UINT8 u1DecId, AUD_DEC_CMD_T eMWSetCtrlCmd);
...
extern BOOL AUD_DrvGetMMAudioOnly(void);
extern BOOL AUD_GetMMAudioOnly(void);
...
extern void AUD_DspSetDelayEnable(UINT8 u1DecId, BOOL fgEnable);
...
extern void vAprocDec_Open (UINT32 u4DecId);
extern void vAprocDec_Close (UINT32 u4DecId);
...
extern BOOL AUD_IsMp3EncPlaying(void);
