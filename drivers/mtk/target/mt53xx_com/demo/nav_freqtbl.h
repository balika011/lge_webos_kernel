...
#ifndef NAV_FREQTBL_H
#define NAV_FREQTBL_H
...
#define DTMB_CH_NS 70//69 // DTMB
#define DVBC_CH_NS 71//69 // DVB-C
#define ISDBT_CH_NS 70 // for Brazil 0~69
#define PALBG_CH_NS 104
#define PALDK_CH_NS 100
#define PALI_CH_NS 102
#define SECAML_CH_NS 58
#define SECAML1_CH_NS 58
#define NTSCM_CH_NS 125

EXTERN UINT32 au4DVBTTWChannel[DVBTTW_CH_NS];
EXTERN UINT32 au4DVBTUKChannel[DVBTUK_CH_NS];
EXTERN UINT32 au4DVBCChannel[DVBC_CH_NS];
EXTERN UINT32 au4PalBGChannel[PALBG_CH_NS];
EXTERN UINT32 au4PalDKChannel[PALDK_CH_NS];
EXTERN UINT32 au4PalIChannel[PALI_CH_NS];
EXTERN UINT32 au4SECAMLChannel[SECAML_CH_NS];
EXTERN UINT32 au4SECAML1Channel[SECAML1_CH_NS];
EXTERN UINT32 au4NTSCMChannel[NTSCM_CH_NS];
EXTERN DRV_TUNER_DATA_T rDVBCTunerData[DVBC_CH_NS];
#ifdef DRV_IF_BR
EXTERN UINT32 au4ISDBTChannel[ISDBT_CH_NS];
#endif
#endif
