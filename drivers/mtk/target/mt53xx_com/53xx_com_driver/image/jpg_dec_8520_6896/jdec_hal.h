...
#include "jdec_com_common.h"
    ...
    #define CC_MT5363
    #define JPG_PROGRASSIVE_V4
    #define JDEC_QTABLE_RISC_MODE_2
    //#define JPG_PROGRASSIVE_VFY_FRAME_CKSUM
    #endif
...
#define RW_VLD_JPG_WINTF_CHKSUM           0x238
...
extern void vHwJdecUpdateWptr(UINT32 u4HwId, UINT32 w_ptr_value);
...
extern UINT32 VLDJPG_ReadErrorType_Prog(UINT32 u4HwId);
extern UINT32 VLDJPG_ReadCKsum_Prog(UINT32 u4HwId);
extern UINT32 VLDJPG_ReadRP(UINT32 u4HwId);
extern UINT32 VLDJPG_ReadWP(UINT32 u4HwId);
#endif
