...
#define PNG_DEC_ENABLE_REG                  0x04
    #define PNG_REG_ENABLE              (0x1<<0)
    #define PNG_REG_MMU_EN              (0x1<<1)
    #define PNG_REG_RANDOM_RESET        (0x1<<2)
    #define PNG_REG_PITCH_EN            (0x1<<3)
...
#define PNG_DEC_DLA_STATE                   0xF8
       #define PNG_REG_CAN_RESET             (0x1<<12)
