...
#define x_alloc_aligned_ch2_mem(size,align) VIRTUAL(BSP_AllocAlignedDmaMemory(size,align))
#define x_alloc_aligned_mem(size,align) VIRTUAL(BSP_AllocAlignedDmaMemory(size,align))
#define x_free_aligned_mem(addr) BSP_FreeAlignedDmaMemory(PHYSICAL(addr))
#define x_alloc_vmem(a)  vmalloc((unsigned long)(a)) //IOMMU_get_fragment_vmem //
#define x_free_vmem(a)  vfree((const void*)a)
#define x_mem_vfree(a)  vfree((const void*)a)
#define x_mem_valloc(a) IOMMU_get_fragment_vmem// vmalloc((unsigned long)(a))
#define FILE VOID 
