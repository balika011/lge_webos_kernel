...
#ifndef _B2R_REG_V1_H_
#define _B2R_REG_V1_H_
...
#define B2R_MODE_CTRL (0x002C)
    ...
    #define ADDR_MODE Fld(2,24,AC_MSKB3)//[25:24]
...
#define B2R_TRACKING (0x0058)
    #define TRACK_INIT_LINE Fld(12,16,AC_MSKW32)//[27:16]
    #define TRACK_MANUAL_MBL Fld(8,8,AC_FULLB1)//[15:8]
    #define TRACK_MANUAL_MBL_EN Fld(1,7,AC_MSKB0)//[7:7]
    #define TRACK_TNB_SW_INIT Fld(1,2,AC_MSKB0)//[2:2]
    #define TRACK_NO_FINISH Fld(1,1,AC_MSKB0)//[1:1]
    #define TRACK_EN Fld(1,0,AC_MSKB0)//[0:0]
...
#define BYPASS_COLOR_TRANSFORM (0x0068)
    #define B2R_CT_EN Fld(1,31,AC_MSKB3)//[31:31]
    #define B2R_CT_BYPASS Fld(1,30,AC_MSKB3)//[30:30]
...
#define B2R_MISC (0x0300)
    ...
    #define HD_Y_RR_TYPE Fld(1,9,AC_MSKB1)//[9:9]
    #define HD_Y_RR_EN Fld(1,8,AC_MSKB1)//[8:8]
