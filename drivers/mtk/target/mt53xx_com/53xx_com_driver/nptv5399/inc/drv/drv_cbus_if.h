...
#define Get_CBUS_PIN_FUNCTION()      (0)
#else
...
#define Get_CBUS_PIN_FUNCTION()   (BSP_PinGet(FLD_HDMI_2_HPD_CBUS))
#endif
...
extern void vCbusSetState(UINT8 ui1_state);
extern void vGetCbusSatus(void);
extern void vCbusStatusQuery(void);
#ifdef SYS_MHL_SUPPORT
#define MHL_TX_NEXT_GROUP 0
#define MHL_TX_CUR_GROUP 1
extern void vCbusWriteBurstRequest(void);
