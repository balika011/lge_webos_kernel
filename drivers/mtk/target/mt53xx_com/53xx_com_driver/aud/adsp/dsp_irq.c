...
UINT32 u4DspIRQSvc (void)
{
    ...
    case INT_DSP_DETECTOR_DEC2_NOTIFY:
        _rDspStatus[AUD_DEC_AUX].fgDspDetected = TRUE;		
        u4Msg = wReadDspWORD(ADDR_DETECTED_TYPE);
        u4Msg = u4Msg<<16;
        u4Msg = u4Msg|ADSPTASK_MSG_INT_DETECTOR_DEC2_NOTIFY;
	  break;
    case INT_DSP_DETECTOR_DEC3_NOTIFY:
        _rDspStatus[AUD_DEC_THIRD].fgDspDetected = TRUE;		
        u4Msg = wReadDspWORD(ADDR_DETECTED_TYPE);
        u4Msg = u4Msg<<16;
...
void vDspIntSvc_Data (void)     //ADSP Data Queue.
{
    ...
    case INT_D2RC_VORBIS_CODEBOOK:
        ...
        if((_rDspVars[AUD_DEC_MAIN].bDspStrTyp == VORBIS_STREAM)||(_rDspVars[AUD_DEC_AUX].bDspStrTyp == VORBIS_STREAM)||(_rDspVars[AUD_DEC_THIRD].bDspStrTyp == VORBIS_STREAM)) 
        {
    ...
    case INT_D2RC_LOG_DUMP:
        ...
        case LOG_STC_DIFF:
            ...
            {                   
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_STC_HIGH);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_STC_LOW);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_CURRENT_STC_HIGH);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_CURRENT_STC_LOW);
                
                pts = dReadDspCommDram32(ADDR_D2RC_DRAM_STC_HIGH) | (dReadDspCommDram32(ADDR_D2RC_DRAM_STC_LOW) >> 16);
                stc = (dReadDspCommDram32(ADDR_D2RC_DRAM_CURRENT_STC_HIGH) << 24) | dReadDspCommDram(ADDR_D2RC_DRAM_CURRENT_STC_LOW);
        ...
        case LOG_STC_DIFF_DEC2:
            ...
            {                   
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_STC_HIGH_DEC2);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_STC_LOW_DEC2);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_CURRENT_STC_HIGH_DEC2);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_CURRENT_STC_LOW_DEC2);
                
                pts = dReadDspCommDram32(ADDR_D2RC_DRAM_STC_HIGH_DEC2) | (dReadDspCommDram32(ADDR_D2RC_DRAM_STC_LOW_DEC2) >> 16);
                stc = (dReadDspCommDram32(ADDR_D2RC_DRAM_CURRENT_STC_HIGH_DEC2) << 24) | dReadDspCommDram(ADDR_D2RC_DRAM_CURRENT_STC_LOW_DEC2);
        ...
        case LOG_STC_DIFF_DEC3:
            ...
            {                
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_STC_HIGH_DEC3);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_STC_LOW_DEC3);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_CURRENT_STC_HIGH_DEC3);
                DSP_FlushInvalidateDCacheSmall2(ADDR_D2RC_DRAM_CURRENT_STC_LOW_DEC3);
                pts = dReadDspCommDram32(ADDR_D2RC_DRAM_STC_HIGH_DEC3) | (dReadDspCommDram32(ADDR_D2RC_DRAM_STC_LOW_DEC3) >> 16);
                stc = (dReadDspCommDram32(ADDR_D2RC_DRAM_CURRENT_STC_HIGH_DEC3) << 24) | dReadDspCommDram(ADDR_D2RC_DRAM_CURRENT_STC_LOW_DEC3);
