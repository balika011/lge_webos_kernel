...
//PROG1
#define DSP_ROM_SZ                    (0x1000*2)  // 8K for mt5365
#define DSP_CMMA_RAM_SZ        (0x1800*2)  // 12k
#define DSP_CTR_RAM_SZ            (0x0800*2)  // 4k
#define DSP_CMMAEXT_RAM_SZ  (0x1000*2)  // 8k
#define DSP_DEC3_RAM_SZ         (0x4000*2)  // 32K
#define DSP_DEC1_RAM_SZ         (0x4000*2)  // 32K
#define DSP_DEC2_RAM_SZ         (0x4000*2)  // 32K
//PROG2
#define DSP_POS_RAM_SZ          (0x3000*2)  // 24K
#define DSP_CMMB_RAM_SZ       (0x3800*2)  // 28k
#define DSP_RESER_RAM_SZ       (0x2800*2)  // 20k
#define DSP_DEC4_RAM_SZ         (0x3000*2)  // 24K
#define DSP_ENC2_RAM_SZ         (0x3000*2)  // 24K

#define DSP_ROM_PG_OFST             (0)
#define DSP_CMMA_PG_OFST          (DSP_ROM_PG_OFST + (DSP_ROM_SZ/2))
#define DSP_CTR_PG_OFST             (DSP_CMMA_PG_OFST + (DSP_CMMA_RAM_SZ/2))
#define DSP_CMMAEXT_PG_OFST    (DSP_CTR_PG_OFST + (DSP_CTR_RAM_SZ/2))
#define DSP_DEC3_PG_OFST           (DSP_CMMAEXT_PG_OFST + (DSP_CMMAEXT_RAM_SZ/2))
#define DSP_DEC1_PG_OFST           (DSP_DEC3_PG_OFST + (DSP_DEC3_RAM_SZ/2))
#define DSP_DEC2_PG_OFST           (DSP_DEC1_PG_OFST + (DSP_DEC1_RAM_SZ/2))
#define DSP_ROM2_PG_OFST           (DSP_DEC2_PG_OFST +(DSP_DEC2_RAM_SZ/2))

#define DSP_CODE_SZ             (DSP_ROM_SZ*2 + DSP_CMMA_RAM_SZ +  DSP_CTR_RAM_SZ + DSP_CMMAEXT_RAM_SZ + DSP_DEC3_RAM_SZ + DSP_DEC1_RAM_SZ + DSP_DEC2_RAM_SZ + DSP_POS_RAM_SZ + DSP_CMMB_RAM_SZ + DSP_RESER_RAM_SZ + DSP_DEC4_RAM_SZ + DSP_ENC2_RAM_SZ)
#endif  //dual decode

// Data Size
// For 2ch output, max size of DEC1 is 145K bytes (MPEG) (no AAC and WMA)
// 0x18000*4: for PCM delay
#define DSP_DAT_DEC1_SZ         (0x12A00*4+0x18000*4+0x76000) // 195 Kbytes, E-AC-3 decoder with converter
#define DSP_DAT_DEC2_SZ         (0x12A00*4)         // 195 Kbytes, E-AC-3 decoder with converter
#define DSP_DAT_DEC3_SZ         (0x12A00*4)       // 144 Kbytes, by gallen, for decoder 3
#define DSP_DAT_CMM_NORMAL_SZ   (0x8000*4)          // Normal common DRAM
#if defined(CC_AUD_DSP_CHINA_MODEL) || defined(CC_AUD_DSP_US_MODEL)
//#define DSP_DAT_CMM_SZ          (0x42800*4+0x19000)
#define DSP_DAT_CMM_SZ          (0x1A9000)
#else
#ifdef CC_AUD_DDI
#define DSP_DAT_CMM_SZ          (0x74000*4+0x19000+0x4000)
#else
#define DSP_DAT_CMM_SZ          (0x74000*4+0x19000)
#endif
#endif

#define DSP_DAT_DEC4_SZ         (0x2100*4)         // 33 Kbytes, for decoder 4
...
#define DSP_SHARED_INFO_SZ      (64*32*2) // 4K
...
//Instruction cache start address
#define DSP_AREA_IC_0_SA        (DSP_SHARED_INFO_SA+DSP_SHARED_INFO_SZ) //ROM
#define DSP_AREA_IC_1_SA        (DSP_AREA_IC_0_SA + DSP_ROM_SZ)         //CommA
#define DSP_AREA_IC_2_SA        (DSP_AREA_IC_1_SA + DSP_CMMA_RAM_SZ)     //CRITICAL
#define DSP_AREA_IC_3_SA        (DSP_AREA_IC_2_SA + DSP_CTR_RAM_SZ)     //reservedA
#define DSP_AREA_IC_4_SA        (DSP_AREA_IC_3_SA + DSP_CMMAEXT_RAM_SZ)     //DEC3
#define DSP_AREA_IC_5_SA        (DSP_AREA_IC_4_SA + DSP_DEC3_RAM_SZ)    //DEC1
#define DSP_AREA_IC_6_SA        (DSP_AREA_IC_5_SA + DSP_DEC1_RAM_SZ)    //DEC2

#define DSP_AREA_IC2_0_SA        (DSP_AREA_IC_6_SA+ DSP_DEC2_RAM_SZ) //ROM
#define DSP_AREA_IC2_1_SA        (DSP_AREA_IC2_0_SA + DSP_ROM_SZ)         //Post
#define DSP_AREA_IC2_2_SA        (DSP_AREA_IC2_1_SA + DSP_POS_RAM_SZ)     //CommB
#define DSP_AREA_IC2_3_SA        (DSP_AREA_IC2_2_SA + DSP_CMMB_RAM_SZ)     //reserved
#define DSP_AREA_IC2_4_SA        (DSP_AREA_IC2_3_SA + DSP_RESER_RAM_SZ)    //ENC1
#define DSP_AREA_IC2_5_SA        (DSP_AREA_IC2_4_SA + DSP_DEC4_RAM_SZ)    //ENC2
#endif  //dual decode
#if defined(CC_MT5398)
// Audio processor working space
#define DSP_APROC_SA             (DSP_AREA_IC_0_SA+DSP_CODE_SZ)
#define DSP_APROC_SZ             (0x40000) // 256k
#else
#define DSP_APROC_SA             (DSP_AREA_IC_0_SA+DSP_CODE_SZ)
#define DSP_APROC_SZ             (0x0)
#endif


#ifdef CC_AUD_APOLLO_SUPPORT
// Audio processor working space
#define DSP_APROC_CODE_SA             (DSP_APROC_SA+DSP_APROC_SZ) //fixed me!!
#define DSP_APROC_CODE_SZ             (0x100000) // 1M Bytes

#define DSP_APROC_DATA_SA             (DSP_APROC_CODE_SA+DSP_APROC_CODE_SZ)
#define DSP_APROC_DATA_SZ             (0x100000) // 1M Bytes

#define DSP_APROC_ALIGNBUF_SA         (DSP_APROC_DATA_SA+DSP_APROC_DATA_SZ)
//#define DSP_APROC_ALIGNBUF_SZ         (AUD_APROC_ALIGN_BYTE) //4k Bytes
#define DSP_APROC_ALIGNBUF_SZ         (0x1000) //4k Bytes

//Data area start address
#define DSP_DATA_AREA           (DSP_APROC_ALIGNBUF_SA + DSP_APROC_ALIGNBUF_SZ)
#else
//Data area start address
...
#else
#ifdef CC_AUD_DDI
#define DSP_AFIFO_SZ_DEC2       (288*1024)
#else
...
#else
#ifdef CC_AUD_DDI
#define DSP_AFIFO_SZ_DEC3       (288*1024)
#else
...
#else
#define DSP_AFIFO_SZ_DEC4       (8*1024)
#endif
...
#else
#define DSP_MIXSNDBUF_SZ2       (24*1024)   //for mixsnd clip (1+2(alsa))
#define DSP_MIXSNDBUF_TMP_SZ2   (8*1024)    //for mixsnd clip SRC buffer
#define DSP_MIXSNDBUF_SZ3       (128*1024)   //for ALSA share memory
#endif
#else
...
#if 0
// Audio processor working space
#define DSP_APROC_CODE_SA             (DSP_MIXSNDBUF_SA+DSP_MIXSNDBUF_ALL_SZ) //fixed me!!
#define DSP_APROC_CODE_SZ             (0x100000) // 1M Bytes
