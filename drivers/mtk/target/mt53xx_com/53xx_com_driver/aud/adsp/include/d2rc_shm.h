...
#define ADDR_D2RC_UPLOAD_WRITE_PTR              (ADDR_D2RC_BASIC_INFO_BASE + 0x000F)
...
#endif
//DTS
#define ADDR_D2RC_DTS_DOWNMIX_FLAG             (ADDR_D2RC_DECODING_INFO_BASE+8)//lenovo 3db,bit[4] 1: embedded loro dwmcoef
// MPEG
