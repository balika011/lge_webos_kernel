...
extern UINT32 u4GetDspImgAddr_new(UINT32 u4Type);
...
extern BOOL Dsp_WaitResume(UINT8 u1DecId); 
...
extern INT32 DSP_ResetPts(UINT8 u1DecId);
...
extern UINT32 u4ReadD2RInfo_PtsCurPnt(UINT8 u1DecId);
extern UINT32 u4ReadD2RInfo_TotalBank(UINT8 u1DecId);
#endif
...
#endif
#ifdef CC_AUD_APOLLO_SUPPORT
extern void vApolloMemInit (UINT8* puWorkingBuffer);
extern UINT32 u4AudApolloLoadCode (UINT32 u4Base, UINT32 u4TblAddr, UINT32 u4Size);
#endif
...
extern void vLogDSPIntHistory(UINT32 u4Addr, UINT32 u4ShortD, UINT32 u4LongD, BOOL fgwait);
