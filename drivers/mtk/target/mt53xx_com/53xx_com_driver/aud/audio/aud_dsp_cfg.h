...
#ifdef CC_AUD_DDI
extern void _AUD_DspSetDelayEnable(UINT8 u1DecId, BOOL fgEnable);
#endif
...
//paul_flac
extern void _Aud_DspFLACHeader(UINT8 u1DecId, AUD_FLAC_INFO_T * prFlacInfo);
...
extern void _AUD_DspHEAACLvlChlVolGain(UINT8 u1Level);
#endif
#ifdef CC_VOCAL_MUTE
