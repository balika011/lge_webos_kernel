...
//-----------------------------------------------------------------------------
/** AUD_ApolloClkSel
 *  Apollo Clk cource selection
 *
 *  @param  u1ADSPclkSel
    APOLLO_CK_SEL	apollo_ck clock source selection
    
    //5399
    0: xtal_d1_ck
    1: sawlesspll_d1_ck
    2: usbpll_d1p5_ck
    3: syspll_d2_ck       ==> 324MHz (default setting)
    4: enetpll_d1p5_ck  
    5: cpupll_d2_ck
    6: cpupll_d2p5_ck
    7: xdds_in_ck
 ...
 */
//-----------------------------------------------------------------------------
void AUD_ApolloClkSel(UINT8 u1ApolloClkSel)
{
    vIO32WriteFldAlign(CKGEN_APOLLO_CKCFG, (UINT32)u1ApolloClkSel, FLD_APOLLO_CK_SEL);
}
#endif
