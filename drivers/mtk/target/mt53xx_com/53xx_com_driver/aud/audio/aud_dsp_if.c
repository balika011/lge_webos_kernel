...
#ifdef CC_AUD_DDI
void AUD_DspSetDelayEnable(UINT8 u1DecId, BOOL fgEnable)
{
    _AUD_DspSetDelayEnable(u1DecId, fgEnable);
}
#endif
...
/***************************************************************************
  ...
  Return    : None
***************************************************************************/
void AUD_DrvHEAACLevelAdjust (UINT8 u1Level)
{
    _AUD_DspHEAACLvlChlVolGain(u1Level);
}
#endif
