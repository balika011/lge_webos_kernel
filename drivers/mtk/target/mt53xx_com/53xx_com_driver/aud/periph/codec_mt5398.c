...
void _MT5398_XYRamTest(BOOL xy)
{
    ...
    else if (xy == 1)
    {
...
#if defined (CC_MT5881) || defined(CC_MT5399)
            vWritePWMG1(A_PCADDR, YRAM_10X[i]);
#else
...
#if defined (CC_MT5881) || defined(CC_MT5399)
            vWritePWMG2(A_PCADDR, YRAM_10X[i]);
#else
...
#if defined (CC_MT5881) || defined(CC_MT5399)
            vWritePWMG3(A_PCADDR, YRAM_10X[i]);
#else
        ...
        for (i = 0; i <= 0xD6; i++)
        {
            ...
            vWritePWMG4(A_PCADDR, YRAM_5X[i]);
            data = u4ReadPWMG4(A_PCADDR);
            Printf("yram %d=", i);
            Printf("0x%x,  ", data);
            if ((i + 1) % 4 == 0)
            {
...
static void _MT5398_Init_all(UINT8 u1ClkFmt, BOOL fgInit)
{
...
#elif defined (CC_MT5881) || defined (CC_MT5399)
    ...
    // default 48k
    {
#if defined (CC_MT5881) || defined (CC_MT5399)    ///Remy without internal ldo.
