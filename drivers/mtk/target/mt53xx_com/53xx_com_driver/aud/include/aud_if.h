...
// for amp hot boot no sound issue
#define DIGITAL_I2S_AMP_REINIT         
#endif
...
typedef enum
{
    ...
    AUD_CH_NUM,
    AUD_CH_IEC_LEFT,
		AUD_CH_IEC_RIGHT      //add IEC channel
}   AUD_CH_T;
...
typedef enum
{
    ...
    AUD_FACTORY_HDEV_REDUCE            /* HDEV level reduction on/off  */          
...
typedef enum{
    ...
    //E_CUST_AUD_SYS_SETTING_CHANGE,
    //E_CUST_AUD_MUTE_STATE_CHANGE,
    E_CUST_AUD_OUT_MUTE_STATE_CHANGE,    //No need to support because MTK's output mute is disabled when 4K model.
...
extern void AUD_HEAACLevelAdjust (UINT8 u1Level);
extern void AUD_DrvHEAACLevelAdjust (UINT8 u1Level);
#endif
...
#ifdef CC_AUD_LINE_IN3
extern void AUD_Line3Input_Enable(BOOL fgEnable);
#endif
