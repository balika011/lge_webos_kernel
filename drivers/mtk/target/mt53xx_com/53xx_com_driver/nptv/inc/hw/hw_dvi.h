...
#define DVI_00 (IO_VIRT_DVI+(IO_DVI_BASE+0x7c0))
  ...
  #define DVI_00_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7c3))
		#define DVI_AV_START_12 Fld(1, 31, AC_MSKB3)//31
    ...
    #define DVI_VS_SEL Fld(1, 24, AC_MSKB3) //24
	#define DVI_AV_START11_0 Fld(12, 12, AC_MSKW21) //23:12
...
#define DVI_01 (IO_VIRT_DVI+(IO_DVI_BASE+0x7c4))
  ...
  #define DVI_01_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7c7))
    ...
    #define DVI_DE_MODE_V Fld(4, 24, AC_MSKB3) //27:24
    	#define DVI_DE_VHS_END Fld(1, 23, AC_MSKB2) //23
	#define DVI_VDE_START10_0 Fld(11, 12, AC_MSKW21) //22:12
		#define DVI_HDELEN_SEL Fld(1, 11, AC_MSKB1)//11
    #define DVI_VDE_WIDTH Fld(11, 0, AC_MSKW10) //10:0
...
#define CCIR_01 (IO_VIRT_DVI+(IO_DVI_BASE+0x7e8))
  ...
  #define CCIR_01_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7eb))
    ...
    #define CCH_FLD_VPOS Fld(1, 30, AC_MSKB3) //30
		...
		#define DVI_HMID_SEL Fld(1, 28, AC_MSKB3)//28
		#define DVI_OVF_DET Fld(1, 27, AC_MSKB3)//27
		#define CCH_OVF_DET Fld(1, 26, AC_MSKB3)//26
		#define CCH_HMID_SEL Fld(1, 25, AC_MSKB3)//25
		#define CCH_AV_START_12 Fld(1, 24, AC_MSKB3)//24
		#define CCH_VHS_END Fld(1, 23, AC_MSKB2)//23
		#define CCH_VS_START Fld(11, 12, AC_MSKW21)//22:12
    #define CCH_AV_START Fld(12, 0, AC_MSKW10) //11:0
...
#define DVI_HDTV_01 (IO_VIRT_DVI+(IO_DVI_BASE+0x204))
  ...
  #define DVI_HDTV_01_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x207))
		...
		#define STA_DVI_HTOTAL_12 Fld(1, 29, AC_MSKB3)//29
		#define STA_DVI_VPOS_H Fld(1, 28, AC_MSKB3)//28
    #define STA_DVI_DE_STABLE Fld(1, 27, AC_MSKB3) //27
    #define STA_DVI_FLD Fld(1, 26, AC_MSKB3) //26
    #define STA_DVI_FLD_COMP Fld(1, 25, AC_MSKB3) //25
    #define STA_DVI_DE_ACT Fld(1, 24, AC_MSKB3) //24
	#define STA_DVI_HDELEN_11_0 Fld(12, 12, AC_MSKW21) //23:12
    #define STA_DVI_HTOTAL Fld(12, 0, AC_MSKW10) //11:0
#define DVI_HDTV_02 (IO_VIRT_DVI+(IO_DVI_BASE+0x208))
  ...
  #define DVI_HDTV_02_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x20b))
		#define STA_DVI_INT_DE Fld(1, 23, AC_MSKB2)//23
 	#define STA_DVI_VSLEN_10_0 Fld(11, 12, AC_MSKW21) //22:12
		#define STA_DVI_VPOS_V Fld(1, 11, AC_MSKB1)//11
    #define STA_DVI_VTOTAL Fld(11, 0, AC_MSKW10) //10:0
#define DVI_HDTV_03 (IO_VIRT_DVI+(IO_DVI_BASE+0x20C))
	...
	#define DVI_HDTV_03_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x20F))
		...
		#define STA_CCH_HTOTAL Fld(13, 7, AC_MSKDW)//19:7
#define DVI_HDTV_04 (IO_VIRT_DVI+(IO_DVI_BASE+0x210))
	...
	#define DVI_HDTV_04_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x213))
		#define MAIN_DATA_SYNC_OVF Fld(1, 31, AC_MSKB3)//31
		#define PIP_DATA_SYNC_OVF Fld(1, 30, AC_MSKB3)//30
		#define MAIN_MUTE Fld(1, 29, AC_MSKB3)//29
		#define PIP2MDDI_MUTE Fld(1, 28, AC_MSKB3)//28
		#define HDMI_VOUT_MUTE Fld(1, 27, AC_MSKB3)//27
		#define STA_CCH_INT_DE Fld(1, 23, AC_MSKB2)//23
		#define STA_CCH_VSLEN Fld(11, 12, AC_MSKW21)//22:12
		#define STA_CCH_VTOTAL Fld(11, 0, AC_MSKW10)//10:0
