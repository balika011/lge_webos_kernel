...
enum {
    ...
    SOURCE_TYPE_TIMING_CVBS_NTSC_358        = 0x10,
    ...
    SOURCE_TYPE_TIMING_CVBS_NTSC_358_OS     = 0x20,
    ...
    SOURCE_TYPE_TIMING_SECAM_RFTV           = 0x30,
    SOURCE_TYPE_TIMING_SECAM_CVBS,
    SOURCE_TYPE_TIMING_SECAM_SV,

    SOURCE_TYPE_TIMING_SCART_RGB            = 0x40,
    ...
    SOURCE_TYPE_TIMING_YPBPR_SD_I_50        = 0x50,
    ...
    SOURCE_TYPE_TIMING_YPBPR_720P_24        = 0x60,
    ...
    SOURCE_TYPE_TIMING_DIGI_SD_I_50         = 0x70,
    ...
    SOURCE_TYPE_TIMING_DTV_SD_I_50          = 0x80,
    ...
    SOURCE_TYPE_TIMING_MM_1080IP, 

    SOURCE_TYPE_TIMING_PC_RGB               = 0xA0,
    SOURCE_TYPE_TIMING_DIGI_PC,
    SOURCE_TYPE_TIMING_PC_YCBCR,

    SOURCE_TYPE_TIMING_PHOTO_COMP               = 0xB0,
    SOURCE_TYPE_TIMING_PHOTO_DIGI,
   
    SOURCE_TYPE_TIMING_MAX                  = 0xFF
};
#else
enum {
