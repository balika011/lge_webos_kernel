...
#define VDP_MSG_BIT_RATE_CHG_CB     14
//-----------------------------------------------------------------------------
// Inter-file functions
//-----------------------------------------------------------------------------

EXTERN void _VDP_VsyncInit(void);
EXTERN void _VDP_VsyncReset(UCHAR ucB2rId);
EXTERN void _VDP_VsyncOnOff(UCHAR ucB2rId, UINT32 u4OnOff);
EXTERN void _VDP_VsyncSendCmd(UCHAR ucB2rId, UCHAR ucCmdId);
EXTERN void _VDP_VsyncNotify(UINT32 u4Type, UINT32 u4Arg1, UINT32 u4Arg2, UINT32 u4Arg3);
EXTERN void _VDP_VsyncTick(UCHAR ucB2rId, UINT32 u4Bottom, UINT32 u4RightView,UINT32 u4IsrType);

EXTERN void _VDP_FrcSetPtsCb(UCHAR ucB2rId, UCHAR ucPort, UINT32 u4CbPts, UINT32 u4CbArg);
