...
#if defined(CC_MT5395) || defined(CC_MT5399) ||defined(CC_MT5398)||defined(CC_MT5890)
...
#elif defined(CC_SUPPORT_TV_STAGEFRIGHT)  // liuqu add for distinguish,20121206
...
#elif  defined(CC_MT5399)|| defined(CC_MT5880)|| defined(CC_MT5860) ||defined(CC_MT5890)
...
#if  defined(CC_MT5399) || defined(CC_MT5398)|| defined(CC_MT5881)||defined(CC_MT5890)
typedef enum {
    FLIP_NONE =0,
    FLIP_BY_SCALER = 0x1,
    FLIP_BY_PSCAN  = 0x2,
