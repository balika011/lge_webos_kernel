...
static VOID  _FbmConfigurePool_MT5881_SCPOS_MAIN(POOL_LIST_T* prPoolList, POOL_ARRANGE_INFO_T* prPoolArrangeInfo)
{
   ...
   if(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
    {
        ...
        #else
        prPoolList[FBM_POOL_TYPE_DMX].u4PoolSize = FBM_ALIGN_MASK((FBM_DMX_H264_SIZE+FBM_PCR_DMX_ADD_SIZE), FBM_DMX_SIZE_ALIGMENT); // new spec, video need to queue 6.24M
		#endif
		#else
    	prPoolList[FBM_POOL_TYPE_DMX].u4PoolSize = FBM_ALIGN_MASK((FBM_DMX_H264_SIZE), FBM_DMX_SIZE_ALIGMENT);
    	#endif	
    ...
    prPoolList[FBM_POOL_TYPE_DMX].u4PoolSize = prPoolList[FBM_POOL_TYPE_DMX].u4PoolSize * 2;
		...
		prPoolArrangeInfo[FBM_POOL_TYPE_EDB].ePool1 = FBM_POOL_TYPE_DMX;
#endif
...
#if defined(CC_EDB_FBM_SHARE_MEM)
		prPoolArrangeInfo[FBM_POOL_TYPE_MPEG].ePool1 = FBM_POOL_TYPE_EDB;
#else
    ...
    if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
    {
        ...
        #ifdef __MODEL_slt__
        prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x1a80000;//1080i MM 0xa00000
        #else
		prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0xB90000;//1080i MM 0xB10000 //0xb90000 for Jpeg can include fbm pool
		#endif
    }
	else if ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_64Mx1)||
		    (SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_SA_64Mx1))
    {
        //prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x1500000;
        prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x540000;//1080i MM 0xa00000
    }
  ...
  if(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
  	{
    #if defined(CC_TVE_FEEDER_NO_SHARE_BUFFER)  	
    // TVE
    ...
    prPoolArrangeInfo[FBM_POOL_TYPE_JPEG_OSD1].ePool1 = FBM_POOL_TYPE_FEEDER;
...
static VOID _FbmConfigurePool_MT5399_MJC_SCPOS_MAIN(POOL_LIST_T* prPoolList, POOL_ARRANGE_INFO_T* prPoolArrangeInfo)
{
    FBM_POOL_TYPE_T u4AheadType = FBM_POOL_TYPE_SCPOS_MAIN, u4BehindType, u4VdoBehindType = FBM_POOL_TYPE_NS;
    UNUSED(u4AheadType);
    UNUSED(u4BehindType);
    ...
    //----- DMX-----
    prPoolList[FBM_POOL_TYPE_DMX].u4Inherit = FBM_POOL_ROOT;
    if ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV_NOSUB)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_2DTV)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_2DTV_NOSUB)
    ...
    if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV)
    {
        prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x2700000; //main 1080i 422 0xe9c0000*2+sub 0x880000
    }
	else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV_NOSUB)
    {
        prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x2180000;//main 1080i 422 0xe9c0000*2+sub 0x300000
    }
	else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_2DTV)
    {
        prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x1C00000;//main 1080p 444 0x1360000+sub 0x880000
    }
	else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_2DTV_NOSUB)
    {
        prPoolList[FBM_POOL_TYPE_SCPOS_MAIN].u4PoolSize = 0x1680000;////main 1080p 444 0x1360000+sub 0x300000
    }
    else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_A3)
    {
    ...
    // pq tool
    prPoolList[FBM_POOL_TYPE_PQ_TOOL].u4Inherit = FBM_POOL_ROOT;
#ifndef CC_CDC_SUPPORT
    if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_A3)
#endif
    {
        prPoolList[FBM_POOL_TYPE_PQ_TOOL].u4PoolSize = 0x800000; // A3 needs 8MB for OD dump
    }
    prPoolArrangeInfo[FBM_POOL_TYPE_PQ_TOOL].eMode = FBM_POOL_ARRANGE_AFTER;
    prPoolArrangeInfo[FBM_POOL_TYPE_PQ_TOOL].ePool1 = u4AheadType;
    u4AheadType = FBM_POOL_TYPE_PQ_TOOL;
            ...
            || (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_A3))
    {
		...
		prPoolList[FBM_POOL_TYPE_4K_2K_SCALER].u4Inherit = FBM_POOL_INHERIT;
        prPoolList[FBM_POOL_TYPE_4K_2K_SCALER].u4PoolSize = FBM_EXTRA_FOR_4K2K_SCL_DRAM;
    	prPoolList[FBM_POOL_TYPE_4K_2K_SCALER].u4AddrAlign = FBM_SCPOS_SIZE_ALIGMENT;
        prPoolArrangeInfo[FBM_POOL_TYPE_4K_2K_SCALER].eMode = FBM_POOL_ARRANGE_BEFORE;
        prPoolArrangeInfo[FBM_POOL_TYPE_4K_2K_SCALER].ePool1 = FBM_POOL_TYPE_TOTAL2;
		#endif
    }    
#else // 1 channel
    if ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV)
    ...
    else
    {
    	...
    	// feeder
    	#if defined(CC_VOMX_TV_COEXIST)||defined(CC_SUPPORT_4K2K)||defined(CC_SUPPORT_4K2K)
    	prPoolList[FBM_POOL_TYPE_FEEDER].u4Inherit = FBM_POOL_ROOT;
    	prPoolList[FBM_POOL_TYPE_FEEDER].u4PoolSize = FBM_FEEDER_POOL_SIZE;
    	prPoolArrangeInfo[FBM_POOL_TYPE_FEEDER].eMode = FBM_POOL_ARRANGE_AFTER;
    	prPoolArrangeInfo[FBM_POOL_TYPE_FEEDER].ePool1 = u4AheadType;
		#if defined(CC_SUPPORT_4K2K)
		prPoolList[FBM_POOL_TYPE_FEEDER].u4PoolSize += 0xA00000;
		#endif
    	u4AheadType = FBM_POOL_TYPE_FEEDER;
    	#else
    	prPoolList[FBM_POOL_TYPE_FEEDER].u4PoolSize = FBM_FEEDER_POOL_SIZE;
...
#define CHECK_SCALER_SIZE_TO_0()\
    do {\
        if ((u4ScalerMode & FBM_POOL_MODE_SCPOS_PSCAN_DISP) || (u4ScalerMode & FBM_POOL_MODE_SCPOS_DISP)|| (u4ScalerMode & FBM_POOL_MODE_SCPOS_LINESYNC_DISP)||(u4ScalerMode == FBM_POOL_MODE_UNSTABLE))\
        {\
            u4Size = 0;\
        }\
    } while (0)
...
#if defined(CC_MT5881)
        if((E_TD_IN_FS_P == eDIIn) || (E_TD_IN_FS_I== eDIIn))
        {
...
#ifdef CC_MT5881
static FBM_POOL_T* _FbmGetPoolInfoAuto_MT5881_128M(UCHAR ucPoolType, const FBM_POOL_MODULE_INFO_T* prInfo)
{
    ...
    IsNoSub = ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_64Mx1)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_SA_64Mx1));
...
#if  defined(CC_MT5399)||defined(CC_MT5890)
static FBM_POOL_T* _FbmGetPoolInfoAuto_MT5399_1GB(UCHAR ucPoolType, const FBM_POOL_MODULE_INFO_T* prInfo)
{
    FBM_POOL_T* prPool=NULL;
    static UINT8 fgInited = FALSE;
    //FBM_POOL_T* prPrevPool;
...
FBM_POOL_T* FBM_GetPoolInfoAuto(UCHAR ucPoolType, const FBM_POOL_MODULE_INFO_T* prInfo)
{
    ...
    {
        return _FbmGetPoolInfoAuto_MT5399_1GB(ucPoolType, prInfo);
    }
#endif
#if defined(CC_MT5881)
    if ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_64Mx1)
		||(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_SA_64Mx1))
    {
        return _FbmGetPoolInfoAuto_MT5881_128M(ucPoolType, prInfo);
    }
#endif
    else
    {
...
VOID FBM_PrintPoolInfo(FBM_POOL_T* prPool, POOL_LIST_T* prPoolList)
{
	...
	if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV)
	{
		LOG(1, "FBM_MEM_CFG_MT5399_3DTV Model\n");
	}
	if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_3DTV_NOSUB)
	{
		LOG(1, "FBM_MEM_CFG_MT5399_3DTV_NOSUB Model\n");
	}
	if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_2DTV)
	{
		LOG(1, "FBM_MEM_CFG_MT5399_2DTV Model\n");
	}
	if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_2DTV_NOSUB)
	{
		LOG(1, "FBM_MEM_CFG_MT5399_2DTV_NOSUB Model\n");
	}
	else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5399_A3)
	{
		LOG(1, "FBM_MEM_CFG_MT5399_A3 Model\n");
	}
#endif
#if defined(CC_MT5881) 
		if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
		{
			LOG(1, "FBM_MEM_CFG_MT5881_128Mx1 Model\n");
		}
		else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_64Mx1)
		{
			LOG(1, "FBM_MEM_CFG_MT5881_64Mx1 Model\n");
		}
		else if (SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_SA_64Mx1)
		{
			LOG(1, "FBM_MEM_CFG_MT5881_SA_64Mx1 Model\n");
		}
#endif
...
VOID FBM_ConfigurePool(POOL_LIST_T* prPoolList, POOL_ARRANGE_INFO_T* prPoolArrangeInfo)
{
    ...
    {
        _FbmConfigurePool_MT5399_MJC_SCPOS_MAIN(prPoolList, prPoolArrangeInfo);
    }
#endif
#if defined(CC_MT5881)
    if ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)||
		...
		(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_SA_64Mx1))
    {
		_FbmConfigurePool_MT5881_SCPOS_MAIN( prPoolList,prPoolArrangeInfo);
	}
#endif
    else
    {
