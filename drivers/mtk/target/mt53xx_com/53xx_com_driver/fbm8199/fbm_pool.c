    ...
    for (u4ListIdx = 0; u4ListIdx < _u4PoolListNs; u4ListIdx++)
    {
        if (u4ListIdx != (UINT32)_arPoolList[u4ListIdx].eType)
        {
            VERIFY(0);
                ...
                if ((SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_64Mx1)
...
//    FBM_ConfigurePool(&_arPoolList, &arPoolArrangeInfo);
    ...
    LOG(0,"Before 4k2k, MPEG1 Size:0x%x; MPEG2 Size:0x%x",_arPoolList[FBM_POOL_TYPE_MPEG].u4PoolSize,_arPoolList[FBM_POOL_TYPE_MPEG2].u4PoolSize);
		...
		if(SRMFBM_GetConf() == FBM_MEM_CFG_MT5881_128Mx1)
			{
				...
				Printf("FBM_MEM_CFG_MT5881_128Mx1 must define CC_FBM_TWO_FBP \n");
				VERIFY(0);
				#endif
