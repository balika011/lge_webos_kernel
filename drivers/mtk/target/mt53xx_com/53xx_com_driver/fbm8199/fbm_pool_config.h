...
#if ( defined(CC_MT5399) || defined(CC_MT5398) || defined(CC_MT5880) || defined(CC_MT5881)||defined(CC_MT5890))
...
#define FBM_AUD_APROC_WORKSPACE              0x300000    // 3MB
#else
#define FBM_AUD_APROC_WORKSPACE              0x40000    // 256 kb
...
#if defined(CC_MT5399)||defined(CC_MT5890) //422 10bit 3 frame buffer
...
#endif
#else
#if defined(CC_MT5399) ||defined(CC_MT5890)//422 10bit 2 frame buffer
#define FBM_TVE_POOL_SIZE                      FBM_ALIGN_MASK(FBM_TVE_POOL_FBM_SIZE, FBM_TVE_SIZE_ALIGMENT)
#else
