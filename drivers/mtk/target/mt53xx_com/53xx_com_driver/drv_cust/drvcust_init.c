...
// NAND flash parameter
    ...
    case eHDMIEDIDNANDOffset:
        *pu4Data = (UINT32)HDMIEDID_NAND_FLASH_OFFSET;
		...
		case eHDMI20NANDPartId:
			*pu4Data = (UINT32)FLASH_HDCP_BIN_PARTITION;
			return 0;
			
		case eHDMI20PROMNANDOffSet:
			*pu4Data = (UINT32)FLASH_HDMI_2_0_PROM_OFFSET;
			return 0;
			
		case eHDMI20PRAMNANDOffSet:
			*pu4Data = (UINT32)FLASH_HDMI_2_0_PRAM_OFFSET;
			return 0;
			
		case eHDMI20HDCP22NANDOffSet:
			*pu4Data = (UINT32)FLASH_HDMI_2_0_HDCP2_2_KEY_OFFSET;
			return 0;
		case eHDMI14HDCP14NANDOffSet:
			*pu4Data = (UINT32)FLASH_HDMI_1_4_HDCP1_4_KEY_OFFSET;
			return 0;
			
		case eHDMI20EDIDNANDOffSet:
			*pu4Data = (UINT32)FLASH_HDMI_2_0_EDID_OFFSET;
			return 0;
			
		case eMHL20EDIDNANDOffsSet:
			*pu4Data = (UINT32)FLASH_MHL_2_0_EDID_OFFSET;
			return 0;
	#endif
...
#if  defined(CC_MT5389) || defined(CC_MT5396) || defined(CC_MT5368) || defined(CC_MT5399)
...
#if  defined(CC_MT5396)|| defined(CC_MT5368) || defined(CC_MT5399)
