...
// Add Panel control word 2
#define EnablePANELCW2
...
#if defined(SUPPORT_PANEL_48HZ) || defined(SUPPORT_PANEL_CUSTOMER_SPEC) || defined(SUPPORT_PANEL_SS) || defined(SUPPORT_PANEL_DITHER) || defined(SUPPORT_PANEL_SCAN_PWM)
...
// disable osd mute when timing change
#define DISABLE_OSD_MUTE_MODCHG (1<< 2)
#define IS_DISABLE_OSD_MUTE_MODCHG (PANEL_GetControlWord2() & DISABLE_OSD_MUTE_MODCHG)
