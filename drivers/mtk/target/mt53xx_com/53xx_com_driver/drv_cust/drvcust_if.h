...
#define FBM_SIZE_FORMULAR(x)    (x + FBM_OD_SIZE + FBM_JPEVDP_POOL_SIZE + FBM_DMX_PID_BUF_SIZE + FBM_VENC_SIZE + FBM_BIG_SIZE + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_DIVX_SIZE +VOMX_EXTRA_FRAME_BUFFER_SZ + FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_VSS_SIZE + FBM_DRM_BUF_SIZE + FBM_MUXER_SIZE + FBM_IMGRZ_3D_KR_BUF + FBM_SLT_EXTRA_SIZE + FBM_PNG_POOL_SIZE + FBM_TDCAV_POOL_SIZE  + FBM_PQ_TOOL_SIZE + FBM_DMX_ADD_SIZE + FBM_EXTRA_FOR_4K2K_FEEDER_DMX + FBM_DSP_BIN_POOL_SIZE + FBM_TVE_POOL_FBM_SIZE  + FBM_DSP_BIN_POOL_SIZE +  FBM_JPEG_SIZE)
...
#define FBM_TWO_FBP_SIZE        (0x800000 + 0x1780000 + FBM_EXTRA_FOR_4K2K_VIDEO)
#else
#define FBM_TWO_FBP_SIZE        (0)
#endif

#if defined(ANDROID) && defined(CC_FBM_3D_OSD)
...
#define FBM_DIVX_SIZE           (0x1200000 + FMB_EXTRA_FOR_H264_LV5)
#else
#define FBM_DIVX_SIZE           (0x900000 + FMB_EXTRA_FOR_H264_LV5)
#endif
#else
...
#if defined(ANDROID)
#ifdef CC_TVP_SUPPORT
#define FBM_MEM_CFG_MT5399_3DTV             FBM_SIZE_FORMULAR(0x4C80000 + 0x1600000 + 0x1c1000)
#else
#define FBM_MEM_CFG_MT5399_3DTV             FBM_SIZE_FORMULAR(0x4A80000 + 0xD00000 )
#endif
#else
#ifdef CC_TVP_SUPPORT
#define FBM_MEM_CFG_MT5399_3DTV             FBM_SIZE_FORMULAR(0x4C70000 + 0x1c1000)
#else
#define FBM_MEM_CFG_MT5399_3DTV             FBM_SIZE_FORMULAR(0x4A80000 + 0x1c1000)
#endif
#endif
#define FBM_MEM_CFG_MT5399_3DTV_NOSUB       FBM_SIZE_FORMULAR(0x4400000 + 0x1c1000)
#define FBM_MEM_CFG_MT5399_2DTV             FBM_SIZE_FORMULAR(0x3f80000 + 0x1c1000)
#define FBM_MEM_CFG_MT5399_2DTV_NOSUB       FBM_SIZE_FORMULAR(0x3a00000 + 0x1c1000)
...
#if 1//def CC_HDMI_2_0_HDCP_BIN
	eHDMI20NANDPartId,
	eHDMI20PROMNANDOffSet,
	eHDMI20PRAMNANDOffSet,
	eHDMI20HDCP22NANDOffSet,
	eHDMI14HDCP14NANDOffSet,
	eHDMI20EDIDNANDOffSet,
	eMHL20EDIDNANDOffsSet,
#endif
...
//#define SERVO_GPIO0             (229)	//not real gpio, just for judge ather sevoad_gpio function
