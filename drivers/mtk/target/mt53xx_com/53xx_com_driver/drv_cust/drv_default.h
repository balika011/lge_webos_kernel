...
#define DEFAULT_DDR_CLOCK           (1440000000)
#endif
...
#ifndef AUDIO_DAC_LINEOUT_DAC_NUM               ///TPV 89 use AL0/AR0
#define AUDIO_DAC_LINEOUT_DAC_NUM           0   ///0,1,2,3 for ALR0,ALR1,ALR2,ALR3.
#endif
#endif
...
// size = 0:       unused partition type.
    ...
    #define NOR_PART_OFFSET_18 (NOR_PART_OFFSET_17+NOR_PART_SIZE_17)
    #define NOR_PART_OFFSET_19 (NOR_PART_OFFSET_18+NOR_PART_SIZE_18)
    #define NOR_PART_OFFSET_20 (NOR_PART_OFFSET_19+NOR_PART_SIZE_19)
    #define NOR_PART_OFFSET_21 (NOR_PART_OFFSET_20+NOR_PART_SIZE_20)
    ...
    // static partition must be the multiple of 64 KB.
	   ...
	   (NOR_PART_SIZE_6 % (64*1024)) ||\
	   (NOR_PART_SIZE_7 % (64*1024)) ||\
	   (NOR_PART_SIZE_8 % (64*1024)) ||\
	   (NOR_PART_SIZE_9 % (64*1024)) ||\
	   (NOR_PART_SIZE_10 % (64*1024)) ||\
	   (NOR_PART_SIZE_11 % (64*1024)) ||\
	   (NOR_PART_SIZE_12 % (64*1024)) ||\
	   (NOR_PART_SIZE_13 % (64*1024)) ||\
	   (NOR_PART_SIZE_14 % (64*1024)) ||\
	   (NOR_PART_SIZE_15 % (64*1024)) ||\
	   (NOR_PART_SIZE_16 % (64*1024)) ||\
	   (NOR_PART_SIZE_17 % (64*1024)) ||\
	   (NOR_PART_SIZE_18 % (64*1024)) ||\
	   (NOR_PART_SIZE_19 % (64*1024)) ||\
	   (NOR_PART_SIZE_20 % (64*1024)) ||\
	   (NOR_PART_SIZE_21 % (64*1024)))
