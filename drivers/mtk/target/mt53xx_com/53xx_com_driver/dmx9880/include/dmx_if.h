...
#define DMX_NUM_FILTER_INDEX            (96)      ///< Number of filters
...
#define DMX_NUM_ONEBYTE_HW_FILTER_COUNT (64)
#else //CC_MT5398
...
#else
#define DMX_MM_MOVE_TSIDX               (1)
#endif

#define DMX_MAX_TSOUT                   (1)
...
typedef enum                            // Set by TS index
{
    ...
    DMX_FE_EXT2_2_S = 0x60,        // Serial
    DMX_FE_EXT2_2_P = 0x61,        // Parallel, no parallel, test
    DMX_FE_EXT3_S = 0x40,
    DMX_FE_EXT3_P = 0x41,
...
EXTERN BOOL DMX_TsOut_SetClockInvertGating(BOOL fgInvert, BOOL fgGating);
