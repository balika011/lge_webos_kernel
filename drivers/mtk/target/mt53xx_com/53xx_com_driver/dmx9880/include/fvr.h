...
#define FVR_SIT_BUFFERSIZE	                (44)    //176 bytes
...
#define FVR_SIT_BUFFER_BASE                    (DEMUX2_BASE + 0x375C)
#define FVR_SIT_BUFFER_BASE2                   (DEMUX2_BASE + 0x3810)
#define FVR_SIT_BUFFER_BASE3                   (DEMUX2_BASE + 0x38C4)
...
#define FVR_SIT_BUFFER_W(idx, word)         \
            FVR_GBL_BASE_W((idx==0) ? FVR_SIT_BUFFER_BASE : \
            (idx==1) ? FVR_SIT_BUFFER_BASE2 : FVR_SIT_BUFFER_BASE3, word)
...
EXTERN BOOL _FVR_SitEnalbe(UINT8 u1TsIdx, BOOL fgEnable);
EXTERN BOOL _FVR_SitFreePattern(UINT8 u1TsIdx);
EXTERN BOOL _FVR_SitSetPattern(UINT8 u1TsIdx, UINT16 u2Pid, UINT8* pu1Pattern, UINT16 u2Len);
EXTERN BOOL _FVR_SitCompleteSwap(UINT8 u1TsIdx,UINT8 u1SitPkt, UINT32 u4SitWp);
EXTERN BOOL _FVR_SitTimerSwap(UINT8 u1TsIdx,UINT8 u1SitPkt, UINT32 u4SitWp, UINT32 u4Data);
EXTERN BOOL _FVR_SitEnableTimer(UINT8 u1TsIdx, BOOL fgEnable);
EXTERN BOOL _FVR_SitSetTimer(UINT32 u4Timer);
