...
BOOL DMX_EMU_PullTsTransfer0(UINT8 u1TsIndex, UINT32 u4Size, UINT16 u2Pid,PUL_MODE_T eMode)
{
    DMX_PID_T rPid;
    UINT32 u4SrcAddr = 0, u4DstAddr = 0, u4DstEnd, u4SrcDiff, u4DstDiff;
    UINT32 u4PesAddr, u4PesSize = 0, u4Flags,u4Reg;
...
BOOL DMX_EMU_PullTsTransfer3(UINT8 u1TsIndex, UINT32 u4Size, UINT16 u2Pid,PUL_MODE_T eMode)
{
    ...
    DMXCMD_WRITE32(DMX_REG_FRAMER_ERROR_HANDLE, 0xF0F0F0F0);
