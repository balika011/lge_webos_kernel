...
BOOL _DMX_EMU_DBM_Auto_SwitchTest( BOOL fgEnable_AutoSwitch)
{
	//DMX_MM_DATA_T rData;
	UINT32 u4DataSize;
	DMX_PID_T rPid;
	...
	//Set ExternalFramer DMX_EXT_FRAMER_2_PVR_3_EXT,make tsindex 2 receive pvr playback data
	_DMX_SetExternalFramer(DMX_EXT_FRAMER_2_PVR_3_EXT);
