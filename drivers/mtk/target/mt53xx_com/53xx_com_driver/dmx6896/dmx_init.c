...
static void _DmxSetExtPinmux(DMX_PINMUX_SEL_T ePin)
{
    ...
    case DMX_PINMUX_EXT2_0_S:
        ...
        if (0x20 == (CKGEN_READ32(0x404) & 0x70))
        {
    ...
    case DMX_PINMUX_EXT2_1_S:
        ...
        u4Ctrl = CKGEN_READ32(0x404);
        // pmux1[8:10], function 1
        if (0x100 == (u4Ctrl & 0x700))
        {
            u4Ctrl &= (~0x700);
            fgDirtyCtrl = TRUE;
        }

        // pmux1[12:14], function 1
        if (0x1000 == (u4Ctrl & 0x7000))
        {
            u4Ctrl &= (~0x7000);
            fgDirtyCtrl = TRUE;
        }
