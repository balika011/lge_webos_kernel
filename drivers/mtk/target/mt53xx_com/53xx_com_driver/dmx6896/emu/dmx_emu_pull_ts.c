...
BOOL DMX_EMU_PullTsTransfer0(UINT8 u1TsIndex, UINT32 u4Size, UINT16 u2Pid)
{
    DMX_PID_T rPid;
...
BOOL DMX_EMU_PullTsTransfer1(UINT8 u1TsIndex, UINT32 u4Size, UINT16 u2Pid)
{
    DMX_PID_T rPid;
    UINT32 u4SrcAddr = 0, u4DstAddr = 0, u4DstBufSize, u4DstEnd;
    UINT32 u4PesAddr, u4PesSize, u4SrcDiff, u4DstDiff, u4Flags;
    const UINT8 u1Pidx = 0;
    BOOL fgRet = FALSE;
    ...
    // Invoke DDI transfer
    if (!_DMX_EMU_DDI_Transfer(3, u4SrcAddr, u4Size))
    {
        // Error on transferring data
        goto _exit;
    }
...
BOOL DMX_EMU_PullTsTransfer2(UINT32 u4Size)
{
    PID_STRUCT_T* prPidStruct;
    UINT32 u4SrcAddr, u4PesSize, u4DstBufStart = 0, u4DstBufEnd = 0, u4DstWp;
    UINT32 u4DstRp, u4Diff;
