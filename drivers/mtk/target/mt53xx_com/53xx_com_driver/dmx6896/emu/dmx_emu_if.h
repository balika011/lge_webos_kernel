...
EXTERN BOOL DMX_EMU_DDI_Transfer1(UINT8 u1Type, UINT32 u4Size);
...
EXTERN BOOL DMX_EMU_PullTsTransfer2(UINT32 u4Size);
...
// DVB decryption
EXTERN BOOL DMX_EMU_DvbMain(UINT8 u1TsIndex, UINT8 u1Type);
