    ...
    UINT32 u4BufEnd, UINT8 *pu1PicInfo)
{
    UINT32 u4PicType;
    UINT8* p;
    UINT8 u1Type, h[PIC_VC1_HEADER_LEN], u1BitField, i;
    ...
    if (((u4Addr + PIC_VC1_HEADER_LEN) - 1) >= u4BufEnd)
    {
        ...
        HalInvalidateDCacheMultipleLine(u4Addr, u1Len);
        HalInvalidateDCacheMultipleLine(u4BufStart, (PIC_VC1_HEADER_LEN - u1Len));
        x_memcpy((void*)h, (void*)p, u1Len);
        x_memcpy((void*)(h + u1Len), (void*)u4BufStart,
    ...
    {
        HalInvalidateDCacheMultipleLine(u4Addr, PIC_VC1_HEADER_LEN);
    }
...
*/
        ...
        {
            LOG(6, "Failed to fill picture info!\n");
        }
...
static void _DmxFifoFull(UINT8 u1Pidx)
{
    ...
    {
    	LOG(3, "Pidx %u fifo full!PidType:DMX_PID_TYPE_PSI.\n", u1Pidx);
