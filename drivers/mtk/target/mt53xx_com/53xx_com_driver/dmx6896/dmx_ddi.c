...
void _DMX_DDI_SetPortEx(DMX_DDI_PORT_T ePort, UINT8 u1Pidx, BOOL fgForce,  BOOL fgTs)
{
    ...
    if(ePort == DMX_DDI_PORT_FRAMER0)
    {
        ...
        if(fgTs)
        {
            ...
            // don't change error handle table, use bypass bit instead
            ...
            DMXCMD_WRITE32(DMX_REG_FRAMER_CTRL3,
                DMXCMD_READ32(DMX_REG_FRAMER_CTRL3) & ~(0x10U));
        }
        else
        {
    ...
    else if(ePort == DMX_DDI_PORT_FRAMER1)
    {
        ...
        if(fgTs)
        {
            ...
            DMXCMD_WRITE32(DMX_REG_FRAMER_CTRL3,
                DMXCMD_READ32(DMX_REG_FRAMER_CTRL3) & ~(0x20U));
        }
        else
        {
            UINT32 u4Ctrl;
    ...
    else if(ePort == DMX_DDI_PORT_FRAMER3)
    {
        ...
        if(fgTs)
        {
            ...
            //    DMXCMD_READ32(DMX_REG_FRAMER_ERROR_HANDLE) | (0xf0c0U << 16));
            DMXCMD_WRITE32(DMX_REG_FRAMER_CTRL3,
                DMXCMD_READ32(DMX_REG_FRAMER_CTRL3) & ~(0x40U));
        }
        else
        {
            UINT32 u4Ctrl;
