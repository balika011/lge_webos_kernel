...
#endif
#if RCMM_SUPPORT
extern UINT32 u4WakeupKey;
extern UINT8 u1BitMode;
#endif
...
//#endif
    ...
    #if RCMM_SUPPORT
    else if(tmpCmd.u1Cmd == Cmd_RCMM_WAKEUPKEY)
    {
		u1BitMode = tmpCmd.u1SubCmd;
		u4WakeupKey = tmpCmd.au1Data[0]|(tmpCmd.au1Data[1]<<8)|(tmpCmd.au1Data[2]<<16)|(tmpCmd.au1Data[3]<<24);
		LogSD("u4WakeupKey",u4WakeupKey);
		vCMD_RESONSE(Cmd_RCMM_WAKEUPKEY, 0, 0, 0);
    }
    #endif
    else
    {
