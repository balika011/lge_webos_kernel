...
{
	if((GoingSupend == SUSPEND_STAGE1) && (RegReadFldAlign(PDWNC_CONCFG0,FLD_RG_DMSUS_RESERVED) == 1))
	{
		#if UART_DBG
		LogS("enter suspend stage 1");
		#endif
		//set DMSUS =1 
		vRegWriteFldAlign(PDWNC_CONCFG0,1,FLD_RG_DMSUS);
...
#if defined VGA_WAKEUP_MANUAL_WAY 
