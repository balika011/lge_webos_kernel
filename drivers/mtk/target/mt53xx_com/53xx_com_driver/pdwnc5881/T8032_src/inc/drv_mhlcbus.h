...
#else
#define FLD_HDMI_2_HPD_CBUS Fld(4,26,AC_MSKB3)//[29:26]
#define DISABLE_PINMUX_TO_CBUS()     ((void)vRegWriteFldAlign(PDWNC_PINMUX2, 0, FLD_HDMI_2_HPD_CBUS)) //(BSP_PinSet(PIN_HDMI_2_HPD_CBUS, 1))
#define ENABLE_PINMUX_TO_CBUS()      ((void)vRegWriteFldAlign(PDWNC_PINMUX2, 2, FLD_HDMI_2_HPD_CBUS)) //(BSP_PinSet(PIN_HDMI_2_HPD_CBU, 2))
#endif
