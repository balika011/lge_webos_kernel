...
#define PDWNC_CLKPDN (IO_VIRT+IO_PDWNC_BASE + 0x000)
    #define FLD_CBUSPD Fld(1,10,AC_MSKB1)//[10:10]
...
#define PDWNC_PDMISC (IO_VIRT+IO_PDWNC_BASE + 0x008)
    #define FLD_HDCP_PORT_SEL Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_HDCP_OUT_SEL Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_PDWN_POL Fld(1,14,AC_MSKB1)//[14:14]
    #define FLD_PD_RX_IN_EN Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_DIS_PD_UART_TX Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_VGA_SYNC_DIS Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_PDWN_EN Fld(1,10,AC_MSKB1)//[10:10]
#define PDWNC_PDMISC1 (IO_VIRT+IO_PDWNC_BASE + 0x00C)
    #define FLD_PDWNC_MISC1_U0RX_U0TX Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_PDWNC_MISC1_HDMI Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_PDWNC_MISC1_VGA Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_PDWNC_MISC1_ALL Fld(1,0,AC_MSKB0)//[0:0]
...
#define PDWNC_INTSTA (IO_VIRT+IO_PDWNC_BASE + 0x040)
    #define FLD_SIFM1_INT_STA Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_CBUS_INT Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_DEV_DET_INT Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_CEC_INT1_STA Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_AVLINK_INT1_STA Fld(1,23,AC_MSKB2)//[23:23]
    #define FLD_DDCCI_INT_STA Fld(1,22,AC_MSKB2)//[22:22]
    #define FLD_AUX_INT_STA Fld(4,18,AC_MSKB2)//[21:18]
    #define FLD_ARM_INT_STA Fld(4,14,AC_MSKW21)//[17:14]
...
#define PDWNC_ARM_INTEN (IO_VIRT+IO_PDWNC_BASE + 0x044)
    #define FLD_SIFM1_INT_EN Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_CBUS_INT_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_DEV_DET_INTEN Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_CEC_INT1EN Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_AVLINK_INT1EN Fld(1,23,AC_MSKB2)//[23:23]
    #define FLD_DDCCI_INT_EN Fld(1,22,AC_MSKB2)//[22:22]
    #define FLD_AUX_INTEN Fld(4,18,AC_MSKB2)//[21:18]
    #define FLD_ARM_INTEN Fld(4,14,AC_MSKW21)//[17:14]
...
#define PDWNC_INTCLR (IO_VIRT+IO_PDWNC_BASE + 0x048)
    #define FLD_SIFM1_INT_CLR Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_CBUS_INT_CLR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_CEC_INT1CLR Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_AVLINK_INT1CLR Fld(1,23,AC_MSKB2)//[23:23]
    #define FLD_AUX_INTCLR Fld(4,18,AC_MSKB2)//[21:18]
    #define FLD_ARM_INTCLR Fld(4,14,AC_MSKW21)//[17:14]
...
#define PDWNC_T8032_INTEN (IO_VIRT+IO_PDWNC_BASE + 0x04C)
    ...
    #define FLD_T8032_CEC_INT1EN Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_T8032_AVLINK_INT1EN Fld(1,23,AC_MSKB2)//[23:23]
    #define FLD_T8032_DDCCI_INT_EN Fld(1,22,AC_MSKB2)//[22:22]
    #define FLD_T8032_AUX_INTEN Fld(4,18,AC_MSKB2)//[21:18]
    #define FLD_T8032_ARM_INTEN Fld(4,14,AC_MSKW21)//[17:14]
...
#define PDWNC_GPIOEN1 (IO_VIRT+IO_PDWNC_BASE + 0x080)
    ...
    #define FLD_PD_GPIO_EN1 Fld(10,0,AC_MSKW10)//[9:0]
...
#define PDWNC_PADRDSEL_1 (IO_VIRT+IO_PDWNC_BASE + 0x090)
    #define FLD_RDSEL_1 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_PADTDSEL_1 (IO_VIRT+IO_PDWNC_BASE + 0x094)
    #define FLD_TDSEL_1 Fld(32,0,AC_FULLDW)//[31:0]
...
#define PDWNC_PINMUX3 (IO_VIRT+IO_PDWNC_BASE + 0x0C0)
    #define FLD_PDMUX3 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_PADCFG0 (IO_VIRT+IO_PDWNC_BASE + 0x0C8)
    #define FLD_AOMCLK_SMT Fld(1,29,AC_MSKB3)//[29:29]
    #define FLD_AOMCLK_PD Fld(1,28,AC_MSKB3)//[28:28]
    #define FLD_AOMCLK_PU Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_AOMCLK_SR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_AOMCLK_E4 Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_AOMCLK_E2 Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_ASPDIFO0_SMT Fld(1,21,AC_MSKB2)//[21:21]
    #define FLD_ASPDIFO0_PD Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_ASPDIFO0_PU Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_ASPDIFO0_SR Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_ASPDIFO0_E4 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_ASPDIFO0_E2 Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_OSCL2_SMT Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_OSCL2_PD Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_OSCL2_PU Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_OSCL2_SR Fld(1,10,AC_MSKB1)//[10:10]
    #define FLD_OSCL2_E4 Fld(1,9,AC_MSKB1)//[9:9]
    #define FLD_OSCL2_E2 Fld(1,8,AC_MSKB1)//[8:8]
    #define FLD_OSDA2_SMT Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_OSDA2_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_OSDA2_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_OSDA2_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_OSDA2_E4 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_OSDA2_E2 Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_PADCFG1 (IO_VIRT+IO_PDWNC_BASE + 0x0CC)
    #define FLD_AOSDATA1_SMT Fld(1,29,AC_MSKB3)//[29:29]
    #define FLD_AOSDATA1_PD Fld(1,28,AC_MSKB3)//[28:28]
    #define FLD_AOSDATA1_PU Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_AOSDATA1_SR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_AOSDATA1_E4 Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_AOSDATA1_E2 Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_AOSDATA0_SMT Fld(1,21,AC_MSKB2)//[21:21]
    #define FLD_AOSDATA0_PD Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_AOSDATA0_PU Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_AOSDATA0_SR Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_AOSDATA0_E4 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_AOSDATA0_E2 Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_AOBCK_SMT Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_AOBCK_PD Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_AOBCK_PU Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_AOBCK_SR Fld(1,10,AC_MSKB1)//[10:10]
    #define FLD_AOBCK_E4 Fld(1,9,AC_MSKB1)//[9:9]
    #define FLD_AOBCK_E2 Fld(1,8,AC_MSKB1)//[8:8]
    #define FLD_AOLRCK_SMT Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_AOLRCK_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_AOLRCK_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_AOLRCK_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_AOLRCK_E4 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_AOLRCK_E2 Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_PADCFG2 (IO_VIRT+IO_PDWNC_BASE + 0x0D0)
    #define FLD_OIRI_SMT Fld(1,29,AC_MSKB3)//[29:29]
    #define FLD_OIRI_PD Fld(1,28,AC_MSKB3)//[28:28]
    #define FLD_OIRI_PU Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_OIRI_SR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_OIRI_E4 Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_OIRI_E2 Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_OPWRSB_SMT Fld(1,21,AC_MSKB2)//[21:21]
    #define FLD_OPWRSB_PD Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_OPWRSB_PU Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_OPWRSB_SR Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_OPWRSB_E4 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_OPWRSB_E2 Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_OPCTRL1_SMT Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_OPCTRL1_PD Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_OPCTRL1_PU Fld(1,11,AC_MSKB1)//[11:11]
    ...
    #define FLD_OPCTRL0_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_OPCTRL0_PU Fld(1,3,AC_MSKB0)//[3:3]
...
#define PDWNC_PADCFG3 (IO_VIRT+IO_PDWNC_BASE + 0x0D4)
...
#define PDWNC_PADCFG4 (IO_VIRT+IO_PDWNC_BASE + 0x0D8)
    #define FLD_OPCTRL5_SMT Fld(1,29,AC_MSKB3)//[29:29]
    #define FLD_OPCTRL5_PD Fld(1,28,AC_MSKB3)//[28:28]
    #define FLD_OPCTRL5_PU Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_OPCTRL5_SR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_OPCTRL5_E4 Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_OPCTRL5_E2 Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_OPCTRL4_SMT Fld(1,21,AC_MSKB2)//[21:21]
    #define FLD_OPCTRL4_PD Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_OPCTRL4_PU Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_OPCTRL4_SR Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_OPCTRL4_E4 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_OPCTRL4_E2 Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_OPCTRL3_SMT Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_OPCTRL3_PD Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_OPCTRL3_PU Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_OPCTRL3_SR Fld(1,10,AC_MSKB1)//[10:10]
    #define FLD_OPCTRL3_E4 Fld(1,9,AC_MSKB1)//[9:9]
    #define FLD_OPCTRL3_E2 Fld(1,8,AC_MSKB1)//[8:8]
    #define FLD_OPCTRL2_SMT Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_OPCTRL2_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_OPCTRL2_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_OPCTRL2_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_OPCTRL2_E4 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_OPCTRL2_E2 Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_PADCFG5 (IO_VIRT+IO_PDWNC_BASE + 0x0DC)
    #define FLD_IF_AGC_SMT Fld(1,29,AC_MSKB3)//[29:29]
    #define FLD_IF_AGC_PD Fld(1,28,AC_MSKB3)//[28:28]
    #define FLD_IF_AGC_PU Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_IF_AGC_SR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_IF_AGC_E4 Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_IF_AGC_E2 Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_SRVAD_SMT Fld(1,21,AC_MSKB2)//[21:21]
    #define FLD_SRVAD_PD Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_SRVAD_PU Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_SRVAD_SR Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_SRVAD_E4 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_SRVAD_E2 Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_OPCTRL7_SMT Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_OPCTRL7_PD Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_OPCTRL7_PU Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_OPCTRL7_SR Fld(1,10,AC_MSKB1)//[10:10]
    #define FLD_OPCTRL7_E4 Fld(1,9,AC_MSKB1)//[9:9]
    #define FLD_OPCTRL7_E2 Fld(1,8,AC_MSKB1)//[8:8]
    #define FLD_OPCTRL6_SMT Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_OPCTRL6_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_OPCTRL6_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_OPCTRL6_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_OPCTRL6_E4 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_OPCTRL6_E2 Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_PADCFG6 (IO_VIRT+IO_PDWNC_BASE + 0x0E0)
    #define FLD_HDMI_2_SDA_SMT Fld(1,29,AC_MSKB3)//[29:29]
    #define FLD_HDMI_2_SDA_PD Fld(1,28,AC_MSKB3)//[28:28]
    #define FLD_HDMI_2_SDA_PU Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_HDMI_2_SDA_SR Fld(1,26,AC_MSKB3)//[26:26]
    #define FLD_HDMI_2_SDA_E4 Fld(1,25,AC_MSKB3)//[25:25]
    #define FLD_HDMI_2_SDA_E2 Fld(1,24,AC_MSKB3)//[24:24]
    #define FLD_HDMI_2_SCL_SMT Fld(1,21,AC_MSKB2)//[21:21]
    #define FLD_HDMI_2_SCL_PD Fld(1,20,AC_MSKB2)//[20:20]
    #define FLD_HDMI_2_SCL_PU Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_HDMI_2_SCL_SR Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_HDMI_2_SCL_E4 Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_HDMI_2_SCL_E2 Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_HDMI_CEC_SMT Fld(1,13,AC_MSKB1)//[13:13]
    #define FLD_HDMI_CEC_PD Fld(1,12,AC_MSKB1)//[12:12]
    #define FLD_HDMI_CEC_PU Fld(1,11,AC_MSKB1)//[11:11]
    ...
    #define FLD_RF_AGC_SMT Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_RF_AGC_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_RF_AGC_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_RF_AGC_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_RF_AGC_E4 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_RF_AGC_E2 Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_PADCFG7 (IO_VIRT+IO_PDWNC_BASE + 0x0E4)
    ...
    #define FLD_MHL_SENCE_SMT Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_MHL_SENCE_PD Fld(1,4,AC_MSKB0)//[4:4]
    #define FLD_MHL_SENCE_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_MHL_SENCE_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_MHL_SENCE_E4 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_MHL_SENCE_E2 Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_PADCFG8 (IO_VIRT+IO_PDWNC_BASE + 0x0E8)
    #define FLD_RG_CBUSREG_VREF_SEL Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_RG_CBUSREG_IBIAS Fld(2,14,AC_MSKB1)//[15:14]
    #define FLD_RG_CBUSREG_VREF Fld(3,11,AC_MSKB1)//[13:11]
    #define FLD_HDMI_2_HPD_CBUS_SMT Fld(1,10,AC_MSKB1)//[10:10]
    #define FLD_HDMI_2_HPD_CBUS_PUPD Fld(1,9,AC_MSKB1)//[9:9]
    #define FLD_HDMI_2_HPD_CBUS_IES Fld(1,8,AC_MSKB1)//[8:8]
    #define FLD_HDMI_2_HPD_CBUS_PU Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_HDMI_2_HPD_CBUS_SR Fld(1,2,AC_MSKB0)//[2:2]
    #define FLD_HDMI_2_HPD_CBUS_E8 Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_HDMI_2_HPD_CBUS_E4 Fld(1,0,AC_MSKB0)//[0:0]
...
#define PDWNC_WAKEN (IO_VIRT+IO_PDWNC_BASE + 0x120)
    ...
    #define FLD_UNOR_WAKEN Fld(1,18,AC_MSKB2)//[18:18]
...
#define PDWNC_PDSTAT (IO_VIRT+IO_PDWNC_BASE + 0x128)
    ...
    #define FLD_UNOR_WAK Fld(1,18,AC_MSKB2)//[18:18]
...
#define PDWNC_EDID_DATA_SEL (IO_VIRT+IO_PDWNC_BASE + 0x1BC)
    #define FLD_SIF_STOP_DATA_EN Fld(1,1,AC_MSKB0)//[1:1]
    #define FLD_SIF_START_DATA_EN Fld(1,0,AC_MSKB0)//[0:0]
...
#define PDWNC_ARM_INT (IO_VIRT+IO_PDWNC_BASE + 0x1E8)
    #define FLD_ARM_INT Fld(4,0,AC_MSKB0)//[3:0]
#define PDWNC_AUX_INT (IO_VIRT+IO_PDWNC_BASE + 0x1F4)
    #define FLD_AUX_INT Fld(4,0,AC_MSKB0)//[3:0]
...
#define PDWNC_ADOUTB (IO_VIRT+IO_PDWNC_BASE + 0x398)
...
#define PDWNC_PRST (IO_VIRT+IO_PDWNC_BASE + 0x3C0)
    ...
    #define FLD_CHE_TH Fld(10,20,AC_MSKW32)//[29:20]
    #define FLD_CHD_TH Fld(10,10,AC_MSKW21)//[19:10]
    #define FLD_CHC_TH Fld(10,0,AC_MSKW10)//[9:0]
#define PDWNC_PRST_1 (IO_VIRT+IO_PDWNC_BASE + 0x3C4)
    #define FLD_CHF_FILTER Fld(5,25,AC_MSKB3)//[29:25]
    #define FLD_CHE_FILTER Fld(5,20,AC_MSKW32)//[24:20]
    #define FLD_CHD_FILTER Fld(5,15,AC_MSKW21)//[19:15]
    #define FLD_CHC_FILTER Fld(5,10,AC_MSKB1)//[14:10]
    #define FLD_CHF_TH Fld(10,0,AC_MSKW10)//[9:0]
...
#define PDWNC_AWEEK0 (IO_VIRT+IO_PDWNC_BASE + 0x728)
    #define FLD_AWEEK_0 Fld(3,0,AC_MSKB0)//[2:0]
...
#define PDWNC_AWEEK1 (IO_VIRT+IO_PDWNC_BASE + 0x750)
    #define FLD_AWEEK_1 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK2 (IO_VIRT+IO_PDWNC_BASE + 0x754)
    #define FLD_AWEEK_2 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK3 (IO_VIRT+IO_PDWNC_BASE + 0x758)
    #define FLD_AWEEK_3 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK4 (IO_VIRT+IO_PDWNC_BASE + 0x75C)
    #define FLD_AWEEK_4 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK5 (IO_VIRT+IO_PDWNC_BASE + 0x760)
    #define FLD_AWEEK_5 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK6 (IO_VIRT+IO_PDWNC_BASE + 0x764)
...
#define PDWNC_CONCFG0 (IO_VIRT+IO_PDWNC_BASE + 0x900)
    #define FLD_RG_CON_RESERVED_1 Fld(8,16,AC_FULLB2)//[23:16]    
    #define FLD_RG_DMSUS_RESERVED Fld(1,9,AC_MSKB1)//[9:9]
    #define FLD_RG_DMSUS Fld(1,8,AC_MSKB1)//[8:8]
    #define FLD_RG_CON_RESERVED_0 Fld(8,0,AC_FULLB0)//[7:0]
...
#define PDWNC_XTALCFG0 (IO_VIRT+IO_PDWNC_BASE + 0x928)
...
#define PDWNC_EXTINTSTA (IO_VIRT+IO_PDWNC_BASE + 0xCA0)
    #define FLD_EXTIO_INT_STA Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_EXTINTEN (IO_VIRT+IO_PDWNC_BASE + 0xCA4)
    #define FLD_EXTIO_INTEN Fld(32,0,AC_FULLDW)//[31:0]
    #define FLD_EXTIO_OIRI_INTEN Fld(1,11,AC_MSKB1)//[11:11]
#define PDWNC_EXTINTCLR (IO_VIRT+IO_PDWNC_BASE + 0xCA8)
    #define FLD_EXTIO_INTCLR Fld(32,0,AC_FULLDW)//[31:0]
    #define FLD_EXTIO_OIRI_INTCLR Fld(1,11,AC_MSKB1)//[11:11]
#define PDWNC_T8032_EXTINTEN (IO_VIRT+IO_PDWNC_BASE + 0xCAC)
    #define FLD_T8032_EXTIO_INTEN Fld(32,0,AC_FULLDW)//[31:0]
    #define FLD_T8032_EXTIO_OIRI_INTEN Fld(1,11,AC_MSKB1)//[11:11]
