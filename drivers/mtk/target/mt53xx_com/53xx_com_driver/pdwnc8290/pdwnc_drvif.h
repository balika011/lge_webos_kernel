...
EXTERN INT32 PDWNC_GpioStatus(INT32 i4Gpio, INT32* pi4Pinmux, INT32* pi4Enable, INT32* pi4Output, INT32* pi4Input);
...
EXTERN UINT32 _PDWNC_ReadWakeupStatus(UINT32 u4Pdstat);
...
EXTERN INT32 PDWNC_GetWakeupGpioNum(UINT32 *u4GpioNum);
