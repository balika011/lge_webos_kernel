...
goto BUILD_ALL_MT8290

:BUILD_ALL_MT8290
@cd ..\Driver
@echo SRC = startup_mt8290.a51\> Makefile
@type CMakefile >> Makefile
@cd ..\..\workspace
@..\bin\GetBL51Cmd.exe system_mt8290.cfg SYSTEM_DEMO_US
@cd ..\
@mkdir lib
...
@ren ..\obj\startup_mt8290.obj startup.obj
@goto LINK_PRC
REM @goto END
...
:SHOW_USAGE
@ECHO [USAGE]:
@ECHO Step1: link.bat clean
@ECHO Step2: link.bat mt5890m1v1
@ECHO Step3: b2h.exe  mt5890m1v1.bin mtk_t8032fw.h
@ECHO [PCB TYPE]:
@dir ..\src\custom /B /AD 
...
@ECHO ***************************************************************************************************
@ECHO NOTE:
@ECHO In PDWNC8290 , GPIO_SetOut() and GPIO_GetIn() have resolved "reentrant" problem, 
@ECHO Control GPIO please use such functions.
@ECHO And if you find any problem, Please contact wangliang.wang.
@ECHO Thanks!!
@ECHO ***************************************************************************************************
