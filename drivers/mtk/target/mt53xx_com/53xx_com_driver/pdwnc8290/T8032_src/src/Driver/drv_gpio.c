...
code const UINT32   _aau1OpctrlSelFunc[TOTAL_OPCTRL_NUM][2] =
{
	...
	{PIN_OPCTRL13,	PINMUX_FUNCTION0 },//OPCTRL(213)
	{PIN_OPCTRL14,	PINMUX_FUNCTION0 },//OPCTRL(214)
	{PIN_OPCTRL15,	PINMUX_FUNCTION0 },//OPCTRL(215)
	{PIN_OPCTRL16,	PINMUX_FUNCTION0 },//OPCTRL(216)
	{PIN_OPCTRL17,	PINMUX_FUNCTION0 },//OPCTRL(217)
	{PIN_OPCTRL18,	PINMUX_FUNCTION0 },//OPCTRL(218)
	{PIN_OPCTRL19,	PINMUX_FUNCTION0 },//OPCTRL(219)
	{PIN_OPCTRL20,	PINMUX_FUNCTION0 },//OPCTRL(220)
	...
	{PIN_HDMI_2_HPD,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION1 - OPCTRL(225)
	...
	{PIN_HDMI_3_HPD,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION1 - OPCTRL(229)
	{PIN_ADIN1,	PINMUX_FUNCTION1 },//OPCTRL(230)
	{PIN_ADIN2,	PINMUX_FUNCTION1 },//OPCTRL(231)
	{PIN_ADIN3,	PINMUX_FUNCTION1 },//OPCTRL(232)
	...
	{PIN_ADIN8,	PINMUX_FUNCTION1 },//OPCTRL(237)
	{PIN_ADIN9,	PINMUX_FUNCTION1 },//OPCTRL(238)
	...
	{PIN_HDMI_3_SDA,	PINMUX_FUNCTION0 },//OPCTRL(245)
	{PIN_HDMI_3_SCL,	PINMUX_FUNCTION0 },//OPCTRL(246)
	{PIN_OPWRSB,	PINMUX_FUNCTION1 },//OPCTRL(247)
	{PIN_OIRI,	PINMUX_FUNCTION1 },//OPCTRL(248)
	{PIN_HDMI_0_SDA,	PINMUX_FUNCTION0 },//OPCTRL(249)
	{PIN_HDMI_0_SCL,	PINMUX_FUNCTION0 },//OPCTRL(250)
	{PIN_HDMI_CEC,	PINMUX_FUNCTION0 },//OPCTRL(251)
	{PIN_HDMI_0_PWR5V,	PINMUX_FUNCTION0 },//OPCTRL(252)
	{PIN_HDMI_0_HPD_CBUS,	PINMUX_FUNCTION0 },//OPCTRL(253)
	{PIN_LED_PWM0,	PINMUX_FUNCTION0 },//OPCTRL(254)
	{PIN_LED_PWM1,	PINMUX_FUNCTION0 },//OPCTRL(255)
	{PIN_LED_PWM2,	PINMUX_FUNCTION0 },//OPCTRL(256)
	{PIN_LED_PWM3,	PINMUX_FUNCTION0 },//OPCTRL(257)
	{PIN_MHL_SENSE,	PINMUX_FUNCTION1 },//OPCTRL(258)
	{PIN_HDMI_3_PWR5V,	PINMUX_FUNCTION0 },//OPCTRL(259)
	{PIN_VGA_SDA,	PINMUX_FUNCTION0 },//OPCTRL(260)
	{PIN_VGA_SCL,	PINMUX_FUNCTION0 },//OPCTRL(261)
	{PIN_TCON0,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION3 - OPCTRL(262)
	{PIN_TCON1,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION3 - OPCTRL(263)
	{PIN_TCON2,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION3 - OPCTRL(264)
	{PIN_TCON3,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION3 - OPCTRL(265)
	{PIN_TCON4,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION3 - OPCTRL(266)
	{PIN_TCON5,	PINMUX_FUNCTION0 },//PINMUX_FUNCTION3 - OPCTRL(267)
	{PIN_TCON6,	PINMUX_FUNCTION0 },//OPCTRL(268)
	{PIN_TCON7,	PINMUX_FUNCTION0 },//OPCTRL(269)
	{PIN_TCON8,	PINMUX_FUNCTION0 },//OPCTRL(270)
	{PIN_TCON9,	PINMUX_FUNCTION0 },//OPCTRL(271)
	{PIN_TCON10,	PINMUX_FUNCTION0 },//OPCTRL(272)
	{PIN_TCON11,	PINMUX_FUNCTION0 },//OPCTRL(273)
	{PIN_TCON12,	PINMUX_FUNCTION0 },//OPCTRL(274)
};
...
static INT16 _GPIONumOffset(INT16 i4GpioNum) reentrant
{
	...
	if ((i4GpioNum >= ADIN0) && (i4GpioNum <= ADIN9))
	{
	...
	case GPIO_HANDLER_PDWNC_SRVAD:
		...
		{
			u4Idx = (i4GpioNum-SERVO_0_ALIAS) + ((SERVO_GPIO1-1)-OPCTRL(0));
		}
	}
	return i4GpioNum;
}
...
{                                                                                                            
	...
	if(IS_IC_5861())
	{
		if(u4PinSel == PIN_HDMI_0_HPD_CBUS)
		{
			u4PinSel = PIN_HDMI_0_HPD_CBUS_MT5861;
		}
		else if(u4PinSel == PIN_HDMI_3_HPD)
		{
			u4PinSel = PIN_HDMI_3_HPD_MT5861;
		}
	}
...
static INT16 PDWNC_GpioInput(INT16 i4Gpio) reentrant
{
	...
	{
		u4Val = IO32ReadFldAlign(PDWNC_GPIOIN2, FLD_PD_GPIO_IN1);
	}   
...
INT16 PDWNC_GpioIntrq(INT16 i4Gpio, INT32 *pfgSet)
{
	...
	if(i4Int <= 31)
	{
		u4Val = u4IO32Read4B(PDWNC_T8032_EXT_INTEN_0);
	}
	else
	{
		u4Val = u4IO32Read4B(PDWNC_T8032_EXT_INTEN_1);
	}
	...
	if(i4Int <= 31)
	{
		vIO32Write4B(PDWNC_T8032_EXT_INTEN_0, u4Val);
	}
	else 
	{
		vIO32Write4B(PDWNC_T8032_EXT_INTEN_1, u4Val);
	}
...
INT16 PDWNC_GpioReg(UINT16 i4Gpio, GPIO_TYPE eType)
{
...

    {
        case GPIO_TYPE_INTR_FALL:
            u4Exint2ed &= ~(1L << i4Idx); // Disable double edge trigger.
            u4Exintlev &= ~(1L << i4Idx);  // Set Edge trigger.
            u4Exintpol &= ~(1L << i4Idx);       // Set Falling Edge interrupt.
            break;    
        case GPIO_TYPE_INTR_RISE:            
            u4Exint2ed &= ~(1L << i4Idx); // Disable double edge trigger.
            u4Exintlev &= ~(1L << i4Idx);  // Set Edge trigger.
            u4Exintpol |= (1L << i4Idx);       // Set rasing Edge interrupt.
            break;                        
        case GPIO_TYPE_INTR_BOTH:            
            u4Exint2ed |= (1L << i4Idx); // enable double edge trigger.
            u4Exintlev &= ~(1L << i4Idx);  // Set Edge trigger.
            break;         
        case GPIO_TYPE_INTR_LEVEL_LOW:            
            u4Exint2ed &= ~(1L << i4Idx); // Disable double edge trigger.
            u4Exintlev |= (1L << i4Idx);  // Set Level trigger.
            u4Exintpol &= ~(1L << i4Idx);       // Set level low interrupt.
            break;       
        case GPIO_TYPE_INTR_LEVEL_HIGH:            
            u4Exint2ed &= ~(1L << i4Idx); // Disable double edge trigger.
            u4Exintlev |= (1L << i4Idx);  // Set level trigger.
            u4Exintpol |= (1L << i4Idx);       // Set level high interrupt.
            break;  
        default:
			u4Val = 0;
			PDWNC_GpioIntrq(i4Gpio,(INT32 *)&u4Val);// Disable interrupt.
            return -1;
        }
...
void vCustGpioIsr(UINT16 u2IntIndex)
{	
#if UART_DBG
	LogS("GpioInt");
	LogSD("u2IntIndex",u2IntIndex);			
#endif
	switch(u2IntIndex)
	{
		case 1:
	...
	vIO32Write4B((u2IntIndex <= 31)? PDWNC_EXT_INTCLR_0 : PDWNC_EXT_INTCLR_1,  ((UINT32)0x1 << (u2IntIndex&0x1F)));
}
#endif
