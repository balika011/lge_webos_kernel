...
typedef enum
{
    ...
    PDWNC_WAKE_UP_REASON_RC_DIGIT_11,
    PDWNC_WAKE_UP_REASON_RC_DIGIT_12,
    ...
    PDWNC_WAKE_UP_REASON_WIFI,
    PDWNC_WAKE_UP_REASON_BT,
    PDWNC_WAKE_UP_REASON_RC_NETFLIX,
...
#define INTERRUPT_RS232_HT_INT_FLAG 		(0x00000020)
#define INTERRUPT_RS232_BT_INT_FLAG 		(0x00000040)
#define INTERRUPT_POWER_EDY_INT_FLAG 		(0x00000080)
#define INTERRUPT_SIFM0_INT_FLAG 			(0x00000100)
#define INTERRUPT_UART_INT_FLAG 			(0x00000200)
//#define INTERRUPT_AVLINK_INT_FLAG 		(0x00000400)
#define INTERRUPT_CEC_INT_FLAG 				(0x00000800)
#define INTERRUPT_RTC_INT_FLAG 				(0x00001000)
#define INTERRUPT_IR_INT_FLAG 				(0x00002000)
#define INTERRUPT_ARM_INT_FLAG 				(0x00004000)
#define INTERRUPT_SIFM1_INT_FLAG 			(0x00100000)
#define INTERRUPT_DDCCI_INT_FLAG 			(0x00200000)
#define INTERRUPT_CEC_INT1_FLAG 			(0x00800000)
#define INTERRUPT_GSPI_INT_FLAG 			(0x01000000)
#define INTERRUPT_DEV_DET_INT_FLAG 			(0x02000000)
#define INTERRUPT_ETHERNET_EPHY_INT_FLAG 	(0x10000000)
#define INTERRUPT_ETHERNET_INT_FLAG 		(0x20000000)
#define INTERRUPT_CBUS_INT_FLAG 			(0x40000000)
#define INTERRUPT_SIFM2_INT_FLAG 			(0x80000000)

//#define INTERRUPT_GPIO_INT_FLAG 0xf00ff
extern UINT16	u2IcVer;
#define vGetIcVersion() 	(u4IcVer)
#define IS_IC_5890()        ((vGetIcVersion() & 0xffff0000)==0x58900000)
#define IS_IC_5861()        ((vGetIcVersion() & 0xffff0000)==0x58610000)
...
#define IC_VER_5861_AA      0x58610001         // 5861 AA
#define IC_VER_5861_AB      0x58610002         // 5861 AB
#define IC_VER_5861_AC      0x58610003         // 5861 AC
#define IC_VER_5861_AD      0x58610004         // 5861 AD
#define IS_IC_5890_ES1()    ((vGetIcVersion() == IC_VER_5890_AA))
#define IS_IC_5890_MPS1()   ((vGetIcVersion() == IC_VER_5890_AB))
#define IS_IC_5890_ES3()    ((vGetIcVersion() == IC_VER_5890_AC))
#define IS_IC_5890_ES4()    ((vGetIcVersion() == IC_VER_5890_AD))
#define IS_IC_5861_ES1()    ((vGetIcVersion() == IC_VER_5861_AA))
#define IS_IC_5861_ES2()    ((vGetIcVersion() == IC_VER_5861_AB))
...
//to do check pin mux
//UART0 pad as T8032 log //bit 16~17
#define SwitchUartPD_PORT0() vRegWrite1B(PDWNC_PINMUX0+2,((u1RegRead1B(PDWNC_PINMUX0+2) & 0xfc)|0x01)); \
							 vRegWrite1B(PDWNC_PINMUX1+2,((u1RegRead1B(PDWNC_PINMUX1+2) & 0xfc)|0x01))
...
#define PDWNC_ETHERNET_INT_STATUS 0x3c50
#define INTERRUPT_ETHERNET_WOL_INT_FLAG     (0x00000010)
