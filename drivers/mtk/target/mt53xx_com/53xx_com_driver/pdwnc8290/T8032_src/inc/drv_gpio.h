...
#define SERVO_GPIO8              (237)
#define SERVO_GPIO9              (238)
#endif
...
#define ADIN8                   SERVO(6)        ///< define ADIN6
#define ADIN9                   SERVO(7)        ///< define ADIN7
...
#define PDMX3	((4L << 5) | BASIC_MASK) //PDMX3
#define PDMX4	((5L << 5) | BASIC_MASK) //PDMX3
...
#define PIN_OPCTRL5   		(PDMX1|4)
#define PIN_OPCTRL8   		(PDMX2|2)
#define PIN_OPCTRL9   		(PDMX2|3)
#define PIN_OPCTRL10   		(PDMX2|4)
#define PIN_OPCTRL11   		(PDMX2|5)
#define PIN_OPCTRL12   		(PDMX4|OFFSETMASK(1,0))
#define PIN_OPCTRL13   		(PDMX4|OFFSETMASK(3,2))
#define PIN_OPCTRL14   		(PDMX4|OFFSETMASK(5,4))
#define PIN_OPCTRL15   		(PDMX4|OFFSETMASK(7,6))
#define PIN_OPCTRL16   		(PDMX4|OFFSETMASK(9,8))
#define PIN_OPCTRL17   		(PDMX4|OFFSETMASK(11,10))
#define PIN_OPCTRL18   		(PDMX4|OFFSETMASK(13,12))
...
#define PIN_HDMI_0_HPD_CBUS (PDMX1|2)
#define PIN_LED_PWM0   		(PDMX0|OFFSETMASK(19,18))
#define PIN_LED_PWM1   		(PDMX0|OFFSETMASK(21,20))
#define PIN_LED_PWM2   		(PDMX1|5)
#define PIN_LED_PWM3   		(PDMX1|6)
#define PIN_MHL_SENSE   	(PDMX1|3)
#define PIN_VGA_SDA   		(PDMX0|OFFSETMASK(14,12))
#define PIN_VGA_SCL   		(PDMX0|OFFSETMASK(14,12))
#define PIN_TCON0   		(PDMX2|OFFSETMASK(21,19)| MULTI_GPIO_FLAG)
#define PIN_TCON1   		(PDMX2|OFFSETMASK(24,22)| MULTI_GPIO_FLAG)
#define PIN_TCON2   		(PDMX2|OFFSETMASK(27,25)| MULTI_GPIO_FLAG)
#define PIN_TCON3   		(PDMX3|OFFSETMASK(2,0)| MULTI_GPIO_FLAG)
#define PIN_TCON4   		(PDMX3|OFFSETMASK(5,3)| MULTI_GPIO_FLAG)
#define PIN_TCON5   		(PDMX3|OFFSETMASK(8,6)| MULTI_GPIO_FLAG)
#define PIN_TCON6   		(PDMX3|OFFSETMASK(11,9))
#define PIN_TCON7   		(PDMX3|OFFSETMASK(14,12))
#define PIN_TCON8   		(PDMX3|OFFSETMASK(17,15))
#define PIN_TCON9   		(PDMX3|OFFSETMASK(20,18))
#define PIN_TCON10   		(PDMX3|OFFSETMASK(23,21))
#define PIN_TCON11   		(PDMX3|OFFSETMASK(26,24))
#define PIN_TCON12   		(PDMX3|OFFSETMASK(29,27))

// gpio pin without pinmux
#define PIN_NO_PINMUX       (PMISC | 31)
#define PIN_LAST_PINMUX     (0xffffffff)

#define PIN_OPCTRL6 		PIN_NO_PINMUX
#define PIN_OPCTRL7 		PIN_NO_PINMUX
#define PIN_OPCTRL19 		PIN_NO_PINMUX
#define PIN_OPCTRL20 		PIN_NO_PINMUX
#define PIN_HDMI_1_PWR5V 	PIN_NO_PINMUX
#define PIN_HDMI_2_PWR5V 	PIN_NO_PINMUX
#define PIN_HDMI_3_HPD 		PIN_NO_PINMUX
#define PIN_HDMI_0_PWR5V 	PIN_NO_PINMUX
#define PIN_HDMI_3_PWR5V 	PIN_NO_PINMUX

#define PIN_HDMI_0_HPD_CBUS_MT5861 	(PDMX4|OFFSETMASK(31,30))
#define PIN_HDMI_3_HPD_MT5861 		(PDMX1|2)
...
extern void vCustGpioIsr(UINT16 u2IntIndex);
