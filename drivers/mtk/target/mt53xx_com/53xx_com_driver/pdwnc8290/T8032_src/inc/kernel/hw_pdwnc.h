...
#define IO_VIRT 0
#define IO_PDWNC_BASE (IO_VIRT + 0x0)

//Page VDOIN_SYS
#define PDWNC_CLKPDN (IO_PDWNC_BASE + 0x000)
...
#define PDWNC_IRCKSEL (IO_PDWNC_BASE + 0x004)
    #define FLD_IRCLKSEL Fld(4,0,AC_MSKB0)//[3:0]
#define PDWNC_PDMISC (IO_PDWNC_BASE + 0x008)
...
#define PDWNC_PDMODE (IO_PDWNC_BASE + 0x010)
    #define FLD_DEEP_SLEEP Fld(1,5,AC_MSKB0)//[5:5]
#define PDWNC_MEMPD (IO_PDWNC_BASE + 0x014)
    #define FLD_MEMPD Fld(8,0,AC_FULLB0)//[7:0]
#define PDWNC_PWROPT (IO_PDWNC_BASE + 0x018)
    #define FLD_PWR_CTL_OPT Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_WAKE_STONLY0 (IO_PDWNC_BASE + 0x020)
...
#define PDWNC_TOUT_RSTCNT (IO_PDWNC_BASE + 0x024)
    #define FLD_TOUT_RSTCNT Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_TOUT_CNT_MON (IO_PDWNC_BASE + 0x028)
    #define FLD_TOUT_CNT_MON Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_MT8193_CLK_SEL (IO_PDWNC_BASE + 0x02C)
    #define FLD_MT8193_CLK_SEL Fld(2,0,AC_MSKB0)//[1:0]
#define PDWNC_HDMI_EDID_DET (IO_PDWNC_BASE + 0x030)
...
#define PDWNC_HDMI_EDID_DET_INTSTA (IO_PDWNC_BASE + 0x034)
...
#define PDWNC_HDMI_EDID_DET_INTEN (IO_PDWNC_BASE + 0x038)
...
#define PDWNC_HDMI_EDID_DET_INTCLR (IO_PDWNC_BASE + 0x03C)
...
#define PDWNC_T8032_INTEN (IO_PDWNC_BASE + 0x04C)
...
#define PDWNC_WDTINT_STA (IO_PDWNC_BASE + 0x050)
    #define FLD_WDT_INT_STA Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WDTINT_EN (IO_PDWNC_BASE + 0x054)
    #define FLD_WDT_INT_EN Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WDTINT_CLR (IO_PDWNC_BASE + 0x058)
    #define FLD_WDT_INT_CLR Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_EXT_INTSTA_0 (IO_PDWNC_BASE + 0x05C)
    #define FLD_GPIO_INT_STA0 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_EXT_INTSTA_1 (IO_PDWNC_BASE + 0x060)
...
#define PDWNC_T8032_EXT_INTEN_0 (IO_PDWNC_BASE + 0x074)
    #define FLD_T8032_GPIO_INTEN0 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_T8032_EXT_INTEN_1 (IO_PDWNC_BASE + 0x078)
    #define FLD_T8032_GPIO_INTEN1 Fld(21,0,AC_MSKDW)//[20:0]
#define PDWNC_WAKEN1 (IO_PDWNC_BASE + 0x080)
    #define FLD_EXTIO_WAKEN1 Fld(31,0,AC_MSKDW)//[30:0]
#define PDWNC_WAKE_STONLY1 (IO_PDWNC_BASE + 0x084)
    #define FLD_WAK_STON1_EN Fld(31,0,AC_MSKDW)//[30:0]
#define PDWNC_PDSTAT1 (IO_PDWNC_BASE + 0x088)
    #define FLD_PDSTAT1 Fld(31,0,AC_MSKDW)//[30:0]
#define PDWNC_PDWNC_MON (IO_PDWNC_BASE + 0x09C)
    #define FLD_PDWNC_MONITOR Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_WDTCTL (IO_PDWNC_BASE + 0x100)
...
#define PDWNC_PDCODE (IO_PDWNC_BASE + 0x124)
    #define FLD_PDCODE Fld(8,0,AC_FULLB0)//[7:0]
#define PDWNC_PDSTAT0 (IO_PDWNC_BASE + 0x128)
...
#define PDWNC_PD_PWM0C1 (IO_PDWNC_BASE + 0x13C)
    #define FLD_PWM0P Fld(25,0,AC_MSKDW)//[24:0]
#define PDWNC_RESRV0 (IO_PDWNC_BASE + 0x140)
    #define FLD_RESRV0 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV1 (IO_PDWNC_BASE + 0x144)
    #define FLD_RESRV1 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV2 (IO_PDWNC_BASE + 0x148)
    #define FLD_RESRV2 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV3 (IO_PDWNC_BASE + 0x14C)
    #define FLD_RESRV3 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_AC_TIMER (IO_PDWNC_BASE + 0x154)
    #define FLD_TIME Fld(20,0,AC_MSKDW)//[19:0]
#define PDWNC_PD_PWM1C0 (IO_PDWNC_BASE + 0x158)
...
#define PDWNC_PD_PWM1C1 (IO_PDWNC_BASE + 0x15C)
    #define FLD_PWM1P Fld(25,0,AC_MSKDW)//[24:0]
#define PDWNC_SM1CTL0 (IO_PDWNC_BASE + 0x160)
...
//Page VDOIN_SYS_2
#define PDWNC_SM1CTL1 (IO_PDWNC_BASE + 0x164)
...
#define PDWNC_SM1D0 (IO_PDWNC_BASE + 0x168)
...
#define PDWNC_SM1D1 (IO_PDWNC_BASE + 0x16C)
...
#define PDWNC_UP_ADDR (IO_PDWNC_BASE + 0x170)
    #define FLD_UP_ADDR Fld(16,0,AC_FULLW10)//[15:0]
#define PDWNC_UP_DATA (IO_PDWNC_BASE + 0x174)
    #define FLD_UP_DATA Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_UP_CFG (IO_PDWNC_BASE + 0x178)
...
#define PDWNC_SHREG0 (IO_PDWNC_BASE + 0x180)
    #define FLD_SHREG0 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_SHREG1 (IO_PDWNC_BASE + 0x184)
    #define FLD_SHREG1 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_SHREG2 (IO_PDWNC_BASE + 0x188)
    #define FLD_SHREG2 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_SHREG3 (IO_PDWNC_BASE + 0x18C)
    #define FLD_SHREG3 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_EDID_DEV0 (IO_PDWNC_BASE + 0x190)
...
#define PDWNC_EDID_DEV1 (IO_PDWNC_BASE + 0x194)
...
#define PDWNC_EDID_DEV2 (IO_PDWNC_BASE + 0x198)
...
#define PDWNC_EDID_DEV3 (IO_PDWNC_BASE + 0x19C)
...
#define PDWNC_EDID_CTL1 (IO_PDWNC_BASE + 0x1A4)
...
#define PDWNC_EDID_CTL2 (IO_PDWNC_BASE + 0x1A8)
...
#define PDWNC_EDID_CTL3 (IO_PDWNC_BASE + 0x1AC)
...
#define PDWNC_SM0CTL1 (IO_PDWNC_BASE + 0x1C4)
...
#define PDWNC_SM0D0 (IO_PDWNC_BASE + 0x1C8)
...
#define PDWNC_SM0D1 (IO_PDWNC_BASE + 0x1CC)
...
#define PDWNC_VGA_DEV (IO_PDWNC_BASE + 0x1D0)
...
#define PDWNC_VGA_ADDR (IO_PDWNC_BASE + 0x1D4)
    #define FLD_VGA_ADDR Fld(6,0,AC_MSKB0)//[5:0]
#define PDWNC_VGA_DATA (IO_PDWNC_BASE + 0x1D8)
    #define FLD_VGA_DATA Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_ARM_INT (IO_PDWNC_BASE + 0x1E8)
    #define FLD_ARM_INT Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_AUX_INT (IO_PDWNC_BASE + 0x1F4)
    #define FLD_AUX_INT Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_IRCNT (IO_PDWNC_BASE + 0x200)
...
#define PDWNC_IRDATA0 (IO_PDWNC_BASE + 0x204)
...
#define PDWNC_IRDATA1 (IO_PDWNC_BASE + 0x208)
...
#define PDWNC_IRCFGH (IO_PDWNC_BASE + 0x20C)
...
#define PDWNC_EXP_IR0 (IO_PDWNC_BASE + 0x228)
...
#define PDWNC_EXP_IR1 (IO_PDWNC_BASE + 0x22C)
...
#define PDWNC_EXP_IR2 (IO_PDWNC_BASE + 0x230)
...
#define PDWNC_EXP_IR3 (IO_PDWNC_BASE + 0x234)
...
#define PDWNC_EXP_IR4 (IO_PDWNC_BASE + 0x238)
...
#define PDWNC_EXP_IR5 (IO_PDWNC_BASE + 0x23C)
...
#define PDWNC_EXP_IR6 (IO_PDWNC_BASE + 0x240)
...
#define PDWNC_EXP_IR7 (IO_PDWNC_BASE + 0x244)
...
#define PDWNC_EXP_IR8 (IO_PDWNC_BASE + 0x248)
...
#define PDWNC_EXP_IR9 (IO_PDWNC_BASE + 0x24C)
...
#define PDWNC_EXP_IR10 (IO_PDWNC_BASE + 0x250)
...
#define PDWNC_EXP_IR11 (IO_PDWNC_BASE + 0x254)
...
#define PDWNC_EXP_IR12 (IO_PDWNC_BASE + 0x258)
...
#define PDWNC_EXP_IR13 (IO_PDWNC_BASE + 0x25C)
...
#define PDWNC_EXP_IR14 (IO_PDWNC_BASE + 0x260)
...
#define PDWNC_EXP_IR15 (IO_PDWNC_BASE + 0x264)
...
#define PDWNC_EXP_BCNT (IO_PDWNC_BASE + 0x268)
    #define FLD_EXP_BITCNT Fld(6,0,AC_MSKB0)//[5:0]
#define PDWNC_RCMM_THD0 (IO_PDWNC_BASE + 0x26C)
...
#define PDWNC_IRDATA3 (IO_PDWNC_BASE + 0x294)
...
//Page VDOIN_SYS_3
#define PDWNC_PD_PWM2C0 (IO_PDWNC_BASE + 0x2A0)
...
#define PDWNC_PD_PWM2C1 (IO_PDWNC_BASE + 0x2A4)
    #define FLD_PWM2P Fld(25,0,AC_MSKDW)//[24:0]
#define PDWNC_PD_PWM3C0 (IO_PDWNC_BASE + 0x2A8)
...
#define PDWNC_PD_PWM3C1 (IO_PDWNC_BASE + 0x2AC)
    #define FLD_PWM3P Fld(25,0,AC_MSKDW)//[24:0]
#define PDWNC_CHKDATA0 (IO_PDWNC_BASE + 0x2BC)
...
#define PDWNC_CHKDATA1 (IO_PDWNC_BASE + 0x2C0)
...
#define PDWNC_CHKDATA2 (IO_PDWNC_BASE + 0x2C4)
...
#define PDWNC_CHKDATA3 (IO_PDWNC_BASE + 0x2C8)
...
#define PDWNC_CHKDATA4 (IO_PDWNC_BASE + 0x2CC)
...
#define PDWNC_CHKDATA5 (IO_PDWNC_BASE + 0x2D0)
...
#define PDWNC_CHKDATA6 (IO_PDWNC_BASE + 0x2D4)
...
#define PDWNC_CHKDATA7 (IO_PDWNC_BASE + 0x2D8)
...
#define PDWNC_CHKDATA8 (IO_PDWNC_BASE + 0x2DC)
...
#define PDWNC_CHKDATA9 (IO_PDWNC_BASE + 0x2E0)
...
#define PDWNC_CHKDATA10 (IO_PDWNC_BASE + 0x2E4)
...
#define PDWNC_CHKDATA11 (IO_PDWNC_BASE + 0x2E8)
...
#define PDWNC_CHKDATA12 (IO_PDWNC_BASE + 0x2EC)
...
#define PDWNC_CHKDATA13 (IO_PDWNC_BASE + 0x2F0)
...
#define PDWNC_CHKDATA14 (IO_PDWNC_BASE + 0x2F4)
...
#define PDWNC_CHKDATA15 (IO_PDWNC_BASE + 0x2F8)
...
#define PDWNC_CHKDATA16 (IO_PDWNC_BASE + 0x2FC)
...
#define PDWNC_SRVCFG0 (IO_PDWNC_BASE + 0x300)
...
#define PDWNC_SRVSWT (IO_PDWNC_BASE + 0x308)
    #define FLD_SWTRG Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_SRVCLR (IO_PDWNC_BASE + 0x30C)
    #define FLD_ADCLR Fld(1,1,AC_MSKB0)//[1:1]
#define PDWNC_SRVRAT (IO_PDWNC_BASE + 0x310)
    #define FLD_SMP_RATE Fld(16,0,AC_FULLW10)//[15:0]
#define PDWNC_SRVTOTEN (IO_PDWNC_BASE + 0x314)
...
#define PDWNC_WAKTOP0 (IO_PDWNC_BASE + 0x318)
    #define FLD_CH0TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM0 (IO_PDWNC_BASE + 0x31C)
    #define FLD_CH0BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG0 (IO_PDWNC_BASE + 0x320)
    #define FLD_CH0WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP1 (IO_PDWNC_BASE + 0x324)
    #define FLD_CH1TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM1 (IO_PDWNC_BASE + 0x328)
    #define FLD_CH1BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG1 (IO_PDWNC_BASE + 0x32C)
    #define FLD_CH1WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP2 (IO_PDWNC_BASE + 0x330)
    #define FLD_CH2TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM2 (IO_PDWNC_BASE + 0x334)
    #define FLD_CH2BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG2 (IO_PDWNC_BASE + 0x338)
    #define FLD_CH2WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP3 (IO_PDWNC_BASE + 0x33C)
    #define FLD_CH3TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM3 (IO_PDWNC_BASE + 0x340)
    #define FLD_CH3BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG3 (IO_PDWNC_BASE + 0x344)
    #define FLD_CH3WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP4 (IO_PDWNC_BASE + 0x348)
    #define FLD_CH4TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM4 (IO_PDWNC_BASE + 0x34C)
    #define FLD_CH4BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG4 (IO_PDWNC_BASE + 0x350)
    #define FLD_CH4WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP5 (IO_PDWNC_BASE + 0x354)
    #define FLD_CH5TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM5 (IO_PDWNC_BASE + 0x358)
    #define FLD_CH5BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG5 (IO_PDWNC_BASE + 0x35C)
    #define FLD_CH5WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP6 (IO_PDWNC_BASE + 0x360)
    #define FLD_CH6TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM6 (IO_PDWNC_BASE + 0x364)
    #define FLD_CH6BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG6 (IO_PDWNC_BASE + 0x368)
    #define FLD_CH6WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP7 (IO_PDWNC_BASE + 0x36C)
    #define FLD_CH7TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM7 (IO_PDWNC_BASE + 0x370)
    #define FLD_CH7BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG7 (IO_PDWNC_BASE + 0x374)
    #define FLD_CH7WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP8 (IO_PDWNC_BASE + 0x378)
    #define FLD_CH8TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM8 (IO_PDWNC_BASE + 0x37C)
    #define FLD_CH8BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG8 (IO_PDWNC_BASE + 0x380)
    #define FLD_CH8WKC Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_WAKTOP9 (IO_PDWNC_BASE + 0x384)
    #define FLD_CH9TOP Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_WAKBTM9 (IO_PDWNC_BASE + 0x388)
    #define FLD_CH9BTM Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_CHCFG9 (IO_PDWNC_BASE + 0x38C)
...
#define PDWNC_ADOUT1 (IO_PDWNC_BASE + 0x398)
    #define FLD_ADOUT1 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT2 (IO_PDWNC_BASE + 0x39C)
    #define FLD_ADOUT2 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT3 (IO_PDWNC_BASE + 0x3A0)
    #define FLD_ADOUT3 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT4 (IO_PDWNC_BASE + 0x3A4)
    #define FLD_ADOUT4 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT5 (IO_PDWNC_BASE + 0x3A8)
    #define FLD_ADOUT5 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT6 (IO_PDWNC_BASE + 0x3AC)
    #define FLD_ADOUT6 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT7 (IO_PDWNC_BASE + 0x3B0)
    #define FLD_ADOUT7 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT8 (IO_PDWNC_BASE + 0x3B4)
    #define FLD_ADOUT8 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT9 (IO_PDWNC_BASE + 0x3B8)
    #define FLD_ADOUT9 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUTA (IO_PDWNC_BASE + 0x3BC)
    #define FLD_ADOUTA Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUTB (IO_PDWNC_BASE + 0x3C0)
    #define FLD_ADOUTB Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUTC (IO_PDWNC_BASE + 0x3C4)
    #define FLD_ADOUTC Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUTD (IO_PDWNC_BASE + 0x3C8)
    #define FLD_ADOUTD Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUTE (IO_PDWNC_BASE + 0x3CC)
    #define FLD_ADOUTE Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUTF (IO_PDWNC_BASE + 0x3D0)
    #define FLD_ADOUTF Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT10 (IO_PDWNC_BASE + 0x3D4)
    #define FLD_ADOUT10 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT11 (IO_PDWNC_BASE + 0x3D8)
    #define FLD_ADOUT11 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT12 (IO_PDWNC_BASE + 0x3DC)
    #define FLD_ADOUT12 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_PRST (IO_PDWNC_BASE + 0x3E0)
...
#define PDWNC_PRST_3 (IO_PDWNC_BASE + 0x3EC)
    #define FLD_VOLTAGE_CHF Fld(12,0,AC_MSKW10)//[11:0]
#define PDWNC_VGA_WAKE_UP_CONTROL_0_REGISTER (IO_PDWNC_BASE + 0x400)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_1_REGISTER (IO_PDWNC_BASE + 0x404)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_2_REGISTER (IO_PDWNC_BASE + 0x408)
...
//Page VDOIN_SYS_4
#define PDWNC_VGA_WAKE_UP_CONTROL_3_REGISTER (IO_PDWNC_BASE + 0x40C)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_4_REGISTER (IO_PDWNC_BASE + 0x410)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_5_REGISTER (IO_PDWNC_BASE + 0x414)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_6_REGISTER (IO_PDWNC_BASE + 0x418)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_7_REGISTER (IO_PDWNC_BASE + 0x41C)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_8_REGISTER (IO_PDWNC_BASE + 0x420)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_9_REGISTER (IO_PDWNC_BASE + 0x424)
...
#define PDWNC_VGA_WAKE_UP_CONTROL_A_REGISTER (IO_PDWNC_BASE + 0x428)
...
#define PDWNC_VGA_WAKE_UP_STATUS_0_REGISTER (IO_PDWNC_BASE + 0x430)
...
#define PDWNC_VGA_WAKE_UP_STATUS_1_REGISTER (IO_PDWNC_BASE + 0x434)
...
#define PDWNC_VGA_WAKE_UP_STATUS_2_REGISTER (IO_PDWNC_BASE + 0x438)
...
#define PDWNC_VGA_WAKE_UP_STATUS_3_REGISTER (IO_PDWNC_BASE + 0x43C)
...
#define PDWNC_IOEXT_INCFG (IO_PDWNC_BASE + 0x600)
...
#define PDWNC_IOEXT_INTRIG (IO_PDWNC_BASE + 0x604)
    #define FLD_IOEXT_IN_IOEXT_IN_TRIG Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_IOEXT_DATAIN (IO_PDWNC_BASE + 0x608)
    #define FLD_IOEXT_IN_INPUT_DATA Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_IOEXT_OUTCFG0 (IO_PDWNC_BASE + 0x60C)
...
#define PDWNC_IOEXT_OUTCFG1 (IO_PDWNC_BASE + 0x610)
    #define FLD_AUTO_ENABLE Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_IOEXT_OUTTRIG (IO_PDWNC_BASE + 0x614)
    #define FLD_IOEXT_OUT_TRIG Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_IOEXT_DATAOUT_EN (IO_PDWNC_BASE + 0x618)
    #define FLD_OUTPUT_DATA_ENABLE Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_IOEXT_DATAOUT (IO_PDWNC_BASE + 0x61C)
    #define FLD_OUTPUT_DATA Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV4 (IO_PDWNC_BASE + 0x620)
    #define FLD_RESRV4 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV5 (IO_PDWNC_BASE + 0x624)
    #define FLD_RESRV5 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV6 (IO_PDWNC_BASE + 0x628)
    #define FLD_RESRV6 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV7 (IO_PDWNC_BASE + 0x62C)
    #define FLD_RESRV7 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_RESRV8 (IO_PDWNC_BASE + 0x630)
...
#define PDWNC_PINMUX0 (IO_PDWNC_BASE + 0x684)
    #define FLD_PDMUX0 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_PINMUX1 (IO_PDWNC_BASE + 0x688)
    #define FLD_PDMUX1 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_PINMUX2 (IO_PDWNC_BASE + 0x68C)
    #define FLD_PDMUX2 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_PINMUX3 (IO_PDWNC_BASE + 0x690)
    #define FLD_PDMUX3 Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_PADCFG0 (IO_PDWNC_BASE + 0x694)
    #define FLD_HDMI_0_SDA Fld(6,24,AC_MSKB3)//[29:24]
    #define FLD_HDMI_0_PWR5V Fld(6,16,AC_MSKB2)//[21:16]
    #define FLD_MHL_SENCE Fld(6,8,AC_MSKB1)//[13:8]
...
#define PDWNC_PADCFG1 (IO_PDWNC_BASE + 0x698)
    #define FLD_HDMI_1_SDA_SR Fld(6,24,AC_MSKB3)//[29:24]
    #define FLD_HDMI_1_HPD Fld(6,16,AC_MSKB2)//[21:16]
    #define FLD_HDMI_1_PWR5V Fld(6,8,AC_MSKB1)//[13:8]
...
#define PDWNC_PADCFG2 (IO_PDWNC_BASE + 0x69C)
    #define FLD_HDMI_2_SDA_SR Fld(6,24,AC_MSKB3)//[29:24]
    #define FLD_HDMI_2_HPD Fld(6,16,AC_MSKB2)//[21:16]
    #define FLD_HDMI_2_PWR5V Fld(6,8,AC_MSKB1)//[13:8]
...
#define PDWNC_PADCFG3 (IO_PDWNC_BASE + 0x6A0)
    #define FLD_HDMI_3_SDA_SR Fld(6,24,AC_MSKB3)//[29:24]
    #define FLD_HDMI_3_HPD Fld(6,16,AC_MSKB2)//[21:16]
    #define FLD_HDMI_3_PWR5V Fld(6,8,AC_MSKB1)//[13:8]
...
#define PDWNC_PADCFG4 (IO_PDWNC_BASE + 0x6A4)
...
#define PDWNC_PADCFG5 (IO_PDWNC_BASE + 0x6A8)
...
#define PDWNC_PADCFG6 (IO_PDWNC_BASE + 0x6AC)
...
#define PDWNC_PADCFG7 (IO_PDWNC_BASE + 0x6B0)
...
#define PDWNC_PADCFG8 (IO_PDWNC_BASE + 0x6B4)
...
#define PDWNC_PADCFG9 (IO_PDWNC_BASE + 0x6B8)
...
#define PDWNC_PADCFG10 (IO_PDWNC_BASE + 0x6BC)
...
#define PDWNC_PADCFG11 (IO_PDWNC_BASE + 0x6C0)
...
#define PDWNC_PADCFG12 (IO_PDWNC_BASE + 0x6C4)
...
#define PDWNC_PADCFG13 (IO_PDWNC_BASE + 0x6C8)
...
#define PDWNC_PADCFG14 (IO_PDWNC_BASE + 0x6CC)
...
//Page VDOIN_SYS_5
#define PDWNC_PADCFG15 (IO_PDWNC_BASE + 0x6D0)
...
#define PDWNC_PADCFG16 (IO_PDWNC_BASE + 0x6D4)
    #define FLD_OPCTRL20 Fld(6,8,AC_MSKB1)//[13:8]
    #define FLD_OPCTRL19 Fld(6,0,AC_MSKB0)//[5:0]
#define PDWNC_PADCFG17 (IO_PDWNC_BASE + 0x6D8)
...
#define PDWNC_LEAPYEAR (IO_PDWNC_BASE + 0x744)
    #define FLD_LY_REG Fld(2,0,AC_MSKB0)//[1:0]
#define PDWNC_PROT (IO_PDWNC_BASE + 0x748)
    #define FLD_PROT Fld(8,0,AC_FULLB0)//[7:0]
#define PDWNC_AWEEK2 (IO_PDWNC_BASE + 0x750)
    #define FLD_AWEEK_2 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK3 (IO_PDWNC_BASE + 0x754)
    #define FLD_AWEEK_3 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK4 (IO_PDWNC_BASE + 0x758)
    #define FLD_AWEEK_4 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK5 (IO_PDWNC_BASE + 0x75C)
    #define FLD_AWEEK_5 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK6 (IO_PDWNC_BASE + 0x760)
    #define FLD_AWEEK_6 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK7 (IO_PDWNC_BASE + 0x764)
    #define FLD_AWEEK_7 Fld(3,0,AC_MSKB0)//[2:0]
#define PDWNC_AWEEK_ENABLE (IO_PDWNC_BASE + 0x768)
    #define FLD_AWEEK_ENABLE Fld(7,0,AC_MSKB0)//[6:0]

//Page RS232_PD_RISC
#define PDWNC_DATAW (IO_PDWNC_BASE + 0x800)
    #define FLD_DATA Fld(32,0,AC_FULLDW)//[31:0]
#define PDWNC_STAB (IO_PDWNC_BASE + 0x804)
...
#define PDWNC_UART_PD_INT_EN (IO_PDWNC_BASE + 0x80C)
...
#define PDWNC_INT_ID (IO_PDWNC_BASE + 0x810)
...
#define PDWNC_RS232_MODE (IO_PDWNC_BASE + 0x818)
    #define FLD_RS232_MODE Fld(2,0,AC_MSKB0)//[1:0]
#define PDWNC_BUFFER_SIZE (IO_PDWNC_BASE + 0x81C)
    #define FLD_BUFFER_SIZE Fld(2,0,AC_MSKB0)//[1:0]
#define PDWNC_CCR (IO_PDWNC_BASE + 0x830)
...
#define PDWNC_UART_PD_STATUS (IO_PDWNC_BASE + 0x834)
...
#define PDWNC_BCR (IO_PDWNC_BASE + 0x838)
...
#define PDWNC_CONCFG2 (IO_PDWNC_BASE + 0x908)
    #define FLD_RG_DMSUS Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_LDOCFG0 (IO_PDWNC_BASE + 0x90C)
    #define FLD_RG_LDO_ABIST_PWD Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_CBUSREG_CFG0 (IO_PDWNC_BASE + 0x910)
...
#define PDWNC_SADCCFG0 (IO_PDWNC_BASE + 0x914)
...
#define PDWNC_VGACFG0 (IO_PDWNC_BASE + 0x918)
...
#define PDWNC_VGACFG1 (IO_PDWNC_BASE + 0x91C)
...
#define PDWNC_VGACFG2 (IO_PDWNC_BASE + 0x920)
...
#define PDWNC_VGACFG3 (IO_PDWNC_BASE + 0x924)
...
#define PDWNC_VGACFG4 (IO_PDWNC_BASE + 0x928)
...
#define PDWNC_VGACFG5 (IO_PDWNC_BASE + 0x92C)
    #define FLD_RG_SYNC2_VTL Fld(4,28,AC_MSKB3)//[31:28]
#define PDWNC_VGACFG6 (IO_PDWNC_BASE + 0x930)
    #define FLD_RG_SYNCREV2 Fld(8,24,AC_FULLB3)//[31:24]
#define PDWNC_XTALCFG0 (IO_PDWNC_BASE + 0x934)
...
#define PDWNC_ADOUT13 (IO_PDWNC_BASE + 0x950)
    #define FLD_ADOUT13 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT14 (IO_PDWNC_BASE + 0x954)
    #define FLD_ADOUT14 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT15 (IO_PDWNC_BASE + 0x958)
    #define FLD_ADOUT15 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT16 (IO_PDWNC_BASE + 0x95C)
    #define FLD_ADOUT16 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT17 (IO_PDWNC_BASE + 0x960)
    #define FLD_ADOUT17 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT18 (IO_PDWNC_BASE + 0x964)
    #define FLD_ADOUT18 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT19 (IO_PDWNC_BASE + 0x968)
    #define FLD_ADOUT19 Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT1A (IO_PDWNC_BASE + 0x96C)
    #define FLD_ADOUT1A Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT1B (IO_PDWNC_BASE + 0x970)
    #define FLD_ADOUT1B Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT1C (IO_PDWNC_BASE + 0x974)
    #define FLD_ADOUT1C Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT1D (IO_PDWNC_BASE + 0x978)
    #define FLD_ADOUT1D Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT1E (IO_PDWNC_BASE + 0x97C)
    #define FLD_ADOUT1E Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_ADOUT1F (IO_PDWNC_BASE + 0x980)
    #define FLD_ADOUT1F Fld(10,2,AC_MSKW10)//[11:2]
#define PDWNC_DDCCI_CFG (IO_PDWNC_BASE + 0xA00)
...
#define PDWNC_DDCCI_INTEN (IO_PDWNC_BASE + 0xA04)
...
#endif
#define PDWNC_DDCCI_INTCLR (IO_PDWNC_BASE + 0xA08)
...
#endif
#define PDWNC_DDCCI_INTST (IO_PDWNC_BASE + 0xA0C)
...
#define PDWNC_SM0D2 (IO_PDWNC_BASE + 0xC08)
...
#define PDWNC_SM0D3 (IO_PDWNC_BASE + 0xC0C)
...
#define PDWNC_SM0D4 (IO_PDWNC_BASE + 0xC10)
...
#define PDWNC_SM0D5 (IO_PDWNC_BASE + 0xC14)
...
#define PDWNC_SM0D6 (IO_PDWNC_BASE + 0xC18)
...
#define PDWNC_SM0D7 (IO_PDWNC_BASE + 0xC1C)
...
#define PDWNC_SM0D8 (IO_PDWNC_BASE + 0xC20)
...
#define PDWNC_SM1D2 (IO_PDWNC_BASE + 0xC30)
...
#define PDWNC_SM1D3 (IO_PDWNC_BASE + 0xC34)
...
#define PDWNC_SM1D4 (IO_PDWNC_BASE + 0xC38)
...
#define PDWNC_SM1D5 (IO_PDWNC_BASE + 0xC3C)
...
#define PDWNC_SM1D6 (IO_PDWNC_BASE + 0xC40)
...
#define PDWNC_SM1D7 (IO_PDWNC_BASE + 0xC44)
...
#define PDWNC_SM1D8 (IO_PDWNC_BASE + 0xC48)
...
#define PDWNC_SM2D2 (IO_PDWNC_BASE + 0xC58)
...
#define PDWNC_SM2D3 (IO_PDWNC_BASE + 0xC5C)
...
#define PDWNC_SM2D4 (IO_PDWNC_BASE + 0xC60)
...
#define PDWNC_SM2D5 (IO_PDWNC_BASE + 0xC64)
...
#define PDWNC_SM2D6 (IO_PDWNC_BASE + 0xC68)
...
#define PDWNC_SM2D7 (IO_PDWNC_BASE + 0xC6C)
...
#define PDWNC_SM2D8 (IO_PDWNC_BASE + 0xC70)
...
#define PDWNC_CBUS_LINK_01 (IO_PDWNC_BASE + 0xD38)
...
//Page VDOIN_SYS_7
#define PDWNC_CBUS_LINK_02 (IO_PDWNC_BASE + 0xD3C)
...
#define PDWNC_CBUS_LINK_03 (IO_PDWNC_BASE + 0xD40)
...
#define PDWNC_CBUS_LINK_04 (IO_PDWNC_BASE + 0xD44)
...
#define PDWNC_CBUS_LINK_05 (IO_PDWNC_BASE + 0xD48)
...
#define PDWNC_CBUS_LINK_06 (IO_PDWNC_BASE + 0xD4C)
...
#define PDWNC_CBUS_LINK_07 (IO_PDWNC_BASE + 0xD50)
...
#define PDWNC_CBUS_LINK_08 (IO_PDWNC_BASE + 0xD54)
...
#define PDWNC_CBUS_LINK_09 (IO_PDWNC_BASE + 0xD58)
...
#define PDWNC_CBUS_LINK_0A (IO_PDWNC_BASE + 0xD5C)
...
#define PDWNC_CBUS_LINK_0B (IO_PDWNC_BASE + 0xD60)
...
#define PDWNC_CBUS_LINK_0C (IO_PDWNC_BASE + 0xD64)
...
#define PDWNC_CBUS_LINK_0D (IO_PDWNC_BASE + 0xD68)
    #define FLD_INT_MASK Fld(17,0,AC_MSKDW)//[16:0]
#define PDWNC_CBUS_STA_00 (IO_PDWNC_BASE + 0xD6C)
...
#define PDWNC_CBUS_STA_01 (IO_PDWNC_BASE + 0xD70)
...
#define PDWNC_CBUS_LINK_BAK (IO_PDWNC_BASE + 0xD74)
...
#define PDWNC_CBUS_TRAN_00 (IO_PDWNC_BASE + 0xD80)
...
#define PDWNC_CBUS_TRAN_01 (IO_PDWNC_BASE + 0xD84)
...
#define PDWNC_CBUS_TRAN_02 (IO_PDWNC_BASE + 0xD88)
...
#define PDWNC_CBUS_TRAN_STA (IO_PDWNC_BASE + 0xD8C)
