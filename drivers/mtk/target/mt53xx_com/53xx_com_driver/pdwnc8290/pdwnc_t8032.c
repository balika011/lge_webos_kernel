...
INT32 _PDWNC_InitT8032(UINT32 u4Addr, UINT32 u4Size)
{
    ...
    vIO32Write4B(PDWNC_RESRV0,BSP_GetIcVersion());//Record IC version.
	...
	if(u4Val == PDWNC_WAKE_UP_REASON_WATCHDOG)
	{
		switch(u1IO32Read1B(PDWNC_RESRV5))
		{
			case 1:
			case 2:
				break;
			default:
				vIO32Write1B(PDWNC_RESRV5,0x03);
				break;
		}
	}
	else
	{
		vIO32Write1B(PDWNC_RESRV5,0x00);
	}
#endif
#endif
