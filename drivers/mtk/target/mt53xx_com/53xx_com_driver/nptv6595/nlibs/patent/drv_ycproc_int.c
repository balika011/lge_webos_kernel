...
#include "hw_ospe.h"
    ...
    #define CAP_EN Fld(1, 2, AC_MSKB0)
#define POS_MAIN 0x7884
	#define POS_Y Fld(11, 16, AC_MSKW32) //26:16
    #define POS_X Fld(11, 0, AC_MSKW10) //10:0
#define CAP_IN_DATA_MAIN 0x7890
    #define CAP_IN_CB Fld(10, 16, AC_MSKW32) //25:16
    #define CAP_IN_Y Fld(10, 0, AC_MSKW10) //9:0
#define CAP_IN_DATA_MAIN_CR 0x7894
    #define CAP_IN_CR Fld(10, 0, AC_MSKW10) //9:0
#define CAP_OUT_DATA_MAIN 0x7898
    #define CAP_OUT_CB Fld(11, 16, AC_MSKW32) //26:16
    #define CAP_OUT_Y Fld(10, 0, AC_MSKW10) //9:0
#define CAP_OUT_DATA_MAIN_CR 0x789c
    #define CAP_OUT_CR Fld(11, 0, AC_MSKW10) //10:0

#define LVDS_DUMP_01 0x77EC
  #define DUMP_SEL Fld(4, 28, AC_MSKB3)// 31:28
  #define DUMP_EN Fld(1, 27, AC_MSKB3)// 27
  #define LVDS_POS_Y Fld(11, 16, AC_MSKW32)// 16:26
  #define LVDS_POS_X Fld(12, 0, AC_MSKW10)// 0:11
    
#define LVDS_DUMP_02 0x77F0
  #define POS_OUT_R Fld(12, 16, AC_MSKW32) // 16:27
  #define POS_OUT_G Fld(12, 0, AC_MSKW10) // 0:11
    
#define LVDS_DUMP_03 0x77F4
  #define POS_OUT_B Fld(12, 0, AC_MSKW10) // 0:11


void vDrvOsDbgInfo(UINT16 u2PosX, UINT16 u2PosY, UINT16 u2RGB[3])
{
    vRegWriteFldMulti(LVDS_DUMP_01, P_Fld(u2PosX, LVDS_POS_X)|P_Fld(u2PosY, LVDS_POS_Y));

    // enable capture
    vRegWriteFldAlign(LVDS_DUMP_01, 1, DUMP_EN);
    ...
    vRegWriteFldAlign(LVDS_DUMP_01, 0, DUMP_EN);
}
...
void vDrvSceDbgInfo(UINT16 u2PosX, UINT16 u2PosY, UINT16 u2YCbCrIn[3], UINT16 u2YCbCrOut[3])
{
    ...
    //enable capture
    vRegWriteFldAlign(DBG_CFG, 1, CAP_EN);
    ...
    vRegWriteFldAlign(DBG_CFG, 0, CAP_EN);
