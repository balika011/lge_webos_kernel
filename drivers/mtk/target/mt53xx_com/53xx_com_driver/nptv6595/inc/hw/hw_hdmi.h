...
#define ANA_IF (IO_VIRT_HDMI+(IO_HDMI_BASE+0xc98))
  #define ANA_IF_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xc98))
  #define ANA_IF_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xc99))
  #define ANA_IF_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xc9a))
  #define ANA_IF_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xc9b))
    #define HDMI_REV Fld(32,0,AC_FULLDW)//[31:0]
...
#define ANA_INTF_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xca0))
  ...
  #define ANA_INTF_0_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xca3))
    #define RG_HDMI_ACBIAS Fld(2,30,AC_MSKB3)//[31:30]
    #define RG_HDMI_CDR_RST Fld(1,29,AC_MSKB3)//29
    #define RG_HDMI_CDR_STOP Fld(1,28,AC_MSKB3)//28
    #define RG_HDMI_ANAMON Fld(3,25,AC_MSKB3)//[27:25]
    #define RG_HDMI_ATEST_EN Fld(1,24,AC_MSKB3)//24
    #define RG_HDMI_CH0_CDRLPI Fld(7,16,AC_MSKB2)//[22:16]
    #define RG_HDMI_CH1_CDRLPI Fld(7,8,AC_MSKB1)//[14:8]
    #define RG_HDMI_CH2_CDRLPI Fld(7,0,AC_MSKB0)//[6:0]
#define ANA_INTF_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xca4))
  ...
  #define ANA_INTF_1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xca7))
    #define RG_HDMI_BAND_SEL_SW Fld(2,30,AC_MSKB3)//[31:30]
    #define RG_HDMI_BAND_SEL_SW_EN Fld(1,29,AC_MSKB3)//29
    #define RG_HDMI_CHAN12_EN Fld(1,28,AC_MSKB3)//28
    #define RG_HDMI_CKDT_AEN Fld(1,27,AC_MSKB3)//27
    #define RG_HDMI_CKDT_SET Fld(1,26,AC_MSKB3)//26
    #define RG_HDMI_CLKBIAS Fld(2,24,AC_MSKB3)//[25:24]
    #define RG_HDMI_CLKBUF_EN Fld(1,23,AC_MSKB2)//23
    #define RG_HDMI_DATA_RST Fld(1,22,AC_MSKB2)//22
    #define RG_HDMI_EQ_FILT Fld(4,16,AC_MSKB2)//[19:16]
    #define RG_HDMI_EQ_FIL_SEL Fld(3,13,AC_MSKB1)//[15:13]
    #define RG_HDMI_EQ_PD Fld(1,12,AC_MSKB1)//12
    #define RG_HDMI_EQ_PRBSCK_SEL Fld(1,11,AC_MSKB1)//11
    #define RG_HDMI_EQ_RST Fld(1,10,AC_MSKB1)//10
    #define RG_HDMI_EQ_SWRSTSEL Fld(1,9,AC_MSKB1)//9
    #define RG_HDMI_EQBIAS Fld(3,5,AC_MSKB0)//[7:5]
    #define RG_HDMI_FULL_EN Fld(1,4,AC_MSKB0)//4
    #define RG_HDMI_HY Fld(2,2,AC_MSKB0)//[3:2]
    #define RG_HDMI_IBMUX Fld(2,0,AC_MSKB0)//[1:0]
#define ANA_INTF_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xca8))
  ...
  #define ANA_INTF_2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcab))
    #define RG_HDMI_JITTST_DIV Fld(1,31,AC_MSKB3)//31
    #define RG_HDMI_JITTST_EN Fld(1,30,AC_MSKB3)//30
    #define RG_HDMI_JITTST_SEL Fld(1,29,AC_MSKB3)//29
    #define RG_HDMI_PI_EN Fld(1,28,AC_MSKB3)//28
    #define RG_HDMI_KPGAIN Fld(3,24,AC_MSKB3)//[26:24]
    #define RG_HDMI_PI_VCOB Fld(2,22,AC_MSKB2)//[23:22]
    #define RG_HDMI_PLLBIAS Fld(2,20,AC_MSKB2)//[21:20]
    #define RG_HDMI_PLLCK_EN Fld(1,19,AC_MSKB2)//19
    #define RG_HDMI_PREDIV_SW Fld(1,18,AC_MSKB2)//18
    #define RG_HDMI_PREDIV_SW_EN Fld(1,17,AC_MSKB2)//17
    #define RG_HDMI_RXAFE_EN_SW Fld(1,16,AC_MSKB2)//16
    #define RG_HDMI_RXAFECH0_EN Fld(1,15,AC_MSKB1)//15
    #define RG_HDMI_RXAFECH1_EN Fld(1,14,AC_MSKB1)//14
    #define RG_HDMI_RXAFECH2_EN Fld(1,13,AC_MSKB1)//13
    #define RG_HDMI_TERM_EN Fld(1,12,AC_MSKB1)//12
    #define RG_HDMI_ZSEL Fld(1,11,AC_MSKB1)//11
    #define RG_HDMI_RXMODE Fld(2,9,AC_MSKB1)//[10:9]
    #define RG_HDMI_TEST_SEL Fld(1,8,AC_MSKB1)//8
    #define RG_HDMI_VCTRL_EN Fld(1,7,AC_MSKB0)//7
    #define RG_HDMI_VCO_RSTB_SW Fld(1,6,AC_MSKB0)//6
    #define RG_HDMI_VCO_RSTB_SW_EN Fld(1,5,AC_MSKB0)//5
    #define RG_HDMI_EQ_GAIN Fld(2,0,AC_MSKB0)//[1:0]
#define ANA_INTF_3 (IO_HDMI_BASE + 0xCAC)
  #define ANA_INTF_3_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcac))
  #define ANA_INTF_3_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcad))
  #define ANA_INTF_3_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcae))
  #define ANA_INTF_3_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcaf))
    #define RG_HDMI_LFCCTL Fld(1,31,AC_MSKB3)//31
    #define RG_HDMI_LFRCTL_SW_EN Fld(1,30,AC_MSKB3)//30
    #define RG_HDMI_LFRCTL_SW Fld(1,29,AC_MSKB3)//29
    #define RG_HDMI_CHPP Fld(3,24,AC_MSKB3)//[26:24]
    #define RG_HDMI_CHPI Fld(3,20,AC_MSKB2)//[22:20]
    #define RG_HDMI_DEEPCLRCLK_PDB Fld(1,19,AC_MSKB2)//19
    #define RG_HDMI_DEEPCLRCLK_RSTN Fld(1,18,AC_MSKB2)//18
...
#define ECC_THRES1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcc0))
  #define ECC_THRES1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcc0))
  #define ECC_THRES1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcc1))
  #define ECC_THRES1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcc2))
  #define ECC_THRES1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xcc3))
...
#define N_HDMI_CTRL3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe28))
  #define N_HDMI_CTRL3_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe28))
  #define N_HDMI_CTRL3_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe29))
  #define N_HDMI_CTRL3_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2a))
  #define N_HDMI_CTRL3_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2b))
...
#define N_HDMI_CTRL4 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2c))
  #define N_HDMI_CTRL4_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2c))
  #define N_HDMI_CTRL4_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2d))
  #define N_HDMI_CTRL4_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2e))
  #define N_HDMI_CTRL4_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe2f))
...
#define CTS_HW_ADP1 (IO_HDMI_BASE + 0xE38)
	#define CTS_HW_ADP1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe38))
	#define CTS_HW_ADP1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe39))
	#define CTS_HW_ADP1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe3a))
	#define CTS_HW_ADP1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe3b))
...
#define CTS_HW_ADP2 (IO_HDMI_BASE + 0xE3C)
	#define CTS_HW_ADP2_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe3c))
	#define CTS_HW_ADP2_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe3d))
	#define CTS_HW_ADP2_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe3e))
	#define CTS_HW_ADP2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe3f))
    #define CTS_HW_ADP Fld(20,0,AC_MSKDW)//[19:0]
#define CTS_STATUS (IO_HDMI_BASE + 0xE40)
	#define CTS_STATUS_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe40))
	#define CTS_STATUS_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe41))
	#define CTS_STATUS_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe42))
	#define CTS_STATUS_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe43))
    #define CTS_STATUS_MONITOR_OUT Fld(32,0,AC_FULLDW)//[31:0]
#define CTS_HW_ADP3 (IO_HDMI_BASE + 0xE44)
	#define CTS_HW_ADP3_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe44))
	#define CTS_HW_ADP3_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe45))
	#define CTS_HW_ADP3_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe46))
	#define CTS_HW_ADP3_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe47))
    #define SDINOVRVAL_31_0 Fld(32,0,AC_FULLDW)//[31:0]
#define CTS_HW_ADP4 (IO_HDMI_BASE + 0xE48)
	#define CTS_HW_ADP4_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe48))
	#define CTS_HW_ADP4_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe49))
	#define CTS_HW_ADP4_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe4a))
	#define CTS_HW_ADP4_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe4b))
...
#define CTS_HW_ADP5 (IO_HDMI_BASE + 0xE4C)
	#define CTS_HW_ADP5_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe4c))
	#define CTS_HW_ADP5_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe4d))
	#define CTS_HW_ADP5_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe4e))
	#define CTS_HW_ADP5_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe4f))
    #define CTS_ADU_FREQ_DIFF Fld(16,0,AC_FULLW10)//[15:0]
#define CTS_HW_ADP6 (IO_HDMI_BASE + 0xE50)
	#define CTS_HW_ADP6_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe50))
	#define CTS_HW_ADP6_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe51))
	#define CTS_HW_ADP6_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe52))
	#define CTS_HW_ADP6_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe53))
    #define CTS_REAL_STABLE_CNT_TH Fld(16,8,AC_FULLW21)//[23:8]
    #define CTS_PRE_STABLE_CNT_TH Fld(8,0,AC_FULLB0)//[7:0]
#define CTS_HW_ADP7 (IO_HDMI_BASE + 0xE5C)
	#define CTS_HW_ADP7_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe54))
	#define CTS_HW_ADP7_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe55))
	#define CTS_HW_ADP7_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe56))
	#define CTS_HW_ADP7_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe57))
...
#define TMDS_CTRL_STATUS1 (IO_HDMI_BASE + 0xE60)
	#define TMDS_CTRL_STATUS1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe60))
	#define TMDS_CTRL_STATUS1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe61))
	#define TMDS_CTRL_STATUS1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe62))
	#define TMDS_CTRL_STATUS1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe63))
...
#define TMDS_CTRL_STATUS2 (IO_HDMI_BASE + 0xE64)
	#define TMDS_CTRL2_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe64))
	#define TMDS_CTRL2_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe65))
	#define TMDS_CTRL2_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe66))
	#define TMDS_CTRL2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe67))
...
#define TMDS_CTRL_STATUS3 (IO_HDMI_BASE + 0xE68)
	#define TMDS_CTRL_STATUS3_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe68))
	#define TMDS_CTRL_STATUS3_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe69))
	#define TMDS_CTRL_STATUS3_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe6a))
	#define TMDS_CTRL_STATUS3_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe6b))
...
#define TMDS_CTRL_STATUS4 (IO_HDMI_BASE + 0xE6C)
	#define TMDS_CTRL_STATUS4_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe6c))
	#define TMDS_CTRL_STATUS4_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe6d))
	#define TMDS_CTRL_STATUS4_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe6e))
	#define TMDS_CTRL_STATUS4_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe6f))
...
#define TMDS_CTRL_STATUS5 (IO_HDMI_BASE + 0xE70)
	#define TMDS_CTRL_STATUS5_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe70))
	#define TMDS_CTRL_STATUS5_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe71))
	#define TMDS_CTRL_STATUS5_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe72))
	#define TMDS_CTRL_STATUS5_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe73))
    #define CS1_PRBS_ERRCNT1 Fld(16,16,AC_FULLW32)//[31:16]
    #define CS0_PRBS_ERRCNT1 Fld(16,0,AC_FULLW10)//[15:0]
#define TMDS_CTRL_STATUS6 (IO_HDMI_BASE + 0xE74)
	#define TMDS_CTRL_STATUS6_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe74))
	#define TMDS_CTRL_STATUS6_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe75))
	#define TMDS_CTRL_STATUS6_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe76))
	#define TMDS_CTRL_STATUS6_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe77))
...
#define TMDS_CTRL_STATUS7 (IO_HDMI_BASE + 0xE78)
	#define TMDS_CTRL_STATUS7_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe78))
	#define TMDS_CTRL_STATUS7_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe79))
	#define TMDS_CTRL_STATUS7_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe7a))
	#define TMDS_CTRL_STATUS7_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe7b))
    #define DEBUG_CDR_DATA Fld(30,0,AC_MSKDW)//[29:0]
#define TMDS_CTRL8 (IO_HDMI_BASE + 0xE7C)
	#define TMDS_CTRL8_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe7c))
	#define TMDS_CTRL8_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe7d))
	#define TMDS_CTRL8_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe7e))
	#define TMDS_CTRL8_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe7f))
    #define DEBUG_FIFO_DATA Fld(30,0,AC_MSKDW)//[29:0]
#define TMDS_CTRL_STATUS9 (IO_HDMI_BASE + 0xE80)
	#define TMDS_CTRL_STATUS9_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe80))
	#define TMDS_CTRL_STATUS9_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe81))
	#define TMDS_CTRL_STATUS9_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe82))
	#define TMDS_CTRL_STATUS9_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe83))
...
#define TMDS_CTRL_STATUS10 (IO_HDMI_BASE + 0xE84)
	#define TMDS_CTRL_STATUS10_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe84))
	#define TMDS_CTRL_STATUS10_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe85))
	#define TMDS_CTRL_STATUS10_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe86))
	#define TMDS_CTRL_STATUS10_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe87))
...
#define TMDS_CTRL_STATUS11 (IO_HDMI_BASE + 0xE88)
	#define TMDS_CTRL_STATUS11_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe88))
	#define TMDS_CTRL_STATUS11_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe89))
	#define TMDS_CTRL_STATUS11_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe8a))
	#define TMDS_CTRL_STATUS11_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe8b))
...
#define TMDS_CTRL_STATUS12 (IO_HDMI_BASE + 0xE8C)
	#define TMDS_CTRL_STATUS12_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe8c))
	#define TMDS_CTRL_STATUS12_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe8d))
	#define TMDS_CTRL_STATUS12_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe8e))
	#define TMDS_CTRL_STATUS12_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe8f))
...
#define TMDS_CTRL_STATUS13 (IO_HDMI_BASE + 0xE90)
	#define TMDS_CTRL_STATUS13_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe90))
	#define TMDS_CTRL_STATUS13_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe91))
	#define TMDS_CTRL_STATUS13_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe92))
	#define TMDS_CTRL_STATUS13_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xe93))
