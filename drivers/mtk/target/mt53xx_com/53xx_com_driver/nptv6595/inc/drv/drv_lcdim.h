...
#ifndef _DRV_LCDIM_H_
#define _DRV_LCDIM_H_

// *-----------------------------------------------------------------------------
// * structure / global variables
// *-----------------------------------------------------------------------------
#define LCDIM_DIV_RES 2
#define LCDIM_CURVE_IDX 256
#define LCDIM_MAX_THD   990 // Max Threshold, 1000 as 100%
                            // in this example, we will discard pixels with level larger than 99% of pixels
#define LCDIM_LOOP_WAIT 30
#define LCDIM_CONTENT_INFO_MAX 800
#ifdef CC_MT5395 // add local data stretch support
#define LCDS_CURVE_IDX 9
#endif    
...
BOOL vDrvVerifyLcDimMappingCurve(void);
void vDrvLcDimPanelInit(void);
...
/////////////////////////////////////////////////////
void vDrvAdaptiveLcDim(void);
void vDrvAdaptiveLcDimUpdateParam(void);
void vDrvAdaptiveLcDimSetParam(void);
