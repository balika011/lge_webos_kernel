...
#define REG_HDMI_RX_Normal_0_CFG2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x008))
  ...
  #define REG_HDMI_RX_Normal_0_CFG2_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x00b))
    ...
    #define RG_HDMI_0_R2R_CK_SEL Fld(1,27,AC_MSKB3)//[27:27]
    ...
    #define RG_HDMI_0_TERM_MHL_SEL Fld(1,3,AC_MSKB0)//[3:3]
    #define RG_HDMI_0_TERM_CM_ENB Fld(1,2,AC_MSKB0)//[2:2]
...
#define REG_HDMI_RX_Normal_0_CFG3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x00c))
  ...
  #define REG_HDMI_RX_Normal_0_CFG3_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x00f))
    #define RG_HDMI_0_FM_SEL Fld(12,0,AC_MSKW10)//[11:0]
...
#define REG_HDMI_RX_Normal_0_CFG7 (IO_VIRT + (IO_HDMI_RX_BASE + 0x01c))
  #define REG_HDMI_RX_Normal_0_CFG7_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x01c))
  #define REG_HDMI_RX_Normal_0_CFG7_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x01d))
  #define REG_HDMI_RX_Normal_0_CFG7_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x01e))
  #define REG_HDMI_RX_Normal_0_CFG7_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x01f))
    #define RG_HDMI_0_PLL_EN Fld(1,31,AC_MSKB3)//[31:31]
    #define RG_HDMI_0_PLL_FBKDIV Fld(7,24,AC_MSKB3)//[30:24]
    #define RG_HDMI_0_PLL_DDSFBK_EN Fld(1,23,AC_MSKB2)//[23:23]
    #define RG_HDMI_0_PLL_RLH_EN Fld(1,22,AC_MSKB2)//[22:22]
    #define RG_HDMI_0_PLL_FBKSEL Fld(2,20,AC_MSKB2)//[21:20]
    #define RG_HDMI_0_PLL_PREDIV Fld(2,18,AC_MSKB2)//[19:18]
    #define RG_HDMI_0_PLL_POSDIV Fld(2,16,AC_MSKB2)//[17:16]
    #define RG_HDMI_0_PLL_IC Fld(4,12,AC_MSKB1)//[15:12]
    #define RG_HDMI_0_PLL_IR Fld(4,8,AC_MSKB1)//[11:8]
    #define RG_HDMI_0_PLL_BP Fld(4,4,AC_MSKB0)//[7:4]
    #define RG_HDMI_0_PLL_BC Fld(2,2,AC_MSKB0)//[3:2]
    #define RG_HDMI_0_PLL_BR Fld(2,0,AC_MSKB0)//[1:0]
#define REG_HDMI_RX_Normal_0_CFG8 (IO_VIRT + (IO_HDMI_RX_BASE + 0x020))
  #define REG_HDMI_RX_Normal_0_CFG8_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x020))
  #define REG_HDMI_RX_Normal_0_CFG8_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x021))
  #define REG_HDMI_RX_Normal_0_CFG8_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x022))
  #define REG_HDMI_RX_Normal_0_CFG8_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x023))
    #define RG_HDMI_0_PLL_AUTOK_LOAD Fld(1,31,AC_MSKB3)//[31:31]
    #define RG_HDMI_0_PLL_DIVEN Fld(3,28,AC_MSKB3)//[30:28]
    #define RG_HDMI_0_PLL_AUTOK_KS Fld(2,26,AC_MSKB3)//[27:26]
    #define RG_HDMI_0_PLL_AUTOK_KF Fld(2,24,AC_MSKB3)//[25:24]
    #define RG_HDMI_0_PLL_AUTOK_EN Fld(1,23,AC_MSKB2)//[23:23]
    #define RG_HDMI_0_PLL_BAND Fld(7,16,AC_MSKB2)//[22:16]
    #define RG_HDMI_0_PLL_MONCK_EN Fld(1,15,AC_MSKB1)//[15:15]
    #define RG_HDMI_0_PLL_MONVC_EN Fld(1,14,AC_MSKB1)//[14:14]
    #define RG_HDMI_0_PLL_MONREF_EN Fld(1,13,AC_MSKB1)//[13:13]
    #define RG_HDMI_0_PLL_LVROD_EN Fld(1,12,AC_MSKB1)//[12:12]
    #define RG_HDMI_0_PLL_BIAS_LPF_EN Fld(1,11,AC_MSKB1)//[11:11]
    #define RG_HDMI_0_PLL_BIAS_EN Fld(1,10,AC_MSKB1)//[10:10]
    #define RG_HDMI_0_PLL_RST_DLY Fld(2,8,AC_MSKB1)//[9:8]
    #define RG_HDMI_0_PLL_RESERVE Fld(8,0,AC_FULLB0)//[7:0]
#define REG_HDMI_RX_Normal_0_CFG9 (IO_VIRT + (IO_HDMI_RX_BASE + 0x024))
  #define REG_HDMI_RX_Normal_0_CFG9_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x024))
  #define REG_HDMI_RX_Normal_0_CFG9_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x025))
  #define REG_HDMI_RX_Normal_0_CFG9_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x026))
  #define REG_HDMI_RX_Normal_0_CFG9_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x027))
    #define RG_HDMI_0_PLL_BRA Fld(1,28,AC_MSKB3)//[28:28]
    #define RG_HDMI_0_PLL_BCA Fld(1,24,AC_MSKB3)//[24:24]
    #define RG_HDMI_0_PLL_DIVENA Fld(3,20,AC_MSKB2)//[22:20]
    #define RG_HDMI_0_PLL_ICADJ Fld(2,18,AC_MSKB2)//[19:18]
    #define RG_HDMI_0_PLL_KVSEL Fld(2,16,AC_MSKB2)//[17:16]
    #define RG_HDMI_0_PLL_VCO_BAND Fld(5,8,AC_MSKB1)//[12:8]
    #define RG_HDMI_0_PLL_DIVCTRL Fld(2,4,AC_MSKB0)//[5:4]
    #define RG_HDMI_0_PLL_DETEN Fld(1,2,AC_MSKB0)//[2:2]
    #define RG_HDMI_0_PLL_DIV2_SEL Fld(1,0,AC_MSKB0)//[0:0]
#define RGS_HDMI_RX_Normal_0_CFGA (IO_VIRT + (IO_HDMI_RX_BASE + 0x028))
  #define RGS_HDMI_RX_Normal_0_CFGA_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x028))
  #define RGS_HDMI_RX_Normal_0_CFGA_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x029))
  #define RGS_HDMI_RX_Normal_0_CFGA_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x02a))
  #define RGS_HDMI_RX_Normal_0_CFGA_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x02b))
...
#define RGS_HDMI_RX_Normal_0_CFGB (IO_VIRT + (IO_HDMI_RX_BASE + 0x02C))
  #define RGS_HDMI_RX_Normal_0_CFGB_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x02C))
  #define RGS_HDMI_RX_Normal_0_CFGB_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x02D))
  #define RGS_HDMI_RX_Normal_0_CFGB_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x02E))
  #define RGS_HDMI_RX_Normal_0_CFGB_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x02F))
...
#define RGS_HDMI_RX_Normal_0_CFGC (IO_VIRT + (IO_HDMI_RX_BASE + 0x030))
  #define RGS_HDMI_RX_Normal_0_CFGC_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x030))
  #define RGS_HDMI_RX_Normal_0_CFGC_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x031))
  #define RGS_HDMI_RX_Normal_0_CFGC_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x032))
  #define RGS_HDMI_RX_Normal_0_CFGC_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x033))
...
#define RGS_HDMI_RX_Normal_0_CFGD (IO_VIRT + (IO_HDMI_RX_BASE + 0x034))
  #define RGS_HDMI_RX_Normal_0_CFGD_0 (IO_VIRT + (IO_HDMI_RX_BASE + 0x034))
  #define RGS_HDMI_RX_Normal_0_CFGD_1 (IO_VIRT + (IO_HDMI_RX_BASE + 0x035))
  #define RGS_HDMI_RX_Normal_0_CFGD_2 (IO_VIRT + (IO_HDMI_RX_BASE + 0x036))
  #define RGS_HDMI_RX_Normal_0_CFGD_3 (IO_VIRT + (IO_HDMI_RX_BASE + 0x037))
    #define RGS_HDMI_0_CH0_EQMM Fld(1,30,AC_MSKB3)//[30:30]
    #define RGS_HDMI_0_CH1_EQMM Fld(1,29,AC_MSKB3)//[29:29]
    #define RGS_HDMI_0_CH2_EQMM Fld(1,28,AC_MSKB3)//[28:28]
    #define RGS_HDMI_0_PLL_AUTOK_PASS Fld(1,25,AC_MSKB3)//[25:25]
    #define RGS_HDMI_0_PLL_AUTOK_FAIL Fld(1,24,AC_MSKB3)//[24:24]
    #define RGS_HDMI_0_PLL_AUTOK_BAND Fld(7,16,AC_MSKB2)//[22:16]
...
#define HDMI_SEL (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc4))
  ...
  #define HDMI_SEL_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc7))
    ...
    #define REG_HDMI2_AUD_SEL Fld(1, 28, AC_MSKB3) //28
...
#define MHL_REG (IO_VIRT_HDMI + (IO_HDMI_BASE+0xeB4))
    ...
    #define REG_HDMI_IMPSEL Fld(5,24,AC_MSKB3)//[28:24]
...
#define ACR_CTRL3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x118))
  ...
  #define ACR_CTRL3_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x11b))
  	#define REG_CTRL_RESERVED Fld(2,25,AC_MSKB3)//26:25
...
#define CALIBRATION_REG (IO_VIRT_HDMI + (IO_HDMI_BASE+0x2B8))
    #define AD_HDMI_0_IMPCOMP Fld(1,5,AC_MSKB0)//[5:5]
