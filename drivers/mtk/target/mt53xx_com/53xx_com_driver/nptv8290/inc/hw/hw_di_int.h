...
#define MCVP_FUSION_2C (IO_MDDI_BASE + 0x2B0)
    #define IF_HD_HOR_MID_F_SUM Fld(8,24,AC_FULLB3)//[31:24]
    #define IF_HD_H_M_DEAD_ZONE Fld(8,16,AC_FULLB2)//[23:16]
...
#define MCVP_FUSION_2D (IO_MDDI_BASE + 0x2B4)
    #define IF_PROG_MODE Fld(1,25,AC_MSKB3)//[25:25]
    #define IF_HD_H_FF_SEL Fld(1,24,AC_MSKB3)//[24:24]
    #define IF_HD_H_MI_NORMALIZ Fld(4,20,AC_MSKB2)//[23:20]
    #define IF_HD_H_HI_NORMALIZ Fld(4,16,AC_MSKB2)//[19:16]
    #define IF_HD_ROI_V Fld(8,8,AC_FULLB1)//[15:8]
    #define IF_HD_ROI_H Fld(8,0,AC_FULLB0)//[7:0]
