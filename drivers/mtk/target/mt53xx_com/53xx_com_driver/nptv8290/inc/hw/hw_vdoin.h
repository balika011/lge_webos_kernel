...
#define fgIsVdoIntW2dL() 	fgIsVdoinInt(INTR_W2DL_MSK)
#define fgIsVdoIntW2dR() 	fgIsVdoinInt(INTR_W2DR_MSK)
...
#define INTR_W2DL_MSK		Fld2Msk32(INTR_W2D_LEFT)
#define INTR_W2DR_MSK		Fld2Msk32(INTR_W2D_RIGHT)
