...
#define MATRIX_00     u4SWReg(0x0050)
	#define HDMIPCLEVELDETECTEN  Fld(1, 20, AC_MSKB2) // 20
...
#define METER_INFO_01    u4SWReg(0x0104)
    #define METER_LUMA_SUM        Fld(32, 0, AC_MSKDW) //31:0
...
#define LUMA_HIST_END       u4SWReg(0x01BC)
    #define METER_LUMA_HIST_PCNT64   Fld(16, 0, AC_FULLW10) 
...
#define METER_DEBUG         u4SWReg(0x0324)
...
#define METER_CFG_00     u4SWReg(0x0328)
...
#define ADAP_LUMA_04    u4SWReg(0x1054)
    ...
    #define SWREG_FULLRANGE_ONOFF			Fld(1,	20,	AC_MSKB0)	// 20	
...
#define ADAP_LUMA2_08    u4SWReg(0x1144)    // MJC moving box patch of mt5396 changelsit:903459 ,checked to cd lee ,it also do in Cobra
...
//=============================================================
	// BE comtrol
#define BETEST_00     u4SWReg(0x1200)
	#define VB1_STABLE_TH Fld(8, 8, AC_FULLB1) //0
...
#define SHARPNESS_ADPT_00     u4SWReg(0x2754)                                       	         
	#define TDSHP_EDGE_GAIN_H 		    Fld(8, 0, AC_FULLB0) //7:0
	#define TDSHP_EDGE_GAIN_D          Fld(8, 8, AC_FULLB1) //15:8
	#define TDSHP_EDGE_GAIN_V          Fld(8, 16, AC_FULLB2) //23:16 

#define SHARPNESS_ADPT_01     u4SWReg(0x2758)                                       	         
	#define TDSHP_DETAIL_GAIN_H 		    Fld(8, 0, AC_FULLB0) //7:0
	#define TDSHP_DETAIL_GAIN_D          Fld(8, 8, AC_FULLB1) //15:8
	#define TDSHP_DETAIL_GAIN_V          Fld(8, 16, AC_FULLB2) //23:16 

#define SHARPNESS_ADPT_02     u4SWReg(0x275C)                                       	         
	#define HSHP_GAIN_LOW_POS 		    Fld(8, 0, AC_FULLB0) //7:0
	#define HSHP_GAIN_LOW_NEG          Fld(8, 8, AC_FULLB1) //15:8
	#define HSHP_GAIN_MID_POS          Fld(8, 16, AC_FULLB2) //23:16 
	#define HSHP_GAIN_MID_NEG          Fld(8, 24, AC_FULLB3) //31:23 

#define SHARPNESS_ADPT_03     u4SWReg(0x2760)                                       	         
	#define HSHP_GAIN_HIGH_POS 		    Fld(8, 0, AC_FULLB0) //7:0
	#define HSHP_GAIN_HIGH_NEG          Fld(8, 8, AC_FULLB1) //15:8

#define SHARPNESS_ADPT_04     u4SWReg(0x2764)                                       	         
	#define HSHP_COR_LOW	 		    Fld(8, 0, AC_FULLB0) //7:0
	#define HSHP_COR_MID				Fld(8, 8, AC_FULLB1) //15:8
	#define HSHP_COR_HIGH	 	        Fld(8, 16, AC_FULLB2) //23:16 
...
#define TDSHP_EXT_OFST_06   u4SWReg(0x2918)
    #define HSHP_GAIN_LOWP_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define HSHP_GAIN_LOWN_OFST             Fld(8, 8, AC_FULLB1) //15:8
    #define HSHP_GAIN_MIDP_OFST             Fld(8, 16, AC_FULLB2) //23:16
    #define HSHP_GAIN_MIDN_OFST             Fld(8, 24, AC_FULLB3) //31:24
    
#define TDSHP_EXT_OFST_07   u4SWReg(0x291C)
    #define HSHP_GAIN_HIGHP_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define HSHP_GAIN_HIGHN_OFST             Fld(8, 8, AC_FULLB1) //15:8
    
#define TDSHP_EXT_OFST_08   u4SWReg(0x2920)
    #define HSHP_CORZ_LOW_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define HSHP_CORZ_MID_OFST             Fld(8, 8, AC_FULLB1) //15:8
    #define HSHP_CORZ_HIGH_OFST             Fld(8, 16, AC_FULLB2) //23:16
    
#define TDSHP_EXT_OFST_09   u4SWReg(0x2924)
    #define TDS_EDGE_GAIN_H_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define TDS_EDGE_GAIN_D_OFST             Fld(8, 8, AC_FULLB1) //15:8
    #define TDS_EDGE_GAIN_V_OFST             Fld(8, 16, AC_FULLB2) //23:16
    
#define TDSHP_EXT_OFST_0A   u4SWReg(0x2928)
    #define TDS_DETAIL_GAIN_H_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define TDS_DETAIL_GAIN_D_OFST             Fld(8, 8, AC_FULLB1) //15:8
    #define TDS_DETAIL_GAIN_V_OFST             Fld(8, 16, AC_FULLB2) //23:16
    
#define VI_SHP_EXT_OFST_0B			          0x292C
#define TDSHP_EXT_OFST_0B   u4SWReg(0x292C)
    #define LTI_GAIN_H1_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define LTI_GAIN_H2_OFST             Fld(8, 8, AC_FULLB1) //15:8
    #define LTI_GAIN_V_OFST             Fld(8, 16, AC_FULLB2) //23:16
    
#define TDSHP_EXT_OFST_0C   u4SWReg(0x2930)
    #define LTI_CORZ_H1_OFST             Fld(8, 0, AC_FULLB0) //7:0
    #define LTI_CORZ_H2_OFST             Fld(8, 8, AC_FULLB1) //15:8
    #define LTI_CORZ_V_OFST             Fld(8, 16, AC_FULLB2) //23:16
...
#define MJC_FW_SCH_08               u4SWReg(0x5318)
	...
	#define MJC_SW_FLIM_DETECT_LOG			Fld( 1, 23, AC_MSKDW) // [23:23]
	#define MJC_SW_FLIM_SEQ_LOG 			Fld( 1, 22, AC_MSKDW) // [22:22]
	#define MJC_SW_FLIM_DETRESULT_LOG		Fld( 1, 21, AC_MSKDW) // [21:21]
	#define MJC_SW_FLIM_DETRESULT_LOG_2 	Fld( 1, 20, AC_MSKDW) // [20:20]
	#define MJC_SW_FLIM_DETECT_LOG_ALL		Fld( 4, 20, AC_MSKDW) // [23:20]
	#define MJC_SW_FRM_LOG					Fld( 1, 19, AC_MSKDW) // [19:19]
	#define MJC_SW_FRM_LOG2 				Fld( 1, 18, AC_MSKDW) // [18:18]
	#define MJC_SW_FRM_LOG3 				Fld( 1, 17, AC_MSKDW) // [17:17]	
	#define MJC_SW_FRM_LOG4 				Fld( 1, 16, AC_MSKDW) // [16:16]
	#define MJC_SW_FRM_LOG5 				Fld( 1, 15, AC_MSKDW) // [15:15]
	#define MJC_SW_FRM_LOG6 				Fld( 1, 14, AC_MSKDW) // [14:14]
	#define MJC_SW_FRM_LOG7 				Fld( 1, 13, AC_MSKDW) // [13:13]	
	#define MJC_SW_FRM_LOG8 				Fld( 1, 12, AC_MSKDW) // [12:12]
	#define MJC_SW_FRM_LOG9 				Fld( 1, 11, AC_MSKDW) // [11:11]
...
#define MJC_FW_SCH_0A               u4SWReg(0x5328)
    ...
    #define MJC_FW_FRM_SCH_22323_THR        Fld( 8,  5, AC_MSKDW) //[12:5]
...
#define NR_PQ_1A    u4SWReg(0x8268)
    #define NR_TBL_MA_AUTO1_MIN_0 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO1_MIN_1 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO1_MIN_2 Fld(6,14,AC_MSKDW)//[19:14]
    #define NR_TBL_MA_AUTO1_MIN_3 Fld(6,8,AC_MSKDW)//[13:8]
    #define NR_TBL_MA_AUTO1_MIN_4 Fld(6,2,AC_MSKDW)//[7:2]
#define NR_PQ_1B    u4SWReg(0x826C)	
    #define NR_TBL_MA_AUTO1_MIN_5 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO1_MIN_6 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO1_MIN_7 Fld(6,14,AC_MSKDW)//[19:14]
    #define NR_AUTO_MODE		  Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_1C    u4SWReg(0x8270)
    #define NR_TBL_MA_AUTO1_MAX_0 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO1_MAX_1 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO1_MAX_2 Fld(6,14,AC_MSKDW)//[19:14]
    #define NR_TBL_MA_AUTO1_MAX_3 Fld(6,8,AC_MSKDW)//[13:8]
    #define NR_TBL_MA_AUTO1_MAX_4 Fld(6,2,AC_MSKDW)//[7:2]
#define NR_PQ_1D    u4SWReg(0x8274)	
    #define NR_TBL_MA_AUTO1_MAX_5 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO1_MAX_6 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO1_MAX_7 Fld(6,14,AC_MSKDW)//[19:14]
#define NR_PQ_1E    u4SWReg(0x8278)
    #define NR_TBL_MA_AUTO2_MIN_0 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO2_MIN_1 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO2_MIN_2 Fld(6,14,AC_MSKDW)//[19:14]
    #define NR_TBL_MA_AUTO2_MIN_3 Fld(6,8,AC_MSKDW)//[13:8]
    #define NR_TBL_MA_AUTO2_MIN_4 Fld(6,2,AC_MSKDW)//[7:2]
#define NR_PQ_1F    u4SWReg(0x827C)	
    #define NR_TBL_MA_AUTO2_MIN_5 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO2_MIN_6 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO2_MIN_7 Fld(6,14,AC_MSKDW)//[19:14]
#define NR_PQ_20    u4SWReg(0x8280)
    #define NR_TBL_MA_AUTO2_MAX_0 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO2_MAX_1 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO2_MAX_2 Fld(6,14,AC_MSKDW)//[19:14]
    #define NR_TBL_MA_AUTO2_MAX_3 Fld(6,8,AC_MSKDW)//[13:8]
    #define NR_TBL_MA_AUTO2_MAX_4 Fld(6,2,AC_MSKDW)//[7:2]
#define NR_PQ_21    u4SWReg(0x8284)	
    #define NR_TBL_MA_AUTO2_MAX_5 Fld(6,26,AC_MSKDW)//[31:26]
    #define NR_TBL_MA_AUTO2_MAX_6 Fld(6,20,AC_MSKDW)//[25:20]
    #define NR_TBL_MA_AUTO2_MAX_7 Fld(6,14,AC_MSKDW)//[19:14]
#define NR_PQ_22    u4SWReg(0x8288)
    #define NR_TBL_THD_AUTO1_MIN_4 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO1_MIN_3 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO1_MIN_2 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO1_MIN_1 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_23    u4SWReg(0x828C)
    #define NR_TBL_THD_AUTO1_MIN_8 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO1_MIN_7 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO1_MIN_6 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO1_MIN_5 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_24    u4SWReg(0x8290)
    #define NR_TBL_THD_AUTO1_MAX_4 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO1_MAX_3 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO1_MAX_2 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO1_MAX_1 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_25    u4SWReg(0x8294)
    #define NR_TBL_THD_AUTO1_MAX_8 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO1_MAX_7 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO1_MAX_6 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO1_MAX_5 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_26    u4SWReg(0x8298)
    #define NR_TBL_THD_AUTO2_MIN_4 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO2_MIN_3 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO2_MIN_2 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO2_MIN_1 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_27    u4SWReg(0x829C)
    #define NR_TBL_THD_AUTO2_MIN_8 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO2_MIN_7 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO2_MIN_6 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO2_MIN_5 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_28    u4SWReg(0x82A0)
    #define NR_TBL_THD_AUTO2_MAX_4 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO2_MAX_3 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO2_MAX_2 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO2_MAX_1 Fld(8,0, AC_MSKDW)//[7:0]
#define NR_PQ_29    u4SWReg(0x82A4)
    #define NR_TBL_THD_AUTO2_MAX_8 Fld(8,24,AC_MSKDW)//[31:24]
    #define NR_TBL_THD_AUTO2_MAX_7 Fld(8,16,AC_MSKDW)//[23:16]
    #define NR_TBL_THD_AUTO2_MAX_6 Fld(8,8, AC_MSKDW)//[15:8]
    #define NR_TBL_THD_AUTO2_MAX_5 Fld(8,0, AC_MSKDW)//[7:0]
...
#define VDP_SCPQ_01 u4SWReg(0xA83C)
	...
	#define SCPQ_CUST_UIMAPPING Fld(1, 1, AC_MSKB0) // [1]
	#define SCPQ_CUST_SOURCETIMINGMAP Fld(1, 2, AC_MSKB0) // [1]
