...
#define INT_COLLECT (IO_VDOIN_BASE+0x0000)
	...
	#define INTR_W2D_LEFT Fld(1,17,AC_MSKB2)//[17:17]
	#define INTR_W2D_RIGHT Fld(1,16,AC_MSKB2)//[16:16]	
...
#define SYS_03 (IO_VDOIN_BASE+0x040C)
    ...
    #define INT_MASK_W2D_LEFT Fld(1,17,AC_MSKB2) //[17:17]
	#define INT_MASK_W2D_RIGHT Fld(1,16,AC_MSKB2) //[16:16]
