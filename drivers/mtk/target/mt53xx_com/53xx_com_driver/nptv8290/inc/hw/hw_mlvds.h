...
#define VINTF_P19 (IO_VIRT + 0x3474C)
	#define VINTF_2SEC_EN Fld(1,20,AC_MSKB2)//[20:20]    //Gazelle only
...
#define VINTF_P27 (IO_VIRT + 0x3476C)
    #define VINTF_P27_2SEC_H_TOTAL Fld(12, 16, AC_MSKW32) //27:16
    #define VINTF_P27_2SEC_H_VALID Fld(11,0,AC_MSKW10)//[10:0]
#define VINTF_P28 (IO_VIRT + 0x34770)
    #define VINTF_P28_2SEC_H_END Fld(12, 16, AC_MSKW32) //27:16
    #define VINTF_P28_2SEC_H_START  Fld(12, 0, AC_MSKW10) //11:0
#define VINTF_P29 (IO_VIRT + 0x34774)
    #define VINTF_P29_2SEC_V_WIDTH Fld(7,16,AC_MSKB2)//[22:16]
    #define VINTF_P29_2SEC_V_TOTAL  Fld(12, 0, AC_MSKW10) //11:0
...
#define LVDSB_REG06 (IO_VIRT + 0x34C18)
    ...
    #define RG_DCBAL_SCAN Fld(1,15,AC_MSKB1)//[15:15]
...
#define LVDSB_REG15 (IO_VIRT + 0x34C3C)
    #define RG_TMDS_PG0 Fld(28,4,AC_MSKDW)//[31:4] 
    #define RG_TP_TS10 Fld(1,3,AC_MSKB0)//[3:3] 
    #define RG_TP_JD98 Fld(1,2,AC_MSKB0)//[2:2]
    #define RG_TP_JD10 Fld(1,1,AC_MSKB0)//[1:1]
    #define RG_TP_VS10 Fld(1,0,AC_MSKB0)//[0:0]
...
#define LVDSB_REG26 (IO_VIRT + 0x34C68)
	#define RG_OSD_SWITCH_CH Fld(2,30,AC_MSKB3)//[31:30]
		#define RG_OSD_SWITCH_CH1 Fld(1,31,AC_MSKB3)//[31:31]
		#define RG_OSD_SWITCH_CH0 Fld(1,30,AC_MSKB3)//[30:30]
...
#define BACKUP_CTRL_00 (IO_VIRT + 0x35114)
	#define RG_BACKUP_00 Fld(32,0,AC_FULLDW)//[31:0]

#define BACKUP_CTRL_01 (IO_VIRT + 0x35118)
	#define RG_BACKUP_01 Fld(32,0,AC_FULLDW)//[31:0]
...
#define PIXEL_REORDER_33 (IO_VIRT + 0x35C80)
	#define RG_DRD_GATE_EVN_B_SEL Fld(4,20,AC_MSKB2)//[23:20]
	#define RG_DRD_GATE_EVN_G_SEL Fld(4,16,AC_MSKB2)//[19:16]
	#define RG_DRD_GATE_EVN_R_SEL Fld(4,12,AC_MSKB1)//[15:12]
	#define RG_DRD_GATE_ODD_B_SEL Fld(4,8,AC_MSKB1)//[11:8]
	#define RG_DRD_GATE_ODD_G_SEL Fld(4,4,AC_MSKB0)//[7:4]
	#define RG_DRD_GATE_ODD_R_SEL Fld(4,0,AC_MSKB0)//[3:0]
#define PIXEL_REORDER_34 (IO_VIRT + 0x35C84)
	#define RG_DRD_BS_GATE_EVN_B_SEL Fld(4,20,AC_MSKB2)//[23:20]
	#define RG_DRD_BS_GATE_EVN_G_SEL Fld(4,16,AC_MSKB2)//[19:16]
	#define RG_DRD_BS_GATE_EVN_R_SEL Fld(4,12,AC_MSKB1)//[15:12]
	#define RG_DRD_BS_GATE_ODD_B_SEL Fld(4,8,AC_MSKB1)//[11:8]
	#define RG_DRD_BS_GATE_ODD_G_SEL Fld(4,4,AC_MSKB0)//[7:4]
	#define RG_DRD_BS_GATE_ODD_R_SEL Fld(4,0,AC_MSKB0)//[3:0]
