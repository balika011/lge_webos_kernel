...
#define REG_VGA_Normal_CFG4 (IO_ANA_VFE+IO_ANA_VGA+0x10)
    #define RG_VGAADC1_IO_PWD Fld(1, 31, AC_MSKB3) //31
    #define RG_VGAADC1_MON_SEL Fld(2, 29, AC_MSKB3) //30:29
    #define RG_VGAADC1_LDO_SEL Fld(2, 26, AC_MSKB3) //27:26
    #define RG_VGAADC1_VREF_SEL Fld(2, 24, AC_MSKB3) //25:24
    #define RG_VGAADC1_DIV_SEL Fld(2, 22, AC_MSKB2) //23:22
    #define RG_VGAADC1_PHSEL Fld(1, 21, AC_MSKB2) //21
    #define RG_VGAADC1_DC_EN Fld(1, 20, AC_MSKB2) //20
    #define RG_VGAADC1_CK_SEL Fld(1, 19, AC_MSKB2) //19
    ...
    #define RG_VGAADC1_REV0 Fld(4, 8, AC_MSKB1) //11:8
    #define RG_VGAADC1_REV1 Fld(4, 0, AC_MSKB0) //3:0
#define REG_VGA_Normal_CFG5 (IO_ANA_VFE+IO_ANA_VGA+0x14)
    #define RG_VGAADC2_IO_PWD Fld(1, 31, AC_MSKB3) //31
    #define RG_VGAADC2_MON_SEL Fld(2, 29, AC_MSKB3) //30:29
    #define RG_VGAADC2_LDO_SEL Fld(2, 26, AC_MSKB3) //27:26
    #define RG_VGAADC2_VREF_SEL Fld(2, 24, AC_MSKB3) //25:24
    #define RG_VGAADC2_DIV_SEL Fld(2, 22, AC_MSKB2) //23:22
    #define RG_VGAADC2_PHSEL Fld(1, 21, AC_MSKB2) //21
    #define RG_VGAADC2_DC_EN Fld(1, 20, AC_MSKB2) //20
    #define RG_VGAADC2_CK_SEL Fld(1, 19, AC_MSKB2) //19
    ...
    #define RG_VGAADC2_REV0 Fld(4, 8, AC_MSKB1) //11:8
    #define RG_VGAADC2_REV1 Fld(4, 0, AC_MSKB0) //3:0
#define REG_VGA_Normal_CFG6 (IO_ANA_VFE+IO_ANA_VGA+0x18)
    #define RG_VGAADC3_IO_PWD Fld(1, 31, AC_MSKB3) //31
    #define RG_VGAADC3_MON_SEL Fld(2, 29, AC_MSKB3) //30:29
    #define RG_VGAADC3_LDO_SEL Fld(2, 26, AC_MSKB3) //27:26
    #define RG_VGAADC3_VREF_SEL Fld(2, 24, AC_MSKB3) //25:24
    #define RG_VGAADC3_DIV_SEL Fld(2, 22, AC_MSKB2) //23:22
    #define RG_VGAADC3_PHSEL Fld(1, 21, AC_MSKB2) //21
    #define RG_VGAADC3_DC_EN Fld(1, 20, AC_MSKB2) //20
    #define RG_VGAADC3_CK_SEL Fld(1, 19, AC_MSKB2) //19
    ...
    #define RG_VGAADC3_REV0 Fld(4, 8, AC_MSKB1) //11:8
    #define RG_VGAADC3_REV1 Fld(4, 0, AC_MSKB0) //3:0
...
#define RGS_VGA_NORMAL_CFG0 (IO_ANA_VFE+IO_ANA_VGA+0x20)
...
#define REG_CVBS_CFG0 (IO_ANA_VFE+IO_ANA_CVBS+0x00)
    ...
    #define RG_SIFTODEMOD_EN Fld(1, 1, AC_MSKB0) //1
    #define RG_SYNCTOVGA_EN Fld(1, 0, AC_MSKB0) //0
#define REG_CVBS_CFG1 (IO_ANA_VFE+IO_ANA_CVBS+0x04)
    #define RG_CLKTOVGA_EN Fld(1, 31, AC_MSKB3) //31
    #define RG_MANUALGAIN_EN Fld(1, 30, AC_MSKB3) //30
    #define RG_PGAGAINB Fld(6, 24, AC_MSKB3) //29:24
    #define RG_LPF_BYPASS Fld(1, 23, AC_MSKB2) //23
    #define RG_CVBSADC_TEST Fld(1, 22, AC_MSKB2) //22
    #define RG_DC_ABIST_EN Fld(1, 21, AC_MSKB2) //21
    #define RG_DC_MONITOR_EN Fld(1, 20, AC_MSKB2) //20
    #define RG_DC_MONITOR_SEL Fld(4, 16, AC_MSKB2) //19:16
    #define RG_SOURCE_SEL Fld(1, 13, AC_MSKB1) //13
    #define RG_GROUND_SEL Fld(1, 12, AC_MSKB1) //12
    #define RG_SHORT_PGAA Fld(1, 11, AC_MSKB1) //11
    #define RG_SHORT_PGAB Fld(1, 10, AC_MSKB1) //10
    #define RG_BP_PGABUFA Fld(1, 9, AC_MSKB1) //9
    #define RG_BP_PGABUFB Fld(1, 8, AC_MSKB1) //8
    #define RG_CVBS_REV1 Fld(4, 4, AC_MSKB0) //7:4
    #define RG_CVBS_REV0 Fld(4, 0, AC_MSKB0) //3:0
#define REG_CVBS_CFG2 (IO_ANA_VFE+IO_ANA_CVBS+0x08)
    #define RG_CVBS_PWD Fld(1, 29, AC_MSKB3) //29
    #define RG_CLAMP_PWD Fld(1, 28, AC_MSKB3) //28
    #define RG_INMUX_PWD Fld(1, 27, AC_MSKB3) //27
    #define RG_PROT_PWD Fld(1, 26, AC_MSKB3) //26
    #define RG_IGEN_PWD Fld(1, 25, AC_MSKB3) //25
    #define RG_CORE_PWD Fld(1, 24, AC_MSKB3) //24
    #define RG_PGABUFNA_PWD Fld(1, 23, AC_MSKB2) //23
    #define RG_PGABUFNB_PWD Fld(1, 22, AC_MSKB2) //22
    #define RG_SHIFTA_PWD Fld(1, 21, AC_MSKB2) //21
    #define RG_SHIFTB_PWD Fld(1, 20, AC_MSKB2) //20
    #define RG_10U_PGAOP Fld(2, 16, AC_MSKB2) //17:16
    #define RG_10U_PGASF Fld(2, 14, AC_MSKB1) //15:14
    #define RG_50U_CLAMP Fld(2, 12, AC_MSKB1) //13:12
    #define RG_CVBS_VCOMSEL Fld(2, 10, AC_MSKB1) //11:10
    #define RG_CVBS_VBGSEL Fld(2, 8, AC_MSKB1) //9:8
    #define RG_OFFCURA Fld(3, 4, AC_MSKB0) //6:4
    #define RG_OFFCURB Fld(3, 0, AC_MSKB0) //2:0
#define REG_CVBS_CFG3 (IO_ANA_VFE+IO_ANA_CVBS+0x0C)
    #define RG_CVBSADC1_IO_PWD Fld(1, 31, AC_MSKB3) //31
    #define RG_CVBSADC1_MON_SEL Fld(2, 29, AC_MSKB3) //30:29
    #define RG_CVBSADC1_LDO_SEL Fld(2, 26, AC_MSKB3) //27:26
    #define RG_CVBSADC1_VREF_SEL Fld(2, 24, AC_MSKB3) //25:24
    #define RG_CVBSADC1_DIV_SEL Fld(2, 22, AC_MSKB2) //23:22
    #define RG_CVBSADC1_PHSEL Fld(1, 21, AC_MSKB2) //21
    #define RG_CVBSADC1_DC_EN Fld(1, 20, AC_MSKB2) //20
    #define RG_CVBSADC1_CK_SEL Fld(1, 19, AC_MSKB2) //19
    #define RG_CVBSADC1_CK_PWD Fld(1, 18, AC_MSKB2) //18
    #define RG_CVBSADC1_CORE_PWD Fld(1, 17, AC_MSKB2) //17
    #define RG_CVBSADC1_LSF_EN Fld(1, 16, AC_MSKB2) //16
    #define RG_CVBSADC1_REV0 Fld(4, 8, AC_MSKB1) //11:8
    #define RG_CVBSADC1_REV1 Fld(4, 0, AC_MSKB0) //3:0
#define REG_CVBS_CFG4 (IO_ANA_VFE+IO_ANA_CVBS+0x10)
    #define RG_CVBSADC2_IO_PWD Fld(1, 31, AC_MSKB3) //31
    #define RG_CVBSADC2_MON_SEL Fld(2, 29, AC_MSKB3) //30:29
    #define RG_CVBSADC2_LDO_SEL Fld(2, 26, AC_MSKB3) //27:26
    #define RG_CVBSADC2_VREF_SEL Fld(2, 24, AC_MSKB3) //25:24
    #define RG_CVBSADC2_DIV_SEL Fld(2, 22, AC_MSKB2) //23:22
    #define RG_CVBSADC2_PHSEL Fld(1, 21, AC_MSKB2) //21
    #define RG_CVBSADC2_DC_EN Fld(1, 20, AC_MSKB2) //20
    #define RG_CVBSADC2_CK_SEL Fld(1, 19, AC_MSKB2) //19
    #define RG_CVBSADC2_CK_PWD Fld(1, 18, AC_MSKB2) //18
    #define RG_CVBSADC2_CORE_PWD Fld(1, 17, AC_MSKB2) //17
    #define RG_CVBSADC2_LSF_EN Fld(1, 16, AC_MSKB2) //16
    #define RG_CVBSADC2_REV0 Fld(4, 8, AC_MSKB1) //11:8
