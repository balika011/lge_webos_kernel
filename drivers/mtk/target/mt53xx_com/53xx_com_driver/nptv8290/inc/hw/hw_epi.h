...
#define EPI_B1 (IO_VIRT + 0x35404)
	#define RG_SWAP_OUT7_SEL Fld(3,28,AC_MSKB3)//[30:28]
	#define RG_SWAP_OUT6_SEL Fld(3,24,AC_MSKB3)//[26:24]
...
#define EPI_B7 (IO_VIRT + 0x3541C)
	#define RG_CTRL2_SELF_7 Fld(1,15,AC_MSKB1)//[15:15]
	#define RG_CTRL2_SELF_6 Fld(1,14,AC_MSKB1)//[14:14]
    ...
    #define RG_CTRL1_SELF_7 Fld(1,7,AC_MSKB0)//[7:7]
    #define RG_CTRL1_SELF_6 Fld(1,6,AC_MSKB0)//[6:6]
...
#define EPI_T19 (IO_VIRT + 0x3554C)
    ...
    #define RG_CTR_2_RGC_EN_5 Fld(16,0,AC_FULLW10)//[15:0]
...
#define EPI_T45 (IO_VIRT + 0x355B4)
	#define RG_CTR_2_RGC_POL_6 Fld(16,16,AC_FULLW32)//[31:16]
	#define RG_CTR_2_RGC_EN_6 Fld(16,0,AC_FULLW10)//[15:0]
#define EPI_T46 (IO_VIRT + 0x355B8)
	#define RG_CTR_2_RGC_POL_7 Fld(16,16,AC_FULLW32)//[31:16]
	#define RG_CTR_2_RGC_EN_7 Fld(16,0,AC_FULLW10)//[15:0]
#define EPI_T47 (IO_VIRT + 0x355BC)
    #define RG_CTRL1_6 Fld(30,0,AC_MSKDW)//[29:0]
#define EPI_T48 (IO_VIRT + 0x355C0)
    #define RG_CTRL1_7 Fld(30,0,AC_MSKDW)//[29:0]
#define EPI_T49 (IO_VIRT + 0x355C4)
    #define RG_CTRL2_6 Fld(30,0,AC_MSKDW)//[29:0]
#define EPI_T50 (IO_VIRT + 0x355C8)
    #define RG_CTRL2_7 Fld(30,0,AC_MSKDW)//[29:0]
#define EPI_T51 (IO_VIRT + 0x355CC)
	#define RG_TCO_7_SEL_6 Fld(4,28,AC_MSKB3)//[31:28]
	#define RG_TCO_6_SEL_6 Fld(4,24,AC_MSKB3)//[27:24]
	#define RG_TCO_5_SEL_6 Fld(4,20,AC_MSKB2)//[23:20]
	#define RG_TCO_4_SEL_6 Fld(4,16,AC_MSKB2)//[19:16]
	#define RG_TCO_3_SEL_6 Fld(4,12,AC_MSKB1)//[15:12]
	#define RG_TCO_2_SEL_6 Fld(4,8,AC_MSKB1)//[11:8]
	#define RG_TCO_1_SEL_6 Fld(4,4,AC_MSKB0)//[7:4]
	#define RG_TCO_0_SEL_6 Fld(4,0,AC_MSKB0)//[3:0]
#define EPI_T52 (IO_VIRT + 0x355D0)
	#define RG_TCO_15_SEL_6 Fld(4,28,AC_MSKB3)//[31:28]
	#define RG_TCO_14_SEL_6 Fld(4,24,AC_MSKB3)//[27:24]
	#define RG_TCO_13_SEL_6 Fld(4,20,AC_MSKB2)//[23:20]
	#define RG_TCO_12_SEL_6 Fld(4,16,AC_MSKB2)//[19:16]
	#define RG_TCO_11_SEL_6 Fld(4,12,AC_MSKB1)//[15:12]
	#define RG_TCO_10_SEL_6 Fld(4,8,AC_MSKB1)//[11:8]
	#define RG_TCO_9_SEL_6 Fld(4,4,AC_MSKB0)//[7:4]
	#define RG_TCO_8_SEL_6 Fld(4,0,AC_MSKB0)//[3:0]
#define EPI_T53 (IO_VIRT + 0x355D4)
	#define RG_TCO_7_SEL_7 Fld(4,28,AC_MSKB3)//[31:28]
	#define RG_TCO_6_SEL_7 Fld(4,24,AC_MSKB3)//[27:24]
	#define RG_TCO_5_SEL_7 Fld(4,20,AC_MSKB2)//[23:20]
	#define RG_TCO_4_SEL_7 Fld(4,16,AC_MSKB2)//[19:16]
	#define RG_TCO_3_SEL_7 Fld(4,12,AC_MSKB1)//[15:12]
	#define RG_TCO_2_SEL_7 Fld(4,8,AC_MSKB1)//[11:8]
	#define RG_TCO_1_SEL_7 Fld(4,4,AC_MSKB0)//[7:4]
	#define RG_TCO_0_SEL_7 Fld(4,0,AC_MSKB0)//[3:0]
#define EPI_T54 (IO_VIRT + 0x355D8)
	#define RG_TCO_15_SEL_7 Fld(4,28,AC_MSKB3)//[31:28]
	#define RG_TCO_14_SEL_7 Fld(4,24,AC_MSKB3)//[27:24]
	#define RG_TCO_13_SEL_7 Fld(4,20,AC_MSKB2)//[23:20]
	#define RG_TCO_12_SEL_7 Fld(4,16,AC_MSKB2)//[19:16]
	#define RG_TCO_11_SEL_7 Fld(4,12,AC_MSKB1)//[15:12]
	#define RG_TCO_10_SEL_7 Fld(4,8,AC_MSKB1)//[11:8]
	#define RG_TCO_9_SEL_7 Fld(4,4,AC_MSKB0)//[7:4]
	#define RG_TCO_8_SEL_7 Fld(4,0,AC_MSKB0)//[3:0]
#define EPI_TRO0 (IO_VIRT + 0x356C0)
    #define EPI_REMOVE_RXCRC_FLAG Fld(1,0,AC_MSKB0)//[0:0]
#define EPI_TRO1 (IO_VIRT + 0x356C4)
    #define MUTE_STATE Fld(2,16,AC_MSKB2)//[17:16]
    #define EN_CS_STATE Fld(2,8,AC_MSKB1)//[9:8]
    #define LOCK Fld(1,0,AC_MSKB0)//[0:0]
#define EPI_TRO2 (IO_VIRT + 0x356C8)
