...
#define PQ_DD_MACRO ((BSP_GetIcVersion()>= IC_VER_5890_AC)&&IS_Support4KDisplay()&&PANEL_IsSupport4K2KDD())
#define IO_POSTPROC_BASE  (VDOIN_BASE+0x7000-(PQ_DD_MACRO?(0x1E000):0))
#endif
#else
#define IO_POSTPROC_BASE  (VDOIN_BASE+0x7000)
#endif
...
#define GC_MIX_02 (IO_POSTPROC_BASE + 0xA50)
	#define GC_VIDEO_DATA Fld(8,16,AC_FULLB2)//[23:16]
	#define GC_MIX_02_ALPHA Fld(1,12,AC_MSKB1)//[12:12]
	#define GC_MIX_02_ALPHA_SEL_MODE Fld(1,11,AC_MSKB1)//[11:11]
    #define GC_MIX_02_TIMING_SEL_MAIN Fld(1,10,AC_MSKB1)//[10:10]
    #define GC_MIX_02_VIDEO_SEL_MAIN Fld(1,9,AC_MSKB1)//[9:9]
    #define GC_MIX_02_OSD_INDEX_EN Fld(1,8,AC_MSKB1)//[8:8]
    #define GC_MIX_02_OSD_INDEX_THD Fld(8,0,AC_FULLB0)//[7:0]    
...
//=> Registers for BT2020 use case ( including xvYCC )
#define YCBCR2RGB_09 (IO_POSTPROC_BASE + 0xA64)
...
#define YCBCR2RGB_10 (IO_POSTPROC_BASE + 0xA68)
    #define Y2RMATRIX21_BT2020_PIP Fld(14,16,AC_MSKW32)//[29:16]
    #define Y2RMATRIX21_BT2020 Fld(14,0,AC_MSKW10)//[13:0]
//<= Registers for BT2020 use case ( including xvYCC )


// only Gazelle support matrix MSB
#if defined( CC_MT5861) 
#define XVYCC_12 (IO_POSTPROC_BASE + 0xC30)
...
#define XVYCC_15 (IO_POSTPROC_BASE + 0xC3C)
...
#endif //#if defined( CC_MT5861)

//=> Registers for xvYCC2 use case
// only Oryx support xvYCC2
#if defined( CC_MT5890)
#define XVYCC_17 (IO_POSTPROC_BASE + 0xC44)
