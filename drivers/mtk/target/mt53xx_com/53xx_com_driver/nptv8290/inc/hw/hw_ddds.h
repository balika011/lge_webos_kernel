...
#define DDDS_09 (IO_VIRT + 0xe024)
	#define DDDS_09_SC_FAST_DEBUG Fld(2,30,AC_MSKB3)//[31:30]
	#define DDDS_09_SC_SLOW_DEBUG Fld(2,28,AC_MSKB3)//[29:28]
	#define DDDS_09_MJC_FAST_DEBUG Fld(2,26,AC_MSKB3)//[27:26]
	#define DDDS_09_MJC_SLOW_DEBUG Fld(2,24,AC_MSKB3)//[25:24]
    #define DDDS_09_MUTE_SPREAD_STEP Fld(24,0,AC_MSKDW)//[23:0]
#define DDDS_0A (IO_VIRT + 0xe028)
	#define DDDS_0A_SC_DEBUG_MODE Fld(1,31,AC_MSKB3)//[31:31]
    #define DDDS_0A_MJC_DEBUG_MODE Fld(1,30,AC_MSKB3)//[30:30]
...
#define DDDS_0B (IO_VIRT + 0xe02C)
    ...
    #define DDDS_0B_CW_OLD_INIT_SEL Fld(1,30,AC_MSKB3)//[30:30]
...
#define DDDS_1C (IO_VIRT + 0xe070)
	#define DDDS_1C_R2R_HSYNC_SEL Fld(1,31,AC_MSKB3)//[31:31]
	#define DDDS_1C_NOR_DDDS_ERR_LIM_SHIFT Fld(3,16,AC_MSKB2)//[18:16]
	#define DDDS_1C_NOR_DDDS_LIM_LOW Fld(16,0,AC_FULLW10)//[15:0]
...
#define STA_DDDS_03 (IO_VIRT + 0xe074)
	#define STA_DDDS_03_SC_DDDS_FAST Fld(2,30,AC_MSKB3)//[31:30]
	#define STA_DDDS_03_SC_DDDS_SLOW Fld(2,28,AC_MSKB3)//[29:28]
	#define STA_DDDS_03_SC_DDDS_FAST_SEL Fld(2,26,AC_MSKB3)//[27:26]
	#define STA_DDDS_03_SC_DDDS_SLOW_SEL Fld(2,24,AC_MSKB3)//[25:24]
	#define STA_DDDS_03_SC_DDDS_FAST_SYNC Fld(2,22,AC_MSKB2)//[23:22]
	#define STA_DDDS_03_SC_DDDS_SLOW_SYNC Fld(2,20,AC_MSKB2)//[21:20]
	#define STA_DDDS_03_MJC_DDDS_FAST Fld(2,18,AC_MSKB2)//[19:18]
	#define STA_DDDS_03_MJC_DDDS_SLOW Fld(2,16,AC_MSKB2)//[17:16]
	#define STA_DDDS_03_MJC_DDDS_FAST_SEL Fld(2,14,AC_MSKB1)//[15:14]
	#define STA_DDDS_03_MJC_DDDS_SLOW_SEL Fld(2,12,AC_MSKB1)//[13:12]
	#define STA_DDDS_03_MJC_DDDS_FAST_SYNC Fld(2,10,AC_MSKB1)//[11:10]
	#define STA_DDDS_03_MJC_DDDS_SLOW_SYNC Fld(2,8,AC_MSKB1)//[9:8]
