...
#define REG_LVDS_TX_CFG7 (IO_ANA_LVDS+0x1C)
    #define RG_LVDSB_GPO_EN_EVEN_D11 Fld(14, 16, AC_MSKW32) //29:16
    	#define RG_LVDSB_ECKP_GPO_EN Fld(1,29,AC_MSKB3)//[29:29]
	    #define RG_LVDSB_ECKN_GPO_EN Fld(1,28,AC_MSKB3)//[28:28]
    	#define RG_LVDSB_E5P_GPO_EN Fld(1,27,AC_MSKB3)//[27:27]
	    #define RG_LVDSB_E5N_GPO_EN Fld(1,26,AC_MSKB3)//[26:26]
	    #define RG_LVDSB_E4P_GPO_EN Fld(1,25,AC_MSKB3)//[25:25]
	    #define RG_LVDSB_E4N_GPO_EN Fld(1,24,AC_MSKB3)//[24:24]
	    #define RG_LVDSB_E3P_GPO_EN Fld(1,23,AC_MSKB2)//[23:23]
	    #define RG_LVDSB_E3N_GPO_EN Fld(1,22,AC_MSKB2)//[22:22]
	    #define RG_LVDSB_E2P_GPO_EN Fld(1,21,AC_MSKB2)//[21:21]
	    #define RG_LVDSB_E2N_GPO_EN Fld(1,20,AC_MSKB2)//[20:20]
	    #define RG_LVDSB_E1P_GPO_EN Fld(1,19,AC_MSKB2)//[19:19]
	    #define RG_LVDSB_E1N_GPO_EN Fld(1,18,AC_MSKB2)//[18:18]
	    #define RG_LVDSB_E0P_GPO_EN Fld(1,17,AC_MSKB2)//[17:17]
	    #define RG_LVDSB_E0N_GPO_EN Fld(1,16,AC_MSKB2)//[16:16]
    #define RG_LVDSB_GPO_EN_ODD_D11 Fld(14, 0, AC_MSKW10) //13:0
    	#define RG_LVDSB_OCKP_GPO_EN Fld(1, 13, AC_MSKB1) //[13:13]
	    #define RG_LVDSB_OCKN_GPO_EN Fld(1, 12, AC_MSKB1) //[12:12]
    	#define RG_LVDSB_O5P_GPO_EN Fld(1, 11, AC_MSKB1) //[11:11]
	    #define RG_LVDSB_O5N_GPO_EN Fld(1, 10, AC_MSKB1) //[10:10]
	    #define RG_LVDSB_O4P_GPO_EN Fld(1, 9, AC_MSKB1) //[9:9]
	    #define RG_LVDSB_O4N_GPO_EN Fld(1, 8, AC_MSKB1) //[8:8]
	    #define RG_LVDSB_O3P_GPO_EN Fld(1, 7, AC_MSKB0) //[7:7]
	    #define RG_LVDSB_O3N_GPO_EN Fld(1, 6, AC_MSKB0) //[6:6]
	    #define RG_LVDSB_O2P_GPO_EN Fld(1, 5, AC_MSKB0) //[5:5]
	    #define RG_LVDSB_O2N_GPO_EN Fld(1, 4, AC_MSKB0) //[4:4]
	    #define RG_LVDSB_O1P_GPO_EN Fld(1, 3, AC_MSKB0) //[3:3]
	    #define RG_LVDSB_O1N_GPO_EN Fld(1, 2, AC_MSKB0) //[2:2]
	    #define RG_LVDSB_O0P_GPO_EN Fld(1, 1, AC_MSKB0) //[1:1]
	    #define RG_LVDSB_O0N_GPO_EN Fld(1, 0, AC_MSKB0) //[0:0]
#define REG_LVDS_TX_CFG8 (IO_ANA_LVDS+0x20)
    #define RG_LVDSB_GPI_EN_EVEN_D11 Fld(14, 16, AC_MSKW32) //29:16
    	#define RG_LVDSB_ECKP_GPI_EN Fld(1,29,AC_MSKB3)//[29:29]
	    #define RG_LVDSB_ECKN_GPI_EN Fld(1,28,AC_MSKB3)//[28:28]
    	#define RG_LVDSB_E5P_GPI_EN Fld(1,27,AC_MSKB3)//[27:27]
	    #define RG_LVDSB_E5N_GPI_EN Fld(1,26,AC_MSKB3)//[26:26]
	    #define RG_LVDSB_E4P_GPI_EN Fld(1,25,AC_MSKB3)//[25:25]
	    #define RG_LVDSB_E4N_GPI_EN Fld(1,24,AC_MSKB3)//[24:24]
	    #define RG_LVDSB_E3P_GPI_EN Fld(1,23,AC_MSKB2)//[23:23]
	    #define RG_LVDSB_E3N_GPI_EN Fld(1,22,AC_MSKB2)//[22:22]
	    #define RG_LVDSB_E2P_GPI_EN Fld(1,21,AC_MSKB2)//[21:21]
	    #define RG_LVDSB_E2N_GPI_EN Fld(1,20,AC_MSKB2)//[20:20]
	    #define RG_LVDSB_E1P_GPI_EN Fld(1,19,AC_MSKB2)//[19:19]
	    #define RG_LVDSB_E1N_GPI_EN Fld(1,18,AC_MSKB2)//[18:18]
	    #define RG_LVDSB_E0P_GPI_EN Fld(1,17,AC_MSKB2)//[17:17]
	    #define RG_LVDSB_E0N_GPI_EN Fld(1,16,AC_MSKB2)//[16:16]
    #define RG_LVDSB_GPI_EN_ODD_D11 Fld(14, 0, AC_MSKW10) //13:0
    	#define RG_LVDSB_OCKP_GPI_EN Fld(1, 13, AC_MSKB1) //[13:13]
	    #define RG_LVDSB_OCKN_GPI_EN Fld(1, 12, AC_MSKB1) //[12:12]
    	#define RG_LVDSB_O5P_GPI_EN Fld(1, 11, AC_MSKB1) //[11:11]
	    #define RG_LVDSB_O5N_GPI_EN Fld(1, 10, AC_MSKB1) //[10:10]
	    #define RG_LVDSB_O4P_GPI_EN Fld(1, 9, AC_MSKB1) //[9:9]
	    #define RG_LVDSB_O4N_GPI_EN Fld(1, 8, AC_MSKB1) //[8:8]
	    #define RG_LVDSB_O3P_GPI_EN Fld(1, 7, AC_MSKB0) //[7:7]
	    #define RG_LVDSB_O3N_GPI_EN Fld(1, 6, AC_MSKB0) //[6:6]
	    #define RG_LVDSB_O2P_GPI_EN Fld(1, 5, AC_MSKB0) //[5:5]
	    #define RG_LVDSB_O2N_GPI_EN Fld(1, 4, AC_MSKB0) //[4:4]
	    #define RG_LVDSB_O1P_GPI_EN Fld(1, 3, AC_MSKB0) //[3:3]
	    #define RG_LVDSB_O1N_GPI_EN Fld(1, 2, AC_MSKB0) //[2:2]
	    #define RG_LVDSB_O0P_GPI_EN Fld(1, 1, AC_MSKB0) //[1:1]
	    #define RG_LVDSB_O0N_GPI_EN Fld(1, 0, AC_MSKB0) //[0:0]
...
#define REG_LVDS_TX_CFG10 (IO_ANA_LVDS+0x28)
    ...
    #define RG_LVDSB_REV_O Fld(8, 0, AC_FULLB0) //7:0
#define REG_LVDS_TX_CFG11 (IO_ANA_LVDS+0x2C)
    #define RG_LVDSB_REV_E Fld(32, 0, AC_FULLDW) //31:0
...
#define REG_LVDS_TX_CFG13 (IO_ANA_LVDS+0x34)
    ...
    #define RG_LVDSA_DRV_PWD Fld(12, 0, AC_MSKW10) //11:0
    	#define RG_VB1_LANE8_11_DRV_PWD Fld(4,8,AC_MSKB1)//[11:8]
    	#define RG_VB1_LANE0_7_DRV_PWD Fld(8,0,AC_FULLB0)//[7:0]
#define REG_LVDS_TX_CFG14 (IO_ANA_LVDS+0x38)
    #define RG_LVDSA_PRE_PWD Fld(12, 16, AC_MSKW32) //27:16
		#define RG_VB1_LANE8_11_PRE_PWD Fld(4,24,AC_MSKB3)//[27:24]
    	#define RG_VB1_LANE0_7_PRE_PWD Fld(8,16,AC_FULLB2)//[23:16]    	
...
#define REG_LVDS_TX_CFG21 (IO_ANA_LVDS+0x54)
    #define RG_VB1_REV Fld(32, 0, AC_FULLDW) //31:0
#define RGS_LVDS_TX_CFG0 (IO_ANA_LVDS+0x58)
    ...
    #define RGS_LVDSB_ABIST_ODD_51LEV_D11 Fld(1, 22, AC_MSKB2) //22
    #define RGS_LVDSB_ABIST_EVEN_51EDG_D11 Fld(1, 21, AC_MSKB2) //21
    #define RGS_LVDSB_ABIST_EVEN_51LEV_D11 Fld(1, 20, AC_MSKB2) //20
    #define RGS_LVDSB_ABIST_ODD_21EDG_D11 Fld(1, 19, AC_MSKB2) //19
    #define RGS_LVDSB_ABIST_ODD_21LEV_D11 Fld(1, 18, AC_MSKB2) //18
    #define RGS_LVDSB_ABIST_EVEN_21EDG_D11 Fld(1, 17, AC_MSKB2) //17
    #define RGS_LVDSB_ABIST_EVEN_21LEV_D11 Fld(1, 16, AC_MSKB2) //16
#endif
