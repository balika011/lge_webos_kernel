...
#define TMGR0 (IO_VIRT + 0x34000)
    #define TMGR0_CKRST_CFG Fld(16,16,AC_FULLW32)//[31:16]
		#define TMGR0_CKRST_CFG_VB1 Fld(1,20,AC_MSKB2)//[20:20]
    #define TMGR0_CKEN_CFG Fld(16,0,AC_FULLW10)//[15:0]

        #define CKEN_CFG_2Port_FIFO Fld(1, 15, AC_MSKB1)  
        #define CKEN_CFG_Pixel_Reorder Fld(1, 14, AC_MSKB1)
        #define CKEN_CFG_LVDS_TX Fld(1, 13, AC_MSKB1)  
        #define CKEN_CFG_PPML Fld(1, 12, AC_MSKB1)
        #define CKEN_CFG_LVDS_ANA Fld(1, 8, AC_MSKB1) 
...
#define TMGR2 (IO_VIRT + 0x34008)
    ...
    #define TMGR2_TCLK_PLLBP Fld(1,27,AC_MSKB3)//[27:27]
    	#define TMGR2_CKRST_CFG_VB1OSD Fld(1,20,AC_MSKB2)//[20:20]
...
#define TMGR3 (IO_VIRT + 0x3400C)
	#define TMGR3_RG_VB1_DE_SEL Fld(1,18,AC_MSKB2)//[18:18]
	#define TMGR3_RG_VB1_VS_SEL Fld(1,17,AC_MSKB2)//[17:17]
	#define TMGR3_RG_VB1_HS_SEL Fld(1,16,AC_MSKB2)//[16:16]
	#define TMGR3_RG_OSD_SYNC_SEL Fld(1,15,AC_MSKB1)//[15:15]
...
#define TMGR4 (IO_VIRT + 0x34010)
	// #ifdef CC_MT5890
    #define TMGR4_SYNC_UPDATE_MODE Fld(1,3,AC_MSKB0)//[3:3]
    #define TMGR4_VDO_SRC_SEL Fld(1,0,AC_MSKB0)//[0:0]
    // #else Gazelle
	#define TMGR4_OSD_SRC_SEL Fld(1,4,AC_MSKB0)//[4:4]
	#define TMGR4_RG_1CHTO2CH_EN Fld(1,0,AC_MSKB0)//[0:0]
	// #endif
...
#define TMGR6 (IO_VIRT + 0x34018)
	#define TMGR6_RG_HS_PWM_SEL Fld(1,1,AC_MSKB0)//[1:1]
	#define TMGR6_RG_VS_PWM_SEL Fld(1,0,AC_MSKB0)//[0:0]
...
#define TMGR7 (IO_VIRT + 0x3401C)
    ...
    #define TMGR7_IMP_CAL_SETB Fld(1,22,AC_MSKB2)//[22:22]
...
#define TMGR18 (IO_VIRT + 0x34048)
	#define TMGR18_RG_SAME_HTPDN Fld(1,9,AC_MSKB1)//[9:9]
	#define TMGR18_RG_SAME_LOCKN Fld(1,8,AC_MSKB1)//[8:8]
	#define TMGR18_RG_HTPD_VALUE_OSD Fld(1,7,AC_MSKB0)//[7:7]
	#define TMGR18_RG_HTPD_CTRL_OSD Fld(1,6,AC_MSKB0)//[6:6]
	#define TMGR18_RG_LOCK_VALUE_OSD Fld(1,5,AC_MSKB0)//[5:5]
	#define TMGR18_RG_LOCK_CTRL_OSD Fld(1,4,AC_MSKB0)//[4:4]
	#define TMGR18_RG_HTPD_VALUE Fld(1,3,AC_MSKB0)//[3:3]
	#define TMGR18_RG_HTPD_CTRL Fld(1,2,AC_MSKB0)//[2:2]
    #define TMGR18_RG_LOCK_VALUE Fld(1,1,AC_MSKB0)//[1:1]
    #define TMGR18_RG_LOCK_CTRL Fld(1,0,AC_MSKB0)//[0:0]

#define TMGR19 (IO_VIRT + 0x3404C)
	#define TMGR19_RG_LVDSB_TERM_ECK Fld(4,28,AC_MSKB3)//[31:28]
	#define TMGR19_RG_LVDSB_TERM_O0 Fld(4,24,AC_MSKB3)//[27:24]
	#define TMGR19_RG_LVDSB_TERM_O1 Fld(4,20,AC_MSKB2)//[23:20]
	#define TMGR19_RG_LVDSB_TERM_O2 Fld(4,16,AC_MSKB2)//[19:16]
	#define TMGR19_RG_LVDSB_TERM_O3 Fld(4,12,AC_MSKB1)//[15:12]
	#define TMGR19_RG_LVDSB_TERM_O4 Fld(4,8,AC_MSKB1)//[11:8]
	#define TMGR19_RG_LVDSB_TERM_O5 Fld(4,4,AC_MSKB0)//[7:4]
	#define TMGR19_RG_LVDSB_TERM_OCK Fld(4,0,AC_MSKB0)//[3:0]

#define TMGR20 (IO_VIRT + 0x34050)
	#define TMGR20_RG_LVDSB_TERM_E0 Fld(4,20,AC_MSKB2)//[23:20]
	#define TMGR20_RG_LVDSB_TERM_E1 Fld(4,16,AC_MSKB2)//[19:16]
	#define TMGR20_RG_LVDSB_TERM_E2 Fld(4,12,AC_MSKB1)//[15:12]
	#define TMGR20_RG_LVDSB_TERM_E3 Fld(4,8,AC_MSKB1)//[11:8]
	#define TMGR20_RG_LVDSB_TERM_E4 Fld(4,4,AC_MSKB0)//[7:4]
	#define TMGR20_RG_LVDSB_TERM_E5 Fld(4,0,AC_MSKB0)//[3:0]

#define TMGR21 (IO_VIRT + 0x34054)
	#define TMGR21_RG_LVDSB_IMP_CALI_EN Fld(12,0,AC_MSKW10)//[11:0]

#define TMGR24 (IO_VIRT + 0x34060)
    #define TMGR24_DA_IMPCAL_TX_LAT Fld(4,16,AC_MSKB2)//[19:16]
    #define TMGR24_GEN_STATE Fld(3,12,AC_MSKB1)//[14:12]
    #define TMGR24_IMP_PD Fld(1,8,AC_MSKB1)//[8:8]
    #define TMGR24_IMP_CALIB_DONE Fld(1,4,AC_MSKB0)//[4:4]
    #define TMGR24_HOLD Fld(1,0,AC_MSKB0)//[0:0]
