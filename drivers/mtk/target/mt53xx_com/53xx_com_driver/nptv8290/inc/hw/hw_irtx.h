...
#define IRTX_IRTX1CFG (IO_IRTX_BASE + 0x600)
    #define FLD_IRTX1_RIGHTPOSEDGE Fld(1,19,AC_MSKB2)//[19:19]
    #define FLD_IRTX1_SONY_MODE Fld(1,18,AC_MSKB2)//[18:18]
    #define FLD_IRTX1_REAL_MODE Fld(1,17,AC_MSKB2)//[17:17]
...
#define IRTX_IRTX1PHASE (IO_IRTX_BASE + 0x680)
    #define FLD_IRTX1_SONY_PHASE Fld(24,0,AC_MSKDW)//[23:0]
#define IRTX_IRTX1WIDTH (IO_IRTX_BASE + 0x684)
    #define FLD_IRTX1_SONY_WIDTH Fld(24,0,AC_MSKDW)//[23:0]
