...
#define SCPIP_SCCTRL1_00 (IO_SCPIP_BASE + 0x200)
    ...
    #define SCCTRL1_00_SC_HSC_FORCE_2D_1 Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCCTRL1_0A (IO_SCPIP_BASE + 0x228)
    #define SCCTRL1_0A_SC_FRC_PUL_SEL_MIB Fld(1,10,AC_MSKB1)//[10:10]   // Gazelle hybrid mode
    #define SCCTRL1_0A_SC_DRAM_RPTR_SEL_MIB Fld(1,9,AC_MSKB1)//[9:9]    // Gazelle hybrid mode
...
#define SCPIP_SCCTRL1_13 (IO_SCPIP_BASE + 0x24C)
    ...
    #define SCCTRL1_13_SC_PD_INFO_FRM_DLY Fld(2,6,AC_MSKB0)//[7:6]
    #define SCCTRL1_13_SC_PD_INFO_IMPORT_EN Fld(1,5,AC_MSKB0)//[5:5]
    #define SCCTRL1_13_SC_PD_INFO_INPUT_SAMPLE_SEL Fld(1,4,AC_MSKB0)//[4:4]
...
#define SCPIP_SCCTRL1_1B (IO_SCPIP_BASE + 0x26C)
    #define SCCTRL1_1B_SC_RPT_DISP_R_EN Fld(1,22,AC_MSKB2)//[22:22]         //Gazelle
    #define SCCTRL1_1B_SC_RPT_DISP_R Fld(1,21,AC_MSKB2)//[21:21]            //Gazelle
    #define SCCTRL1_1B_SC_RPT_GEN_VTOT_SEL_1 Fld(1,20,AC_MSKB2)//[20:20]    //Gazelle
...
#define SCPIP_SCCTRL2_1B (IO_SCPIP_BASE + 0x46C)
    #define SCCTRL2_1B_SC_RPT_GEN_VTOT_SEL_2 Fld(1,20,AC_MSKB2)//[20:20]   //Gazelle
...
#define SCPIP_SCCTRL2_30 (IO_SCPIP_BASE + 0x4C0)
    ...
    #define SCCTRL2_30_VSC_PART_SEL_2 Fld(1,15,AC_MSKB1)//[15:15]
...
#define SCPIP_SCSYS_4A (IO_SCPIP_BASE + 0x128)
    #define SCSYS_4A_REF_PNL_WIDTH Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_4A_REF_PNL_HEIGHT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_4B (IO_SCPIP_BASE + 0x12C)
    #define SCSYS_4B_REF_PNL_HTOTAL Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_4B_REF_PNL_VTOTAL Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_4C (IO_SCPIP_BASE + 0x130)
    #define SCSYS_4C_REF_PNL_FRNT_HPORCH Fld(16,0,AC_FULLW10)//[31:16]
    #define SCSYS_4C_REF_PNL_BACK_HPORCH Fld(16,16,AC_FULLW32)//[15:0]
#define SCPIP_SCSYS_4D (IO_SCPIP_BASE + 0x134)
    #define SCSYS_4D_REF_PNL_FRNT_VPORCH Fld(16,0,AC_FULLW10)//[31:16]
    #define SCSYS_4D_REF_PNL_BACK_VPORCH Fld(16,16,AC_FULLW32)//[15:0]
#define SCPIP_SCSYS_4E (IO_SCPIP_BASE + 0x138)
    #define SCSYS_4E_REF_OUTPUT_HEIGHT Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_4E_REF_OUTPUT_WIDTH Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_4F (IO_SCPIP_BASE + 0x13C)
    #define SCSYS_4F_REF_VMSK_STR_OFST Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_4F_REF_HMSK_STR_OFST Fld(16,0,AC_FULLW10)//[15:0]
...
#define SCPIP_SCSYS_61 (IO_SCPIP_BASE + 0x184)
    #define SCSYS_61_GFX_PNL_WIDTH Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_61_GFX_PNL_HEIGHT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_62 (IO_SCPIP_BASE + 0x188)
    #define SCSYS_62_GFX_PNL_HTOTAL Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_62_GFX_PNL_VTOTAL Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_63 (IO_SCPIP_BASE + 0x18C)
    #define SCSYS_63_GFX_PNL_FRNT_HPORCH Fld(16,0,AC_FULLW10)//[31:16]
    #define SCSYS_63_GFX_PNL_BACK_HPORCH Fld(16,16,AC_FULLW32)//[15:0]
#define SCPIP_SCSYS_64 (IO_SCPIP_BASE + 0x190)
    #define SCSYS_64_GFX_PNL_FRNT_VPORCH Fld(16,0,AC_FULLW10)//[31:16]
    #define SCSYS_64_GFX_PNL_BACK_VPORCH Fld(16,16,AC_FULLW32)//[15:0]
#define SCPIP_SCSYS_65 (IO_SCPIP_BASE + 0x194)
    #define SCSYS_65_GFX_DRAM_RDREQ_DLY_2 Fld(4,28,AC_MSKB3)//[31:28]
    #define SCSYS_65_GFX_DRAM_RDREQ_DLY_1 Fld(4,24,AC_MSKB3)//[27:24]
    #define SCSYS_65_GFX_TG_SLAVE_INIT_DISP_R Fld(1,23,AC_MSKB2)//[23:23]
    #define SCSYS_65_GFX_TG_DISP_R_FREERUN_EN Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_65_GFX_SET_DATA Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_65_GFX_STA_SET_DATA Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_65_GFX_TG_FORCE_ZERO_EN Fld(1,19,AC_MSKB2)//[19:19]
    #define SCSYS_65_GFX_TG_SLAVE_SYNC_MODE Fld(1,18,AC_MSKB2)//[18:18]
    #define SCSYS_65_GFX_TG_SLAVE_MODE Fld(1,17,AC_MSKB2)//[17:17]
    #define SCSYS_65_GFX_TG_ENABLE Fld(1,16,AC_MSKB2)//[16:16]
    #define SCSYS_65_GFX_TG_IMPORT_VCNT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_66 (IO_SCPIP_BASE + 0x198)
    #define SCSYS_66_GFX_OSD_HSYNC_SEL Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_66_GFX_OSD_VSYNC_SEL Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_66_GFX_INV_MEASURE_H Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_66_GFX_INV_MEASURE_V Fld(1,19,AC_MSKB2)//[19:19]
    #define SCSYS_66_GFX_CLR_OUTPUT_MEASURE Fld(1,18,AC_MSKB2)//[18:18]
    #define SCSYS_66_GFX_OUTPUT_MEASURE_SEL Fld(2,16,AC_MSKB2)//[17:16]
    #define SCSYS_66_GFX_CLR_PTG_UDFL_FLG Fld(1,1,AC_MSKB0)//[1:1]
    #define SCSYS_66_GFX_CLR_MTG_UDFL_FLG Fld(1,0,AC_MSKB0)//[0:0]
#define SCPIP_SCSYS_67 (IO_SCPIP_BASE + 0x19C)
    #define SCSYS_67_GFX_OSD_VSYNC_DLY Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_67_GFX_OSD_HSYNC_DLY Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_68 (IO_SCPIP_BASE + 0x1A0)
    #define SCSYS_68_GFX_OUT_MEASURE_HTOTAL Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_68_GFX_OUT_MEASURE_VTOTAL Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_69 (IO_SCPIP_BASE + 0x1A4)
    #define SCSYS_69_GFX_OUT_MEASURE_HACTIVE Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_69_GFX_OUT_MEASURE_VACTIVE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_6A (IO_SCPIP_BASE + 0x1A8)
    #define SCSYS_6A_GFX_STA_H_CNT Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_6A_GFX_STA_V_CNT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_6B (IO_SCPIP_BASE + 0x1AC)
    #define SCSYS_6B_GFX_SET_DATA_HTOT Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_6B_GFX_SET_DATA_VTOT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_6C (IO_SCPIP_BASE + 0x1B0)
    #define SCSYS_6C_REF_VMSK_END_CROP Fld(8,24,AC_FULLB3)//[31:24]
    #define SCSYS_6C_REF_VMSK_STR_CROP Fld(8,16,AC_FULLB2)//[23:16]
    #define SCSYS_6C_REF_HMSK_END_CROP Fld(8,8,AC_FULLB1)//[15:8]
    #define SCSYS_6C_REF_HMSK_STR_CROP Fld(8,0,AC_FULLB0)//[7:0]
#define SCPIP_SCSYS_6D (IO_SCPIP_BASE + 0x1B4)
    #define SCSYS_6D_REF_SET_DATA Fld(1,31,AC_MSKB3)//[31:31]
    #define SCSYS_6D_REF_STA_SET_DATA Fld(1,30,AC_MSKB3)//[30:30]
    #define SCSYS_6D_REF_FRM_TRK_CROSS_VSYNC_EN Fld(1,29,AC_MSKB3)//[29:29]
    #define SCSYS_6D_REF_FRM_TRK_3D_EN Fld(1,28,AC_MSKB3)//[28:28]
    #define SCSYS_6D_REF_FRM_TRK_DISP_R Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_6D_REF_FRM_MASK_IN_LR_SEL Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_6D_REF_FRM_MASK_IN_LR_EN Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_6D_REF_FRM_MASK_OUT_LR_SEL Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_6D_REF_FRM_MASK_OUT_LR_EN Fld(1,23,AC_MSKB2)//[23:23]
    #define SCSYS_6D_REF_FRM_TRK_DDDS_EN Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_6D_REF_FRM_TRK_ONCE_ONLY Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_6D_REF_FRM_TRK_VIN_EDGE_SEL Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_6D_REF_FRM_TRK_OUT_SEL Fld(2,18,AC_MSKB2)//[19:18]
    #define SCSYS_6D_REF_FRM_TRK_IN_SEL Fld(2,16,AC_MSKB2)//[17:16]
    #define SCSYS_6D_REF_TG_IMPORT_VCNT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_6E (IO_SCPIP_BASE + 0x1B8)
    #define SCSYS_6E_REF_FRM_MASK_I Fld(4,28,AC_MSKB3)//[31:28]
    #define SCSYS_6E_REF_FRM_MASK_O Fld(4,24,AC_MSKB3)//[27:24]
    #define SCSYS_6E_REF_FRM_MASK_O_SEL Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_6E_REF_FRM_MASK_I_SEL Fld(4,16,AC_MSKB2)//[19:16]
    #define SCSYS_6E_REF_FRM_TRK_LINE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_6F (IO_SCPIP_BASE + 0x1BC)
    #define SCSYS_6F_REF_FRM_LOCK_TOR Fld(8,24,AC_FULLB3)//[31:24]
    #define SCSYS_6F_REF_FRM_LOCK_WIN Fld(8,16,AC_FULLB2)//[23:16]
    #define SCSYS_6F_REF_STA_FRM_TRK_LOCK_OK Fld(1,15,AC_MSKB1)//[15:15]
    #define SCSYS_6F_REF_INV_MEASURE_H Fld(1,14,AC_MSKB1)//[14:14]
    #define SCSYS_6F_REF_INV_MEASURE_V Fld(1,13,AC_MSKB1)//[13:13]
    #define SCSYS_6F_REF_CLR_OUTPUT_MEASURE Fld(1,12,AC_MSKB1)//[12:12]
    #define SCSYS_6F_REF_OUTPUT_MEASURE_SEL Fld(2,10,AC_MSKB1)//[11:10]
    #define SCSYS_6F_REF_TG_DISP_R_FREERUN_EN Fld(1,9,AC_MSKB1)//[9:9]
    #define SCSYS_6F_REF_DDDS_TRK_INV Fld(1,8,AC_MSKB1)//[8:8]
    #define SCSYS_6F_REF_FRM_TRK_STEP Fld(8,0,AC_FULLB0)//[7:0]
#define SCPIP_SCSYS_70 (IO_SCPIP_BASE + 0x1C0)
    #define SCSYS_70_REF_STA_FRM_VSYNC_OUT_EARLY Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_70_REF_DDDS_TURBO_RGN Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_71 (IO_SCPIP_BASE + 0x1C4)
    #define SCSYS_71_REF_STA_FRM_TRK_ABS_DIS Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_72 (IO_SCPIP_BASE + 0x1C8)
    #define SCSYS_72_REF_OUT_MEASURE_HTOTAL Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_72_REF_OUT_MEASURE_VTOTAL Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_73 (IO_SCPIP_BASE + 0x1CC)
    #define SCSYS_73_REF_OUT_MEASURE_HACTIVE Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_73_REF_OUT_MEASURE_VACTIVE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_74 (IO_SCPIP_BASE + 0x1D0)
    #define SCSYS_74_REF_H_CNT Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_74_REF_V_CNT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_75 (IO_SCPIP_BASE + 0x1D4)
    #define SCSYS_75_FSC_EDGE_SEL Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_75_FSC_3D_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_75_FSC_TARGET_DISP_R Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_75_FSC_MASK_EN Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_75_FSC_MASK_N Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_75_FSC_MASK_M Fld(4,16,AC_MSKB2)//[19:16]
    #define SCSYS_75_FSC_TARGET_LINE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_76 (IO_SCPIP_BASE + 0x1D8)
    #define SCSYS_76_PSC_EDGE_SEL Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_76_PSC_3D_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_76_PSC_TARGET_DISP_R Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_76_PSC_MASK_EN Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_76_PSC_MASK_N Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_76_PSC_MASK_M Fld(4,16,AC_MSKB2)//[19:16]
    #define SCSYS_76_PSC_TARGET_LINE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_77 (IO_SCPIP_BASE + 0x1DC)
    #define SCSYS_77_GFX_EDGE_SEL Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_77_GFX_3D_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_77_GFX_TARGET_DISP_R Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_77_GFX_MASK_EN Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_77_GFX_MASK_N Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_77_GFX_MASK_M Fld(4,16,AC_MSKB2)//[19:16]
    #define SCSYS_77_GFX_TARGET_LINE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_78 (IO_SCPIP_BASE + 0x1E0)
    #define SCSYS_78_B2R_EDGE_SEL Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_78_B2R_3D_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_78_B2R_TARGET_DISP_R Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_78_B2R_MASK_EN Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_78_B2R_MASK_N Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_78_B2R_MASK_M Fld(4,16,AC_MSKB2)//[19:16]
    #define SCSYS_78_B2R_TARGET_LINE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_79 (IO_SCPIP_BASE + 0x1E4)
    #define SCSYS_79_R2R_EDGE_SEL Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_79_R2R_3D_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_79_R2R_TARGET_DISP_R Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_79_R2R_MASK_EN Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_79_R2R_MASK_N Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_79_R2R_MASK_M Fld(4,16,AC_MSKB2)//[19:16]
    #define SCSYS_79_R2R_TARGET_LINE Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_7A (IO_SCPIP_BASE + 0x1E8)
    #define SCSYS_7A_REF_MASK_RST Fld(1,16,AC_MSKB2)//[16:16]
    #define SCSYS_7A_GFX_SET_DATA_HACT Fld(16,0,AC_FULLW10)//[15:0]
#define SCPIP_SCSYS_7B (IO_SCPIP_BASE + 0x1EC)
    #define SCSYS_7B_INT_TDSHARP_CLR Fld(1,29,AC_MSKB3)//[29:29]    // Gazelle
    #define SCSYS_7B_INT_REF2R2R_PUL_CLR Fld(1,28,AC_MSKB3)//[28:28]
    #define SCSYS_7B_INT_REF2B2R_PUL_CLR Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_7B_INT_REF2GFX_PUL_CLR Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_7B_INT_REF2PSC_PUL_CLR Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_7B_INT_REF2FSC_PUL_CLR Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_7B_INT_GFX_OSD_VDE_F_CLR Fld(1,23,AC_MSKB2)//[23:23]
    #define SCSYS_7B_INT_GFX_OSD_VDE_R_CLR Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_7B_INT_GFX_OSD_VSYNC_F_CLR Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_7B_INT_GFX_OSD_VSYNC_R_CLR Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_7B_INT_GFX_VDE_F_CLR Fld(1,19,AC_MSKB2)//[19:19]
    #define SCSYS_7B_INT_GFX_VDE_R_CLR Fld(1,18,AC_MSKB2)//[18:18]
    #define SCSYS_7B_INT_GFX_VSYNC_F_CLR Fld(1,17,AC_MSKB2)//[17:17]
    #define SCSYS_7B_INT_GFX_VSYNC_R_CLR Fld(1,16,AC_MSKB2)//[16:16]
    #define SCSYS_7B_INT_TDSHARP_EN Fld(1,13,AC_MSKB1)//[13:13]   //Gazelle
    #define SCSYS_7B_INT_REF2R2R_PUL_EN Fld(1,12,AC_MSKB1)//[12:12]
    #define SCSYS_7B_INT_REF2B2R_PUL_EN Fld(1,11,AC_MSKB1)//[11:11]
    #define SCSYS_7B_INT_REF2GFX_PUL_EN Fld(1,10,AC_MSKB1)//[10:10]
    #define SCSYS_7B_INT_REF2PSC_PUL_EN Fld(1,9,AC_MSKB1)//[9:9]
    #define SCSYS_7B_INT_REF2FSC_PUL_EN Fld(1,8,AC_MSKB1)//[8:8]
    #define SCSYS_7B_INT_GFX_OSD_VDE_F_EN Fld(1,7,AC_MSKB0)//[7:7]
    #define SCSYS_7B_INT_GFX_OSD_VDE_R_EN Fld(1,6,AC_MSKB0)//[6:6]
    #define SCSYS_7B_INT_GFX_OSD_VSYNC_F_EN Fld(1,5,AC_MSKB0)//[5:5]
    #define SCSYS_7B_INT_GFX_OSD_VSYNC_R_EN Fld(1,4,AC_MSKB0)//[4:4]
    #define SCSYS_7B_INT_GFX_VDE_F_EN Fld(1,3,AC_MSKB0)//[3:3]
    #define SCSYS_7B_INT_GFX_VDE_R_EN Fld(1,2,AC_MSKB0)//[2:2]
    #define SCSYS_7B_INT_GFX_VSYNC_F_EN Fld(1,1,AC_MSKB0)//[1:1]
    #define SCSYS_7B_INT_GFX_VSYNC_R_EN Fld(1,0,AC_MSKB0)//[0:0]
#define SCPIP_SCSYS_7C (IO_SCPIP_BASE + 0x1F0)
    #define SCSYS_7C_SC_SCSYS_RESERVED0 Fld(32,0,AC_FULLDW)//[31:0]
#define SCPIP_SCSYS_7D (IO_SCPIP_BASE + 0x1F4)
    #define SCSYS_7D_SC_SCSYS_RESERVED1 Fld(32,0,AC_FULLDW)//[31:0]
#define SCPIP_SCSYS_7E (IO_SCPIP_BASE + 0x1F8)
    #define SCSYS_7E_SC_SCSYS_RESERVED2 Fld(32,0,AC_FULLDW)//[31:0]
#define SCPIP_SCSYS_7F (IO_SCPIP_BASE + 0x1FC)
    #define SCSYS_7F_SCSYS_ATPG_OB Fld(1,31,AC_MSKB3)//[31:31]
    #define SCSYS_7F_SCSYS_ATPG_CT Fld(1,30,AC_MSKB3)//[30:30]
#define SCPIP_SCSYS_00 (IO_SCPIP_BASE + 0x300)
    #define SCSYS_00_SC_TIME_GEN_OUT_SEL Fld(1,31,AC_MSKB3)//[31:31]
    #define SCSYS_00_SC_TIME_GEN_IN_SEL Fld(1,30,AC_MSKB3)//[30:30]
    #define SCSYS_00_REF_TG_IMPORT_ENABLE Fld(1,23,AC_MSKB2)//[23:23]
    #define SCSYS_00_C_GFX_TG_CLK_CLKEN Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_00_SC_GFX_TG_CLK_SWRST Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_00_C_REF_TG_CLK_CLKEN Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_00_SC_REF_TG_CLK_SWRST Fld(1,19,AC_MSKB2)//[19:19]
...
#define SCPIP_SCSYS_01 (IO_SCPIP_BASE + 0x304)
    ...
    #define SCSYS_01_MUX_TG_IMPORT_ENABLE Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_01_GFX_TG_IMPORT_ENABLE Fld(1,24,AC_MSKB3)//[24:24]
...
#define SCPIP_SCSYS_06 (IO_SCPIP_BASE + 0x318)
    ...
    #define SCSYS_06_SC_M_DISP_R_SEL Fld(1,10,AC_MSKB1)//[10:10]    //Gazelle
    #define SCSYS_06_SC_M_VSYNC_SEL Fld(1,9,AC_MSKB1)//[9:9]        //Gazelle
    #define SCSYS_06_SC_TG_SLAVE_INIT_DISP_R Fld(1,8,AC_MSKB1)//[8:8]
    #define SCSYS_06_SC_INV_HDMI_VSYNC_IN Fld(1,7,AC_MSKB0)//[7:7]
    #define SCSYS_06_SC_INV_HDMI_DISP_R Fld(1,6,AC_MSKB0)//[6:6]
    #define SCSYS_06_SC_DDDS_SRC_SEL Fld(2,4,AC_MSKB0)//[5:4]
    #define SCSYS_06_SC_TG_FORCE_ZERO_EN Fld(1,3,AC_MSKB0)//[3:3]
    #define SCSYS_06_SC_TG_SLAVE_SYNC_MODE Fld(1,2,AC_MSKB0)//[2:2]
    #define SCSYS_06_SC_TG_SLAVE_MODE Fld(1,1,AC_MSKB0)//[1:1]
    #define SCSYS_06_SC_TG_ENABLE Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCSYS_0A (IO_SCPIP_BASE + 0x328)
    #define SCSYS_0A_INT_STA_TDSHARP Fld(1,29,AC_MSKB3)//[29:29]    // Gazelle
    #define SCSYS_0A_INT_STA_REF2R2R_PUL Fld(1,28,AC_MSKB3)//[28:28]
    #define SCSYS_0A_INT_STA_REF2B2R_PUL Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_0A_INT_STA_REF2GFX_PUL Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_0A_INT_STA_REF2PSC_PUL Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_0A_INT_STA_REF2FSC_PUL Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_0A_INT_STA_GFX_OSD_VDE_F Fld(1,23,AC_MSKB2)//[23:23]
    #define SCSYS_0A_INT_STA_GFX_OSD_VDE_R Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_0A_INT_STA_GFX_OSD_VSYNC_F Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_0A_INT_STA_GFX_OSD_VSYNC_R Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_0A_INT_STA_GFX_VDE_F Fld(1,19,AC_MSKB2)//[19:19]
    #define SCSYS_0A_INT_STA_GFX_VDE_R Fld(1,18,AC_MSKB2)//[18:18]
    #define SCSYS_0A_INT_STA_GFX_VSYNC_F Fld(1,17,AC_MSKB2)//[17:17]
    #define SCSYS_0A_INT_STA_GFX_VSYNC_R Fld(1,16,AC_MSKB2)//[16:16]
...
#define SCPIP_SCSYS_0F (IO_SCPIP_BASE + 0x33C)
    #define SCSYS_0F_SC_FRM_TRK_CROSS_VSYNC_EN Fld(1,31,AC_MSKB3)//[31:31]
    #define SCSYS_0F_SC_FRM_TRK_3D_EN Fld(1,30,AC_MSKB3)//[30:30]
    #define SCSYS_0F_SC_FRM_TRK_DISP_R Fld(1,29,AC_MSKB3)//[29:29]
...
#define SCPIP_SCSYS_11 (IO_SCPIP_BASE + 0x344)
    #define SCSYS_11_SC_DDDS_TRK_INV Fld(1,30,AC_MSKB3)//[30:30]
    #define SCSYS_11_SC_FRM_TRK_DDDS_EN Fld(1,29,AC_MSKB3)//[29:29]
    #define SCSYS_11_SC_INV_OSD_TVE_VSYNC Fld(1,28,AC_MSKB3)//[28:28]
    #define SCSYS_11_SC_INV_INPUT_P_FIELD Fld(1,27,AC_MSKB3)//[27:27]
    #define SCSYS_11_SC_INV_INPUT_M_FIELD Fld(1,26,AC_MSKB3)//[26:26]
    #define SCSYS_11_SC_INV_MIB_DISP_R Fld(1,25,AC_MSKB3)//[25:25]
    #define SCSYS_11_SC_INV_INPUT_M_DISP_R Fld(1,24,AC_MSKB3)//[24:24]
    #define SCSYS_11_SC_INV_REF_DISP_R Fld(1,23,AC_MSKB2)//[23:23]
    #define SCSYS_11_SC_INV_REF_VSYNC_IN Fld(1,22,AC_MSKB2)//[22:22]
    #define SCSYS_11_SC_INV_INPUT_PVDE Fld(1,21,AC_MSKB2)//[21:21]
    #define SCSYS_11_SC_INV_INPUT_PHDE Fld(1,20,AC_MSKB2)//[20:20]
    #define SCSYS_11_SC_INV_INPUT_MVDE Fld(1,19,AC_MSKB2)//[19:19]
    #define SCSYS_11_SC_INV_INPUT_MHDE Fld(1,18,AC_MSKB2)//[18:18]
    #define SCSYS_11_SC_INV_HMSK Fld(1,17,AC_MSKB2)//[17:17]
    #define SCSYS_11_SC_INV_VMSK Fld(1,16,AC_MSKB2)//[16:16]
    #define SCSYS_11_SC_FRM_TRK_OUT_SEL Fld(2,14,AC_MSKB1)//[15:14]
    #define SCSYS_11_SC_FRM_TRK_IN_SEL Fld(2,12,AC_MSKB1)//[13:12]
...
#define SCPIP_SCSYS_12 (IO_SCPIP_BASE + 0x348)
    #define SCSYS_12_SC_OSD_HSYNC_DLY Fld(16,16,AC_FULLW32)//[31:16]
    #define SCSYS_12_SC_OSD_VSYNC_DLY Fld(16,0,AC_FULLW10)//[15:0]
...
#define SCPIP_SCSYS_14 (IO_SCPIP_BASE + 0x350)
    ...
    #define SCSYS_14_SC_OSD_SRC_SEL Fld(2,13,AC_MSKB1)//[14:13]
    #define SCSYS_14_SC_TVE_SRC_SEL Fld(1,12,AC_MSKB1)//[12:12]
    #define SCSYS_14_SC_OSD_HSYNC_SEL Fld(1,11,AC_MSKB1)//[11:11]
...
#define SCPIP_DRAM_M_00 (IO_SCPIP_BASE + 0xB00)
    #define DRAM_M_00_DA_RD_SHARE_MODE Fld(2,26,AC_MSKB3)//[27:26]     //gazelle
    #define DRAM_M_00_DA_WR_SHARE_MODE Fld(2,24,AC_MSKB3)//[25:24]
...
#define SCPIP_DRAM_M_01 (IO_SCPIP_BASE + 0xB04)
    ...
    #define DRAM_M_01_DA_RD_CHROMA_MODE Fld(1,6,AC_MSKB0)//[6:6]   // Gazelle
    #define DRAM_M_01_DA_RD_DISPLAY_MODE Fld(2,4,AC_MSKB0)//[5:4]  // Gazelle
...
#define SCPIP_DRAM_M_02 (IO_SCPIP_BASE + 0xB08)
    ...
    #define DRAM_M_02_STA_RD_REPEAT Fld(1,5,AC_MSKB0)//[5:5]
...
#define SCPIP_DRAM_P_02 (IO_SCPIP_BASE + 0xC08)
    ...
    #define DRAM_P_02_STA_RD_REPEAT Fld(1,5,AC_MSKB0)//[5:5]
...
#define SCPIP_DRAM_P_12 (IO_SCPIP_BASE + 0xC48)
    #define DRAM_P_12_STA_WR_FLD Fld(1,31,AC_MSKB3)//[31:31]
    #define DRAM_P_12_DA_FLD_INT_EN Fld(1,18,AC_MSKB2)//[18:18]
    #define DRAM_P_12_DA_ADDR_FLD_INV Fld(1,17,AC_MSKB2)//[17:17]
    #define DRAM_P_12_DA_CTRL_FLD_INV Fld(1,16,AC_MSKB2)//[16:16]
