...
#define HDMI2_PATH_SEL (IO_VIRT_DVI+(IO_DVI_BASE+0x4b8))
    #define FLD_HDMI2_PATH_CCIR0 Fld(1,3,AC_MSKB0)//[3:3]
    #define FLD_HDMI2_PATH_CCIR1 Fld(1,7,AC_MSKB0)//[7:7]
    #define FLD_HDMI2_PATH_W2D Fld(1,11,AC_MSKB1)//[11:11]
    #define FLD_HDMI2_PATH_AUD_CLK Fld(1,15,AC_MSKB1)//[15:15]
...
#define DVI_HDTV_03 (IO_VIRT_DVI+(IO_DVI_BASE+0x20C))
	...
	#define DVI_HDTV_03_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x20F))
		#define STA_CCH_HDELEN Fld(13, 19, AC_MSKW32)//31:19
        #define STA_CCH_3D_ST Fld(4,15,AC_MSKB2)//[18:15]
...
#define DVI_HDTV_04 (IO_VIRT_DVI+(IO_DVI_BASE+0x210))
	...
	#define DVI_HDTV_04_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x213))
		...
		#define STA_CCH_INT_DE Fld(1, 26, AC_MSKB2)//26
		#define STA_CCH_VSLEN Fld(13, 13, AC_MSKW21)//25:13
		#define STA_CCH_VTOTAL Fld(13, 0, AC_MSKW10)//12:0
...
#define CCIR_HDTV_06 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A0))
  #define CCIR_HDTV_06_0 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A0))
  #define CCIR_HDTV_06_1 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A1))
  #define CCIR_HDTV_06_2 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A2))
  #define CCIR_HDTV_06_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A3))
  	#define CCH_VDE_WIDTH Fld(13, 16, AC_MSKW32)//28:16
    #define CCH_VS_START Fld(13,0,AC_MSKW10)//[12:0]
    
#define CCIR_HDTV_07 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A4))
  #define CCIR_HDTV_07_0 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A4))
  #define CCIR_HDTV_07_1 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A5))
  #define CCIR_HDTV_07_2 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A6))
  #define CCIR_HDTV_07_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A7))
	#define CCH_3D_VACT Fld(13,0,AC_MSKW32)//[12:0]
	
#define CCIR_HDTV_08 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A8))
	#define CCIR_HDTV_08_0 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A8))
	#define CCIR_HDTV_08_1 (IO_VIRT_DVI+(IO_DVI_BASE+0x7A9))
	#define CCIR_HDTV_08_2 (IO_VIRT_DVI+(IO_DVI_BASE+0x7Aa))
	#define CCIR_HDTV_08_3 (IO_VIRT_DVI+(IO_DVI_BASE+0x7Ab))
		#define CCH_VS_START_PIP Fld(13,0,AC_MSKW10)//[12:0]
		#define CCH_VDE_WIDTH_PIP Fld(13,16,AC_MSKW32)//[28:16]
		
#define CCIR_HDTV_09 (IO_VIRT_DVI+(IO_DVI_BASE+0x7AC))	
		#define DVI_3D_VACT_PIP Fld(13,0,AC_MSKW10)//[12:0]
...
#define CCIR_04_NEW (IO_VIRT_DVI+(IO_DVI_BASE+0x8AC))
    ...
    #define CCH_VIDEO_SEL Fld(1,3,AC_MSKB0)//[3:3]
#define CCIR_05_NEW (IO_VIRT_DVI+(IO_DVI_BASE + 0x2A0))
    #define STA_CCH_NEW_HTOTAL Fld(13,0,AC_MSKW10)//[12:0]
    #define STA_CCH_NEW_HDE Fld(13,19,AC_MSKW32)//[31:19]
#define CCIR_06_NEW (IO_VIRT_DVI+(IO_DVI_BASE + 0x2A4))
    #define STA_CCH_NEW_VTOTAL Fld(13,0,AC_MSKW10)//[12:0]
    #define STA_CCH_NEW_VSLEN Fld(13,13,AC_MSKDW)//[25:13]
#endif
