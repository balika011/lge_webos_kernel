...
#define SV_PATTERN_SCEI_PS3P 0x50335350 //P3SP, mapped from ASIC Code
typedef struct
{
...
extern BOOL _fgIsMHLDiscoveryOK;
...
extern UINT32 u4GetHdmiRegBase(E_HDMI_SWITCH_NUM ePort);
extern void vHDMIAudDbgMsg(void);
...
extern void vHDMIHDCPEN(UINT8 u1En);
#ifdef CC_SUPPORT_W2DR2R
extern UINT32 dwHDMILineFreqByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
extern UINT8 bHDMIRefreshRateByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
extern BOOL fgHDMIinterlacedByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
extern UINT16 wHDMIVTotalByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
extern UINT16 wHDMIHTotalByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
extern UINT16 wHDMIResoHeightByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
extern UINT16 wHDMIResoWidthByPort(E_HDMI_SWITCH_NUM u1HdmiPort);
#endif
#ifdef CC_COMBINE_4K_2K
UINT8 u1GetHDMI2KModel(void);
void vHdmiSwitchCmdTest(UINT8 cmd, UINT32 value);
#endif
