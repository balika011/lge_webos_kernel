...
extern UINT16 u2MpegHdInputWidth(UINT8 bPath);
extern UINT16 u2MpegSdInputWidth(UINT8 bPath);
...
extern UINT8 u1MpegHdClock(UINT8 bPath);
extern UINT8 u1MpegSdClock(UINT8 bPath);
...
extern UINT32 u4MpegHdPreciseRefreshRate(UINT8 bPath);
extern UINT32 u4MpegSdPreciseRefreshRate(UINT8 bPath);
