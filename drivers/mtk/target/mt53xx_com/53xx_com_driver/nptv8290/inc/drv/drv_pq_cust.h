...
#else
extern UINT8 bCustomQtyTbl[FLASHPQ_NUM][CUSTOMIZE_FLASHPQ_TOTAL_TIMING][CUSTOM_QTY_TBL_DIM];
#endif
#define READ_CUSTOM_QTY_TBL(timing,item) (bCustomQtyTbl[((item>>QTY_TBL_REF_INDEX_SHIFT)<FLASHPQ_NUM)?(item>>QTY_TBL_REF_INDEX_SHIFT):0][MIN(timing, CUSTOMIZE_FLASHPQ_TOTAL_TIMING-1)][item &0x3FFF])
#define WRITE_CUSTOM_QTY_TBL(timing,item,value) {bCustomQtyTbl[item>>QTY_TBL_REF_INDEX_SHIFT][MIN(timing, CUSTOMIZE_FLASHPQ_TOTAL_TIMING-1)][item &0x3FFF]=(value);}
