...
typedef struct{
	UINT16  Cur_AVStart_Value;
	UINT16  Old_AVStart_Value;
	UINT16  Cur_AVWidth_Value;
	UINT16  Old_AVWidth_Value;

	UINT16  Cur_VSStart_Value;
	UINT16  Old_VSStart_Value;
	UINT16  Cur_VDEWidth_Value;
	UINT16  Old_VDEWidth_Value;

	UINT8   New_Pattern_Num;
	UINT8   Old_Pattern_Num;
	
}CCIR_Blank_Value_T;
extern CCIR_Blank_Value_T CCIRBlankValue;
