...
#define PORTA_PWD 3
#define PORTB_PWD 4//set LVDS pin as GPIO.
...
extern void vDrvLVDSToGPIOInit(UINT8 u1OnOff);
extern void vDrvSetLVDSToGPI(UINT8 u1LVDSPin, UINT8 u1OnOff);
extern void vDrvSetLVDSToGPO(UINT8 u1LVDSPin, UINT8 u1OnOff);
...
#endif
extern void vDrvSetPanelIFRGBInOrder(UINT8 u1R,UINT8 u1G,UINT8 u1B);
