...
//Address = 0x04
#define	DEVCAP_ADOPTER_ID_L				0x43
...
enum
{
	PATH_EN_NAGTIVE = 0x0,//PATH_EN{0}
	PATH_EN_POSITIVE = 0x1,//PATH_EN{1}
};
enum
{
	WRITE_BURST_END = 0X0, //Stop the write.
	WRITE_BURST_BEGIN = 0x1,// the first time to write after received GRT_WRT.
	WRITE_BURST_CONT = 0x2,//the continue writting, if the 3D data is not finished.
	WRITE_BURST_HAL_REQ = 0x3,//HAL request write.
};
enum
{
...
//For 5861
#define FLD_HDMI_GZL_2_HPD_CBUS Fld(2,30,AC_MSKB3)//[31:30]
#define ENABLE_GZL_PINMUX_TO_CBUS() ((void)vRegWriteFldAlign(PDWNC_PINMUX4,1,FLD_HDMI_GZL_2_HPD_CBUS))
#define DISABLE_GZL_PINMUX_TO_CBUS() ((void)vRegWriteFldAlign(PDWNC_PINMUX4,0,FLD_HDMI_GZL_2_HPD_CBUS)) 
#endif
...
// Public functions
//---------------------------------------------------------------------------
extern UINT8 _arMhlSrcDevCap[0x10];
...
extern void vCbusSendWriteBurstHalCmd(void);
#else
...
extern Resister_State eResist_state;
