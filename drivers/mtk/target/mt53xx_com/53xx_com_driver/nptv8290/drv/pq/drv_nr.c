...
{
    {MCNR_00,    0x0000003C, 0x0000007C},       // MCNR_DCNR_STRENGTH = F
#if !PQL_DB_ON
    {MCNR_09,    0xFE3F8F00, 0xFFFFFF80},       // MCNR_DC_MODE_WEI_Y_BASE = 0xF, DIFF_THD_Y_BASE = 7, SLOP_Y = 0, MAX_WEI = 0x1E
#endif
...
void vDrvNRSet3DNRMode(E_3DNR_MODE e3DMode)
{
    switch (e3DMode)
    {
        ...
        case MCNR_MODE_NM:
        case MCNR_MODE_MA:
            NR_WM(MCNR_00, P_Fld(1, MCNR_ENABLE));   
            NR_WM(MCNR_00, P_Fld(((UINT8)e3DMode-1), MCNR_MODE));
            break;
        case MCNR_MODE_OFF:
            default:
            NR_WM(MCNR_00, P_Fld(0, MCNR_ENABLE));    
            NR_WM(MCNR_00, P_Fld(0, MCNR_MODE));
            break;
    }
...
void vDrvNRSetQuality(UINT8 u1Interlace, UINT16 u2Width, UINT16 u2Height)
{
    ...
    case MODE_3840_2160P_30:
        vDrvLoadRegTbl(_MCNR_PQ_PARAM[E_MCNR_4k2k]);
        u4Thd8 = 0x38;
    ...
    _SWW(NR_NM_06, 0, NM_SC_Q_NL_MODE);
...
void vDrvNRSet3DNRParam(void)
{
	...
	_SWWM(NR_PQ_22, _P3D(NR_TBL_THD_AUTO1_MIN_1)|_P3D(NR_TBL_THD_AUTO1_MIN_2)|_P3D(NR_TBL_THD_AUTO1_MIN_3)|_P3D(NR_TBL_THD_AUTO1_MIN_4));
    _SWWM(NR_PQ_23, _P3D(NR_TBL_THD_AUTO1_MIN_5)|_P3D(NR_TBL_THD_AUTO1_MIN_6)|_P3D(NR_TBL_THD_AUTO1_MIN_7)|_P3D(NR_TBL_THD_AUTO1_MIN_8));
	_SWWM(NR_PQ_24, _P3D(NR_TBL_THD_AUTO1_MAX_1)|_P3D(NR_TBL_THD_AUTO1_MAX_2)|_P3D(NR_TBL_THD_AUTO1_MAX_3)|_P3D(NR_TBL_THD_AUTO1_MAX_4));
	_SWWM(NR_PQ_25, _P3D(NR_TBL_THD_AUTO1_MAX_5)|_P3D(NR_TBL_THD_AUTO1_MAX_6)|_P3D(NR_TBL_THD_AUTO1_MAX_7)|_P3D(NR_TBL_THD_AUTO1_MAX_8));
	_SWWM(NR_PQ_26, _P3D(NR_TBL_THD_AUTO2_MIN_1)|_P3D(NR_TBL_THD_AUTO2_MIN_2)|_P3D(NR_TBL_THD_AUTO2_MIN_3)|_P3D(NR_TBL_THD_AUTO2_MIN_4));
    _SWWM(NR_PQ_27, _P3D(NR_TBL_THD_AUTO2_MIN_5)|_P3D(NR_TBL_THD_AUTO2_MIN_6)|_P3D(NR_TBL_THD_AUTO2_MIN_7)|_P3D(NR_TBL_THD_AUTO2_MIN_8));
	_SWWM(NR_PQ_28, _P3D(NR_TBL_THD_AUTO2_MAX_1)|_P3D(NR_TBL_THD_AUTO2_MAX_2)|_P3D(NR_TBL_THD_AUTO2_MAX_3)|_P3D(NR_TBL_THD_AUTO2_MAX_4));
	_SWWM(NR_PQ_29, _P3D(NR_TBL_THD_AUTO2_MAX_5)|_P3D(NR_TBL_THD_AUTO2_MAX_6)|_P3D(NR_TBL_THD_AUTO2_MAX_7)|_P3D(NR_TBL_THD_AUTO2_MAX_8));
	...
	_SWWM(NR_PQ_1A, _P3D(NR_TBL_MA_AUTO1_MIN_0)|_P3D(NR_TBL_MA_AUTO1_MIN_1)|_P3D(NR_TBL_MA_AUTO1_MIN_2)|_P3D(NR_TBL_MA_AUTO1_MIN_3)|_P3D(NR_TBL_MA_AUTO1_MIN_4));
    _SWWM(NR_PQ_1B, _P3D(NR_TBL_MA_AUTO1_MIN_5)|_P3D(NR_TBL_MA_AUTO1_MIN_6)|_P3D(NR_TBL_MA_AUTO1_MIN_7));
	_SWWM(NR_PQ_1C, _P3D(NR_TBL_MA_AUTO1_MAX_0)|_P3D(NR_TBL_MA_AUTO1_MAX_1)|_P3D(NR_TBL_MA_AUTO1_MAX_2)|_P3D(NR_TBL_MA_AUTO1_MAX_3)|_P3D(NR_TBL_MA_AUTO1_MAX_4));
    _SWWM(NR_PQ_1D, _P3D(NR_TBL_MA_AUTO1_MAX_5)|_P3D(NR_TBL_MA_AUTO1_MAX_6)|_P3D(NR_TBL_MA_AUTO1_MAX_7));
	_SWWM(NR_PQ_1E, _P3D(NR_TBL_MA_AUTO2_MIN_0)|_P3D(NR_TBL_MA_AUTO2_MIN_1)|_P3D(NR_TBL_MA_AUTO2_MIN_2)|_P3D(NR_TBL_MA_AUTO2_MIN_3)|_P3D(NR_TBL_MA_AUTO2_MIN_4));
    _SWWM(NR_PQ_1F, _P3D(NR_TBL_MA_AUTO2_MIN_5)|_P3D(NR_TBL_MA_AUTO2_MIN_6)|_P3D(NR_TBL_MA_AUTO2_MIN_7));
	_SWWM(NR_PQ_20, _P3D(NR_TBL_MA_AUTO2_MAX_0)|_P3D(NR_TBL_MA_AUTO2_MAX_1)|_P3D(NR_TBL_MA_AUTO2_MAX_2)|_P3D(NR_TBL_MA_AUTO2_MAX_3)|_P3D(NR_TBL_MA_AUTO2_MAX_4));
    _SWWM(NR_PQ_21, _P3D(NR_TBL_MA_AUTO2_MAX_5)|_P3D(NR_TBL_MA_AUTO2_MAX_6)|_P3D(NR_TBL_MA_AUTO2_MAX_7));
	...
	NR_WM(MCNR_38,
        P_Fld(wReadQualityTable(QUALITY_3DNR_DNR0_H_MM_TH), DNR0_H_MM_TH)|
        P_Fld(wReadQualityTable(QUALITY_3DNR_DNR0_V_MM_TH), DNR0_V_MM_TH)|
        P_Fld(wReadQualityTable(QUALITY_3DNR_DNR0_DOT_MAX_AMP_TH), DNR0_DOT_MAX_AMP_TH));
	NR_WM(MCNR_39,
        P_Fld(wReadQualityTable(QUALITY_3DNR_DNR0_EN), DNR0_EN));
...
void vDrvNRSetMpegNRParam(void)
{
	...
	NR_WM(NXNR_38,
        P_Fld(wReadQualityTable(QUALITY_2DNR_DNR1_H_MM_TH), DNR1_H_MM_TH)|
        P_Fld(wReadQualityTable(QUALITY_2DNR_DNR1_V_MM_TH), DNR1_V_MM_TH)|
        P_Fld(wReadQualityTable(QUALITY_2DNR_DNR1_DOT_MAX_AMP_TH), DNR1_DOT_MAX_AMP_TH));
	NR_WM(NXNR_39,
        P_Fld(wReadQualityTable(QUALITY_2DNR_DNR1_FILTER_EN), DNR1_FILTER_EN));
}
void vDrvNRSetDotNRParam(void)
{
	vDrvNRSet2DDotCrawlNROnOff(wReadQualityTable(QUALITY_2DNR_DNR1_FILTER_EN));
	vDrvNRSet3DDotCrawlNROnOff(wReadQualityTable(QUALITY_3DNR_DNR0_EN));

	NR_WM(MCNR_38, _P3D(DNR0_H_MM_TH)|_P3D(DNR0_V_MM_TH)|_P3D(DNR0_DOT_MAX_AMP_TH));
    NR_WM(NXNR_38, _P2D(DNR1_H_MM_TH)|_P2D(DNR1_V_MM_TH)|_P2D(DNR1_DOT_MAX_AMP_TH));
}
...
void vDrvNRSet2DDotCrawlNROnOff(UINT8 u1OnOff)
{
	UINT32 u4VdoTiming = bDrvVideoGetTiming(SV_VP_MAIN);
...
void vDrvNRSet3DDotCrawlNROnOff(UINT8 u1OnOff)
{
	UINT32 u4VdoTiming = bDrvVideoGetTiming(SV_VP_MAIN);
...
{
	_SWW(NR_PQ_1B, u1OnOff, NR_AUTO_MODE);
