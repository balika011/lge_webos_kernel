...
//#undef CC_YPBPR_ADAPTIVE_SLICER_REDUCE_TIME
//#endif
        ...
        switch(bHdtvMDStateMachine)
        {
            ...
            case 2:
                ...
                if(bHdtvOpt05_AdaptiveSlicer && fgIsVideoTiming(_bHdtvTiming)&&
					((Get_VGAMODE_IVTOTAL(_bHdtvTiming)-wASVtotalMeasure()*(Get_VGAMODE_INTERLACE(_bHdtvTiming)+1) >1)||
					(wASVtotalMeasure()*(Get_VGAMODE_INTERLACE(_bHdtvTiming)+1)-Get_VGAMODE_IVTOTAL(_bHdtvTiming) >1)
				#ifdef CC_HDTV_NON_STANDARD
