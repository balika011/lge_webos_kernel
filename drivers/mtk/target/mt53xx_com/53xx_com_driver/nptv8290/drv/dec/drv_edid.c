...
#ifndef CC_HDMI_2_0_HDCP_BIN
extern UINT8 u1MhlEdid_P0[256];
#endif
#endif
...
#if defined(CC_MT5890)
void vMHL_INTERNAL_EDID_Init(void)
{
#ifdef CC_HDMI_2_0_HDCP_BIN
	vHDMILoadMhlEdidToSram();
#else
	...
	for(i=0; i < 256; i++)
	{
		...
		vIO32Write4B(PDWNC_MHL_EDID_DATA,u1MhlEdid_P0[i]);
		//vUtDelay2us(1);
	}
#endif
}
