...
#define SUPPORT_SD_HDTV_704_WIDTH 0
...
{
#if SUPPORT_SD_HDTV_704_WIDTH
	if(((fgIsMainDec() && !fgIsMainDVI()) || (fgIsPipDec() && !fgIsPipDVI()))
		&&((mode==MODE_525I_OVERSAMPLE) || (mode==MODE_625I_OVERSAMPLE) || (mode==MODE_480P_OVERSAMPLE)||(mode==MODE_576P_OVERSAMPLE)
			||(mode==MODE_525I)||(mode==MODE_625I)|| (mode==MODE_480P) || (mode==MODE_576P) ) 
		&&(((VGATIMING_TABLE[mode].IPH_WID)%720)==0))
	{
		VGATIMING_TABLE[mode].IPH_WID=704*(VGATIMING_TABLE[mode].IPH_WID/720);
