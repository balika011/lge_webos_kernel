...
//====================================================================================
sLdmSpiCommandSet sSonySpiFunc = 
{
...
//====================================================================================
/*
Sets the header/footer of the LD¡¦s SPI message.
    Parameters
        header.
            Header 0 & Header 1 << 16.
        footer
            Footer 0  & Footer 1 << 16.
    Return
        None.
...
{
    vIO32WriteFldAlign(LED_NHEAD, (UINT16)(u4CmdHeader&0xFFFF), NHEAD_0);  
    vIO32WriteFldAlign(LED_NHEAD, (UINT16)(u4CmdHeader>>16)   , NHEAD_1);  
    vIO32WriteFldAlign(LED_NFOOT, (UINT16)(u4CmdFooter&0xFFFF), NFOOT_0);  
    vIO32WriteFldAlign(LED_NFOOT, (UINT16)(u4CmdFooter>>16)   , NFOOT_1);  
...
{    
    vDrvLcdimSpiSendDataHWMode(u1AmbilCmd, u2CmdLength);     
}
...
{    
    ...
    vIO32WriteFldAlign(LED_CON, SV_TRUE, HW_TRIG_EN);  
    ...
    vIO32WriteFldAlign(LED_NOB, 28, MDATA_LEN);     // 224 x 2 bits, only for initialization
    vIO32WriteFldAlign(LED_NOB, 1, NDATA_LEN);          

    vIO32WriteFldAlign(LED_NOB, 2, NHEAD_LEN);     // 224 x 2 bits, only for initialization
    vIO32WriteFldAlign(LED_NOB, 2, NFOOT_LEN);          
