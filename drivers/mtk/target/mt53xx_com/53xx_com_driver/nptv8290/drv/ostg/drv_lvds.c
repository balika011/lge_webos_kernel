...
static void _vDrvLVDSConfigFormat(void)
{
	...
	if (IS_SEPARATE_OSD_AND_DATA)
	{
        vIO32WriteFldAlign(LVDSB_REG26, 3, RG_OSD_SWITCH_CH);  
...
void vDrvLVDSInit(void)
{
    ...
    {
#ifndef LVDS_GPIO_SUPPORT
 	#ifdef CC_MT5881
     		if(LVDS_OUTPUT_PORT == DUAL_PORT)
     		{
      			vIO32WriteFldMulti(REG_LVDS_TX_CFG6, P_Fld(0x1fff,RG_LVDSB_R_TERM_EVEN_D11) |P_Fld(0x1fff,RG_LVDSB_R_TERM_ODD_D11) );
     		}
     		else
  	#endif 
     		{
	...
	vIO32WriteFldMulti(REG_LVDS_TX_CFG20, P_Fld(1, RG_LVDSA_LDO_BIAS_EVEN_PWD_D11)|P_Fld(1, RG_LVDSA_LDO_EVEN_PWD_D11)|P_Fld(1, RG_LVDSA_LDO_BIAS_ODD_PWD_D11)|P_Fld(1, RG_LVDSA_LDO_ODD_PWD_D11));
    vIO32WriteFldMulti(REG_LVDS_TX_CFG12, P_Fld(0x0B, RG_LVDSA_TVCM)|P_Fld(1, RG_LVDSA_NSRC)|P_Fld(1, RG_LVDSA_PSRC)
	...
	#if defined(CC_MT5890)
    vIO32WriteFldMulti(REG_LVDS_TX_CFG15, P_Fld(0, RG_LVDSA_HSN_MODE_EVEN_EN_D11)|P_Fld(0, RG_LVDSA_HSP_MODE_EVEN_EN_D11)|P_Fld(0, RG_LVDSA_HSN_MODE_ODD_EN_D11)|P_Fld(0, RG_LVDSA_HSP_MODE_ODD_EN_D11));
    vIO32WriteFldMulti(REG_LVDS_TX_CFG13, P_Fld(4, RG_LVDSA_BIAS_SEL)|P_Fld(1, RG_LVDSA_NSRC_PRE)|P_Fld(1, RG_LVDSA_PSRC_PRE));

    vIO32WriteFldAlign(REG_LVDS_TX_CFG15, 0xFFF, RG_LVDSA_LVDS_SEL);
	...
	#if defined(CC_MT5890)
    vIO32WriteFldAlign(REG_LVDS_TX_CFG20, 0x1, RG_LVDSA_RESYNC_LVDS_SEL_D11);
...
//  1mA,  1mA,  2mA, 3mA,   4mA,   5mA,   6mA,   7mA,    8mA,//for Oryx 
...
{    
    ...
    vIO32WriteFldAlign(REG_LVDS_TX_CFG12, bDriving, RG_LVDSA_TVO);
...
UINT8 vDrvLVDSGetDriving(void)
{
    UINT8 bDriving;
	#if defined(CC_MT5890)
    bDriving = IO32ReadFldAlign(REG_LVDS_TX_CFG12,  RG_LVDSA_TVO) /2+1;
    #else
    bDriving =( (IO32ReadFldAlign(REG_LVDS_TX_CFG3,  RG_LVDSB_TVO_EVEN_D11) )>>24)/2+1;
    #endif
	bDriving &= 0xf;  //0~15
    return (bDriving);
}
...
{    
    bVCM &= 0xf;  //0~15
	#if defined(CC_MT5890)
    vIO32WriteFldAlign(REG_LVDS_TX_CFG12, bVCM, RG_LVDSA_TVCM);
	#endif
...
{
    UINT8 bVCM;
    bVCM = IO32ReadFldAlign(REG_LVDS_TX_CFG0,  RG_LVDSB_TVCM_D11 );
	bVCM &= 0xf;  //0~15
    return (bVCM);
}
...
void vSetLVDSPadPD(UINT32 u4PDVal)
{
   ...
   vIO32WriteFldAlign(REG_LVDS_TX_CFG12, (0xFFF-u4PDVal), RG_LVDSA_EXT_EN_D11);
   //vIO32WriteFldAlign(REG_LVDS_TX_CFG0, (0xFFF-(u4PDVal>>12)), RG_LVDSB_EXT_EN_D11);
   vIO32WriteFldAlign(REG_LVDS_TX_CFG12, 0x1, RG_LVDSA_EXT_EN_D11_E0);
   vIO32WriteFldAlign(REG_LVDS_TX_CFG13, u4PDVal, RG_LVDSA_DRV_PWD);
...
void u4ReadAPad(void)
{
	...
	printf("LVDSA_EXT_EN:  <0x%3x>\n", IO32ReadFldAlign(REG_LVDS_TX_CFG12,RG_LVDSA_EXT_EN_D11));
	printf("LVDSA_DRV_PWD: <0x%3x>\n", IO32ReadFldAlign(REG_LVDS_TX_CFG13,RG_LVDSA_DRV_PWD));
#endif
	printf("			         ECK E5 E4 | E3 E2 E1 E0\n");
	printf("LVDSB_DRV_EN_EVEN:  <0x%2x>\n", IO32ReadFldAlign(REG_LVDS_TX_CFG1,RG_LVDSB_DRV_EN_EVEN_D11));
	printf("			         OCK O5 O4 | O3 O2 O1 O0\n");
	printf("LVDSB_DRV_EN_ODD:   <0x%2x>\n", IO32ReadFldAlign(REG_LVDS_TX_CFG1,RG_LVDSB_DRV_EN_ODD_D11));
...
void vSetLVDSAPad(UINT8 u1OnOff, UINT16 u4BExtEn, UINT16 u4BDrvPwd,UINT16 u4AExtEn, UINT16 u4ADrvPwd)
{
	...
	switch (u1OnOff)
	{
		case 0:  // power on
			...
			break;
		case 1:  // power down
			vSetLVDSPadPD(0xFFFFFF);
			break;
		case 2: // user-defined
		#if defined(CC_MT5890)
			vIO32WriteFldAlign(REG_LVDS_TX_CFG12, u4AExtEn, RG_LVDSA_EXT_EN_D11);
   			vIO32WriteFldAlign(REG_LVDS_TX_CFG12, 0x1, RG_LVDSA_EXT_EN_D11_E0);
   			vIO32WriteFldAlign(REG_LVDS_TX_CFG13, u4ADrvPwd, RG_LVDSA_DRV_PWD);
		#endif
    		EVEN=(( u4BExtEn>>6)|(((u4BExtEn>>6)&& 0x20)<<7))&0x5F;
        	ODD=(( u4BExtEn&0x3F)|(((u4BExtEn&0x3F)&& 0x20)<<7))&0x5F;
		    vIO32WriteFldMulti(REG_LVDS_TX_CFG1, P_Fld(EVEN, RG_LVDSB_DRV_EN_EVEN_D11)|P_Fld(ODD,RG_LVDSB_DRV_EN_ODD_D11));
			break;
		case 3:  // port A power down
		#if defined(CC_MT5890)
			vIO32WriteFldAlign(REG_LVDS_TX_CFG12, 0x0, RG_LVDSA_EXT_EN_D11);
   			vIO32WriteFldAlign(REG_LVDS_TX_CFG12, 0x1, RG_LVDSA_EXT_EN_D11_E0);
   			vIO32WriteFldAlign(REG_LVDS_TX_CFG13, 0xfff, RG_LVDSA_DRV_PWD);
		#endif
			break;
		case 4: // port B power down
			vIO32WriteFldMulti(REG_LVDS_TX_CFG1, P_Fld(0x0, RG_LVDSB_DRV_EN_EVEN_D11)|P_Fld(0x0,RG_LVDSB_DRV_EN_ODD_D11));
			break;
		default:
			break;
	}
...
void vDrvLVDSOn(void)
{
	...
	#if defined(CC_MT5890)
    vIO32WriteFldMulti(REG_LVDS_TX_CFG12,P_Fld( 0, RG_LVDSA_BIAS_ODD_PWD)|P_Fld( 0, RG_LVDSA_BIAS_EVEN_PWD));
    vIO32WriteFldMulti(REG_LVDS_TX_CFG20,P_Fld( 0, RG_LVDSA_LDO_BIAS_ODD_PWD_D11)|P_Fld( 0, RG_LVDSA_LDO_BIAS_EVEN_PWD_D11));
    vIO32WriteFldMulti(REG_LVDS_TX_CFG20, P_Fld( 0, RG_LVDSA_LDO_ODD_PWD_D11)|P_Fld( 0, RG_LVDSA_LDO_EVEN_PWD_D11));
	vIO32WriteFldAlign(REG_LVDS_TX_CFG12, 1, RG_LVDSA_EN);    
    #endif
...
void vDrvLVDSOff(void)
{
	...
	#if defined(CC_MT5890)
    vIO32WriteFldMulti(REG_LVDS_TX_CFG12, P_Fld(0, RG_LVDSA_EXT_EN_D11)|P_Fld(0,RG_LVDSA_EN));    
    vIO32WriteFldAlign(REG_LVDS_TX_CFG13, 0xFFF, RG_LVDSA_DRV_PWD);    
    vIO32WriteFldMulti(REG_LVDS_TX_CFG20, P_Fld( 1, RG_LVDSA_LDO_ODD_PWD_D11)|P_Fld( 1, RG_LVDSA_LDO_EVEN_PWD_D11));
    vIO32WriteFldMulti(REG_LVDS_TX_CFG20,P_Fld( 1, RG_LVDSA_LDO_BIAS_ODD_PWD_D11)|P_Fld( 1, RG_LVDSA_LDO_BIAS_EVEN_PWD_D11));
    vIO32WriteFldMulti(REG_LVDS_TX_CFG12,P_Fld( 1, RG_LVDSA_BIAS_ODD_PWD)|P_Fld( 1, RG_LVDSA_BIAS_EVEN_PWD));
    #endif
...
void LVDS_ATERM_ATVO_Setting(UINT8 mode)
{
   ...
   {
	#if defined(CC_MT5890)
	vIO32WriteFldAlign(REG_LVDS_TX_CFG12,8,RG_LVDSA_TVO);
	#endif
    LVDSTVO=vDrvLVDSsettingDrivingCurrent(8);
    vIO32WriteFldAlign(REG_LVDS_TX_CFG3,  LVDSTVO, RG_LVDSB_TVO_EVEN_D11);
    vIO32WriteFldAlign(REG_LVDS_TX_CFG4, LVDSTVO, RG_LVDSB_TVO_ODD_D11);
     vIO32WriteFldMulti(REG_LVDS_TX_CFG6, P_Fld(0x3fff,RG_LVDSB_R_TERM_EVEN_D11)| P_Fld(0x3fff,RG_LVDSB_R_TERM_ODD_D11));   
   }
   ...
   {
	#if defined(CC_MT5890)
	vIO32WriteFldAlign(REG_LVDS_TX_CFG12,4,RG_LVDSA_TVO);
	#endif
...
{
	#if defined(CC_MT5890)
	vIO32WriteFldAlign(REG_LVDS_TX_CFG12,ATVO,RG_LVDSA_TVO);
	#endif
...
{
	#if defined(CC_MT5890)
	vIO32WriteFldAlign(REG_LVDS_TX_CFG12,mode,RG_LVDSA_TVO);
	#endif
...
void MLVDS_LS_Set(UINT8 mode)
{
   if (mode==0)
      {
		#if defined(CC_MT5890)
        vIO32WriteFldMulti(REG_LVDS_TX_CFG12, P_Fld(1, RG_LVDSA_NSRC)|P_Fld(1, RG_LVDSA_PSRC));
        #endif
      ...
      {
		#if defined(CC_MT5890)
        vIO32WriteFldMulti(REG_LVDS_TX_CFG12, P_Fld(0, RG_LVDSA_NSRC)|P_Fld(7, RG_LVDSA_PSRC));
        #endif
...
{
	vIO32WriteFldAlign(REG_LVDSTX_PLL_CFG2, u1Phase, REG_LVDSTX_PLL_CFG2_VPLL_DLY_DATA);
}
...
void vDrvLVDSToGPIOInit(UINT8 u1OnOff)
{
	UINT32 u4Val_tmp=0;
	UINT8 EPD=0;
    UINT8 OPD=0;
	...
	// only for Port B
	if (u1OnOff)  // Set to GPO/I
	{
		pu4GPOMap = (UINT32*)DRVCUST_PanelGet(ePanelLVDSToGPO);
		pu4GPIMap = (UINT32*)DRVCUST_PanelGet(ePanelLVDSToGPI);
		vIO32WriteFldMulti(REG_LVDS_TX_CFG1, P_Fld(0x0, RG_LVDSB_DRV_EN_EVEN_D11)|P_Fld(0x0,RG_LVDSB_DRV_EN_ODD_D11));
		vIO32WriteFldMulti(REG_LVDS_TX_CFG7,P_Fld(pu4GPOMap[27], RG_LVDSB_ECKP_GPO_EN)|P_Fld(pu4GPOMap[26], RG_LVDSB_ECKN_GPO_EN)|P_Fld(pu4GPOMap[25], RG_LVDSB_E5P_GPO_EN)|P_Fld(pu4GPOMap[24], RG_LVDSB_E5N_GPO_EN)
										|P_Fld(pu4GPOMap[23], RG_LVDSB_E4P_GPO_EN)|P_Fld(pu4GPOMap[22], RG_LVDSB_E4N_GPO_EN)|P_Fld(pu4GPOMap[21], RG_LVDSB_E3P_GPO_EN)|P_Fld(pu4GPOMap[20], RG_LVDSB_E3N_GPO_EN)
										|P_Fld(pu4GPOMap[19], RG_LVDSB_E2P_GPO_EN)|P_Fld(pu4GPOMap[18], RG_LVDSB_E2N_GPO_EN)|P_Fld(pu4GPOMap[17], RG_LVDSB_E1P_GPO_EN)|P_Fld(pu4GPOMap[16], RG_LVDSB_E1N_GPO_EN)
										|P_Fld(pu4GPOMap[15], RG_LVDSB_E0P_GPO_EN)|P_Fld(pu4GPOMap[14], RG_LVDSB_E0N_GPO_EN)
										|P_Fld(pu4GPOMap[13], RG_LVDSB_OCKP_GPO_EN)|P_Fld(pu4GPOMap[12], RG_LVDSB_OCKN_GPO_EN)|P_Fld(pu4GPOMap[11], RG_LVDSB_O5P_GPO_EN)|P_Fld(pu4GPOMap[10], RG_LVDSB_O5N_GPO_EN)
										|P_Fld(pu4GPOMap[9], RG_LVDSB_O4P_GPO_EN)|P_Fld(pu4GPOMap[8], RG_LVDSB_O4N_GPO_EN)|P_Fld(pu4GPOMap[7], RG_LVDSB_O3P_GPO_EN)|P_Fld(pu4GPOMap[6], RG_LVDSB_O3N_GPO_EN)
										|P_Fld(pu4GPOMap[5], RG_LVDSB_O2P_GPO_EN)|P_Fld(pu4GPOMap[4], RG_LVDSB_O2N_GPO_EN)|P_Fld(pu4GPOMap[3], RG_LVDSB_O1P_GPO_EN)|P_Fld(pu4GPOMap[2], RG_LVDSB_O1N_GPO_EN)
										|P_Fld(pu4GPOMap[1], RG_LVDSB_O0P_GPO_EN)|P_Fld(pu4GPOMap[0], RG_LVDSB_O0N_GPO_EN));
		vIO32WriteFldMulti(REG_LVDS_TX_CFG8,P_Fld(pu4GPIMap[27], RG_LVDSB_ECKP_GPI_EN)|P_Fld(pu4GPIMap[26], RG_LVDSB_ECKN_GPI_EN)|P_Fld(pu4GPIMap[25], RG_LVDSB_E5P_GPI_EN)|P_Fld(pu4GPIMap[24], RG_LVDSB_E5N_GPI_EN)
										|P_Fld(pu4GPIMap[23], RG_LVDSB_E4P_GPI_EN)|P_Fld(pu4GPIMap[22], RG_LVDSB_E4N_GPI_EN)|P_Fld(pu4GPIMap[21], RG_LVDSB_E3P_GPI_EN)|P_Fld(pu4GPIMap[20], RG_LVDSB_E3N_GPI_EN)
										|P_Fld(pu4GPIMap[19], RG_LVDSB_E2P_GPI_EN)|P_Fld(pu4GPIMap[18], RG_LVDSB_E2N_GPI_EN)|P_Fld(pu4GPIMap[17], RG_LVDSB_E1P_GPI_EN)|P_Fld(pu4GPIMap[16], RG_LVDSB_E1N_GPI_EN)
										|P_Fld(pu4GPIMap[15], RG_LVDSB_E0P_GPI_EN)|P_Fld(pu4GPIMap[14], RG_LVDSB_E0N_GPI_EN)
										|P_Fld(pu4GPIMap[13], RG_LVDSB_OCKP_GPI_EN)|P_Fld(pu4GPIMap[12], RG_LVDSB_OCKN_GPI_EN)|P_Fld(pu4GPIMap[11], RG_LVDSB_O5P_GPI_EN)|P_Fld(pu4GPIMap[10], RG_LVDSB_O5N_GPI_EN)
										|P_Fld(pu4GPIMap[9], RG_LVDSB_O4P_GPI_EN)|P_Fld(pu4GPIMap[8], RG_LVDSB_O4N_GPI_EN)|P_Fld(pu4GPIMap[7], RG_LVDSB_O3P_GPI_EN)|P_Fld(pu4GPIMap[6], RG_LVDSB_O3N_GPI_EN)
										|P_Fld(pu4GPIMap[5], RG_LVDSB_O2P_GPI_EN)|P_Fld(pu4GPIMap[4], RG_LVDSB_O2N_GPI_EN)|P_Fld(pu4GPIMap[3], RG_LVDSB_O1P_GPI_EN)|P_Fld(pu4GPIMap[2], RG_LVDSB_O1N_GPI_EN)
										|P_Fld(pu4GPIMap[1], RG_LVDSB_O0P_GPI_EN)|P_Fld(pu4GPIMap[0], RG_LVDSB_O0N_GPI_EN));
		vIO32WriteFldAlign(REG_LVDS_TX_CFG0, 0x1, RG_LVDSB_GPO_TURBO_D11);
		vIO32WriteFldMulti(REG_LVDS_TX_CFG6, P_Fld(0x0, RG_LVDSB_R_TERM_EVEN_D11)|P_Fld(0x0, RG_LVDSB_R_TERM_ODD_D11));
	}
	else  // resume to LVDS
	{
		#if defined(CC_MT5890)
		u4Val_tmp= (_u4APadPDValue>>12&0xFFF);
	#else
		u4Val_tmp= (_u4APadPDValue&0xFFF);
	#endif
		EPD=(( u4Val_tmp>>6)|(((u4Val_tmp>>6)&& 0x20)<<7))&0x5F;
    	OPD=(( u4Val_tmp&0x3F)|(((u4Val_tmp&0x3F)&& 0x20)<<7))&0x5F;
    	vIO32WriteFldMulti(REG_LVDS_TX_CFG1, P_Fld((0x5F-EPD), RG_LVDSB_DRV_EN_EVEN_D11)|P_Fld((0x5F-OPD),RG_LVDSB_DRV_EN_ODD_D11));
		vIO32WriteFldMulti(REG_LVDS_TX_CFG7,P_Fld(0x0, RG_LVDSB_GPO_EN_EVEN_D11)|P_Fld(0x0, RG_LVDSB_GPO_EN_ODD_D11));
		vIO32WriteFldMulti(REG_LVDS_TX_CFG8,P_Fld(0x0, RG_LVDSB_GPI_EN_EVEN_D11)|P_Fld(0x0, RG_LVDSB_GPI_EN_ODD_D11));
		vIO32WriteFldAlign(REG_LVDS_TX_CFG0, 0x0, RG_LVDSB_GPO_TURBO_D11);
		vIO32WriteFldMulti(REG_LVDS_TX_CFG6, P_Fld(0x3FFF, RG_LVDSB_R_TERM_EVEN_D11)|P_Fld(0x3FFF, RG_LVDSB_R_TERM_ODD_D11));
	}
}

void vDrvSetPanelIFRGBInOrder(UINT8 u1R,UINT8 u1G,UINT8 u1B)
{
	vIO32WriteFldMulti(VINTF_P0, P_Fld(u1B, VINTF_PANEL_IN_B_SWAP)|P_Fld(u1G,VINTF_PANEL_IN_G_SWAP)|P_Fld(u1R,VINTF_PANEL_IN_R_SWAP));
}

void vDrvSetLVDSToGPI(UINT8 u1LVDSPin, UINT8 u1OnOff)
 {
	 UINT16 u2LVDSBO_GPI=0;
	 UINT16 u2LVDSBE_GPI=0;
	 UINT16 u2LVDSBO_GPO=0;
	 UINT16 u2LVDSBE_GPO=0;

	 u2LVDSBO_GPI = IO32ReadFldAlign(REG_LVDS_TX_CFG8, RG_LVDSB_GPI_EN_ODD_D11);
	 u2LVDSBE_GPI = IO32ReadFldAlign(REG_LVDS_TX_CFG8, RG_LVDSB_GPI_EN_EVEN_D11);

	 u2LVDSBO_GPO = IO32ReadFldAlign(REG_LVDS_TX_CFG7, RG_LVDSB_GPO_EN_ODD_D11);
	 u2LVDSBE_GPO = IO32ReadFldAlign(REG_LVDS_TX_CFG7, RG_LVDSB_GPO_EN_EVEN_D11);

	 // only for Port B
	 if (u1OnOff)  // Set to GPI
	 {
	 	if (u1LVDSPin >= 16)  // BE
	 	{
	 		u1LVDSPin -= 16;
			if (u1LVDSPin>13)
				u1LVDSPin=13;
			u2LVDSBE_GPI |= (1 << u1LVDSPin);

			u2LVDSBE_GPO ^= (1 << u1LVDSPin);
		}
		else  // BO
		{
			if (u1LVDSPin>13)
				u1LVDSPin=13;
			u2LVDSBO_GPI |= (1 << u1LVDSPin);

			u2LVDSBO_GPO ^= (1 << u1LVDSPin);
		}
	 }
	 else
	 {
	 ...
	 //Printf("**[GPI]BO=0x%x, BE=0x%x\n", u2LVDSBO_GPI, u2LVDSBE_GPI);
	 //Printf("**[GPO]BO=0x%x, BE=0x%x\n", u2LVDSBO_GPO, u2LVDSBE_GPO);
	 vIO32WriteFldMulti(REG_LVDS_TX_CFG8,P_Fld(u2LVDSBE_GPI, RG_LVDSB_GPI_EN_EVEN_D11)|P_Fld(u2LVDSBO_GPI, RG_LVDSB_GPI_EN_ODD_D11));
	 vIO32WriteFldMulti(REG_LVDS_TX_CFG7,P_Fld(u2LVDSBE_GPO, RG_LVDSB_GPO_EN_EVEN_D11)|P_Fld(u2LVDSBO_GPO, RG_LVDSB_GPO_EN_ODD_D11));
 }

void vDrvSetLVDSToGPO(UINT8 u1LVDSPin, UINT8 u1OnOff)
{
	 UINT16 u2LVDSBO_GPI=0;
	 UINT16 u2LVDSBE_GPI=0;
	 UINT16 u2LVDSBO_GPO=0;
...
#if defined (CC_MT5399) || defined(CC_MT5880) || defined(CC_MT5890)
			if (IS_PANEL_L12R12)
