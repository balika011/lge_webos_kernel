...
VOID FBM_TriggerSmlsByResizer(UCHAR ucFbgId, UCHAR ucFbId)
{
    ...
    {
        ASSERT((_prFbg[ucFbgId].fgCreateFromInst != TRUE) || (-1 == LOG(0, "StageFright not support seamless.")));
 ...
 */
//-------------------------------------------------------------------------
VOID _FBM_2FBsChkDynamicDone(UCHAR ucFbgId)
{
...
UCHAR FBM_PreLook2ndFrameBufferFromDispQ(UCHAR ucFbgId)
{
    ...
    if (_prFbg[ucFbgId].rDisplayQ.ucCount > 1)
    {
