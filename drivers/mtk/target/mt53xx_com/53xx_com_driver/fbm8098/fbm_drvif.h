...
//#define FBM_4K2K_JPG_SUPPORT  //AS video support 4k2k now,no need to add 4k2k jpeg!
#define FBM_4K1K_VIDEO_SUPPORT
#if 0//def CC_SUPPORT_4K2K_SEAMLESS
#define FBM_SUPPORT_4K2K_SEAMLESS //4K2K FBM & Two image resizer
...
#define FBM_FMG_C_ALIGMENT                                              (2048 - 1)
#define FBM_MPV_Y_ALIGMENT                                              (512 - 1)
#define FBM_MPV_C_ALIGMENT                                              (256 - 1)
#define FBM_GFX_Y_ALIGMENT                                              (4096 - 1)
#define FBM_GFX_C_ALIGMENT                                              (2048 - 1)
...
#define FBM_FBG_4K2K_H                                                  3840   //FBM_SUPPORT_4K2K
#define FBM_FBG_4K2K_V                                                  2176    //?? 

#define FBM_NORMAL_FB_NS                                                5  // 4
...
#define FBM_FBG_H264_4K2K_REFERNCE_NS                                    (4)     // Reference Frame Number for 4k2k
...
#if defined(DIVX_PLUS_CER) || defined(CC_NETFLIX_CE3_SUPPORT) || defined(CC_ENABLE_SEAMLESS_FOR_2D)
...
#define STAGEFRIGHT_EXTRA_FB_NS   3  //TBD
#elif defined(CC_SUPPORT_TV_STAGEFRIGHT) && !defined(CC_SHRINK_FBM_FOR_512MB)
#define STAGEFRIGHT_EXTRA_FB_NS   3
#else
#define STAGEFRIGHT_EXTRA_FB_NS   0
#endif
#define FBM_FBG_TYPE_1080HD_H264_SIZE ((((FBM_FBG_TYPE_1080HD_H264_R_NS+1+STAGEFRIGHT_EXTRA_FB_NS+FBM_LOCK_FB_NS)*FBM_FBG_TYPE_1080HD_Y_SIZE*3)>>1) + (((FBM_FBG_TYPE_1080HD_H264_R_NS+1)*FBM_FBG_TYPE_1080HD_Y_SIZE) >>2))
#define FBM_FBG_TYPE_720HD_H264_SIZE  ((((FBM_FBG_TYPE_720HD_H264_R_NS+1+STAGEFRIGHT_EXTRA_FB_NS+FBM_LOCK_FB_NS)*FBM_FBG_TYPE_720HD_Y_SIZE*3)>>1) + (((FBM_FBG_TYPE_720HD_H264_R_NS+1)*FBM_FBG_TYPE_720HD_Y_SIZE) >>2))
#define FBM_FBG_TYPE_PAL_H264_SIZE    ((((FBM_FBG_TYPE_PAL_H264_R_NS+1+STAGEFRIGHT_EXTRA_FB_NS+FBM_LOCK_FB_NS)*FBM_FBG_TYPE_PAL_Y_SIZE*3)>>1) + (((FBM_FBG_TYPE_PAL_H264_R_NS+1)*FBM_FBG_TYPE_PAL_Y_SIZE) >>2))
...
#ifdef CC_FBM_TWO_FBP  // if use 2 mpeg pool, half size each(32)!
#define FBM_FBG_TYPE_4K2K_JPEG_SIZE                                     (FBM_FBG_TYPE_4K2K_Y_SIZE*2*1) // 2 frame,422 mode. each mpeg for 1 frame!//FBM_SUPPORT_4K2K      
#define FBM_FBG_TYPE_4K2K_MPEG_SIZE                                     (FBM_FBG_TYPE_1080HD_H264_SIZE*4)
#else
#define FBM_FBG_TYPE_4K2K_JPEG_SIZE                                     (FBM_FBG_TYPE_4K2K_Y_SIZE*2*2) // 4 frame,422 mode.  this is for 4k2k jpeg!!!//FBM_SUPPORT_4K2K      
#define FBM_FBG_TYPE_4K2K_MPEG_SIZE                                     (FBM_FBG_TYPE_1080HD_H264_SIZE*4)
#endif
...
#define FBM_FBG_TYPE_4K2K_H264_FB_NS          (FBM_FBG_H264_4K2K_REFERNCE_NS + STAGEFRIGHT_EXTRA_FB_NS + FBM_LOCK_FB_NS + 1)//ref + stage fright lock + lock + decode
...
#elif defined(CC_MT5396) || defined(CC_MT5368) || defined(CC_MT5389) || defined(CC_MT5398)|| defined(CC_MT5880)|| defined(CC_MT5860)
...
typedef struct
{
    ...
    BOOL    fg4K1K;//for mpo photo display as frame squential
    BOOL   fgUfoEn;
    UINT8  u1Depth;
