...
BOOL _FVR_DispatchuPInterrupt(UINT32 u4Status, UINT32 u4Status2)
{
    ...
    if (!_FVR_IsRecording(0) && !_FVR_IsRecording(1) && !_FVR_IsRecording(2) && !_FVR_IsRecording(3))
    {
        // Clear interrupt
        return TRUE;
    }
    ...
    case 65:    // I,P,B notification
...

        {
            ...
            u8Pts33 = FVR_PER_PID_S_W(u1Pidx, 12);
            u8Pts33 = ((UINT64)(FVR_PER_PID_S_W(u1Pidx, 13) & 0xFF) << 32) | u8Pts33;
