 ...
 */
//-----------------------------------------------------------------------------
BOOL DMX_EMU_FVR_TimestampOnOffTest(UINT8 u1TsIndex, BOOL fgTimeStampOn, UINT8 u1TsOutIdx)
{
    DMX_MM_DATA_T rData;
    DMX_PVR_PLAY_T rPlay;
 ...
 */
//-----------------------------------------------------------------------------
BOOL DMX_EMU_FVR_TimestampPauseTest(UINT8 u1TsIndex, UINT8 u1TsOutIdx)
{
    DMX_PVR_PLAY_T rPlay;
 ...
 */
//-----------------------------------------------------------------------------
BOOL DMX_EMU_FVR_TimestampErrTest(UINT8 u1TsIndex, UINT8 u1TsOutIdx)
{
    DMX_PVR_PLAY_T rPlay;
    UINT32 u4DataSize;
    DMX_PID_T rPid;
 ...
 */
//-----------------------------------------------------------------------------
BOOL DMX_EMU_FVR_TimestampResetTest(UINT8 u1TsIndex, UINT8 u1TsOutIdx)
{
    DMX_PVR_PLAY_T rPlay;
    UINT32 u4DataSize;
    DMX_PID_T rPid;
