...
EXTERN BOOL DMX_EMU_FVR_TimestampOnOffTest(UINT8 u1TsIndex, BOOL fgTimeStampOn, UINT8 u1TsOutIdx);

EXTERN BOOL DMX_EMU_FVR_TimestampPauseTest(UINT8 u1TsIndex, UINT8 u1TsOutIdx);

EXTERN BOOL DMX_EMU_FVR_TimestampErrTest(UINT8 u1TsIndex, UINT8 u1TsOutIdx);

EXTERN BOOL DMX_EMU_FVR_TimestampResetTest(UINT8 u1TsIndex, UINT8 u1TsOutIdx);
