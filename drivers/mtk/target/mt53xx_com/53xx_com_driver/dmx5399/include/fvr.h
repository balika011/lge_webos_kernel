...
#define FVR_PID_SIZE                        (18)    // 72bype Record PID data structure

#define FVR_PID_TABLE_BASE                  (DEMUX0_BASE + 0xE00) //0x17E00
#define FVR_GBL_PID_BASE                    (DEMUX5_BASE + 0x1F4) //0x1c1f4
#define FVR_GBL_PID_BASE1                   (DEMUX5_BASE + 0x234) //0x1c234
#define FVR_GBL_PID_BASE2                   (DEMUX5_BASE + 0x274) //0x1c274
#define FVR_GBL_PID_BASE3                   (DEMUX5_BASE + 0x2B4) //0x1c2B4

#define FVR_GBL_COMMON_REGION               (DEMUX5_BASE + 0x2F4) //0x1c2F4

#define FVR_SIT_BUFFER_OFFSET               (0x3878)
#define FVR_SIT_BUFFER_OFFSET1              (0x392C)
#define FVR_SIT_BUFFER_OFFSET2              (0x39E0)
#define FVR_SIT_BUFFER_OFFSET3              (0x3A94)

#define FVR_SIT_BUFFER_BASE                 (DEMUX2_BASE + FVR_SIT_BUFFER_OFFSET) 
#define FVR_SIT_BUFFER_BASE1                (DEMUX2_BASE + FVR_SIT_BUFFER_OFFSET1)
#define FVR_SIT_BUFFER_BASE2                (DEMUX2_BASE + FVR_SIT_BUFFER_OFFSET2)
#define FVR_SIT_BUFFER_BASE3                (DEMUX2_BASE + FVR_SIT_BUFFER_OFFSET3)


#define FVR_PER_PID_OFFSET                  (0x1E00)
#define FVR_PER_PID_BASE                    (DEMUX2_BASE + FVR_PER_PID_OFFSET) //0xf001ae00

#define FVR_KEY_BASE                        (DEMUX7_BASE + 0xC80) //0xf0054C80
