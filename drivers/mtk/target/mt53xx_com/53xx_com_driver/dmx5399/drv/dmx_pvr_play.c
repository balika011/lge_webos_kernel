...
static HANDLE_T _hDMXPVRPlaySema[DMX_MAX_TSOUT] = {NULL_HANDLE , NULL_HANDLE};

static BOOL _fgTSOut[DMX_MAX_TSOUT] = {FALSE, FALSE};
...
static BOOL _fgDmxTimeshiftOpen[DMX_MAX_TSOUT] = {FALSE, FALSE};
...
static VOID _DmxPVRPlay_SetFramerMode(UINT8 u1TsOutIdx, BOOL fgExtSync, BOOL fgEnable)
{
    ...
    if (u1TsOutIdx == 0)
    {
        ...
        DMXCMD_WRITE32(DMX_REG_FRAMER_CTRL1, u4Ctrl);   // disable framer
    ...
    else if (u1TsOutIdx == 1)
    {
        ...
        u4Ctrl = (u4Ctrl & 0xFFFFFFFE);
        DMXCMD_WRITE32(DMX_REG_PLAYBACKFRAMER2_CTRL1, u4Ctrl);   // disable framer
