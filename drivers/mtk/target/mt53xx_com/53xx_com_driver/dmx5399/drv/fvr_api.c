                          ...
                          FVR_PID_STRUCT_T *prPid)
{
    ...
    if (fgEnable)
    {
        ...
        FVR_PER_PID_S_W(u1Pidx, 16) = FVR_PER_PID_S_W(u1Pidx, 16) | 0x0000FF00;
...
//  Not use now. Use logical mapping
    ...
    if (u4Flags & FVR_PID_FLAG_DESC)
    {
        ...
        u4Tmp = FVR_PER_PID_S_W(u1Pidx, 16) & 0xFFFFFF00;
        u4Tmp |= prPid->u1DescKeyidx;
        FVR_PER_PID_S_W(u1Pidx, 16) = u4Tmp;
...
FVR_SCRAMBLE_STATE_T _FVR_GetRawScrambleState(UINT8 u1Pidx)
{
    ...
    u4ScrambleFlag = (FVR_PER_PID_S_W(u1Pidx, 16) >> 8) & 0xff;
    switch (u4ScrambleFlag)
    {
    case 0:
        eState = FVR_SCRAMBLE_STATE_CLEAR;
