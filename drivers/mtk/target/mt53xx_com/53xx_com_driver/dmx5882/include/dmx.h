...
#define DMX_DMEM_MM_IV_BASE                     (DEMUX7_BASE + 0xEDC) //54EDC
#define DMX_DMEM_MM_KEY_BASE1                   (DEMUX7_BASE + 0xF24) //54F24
#define DMX_DMEM_MM_IV_BASE1                    (DEMUX7_BASE + 0xF5C) //54F5C
...
#define CKGEN_TSOUT_CKCFG3      0x41C   //TSOUT CONFIGURATION3
