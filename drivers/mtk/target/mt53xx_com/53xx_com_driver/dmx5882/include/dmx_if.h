...
#endif //CC_MT5399 //mt5880 don't support multi2
...
#define DMX_FRAMER_COUNT                4       //in mt5882, note that frame2 is removed, so there are only 3 framers 
#define DMX_FRAMER_TOTAL_INDEX          4       //freamer index 0,1,3
#define DMX_FRAMER_INDEX_2              2       //freamer index = 2 is not available
...
#define DMX_MM_MOVE_TSIDX               (3)     ///< Use ts index 3  when do mm playback
...
typedef enum
{
    ...
    DMX_PINSET_EXT4 = 0x90,
    DMX_PINSET_EXT5 = 0xA0,
#endif
} DMX_PINSET_T;
...
typedef enum
{
    DMX_CRYPTO_KEY_AES = 0,
    DMX_CRYPTO_KEY_AES_IV,
    DMX_CRYPTO_KEY_MARLIN_AES,
    DMX_CRYPTO_KEY_SECURE_PVR_AES_0 = 0x30,     ///< secure key
