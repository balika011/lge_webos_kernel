...
static void _DmxCkgenInit(BOOL fgOn)
{
    ...
    if (fgOn)
    {
        ...
        _DmxCkgenToggle(0);
        _DmxCkgenToggle(1);
        //_DmxCkgenToggle(2);   // no framer2 in dmx5882
        _DmxCkgenToggle(3);
                        ...
                        BOOL fgExtSync, BOOL fgPosEdge)
{
    ...
    if(u1Framer >= DMX_FRAMER_TOTAL_INDEX || u1Framer == 2 )
    {
...
DMX_DBM_INPUT_SOURCE_T _DMX_GetDbm_InputSource(UINT8 u1TsIdx)
{
    ...
    {
        LOG(0, "Tsindex Error, _DMX_GetDbm_InputSource only support framer 2 and 3.\n");
	...
	//else if(u1TsIdx == 4)
	//{
	//   eSource = _eDmxDBm4Input;  //To be confirmed 
    //}	
    else 
    {
         ASSERT(0);
