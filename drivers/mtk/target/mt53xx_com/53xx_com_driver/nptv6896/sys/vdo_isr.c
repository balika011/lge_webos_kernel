...
PRIVATE void vOutVSyncISR(void)
{
	...
	vRegWriteFldAlign(MUTE_00, SV_ON, R_MUTE_VS_LATCH_OFF);
	vRegWriteFldAlign(MUTE_04, RegReadFldAlign(CRC32_01, R_MJC_MUTE_LATCH), R_MUTE_MJC_EN);
    ...
    #ifdef CC_MT5396// reserved for 120Hz Panel
    if ((IS_PANEL_PDP) || (vDrvGetLCDFreq() < 77) || (_u1VSyncCount==0))
    {
