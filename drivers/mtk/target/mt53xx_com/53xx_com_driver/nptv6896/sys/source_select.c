...
#include "drv_hdtv.h"
#include "drv_async.h"
#ifdef GET_CURRENT_SOURCE_STATUS
#include "drv_video.h"
#endif
...
#ifdef GET_CURRENT_SOURCE_STATUS
	UINT8 status = (UINT8)SRC_DET_NOSIGNAL;
#endif
	LOG(0, "======vDrvGetSrcDetectStatus\n");
...
#ifdef GET_CURRENT_SOURCE_STATUS
	switch(bDrvVideoSignalStatus(0))
	 {

		 case SV_VDO_NOSIGNAL:
		 case SV_VDO_NOSUPPORT:
			 status=SRC_DET_NOSIGNAL;
			  break;

		 case SV_VDO_STABLE:
			 status=SRC_DET_STABLE;
			 break;
	 ...
	 switch(_bSrcMainNew)
	 {
		 case SV_VS_CVBS1: 	pv_get_info->ui2_av1_status=status;		break;
		 case SV_VS_CVBS2:	pv_get_info->ui2_av2_status=status;		break;
		 case SV_VS_YPbPr1: pv_get_info->ui2_ypbpr1_status=status;	break;
		 case SV_VS_HDMI1: 	pv_get_info->ui2_hdmi1_status=status;	break;
		 case SV_VS_HDMI2: 	pv_get_info->ui2_hdmi2_status=status;	break;
		 case SV_VS_HDMI3: 	pv_get_info->ui2_hdmi3_status=status;	break;
		 case SV_VS_HDMI4:	pv_get_info->ui2_hdmi4_status=status;	break;
		 case SV_VS_VGA1:	pv_get_info->ui2_vga_status=status;	  	break;
		 default:			break;
	 }	
#endif
}
