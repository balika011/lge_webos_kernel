...
void _FBM_PutFrameBufferToEmptyQ(UCHAR ucFbgId, UCHAR ucFbId)
{
    ...
    if (_prFbg[ucFbgId].rEmptyQ.ucCount >= _prFbg[ucFbgId].ucFbNs)
    {
        ...
        {
            ASSERT_FBM(_prFbg[ucFbgId].rEmptyQ.ucCount < _prFbg[ucFbgId].ucFbNs);
        }
    }
...
UCHAR FBM_GetFrameBufferFromDispQ(UCHAR ucFbgId)
{
    ...
    {
        _FbmFbLog(0xFB, FBM_FB_ID_UNKNOWN, __func__, __LINE__);
    }
...
#ifdef FBM_FB_LOG
void FBM_FlushFbLog(UINT8 u4FbIdx, UINT8 u4FbStatus)
{
    _FbmFbLog(u4FbIdx, u4FbStatus, __func__, __LINE__);
...
UCHAR FBM_GetEmptyResizeFrameBuffer(UCHAR ucFbgId, UCHAR ucSrcFbId, UCHAR ucTaskId, UINT32 u4Delay, UCHAR* pucRetValue)
{
    ...
    *pucRetValue = 0;
    ...
    if(_prFbg[ucFbgId].aucFbStatus[ucSrcFbId] == FBM_FB_STATUS_EMPTY)
    {
