...
// -------- TDC --------
#if defined(CC_MT8223) || defined(CC_MT5365)  || defined(CC_MT5395) || defined(CC_MT5368) || defined(CC_MT5396) || defined(CC_MT5389) || defined(CC_MT5398)
...
#define FBM_AUD_BASE                        (0x2A8400+0x8F000)    // 2721 kb
#else
#define FBM_AUD_BASE                        (0x407400)    // 3219 kb
#endif
#else
#define FBM_AUD_BASE                        (0x2a3c00+0x8F000)    // 2703 kb
#endif
...
#else
#define FBM_JPEG_POOL_SIZE                      (0xa00000)	//(1920*1080*4)
#endif
#else
