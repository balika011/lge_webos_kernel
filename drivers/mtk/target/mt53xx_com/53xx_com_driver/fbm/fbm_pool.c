...
FBM_POOL_T* _FBM_PoolInit(VOID)
{
    ...
    _arFbpConf[0].ucType = FBM_FBG_TYPE_1080HD;
    _arFbpConf[1].ucType = FBM_FBG_TYPE_SBSHD;
    _ucFbpConfNs = 2;
#endif
		...
		if(SRMFBM_GetConf() == FBM_MEM_CFG_MT5880_3DTV_SHRINK)
			{
				...
				Printf("FBM_MEM_CFG_MT5880_3DTV_SHRINK must define CC_FBM_TWO_FBP_SHARED_WITH_DFB \n");
				VERIFY(0);
				#endif
    ...
    for (u4Idx = 0; u4Idx < _ucFbpListNs; u4Idx++)
    {
        if (((_arFbpList[u4Idx].u4Width >= u4Width) &&
                ...
                || ((_arFbpList[u4Idx].u4Width * _arFbpList[u4Idx].u4Height >=
                     ...
                     FBM_ALIGN_MASK(u4Height, FBM_MPV_V_ALIGMENT)) && (u4Width != B2R_MAX_WIDTH && u4Height != B2R_MAX_HEIGHT)))
        {
