...
extern INT32 GfxSwCBCRBlockTo1CBCRRaster(UINT8 *pu1SrcBase, UINT8 *pu1DstBase, UINT32 u4SrcPitch, UINT32 u4DstPitch,
...
extern INT32 GfxSwCBCRBlockTo2CBCRRaster(UINT8 *pu1SrcBase, UINT8 *pu1DstBase, UINT32 u4SrcPitch, UINT32 u4DstPitch,
                UINT32 u4SrcCM, UINT32 u4DstCM, UINT32 u4Width, UINT32 u4Height, UINT32 pu1CBCRBase, UINT32 u4CBCRPitch,
                UINT32 u4Vfull, UINT32 u4SwapMode, UINT32 u4WritePitchEn, UINT32 u4CBCROrder);

extern INT32 GFX_SwYUYVToRaster(UINT8 *pu1SrcBase, UINT8 *pu1DstBase, UINT32 u4SrcPitch,
            UINT32 u4DstPitch, UINT32 u4SrcCM, UINT32 u4DstCM, UINT32 u4Width,
            UINT32 u4Height, UINT32 u4wrAorder, UINT32 u4wrRorder, UINT32 u4wrGorder,UINT32 u4wrBorder);
extern INT32 GFX_SwGetARGBOrder(UINT32 u4Aorder, UINT32 u4Rorder, UINT32 u4Gorder, UINT32 u4Border, INT32 * ai4SrcColorComp);

extern INT32 GfxSwYBlockToYRaste(UINT8 *pu1SrcBase, UINT8 *pu1DstBase, UINT32 u4SrcPitch, UINT32 u4DstPitch,
                UINT32 u4SrcCM, UINT32 u4DstCM, UINT32 u4Width, UINT32 u4Height, UINT32 pu1CBCRBase, UINT32 u4CBCRPitch,
