...
void vCCIRSetAvStart(UINT16 wStart)
{
	...
	if((_bIsMhlDevice == 1) && (eActiveHdmiPort == HDMI_SWITCH_3) && (FP_progressive==bHDMI3DIPCheck()))
	{
...
void vHDMI3DSetConfig(void)
{
    ...
    {
		if((_bIsMhlDevice == 1) && (eActiveHdmiPort == HDMI_SWITCH_3) &&(_bDviTiming == MODE_3D_720p_60_LA))
		{
			wVprochwidth= 30;
		}
		else if((_bIsMhlDevice == 1) && (eActiveHdmiPort == HDMI_SWITCH_3) &&(_bDviTiming == MODE_3D_720p_50_LA))
		{
			wVprochwidth= 30;
		}
		else if((_bIsMhlDevice == 1) && (eActiveHdmiPort == HDMI_SWITCH_3) &&(_bDviTiming == MODE_3D_1080p_24_LA))
		{
			wVprochwidth= 45;
		}
		else
...
//MHL frame sequencal timing vstart is form vysn rising edge, not vblank
void vSetCCIRForMHLFSTiming(void)
{
	if((_bIsMhlDevice == 1) && (eActiveHdmiPort == HDMI_SWITCH_3) && (FP_progressive==bHDMI3DIPCheck()))
	{
		...
		{
			wVSyncWidth = wVSyncWidth - 5;//vblank - vfront - vsync
		}
		else if(_bDviTiming == MODE_3D_1080p_24_FP)
		{
			wVSyncWidth = wVSyncWidth - 4;//vblank - vfront - vsync
		}
