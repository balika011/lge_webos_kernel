...
#endif
#include "../../../aud/adsp/include_API/dsp_common.h"
#include "hw_pdwnc.h"
...
#endif
//for cbus hpd 
extern void vCbusInitHpd(void);
extern UINT8 bHpdInitFlg;
...
#ifdef __MODEL_slt__
static UINT8 _audTestData[384] =
{
	
};
#endif
...
void bHDMIAudioSigmaDeltaSetting(UINT32 value1, UINT8 value2, UINT8 bSDINOVR)
{
    ...
    if(value1 == 0x205bc01a)
    {
        ...
        vIO32WriteFldAlign(DDS, 0x131205bc, REG_HADDS2_PCW_SW);// fix 27MHz reference clock
#if 0
        if(IS_XTAL_27MHZ())
        {
            vIO32WriteFldAlign(DDS, 0x131205bc, REG_HADDS2_PCW_SW);
        }
	    else if(IS_XTAL_24MHZ())
	    {
	        vIO32WriteFldAlign(DDS, 0x159353f7, REG_HADDS2_PCW_SW);
	    }
#endif
    }
    else
    {
        //48KHz
        //for DDS mode HDMI setting
        vIO32WriteFldAlign(DDS, 0x14d867c3, REG_HADDS2_PCW_SW);// fix 27MHz reference clock
#if 0
        if(IS_XTAL_27MHZ())
        {
            vIO32WriteFldAlign(DDS, 0x14d867c3, REG_HADDS2_PCW_SW);
        }
	    else if(IS_XTAL_24MHZ())
	    {
            vIO32WriteFldAlign(DDS, 0x179374bc, REG_HADDS2_PCW_SW);
        }
#endif
    }

    //PCW_NCPO_CHG toggle
    vIO32WriteFldAlign(HADDS_SW_CTRL, 0, FBDIV);   //fbdiv multiply 2

    if((value1==0)&&(value2==0)&&(bSDINOVR==0))
    {
        vIO32WriteFldAlign(HADDS_SW_CTRL, 0, REG_HADDS2_PCW_SEL_SW);   // 0: HW mode PCW
    }
    else
    {
        vIO32WriteFldAlign(HADDS_SW_CTRL, 1, REG_HADDS2_PCW_SEL_SW);	// 1: SWmode PCW
    }

    vIO32WriteFldAlign(HADDS_SW_CTRL, 1, REG_HADDS2_PCW_CHG_SW);
    vIO32WriteFldAlign(HADDS_SW_CTRL, 0, REG_HADDS2_PCW_CHG_SW);
}
...
void bHDMIAudioSigmaDeltaFineTuneSetting(UINT32 value1, UINT8 value2, UINT32 target, UINT8 bSDINOVR)
{
    ...
    if (value1 == 0x205bc01a)
    {
        //44.1KHz
        //for DDS mode HDMI setting
        vRegWriteFldAlign(DDS, target, REG_HADDS2_PCW_SW);
    }
    else
    {
        //48KHz
    ...
    vRegWriteFldAlign(HADDS_SW_CTRL, 0, FBDIV);   //fbdiv multiply 2

	vRegWriteFldAlign(HADDS_SW_CTRL, 1, REG_HADDS2_PCW_SEL_SW);	// 1: SWmode PCW

    vRegWriteFldAlign(HADDS_SW_CTRL, 1, REG_HADDS2_PCW_CHG_SW);
    vRegWriteFldAlign(HADDS_SW_CTRL, 0, REG_HADDS2_PCW_CHG_SW);
...
static void vHDMIPhyBandCtrl(E_HDMI_SWITCH_NUM ePortl, UINT8 u1Val)
{
	...
	if((_bIsMhlDevice == 1) && (ePortl == HDMI_SWITCH_3))
	{
	...
	if((_bIsMhlDevice == 1) && (eActiveHdmiPort != HDMI_SWITCH_2))
	{
		vIO32WriteFldAlign(MHL_REG, 1, REG_MHL_DPCLK_SEL);
		vIO32WriteFldAlign(MHL_REG, 1, REG_MHL_PCLK_SEL);
		vIO32WriteFldAlign(MHL_REG, 1, REG_MHL_MODE_SEL);
	}
	else
	{
		vIO32WriteFldAlign(MHL_REG, 0, REG_MHL_DPCLK_SEL);
		vIO32WriteFldAlign(MHL_REG, 0, REG_MHL_PCLK_SEL);
		vIO32WriteFldAlign(MHL_REG, 0, REG_MHL_MODE_SEL);
    	// TODO, set 1 at MHL mode and set 0 at non-MHL mode
    	vIO32WriteFldAlign((MHL_HDCP_DDC + 0xc00), 0x0, MHL_HDCP_DDC_EN);
		//connect 300ohm between DIP and DINN
		vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + u4RegOffset, 0x0, RG_HDMI_0_300_OHM_OFF_SEL);
	}
	...
	if((_bIsMhlDevice == 1) && (ePortl == HDMI_SWITCH_3) && (_bIsMhlPPMode == 1) && (_bEQTuning == 0))
	{
		_bKPGain = 4;
		_bRXMode = 3;
		_bEQGain = 3;
...
static void vHdmiPhySetting(E_HDMI_SWITCH_NUM ePort)
{
    ...
    if(IS_XTAL_24MHZ())
   	{
		if((_bIsMhlDevice == 1) && (ePort == HDMI_SWITCH_3))
		{
    ...
    if(u1HdmiGetTmdsClkRate(ePort) != u1ClkRate)
    {
		...
		/*if((_bIsMhlDevice == 1) && (ePort == HDMI_SWITCH_3) && (eActiveHdmiPort != HDMI_SWITCH_3))
		{
			LOG(6,"when mhl device is in, but the active source is not hdmi3, this time will not do phy reset, because some send wrong tmds timing\n");
		}
		else*/
		{
...
#if defined(CC_MT5396) || defined(CC_MT5398) || defined(CC_MT5880)
...
void vHDMISel(E_HDMI_SWITCH_NUM eSel)
{
    ...
    switch(eSel)
    {
        ...
        case HDMI_SWITCH_1:
			_arHdmiRx[eSel]._bRxShared = 0;
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 , 0, RG_HDMI_0_PORT1_EN);
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 , 0, RG_HDMI_0_PORT2_EN);
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 , 0, RG_HDMI_0_PULL_EN);
            break;

        case HDMI_SWITCH_2:
            _arHdmiRx[eSel]._bRxShared = 0;
            _arHdmiRx[HDMI_SWITCH_3]._bRxShared = 1;
			vIO32WriteFldAlign((REG_HDMI_RX_NORMAL_0_CFG6 + 0x100), 1, RG_HDMI_0_PORT1_EN);
			if(_bIsMhlDevice == 1)
			{
				vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 1, RG_HDMI_0_PORT2_EN);
			}
			else
			{
				vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 0, RG_HDMI_0_PORT2_EN);
			}
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 1, RG_HDMI_0_PULL_EN);
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 0, RG_HDMI_0_TERM_ON_SEL);
			//sel port to HDMI mode
			vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + 0x100, 0, RG_HDMI_0_MHLEN);
			vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + 0x100, 0, RG_HDMI_0_MHLMODE);
			vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + 0x100, 1, RG_HDMI_0_FTMODE);
			//HDCP sel to port2
			vIO32WriteFldAlign(PDWNC_PDMISC, 0, FLD_HDCP_PORT_SEL);			
			vIO32WriteFldAlign(PDWNC_PDMISC, 0, FLD_HDCP_OUT_SEL);
        ...
        case HDMI_SWITCH_3:
            _arHdmiRx[eSel]._bRxShared = 0;
            _arHdmiRx[HDMI_SWITCH_2]._bRxShared = 1;
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 0, RG_HDMI_0_PORT1_EN);
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 1, RG_HDMI_0_PORT2_EN);
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 1, RG_HDMI_0_PULL_EN);
			//HDCP sel to port3
			vIO32WriteFldAlign(PDWNC_PDMISC, 0, FLD_HDCP_PORT_SEL);			
			vIO32WriteFldAlign(PDWNC_PDMISC, 1, FLD_HDCP_OUT_SEL);
            break;
    }
    ...
    switch(eSel)
    {
        ...
        case HDMI_SWITCH_1:
            ...
            vIO32WriteFldAlign(HDMI_SEL, 0, REG_REGISTER_OUT_MAVIS_SEL);
            // aout
            vIO32WriteFldAlign(HDMI_SEL, 0, REG_AUDIO_OUT_MAVIS_SEL);
            // video out
            vIO32WriteFldAlign(HDMI_SEL, 0, REG_VIDEO_OUT_MAVIS_SEL);
            // main clk sel
            vIO32WriteFldAlign(HDMI_SEL, 0, REG_MAIN_CLK_SEL);
        ...
        case HDMI_SWITCH_2:
            ...
            vIO32WriteFldAlign(HDMI_SEL, 1, REG_REGISTER_OUT_MAVIS_SEL);
            // aout
            vIO32WriteFldAlign(HDMI_SEL, 1, REG_AUDIO_OUT_MAVIS_SEL);
            // video out
            vIO32WriteFldAlign(HDMI_SEL, 1, REG_VIDEO_OUT_MAVIS_SEL);
            // main clk sel
            vIO32WriteFldAlign(HDMI_SEL, 1, REG_MAIN_CLK_SEL);
...
#endif
    //adjust hdmi current
    vIO32WriteFldAlign(PDWNC_VGACFG0,0,FLD_RG_HDMIIB_PWD);
...
#if defined(CC_MT5389) || defined(CC_MT5398) || defined(CC_MT5880) || defined(CC_MT5881)//CC_AUD_PLL_HALF
        vIO32WriteFldAlign(ACR_CTRL3_0 + u4RegBase, 1, POST_DIV2_ENA);
#else
        vIO32WriteFldAlign(ACR_CTRL3_0 + u4RegBase, 0, POST_DIV2_ENA);
#endif

#if defined(CC_MT5398) || defined(CC_MT5881)
		if(IS_XTAL_24MHZ())
		{
...
#ifdef __HDMI_SLT__
	vCbusInit();
	vHDMISel(HDMI_SWITCH_2);  // side port
#endif	
...
u1HDMI_SetEdidData(_au1Edid, sizeof(_au1Edid));
	...
	{
		//24M clk sel
		vIO32WriteFldAlign(HADDS_SW_CTRL, 1, CLK24M); //TODO_ES 0//25
	}
	else*/
	{
		//27M clk sel
		vIO32WriteFldAlign(HADDS_SW_CTRL, 0, CLK24M); //TODO_ES 0//25
	}
	
	u1term = u1IO32Read1B(0xf0008690)&0x1f; //0xf0008690[4:0]
	if(u1term == 0)
	{
...
{
    if ((u1IO32Read1B(UNRECRX0_0 + u4ActiveHdmiRegBase) == 0x81) && (1 == IO32ReadFldAlign(INTR_STATE0 + u4ActiveHdmiRegBase, INTR3_NEW_UNREC)))
    {
...
{
	if( (_bIsMhlDeviceConnect == 1) && (eActiveHdmiPort == HDMI_SWITCH_3) )
	{
		return 1;
	}
	else
...
void vHDMI_MHL_Switch(void)
{
	...
	{
		vHdmiSaveTmdsClkRate(HDMI_SWITCH_3, TMDS_CLOCK_UNKNOW);
		vHdmiPhySetting(HDMI_SWITCH_3);
...
void vHDMIMainLoop(void)
{
    ...
    else
    {
        ...
        if (_arHdmiRx[eHdmiPort]._bHDMIState == HDMI_STATE_PWOFF)
        {
			...
			if ((_bIsMhlDevice == 1) && (eHdmiPort == HDMI_SWITCH_3))
            {
	            _arHdmiRx[eHdmiPort]._u1Tx5VActive = 1;
	            ...
	            if(_arHdmiRx[eHdmiPort]._bHDMIState == HDMI_STATE_PWOFF)
	            {
	                _arHdmiRx[eHdmiPort]._bHDMIState = HDMI_STATE_PWON;
	                _arHdmiRx[eHdmiPort]._bResStableCnt = 0;
					LOG(6, "eHdmiPort %d HDMI_STATE_PWON\n",eHDMICurrSwitch);
        ...
        switch(_arHdmiRx[eHdmiPort]._bHDMIState)
        {
...
#else
                vIO32WriteFldAlign(TMDS_CTRL0 + u4HdmiRegBase, 1, C_DATA_SYNC_AUTO);
                vHDMIDDCBusCTRL(TRUE);
...
#if 0            
               if(eActiveHdmiPort == HDMI_SWITCH_3)
               {
                    if(_bIsMhlDevice == 1)
                    {
                         if(bHpdInitFlg == 0)
            ...
            case HDMI_STATE_AUTH:
	         ...
	         if (eHdmiPort == eActiveHdmiPort)
                ...
                if(eHdmiPort == eActiveHdmiPort)
                {
                	if((eHdmiPort == HDMI_SWITCH_3) && (_bIsMhlDevice == 1)&& (vMHLGETRAPContentOnoff() == 0))
                	{
...
/**
 * HDMI analog PHY EQ setting scan 
 * for one timing, looking for all CRC pass EQ setting case
 */

UINT8 fgHDMIEQSettingScan(UINT8 ntry)
{
	UINT8 _bKPGain_old,_bRXMode_old,_bEQGain_old;
	
	if(_arHdmiRx[eActiveHdmiPort]._bHDMIState == HDMI_STATE_AUTH)
	{
		LOG(0, "width: %d\n", wHDMIResoWidth());
		LOG(0, "height: %d\n", wHDMIResoHeight());
		LOG(0, "refresh rate: %d\n", bHDMIRefreshRate());
		LOG(0, "EQ setting: KPGain(0~7) RXmode(0~3) EQ_Gain(0~3) ZSel(0~3) VRef(1,2,4)\n");
	}
	else
	{
		LOG(0, "HDMI source not stable, please connect HDMI source or wait stable\n");
		return 0;
	}
	
	LOG(0, "HDMI Eq Setting CRC Check:\n");

	_bKPGain_old = _bKPGain;
	_bRXMode_old = _bRXMode;
	_bEQGain_old = _bEQGain;
	
	_bEQTuning = 1;

	for(_bKPGain = 0; _bKPGain <= 4; _bKPGain++)//KPGAIN 0-4 is advised
	{
		for(_bRXMode = 0; _bRXMode <= 3; _bRXMode++)//RXMODE
		{
			for(_bEQGain = 0; _bEQGain <= 3; _bEQGain++)//EQGAIN
			{	
				//set EQ value
				vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + u4ActiveAnalogRegBase, _bKPGain, RG_HDMI_0_KPGAIN);
				vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + u4ActiveAnalogRegBase, _bRXMode, RG_HDMI_0_RXMODE);
				vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + u4ActiveAnalogRegBase, _bEQGain, RG_HDMI_0_EQ_GAIN);
				
				vUtDelay1ms(1);
				//reset EQ data
				vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG1 + u4ActiveAnalogRegBase, 1, RG_HDMI_0_DATA_RST);
				//vUtDelay1ms(5);
				//vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG1 + u4ActiveAnalogRegBase, 0, RG_HDMI_0_DATA_RST);
				...
				if(fgHDMICRC(ntry) == 1)
				{
					...
					{
						LOG(0, "Pass Case:\n");
						LOG(0, "KP_GAIN=%x RX_MODE=%x EQ_GAIN=%x\n", _bKPGain, _bRXMode, _bEQGain);
					}
					else
					{
						LOG(2, "Pass Case:\n");
						LOG(2, "KP_GAIN=%x RX_MODE=%x EQ_GAIN=%x\n", _bKPGain, _bRXMode, _bEQGain);
					}
				}
				else
				{
					LOG(1, "Fail Case:\n");
					LOG(1, "KP_GAIN=%x RX_MODE=%x EQ_GAIN=%x\n", _bKPGain, _bRXMode, _bEQGain);
				}
			}
		}
	}
	
    vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + u4ActiveAnalogRegBase, _bKPGain_old, RG_HDMI_0_KPGAIN);
    vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + u4ActiveAnalogRegBase, _bRXMode_old, RG_HDMI_0_RXMODE);
    vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + u4ActiveAnalogRegBase, _bEQGain_old, RG_HDMI_0_EQ_GAIN);
...
//	LOG(3, "CdsenseStatus : %d\n", u1GetCdsenseStatus());
    LOG(3, "_bIsMhlDevice : %d\n", _bIsMhlDevice);
    LOG(3, "_bIsMhlPPMode : %d\n", _bIsMhlPPMode);
}
...
//        return;
	...
	*/
    ...
    BSP_PinSet(PIN_OPCTRL5, 1);
    BSP_PinSet(PIN_OPCTRL6, 1);
...
#ifdef __MODEL_slt__
UINT8 vMHLAUDTEST(void)
{	
	UINT16 i;	
	UINT8 u1testRes=0;
	UINT32 u4Data;
	
	u4Data = VIRTUAL(_u4AFIFO[0][0]);
		
	for (i=0; i<(sizeof(_audTestData)/sizeof(UINT8)); i++)
	{
		...
		LOG(3, " %02x", *((UINT8*)(u4Data + i)));
			
		if(x_memcmp((UINT8*)(u4Data + i), _audTestData,sizeof(_audTestData)/sizeof(UINT8)) == 0)
		{		
			u1testRes=1;
			break;
		}
	...
	if(u1testRes == 1)
	{
		printf("MHL audio SLT test pass!\n");
	}
	else
	{
		printf("MHL audio SLT test fail!\n");
	}
...
void vSelMHLPort(BOOL bOnOff)
{
	if(bOnOff)
	{
	    vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 1, RG_HDMI_0_PORT2_EN);  //61118bit30
	}
	else
	{
		vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 0, RG_HDMI_0_PORT2_EN);	//61118bit30
	}
}
...
void vMHLAdjustChannel(void)
{
	if(!(IS_IC_5881_ES()))
	{
		if((_bIsMhlDevice == 1) && (eActiveHdmiPort == HDMI_SWITCH_3))
		{
			if(_bIsMhlPPMode == 1)
			{
	...
	if(IS_IC_5881_ES())
	{
		if((_arHdmiRx[eActiveHdmiPort]._bHDMIState == HDMI_STATE_SCDT) || (wHDMIHTotal() < 150) || (wHDMIVTotal() < 150) || (wHDMIResoHeight() < 150))
		{
			_bResDigPhy ++;
			...
			{
				_bResDigPhy = 0;
				bHdmiPhyReset(eActiveHdmiPort, HDMI_RST_DIGITALPHY);
				LOG(6, "Mhl digital PHY has no sync output, it need to be reset\n");
			}
		}
		else
		{
...
{
	if((_bIsMhlDevice == 1) && ((eActiveHdmiPort == HDMI_SWITCH_3) ||(eActiveHdmiPort != HDMI_SWITCH_2)))
	{
		if(bOnoff)
		{
			vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + 0x100, 1,RG_HDMI_0_TERM_EN);
			//connect 300ohm between DIP and DINN
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 0x0, RG_HDMI_0_300_OHM_OFF_SEL);
		}
		else
		{
			//disconnect 300ohm between DIP and DINN
			vIO32WriteFldAlign(REG_HDMI_RX_NORMAL_0_CFG6 + 0x100, 0x1, RG_HDMI_0_300_OHM_OFF_SEL);
			vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG2 + 0x100, 0,RG_HDMI_0_TERM_EN);
		}
	}
}
...
void vMHLHdcpErrHandle(void)
{
    ...
    u1Buf = u1IO32Read1B(HDCP_STAT_2+ 0xc00) & 0x30; //00: No HDCP; 01: Authenticating; 11: AUTH Done
	 ...
	 {
		 u1err_cnt ++;
		 //LOG(0,"detect video premble error count +\n");
	 }
	 else
	 {
		 u1err_cnt = 0;
	 ...
	 if(u1err_cnt > 15)
	 {
		 ...
		 vIO32WriteFldAlign(REG_HDMI_RX_Normal_0_CFG3 + 0x100, u1_value, RG_HDMI_0_PLL_BAND);
...
void vMHLSetHdcpAn(UINT8* pu1An)
{
    ...
    {
    	// clock divider
    	vIO32WriteFldAlign((MHL_HDCP_DDC + 0xc00), 0x20, MHL_HDCP_DDC_CLK);

	    // TODO, set 1 at MHL mode and set 0 at non-MHL mode
    	vIO32WriteFldAlign((MHL_HDCP_DDC + 0xc00), 0x1, MHL_HDCP_DDC_EN);
		
        for (i=0;i<8;i++)
		{
        	 u4An =  ((0x18+i)<<8) + pu1An[i];
             vIO32Write4B(MHL_HDCP_CTRL + 0xc00,u4An);
...
void vMHLSetHdcpAksv(UINT8* pu1Aksv)
{
    ...
    if(pu1Aksv)
    {
        ...
        for (i=0;i<5;i++)
		{
             ...
             vIO32Write4B(MHL_HDCP_CTRL + 0xc00, u4Aksv);
             vUtDelay2us(25);   // T.B.D, need some time for writing into HDCP engine.
             // TODO, read back for checking.
             // note, TMDS clock must be active while writing Aksv values to hdcp engine
...
{
   if((eActiveHdmiPort == HDMI_SWITCH_3) &&(_bIsMhlDevice == 1))
   {
      return TRUE;
   }
   else
