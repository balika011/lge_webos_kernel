...
const REGTBL_T CODE _MCNR_PQ_PARAM[E_MCNR_NUM_TIMINGS][6] =
{
    {   // SD interlaced (480i/576i)
        //{MCNR_03,    0x00000C60, 0xFF807F7E},   // MCNR_MA_MOVINGTXR_REFINED_STILL_LVL = 0
        {MCNR_03,    0x00003420, 0xFF807F7E},   // MCNR_MA_MOVINGTXR_REFINED_STILL_LVL = 0
        {MCNR_05,    0x00404410, 0x007FFFFF},
        {MCNR_08,    0x04000000, 0x07800000},   // MCNR_TXTR_MC_THD = 8
        {MCNR_31,    0x8F800000, 0xFFF00000},   // MCNR_MV_REFINE_NEI_COST_NL = 5
        {MCNR_32,    0xB8800000, 0xFE800000},
        {REGTBL_END, 0x00000000, 0x00000000}
    },
    {   // SD progressive (480p/576p)
        {MCNR_03,    0x00003420, 0xFF807F7E},   // MCNR_MA_MOVINGTXR_REFINED_STILL_LVL = 0
        {MCNR_05,    0x00404420, 0x007FFFFC},       // LOW_MTN_BND = 0x40, LOW_MTN_STILL_GAIN = 8, PXL_DIF_BND = 0x10, PXL_DIF_STILL_GAIN = 4
        {MCNR_08,    0x04000000, 0x07800000},   // MCNR_TXTR_MC_THD = 8
        {MCNR_31,    0x80500000, 0xFFF00000},   //  MCNR_MV_REFINE_NEI_COST_NL = 5
        {MCNR_32,    0x38000000, 0xFE800000},
        {REGTBL_END, 0x00000000, 0x00000000}
    },
    {   // HD 720p
        {MCNR_03,    0x00003420, 0xFF807F7E},   // MCNR_MA_MOVINGTXR_REFINED_STILL_LVL = 0
        {MCNR_05,    0x00408420, 0x007FFFFC},       // LOW_MTN_BND = 0x40, LOW_MTN_STILL_GAIN = 8, PXL_DIF_BND = 0x10, PXL_DIF_STILL_GAIN = 4
        {MCNR_08,    0x04000000, 0x07800000},   // MCNR_TXTR_MC_THD = 4
        {MCNR_31,    0x00000000, 0xFFF00000},   // MCNR_MV_REFINE_NEI_COST_NL = 0
        {MCNR_32,    0x38000000, 0xFE800000},
        {REGTBL_END, 0x00000000, 0x00000000}
    },
    {   // FHD interlaced (1080i)
        {MCNR_03,    0x03000F60, 0xFF807F7E},   // MCNR_MA_MOVINGTXR_HIGH_DIFF_THD = F, MCNR_FORCE_MA_MOVINGTXR_LOW_DIFF_THD = 1, MCNR_MA_MOVINGTXR_REFINED_STILL_LVL = 1
        {MCNR_05,    0x00408420, 0x007FFFFC},       // LOW_MTN_BND = 0x40, LOW_MTN_STILL_GAIN = 8, PXL_DIF_BND = 0x10, PXL_DIF_STILL_GAIN = 4
        {MCNR_08,    0x04000000, 0x07800000},   // MCNR_TXTR_MC_THD = 4
        {MCNR_31,    0x00300000, 0xFFF00000},   // MCNR_MV_REFINE_NEI_COST_NL = 0
        {MCNR_32,    0x38800000, 0xFE800000},
        {REGTBL_END, 0x00000000, 0x00000000}
    },
    {   // FHD progressive (1080p)
        {MCNR_03,    0x00003430, 0xFF807F7E},   // MCNR_MA_MOVINGTXR_REFINED_STILL_LVL = 0
        {MCNR_05,    0x00408420, 0x007FFFFC},       // LOW_MTN_BND = 0x40, LOW_MTN_STILL_GAIN = 8, PXL_DIF_BND = 0x10, PXL_DIF_STILL_GAIN = 4
        {MCNR_08,    0x04000000, 0x07800000},   // MCNR_TXTR_MC_THD = 4
        {MCNR_31,    0x80000000, 0xFFF00000},   // MCNR_MV_REFINE_NEI_COST_NL = 0
        {MCNR_32,    0x38000000, 0xFE800000},
        {REGTBL_END, 0x00000000, 0x00000000}
    }
};
...
const REGTBL_T CODE _NXNR_PQ_COMMON[] =
{
    ...
    {NXNR_08, 0x00000000, 0x00003FFF}, //remove HBLK

    {NXNR_0A, 0x40402020, 0x00FF00FF},
    {NXNR_0B, 0xA2202D2D, 0x30F300FF},
...
EXTERN void vDrvNRDNRWAProc(void);
...
void vDrvNRSet3DNRMode(E_3DNR_MODE e3DMode)
{
    switch (e3DMode)
    {
        ...
        case MCNR_MODE_NM:
        case MCNR_MODE_MA:
            NR_WM(MCNR_00, P_Fld(1, MCNR_ENABLE) | P_Fld(((UINT8)e3DMode-1), MCNR_MODE));
            break;
        case MCNR_MODE_OFF:
            default:
...
{
#ifdef __MODEL_slt__
    Printf("[SLT] 5398A NX_BYPASS = 0, vDrvNRSet2DNRMode\n");
...
void vDrvNRSetBlkMeterParam(E_BNM_MODE eBnmMode)
{
    ...
    case E_BNM_CVBS:    // himedia CVBS, 480i
        ...
        _SWW(NR_FWBNR_01,  15, NR_FWBNR_VBLKLEVELLEAKAGE);
        _SWW(NR_FWBNR_02,  10, NR_FWBNR_VBLKINSIDEOUTSIDERATIO);
...
{
    BOOL RNRDisable = (((u2Width & 0x3) != 0) && (!IS_ECO_2_IC())) ||( NR_R(MCVP_DRAM_01, DA_FLAG_RNR_MODE) == E_MIB_RNR_DISABLE);
    BNR_FW_Initialize(u2Width, u2Height);
    NR_WM(NXNR_3F,
        P_Fld(RNRDisable ? 1 : 0, NX_RNR_FORCE_AGG_RATIO_EN)|
	...
	if(u2Height>=720)  //For HD,NX_VBlk_Line_Sum_Sat_Lvl is 2047
		NR_W(NXNR_09, 1, NX_VBLK_LINE_SUM_SAT_LV);
	else				//For SD,NX_VBlk_Line_Sum_Sat_Lvl is 1023
		NR_W(NXNR_09, 0, NX_VBLK_LINE_SUM_SAT_LV);
}
...
void vDrvNRSetQuality(UINT8 u1Interlace, UINT16 u2Width, UINT16 u2Height)
{
    ...
    UINT32 u4SupportHBlkMeter = 0;//for  Remy , not support HBlk.
    UINT32 u4Thd8 = 0x30;
    UINT32 u4SADHistWinH = 4;
    UINT32 u4SADHistWinV = 16;
    UINT32 u4BKNLMaxStr = 0;
    UINT32 u4BkNLGain = 0;
	UINT32 u4FattailAdj = 1;
	UINT8  u1MeFhdp = 0;
	...
	_SWW(NR_NM_0F, u4FattailAdj, NM_ADJ_BY_FATTAIL);
	...
	_SWW(NR_CTRL_00, !IS_PROG_DISPMODE(VDP_1), EN_BNM_ISR_MOADJ);
...
void vDrvNRSetMpegNRParam(void)
{
    ...
    // BNR
    NR_WM(NXNR_09,_P2D(NX_VBLK_MIN_LINE_SUM));
    // MNR
...
void vDrvNRSet2DNRBNROnOff(UINT8 u1OnOff)
{
    ...
    _SWW(NR_CTRL_00, u1OnOff, EN_BNR_RNR_ADAP);
...
void vDrvNRSet2DNRSNROnOff(UINT8 u1OnOff)
{
    ...
    NR_W(NXNR_00, (u1OnOff ? 1 : (_SWR(NR_CTRL_00, EN_BNR_RNR_ADAP) ? 1 : 0)), NX_SNR_Y);
}
...
{
    NR_W(MCNR_39, (u1OnOff ? 1 : 0), DNR0_EN);
	NR_W(NXNR_39, (u1OnOff ? 1 : 0), DNR1_FILTER_EN);
	if (IC_VER_5398_AA == BSP_GetIcVersion())
	{
		_SWW(NR_PQ_0A,(u1OnOff ? 1 : 0), NR_DNR_WA_EN);
	}
}
...
void vDrvNRSet2DNRAuto(UINT8 u1OnOff)
{
    ...
    //_SWW(NR_PQ_13, u1OnOff, RNR_TH_ADAP);
}
...
void vDrvNRSet3DNRAuto(UINT8 u1OnOff)
{
    ...
    _SWWM(NR_CTRL_00,
        ...
        P_Fld(u1OnOff || (NR_NM_TDF_BASE == u1DrvNRGetNoiseMeterSupport()), EN_ADAP_WEIGHT)); //different with TPV viper 
}
...
void vDrvNRSet3DNRDitherOnOff(UINT8 u1OnOff)
{   
    //use 8bit rounding ,not use dither.f00236f0  [11:10] set to 0.
	NR_W(MCNR_3E, 0, MCNR_DITHER_EN);	
}
void vDrvNRSetBitRes(UINT8 u18bit)
{
    NR_W(MCNR_01, (u18bit ? 10 : 8), MCNR_RND_PRECISION);
   // _SWW(NR_CTRL_00, (u18bit ? 1 : 0), EN_PATCH_8BIT);
    _SWW(NR_CTRL_00, 0, EN_PATCH_8BIT);
	//use dither
	vDrvNRSet3DNRDitherOnOff(u18bit);
}
...
void vDrvNRInit(void)
{
    ...
    _vDrvNRCreateThread();
#endif
    vDrvNRMCVPDitherInit();
    vDrvNR3DNRDitherInit();
    vDrvNRPQInit();
}
...
{
#ifdef CC_FLIP_MIRROR_SUPPORT
	if((u4QueryFlipModule(VDP_1) & 0x6)&&(u1GetFlipMirrorConfig()& 0x2))
	{bRegion = !bRegion;}
#endif
...
#ifdef CC_FLIP_MIRROR_SUPPORT
	if(((u4QueryFlipModule(VDP_1) & 0x6)&&(u1GetFlipMirrorConfig()& 0x2))&&
        (!((u4QueryFlipModule(VDP_1) & 0x2) && bDrvVideoIsSrcInterlace(VDP_1) == 0)))
	{bRegion = !bRegion;}
#endif
