...
// === EXTERN FUNCTION ====================================================================
// === GLOBAL VARIABLE ====================================================================
UINT8 _fgGammaStressTest = SV_FALSE;
...
UINT8 u1LcDimGainTableMSB[LCDIM_DIMMING_NUM];
UINT8 u1LcDimGainTableLSB[LCDIM_DIMMING_NUM];    
#endif
...
UINT8 bScalerStressTest(UINT8 u1TablePattern)
{
...
#ifdef CC_MT5398     
	for(i=PSC_COEFTYP_HOR_Y; i<PSC_COEFTYP_MAX; i++)
	{
		vDrvPSCPQSetSramCoeff(i, dwWriteCoeff1);
        vDrvPSCPQCoeffRead(i, dwReadCoeff);
		if(!bDrvPSCPQCoeffValidate(i, dwReadCoeff, dwWriteCoeff1))
        {      
            bRet=SV_FALSE;
        }
	...
	for(i=PSC_COEFTYP_HOR_Y; i<PSC_COEFTYP_MAX; i++)
	{
		vDrvPSCPQSetSramCoeff(i, dwWriteCoeff0);
        vDrvPSCPQCoeffRead(i, dwReadCoeff);
		if(!bDrvPSCPQCoeffValidate(i, dwReadCoeff, dwWriteCoeff0))
        {      
            bRet=SV_FALSE;
        }
	}    
...
UINT8 bDrvPeSramStressTest(UINT8 u1Module, UINT8 u1TablePattern, UINT32 u4TestRound)
{
    ...
    {    
        ...
        {        
            ...
            case 2:                    
                #ifdef CC_MT5398
                vDrvPSCPQCoeffRead(u1TablePattern, u4bCoeffTbl);
                #endif    
                break;
            case 3:
