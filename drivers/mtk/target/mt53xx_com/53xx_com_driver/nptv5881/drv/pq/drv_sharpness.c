...
{
#ifndef CUST_LCCT_DRV
    //PBC1 color range initial  --green
	{         CDS_00, 0x80800A20, 0x0000FFFF},
	{         CDS_01, 0x7D048199, 0xFFFFFFFF},
	{		  CDS_02, 0xC2CAC080, 0xFFFFF0FF},
	{		  CDS_03, 0x00C03220, 0xFFF00000},
#else
	//PBC2 color range initial  --skin
	{         CDS_00, 0x800C0A0A, 0x0000FFFF},
	{         CDS_01, 0x5406000C, 0xFFFFFFFF},
	{		  CDS_02, 0x62C85080, 0xFFFFF0FF},
	{		  CDS_03, 0x00C82020, 0xFFFFFFFF},
	//PBC3 color range initial  --blue
	//{         CDS_00, 0x800C0A0A, 0x0000FFFF},
	//{         CDS_01, 0xD947900C, 0xFFFFFFFF},
	//{		CDS_02, 0xE0187080, 0xFFFFF0FF},
	//{		CDS_03, 0x00C03220, 0xFFF00000},
#endif
	{       REGTBL_END, 0x00000000, 0x00000000},
};
...
{
	vIO32WriteFldAlign(ECTI_00, bOnOff, ECTI_ENA);
}
...
void vDrvCTIRParam(void)
{
	...
	vIO32WriteFldAlign(ECTI_00, wReadQualityTable(QUALITY_CTIR_ENA),
	                  ECTI_ENA);
...
{
    vDrvSharpCalcuACCurve(CDS1_H1, CDS1_D3);
}
...
void vDrvPostSharpParam(void)
{
	...
	//PBC
    vIO32WriteFldAlign(CDS_00, wReadQualityTable(QUALITY_PBC_PBC1_EN), PBC1_EN);                                                                                                                   
...
void vDrv2DSharpDemo(UINT8 bOnOff, Region rRegion)
{
	...
	#endif
	vIO32WriteFldAlign(TDPROC_MISC_00, (bOnOff==SV_ON ? ((rRegion.u1OnOff==SV_ON)? 0:1) : 0), TDS_DEMO_SWAP);//for sony demo function
...
void vDrvECTIDemo(UINT8 bOnOff, Region rRegion)
{
    ...
    vIO32WriteFldAlign(TDPROC_MISC_00, (bOnOff==SV_ON ? ((rRegion.u1OnOff==SV_ON)? 0:1) : 0), ECTI_DEMO_SWAP);//for sony demo function
