...
{
	SCPIP_WRITE_FLD(SCPIP_SCCTRL1_25+getMskOffset(bPath), u4Hofst, SCCTRL1_25_SC_HMSK_STR_OFST_1);
	SCPIP_WRITE_FLD(SCPIP_SCCTRL1_27+getMskOffset(bPath), u4VOfst, SCCTRL1_27_SC_VMSK_STR_OFST_1);
}

void vScpipSetMaskCrop(UINT8 bPath, UINT32 u4HCropStart, UINT32 u4HCropEnd, UINT32 u4VCropStart, UINT32 u4VCropEnd)
{
	SCPIP_WRITE_FLD(SCPIP_SCCTRL1_28+getMskOffset(bPath), u4HCropStart, SCCTRL1_28_SC_HMSK_STR_CROP_1);
	SCPIP_WRITE_FLD(SCPIP_SCCTRL1_28+getMskOffset(bPath), u4HCropEnd, SCCTRL1_28_SC_HMSK_END_CROP_1);
	SCPIP_WRITE_FLD(SCPIP_SCCTRL1_28+getMskOffset(bPath), u4VCropStart, SCCTRL1_28_SC_VMSK_STR_CROP_1);
	SCPIP_WRITE_FLD(SCPIP_SCCTRL1_28+getMskOffset(bPath), u4VCropEnd, SCCTRL1_28_SC_VMSK_END_CROP_1);	
}
...
{
	SCPIP_WRITE_FLD(SCPIP_DRAM_M_03, u4N, DRAM_M_03_DA_FRAME_DROP_N);
	SCPIP_WRITE_FLD(SCPIP_DRAM_M_03, u4M, DRAM_M_03_DA_FRAME_DROP_M);
}
...
void vScpipGfx3DTo2DEnable(UINT32 u4VdpId, UINT32 u4Enable)
{
	...
	SCPIP_WRITE_FLD(SCPIP_DRAM_M_11+u2DramOffset, value, DRAM_M_11_DA_GFX_WADDR_LO_LIMIT);
}
