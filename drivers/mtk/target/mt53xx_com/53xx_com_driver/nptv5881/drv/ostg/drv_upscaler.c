...
UINT8 vDrvSCPQSetHCoeff(UINT8 bPath)
{
    ...
    vIO32WriteFldAlign(SCPIP_SCCTRL1_0C, (!bHCoeffIdx), SCCTRL1_0C_SC_DERING_H_EN);
...
UINT8 vDrvSCPQSetVCoeff(UINT8 bPath)
{
    ...
    */
	...
	//Turn off dering when down-scaling
    vIO32WriteFldAlign(SCPIP_SCCTRL1_0C, (!bVCoeffIdx), SCCTRL1_0C_SC_DERING_V_EN);	
    return SV_TRUE;
...
void vDrvDeRingOnOff(UINT8 bPath, UINT8 bOnOff)
{
    ...
    {
        vIO32WriteFldMulti(SCPIP_SCCTRL1_0C,
                          P_Fld(bOnOff, SCCTRL1_0C_SC_DERING_V_EN)|
                          P_Fld(bOnOff, SCCTRL1_0C_SC_DERING_H_EN));
