...
void vPscSetFrameTrackOnOff(UINT32 u4OnOff)
{
    ...
    {    
    	 //when frame track is on, default step is 1 line.
...
static void _vPscModeSwitch(void)
{
	vPscSetMjcDispInterfaceHtotal(u4PscGetPanelHTotal());
}
