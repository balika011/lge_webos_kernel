...
void vGetScalerDRAMInfo(tagDramDumpInfo_T *rDramDumpInfo)
{
    ...
    bIndex = IO32ReadFldAlign(SCPIP_PIP1_RO_00, PIP1_RO_00_R_POS_1);
    
    // get MHL
    rDramDumpInfo->dwMHL = IO32ReadFldAlign(SCPIP_PIP1_01, PIP1_01_HL_1);
    // get MVL
    rDramDumpInfo->dwMVL = IO32ReadFldAlign(SCPIP_PIP1_00, PIP1_00_VL_1);
    
    PreDownScaleFactor = u4PDSGetHPSFactorReg(SV_VP_MAIN);
    DownScaleFactor = IO32ReadFldAlign(SCPIP_DS1_00, DS1_00_DSCALER_H_1);
    ...
    rDramDumpInfo->bIs10bit = IO32ReadFldAlign(SCPIP_DS1_02, DS1_02_VD10BSEL_1);
    rDramDumpInfo->bIs444 = IO32ReadFldAlign(SCPIP_DS1_02, DS1_02_SEL444_1); 

    // WINC
    rDramDumpInfo->dwWINC = IO32ReadFldAlign(SCPIP_PIP1_07, PIP1_07_WINC_1);
    rDramDumpInfo->u2W_POS = IO32ReadFldAlign(SCPIP_PIP1_RO_00, PIP1_RO_00_W_POS_1);
    rDramDumpInfo->u2R_POS = IO32ReadFldAlign(SCPIP_PIP1_RO_00, PIP1_RO_00_R_POS_1);
