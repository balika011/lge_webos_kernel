...
UINT16 wTmpOffset=0;
	...
	{
		case 0:
		       wTmpOffset = IO32ReadFldAlign(VFE_02, PGAOFFSET_1H) & 0x03;
		       wTmpOffset = (wTmpOffset<<8)|(UINT16)(IO32ReadFldAlign(VFE_02, PGAOFFSET_1L));	
		       break;
		case 1:
		       wTmpOffset = IO32ReadFldAlign(VFE_06, PGAOFFSET_2H) & 0x03;
		       wTmpOffset = (wTmpOffset<<8)|(UINT16)(IO32ReadFldAlign(VFE_06, PGAOFFSET_2L));
		       break;
		case 2:
		default:
		       wTmpOffset = IO32ReadFldAlign(VFE_0A, PGAOFFSET_3H) & 0x03;
		       wTmpOffset = (wTmpOffset<<8)|(UINT16)(IO32ReadFldAlign(VFE_0A, PGAOFFSET_3L));
		       break;
	}
	return (wTmpOffset);
}
...
UINT8 bTmpHighByte,bTmpLowByte;
	...
	{
		case 0:
			vIO32WriteFldAlign(VFE_02, bTmpLowByte, PGAOFFSET_1L);
			vIO32WriteFldAlign(VFE_02, bTmpHighByte, PGAOFFSET_1H);
			break;
		case 1:
			vIO32WriteFldAlign(VFE_06, bTmpLowByte, PGAOFFSET_2L);
			vIO32WriteFldAlign(VFE_06, bTmpHighByte, PGAOFFSET_2H);
			break;
		case 2:
		default:
			vIO32WriteFldAlign(VFE_0A, bTmpLowByte, PGAOFFSET_3L);
			vIO32WriteFldAlign(VFE_0A, bTmpHighByte, PGAOFFSET_3H);
			break;
	}
}
#else
PRIVATE UINT8 bDrvGetHDADCOffset(UINT8 bOrder)
{
	...
	{
		case 0:
			return (IO32ReadFldAlign(VFE_02, PGAOFFSET_1));	//R channel maximum value in a frame
		case 1:
			return (IO32ReadFldAlign(VFE_06, PGAOFFSET_2));	//G channel maximum value in a frame
		case 2:
		default:
			return (IO32ReadFldAlign(VFE_0A, PGAOFFSET_3));	//B channel maximum value in a frame
	}
}
...
void bDrvSetHDADCOffset(UINT8 bOrder,UINT8 value)
{
	...
	{
		case 0:
			vIO32WriteFldAlign(VFE_02, value, PGAOFFSET_1);
			break;
		case 1:
			vIO32WriteFldAlign(VFE_06, value, PGAOFFSET_2);
			break;
		case 2:
		default:
			vIO32WriteFldAlign(VFE_0A, value, PGAOFFSET_3);
			break;
	}
}
#endif
...
PRIVATE UINT8 bDrvGetHDADCGain(UINT8 bOrder)
{
	...
	{
		case 0:
			return (IO32ReadFldAlign(VFE_02, PGAGAIN_1));	//R channel maximum value in a frame
		case 1:
			return (IO32ReadFldAlign(VFE_06, PGAGAIN_2));	//G channel maximum value in a frame
		case 2:
		default:
			return (IO32ReadFldAlign(VFE_0A, PGAGAIN_3));	//B channel maximum value in a frame
	}
}
...
void bDrvSetHDADCGain(UINT8 bOrder,UINT8 value)
{
	...
	#else
		case 0:
			vIO32WriteFldAlign(VFE_02, value, PGAGAIN_1);
			break;
		case 1:
			vIO32WriteFldAlign(VFE_06, value, PGAGAIN_2);
			break;
		case 2:
		default:
			vIO32WriteFldAlign(VFE_0A, value, PGAGAIN_3);
			break;
       #endif			
	}
}
...
UINT8 bGainWeighting;
      ...
      if(bUpDown==0)
      {
             ...
             {
                       case 0:
                vIO32WriteFldAlign(HDFE_01, 0x8000 - ((UINT16)bGain*(UINT16)bGainWeighting), AD1_GAIN);  // reset the Digital gain to uint gain
                           break;
                       case 1:
                vIO32WriteFldAlign(HDFE_01, 0x8000 - ((UINT16)bGain*(UINT16)bGainWeighting), AD2_GAIN);  // reset the Digital gain to uint gain
                           break;
                       case 2:
                       default:
                vIO32WriteFldAlign(HDFE_02, 0x8000 - ((UINT16)bGain*(UINT16)bGainWeighting), AD3_GAIN);  // reset the Digital gain to uint gain
                           break;
             }
     }
     else
...
static UINT8 vReadSignBit(UINT8 bOrder)
{
    ...
    {
        case 0:
           return(vIO32WriteFldAlign(HDFE_00, SIGN_OFFSET1));
        case 1:
           return(vIO32WriteFldAlign(HDFE_00, SIGN_OFFSET2));
        case 2:
        default:
           return(vIO32WriteFldAlign(HDFE_00, SIGN_OFFSET3));
   }
}
...
static UINT8 bReadHDTVDigitalOffset(UINT8 bOrder)
{
    ...
    {
        case 0:
           return(vIO32WriteFldAlign(HDFE_02, AD1_OFFSET));
        case 1:
           return(vIO32WriteFldAlign(HDFE_02, AD2_OFFSET));
        case 2:
        default:
           return(vIO32WriteFldAlign(HDFE_00, AD3_OFFSET));
   }
}
...
static UINT16 wReadHDTVDigitalGain(UINT8 bOrder)
{
    ...
    {
        case 0:
           return(vIO32WriteFldAlign(HDFE_01, AD1_GAIN));
        case 1:
           return(vIO32WriteFldAlign(HDFE_01, AD2_GAIN));
        case 2:
        default:
           return(vIO32WriteFldAlign(HDFE_02, AD3_GAIN));
   }
}
#endif
...
UINT8 bCh;
    ...
    vIO32WriteFldAlign(VFE_00, bOnOff, ALWAYSAG); // 1:enable "PGA Negative AG Always Connect" 
    for (bCh=0; bCh<3; bCh++)
    {
       //vIO32WriteFldAlign(VFE_01+(bCh<<4), 0, CLAMP_1_PWD); //5365 mark //don't power down clamp no matter what bOnOff=1 or 0
       if(bOnOff==0)
       {
//	  vIO32WriteFldAlign(VFE_01+(bCh<<4), 1, PGA_1_PWD);		//power down PGA  // [SA7_Nick] 080525 marked
//	  vIO32WriteFldAlign(VFE_03+(bCh<<4), 1, ADC_1_PWD);	       //power down ADC  // [SA7_Nick] 080525 marked
       }
       else
       {
	  vIO32WriteFldAlign(VFE_01+(bCh<<4), 0, PGA_1_PWD);		//power on PGA
	  vIO32WriteFldAlign(VFE_03+(bCh<<4), 0, ADC_1_PWD);	       //power on ADC
       }
      vIO32WriteFldAlign(VFE_01+(bCh<<4),bOnOff,CLAMP_SOURCE_OFF_1);
      vIO32WriteFldAlign(VFE_01+(bCh<<4),bOnOff,CLAMP_SINK_OFF_1);
    }
    ...
    if(bOnOff==0)     //turn off
    {
       ...
       vIO32WriteFldAlign(VFE_04, 1, ACBUF_PWD);
       vIO32WriteFldAlign(VFE_04, 0, ACCH1IN);
       vIO32WriteFldAlign(VFE_08, 0, ACCH2IN );
       vIO32WriteFldAlign(VFE_0C, 0, ACCH3IN );
    }
    else
    {
       ...
       vIO32WriteFldAlign(VFE_04, 0, ACBUF_PWD );   //to power down "ON CHIP auto color buffer and disable 825/450mv,
    }
...
{
  vIO32WriteFldAlign(VFE_04+(4<<(bOrder)), 1, ACCH1IN); //5360 select channel buffer of ON CHIP AUTO COLOR 
}
...
PRIVATE void vDrvSelV1V2(UINT8 bLoopCnt_V1V2)
{
                if(bLoopCnt_V1V2 ==0)
             	  {
                   vIO32WriteFldAlign(VFE_04, 1, ACHIN); //Select V2=750mv  
           	  }
                else
                {
                   vIO32WriteFldAlign(VFE_04, 0, ACHIN); //Select V1=400mv 
               }
}
...
PRIVATE void vDrvOnChipAutoColorGetADCData(UINT8 bMode)
{
 ...
 UINT8  bLoopCnt,bSelV1V2;//,bGainOffsetMode;  //dwSumADCRawData2 = u4IO32Read4B(VFE_00+(4*bIndexCnt));
 if(_bOrder<3)  //for klocwork check
 {
	...
	case ON_CHIP_GAIN_MODE:
            ...
            vDrvSelectAutoColorBufferOutputChannel(_bOrder);  //select channel buffer of ON CHIP AUTO COLOR 
               //dwSumADCRawData2 = u4IO32Read4B(VFE_03);
...
UINT8 bCalibration_direction;
 ...
 if(_bOrder<3)  //for klocwork check
 {
    ...
    vDrvOnChipAutoColorModeSet(OFFSET_MODE,_bType);
        ...
        {
           case 0:
               bDigital_gain = (vIO32WriteFldAlign(HDFE_02, AD1_OFFSET));
               break;
           case 1:
               bDigital_gain = (vIO32WriteFldAlign(HDFE_02, AD2_OFFSET));
               break;
           case 2:
           default:
               bDigital_gain = (vIO32WriteFldAlign(HDFE_00, AD3_OFFSET));
               break;
        }
...
UINT16 wTmp2;
   ...
   switch (_bAutoColorState0)
   {
     ...
     case VDO_AUTO_COLOR_1P0_START:  //to set gain and offset for the corresponding signal type
       ...
       #ifdef CC_MT5365_V2
            //vIO32WriteFldAlign(VFE_02, 0, PGAGAIN_1);  // reset the Analog gain to unit gain
            //vIO32WriteFldAlign(VFE_06, 0, PGAGAIN_2);
            //vIO32WriteFldAlign(VFE_0A, 0, PGAGAIN_3);
        ...
        if(((_bOffsetGainDone & 0x03) == 0x03) || (_bAutoColorTimeOutCNT>AUTO_COLOR_MAX_TIME))
	{
     ...
     case VDO_AUTO_COLOR_5_START:
		...
		_bAutoColorTimeOutCNT ++;
	          ...
	          if(IO32ReadFldAlign(HDTV_02,HDTV_BLK_CALI_EN)==CALI_ENABLE)
                {
 ...
 switch (_OnChipAutoColorState) 
 {
    ...
    //Printf("--------- ON_CHIP_AUTO_COLOR_INITIAL_STATE, mode=%x----\n",bMode);
       ...
       else
       {
          ...
          {
            dWData = u4IO32Read4B(VFE_00+(4*bIndexCnt));
