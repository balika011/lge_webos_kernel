...
static const char* szVdoInName[]=
{
    ...
    ENUM_TO_STR(E_TD_IN_END) ,//just for build warning
    ENUM_TO_STR(E_TD_IN_END) ,
    ENUM_TO_STR(E_TD_IN_END) ,
    ENUM_TO_STR(E_TD_IN_END) ,
    ENUM_TO_STR(E_TD_IN_END) ,
...
static const char* szVdoOutName[]=
{
    ...
    ENUM_TO_STR(E_TD_OUT_END) ,//just for build warning
    ENUM_TO_STR(E_TD_OUT_END) ,
    ENUM_TO_STR(E_TD_OUT_END) ,
    ENUM_TO_STR(E_TD_OUT_END) ,
    ENUM_TO_STR(E_TD_OUT_END) ,
...
{    
    ...
    {    
        ...
        else if(E_TDTV_UI_3D_MODE_FS==eDrvTDTVGetCurCfg())
        {
            ...
            MJC_SetOutputLRSwap(ePanelLRInv);              
        }
        else
        {
            vDrvTTDSetLREyeInverse(SV_OFF);
            MJC_SetInputLRSwap(SV_OFF);            
            MJC_SetOutputLRSwap(ePanelLRInv!=eLRInv);
        }        
    }    
#endif
