...
#define EH_00 (IO_VIRT + 0x34400)
    ...
    #define EH_H_CALI_REAL_TIME_CALI_EN Fld(1,17,AC_MSKB2)//[17:17]
...
#define EH_STATUS_03 (IO_VIRT + 0x3448C)
    #define EH_REMOVE_PTGEN_LVDS Fld(1,31,AC_MSKB3)//[31:31]
...
#define EH_STATUS_0D (IO_VIRT + 0x344B4)
    ...
    #define EH_DISP_R_IN_STATUS Fld(1,29,AC_MSKB3)//[29:29]
    #define EH_DISP_R_OUT_STATUS Fld(1,28,AC_MSKB3)//[28:28]
...
#define PWM_HS_01 (IO_VIRT + 0x34204)
    ...
    #define REG_PWM_SCAN_SET_DATA_EN Fld(1,7,AC_MSKB0)//[7:7]  //REG_PWM_LATCH_OFF
    #define REG_PWM_SCAN_LATCH_SEL Fld(1,6,AC_MSKB0)//[6:6]  //REG_PWM_SET
    #define REG_PWM_SCAN_LATCH_OFF2 Fld(1,5,AC_MSKB0)//[5:5]  //REG_PWM_EN
    #define REG_PWM_SCAN_SET_DATA_EN2 Fld(1,4,AC_MSKB0)//[4:4]  //REG_PWM_POL
