...
#else  //MT5881 ES    
#define OS_DITHER_03 (IO_POSTPROC_BASE + 0xA04)
    #define REG_FPHASE_BIT_POST Fld(3,15,AC_MSKW21)//[17:15]
    #define REG_FPHASE_SEL_POST Fld(2,10,AC_MSKB1)//[11:10]
    #define REG_FPHASE_POST Fld(6,4,AC_MSKW10)//[9:4]
    #define REG_FPHASE_R_POST Fld(1,3,AC_MSKB0)//[3:3]
    #define REG_FPHASE_EN_POST Fld(1,2,AC_MSKB0)//[2:2]
    #define REG_LFSR_EN_POST Fld(1,1,AC_MSKB0)//[1:1]
    #define REG_RDITHER_EN_POST Fld(1,0,AC_MSKB0)//[0:0]
#define OS_DITHER_05 (IO_POSTPROC_BASE + 0xA04)
    #define REG_INK_POST Fld(1,13,AC_MSKB1)//[13:13]
    #define REG_DRMOD_B_POST Fld(2,12,AC_MSKB1)//[12:12]
    #define REG_DRMOD_G_POST Fld(2,12,AC_MSKB1)//[12:12]
    #define REG_DRMOD_R_POST Fld(2,12,AC_MSKB1)//[12:12]
#endif
