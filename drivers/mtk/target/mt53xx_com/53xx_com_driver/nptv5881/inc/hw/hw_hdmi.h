...
#define REG_HDMI_RX_NORMAL_0_CFG6 (IO_VIRT + (IO_HDMI_RX_BASE + 0x018))//(0x0018)
  #define RG_HDMI_0_REV Fld(32,0,AC_FULLDW)//[31:0]
	#define RG_HDMI_0_PORT1_EN Fld(1,31,AC_MSKB3)//[31:31]
	#define RG_HDMI_0_PORT2_EN Fld(1,30,AC_MSKB3)//[30:30]
	#define RG_HDMI_0_PULL_EN Fld(1,29,AC_MSKB3)//[29:29]
...
#define HDMI_SEL (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc0))
  ...
  #define HDMI_SEL_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc2))
  #define HDMI_SEL_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc3))
    #define REG_INT_OUT_MAVIS_SEL Fld(1,20,AC_MSKB2)//[20:20]
    #define REG_ACR_OUT_MAVIS_SEL Fld(1,19,AC_MSKB2)//[19:19]
    #define REG_REGISTER_OUT_MAVIS_SEL Fld(1,18,AC_MSKB2)//[18:18]
    #define REG_AUDIO_OUT_MAVIS_SEL Fld(1,17,AC_MSKB2)//[17:17]
    #define REG_VIDEO_OUT_MAVIS_SEL Fld(1,16,AC_MSKB2)//[16:16]
    #define REG_MAIN_CLK_SEL Fld(1,9,AC_MSKB1)//[9:9]
    #define MAVIS_U3_RESET Fld(1,7,AC_MSKB0)//[7:7]
    #define MAVIS_U2_RESET Fld(1,6,AC_MSKB0)//[6:6]
    #define MAVIS_U1_RESET Fld(1,5,AC_MSKB0)//[5:5]
    #define RACHEL_RESET Fld(1,4,AC_MSKB0)//[4:4]
    #define MAVIS_U3_REG_RESET Fld(1,3,AC_MSKB0)//[3:3]
    #define MAVIS_U2_REG_RESET Fld(1,2,AC_MSKB0)//[2:2]
    #define MAVIS_U1_REG_RESET Fld(1,1,AC_MSKB0)//[1:1]
    #define RACHEL_REG_RESET Fld(1,0,AC_MSKB0)//[0:0]
#define MHL_REG (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc4))
  #define MHL_REG_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc4))
  #define MHL_REG_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc5))
  #define MHL_REG_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc6))
  #define MHL_REG_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc7))
...
#define MHL_REG_CALIB (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc8))
  #define MHL_REG_CALIB_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc8))
  #define MHL_REG_CALIB_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfc9))
  #define MHL_REG_CALIB_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfca))
  #define MHL_REG_CALIB_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfcb))
    #define AD_HDMI_2_IMPCOMP Fld(1,6,AC_MSKB0)//[6:6]
    #define AD_HDMI_1_IMPCOMP Fld(1,5,AC_MSKB0)//[5:5]
    #define DA_HDMI_1_IMPSEL Fld(5,0,AC_MSKB0)//[4:0]
#define HADDS_SW_CTRL (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfd4))
  #define HADDS_SW_CTRL_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfd4))
  #define HADDS_SW_CTRL_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfd5))
  #define HADDS_SW_CTRL_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfd6))
  #define HADDS_SW_CTRL_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfd7))
	#define REG_PCW_CTL Fld(16,16,AC_FULLW32)//[31:16]
	#define FBDIV Fld(1, 24, AC_MSKB3) //24
	#define CLK24M Fld(1, 23, AC_MSKB2) //23
    #define REG_PCW_LEVEL_SHIFT Fld(1,11,AC_MSKB1)//[11:11]
    #define REG_HADDS2_PCW_TYPE Fld(1,10,AC_MSKB1)//[10:10]
    #define REG_HADDS2_PCW_CHG_SW Fld(1,9,AC_MSKB1)//[9:9]
    #define REG_HADDS2_PCW_SEL_SW Fld(1,8,AC_MSKB1)//[8:8]
#define DDS (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfd8))
    #define REG_HADDS2_PCW_SW Fld(31,0,AC_FULLDW)//[30:0]
#define HADDS_STATUS0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfdc))
    #define HADDS_STATUS_0 Fld(32,0,AC_FULLDW)//[31:0]
#define HADDS_STATUS1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfe0))
    #define HADDS_STATUS_1 Fld(32,0,AC_FULLDW)//[31:0]
#define HADDS_STATUS2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0xfe4))
...
#define TMDS_CTRL_STATUS1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x260))
    ...
    #define HDMI_CH0_24M Fld(3,12,AC_MSKB1)//[14:12]
...
#define MHL_HDCP_CTRL (IO_VIRT_HDMI + (IO_HDMI_BASE+0x2A0))
	#define MHL_HDCP_CTRL_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A0))
	#define MHL_HDCP_CTRL_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A1))
	#define MHL_HDCP_CTRL_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A2))
	#define MHL_HDCP_CTRL_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A3))
    #define MHL_HDCP_ADR Fld(8,8,AC_FULLB1)//[15:8]
    #define MHL_HDCP_DATA Fld(8,0,AC_FULLB0)//[7:0]   

#define MHL_HDCP_DDC (IO_VIRT_HDMI + (IO_HDMI_BASE+0x2A4))
	#define MHL_HDCP_DDC_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A4))
	#define MHL_HDCP_DDC_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A5))
	#define MHL_HDCP_DDC_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A6))
	#define MHL_HDCP_DDC_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2A7))
    #define MHL_HDCP_DDC_CLK Fld(8,8,AC_FULLB1)//[15:8]
    #define MHL_HDCP_DDC_EN Fld(1,0,AC_MSKB0)//[0:0]
