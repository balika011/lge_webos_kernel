...
#define TDNVAI_03 (IO_PRE_PROC_BASE + 0x40C)
    ...
    #define REST_Y Fld(12,12,AC_MSKW21)//[23:12]
    #define REST_X Fld(12,0,AC_MSKW10)//[11:0]
...
#define TDNVAI_07 (IO_PRE_PROC_BASE + 0x41C)
    #define CI_HOR_THR Fld(4,26,AC_MSKB3)//[29:26]
    #define CI_DIFF_GAP_THR Fld(4,22,AC_MSKW32)//[25:22]
...
#define TDNVAI_08 (IO_PRE_PROC_BASE + 0x420)
    #define LI_CNT_THR Fld(4,26,AC_MSKB3)//[29:26]
    #define CI_CNT_THR Fld(4,22,AC_MSKW32)//[25:22]
    #define CB_CNT_THR Fld(4,18,AC_MSKB2)//[21:18]
    #define QC_CNT_THR Fld(4,14,AC_MSKW21)//[17:14]
    #define LI_STA_MODE Fld(4,10,AC_MSKB1)//[13:10]
    #define CI_STA_MODE Fld(4,6,AC_MSKW10)//[9:6]
    #define CB_STA_MODE Fld(4,2,AC_MSKB0)//[5:2]
    #define QC_STA_MODE Fld(2,0,AC_MSKB0)//[1:0]
#define TDNVAI_09 (IO_PRE_PROC_BASE + 0x424)
    #define LI_FCR_HI Fld(5,25,AC_MSKB3)//[29:25]
    #define LI_FCR_LO Fld(5,20,AC_MSKW32)//[24:20]
    #define CI_FCR_HI Fld(5,15,AC_MSKW21)//[19:15]
    #define CI_FCR_LO Fld(5,10,AC_MSKB1)//[14:10]
    #define CB_FCR_HI Fld(5,5,AC_MSKW10)//[9:5]
    #define CB_FCR_LO Fld(5,0,AC_MSKB0)//[4:0]
#define TDNVAI_0A (IO_PRE_PROC_BASE + 0x428)
    #define QC_FCR_HI Fld(5,8,AC_MSKB1)//[12:8]
    #define QC_FCR_LO Fld(5,3,AC_MSKB0)//[7:3]
    #define TD_NAVI_INK Fld(3,8,AC_MSKB1)//[10:8]
#define TDNVAI_0B (IO_PRE_PROC_BASE + 0x428)
    #define FW_DBG_INK_CR Fld(8,0,AC_FULLB0)//[7:0]
#define TDNVAI_STA0 (IO_PRE_PROC_BASE + 0x440)
...
#define TDNVAI_STA1 (IO_PRE_PROC_BASE + 0x444)
...
#define TDNVAI_STA2 (IO_PRE_PROC_BASE + 0x448)
...
#define TDNVAI_STA3 (IO_PRE_PROC_BASE + 0x44C)
    #define STA_LI_CNT_MAX Fld(8,24,AC_FULLB3)//[31:24]
    #define STA_CI_CNT_MAX Fld(8,16,AC_FULLB2)//[23:16]
    #define STA_CB_CNT_MAX Fld(8,8,AC_FULLB1)//[15:8]
    #define STA_QC_CNT Fld(8,0,AC_FULLB0)//[7:0]
#define TDNVAI_STA4 (IO_PRE_PROC_BASE + 0x450)
    #define STA_FMT Fld(3,24,AC_MSKB3)//[26:24]
    #define STA_LI_CNT_MEAN Fld(8,16,AC_FULLB2)//[23:16]
    #define STA_CI_CNT_MEAN Fld(8,8,AC_FULLB1)//[15:8]
    #define STA_CB_CNT_MEAN Fld(8,0,AC_FULLB0)//[7:0]
#define TDNVAI_STA5 (IO_PRE_PROC_BASE + 0x454)
    #define STA_CI_FCR_MEAN Fld(5,25,AC_MSKB3)//[29:25]
    #define STA_CB_FCR_MEAN Fld(5,20,AC_MSKW32)//[24:20]
    #define STA_LI_FCR_MAX Fld(5,15,AC_MSKW21)//[19:15]
    #define STA_CI_FCR_MAX Fld(5,10,AC_MSKB1)//[14:10]
    #define STA_CB_FCR_MAX Fld(5,5,AC_MSKW10)//[9:5]
    #define STA_QC_FCR Fld(5,0,AC_MSKB0)//[4:0]
#define TDNVAI_STA6 (IO_PRE_PROC_BASE + 0x458)
    #define STA_LI_IDX Fld(4,17,AC_MSKB2)//[20:17]
    #define STA_CI_IDX Fld(4,13,AC_MSKW21)//[16:13]
    #define STA_CB_IDX Fld(4,9,AC_MSKB1)//[12:9]
    #define STA_QC_IDX Fld(4,5,AC_MSKW10)//[8:5]
    #define STA_LI_FCR_MEAN Fld(5,0,AC_MSKB0)//[4:0]
...
#define TDNVAI_FPGA_01 (IO_PRE_PROC_BASE + 0x42C)
    #define TDNVAI_FPGA_01_READ_EN Fld(1,0,AC_MSKB0)//[0:0]
    #define TDNVAI_FPGA_01_READ_POS Fld(9,1,AC_MSKW10)//[9:1]
    #define TDNVAI_FPGA_01_RESERVED Fld(22,10,AC_MSKDW)//[31:10]
    
#define TDNVAI_FPGA_02 (IO_PRE_PROC_BASE + 0x444)  
    #define TDNVAI_FPGA_02_BLK_Y Fld(8,8,AC_FULLB0)//[7:0]
    #define TDNVAI_FPGA_02_BLK_PIXEL_DIFF Fld(8,0,AC_FULLB1)//[15:8]
