...
#define VSRC_09 (IO_TVD_BASE + 0x243C) //MT5881 Add Register
  ...
  #define VSRC_09_3 (IO_TVD_BASE + 0x243F)
  	...
  	#define TEST_CHIP_SEL Fld(8, 13, AC_MSKB21) //20:13	
...
#define TG_DERING (IO_TVD_BASE + 0x28B4)
  #define TG_DERING_0 (IO_TVD_BASE + 0x28B4)
  #define TG_DERING_1 (IO_TVD_BASE + 0x28B5)
  #define TG_DERING_2 (IO_TVD_BASE + 0x28B6)
  #define TG_DERING_3 (IO_TVD_BASE + 0x28B7)
