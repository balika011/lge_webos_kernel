...
//Page HISTORY
#define IO_IFPGA_BASE (IO_VIRT + 0x60000)

//Page TABLE
#define REG_IFPGA_CFG0 (IO_IFPGA_BASE + 0x600)
...
#define REG_IFPGA_CFG1 (IO_IFPGA_BASE + 0x604)
...
#define REG_IFPGA_CFG2 (IO_IFPGA_BASE + 0x608)
