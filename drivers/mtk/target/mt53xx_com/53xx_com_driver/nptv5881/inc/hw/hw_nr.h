...
#define NXNR_00 (IO_PREPROC_BASE + 0x700)
    ...
    #define NX_VBLK_WINDOW_MODE Fld(2,24,AC_MSKB3)//[25:24]
    ...
    #define NX_RESERVED_00_20_19 Fld(2,19,AC_MSKB2)//[20:19]
...
#define NXNR_05 (IO_PREPROC_BASE + 0x714)
    ...
    #define NX_VBLK_REMOVAL_MODE Fld(1,10,AC_MSKB1)//[10:10]
...
#define NXNR_09 (IO_PREPROC_BASE + 0x724)
    ...
    #define NX_VBLK_LINE_SUM_SAT_LV Fld(1,8,AC_MSKB1) //[8:8]
...
#define NXNR_13 (IO_PREPROC_BASE + 0x74C)
    ...
    #define NX_STA_VBLK_PIX_CNT Fld(16,0,AC_MSKDW)//[15:0]
#define NXNR_14 (IO_PREPROC_BASE + 0x750)
    ...
    #define NX_SRAM_AUTO_MOV_TRG Fld(1,29,AC_MSKB3)//[29:29]
...
#define NXNR_3E (IO_PREPROC_BASE + 0x7F8)
    #define NX_FORCE_RNR_TH_EN Fld(1,31,AC_MSKB3)//[31:31]
