...
#define SUPPORT_HD_TIMING_VBI   0
#define SUPPORT_TYPE_B_VBI      0
...
#define HDTV_1080I_WSS_SEL1  (12) // 5393 (O) 
...
#define HDTV_1080I_TYPE_B_WSS_SEL1  (11) // 5393 (O) 
#else
...
#if SUPPORT_TYPE_B_VBI
#define IsTypeBWSSRdy()  (IO32ReadFldAlign(VBI_TYPE_B_STA_00, VBI_B_HD_WSS_EN))
#define IsTypeBWSS2Rdy()  (IO32ReadFldAlign(VBI2_TYPE_B_STA_00, VBI2_B_HD_WSS_EN))
#define IsTypeBWSSEnable()  (IO32ReadFldAlign(VBI_TYPE_B_00, STA_VBI__B_WSS_RDY))
#define IsTypeBWSS2Enable()  (IO32ReadFldAlign(VBI2_TYPE_B_00, STA_VBI2__B_WSS_RDY))
