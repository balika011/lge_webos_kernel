...
#define _NXNR_SELECT_WINDOW_STATE_START       0
#define _NXNR_SELECT_WINDOW_STATE_WAIT_NW     1
#define _NXNR_SELECT_WINDOW_STATE_TEST_NW     2
#define _NXNR_SELECT_WINDOW_STATE_WAIT_N      3
#define _NXNR_SELECT_WINDOW_STATE_TEST_N      4
#define _NXNR_SELECT_WINDOW_STATE_WAIT_W      5
#define _NXNR_SELECT_WINDOW_STATE_TEST_W      6
#define _NXNR_SELECT_WINDOW_STATE_WAIT_READY  7
#define _NXNR_SELECT_WINDOW_STATE_READY       8
#define _NXNR_SELECT_WINDOW_STATE_FORCE_NW    9
#define _NXNR_SELECT_WINDOW_STATE_FORCE_N    10
#define _NXNR_SELECT_WINDOW_STATE_FORCE_W    11

#define _NXNR_WINDOW_MODE_NONE -1
#define _NXNR_WINDOW_MODE_NW    0
#define _NXNR_WINDOW_MODE_N     1
#define _NXNR_WINDOW_MODE_W     2
...
EXTERN void BNR_FW_SetWindowMode(UINT8 u1Mode);
#endif
