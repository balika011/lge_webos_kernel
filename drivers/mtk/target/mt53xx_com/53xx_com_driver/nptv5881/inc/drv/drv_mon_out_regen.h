 ...
 * $Revision: #1 $
*************************************************************************/
#ifndef _DRV_Mon_Out_REGEN_H_
#define _DRV_Mon_Out_REGEN_H_
#include "drv_scaler.h"


typedef struct
{
    UINT8 bMONOUTREGENModeChanged;
...
#define MON_OUT_REGEN_WRITE_FLD(reg,value,fld) vIO32WriteFldAlign(reg, value, fld)
#define MON_OUT_REGEN_READ_FLD(reg,fld) IO32ReadFldAlign(reg,fld)
#define getMonOutRegenInfo() (&_monOutRegenInfo)
