...
//CUST_QTY_TBL    
extern UINT8 bCustomQtyTbl[FLASHPQ_NUM][MAX_TIMING_NUM][CUSTOM_QTY_TBL_DIM];
#define READ_CUSTOM_QTY_TBL(timing,item) (bCustomQtyTbl[((item>>QTY_TBL_REF_INDEX_SHIFT)<FLASHPQ_NUM)?(item>>QTY_TBL_REF_INDEX_SHIFT):0][MIN(timing, MAX_TIMING_NUM-1)][item &0x3FFF])
#define WRITE_CUSTOM_QTY_TBL(timing,item,value) {bCustomQtyTbl[item>>QTY_TBL_REF_INDEX_SHIFT][MIN(timing, MAX_TIMING_NUM-1)][item &0x3FFF]=(value);}
