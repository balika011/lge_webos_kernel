...
#define IS_REMY()      (BSP_GetIcVersion() >= IC_VER_5881_AA && BSP_GetIcVersion() <= IC_VER_5881_AC)
#define IS_REMY_E()    (BSP_GetIcVersion() == IC_VER_5881_AA)
#define IS_REMY_M()    (BSP_GetIcVersion() > IC_VER_5881_AA && BSP_GetIcVersion() <= IC_VER_5881_AC)
...
/** Brief of VDP_MONOUT_PRM_T
 */
typedef struct
{
    UINT32 u4TveEnable;                        //enabled 
    UINT32 u4TveFmt;   
...
EXTERN VDP_MONOUT_PRM_T _arMonOutPrm;
...
void vScpipSetOutputInfo(UINT32 u4VdpId, UINT32 u4OutputX, UINT32 u4OutputY,UINT32 u4OutputWidth, UINT32 u4OutputHeight);
