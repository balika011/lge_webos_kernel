...
#if defined(CUST_LCCT_DRV) || defined(CC_SIPADAN_LINUX) || defined(CC_TAHITI_LINUX)
...
#define EEP_FIGARO_DYN_GAMMA_DATA_LEN      (771)
#define EEP_FIGARO_DYN_GAMMA_TOTAL_LEN     (EEP_DYN_GAMMA_MAGIC_LEN + EEP_FIGARO_DYN_GAMMA_DATA_LEN)
#endif
