...
enum
{
    ...
    QUALITY_ALCOM_YGAMMA_DARK_SCENE_BRIT,
    ...
    QUALITY_ALCOM_CBOOST_ONOFF,
    QUALITY_ALCOM_MINUS_BOOST_EN,
    QUALITY_ALCOM_BOOST_GAIN,
...
// Define the maximum number of items in custom quality table.
 ...
 #ifdef SUPPORT_REDUCE_PQ_QTYNUM
   #define CUSTOM_QTY_TBL_DIM 326
 #else
