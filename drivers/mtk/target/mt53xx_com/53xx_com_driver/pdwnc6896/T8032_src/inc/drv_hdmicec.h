...
#define PDWNC_PIN_HDMI_CEC 0x00bc
#define HDMI_CEC_FUN Fld(4, 14, AC_MSKW21) //17:14
#define CEC_PIN_FUNCTION 0x2
#elif defined(CC_MT5880)
#define PDWNC_PIN_HDMI_CEC 0x00b8
#define HDMI_CEC_FUN Fld(2, 0, AC_MSKW21) //1:0
#define CEC_PIN_FUNCTION 0x1
#endif
