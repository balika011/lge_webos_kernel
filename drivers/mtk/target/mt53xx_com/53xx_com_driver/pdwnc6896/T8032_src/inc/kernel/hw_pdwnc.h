...
#define PDWNC_GPIOOUT0 (IO_VIRT+IO_PDWNC_BASE+0x074)
	...
	#elif defined(CC_MT5368)||defined(CC_MT5396)||defined(CC_MT5398)
...
#define PDWNC_PDIO (IO_VIRT+IO_PDWNC_BASE+0x09C)
	...
	#else	//defined(CC_MT5396)||defined(CC_MT5398)||defined(CC_MT5880)
...
#define PDWNC_PADTDSEL (IO_VIRT+IO_PDWNC_BASE+0x0A4)
	...
	#else	//defined(CC_MT5368)||defined(CC_MT5396)||defined(CC_MT5398)||defined(CC_MT5880)
...
#define PDWNC_EXINT2ED (IO_VIRT+IO_PDWNC_BASE+0x0A8)
	...
	#else	//defined(CC_MT5368)||defined(CC_MT5396)||defined(CC_MT5398)
...
#define PDWNC_PINMUX1 (IO_VIRT+IO_PDWNC_BASE+0x0B8)
	...
	#else	//defined(CC_MT5368)||defined(CC_MT5396)||defined(CC_MT5880)
...
#define PDWNC_PD_PWM1C1 (IO_VIRT+IO_PDWNC_BASE+0x15C)
	...
	#else   //defined(CC_MT5368) ||defined(CC_MT5389) ||defined(CC_MT5396) 
...
#define PDWNC_VGACFG6 (IO_VIRT+IO_PDWNC_BASE+0x928)
	...
	#else //defined(CC_MT5398)||defined(CC_MT5880)
#define PDWNC_CONCFG0 (IO_VIRT+IO_PDWNC_BASE+0x900)
    #define FLD_RG_XTAL_GM Fld(4,28,AC_MSKB3)//[31:28]
    #define FLD_RG_XTAL_BIASR Fld(1,27,AC_MSKB3)//[27:27]
    #define FLD_RG_XTAL_TMEN Fld(1,26,AC_MSKB3)//[26:26]
...
#define PDWNC_CONCFG1 (IO_VIRT+IO_PDWNC_BASE+0x904)
    #define FLD_RG_PDREV_2 Fld(1,31,AC_MSKB3)//[31:31]
	#endif
...
#define PDWNC_VGACFG5 (IO_VIRT+IO_PDWNC_BASE+0x928)
    ...
    #define FLD_RG_VREFMON11_8 Fld(4,8,AC_FULLB1)//[11:8]
    #define FLD_RG_VGA_TESTBUF_PWD Fld(1,0,AC_MSKB0)//[0:0]
#define PDWNC_VGACFG6 (IO_VIRT+IO_PDWNC_BASE+0x92C)
    #define FLD_RG_DIG_TST_EN Fld(1,17,AC_MSKB2)//[17:17]
    #define FLD_RG_MASK_SEL Fld(1,16,AC_MSKB2)//[16:16]
    #define FLD_RG_AUTOBIAS_EN Fld(1,5,AC_MSKB0)//[5:5]
    #define FLD_RG_SC2_SCART_EN Fld(1,4,AC_MSKB0)//[4:4]
