...
#define MOIRI_DIS_INT() vIO32Write1B(PDWNC_T8032_INTEN, u1IO32Read1B(PDWNC_T8032_INTEN) & 0x7f)
#define MOIRI_EN_INT() vIO32Write1B(PDWNC_T8032_INTEN, u1IO32Read1B(PDWNC_T8032_INTEN) | 0x80)
#define MOIRI_GPIO_BOTH_EDGE_SETUP() vIO32Write1B(PDWNC_EXINT2ED, u1IO32Read1B(PDWNC_EXINT2ED) | 0x80);\
						vIO32Write1B(PDWNC_EXINTLEV, u1IO32Read1B(PDWNC_EXINTLEV) & 0x7f);\
						vIO32Write1B(PDWNC_EXINTPOL, u1IO32Read1B(PDWNC_EXINTPOL) & 0x7f);
#else//5395/5365
...
#if 1//5365/5395/5368/5396/5389/5398/5880
...
#if defined(CC_MT5389)||defined(CC_MT5396)||defined(CC_MT5398)||defined(CC_MT5368)||defined(CC_MT5880)	//MT5389_TODO
    #define SetSERVOEN(x)
...
#define MUpdateSrvad(x) vRegWriteFldAlign(PDWNC_ADOUT0 + ((x) << 2), 0, FLD_ADOUT0);//only support ad ch 0~9
...
#if SUSPEND_TO_DRAM
extern void vEnterSuspend(void);
extern void vWakeUpSystemFromSuspend(void);
#endif
