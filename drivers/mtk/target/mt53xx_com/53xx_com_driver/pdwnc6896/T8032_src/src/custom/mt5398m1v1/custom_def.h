...
#define HOTKEY_WAKEUP_SUPPORT 1 
...
#if SUSPEND_TO_DRAM
#define IR_TASK 1 // 1  // if suspend, this define must be 1
#define IR_TASK_STANDBY 0   //  define according to customer. when suspend is ensable, this define control IR in standby mode 
#else
#define IR_TASK 0 // 1  // define according to customer. when suspend is disable, this define control IR in standby mode 
...
#define SWITCH_UART_PORT_5396 1
#define SWITCH_UART_PORT_5389 0
