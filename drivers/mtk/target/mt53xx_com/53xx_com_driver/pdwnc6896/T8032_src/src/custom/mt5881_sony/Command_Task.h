...
#define Cmd_SetT8032DebugLevel 0x19

#define Cmd_GetIrWakeupValue  	0x18
...
//PDWNC_CMD_ARMT8032_GET_LOCATEL_DATA
#if 0//S_HOTEL_MODE_COMMAND
#define Cmd_GetLocatelData      0x5b
#define Cmd_GetLocatelData1      0x5c
#define Cmd_GetLocatelData2      0x5d
#endif
...
#define Cmd_SetACDetectPins     (Cmd_Turnkey_Max + 6) 
	...
	#define T8032_IR_WAK_KEY        (T8032_IR_WAK_POWER | \
	                                 T8032_IR_WAK_CH_UP_DOWN | \
	                                 T8032_IR_WAK_NUMERIC | \
	                                 T8032_IR_WAK_ATV | \
	                                 T8032_IR_WAK_ADTV_SW)
