...
#if HOTKEY_WAKEUP_SUPPORT || HOTKEY_SW_WAKEUP_SUPPORT
...
//        SetCtrlLedEnable();        
    ...
    else if(tmpCmd.u1Cmd == Cmd_EnterSuspend)
    {
        ...
        LogS("EnterSuspend");
#endif	
#if 1//SUSPEND_GPIO_CONTROL_ENABLE		
...
#endif
	#if 0//wangle trans
    else if(tmpCmd.u1Cmd == Cmd_SetT8032DebugLevel)
    {
		vSetT8032DebugMsgLevel(tmpCmd.u1SubCmd);
        vCMD_RESONSE(Cmd_SetT8032DebugLevel, 0, 0, 0);
    }
	#endif
