...
#define RCMM_SUPPORT 0 

#define SUSPEND_TO_DRAM 0
#define HOTKEY_WAKEUP_SUPPORT 0 
#define HOTKEY_SW_WAKEUP_SUPPORT 1
//#define CC_MT8223
...
#define UART_DBG 0
#define SONY_IR_DBG 1

#define SUPPORT_ERROR_LED_CTRL  1//0
...
#define SIR_TASK 1 // 1
#define QUERY_IR_POWER_KEY_STATE_SUPPORT 0
#define DISABLE_WAKEUP_SOMETIME 1
#define IR_TASK_STANDBY IR_TASK
...
#define CEC_FEATURE_1  	0  // 1
#define CEC_FEATURE_2  	1//0
...
#define ENABLE_CBUS 0
#if ENABLE_CBUS
//#define CC_MHL_CBUS_CMOS_CTRL
#define CC_SONY_VBUS_CTRL
#define CC_MHL_PRADA_NOTE
#endif

#define SUSPEND_GPIO_NUMBER GPIO(226)//ADIN4
#endif 
