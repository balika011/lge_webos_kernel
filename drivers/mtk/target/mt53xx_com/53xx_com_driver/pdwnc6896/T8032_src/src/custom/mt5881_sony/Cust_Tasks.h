...
#define vTask3StandbyProcess vRS232CustTaskStandby
#define vTask3WakeupProcess vRS232CustTaskWakeup
#endif
...
#if CY8C20110_SUPPORT
extern void vTask9KeypadPolling(void);
extern void vTask9KeypadCtrl_Standby_Process(void);
#define vTask9          vTask9KeypadPolling
#define vTask6StandbyProcess vTask9KeypadCtrl_Standby_Process
#endif
...
//#define TMIER_PKT_RECEIVER 100//ms
//#define TIMER_PKT_SENDER 100
//#define TIMER_CMD_RECEIVER 320
//#define TIMER_CMD_SENDER 320
#endif

#if 1//wangle for build pass
