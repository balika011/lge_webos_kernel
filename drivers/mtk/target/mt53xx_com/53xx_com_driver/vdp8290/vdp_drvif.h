...
#define VDP_SCPOS_HYBRID_MODE       6     //added for Gazelle hybrid mode
#define VDP_SCPOS_DISPMODE_UNKNOWN  7
...
EXTERN UINT32 VDP_Drv3DModeChgNotify(UINT8 bPath, VDP_3D_MODE_CHG_INFO_T rMode,UINT8 u1BeforeAfter);
