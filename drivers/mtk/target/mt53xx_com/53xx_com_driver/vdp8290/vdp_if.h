...
#define VDP_BYPASS                  0    	///< VDP bypass path for 4k2k, HDMI/B2R
#define VDP_PQPATH                  1    	///< VDP pq path for normal video
#define VDP_GFXOUT                  2    	///< VDP gfx out path for 4k2k
#define OUTPUT_PLANE_NS             3
...
typedef struct
{
	...
	UINT32  u1Input3DFormat;
	UINT32  u1ColorFormat;
	UINT32 u1ColorSpace;
}VDP_3D_MODE_CHG_INFO_T;
...
/**
*/
typedef UINT32 (*PFN_VDP_3D_Mode_CHG_NOTIFY)(UCHAR u4VdpId, VDP_3D_MODE_CHG_INFO_T rMode);
...
typedef enum
{
	...
	VDP_CB_FUNC_3D_MODE_CHG_IND,
	VDP_CB_FUNC_AFTER_3D_MODE_CHGED_IND,
    VDP_CB_FUNC_NS
} VDP_CB_FUNC_ENUM_T;
