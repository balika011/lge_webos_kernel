...
UINT32 VDP_SetMode(UCHAR ucVdpId, UCHAR ucMode)
{
    ...
    else if (_arVdpConf[ucVdpId].ucVdpEnable && _u4DrvVideoGetMute(ucVdpId))
    {
...
{
	UINT8 u1IsSupport121;
	
       u1IsSupport121 = u1ScpipIsSupport121(SV_VP_MAIN);
       LOG(3, "VDP_IsSupportDotByDot %d\n", u1IsSupport121);
       return u1IsSupport121;
}
