...
#if defined (CC_MT5175) && (defined(CC_MT5399))
    mcSHOW_DBG_MSG((" [40732 5399&&5175]Enter DTMB_TunerAcq\n"));
	#endif
...
//#endif
    ...
    switch (ucCmdId)
    {
        ...
        //#endif
            ...
            mcSHOW_USER_MSG(("=================================\n"));
        #if defined(CC_MT5135) || defined(CC_MT5396)|| defined(CC_MT5368) || defined(CC_MT5175) || defined(CC_MT5398)||defined(CC_MT5880)||defined(CC_MT5881)||defined(CC_MT5399)//EC_code_dB330: For MT5396DTMBC demod
...
void DTMB_pm_str_suspend(void)
{
    ...
    mcSHOW_DBG_MSG4(("DTMB_pm_str_suspend pPdCtx->hHalLock\n")); 
    mcMUTEX_LOCK(pPdCtx->hHalLock);
    mcSHOW_DBG_MSG4(("escape DTMB_pm_str_suspend pPdCtx->hHalLock\n"));
	
    DTMB_DisConnect(psDtmbDemodCtx);
	DTMB_CloseClk(psDtmbDemodCtx);
	
    mcMUTEX_UNLOCK(pPdCtx->hHalLock);
    mcSHOW_DBG_MSG4(("DTMB_pm_str_suspend unlock pPdCtx->hHalLock\n"));
...
void DTMB_pm_str_resume(void)
{
	...
	UINT8	bw = MT5391_BW_8MHz;
	//UINT8   fgChannelScan = FALSE;
	mcSHOW_DBG_MSG4((" DTMB_pm_str_resume pPdCtx->hHalLock\n"));
    mcMUTEX_LOCK(pPdCtx->hHalLock);
    mcSHOW_DBG_MSG4((" escape DTMB_pm_str_resume  pPdCtx->hHalLock\n"));
