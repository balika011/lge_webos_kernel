 ...
 *************************************************************************/
/* VBI Working Modes*/
static VBI_MODE_T  _t_VbiMode, _t_pre_VbiMode = VBI_MODE_NUM;
...
void VBI_ISR(void)
{
    ...
    if(_fgVbiFifoRstDone == FALSE)
    {
		...
		if((_rVbiFifoRstTime.u4Seconds > rCurTime.u4Seconds) ||
        ((_rVbiFifoRstTime.u4Seconds == rCurTime.u4Seconds) &&
        (_rVbiFifoRstTime.u4Micros > rCurTime.u4Micros)))
        
		{
         return;      //old time is larger than new time!!!!!
		}
		...
		if(IsTypeBWSSEnable() && IsTypeBWSSRdy())
		{
...
#endif
			{
...
#endif
				{
					...
					if(_u1VbiTypeBWSSMainNotify == SV_ON)
					{
        ...
        if(IsTypeBWSS2Enable() && IsTypeBWSS2Rdy())
		{
...
#endif
			{
...
#endif
			    {
				    ...
				    if(_u1VbiTypeBWSSSubNotify == SV_ON)
				    {
