...
{REG_LVDS_TX_CFG9, 0x0448c000},
{REG_LVDS_TX_CFG10, 0x0c480fff},
{REG_LVDS_TX_CFG11, 0x0fff0000},
{REG_LVDS_TX_CFG12, 0x00000000},
{REG_LVDS_TX_CFG13, 0x00000000},
{REG_LVDS_TX_CFG14, 0x00000000},
{REG_LVDS_TX_CFG15, 0x00000000},
{REG_LVDS_TX_CFG16, 0x00000000},
{REG_LVDS_TX_CFG17, 0x000f0000},
{REG_LVDS_TX_CFG18, 0x00000000},
{RGS_LVDS_TX_CFG0, 0x00000000},
#endif
...
void vVByOneAnalogOffSetting(void)
{
    ...
    vIO32WriteFldMulti(REG_LVDS_TX_CFG12, P_Fld(0, RG_LVDSA_HSN_MODE_EVEN_EN_D11)|P_Fld(0, RG_LVDSA_HSP_MODE_EVEN_EN_D11)
	...
	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 1, RG_LVDSA_LDO_EVEN_PWD_D11);

	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 1, RG_LVDSA_LDO_ODD_PWD_D11);

	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 1, RG_LVDSA_LDO_BIAS_EVEN_PWD_D11);

	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 1, RG_LVDSA_LDO_BIAS_ODD_PWD_D11);

	vIO32WriteFldAlign(REG_LVDS_TX_CFG9, 1, RG_LVDSA_BIAS_EVEN_PWD);

	vIO32WriteFldAlign(REG_LVDS_TX_CFG9, 1, RG_LVDSA_BIAS_ODD_PWD);
...
void vVByOne_Impedance_Cal(void)
{
	...
	vIO32WriteFldAlign(REG_LVDS_TX_CFG15,0x1c,RG_LVDSA_ABIST_VL_ODD_SEL_D11);
	vDrvLVDSSetDriving(6); // default 6mA 	vIO32WriteFldAlign(REG_LVDS_TX_CFG9, 0xd,RG_LVDSA_TVO);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG9,0x4,RG_LVDSA_TVCM);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG10,0x4,RG_LVDSA_BIAS_SEL);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG9,0x6,RG_LVDSA_NSRC);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG9,0x6,RG_LVDSA_PSRC);
...
void vVByOneInit(void)
{
	...
	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 0x1, RG_LVDSA_LDO_ODD_PWD_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 0x1, RG_LVDSA_LDO_EVEN_PWD_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 0x1, RG_LVDSA_LDO_BIAS_ODD_PWD_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG17, 0x1, RG_LVDSA_LDO_BIAS_EVEN_PWD_D11);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG9, 0x1, RG_LVDSA_BIAS_ODD_PWD);
	vIO32WriteFldAlign(REG_LVDS_TX_CFG9, 0x1, RG_LVDSA_BIAS_EVEN_PWD);
