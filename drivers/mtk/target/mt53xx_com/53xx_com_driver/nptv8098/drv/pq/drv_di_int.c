...
typedef struct
{
    ...
    UINT16 u2MutiCandence_Config;  //MultiCadence config
} DI_PQ_MODE;
    ...
    if (bPath == VDP_1)
    {
        ...
        switch (bDrvVideoGetTiming(bPath))
        {
            ...
            case MODE_1080i_50:
                ...
                DiPQMode.u2MutiCandence_Config = IO32ReadFldAlign(PSCAN_FWFILM_07, CANDENCE_CONFGIG_50);
                break;
            default:
                DiPQMode.b22Film = u1OnOff;
                DiPQMode.b32Film = u1OnOff;
                DiPQMode.u2MutiCandence_Config = IO32ReadFldAlign(PSCAN_FWFILM_07, CANDENCE_CONFGIG_60);
                break;
        }
...
static void _vDrvDISetIFQuality(UINT8 bPath)
{
    ...
    if ((bGetSignalTypeNew(VDP_1) == SV_ST_AV) || (bGetSignalTypeNew(VDP_1) == SV_ST_AV))
    {
...
{        
    ...
    else
    {
        ...
        if (IO32ReadFldAlign(PSCAN_FWFILM_06, FILED_WEAVE_EN)
            && (((DiPar.PdPar.u2FilmMode > E_DI_FILM_22)&&
                 ((1<<DiPar.PdPar.u2FilmMode)&DiPQMode.u2MutiCandence_Config))|| 
                (DiPar.PdPar.bFilm24To50) || 
                (((DiPar.PdPar.u2FilmMode == E_DI_FILM_22) || 
                (DiPar.PdPar.u2FilmMode == E_DI_FILM_32)) && (E_TD_OUT_3D_FS==_arMDDiPrm[VDP_1].eTDOutput))) 
            && (DiPar.PdPar.bFwBadEdit == 0)
...
{      
    ...
    vIO32WriteFldAlign(PSCAN_FWFILM_07, 0x7F8, CANDENCE_CONFGIG_50);   
    vIO32WriteFldAlign(PSCAN_FWFILM_07, 0x7F8, CANDENCE_CONFGIG_60);
