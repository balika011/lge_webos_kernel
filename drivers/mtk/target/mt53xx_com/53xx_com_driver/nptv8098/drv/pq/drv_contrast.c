...
static void vDrvADLSetLumaCurveHwExtend(const UINT16 * waLArray)
{
	...
	vIO32Write4B(Y_FTN_64_MAIN, waLArray[64]);
}
...
static void vDrvADLSetLumaCurveHw(const UINT16 * waLArray)
{
    ...
    vDrvADLSetLumaCurveHwExtend(waLArray65);
}
...
void vDrvADLSetSecondLumaCurveHwExtend(const UINT16 * waSLArray)
{
	...
	vIO32Write4B(Y_FTN2_64_MAIN, waSLArray[64]);
}
...
void vDrvADLSetSecondLumaCurveHw(const UINT16 * waSLArray)
{
    ...
    vDrvADLSetSecondLumaCurveHwExtend(waSLArray65);
}
...
// Update Adaptive luma version 2 parameter
    ...
    #else
    vIO32WriteFldAlign(ADAP_LUMA2_05, SV_TRUE, ADL_FORCE_SCENE_CHANGE);
    #endif
