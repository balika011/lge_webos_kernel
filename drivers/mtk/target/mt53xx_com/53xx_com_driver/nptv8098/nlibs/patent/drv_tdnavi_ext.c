...
{
	vIO32WriteFldAlign(TDNVAI_06, g_u1TdLb_Thr, TD_LB_THR);
	
	vIO32WriteFldAlign(TDNVAI_06, g_u1LiVerThr1, LI_VER_THR1);
	vIO32WriteFldAlign(TDNVAI_06, g_u1LiVerThr2, LI_VER_THR2);
	
	vIO32WriteFldAlign(TDNVAI_07, g_u1CiHorThr, CI_HOR_THR);
	vIO32WriteFldAlign(TDNVAI_07, g_u1CiDiffGapthr, CI_DIFF_GAP_THR);
	
	vIO32WriteFldAlign(TDNVAI_07, g_u1CbCoriThr, CB_CORI_THR);
	vIO32WriteFldAlign(TDNVAI_07, g_u1CbDiffGapThr, CB_DIFF_GAP_THR);
	
	vIO32WriteFldAlign(TDNVAI_07, g_u1QcVdiffMinThr, QC_VDIFF_MIN_THR);
	vIO32WriteFldAlign(TDNVAI_07, g_u1QcVdiffGainThr, QC_VDIFF_GAIN_THR);
	vIO32WriteFldAlign(TDNVAI_07, g_u1QcDiffGapThr, QC_DIFF_GAP_THR);
	vIO32WriteFldAlign(TDNVAI_07, g_u1QcMode, QC_MODE);
		
	vIO32WriteFldAlign(TDNVAI_08, g_u1LiCntThr, LI_CNT_THR);
	vIO32WriteFldAlign(TDNVAI_08, g_u1CiCntThr, CI_CNT_THR);
	
	vIO32WriteFldAlign(TDNVAI_08, g_u1CbCntthr, CB_CNT_THR);
	vIO32WriteFldAlign(TDNVAI_08, g_u1QcCntThr, QC_CNT_THR);
	
	vIO32WriteFldAlign(TDNVAI_08, g_u1LiStaMode, LI_STA_MODE);
	vIO32WriteFldAlign(TDNVAI_08, g_u1CiStaMode, CI_STA_MODE);
	
	vIO32WriteFldAlign(TDNVAI_08, g_u1CbStaMode, CB_STA_MODE);
	vIO32WriteFldAlign(TDNVAI_08, g_u1QcStaMode, QC_STA_MODE);
	
	vIO32WriteFldAlign(TDNVAI_09, g_u1LiFrcHi, LI_FCR_HI);
	vIO32WriteFldAlign(TDNVAI_09, g_u1LiFrcLo, LI_FCR_LO);
	
	vIO32WriteFldAlign(TDNVAI_09, g_u1CiFrcHi, CI_FCR_HI);
	vIO32WriteFldAlign(TDNVAI_09, g_u1CiFrcLo, CI_FCR_LO);
	
	vIO32WriteFldAlign(TDNVAI_09, g_u1CbFrcHi, CB_FCR_HI);
	vIO32WriteFldAlign(TDNVAI_09, g_u1CbFrcLo, CB_FCR_LO);
	
	vIO32WriteFldAlign(TDNVAI_0A, g_u1QcFrcHi, QC_FCR_HI);
	vIO32WriteFldAlign(TDNVAI_0A, g_u1QcFrcLo, QC_FCR_LO);		
}
...
static void vDrvTdNaviV2SetPicSize(void)
{
	...
	vIO32WriteFldAlign(TDNVAI_05, g_u1HMidBlk, H_MID_BLK);
	vIO32WriteFldAlign(TDNVAI_05, g_u1WMidBlk, W_MID_BLK);		
	vIO32WriteFldAlign(TDNVAI_05, g_u4HeightSt, HEIGHT_ST);		
	vIO32WriteFldAlign(TDNVAI_05, g_u4WidthSt, WIDTH_ST);
	
	vIO32WriteFldAlign(TDNVAI_06, u1BlkHeight, WIN_HEIGHT);		
	vIO32WriteFldAlign(TDNVAI_06, u1BlkWidth, WIN_WIDTH);		
...
{
	return IO32ReadFldAlign(TDNVAI_STA4, STA_FMT);
}
...
void vDrvTdNaviV2Det(void)
{
	...
	LOG(8,"CbCnt(%d),CiCnt(%d),LiCnt(%d),QcCnt(%d),2DCnt(%d),DetV2New(%d),DetV2Curr(%d)\n"
