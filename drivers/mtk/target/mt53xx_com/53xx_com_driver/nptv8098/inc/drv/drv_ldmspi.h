...
void SPI_NON_DEF_CMD_3_PARAM(UINT8 u1Param1, UINT8 u1Param2, UINT8 u1Param3);
...
typedef struct sLdmSpiFuncSet {    
	...
	void (*vSpiMultiDevRead1BCmd)(UINT8, UINT8);
	void (*vSpiMultiDevWrite1BCmd)(UINT8, UINT8, UINT8);
} sLdmSpiCommandSet;
...
//-----------------------------------------------------------
//                Driver For LEPOWER 1887 Driver IC
//-----------------------------------------------------------
