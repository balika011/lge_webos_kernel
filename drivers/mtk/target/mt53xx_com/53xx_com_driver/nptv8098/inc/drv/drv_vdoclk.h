...
extern void vDrvEnable_DDDS_Calibration(UINT8 bKP0_START,UINT8 bKP0_END, UINT8 bKI0_START, UINT8 bKI0_END, UINT8 ERROR_LIM,UINT8 bRange);
...
#define vDrvCLKINSyncSel(bSrc) 	vIO32WriteFldAlign(REG_PLL_GROUP_CFG9, bSrc, FLD_RG_VGAPLL_SDDS_HSEL)
//#define vDrvCLKINHsyncPol(bPol) vIO32WriteFldAlign(CKGEN_AFEPLLCFG5, bPol, FLD_RG_VGAPLL_SDDS_HPOR)
#define vDrvCLKINHsyncPol(bPol) 	vIO32WriteFldAlign(REG_PLL_GROUP_CFG9, bPol, FLD_RG_VGAPLL_SDDS_HPOR)
