...
//CUST_QTY_TBL    
extern UINT8 bCustomQtyTbl[FLASHPQ_NUM][25][CUSTOM_QTY_TBL_DIM];
#define READ_CUSTOM_QTY_TBL(timing,item) (bCustomQtyTbl[((item>>QTY_TBL_REF_INDEX_SHIFT)<FLASHPQ_NUM)?(item>>QTY_TBL_REF_INDEX_SHIFT):0][MIN(timing, 24)][item &0x3FFF])
#define WRITE_CUSTOM_QTY_TBL(timing,item,value) {bCustomQtyTbl[item>>QTY_TBL_REF_INDEX_SHIFT][MIN(timing, 24)][item &0x3FFF]=(value);}
