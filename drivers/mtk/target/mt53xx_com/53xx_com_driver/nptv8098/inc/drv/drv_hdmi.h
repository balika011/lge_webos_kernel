...
#define HPDLOW_WAITNEXT_PULL 0xF
#define HPDLOW_PULLING 0xFF
...
typedef struct
{
	UINT8 HDMI_ppl2_App1;
	UINT8 HDMI_ppl2_App2;
	UINT8 HDMI_ppl2_App3;
	UINT8 HDMI_ppl2_App4;
	UINT8 HDMI_ppl2_App5;
}PPL2Info_t;
...
extern UINT32 _wHDMI_OFFON_MUTE_COUNT;
