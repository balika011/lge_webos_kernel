...
enum
{
	...
	#ifdef CUST_SOEM_DRV
	// FleshTone ADL 
    QUALITY_AL_BS_COLOR_ON_1_OFF_0,
    QUALITY_AL_R_RATIO,
    QUALITY_AL_G_RATIO,
    QUALITY_AL_B_RATIO,
    QUALITY_AL_R_SAT_L,
    ...
    #ifdef CUST_SOEM_DRV
    QUALITY_MISC_BRIGHTPLUS_CTRL,
    QUALITY_MISC_BRIGHTPLUS_MAXTH,
    QUALITY_MISC_BRIGHTPLUS_MAXTH_MSB,
    QUALITY_MISC_BRIGHTPLUS_P1,
    QUALITY_MISC_BRIGHTPLUS_P2,
    QUALITY_MISC_BRIGHTPLUS_G1,
    QUALITY_MISC_BRIGHTPLUS_G2,
	#endif
    ...
    QUALITY_DEPTH_TTDC_GLOBAL,
    QUALITY_DEPTH_TTDC_LOCAL,
...
#else
#define QUALITY_SHARP_END                   QUALITY_CTIR_COR //QUALITY_TDSHARP_3D_DA_VCLIP // modify to update CTIR data when change PIC Mode
#endif
...
#else
#define QUALITY_AL_END                      QUALITY_AL_WHITE_DECAY
#endif
...
#else
#define QUALITY_GAMMA_END                   QUALITY_MISC_BRIGHTPLUS_G2
#endif
...
#define QUALITY_DEPTH_END       			QUALITY_DEPTH_TTDC_LOCAL
...
#define R_TIMEUI    0x200 	// Store UI driver value in each timing sequentially

extern PE_UI_RANGE_T aUiQtyItemMinMax[PE_ARG_NS];
