...
#define MCVP_KC_33 (IO_MDDI_BASE + 0x1CC)
    ...
    #define PROG_SRC_RST_EN   Fld(1,8,AC_MSKB1) //[8:8]
    ...
    #define OS_RST_NO_DELAY Fld(1,4,AC_MSKB0)
    #define INPUT_SYNC_FREEZE Fld(1,3,AC_MSKB0) //[3:3]
    #define DISABLE_PRE_HSYNC_REF Fld(1,2,AC_MSKB0) //[2:2]
...
#define MCVP_DRAM_09 (IO_MDDI_BASE + 0x084)
    ...
    #define DA_READ_REQ_SPACING Fld(7,9,AC_MSKB1)//[15:9]
    #define DA_420_TB_EN        Fld(1,8,AC_MSKB1)//[8:8]
