...
#define PWM_SCAN_06 (IO_VIRT + 0x34220)
    #define REG_TCON_BL_IN_POL Fld(1,31,AC_MSKB3)//[31:31]
    #define REG_TCON_BL_EN Fld(1,30,AC_MSKB3)//[30:30]
    #define REG_PWM_SCAN_BL_DIS_LATCH Fld(1,29,AC_MSKB3)//[29:29] 
