...
#define SCPIP_SCCTRL1_0C (IO_SCPIP_BASE + 0x230)
    ...
    #define SCCTRL1_0C_SC_SS_V_EN Fld(1,27,AC_MSKB3)//[27:27]
    #define SCCTRL1_0C_SC_SS_H_EN Fld(1,26,AC_MSKB3)//[26:26]
    #define SCCTRL1_0C_SC_TAP_ADAPT_V_EN Fld(1,27,AC_MSKB3)//[27:27]  Python only
    #define SCCTRL1_0C_SC_TAP_ADAPT_H_EN Fld(1,26,AC_MSKB3)//[26:26]  Python only
...
#define SCPIP_SCCTRL1_17 (IO_SCPIP_BASE + 0x25C)
    #define SCCTRL1_17_SC_V_DS_INTEGRAL_EN_1 Fld(1,31,AC_MSKB3)//[31:31]
    #define SCCTRL1_17_SC_H_DS_INTEGRAL_EN_1 Fld(1,30,AC_MSKB3)//[30:30]
    #define SCCTRL1_17_SC_V_DS_INTEGRAL_RATIO Fld(12,16,AC_MSKW32)//[27:16]
    #define SCCTRL1_17_SC_H_DS_INTEGRAL_RATIO Fld(12,4,AC_MSKW10)//[15:4]
...
#define SCPIP_SCCTRL1_1F (IO_SCPIP_BASE + 0x27C)
    ...
    #define SCCTRL1_1F_SC_TG_OUTPUT_SEL_1 Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCCTRL1_25 (IO_SCPIP_BASE + 0x294)
    #define SCCTRL1_25_SC_TG_OUTPUT_WIDTH_1 Fld(16,16,AC_FULLW32)//[31:16]
    #define SCCTRL1_25_SC_TG_OUTPUT_HEIGHT_1 Fld(16,0,AC_FULLW10)//[15:0]
...
#define SCPIP_SCCTRL1_33 (IO_SCPIP_BASE + 0x2CC)
    #define SCCTRL1_33_SC_SCCTRL1_RESERVED0 Fld(32,0,AC_FULLDW)//[31:0]
    #define SCCTRL2_13_SC_HC_COEF_TABLE_SEL Fld(3,0,AC_MSKB0)//[2:0]
#if defined(CC_MT5398)
#define SCPIP_SCCTRL1_34 (IO_SCPIP_BASE + 0x2D0)
    #define SCCTRL1_34_SC_DRAM_SRC_W_HEIGHT_1 Fld(16,0,AC_FULLW10)//[15:0]    
#endif
#define SCPIP_SCCTRL1_37 (IO_SCPIP_BASE + 0x2DC)
    #define SCCTRL1_37_SC_TG_DLY Fld(2,1,AC_MSKB0)//[2:1]
    #define SCCTRL1_37_SC_TG_DLY_IMPORT_ENABLE Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCCTRL2_1F (IO_SCPIP_BASE + 0x47C)
    ...
    #define SCCTRL2_1F_SC_TG_OUTPUT_SEL_2 Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCCTRL2_25 (IO_SCPIP_BASE + 0x494)
    #define SCCTRL2_25_SC_TG_OUTPUT_WIDTH_2 Fld(16,16,AC_FULLW32)//[31:16]
    #define SCCTRL2_25_SC_TG_OUTPUT_HEIGHT_2 Fld(16,0,AC_FULLW10)//[15:0]
...
#define SCPIP_SCCTRL2_34 (IO_SCPIP_BASE + 0x4D0)
    #define SCCTRL2_34_SC_DRAM_SRC_W_HEIGHT_2 Fld(16,0,AC_FULLW10)//[15:0]        
#endif
#define SCPIP_SCCTRL2_37 (IO_SCPIP_BASE + 0x4DC)
    #define SCCTRL2_37_SC_TG_DLY Fld(2,1,AC_MSKB0)//[2:1]
    #define SCCTRL2_37_SC_TG_DLY_IMPORT_ENABLE Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCSYS_51 (IO_SCPIP_BASE + 0x144)
    #define SCSYS_51_SC_M_NOCTI_REG_H_BOUND_EN Fld(1,9,AC_MSKB1)//[9:9]
    #define SCSYS_51_SC_M_NOCTI_MIRROR_422 Fld(2,7,AC_MSKW10)//[8:7]
    #define SCSYS_51_SC_M_NOCTI_UVINV Fld(1,6,AC_MSKB0)//[6:6]
    #define SCSYS_51_SC_M_NOCTI_SEL444 Fld(1,5,AC_MSKB0)//[5:5]
    #define SCSYS_51_SC_P_NOCTI_REG_H_BOUND_EN Fld(1,4,AC_MSKB0)//[4:4]
    #define SCSYS_51_SC_P_NOCTI_MIRROR_422 Fld(2,2,AC_MSKB0)//[3:2]
    #define SCSYS_51_SC_P_NOCTI_UVINV Fld(1,1,AC_MSKB0)//[1:1]
    #define SCSYS_51_SC_P_NOCTI_SEL444 Fld(1,0,AC_MSKB0)//[0:0]
#endif
#define SCPIP_SCSYS_77 (IO_SCPIP_BASE + 0x1DC)
    #define SCSYS_77_SC_PIP_RST_CNT_OFST Fld(4,28,AC_MSKB3)//[31:28]
    #define SCSYS_77_SC_SCSYS_RESERVED0_1 Fld(18,10,AC_MSKDW)//[27:10]
    #define SCSYS_77_MIRROR_422_MAIN Fld(2,8,AC_MSKB1)//[9:8]
    #define SCSYS_77_MIRROR_422_PIP Fld(2,6,AC_MSKB0)//[7:6]
    #define SCSYS_77_UVINV_PIP Fld(1,5,AC_MSKB0)//[5:5]
    #define SCSYS_77_SEL444_PIP Fld(1,4,AC_MSKB0)//[4:4]
    #define SCSYS_77_SC_SCSYS_RESERVED0_0 Fld(2,2,AC_MSKB0)//[3:2]
    #define SCSYS_77_UVINV_MAIN Fld(1,1,AC_MSKB0)//[1:1]
    #define SCSYS_77_SEL444_MAIN Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCSYS_06 (IO_SCPIP_BASE + 0x318)
    ...
    #define SCSYS_06_SC_HMSK_STR_OFST_1 Fld(17,0,AC_MSKDW)//[16:0]
#define SCPIP_SCSYS_07 (IO_SCPIP_BASE + 0x31C)
    #define SCSYS_07_SC_SCALER_DEBUG_SEL Fld(8,24,AC_FULLB3)//[31:24]
    #define SCSYS_07_SC_VMSK_STR_OFST_1 Fld(17,0,AC_MSKDW)//[16:0]
#define SCPIP_SCSYS_08 (IO_SCPIP_BASE + 0x320)
    #define SCSYS_08_SC_HMSK_STR_OFST_2 Fld(17,0,AC_MSKDW)//[16:0]
#define SCPIP_SCSYS_09 (IO_SCPIP_BASE + 0x324)
    #define SCSYS_09_SC_FRM_MASK_O_SEL Fld(4,24,AC_MSKB3)//[27:24]
    #define SCSYS_09_SC_FRM_MASK_I_SEL Fld(4,20,AC_MSKB2)//[23:20]
    #define SCSYS_09_SC_INV_OUTPUT_DISP_R Fld(1,19,AC_MSKB2)//[19:19]
    #define SCSYS_09_SC_CLR_STA_INPUTV_ABNORMAL Fld(1,18,AC_MSKB2)//[18:18]
    #define SCSYS_09_SC_VMSK_STR_OFST_2 Fld(17,0,AC_MSKDW)//[16:0]
#define SCPIP_SCSYS_0A (IO_SCPIP_BASE + 0x328)
    #define SCSYS_0A_SC_VMSK_END_CROP_1 Fld(8,24,AC_FULLB3)//[31:24]
    #define SCSYS_0A_SC_VMSK_STR_CROP_1 Fld(8,16,AC_FULLB2)//[23:16]
    #define SCSYS_0A_SC_HMSK_END_CROP_1 Fld(8,8,AC_FULLB1)//[15:8]
    #define SCSYS_0A_SC_HMSK_STR_CROP_1 Fld(8,0,AC_FULLB0)//[7:0]
#define SCPIP_SCSYS_0B (IO_SCPIP_BASE + 0x32C)
    #define SCSYS_0B_SC_VMSK_END_CROP_2 Fld(8,24,AC_FULLB3)//[31:24]
    #define SCSYS_0B_SC_VMSK_STR_CROP_2 Fld(8,16,AC_FULLB2)//[23:16]
    #define SCSYS_0B_SC_HMSK_END_CROP_2 Fld(8,8,AC_FULLB1)//[15:8]
    #define SCSYS_0B_SC_HMSK_STR_CROP_2 Fld(8,0,AC_FULLB0)//[7:0]
#define SCPIP_SCSYS_0C (IO_SCPIP_BASE + 0x330)
    ...
    #define SCSYS_0C_SC_GFX_SRC_SEL Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_SCSYS_20 (IO_SCPIP_BASE + 0x380)
    ...
    #define SCSYS_20_SC_PIP2TVE_ENABLE Fld(1,2,AC_MSKB0)//[2:2]
    #define SCSYS_20_SC_INV_TVE_VSYNC Fld(1,1,AC_MSKB0)//[1:1]
    #define SCSYS_20_SC_INV_TVE_HDE Fld(1,0,AC_MSKB0)//[0:0]
...
#define SCPIP_DRAM_P_04 (IO_SCPIP_BASE + 0xC10)
    #define DRAM_P_04_DA_ADDR_BASE_MSB_Y Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_05 (IO_SCPIP_BASE + 0xC14)
    #define DRAM_P_05_DA_ADDR_BASE_LSB_Y Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_06 (IO_SCPIP_BASE + 0xC18)
    #define DRAM_P_06_DA_ADDR_BASE_MSB_U Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_07 (IO_SCPIP_BASE + 0xC1C)
    #define DRAM_P_07_DA_ADDR_BASE_LSB_U Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_08 (IO_SCPIP_BASE + 0xC20)
    #define DRAM_P_08_DA_ADDR_BASE_MSB_V Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_09 (IO_SCPIP_BASE + 0xC24)
    #define DRAM_P_09_DA_ADDR_BASE_LSB_V Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_0A (IO_SCPIP_BASE + 0xC28)
    #define DRAM_P_0A_DA_WADDR_HI_LIMIT Fld(20,11,AC_MSKDW)//[30:11]
#define SCPIP_DRAM_P_0B (IO_SCPIP_BASE + 0xC2C)
    #define DRAM_P_0B_DA_WADDR_LO_LIMIT Fld(20,11,AC_MSKDW)//[30:11]
...
#define SCPIP_DRAM_P_20 (IO_SCPIP_BASE + 0xC80)
    #define DRAM_P_20_DA_ECO_RSV Fld(32,0,AC_FULLDW)//[31:0]
#endif
