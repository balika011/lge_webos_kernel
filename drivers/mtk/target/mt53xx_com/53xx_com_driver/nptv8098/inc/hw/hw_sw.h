...
#ifdef CUST_SOEM_DRV
#define PEUI_DBG u4SWReg(0x0008)
    #define PEUI_DBG_00               Fld(1, 0, AC_MSKB0) 
    #define PEUI_DBG_01               Fld(1, 1, AC_MSKB0)
#endif
//=============================================================
// Addr : 0x0000 - 0x0100
...
#define OD_SW_00    u4SWReg(0x0034)
    #define OD_SW_CNT               Fld(16, 0,  AC_MSKW10)  //15:0    
#define OD_SW_01    u4SWReg(0x0038)
    #define OD_MOTION_LVL               Fld(16, 0,  AC_MSKW10)  //15:0
    #define OD_STILL_CNT            Fld(8, 16,  AC_MSKDW)  //23:16
    #define OD_STILL_OFF_EN            Fld(1, 31,  AC_MSKDW)  //31:31
...
#if 0
#define SW_DEBUG_INFO_00 u4SWReg(0x0904)
    #define LIB_AMBIL_BYPASS                            Fld(1, 0, AC_MSKB0) // 0
    #define LIB_BLD_BYPASS                              Fld(1, 1, AC_MSKB0) // 1
    #define LIB_SQM_BYPASS                              Fld(1, 2, AC_MSKB0) // 2
    #define LIB_PQM_BYPASS                              Fld(1, 3, AC_MSKB0) // 3
    #define LIB_WBC_BYPASS                              Fld(1, 4, AC_MSKB0) // 4
    #define SW_DEBUG_CUR_CUST_TIMING                    Fld(8, 8, AC_FULLB1)  //15:8    

#define SW_DEBUG_INFO_01 u4SWReg(0x0908)    
    #define SW_PQ_FEATURE_BYTE_0                        Fld(8, 0, AC_FULLB0) //7:0
    #define SW_PQ_FEATURE_BYTE_1                        Fld(8, 8, AC_FULLB1) //15:8
    #define SW_PQ_FEATURE_BYTE_2                        Fld(8, 16, AC_FULLB2) //23:16
    #define SW_PQ_FEATURE_BYTE_3                        Fld(8, 24, AC_FULLB3) //31:24

#define SW_DEBUG_INFO_02 u4SWReg(0x090C)    
    #define SW_AL_FEATURE_BYTE_0                        Fld(8, 0, AC_FULLB0) //7:0
    #define SW_AL_FEATURE_BYTE_1                        Fld(8, 8, AC_FULLB1) //15:8
    #define SW_AL_FEATURE_BYTE_2                        Fld(8, 16, AC_FULLB2) //23:16
    #define SW_AL_FEATURE_BYTE_3                        Fld(8, 24, AC_FULLB3) //31:24    
#endif
...
#define OPC_0A  u4SWReg(0x1124)
    ...
    #define OPC_REMAP_PWM      Fld(8, 24, AC_FULLB3) //31:24
    #define OPC_SEARCHED_PWM   Fld(8, 16, AC_FULLB2) //23:16
...
#define OPC_12  u4SWReg(0x1144)
    #define OPC_REMAP_P3 Fld(8, 24, AC_FULLB3) //31:24
    #define OPC_REMAP_P2 Fld(8, 16, AC_FULLB2) //23:16
    #define OPC_REMAP_P1 Fld(8, 8, AC_FULLB1) //15:8
    #define OPC_REMAP_P0 Fld(8, 0, AC_FULLB0) //7:0
#define OPC_13  u4SWReg(0x1148)
    #define OPC_REMAP_P7 Fld(8, 24, AC_FULLB3) //31:24
    #define OPC_REMAP_P6 Fld(8, 16, AC_FULLB2) //23:16
    #define OPC_REMAP_P5 Fld(8, 8, AC_FULLB1) //15:8
    #define OPC_REMAP_P4 Fld(8, 0, AC_FULLB0) //7:0
#define OPC_14  u4SWReg(0x114C)
    #define OPC_REMAP_UPDATE Fld(1, 9, AC_MSKB1) // 9
    #define OPC_REMAP_EN Fld(1, 8, AC_MSKB1) // 8
    #define OPC_REMAP_P8 Fld(8, 0, AC_FULLB0) //7:0

#define ADAP_LUMA2_08    u4SWReg(0x1160)    // MJC moving box patch of mt5396 changelsit:903459 ,checked to cd lee ,it also do in Cobra
...
#define BRIGHT_PLUS_03  u4SWReg(0x120C)
    #define BRIGHT_PLUS_APL_REF Fld(1, 31, AC_MSKB3) //31:31
    #define BRIGHT_PLUS_APL_LOG Fld(1, 30, AC_MSKB3) //30:30
    #define BRIGHT_PLUS_APLTHD Fld(8, 0, AC_FULLB0) //7:0   
#endif
...
#define ADAP_LCDIM_SPI u4SWReg(0x1418)
    #define SPI_FAULT Fld(8, 24, AC_FULLB3) //31:24
    #define SPI_HW_MODE  Fld(1,21,AC_MSKB2)//[21:21]
    #define SPI_BLK   Fld(2, 19,AC_MSKB2)//[20:19]
    ...
    #define SPI_DUMMY_CH_NUM    Fld(8, 0, AC_FULLB0) //7:0

#define ADAP_LCDIM_SPI_SEP_1 u4SWReg(0x141C)
...
#define SPI_SCANNING_DELAY_3 u4SWReg(0x142C)
    #define SPI_SCANNING_DELAY_06 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_07 Fld(16, 16, AC_FULLW32) //31:16  

#define SCAN_PWM_0 u4SWReg(0x1430)
    #define SCAN_PWM_CMD_LOG Fld(1, 31, AC_MSKB3) //31   
    #define SCAN_PWM_HW_CMD_LOG Fld(1, 30, AC_MSKB3) //30
    #define SCAN_PWM_TEST_CMD Fld(1, 29, AC_MSKB3) //29
#ifdef CC_CHECK_INDEX_SCAN_PWM
    #define SCAN_PWM_PWM_CMD Fld(1, 28, AC_MSKB3) //28
    #define SCAN_PWM_SRC    Fld(8, 8, AC_FULLB1) //15:8
    #define SCAN_PWM_MARGIN Fld(8, 0, AC_FULLB0) //7:0
#endif

#define SCAN_PWM_1 u4SWReg(0x1434)
    #define SCAN_PWM_CMD_1 Fld(8, 0, AC_FULLB0) //7:0
    #define SCAN_PWM_CMD_2 Fld(8, 8, AC_FULLB1) //15:8
    #define SCAN_PWM_CMD_3 Fld(8, 16, AC_FULLB2) //23:16
    #define SCAN_PWM_CMD_4 Fld(8, 24, AC_FULLB3) //31:24
#define SCAN_PWM_2 u4SWReg(0x1438)
    #define SCAN_PWM_CMD_5 Fld(8, 0, AC_FULLB0) //7:0
#ifdef CC_CHECK_INDEX_SCAN_PWM
#define SCAN_PWM_3 u4SWReg(0x143C)
    #define SCAN_PWM_READ  Fld( 1, 31, AC_MSKB3) //31
    #define SCAN_PWM_POL   Fld( 1, 30, AC_MSKB3) //30
    #define SCAN_PWM_LOW   Fld(10, 20, AC_MSKW32)//29:20
    #define SCAN_PWM_HIGH  Fld(10, 10, AC_MSKW21)//19:10
    #define SCAN_PWM_DELAY Fld(10,  0, AC_MSKW10)//9:0
#endif

#define FORCE_BACKLIGHT_0 u4SWReg(0x1440)
    #define FORCE_BACKLIGHT_EN Fld(8, 0, AC_FULLB0) //7:0
    #define FORCE_BACKLIGHT_DUTY Fld(8, 8, AC_FULLB1) //15:8

#define SPI_FREQ_CTRL_0 u4SWReg(0x1450)
    #define SPI_FREQ_CTRL Fld(8, 0, AC_FULLB0) //7:0
    #define SPI_PWM_FREQ_MULTI Fld(8, 8, AC_FULLB1) //15:8
#define SPI_FREQ_CTRL_1 u4SWReg(0x1454)
    #define SPI_HSYNC_FREQ_60 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_2 u4SWReg(0x1458)
    #define SPI_HSYNC_FREQ_120 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_3 u4SWReg(0x145C)
    #define SPI_HSYNC_FREQ_240 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_4 u4SWReg(0x1460)
    #define SPI_HSYNC_FREQ_480 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_5 u4SWReg(0x1464)
    #define SPI_HSYNC_FREQ_50 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_6 u4SWReg(0x1468)
    #define SPI_HSYNC_FREQ_100 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_7 u4SWReg(0x146C)
    #define SPI_HSYNC_FREQ_200 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_8 u4SWReg(0x1470)
    #define SPI_HSYNC_FREQ_400 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_9 u4SWReg(0x1474)
    #define SPI_HSYNC_FREQ_48 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_10 u4SWReg(0x1478)
    #define SPI_HSYNC_FREQ_96 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_11 u4SWReg(0x147C)
    #define SPI_HSYNC_FREQ_192 Fld(32, 0, AC_FULLDW)
#define SPI_FREQ_CTRL_12 u4SWReg(0x1480)
    #define SPI_HSYNC_FREQ_384 Fld(32, 0, AC_FULLDW)

#define SPI_SCANNING_DELAY_4 u4SWReg(0x1490)
    #define SPI_SCANNING_DELAY_08 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_09 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_5 u4SWReg(0x1494)
    #define SPI_SCANNING_DELAY_10 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_11 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_6 u4SWReg(0x1498)
    #define SPI_SCANNING_DELAY_12 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_13 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_7 u4SWReg(0x149C)
    #define SPI_SCANNING_DELAY_14 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_15 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_8 u4SWReg(0x14A0)
    #define SPI_SCANNING_DELAY_16 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_17 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_9 u4SWReg(0x14A4)
    #define SPI_SCANNING_DELAY_18 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_19 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_A u4SWReg(0x14A8)
    #define SPI_SCANNING_DELAY_20 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_21 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_B u4SWReg(0x14AC)
    #define SPI_SCANNING_DELAY_22 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_23 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_C u4SWReg(0x14B0)
    #define SPI_SCANNING_DELAY_24 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_25 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_D u4SWReg(0x14B4)
    #define SPI_SCANNING_DELAY_26 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_27 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_E u4SWReg(0x14B8)
    #define SPI_SCANNING_DELAY_28 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_29 Fld(16, 16, AC_FULLW32) //31:16  
#define SPI_SCANNING_DELAY_F u4SWReg(0x14BC)
    #define SPI_SCANNING_DELAY_30 Fld(16, 0, AC_FULLW10) //15:0
    #define SPI_SCANNING_DELAY_31 Fld(16, 16, AC_FULLW32) //31:16  
...
#define LCDIM_DEMO_SETTING_0  u4SWReg(0x1550)
    ...
    #define LCDIM_ADAP_GAINLIMT_HUE_DET     Fld(1, 16, AC_MSKB2) //1            
    ...
    #define LCDIM_UPDATE_DIM_CURVE          Fld(1, 28, AC_MSKB3)
...
#define ADAP_LCDIM_ADAP_GAIN_LMT_1  u4SWReg(0x1610)
    #define LCDIM_ADAP_GAIN_LMT_SKINTH_L   Fld(0, 32, AC_FULLDW)

#define ADAP_LCDIM_ADAP_GAIN_LMT_2  u4SWReg(0x1614)
    #define LCDIM_ADAP_GAIN_LMT_SKINTH_H   Fld(0, 32, AC_FULLDW)

#define ADAP_LCDIM_ADAP_GAIN_LMT_3  u4SWReg(0x1618)
    #define LCDIM_ADAP_GAIN_LMT_EN   Fld(1, 0, AC_MSKB0)
    #define LCDIM_ADAP_GAIN_LMT_LOG   Fld(1, 1, AC_MSKB0)

#define ADAP_LCDIM_ADAP_GAIN_LMT_4  u4SWReg(0x161C)
    #define LCDIM_ADAP_GAIN_LMT_APL_RATIO       Fld(8, 0, AC_FULLB0) //7:0
    #define LCDIM_ADAP_GAIN_LMT_SKIN_RATIO      Fld(8, 8, AC_FULLB1) //15:8
    #define LCDIM_ADAP_GAIN_LMT_FINAL_RATIO     Fld(8, 16, AC_FULLB2) //23:16
    #define LCDIM_ADAP_GAIN_LMT_PREFINAL_RATIO  Fld(8, 24, AC_FULLB3) //31:24    

#define ADAP_LCDIM_ADAP_GAIN_LMT_5  u4SWReg(0x1620)
    #define LCDIM_ADAP_GAIN_LMT_INC_STEP     Fld(8, 0, AC_FULLB0) //7:0
    #define LCDIM_ADAP_GAIN_LMT_DEC_STEP     Fld(8, 8, AC_FULLB1) //15:8
...
#define ADAPTIVE_RGB_GAMMA_REG u4SWReg(0x2010)
    #define ADAPTIVE_RGB_GAMMA_SEL Fld(8, 0, AC_FULLB0)
    #define ADAPTIVE_RGB_GAMMA_FORCE_LOAD Fld(1, 31, AC_MSKB3)
...
#define GAMMA_MAUNAL_REMAP_R_00 u4SWReg(0x2040)
    #define GAMMA_REMAP_R_00 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_R_01 Fld(16, 16, AC_FULLW32)
        
#define GAMMA_MAUNAL_REMAP_R_01 u4SWReg(0x2044)
    #define GAMMA_REMAP_R_02 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_R_03 Fld(16, 16, AC_FULLW32)
        
#define GAMMA_MAUNAL_REMAP_R_02 u4SWReg(0x2048)
    #define GAMMA_REMAP_R_04 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_R_05 Fld(16, 16, AC_FULLW32)
        
#define GAMMA_MAUNAL_REMAP_R_03 u4SWReg(0x204C)
    #define GAMMA_REMAP_R_06 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_R_07 Fld(16, 16, AC_FULLW32)
        
#define GAMMA_MAUNAL_REMAP_R_04 u4SWReg(0x2050)
    #define GAMMA_REMAP_R_08 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_R_09 Fld(16, 16, AC_FULLW32)
        
#define GAMMA_MAUNAL_REMAP_R_05 u4SWReg(0x2054)
    #define GAMMA_REMAP_R_10 Fld(16, 0, AC_FULLW10)
        
#define GAMMA_MAUNAL_REMAP_G_00 u4SWReg(0x2060)
    #define GAMMA_REMAP_G_00 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_G_01 Fld(16, 16, AC_FULLW32)
            
#define GAMMA_MAUNAL_REMAP_G_01 u4SWReg(0x2064)
    #define GAMMA_REMAP_G_02 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_G_03 Fld(16, 16, AC_FULLW32)
            
#define GAMMA_MAUNAL_REMAP_G_02 u4SWReg(0x2068)
    #define GAMMA_REMAP_G_04 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_G_05 Fld(16, 16, AC_FULLW32)
            
#define GAMMA_MAUNAL_REMAP_G_03 u4SWReg(0x206C)
    #define GAMMA_REMAP_G_06 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_G_07 Fld(16, 16, AC_FULLW32)
            
#define GAMMA_MAUNAL_REMAP_G_04 u4SWReg(0x2070)
    #define GAMMA_REMAP_G_08 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_G_09 Fld(16, 16, AC_FULLW32)
            
#define GAMMA_MAUNAL_REMAP_G_05 u4SWReg(0x2074)
    #define GAMMA_REMAP_G_10 Fld(16, 0, AC_FULLW10)
        
#define GAMMA_MAUNAL_REMAP_B_00 u4SWReg(0x2080)
    #define GAMMA_REMAP_B_00 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_B_01 Fld(16, 16, AC_FULLW32)
                
#define GAMMA_MAUNAL_REMAP_B_01 u4SWReg(0x2084)
    #define GAMMA_REMAP_B_02 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_B_03 Fld(16, 16, AC_FULLW32)
                
#define GAMMA_MAUNAL_REMAP_B_02 u4SWReg(0x2088)
    #define GAMMA_REMAP_B_04 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_B_05 Fld(16, 16, AC_FULLW32)
                
#define GAMMA_MAUNAL_REMAP_B_03 u4SWReg(0x208C)
    #define GAMMA_REMAP_B_06 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_B_07 Fld(16, 16, AC_FULLW32)
                
#define GAMMA_MAUNAL_REMAP_B_04 u4SWReg(0x2090)
    #define GAMMA_REMAP_B_08 Fld(16, 0, AC_FULLW10)
    #define GAMMA_REMAP_B_09 Fld(16, 16, AC_FULLW32)
                
#define GAMMA_MAUNAL_REMAP_B_05 u4SWReg(0x2094)
    #define GAMMA_REMAP_B_10 Fld(16, 0, AC_FULLW10)
    
#define GAMMA_REMAP_00 u4SWReg(0x2098)
    #define GAMMA_REMAP_INDEX Fld(8, 0, AC_FULLB0)
...
#define ADAPTIVE_PBC_00  u4SWReg(0x2150)
    #define ADAPTIVE_PBC_EN Fld(1, 31, AC_MSKB3) //31:31
    #define ADAPTIVE_PBC_LOG Fld(1, 30, AC_MSKB3) //30:30
    #define ADAPTIVE_PBC_BLUE_RATE Fld(23, 16, AC_FULLB2) //23:16
    #define ADAPTIVE_PBC_THD Fld(9, 0, AC_MSKW10) //9:0

#define ADAP_SHARPNESS_00 u4SWReg(0x2160)
    #define ADAP_SHARP_ENABLE Fld(1, 31, AC_MSKB3) //31:31
    #define ADAP_SHARP_LOG    Fld(1, 30, AC_MSKB3) //30:30
    #define ADAP_SHARP_THD_DN Fld(8, 16, AC_FULLB2) //23:16      
    #define ADAP_SHARP_THD_UP Fld(8, 8, AC_FULLB1)  //15:8
    #define ADAP_SHARP_GAIN_DN Fld(8, 0, AC_FULLB0) //7:0
#endif
...
#ifdef CUST_SOEM_DRV
#define PIC_RGB_GAIN u4SWReg(0x2300)
    #define PIC_GAIN_EN Fld(1,31,AC_MSKB3)//[31:31]
    #define PIC_GAIN_EN30 Fld(1,30,AC_MSKB3)//[30:30]
    #define PIC_GAIN_R Fld(10,20,AC_MSKW32)//[29:20]
    #define PIC_GAIN_G Fld(10,10,AC_MSKW21)//[19:10]
    #define PIC_GAIN_B Fld(10,0,AC_MSKW10)//[9:0]
#define PIC_RGB_OFFSET u4SWReg(0x2304)
    #define PIC_OFFSET_R Fld(10,20,AC_MSKW32)//[29:20]
    #define PIC_OFFSET_G Fld(10,10,AC_MSKW21)//[19:10]
    #define PIC_OFFSET_B Fld(10,0,AC_MSKW10)//[9:0]
#endif
...
#define PSCAN_FWFILM_07     u4SWReg(0x304C)
    #define CANDENCE_CONFGIG_50     Fld(16, 0, AC_FULLW10) //15:0
    #define CANDENCE_CONFGIG_60     Fld(16, 16, AC_FULLW32) //31:16  
...
#define PSCAN_FW_ADAPTIVE_IF_03       u4SWReg(0x30DC)
    #define DI_TEXT_MIN                     Fld(8, 0, AC_FULLB0)
    #define DI_TEXT_MAX                     Fld(8, 8, AC_FULLB1)
    #define DI_MIN_COST_MIN                 Fld(8, 16, AC_FULLB2)
    #define DI_MIN_COST_MAX                 Fld(8, 24, AC_FULLB3)

#define PSCAN_FW_ADAPTIVE_IF_04       u4SWReg(0x30E0)
    #define DI_HOMO_MIN                     Fld(8, 0, AC_FULLB0)
    #define DI_HOMO_MAX                     Fld(8, 8, AC_FULLB1)
    #define DI_HETER_MIN                    Fld(8, 16, AC_FULLB2)
    #define DI_HETER_MAX                    Fld(8, 24, AC_FULLB3)

#define PSCAN_FW_ADAPTIVE_IF_05       u4SWReg(0x30E4)
    #define DI_STABLE_CNT_TH                Fld(8, 0, AC_FULLB0)
...
#define SW_TDDC_REG_00          u4SWReg(0x4B00)  
    ...
    #define TDDC_FS_DET_RST         Fld(1, 7, AC_MSKB0)
...
#define MJC_BADEDIT_00      u4SWReg(0x504C)
    #define BADEDIT_ENTER_TH        Fld(8, 24, AC_FULLB3) // 31:24
    #define BADEDIT_EN              Fld(1, 20, AC_MSKB2) // 20
    #define BADEDIT_UNSTABLE_CNT    Fld(4, 16, AC_MSKB2) // 19:16
    #define BADEDIT_EXIT_TH         Fld(16, 0, AC_FULLW10) // 15:0
...
#define MJC_FW_SCH_02               u4SWReg(0x5308)
    ...
    #define MJC_FRM_SCH_FWHW_SWITCH_AUTO_DBG Fld( 1, 4, AC_MSKDW) // [ 4: 4]
...
#define MJC_ZP_00              u4SWReg(0x5414)
    #define MJC_ZP_UPDATE                   Fld( 1, 31, AC_MSKDW) // [31: 31]
    #define MJC_ZP_CNT_TH                   Fld( 8,  0, AC_MSKDW) // [ 7: 0]
...
// ---Main control Part--- 
#ifdef CUST_SOEM_DRV
#define BL_CONTROL_MAIN_00      u4SWReg(0x6000)
    #define FINAL_DIMMER1_OUT       Fld( 8,  24, AC_FULLB3)    //PWM_RATIO     --DIMMER1
    #define IP_REF_DIMMING          Fld( 8,  16, AC_FULLB2)    //CURRENT RATIO --IP_REF
    #define BLINK_GAIN              Fld( 8,   8, AC_FULLB1)    //--BLINK RATIO   --DIMMER2//---BLINK Gain
    #define PARAM_UPDATE_PER_V      Fld( 1,   6, AC_MSKB0) 
    #define BLINK_EN                Fld( 1,   5, AC_MSKB0)
    #define ZEROD_EN                Fld( 1,   4, AC_MSKB0)
    #define DBC_CRI_EN              Fld( 1,   3, AC_MSKB0)
    #define DBC_PS_EN               Fld( 1,   2, AC_MSKB0)
    #define DBC_EN                  Fld( 1,   1, AC_MSKB0)
    #define BL_UPDATE_EN            Fld( 1,   0, AC_MSKB0) 
        
#define BL_CONTROL_MAIN_01   u4SWReg(0x6004)
    #define LUMA_CORRECT         Fld( 8,  24, AC_FULLB3)
    #define PWM_RATIO_BLIM       Fld( 8,  16, AC_FULLB2)
    #define UI_BL_PS_MODE        Fld( 3,   8, AC_MSKB1)
    #define UI_BL_LEVEL          Fld( 8,   0, AC_FULLB0)
        
#define BL_CONTROL_MAIN_02   u4SWReg(0x6008)
    #define BL_PWM_FRQ           Fld( 16,  8, AC_FULLW21)
    #define DIMMER1_OUT          Fld( 8,   0, AC_FULLB0)

#define BL_CONTROL_MAIN_03   u4SWReg(0x600C)
    #define CURRENT_MIN          Fld(13,  16, AC_MSKW32)
    #define CURRENT_MAX          Fld(13,   0, AC_MSKW10)
        
//---SBC Part---
#define SBC_PARAM_00         u4SWReg(0x6010)
    #define SBC_GAIN             Fld( 8,  24, AC_FULLB3)
    #define SBC_BL_PSH           Fld( 8,  16, AC_FULLB2)
#define SBC_PARAM_01         u4SWReg(0x6014)
    #define SBC_BL_TOP           Fld( 8,  24, AC_FULLB3)
    #define SBC_BL_MIDDLE        Fld( 8,  16, AC_FULLB2)
    #define SBC_BL_BOTTOM        Fld( 8,   8, AC_FULLB1)
    #define SBC_BL_SETUDEN       Fld( 8,   0, AC_FULLB0)    
            
//---DBC-MAIN---
#define DBC_PARAM1_MAIN      u4SWReg(0x6018)
    #define DBC_GAIN             Fld( 8,  24, AC_FULLB3)
        
//---DBC Calc Parameter ---
#define DBC_PARAM1_APL_00    u4SWReg(0x601C)
    #define DBC_APL_EN           Fld( 1,  0, AC_MSKB0)
    #define APL_DBC              Fld( 8,  8, AC_FULLB1)
    #define DBC_APL_GAIN         Fld(16, 16, AC_FULLW32)
#define DBC_PARAM1_APL_01    u4SWReg(0x6020)
    #define DBC_APL_TH0          Fld( 8,  0, AC_FULLB0)
    #define DBC_APL_TH1          Fld( 8,  8, AC_FULLB1)
    #define DBC_APL_TGT          Fld( 8, 16, AC_FULLB2)
        
#define DBC_PARAM1_BK_00     u4SWReg(0x6024)
    #define DBC_BK_EN            Fld( 1,  0, AC_MSKB0)
    #define BK_DBC               Fld( 8,  8, AC_FULLB1) 
    #define DBC_BK_GAIN          Fld(16, 16, AC_FULLW32)
#define DBC_PARAM1_BK_01     u4SWReg(0x6028)
    #define DBC_BK_TH0           Fld( 8,  0, AC_FULLB0)
    #define DBC_BK_TH1           Fld( 8,  8, AC_FULLB1)
    #define DBC_BK_TGT           Fld( 8, 16, AC_FULLB2)
    #define DBC_BK_INDEX         Fld( 8, 24, AC_FULLB3)
        
#define DBC_PARAM1_MAX_DET_00    u4SWReg(0x602C)
    #define DBC_MAX_DET_EN           Fld( 1,  0, AC_MSKB0)
    #define MAX_DET_DBC              Fld( 8,  8, AC_FULLB1) 
    #define DBC_MAX_DET_GAIN         Fld(16, 16, AC_FULLW32)
#define DBC_PARAM1_MAX_DET_01    u4SWReg(0x6030)
    #define DBC_MAX_DET_TH0          Fld( 8,  0, AC_FULLB0)
    #define DBC_MAX_DET_TH1          Fld( 8,  8, AC_FULLB1)
    //#define DBC_MAX_DET_TGT          Fld( 8, 16, AC_FULLB2)
        
#define DBC_PARAM1_GFX_00    u4SWReg(0x6034)
    #define DBC_GFX_EN           Fld( 1,  0, AC_MSKB0)
    #define GFX_DBC              Fld( 8,  8, AC_FULLB1)
    #define DBC_GFX_GAIN         Fld( 8, 16, AC_FULLB2)
        
        
//---DBC  IIR Parameter ---
#define DBC_PARAM0_APL_00    u4SWReg(0x6038)
    #define DBCP_APL_IIR_TH1         Fld( 8,  0, AC_FULLB0)
    #define DBCP_APL_IIR_TH2         Fld( 8,  8, AC_FULLB1)
    #define DBCP_APL_IIR_TH3         Fld( 8, 16, AC_FULLB2)
    #define DBCP_APL_IIR_TH4         Fld( 8, 24, AC_FULLB3)
#define DBC_PARAM0_APL_01    u4SWReg(0x603C)
    #define DBCP_APL_IIR_L       Fld( 8,  0, AC_FULLB0)
    #define DBCP_APL_IIR_M       Fld( 8,  8, AC_FULLB1)
    #define DBCP_APL_IIR_H       Fld( 8, 16, AC_FULLB2)
        
#define DBC_PARAM0_BK_00     u4SWReg(0x6040)
    #define DBCP_BK_IIR_TH1          Fld( 8,  0, AC_FULLB0)
    #define DBCP_BK_IIR_TH2          Fld( 8,  8, AC_FULLB1)
    #define DBCP_BK_IIR_TH3          Fld( 8, 16, AC_FULLB2)
    #define DBCP_BK_IIR_TH4          Fld( 8, 24, AC_FULLB3)
#define DBC_PARAM0_BK_01     u4SWReg(0x6044)
    #define DBCP_BK_IIR_L        Fld( 8,  0, AC_FULLB0)
    #define DBCP_BK_IIR_M        Fld( 8,  8, AC_FULLB1)
    #define DBCP_BK_IIR_H        Fld( 8, 16, AC_FULLB2)
        
#define DBC_PARAM0_MAX_DET_00    u4SWReg(0x6048)
    #define DBCP_MAX_DET_IIR_TH1         Fld( 8,  0, AC_FULLB0)
    #define DBCP_MAX_DET_IIR_TH2         Fld( 8,  8, AC_FULLB1)
    #define DBCP_MAX_DET_IIR_TH3         Fld( 8, 16, AC_FULLB2)
    #define DBCP_MAX_DET_IIR_TH4         Fld( 8, 24, AC_FULLB3)
#define DBC_PARAM0_MAX_DET_01    u4SWReg(0x604C)
    #define DBCP_MAX_DET_IIR_L       Fld( 8,  0, AC_FULLB0)
    #define DBCP_MAX_DET_IIR_M       Fld( 8,  8, AC_FULLB1)
    #define DBCP_MAX_DET_IIR_H       Fld( 8, 16, AC_FULLB2)
    #define DBCP_MAX_DET_TH          Fld( 8, 24, AC_FULLB3)
        
#define DBC_PARAM0_GFX_00    u4SWReg(0x6050)
    #define DBCP_GFX_IIR_TH1         Fld( 8,  0, AC_FULLB0)
    #define DBCP_GFX_IIR_TH2         Fld( 8,  8, AC_FULLB1)
    #define DBCP_GFX_IIR_TH3         Fld( 8, 16, AC_FULLB2)
    #define DBCP_GFX_IIR_TH4         Fld( 8, 24, AC_FULLB3)
#define DBC_PARAM0_GFX_01    u4SWReg(0x6054)
    #define DBCP_GFX_IIR_L       Fld( 8,  0, AC_FULLB0)
    #define DBCP_GFX_IIR_M       Fld( 8,  8, AC_FULLB1)
    #define DBCP_GFX_IIR_H       Fld( 8, 16, AC_FULLB2)
    #define DBCP_GFX_TGT         Fld( 8, 24, AC_FULLB3)

//---Power Saving part---        
#define DBC_PS_PARAM_00      u4SWReg(0x6058)
    #define DBC_PS_LUMA_TH_DIG   Fld( 8,  24, AC_FULLB3)
    #define DBC_PS_LUMA_TH_ANA   Fld( 8,  16, AC_FULLB2)
    #define DBC_CRI_LUMA_TH      Fld( 8,   8, AC_FULLB1)
    #define DBC_PS_SAT_TH        Fld( 8,   0, AC_FULLB0)
#define DBC_PS_PARAM_01      u4SWReg(0x605C)   
    #define DBC_PS_TGT           Fld(16,  16, AC_FULLW32)
    #define DBC_PS_TM_ENTER      Fld( 8,   8, AC_FULLB1)
    #define DBC_PS_TM_EXIT       Fld( 8,   0, AC_FULLB0)
#define DBC_PS_PARAM_02      u4SWReg(0x6060)       
    #define DBC_PS_ATN_DOWN      Fld( 8,  24, AC_FULLB3)
    #define DBC_PS_ATN_UP        Fld( 8,  16, AC_FULLB2)   
    #define DBC_PS_OPERATE       Fld( 1,  2, AC_MSKB0)
    #define DBC_PS_PIC_STATE     Fld( 1,  1, AC_MSKB0)
    #define DBC_PS_IN_STATE      Fld( 1,  0, AC_MSKB0)
        
//---Zero-D Part        
#define ZEROD_DIMMING_PARAM     u4SWReg(0x6064)
    #define ZEROD_HEAT_BLSAVE       Fld( 8,  24, AC_FULLB3)
            
//---BLINK Part---
#define BLINK_PARAM          u4SWReg(0x6068)
    #define BLINK_GAIN_TGT       Fld( 8,  24, AC_FULLB3)
    #define BLINK_PHASE          Fld( 8,  16, AC_FULLB2)
    #define BLINK_DUTY           Fld( 8,   8, AC_FULLB1)
    #define LEDMOTION_MODE       Fld( 1,   0, AC_MSKB0)

#define BLINK_DEBUG         u4SWReg(0x606C)
    #define BLINK_DEBUG_PHASE    Fld( 8,  24, AC_FULLB3)
    #define BLINK_DEBUG_DUTY     Fld( 8,  16, AC_FULLB2)
    #define BLINK_DEBUG_Mutiple  Fld( 8,   8, AC_FULLB1)
    #define BLINK_DEBUG_ONOFF    Fld( 1,   1, AC_MSKB0)
    #define BLINK_DEBUG_EN       Fld( 1,   0, AC_MSKB0)

#define DBC_MISC_00         u4SWReg(0x6070)
    #define M_sbcGain           Fld( 11,   0, AC_MSKW10)  //[10:0]
    #define M_currentGain       Fld( 11,  11, AC_MSKW21)   //[21:11]
#define DBC_MISC_01         u4SWReg(0x6074)
    #define M_CURRENT_GAIN      Fld( 11,   0, AC_MSKW10)  //[10:0]
    #define M_PWM_RATIO2       Fld( 11,  11, AC_MSKW21)   //[21:11]
#define DBC_MISC_02         u4SWReg(0x6078)
    #define M_BL_DBC            Fld( 11,   0, AC_MSKW10)  //[10:0]
    #define M_DBC_GAIN_TOTAL    Fld( 11,  11, AC_MSKW21)   //[21:11]
#define DBC_MISC_03         u4SWReg(0x607C)
    #define M_PWM_RATIO1        Fld( 11,   0, AC_MSKW10)  //[10:0]
    #define M_PWM_RATIO_SUB     Fld( 11,  11, AC_MSKW21)   //[21:11]
#define DBC_MISC_04         u4SWReg(0x6080)
    #define M_PWM_RATIO         Fld( 11,   0, AC_MSKW10)  //[10:0]
#define DBC_MISC_05         u4SWReg(0x6084)
    #define M_BL_POWER_LIMIT_GAIN      Fld( 11,   0, AC_MSKW10)  //[10:0]
    #define M_sbcPowerGain             Fld( 11,  11, AC_MSKW21)   //[21:11]
    

//---EEI Part---
#define EEI_PARAM_00         u4SWReg(0x6090)
    #define DBC_EEI_INCREASE     Fld(8, 24, AC_FULLB3)
    #define DBC_EEI_STEP         Fld(8, 16, AC_FULLB2)
    #define DBC_EEI_ON           Fld(1,  0, AC_MSKB0)

#define EEI_PARAM_01         u4SWReg(0x6094)
    #define DBC_EEI_DARK_TH      Fld(16, 16, AC_FULLW32)
    #define DBC_EEI_WHITE_TH     Fld(16,  0, AC_FULLW10)

#define EEI_PARAM_02         u4SWReg(0x6098)
    #define DBC_EEI_DARK_Count   Fld(16, 16, AC_FULLW32)
    #define DBC_EEI_WHITE_Count  Fld(16,  0, AC_FULLW10)  
...
#define DBC_00 u4SWReg(0x6000)
    ...
    #define DBC_BL_MIDDLE Fld(8,8,AC_FULLB1)
...
#define DBC_16 u4SWReg(0x6058)
	...
	#define DBC_PS_CHR_TH Fld(8, 8, AC_FULLB1)
...
#define DBC_19 u4SWReg(0x6064)
    #define DBC_LUMA_MAX_TH Fld(10,0,AC_MSKW10)
#endif
...
#ifdef CUST_SOEM_DRV
#define NR_PATCH_RF  u4SWReg(0x7920)	//Masoem, for weak RF signal
    #define NR_PATCH1_RF_EN      Fld(1,31,AC_MSKB3)
    #define NR_PATCH2_RF_EN      Fld(1,30,AC_MSKB3)
    #define NR_PATCH_RF_LOG      Fld(1,29,AC_MSKB3)
    #define NR_PATCH_RF_THD_EN   Fld(1,28,AC_MSKB3)
    #define NR_PATCH_RF_RATION   Fld(10,16,AC_MSKW32) //25:16
    #define NR_PATCH_RF_THD      Fld(16,0,AC_MSKW10)//[15:0]

#define NR_PATCH_AV  u4SWReg(0x7924)	//Masoem, for AV 
    #define NR_PATCH1_AV_EN      Fld(1,31,AC_MSKB3)
    #define NR_PATCH2_AV_EN      Fld(1,30,AC_MSKB3)
    #define NR_PATCH_AV_LOG      Fld(1,29,AC_MSKB3)
    #define NR_PATCH_AV_THD_EN   Fld(1,28,AC_MSKB3)
    
#define NR_PATCH_HDMI  u4SWReg(0x7928)	//Masoem, for HDMI
    #define NR_PATCH1_HDMI_EN      Fld(1,31,AC_MSKB3)
    #define NR_PATCH2_HDMI_EN      Fld(1,30,AC_MSKB3)
    #define NR_PATCH_HDMI_LOG      Fld(1,29,AC_MSKB3)

#define NR_PATCH_00  u4SWReg(0x7930)
	#define NR_PIXELRATIO_TH Fld(8, 0, AC_FULLB0)
	#define NR_ACSTRENGTH_ADJ1 Fld(8, 8, AC_FULLB1)
	#define NR_ACSTRENGTH_ADJ2 Fld(8, 16, AC_FULLB2)
	#define NR_PATCH_00_DEBUG_EN     Fld(1,31,AC_MSKB3)
	#define NR_PATCH_00_DISABLE     Fld(1,30,AC_MSKB3)

#define NR_PATCH_01  u4SWReg(0x7934)
	#define NR_APL_TH Fld(8, 0, AC_FULLB0)
	#define NR_ASL_TH Fld(8, 8, AC_FULLB0)

#define NR_PATCH_02  u4SWReg(0x7938)
	#define NR_FRAME_MOTION_HIGHTH  Fld(32,0,AC_FULLDW)

#define NR_PATCH_03  u4SWReg(0x793C)
	#define NR_FRAME_MOTION_LOWHTH  Fld(32,0,AC_FULLDW)

#define NR_PATCH_04  u4SWReg(0x7940)
	#define NR_HUE_6_TH	Fld(16,0,AC_MSKDW)
	#define NR_HUE_7_TH Fld(16,16,AC_MSKDW)

#define NR_PATCH_05  u4SWReg(0x7944)
	#define NR_SAT_TH   Fld(16,0,AC_MSKDW)
#endif
//=============================================================
// Addr : 0x7A00 - 0x7AFF
...
#define NR_BLK_STA_13 u4SWReg(0x9F4C)
    #define NR_STA_VBLK_BEST_PCT Fld(16,0,AC_MSKDW)//[15:0]
//=============================================================
// Addr : 0xA000 - 0xAFFF
...
#define VDP_SCPQ_02 u4SWReg(0xA840)
    #define SCPQ_CUST_VC_FILTER_ID Fld(8,16,AC_MSKDW)//[23:16]	
    #define SCPQ_CUST_VY_FILTER_ID Fld(8,8,AC_MSKDW)//[15:8]	
    #define SCPQ_CUST_SHARP_UI Fld(8,0,AC_MSKDW)//[7:0]	
//=============================================================
// Addr : 0xB000 - 0xBFFF
// Name : Demo Mode
//=============================================================
