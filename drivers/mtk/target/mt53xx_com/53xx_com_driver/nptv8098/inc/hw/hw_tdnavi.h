...
#define TDNVAI_01 (IO_PRE_PROC_BASE + 0x404)
    ...
    #define VALID_BLK_THR Fld(7,1,AC_MSKB0)//[7:0]

    #define TDNVAI_FPGA_01_READ_EN Fld(1,0,AC_MSKB0)//[1:0]    
    #define TDNVAI_FPGA_01_READ_POS Fld(9,7,AC_MSKW10)//[15:7]    
...
#define TDNVAI_0A (IO_PRE_PROC_BASE + 0x428)
    ...
    #define TD_NAVI_INK Fld(3,0,AC_MSKB0)//[2:0]
...
#define TDNVAI_FPGA_01 (IO_PRE_PROC_BASE + 0x404)

#define TDNVAI_FPGA_02 (IO_PRE_PROC_BASE + 0x444)  
    #define TDNVAI_FPGA_02_BLK_PIXEL_DIFF Fld(8,8,AC_FULLB0)//[7:0]
    #define TDNVAI_FPGA_02_BLK_Y Fld(8,0,AC_FULLB1)//[15:8]
