...
#define HSHARP_0C (IO_SCALER_BASE + 0x630)
	...
	#define BND_EXT_END Fld(1,11,AC_MSKB1)//[11:11]
...
#define SCFIR_09 (IO_SCALER_BASE + 0x524)
    #define DE_RING_EN_V Fld(1,31,AC_MSKB3)//[31:31]
    #define DE_RING_SEL_V Fld(2,28,AC_MSKB3)//[29:28]
...
#define SCFIR_0A (IO_SCALER_BASE + 0x528)
    #define DE_RING_EN_H_YUV Fld(1,31,AC_MSKB3)//[31:31]
    #define DE_RING_SEL_H_YUV Fld(2,28,AC_MSKB3)//[29:28]
...
#define SCFIR_0F (IO_SCALER_BASE + 0x53C)
    #define ADAPT_THR_H Fld(4,28,AC_MSKB3)//[31:28]
    ...
    #define ADAPT_BACK_RATIO_H Fld(7,1,AC_MSKB0)//[7:1]
    #define ADAPT_DERING_H Fld(1,0,AC_MSKB0)//[0:0]
#define SCFIR_10 (IO_SCALER_BASE + 0x540)
    #define ADAPT_THR_V Fld(4,28,AC_MSKB3)//[31:28]
    ...
    #define ADAPT_BACK_RATIO_V Fld(7,1,AC_MSKB0)//[7:1]
    #define ADAPT_DERING_V Fld(1,0,AC_MSKB0)//[0:0]
#define SCFIR_11 (IO_SCALER_BASE + 0x544)
    #define ADAPT_EN_H Fld(1,31,AC_MSKB3)//[31:31]
    #define ADAPT_EN_V Fld(1,30,AC_MSKB3)//[30:30]
    #define ADAPT_INK_SEL Fld(4,24,AC_MSKB3)//[27:24]
    #define ADAPT_VERT_RATIO_0 Fld(4,20,AC_MSKB2)//[23:20]
    #define ADAPT_VERT_RATIO_1 Fld(4,16,AC_MSKB2)//[19:16]
#define SCFIR_ATPG (IO_SCALER_BASE + 0x5FC)
    #define SCFIR_ATPG_OB Fld(1,1,AC_MSKB0)//[1:1]
    #define SCFIR_ATPG_CT Fld(1,0,AC_MSKB0)//[0:0]
