...
#define SWRW_08 (0xF00235A0)
    #define SPI_LIGHT_UP Fld(1,0,AC_MSKB0)//[0:0]

#define LD2_MODE_DS (0xF005D800)
    #define LD_DS Fld(3,26,AC_MSKB3)//[28:26]
...
#define LDM_AS382X_GPIO_CTRL      0x04    // AS3820 page 17
#define LDM_AS382X_FB_SEL_1       0x05
#define LDM_AS382X_FB_SEL_2       0x06
#define LDM_AS382X_CUR_CTRL      0x07
#define LDM_AS382X_SHORTLED_1    0x08   // SHORTLED_1                                                        see page 17
#define LDM_AS382X_SHORTLED_2    0x09   // SHORTLED_2                                                        see page 17
#define LDM_AS382X_OPENLED_1     0x0A   // OPENLED_1                                                        see page 17
#define LDM_AS382X_OPENLED_2     0x0B   // OPENLED_2                                                        see page 17
...
#define LDM_AS382X_STATUS         0x60    // STATUS                                                see page 18
#define LDM_AS382X_BIST_CTRL2     0x65    // Controls the short detection voldate based on ext 100k resistor. see page 13 //Need MTK to integrate.
    enum _LDM_AS382X_COMP_LEVEL
    {
        LDM_AS382X_COMP_LEVEL_2V   = 0x00,
        LDM_AS382X_COMP_LEVEL_3V,
        LDM_AS382X_COMP_LEVEL_4V,
        LDM_AS382X_COMP_LEVEL_5V,
        LDM_AS382X_COMP_LEVEL_6V,
        LDM_AS382X_COMP_LEVEL_7V,
        LDM_AS382X_COMP_LEVEL_8V,
        LDM_AS382X_COMP_LEVEL_9V,
        LDM_AS382X_COMP_LEVEL_10V,
        LDM_AS382X_COMP_LEVEL_11V,
        LDM_AS382X_COMP_LEVEL_12V
    };
#define LDM_AS382X_COMP_AUTOOFF_ENABLE 0x10                                                  see page 19

#define LDM_AS382X_WRITE_IDX      0x0
#define LDM_AS382X_READ_IDX       0x1
#define LDM_AS382X_SINGLE_DEV     0x0
#define LDM_AS382X_MULTI_DEV      0x1
...
#define LDM_AS382X_BCAST_SAME   0x00
#define LDM_AS382X_BCAST_DIFF   0x3F
...
#define LDM_LP1087_PWM_PERIOD_LSB 0x1E
#define LDM_LP1087_PWM_HTIME1     0x20
#define LDM_LP1087_DELAY1         0x40
...
/* LePower 1887 Registers */
#define LDM_LP1887_PWM_MODE       0x03
#define LDM_LP1887_PLL_MODE       0x05
#define LDM_LP1887_PWM_PERIOD_LSB 0x1E
#define LDM_LP1887_PWM_PERIOD_MSB 0x1F
#define LDM_LP1887_PWM_HTIME1     0x20
#define LDM_LP1887_DELAY1         0x40
#define LDM_LP1887_TRIMMING       0x74

#define LDM_LP1887_WRITE_IDX      0x0
#define LDM_LP1887_READ_IDX       0x1
#define LDM_LP1887_SINGLE_DEV     0x0
#define LDM_LP1887_MULTI_DEV      0x1
#define LDM_LP1887_MULTI_BYTE     0x0
#define LDM_LP1887_SINGLE_BYTE    0x1

/* LePower 1887 Device IDs*/
#define LDM_LP1887_ADDR1        0x01
#define LDM_LP1887_BCAST_SAME   0x00
#define LDM_LP1887_BCAST_DIFF   0x3F
