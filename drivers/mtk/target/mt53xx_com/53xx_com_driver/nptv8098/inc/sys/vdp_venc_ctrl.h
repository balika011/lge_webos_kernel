...
typedef enum
{
    E_VDP_VENC_OSTG     = 0,                   ///< encode output stage
    E_VDP_VENC_OSTG_OSD    ,                   ///< encode output stage + OSD
    E_VDP_VENC_SUB_AFTER_DI,                   ///< encode input from sub path after DI
    E_VDP_VENC_SUB_BEFORE_DI,                  ///< encode input from sub path Before DI
