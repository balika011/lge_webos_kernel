...
#if defined(CC_MT5881)||defined(CC_MT5882)
#if defined(CC_MVC_SUPPORT)
extern BOOL _VDEC_ISH264_MVC(void);
#endif
static UINT32 _SrmScposRule5881_64Mx1(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
    UINT32 u4Mode = 0;
             ...
             (SRM_GetMmMode() != SRM_MM_MODE_TYPE_THUMBNAIL))
    {
           ...
           )
        {
            ...
            {//fbm size limited for video path ,so the width of HD timing need to predown
                u4PDSize =720;
            }
        }
        ...
        else
        {
            ...
            #else			
            #if defined(CC_64Mx1_WITHSUB_OVERSET)
			if((prSrmVdpInfo[VDP_1].u4Source == (UINT32)VSS_DTV) && 
                    (prSrmVdpInfo[VDP_1].u4Resolution > SRM_VDP_720HD_RESOLUTION)
...
static UINT32 _SrmScposRule5881_128Mx1(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
    UINT32 u4Mode = 0;
    UINT32 u4CtrlMode = SRM_CTRL_MODE_NONE;
    UINT32 u4ScalerModeEx=0;
             ...
             (SRM_GetMmMode() != SRM_MM_MODE_TYPE_THUMBNAIL))
    {
		...
		#if defined(CC_HD_PQ_DOWNGRADE_TO_SAVE_BW)
		else if((prSrmVdpInfo[VDP_1].u4Resolution >= SRM_VDP_720HD_RESOLUTION)
			&&(prSrmVdpInfo[VDP_1].u4Source== VSS_DTV))
		{
			u4Mode |= FBM_POOL_MODE_8BIT;
		}
		#endif
		#if defined(CC_MVC_SUPPORT)
		else if(_VDEC_ISH264_MVC()&&(prSrmVdpInfo[VDP_1].u4Source== VSS_DTV)
			&&(prSrmVdpInfo[VDP_1].u4Resolution > SRM_VDP_720HD_RESOLUTION))
        {
            u4Mode |= FBM_POOL_MODE_8BIT;
		}
...
static UINT32 _SrmScposRule5399_DDRXx2(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
    UINT32 u4Mode = 0;
    UINT32 u4CtrlMode = SRM_CTRL_MODE_NONE;
    UINT32 u4PDSize = PANEL_GetPanelWidth();
...
#if defined(CC_MT5881)||defined(CC_MT5882)
static UINT32 _SrmMddiRule5881_64Mx1(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
    UINT32 u4Mode = 0;
    UINT32 u4CtrlMode = SRM_CTRL_MODE_NONE;
...
static UINT32 _SrmMddiRule5881_128Mx1(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
    UINT32 u4Mode = 0;
    UINT32 u4CtrlMode = SRM_CTRL_MODE_NONE;
    UINT32 u4PscanModeEx=0;
...
#if defined(CC_MT5399)||defined(CC_MT5890)
static UINT32 _SrmMddiRule5399_DDRXx2(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
    UINT32 u4Mode = 0;
    UINT32 u4PscanModeEx=0;
...
static UINT32 _SrmMJCRule5395(SRM_VDP_INFO_T* prSrmVdpInfo, SRM_VDP_CRTL_T* prSrmVdpCtrl)
{
	...
	//force configure y8c8-422 repeat mode  if output 4K2K, and ignore any other conditions [Mustang]
                  ...
                  FN_SRN_DB_RULE **papfNotStableRule, UINT32 *pu4NotStableRuleNs)
{
    ...
    {
        UINT8 idx = 0;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmScposRule5399_DDRXx2;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmMddiRule5399_DDRXx2;
    ...
    {
        UINT8 idx = 0;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmScposRule5881_128Mx1;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmMddiRule5881_128Mx1;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmStableRule;
        *pu4StableRuleNs = idx;
    }
    ...
    {
        UINT8 idx = 0;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmScposRule5881_64Mx1;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmMddiRule5881_64Mx1;
        papfStableRule[idx++] = (FN_SRN_DB_RULE*)_SrmStableRule;
        *pu4StableRuleNs = idx;
    }
#endif
