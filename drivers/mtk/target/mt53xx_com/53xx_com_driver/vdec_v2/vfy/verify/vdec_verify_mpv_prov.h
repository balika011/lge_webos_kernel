...
extern UCHAR *_pucDPB[4];

//for still image
extern UCHAR *_pucVLDPredBuf[4];
extern UCHAR *_pucVLDIPBuf[4];
extern UCHAR *_pucVLDVBuf[4];
extern UCHAR *_pucPPSAOBuf[4];
extern UCHAR *_pucPPDBKBuf[4];
extern UCHAR *_pucYConvertBuf[4];
extern UCHAR *_pucUConvertBuf[4];
extern UCHAR *_pucVConvertBuf[4];

extern UCHAR *_pucPredSa[2];
extern UCHAR *_pucDumpYBuf[4];
extern UCHAR *_pucDumpCBuf[4];
extern UCHAR *_pucDecWorkBuf[4];
extern UCHAR *_pucDecCWorkBuf[4];
...
extern HANDLE_T _ahvMpeg2DualCoreSema;
...
extern UCHAR *_pucRMIntraTableBuf[2];
extern UCHAR *_pucRMInterTableBuf[2];
...
extern UCHAR *_pucBSCABACBuff[2];
extern UCHAR *_pucECInfoBuff[2];
...
//	#endif
extern HANDLE_T hVdecOpenFileSem;
extern HANDLE_T hVdecDecDone[2];
extern HANDLE_T hVdecSramCtr[2];
...
extern VDEC_INFO_VERIFY_MAP_UNMAP_INFO_T _tBufPVAddrInfo[2];

extern VDEC_INFO_VERIFY_DEC_T _tVerDec[2];
extern VDEC_INFO_VERIFY_PIC_T _tVerPic[2];
extern VDEC_INFO_H264_FBUF_INFO_T _ptFBufInfo[4][17];
extern VDEC_INFO_H264_FBUF_INFO_T *_ptCurrFBufInfo[4];
extern VDEC_INFO_H264_REF_PIC_LIST_T _ptRefPicList[4][6]; // 0:P0, 1:B0, 2:B1, 3:Temp for Fields

extern UINT32 _u4VerBitCount[2];
extern UINT32 _u4K2KMode[2];
extern UINT32 _u4LaeMode[2];
extern UINT32 _u4DualCoreEnable[2];
extern UINT32 _u4Main10Mode;
extern UINT32 _u4UFOMode;
extern UINT32 _u4CRCMode;
extern UINT32 _u4PicInfo[600];
extern UINT32 _u4PicRdtpr[2];

extern BOOL _fgFirstInit;
extern UINT32 _u4FileScanned;
extern BOOL _fgWaitSub;

extern UCHAR _u4NalRefIdc[4];
extern UCHAR _ucNalUnitType[4];

#if (PROFILE_TIME_TEST && CONFIG_DRV_VERIFY_SUPPORT)
extern HAL_TIME_T rTimeStartDec[2];
extern HAL_TIME_T rTimeEndDec[2];
extern HAL_TIME_T rTimeDecDuration[2];
extern UINT32 u8VdecFrameTypeDuration[3];//0: IDR/I frame; 1: P; 2: B
extern UINT32 u8VdecFrameTypeCount[3];
#endif

extern UCHAR _u4NuhLayerId[4];
extern UCHAR _u4NuhTemporalId[4];
...
#endif
// H265 Struct
extern VDEC_INFO_H265_FBUF_INFO_T _ptH265FBufInfo[4][25];
extern VDEC_INFO_H265_FBUF_INFO_T _ptH265FBufInfoTmp[4][25]; // for FBM AddressReset

extern VDEC_INFO_H265_FBUF_INFO_T *_ptH265CurrFBufInfo[4];
extern VDEC_INFO_H265_REF_PIC_LIST_T _ptH265RefPicList[4];
extern H265_SPS_Data _rH265SPS[4][32];
extern H265_PPS_Data _rH265PPS[4][256];
extern H265_Slice_Hdr_Data _rH265SliceHdr[4];
extern H265_SEI_Data _rH265SEI[4];
extern VDEC_INFO_H265_PIC_INFO_T _rH265PicInfo[4];
extern INT32 *_rPPSScalingListDeltaCoef[4][MAX_H265_PPS_THD][SCALING_LIST_SIZE_NUM][SCALING_LIST_NUM];
extern INT32 *_rSPSScalingListDeltaCoef[4][MAX_H265_SPS_THD][SCALING_LIST_SIZE_NUM][SCALING_LIST_NUM];
// H265 Struct


// H264 Struct
extern VDEC_INFO_H264_SPS_T _rH264SPS[4][32];
extern VDEC_INFO_H264_PPS_T _rH264PPS[4][256];
extern VDEC_INFO_H264_SLICE_HDR_T _rH264SliceHdr[4];
extern VDEC_INFO_H264_SEI_T _rSEI[4];
extern VDEC_INFO_H264_FGT_PRM_T _rFGTPrm[2];
#if defined(MVC_VFY_SUPPORT) 
extern VDEC_INFO_H264_FBUF_INFO_T _rH264PrevFbInfo[2];
#endif
extern VDEC_INFO_H264_P_REF_PRM_T _arPRefPicListInfo[4];
extern VDEC_INFO_H264_B_REF_PRM_T _arBRefPicListInfo[4];
extern UCHAR ucCurrStatus;
// H264 Struct
...
// Common Struct
extern VDEC_INFO_DEC_PRM_T _tVerMpvDecPrm[4]; 
extern VDEC_INFO_VERIFY_DEC_T _tVerDec[2]; 
extern VDEC_INFO_VERIFY_PIC_T _tVerPic[2];
...
extern UINT8  *_pu1VP8VDecYLstPhy;
...
//VP9 Struct
extern VP9_COMMON_T _rVdecVp9Common[2];
extern UCHAR* _pucSegId[2][2];
extern UCHAR *_pucLAEBuffer[2][2];    //for core0, 1
extern UCHAR *_pucErrBuffer[2][2];    //for core0, 1
extern UCHAR *_pucVP9CRCYBuf0[2]; // multi-core 0
extern UCHAR *_pucVP9CRCCBuf0[2]; // multi-core 0
extern UCHAR *_pucVP9CRCYBuf1[2]; // multi-core 1
extern UCHAR *_pucVP9CRCCBuf1[2]; // multi-core 1
//~VP9
...
extern UINT32 _u4AvsResetHWCnt[2];
extern UINT32 _u4AvsTriggerCnt[2];
extern UINT32 _u4AvsPicCnt[2];
extern UINT32 _u4AvsVldPtrBeforeTrig[2];
extern BOOL fgAVSCRCLoaded[2];
//~AVS


extern volatile BOOL _fgVDecComplete[2];
extern volatile BOOL _fgLaeComplete[2];
extern volatile BOOL _fgVDecErr[2];

extern UINT32 u4BitstreamLoaded[2];  // xiaolei adds this for sim-dump control for 5399 verify
...
extern UINT32 _u4LaeDecCnt[2];
//extern UINT32 _u4VDecID;
extern UINT32 _u4BSID[4];
...
extern char _bTempStr1[4][300];

extern volatile UINT32 _u4CurrPicStartAddr[2];
extern volatile UINT32 _u4PrevPtr[2];
extern volatile UINT32 _u4LAEParseStartAddr[2];
extern volatile UINT32 _u4AUParseStartAddr[2];
...
extern UINT32 _u4Bitstream_Num[2];
...
extern char _Rm_intra_rom_table_list[2][100];
extern char _Rm_inter_rom_table_list[2][100];
#endif
#endif
