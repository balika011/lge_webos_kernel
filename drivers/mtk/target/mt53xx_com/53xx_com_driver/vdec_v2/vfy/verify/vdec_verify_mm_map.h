...
#define Y_CONVERT_SZ    0x200000
#define UV_CONVERT_SZ   0x100000
...
#define VDEC_VP8_WEBP_SUPPORT 0     

#if 0//VDEC_VP8_WEBP_SUPPORT
#define GOLD_Y_SZ  0x1A00000//(4096*4096)
#define GOLD_C_SZ  0xD00000 //(4096*4096)/2  //1920x1080
#elif HEVC_CRC_COMPARE
#define GOLD_Y_SZ  0x7D000  // 500k
#define GOLD_C_SZ  0x7D000  // 500k
#elif VDEC_4K2K
#define GOLD_Y_SZ  0xB00000   // 4096 x 2176 * 1.25 (for 10 bit compact mode)
#define GOLD_C_SZ  0x580000   // Y_SZ >> 1
//#define GOLD_Y_SZ  0x800000   // 4096 x 2176 8bit
//#define GOLD_C_SZ  0x400000   // Y_SZ >> 1
#else
#define GOLD_Y_SZ  PIC_Y_SZ
#define GOLD_C_SZ  PIC_C_SZ
#endif

#define GOLD_Y_SZ  4096*2560
#define GOLD_C_SZ  4096*1280

#define GOLD_Y_SZ_CRC  0x7D000  // 500k
#define GOLD_C_SZ_CRC  0x7D000  // 500k
...
#define V_PRED_SA V_FIFO_SA + VLD_PRED_SZ

#define SEG_ID_SZ 256*1024
#define SEG_I_SA V_FIFO_SA + SEG_ID_SZ

#define PP_WRAPY_SZ 64*1024
#define PP_WRAPY_SA SEG_I_SA + PP_WRAPY_SZ 

#define PP_WRAPC_SZ 64*1024
#define PP_WRAPC_SA PP_WRAPY_SA + PP_WRAPC_SZ  

#define WEBP_RESZ_TMP_SIZE 16384*8
#endif
#if  1
#if VDEC_VP8_WEBP_SUPPORT
#define V_FIFO_SZ 0x0800000
#else
//#define V_FIFO_SZ  0xA000000 //0x78a0000 for all avc/mvc
//#define V_FIFO_SZ  0x1000000 //0x78a0000 for all avc/mvc
#define V_FIFO_SZ  0x2000000 //70M, semihosting
#endif
#else
...
#else
#define DPB_SA    V_FIFO_SA + V_FIFO_SZ       // 0xCCCFE000
#endif

#if 0//VDEC_MVC_SUPPORT
#define DPB_SZ    0x01C00000 //(12288*1024)
#else
//#define DPB_SZ    0x3000000//0x01C00000 // 0x01C00000 for all avc/mvc

// try to squeeze more..
//	#if HEVC_CRC_COMPARE
//	#define DPB_SZ    0x7D00000  //125 MB, only with crc..
//	#else
#define DPB_SZ    0x7000000  //105 MB
//	#endif

//for still image
#define PRED_SZ 50664//16888x3
#define IP_SZ   50664
#define VBUF_SZ 50664
#define SAO_SZ  69632//4352x16
#define DBK_SZ  294912//18432x16

//#define DPB_SZ    0x02C00000
#define MVBUF_SZ	0x300000//4096*2048*2 + 4096*2048/4 //4096*1088*2 + 4096*1088/4
#define CABAC_SZ    0x200000
#define EC_SZ       0x100000
#define H265CRCSIZE 	102400 
#endif

#define FILE_LIST_SA DPB_SA + DPB_SZ        // 0xCDEFE000
#define FILE_LIST_SZ 200*1024
...
#define ADDSWAP_BUF_SZ (PIC_Y_SZ+PIC_C_SZ) //0x3FC000  //1920x1080x2
...
#define RM_INTRA_TABLE_DATA_SZ 44 * 1024  //Intra table data size 43840 bytes
#define RM_INTER_TABLE_DATA_SZ 31 * 1024  //Inter table data size 30912 bytes
...
#else
#define PIC_Y_SZ          (3840*2160) *2
#define PIC_C_SZ          (3840*2160 / 2) *2 
#endif
...
// WMV PP Work Bufer
#define DEC_PP_SZ         0x40000 //((2048/16)*9*8)*2
...
// ~WMV PP Work Bufer
#define DEC_PP_Y_SZ      0x400000 //(2048*1088) *2
#define DEC_PP_C_SZ      0x200000 //(2048*1088/2) *2
...
#endif
#else  // mpeg4_new_mode
#define DCAC_SZ                     (6*(4096/16)*128/8)  //unit:byte  this is for no bypass wrapper//((((4096 / 16) * 8) * (4)) * 4):this is for bypass wrapper
#define VER_MVEC_SA           (MP4_DCAC_SA + DCAC_SZ)
#define VER_MVEC_SZ           ((4096 / 16) * (2304 / 16)*128/8) //unit:byte //(((4096 / 16) * 4 * (2048 / 16)) * 4) // (MBx * 4) * (MBy) = 6480
#define VER_BMB1_SA           (VER_MVEC_SA + VER_MVEC_SZ)
#define VER_BMB1_SZ           ((4096 / 16) * (2304 / 16)*128/8) //(((4096 / 16) * 8 * (2048 / 16)) * 4)
#define VER_BMB2_SA           (VER_BMB1_SA + VER_BMB1_SZ)
#define VER_BMB2_SZ           ((4096 / 16) * (2304 / 16)*128/8) //(((4096 / 16) * 4 * (2048 / 16)) * 4) // (MBx * 4) * (MBy) = 6480
#define BCODE_SA              (VER_BMB2_SA + VER_BMB2_SZ)
#define BCODE_SZ              (((((4096 / 16) * (2304 / 16)+128)>>7)<<7)/8) //unit:byte //(((2048 / 16) * 8) * 4) // (MBx * 2) = 90
#endif

#define MEM_CHANNEL_A   0
#define MEM_CHANNEL_B   1
#define MEM_128M                (128*1024*1024)
#define MEM_256M                (256*1024*1024)
#define MEM_512M                (512*1024*1024)
...
extern  void HalFlushInvalidateDCache();
