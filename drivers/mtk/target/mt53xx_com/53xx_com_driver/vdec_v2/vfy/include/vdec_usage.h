...
#endif
#if DRV_CROSSFADE_SUPPORT
    VDEC_EVENT_CROSSFADE_WAIT_FB = 1 << 20,
    VDEC_EVENT_CROSSFADE_WAIT_DONE = 1 << 21,
#endif
    VDEC_EVENT_MAX               = 0xff,
} VDEC_EVENT_T;
...
typedef struct _VDEC_PIC_INFO_T
{
    ...
    UINT64 u8PTXStartTime;                //Parser Start PTX Time
    UINT64 u8PsrCreateAUTime;         //Parser Create AU Time
    UINT64 u8VdecStartParsTime;       //Vdec Start Parsing Time
...
typedef struct _VDEC_NORM_INFO_T
{
    ...
    VID_DEC_SCAN_TYPE_T u4ScanType;
    #endif // CONFIG_TV_DRV_VFY
...
extern BOOL fgIsVDecCmdExisted(UCHAR ucEsId, UINT16 *pu2Count);
