...
typedef struct _VDEC_INFO_AVS_PIC_HDR_T_	
{
    ...
    BOOL  fgIsIPic;
    BOOL  fgSecField;
    UINT32 u4WeightingQuantFlag;
    UINT32 u4MbAdaptWeightingQuantDisable;
    UINT32 u4ChromaQuantParamDisable;
    UINT32 u4ChromaQuantParamDeltaCb;
    UINT32 u4ChromaQuantParamDeltaCr;
    UINT32 u4WeightingQuantParamIndex;
    UINT32 u4WeightingQuantModel;
    UINT32 u4WeightingQuantParamDelta1[6];
    UINT32 u4WeightingQuantParamDelta2[6];
    UINT32 u4AceEnable;
