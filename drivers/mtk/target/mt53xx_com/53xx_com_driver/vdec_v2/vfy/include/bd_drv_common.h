...
*
*/
#if ! defined(BD_DRV_COMMON_H)
#define BD_DRV_COMMON_H
...
#define DRV_VP6A_SUPPORT 1

// For FLV media use sorenson H263 codec @2009/06/26
#if CONFIG_DRV_SUPPORT_SORENSON_H263
...
#define CONFIG_DRV_SUPPORT_SKYPE (1)
...
#define DRV_VDP_3D_RACING 1
#else
#define DRV_VDP_3D_RACING 0
#endif
...
#if !(CONFIG_SYS_MEM_PHASE3 || CONFIG_DRV_3D_384_SUPPORT || CONFIG_DRV_DRAM256_PLUS_NEWFEATURE || CONFIG_DRV_VERIFY_SUPPORT)
...
#if CONFIG_DRAM256_MODEL
#if CONFIG_DRV_3D_256_SUPPORT && CONFIG_DRV_3D_384_SUPPORT
#define DRV_BKIMG_FRMBUF_OVERLAP    /* 3D256 */
#elif CONFIG_DRV_3D_384_SUPPORT
#undef DRV_BKIMG_FRMBUF_OVERLAP     /* 3D384 */
#else
#define DRV_BKIMG_FRMBUF_OVERLAP    /* 2D256 */
#endif
#endif
...
#define DRV_CROSSFADE_SUPPORT  0
#else
#define DRV_CROSSFADE_SUPPORT  0
#endif
...
#define fgIsRefType(arg)  ((arg & REF_PIC) || \
                                       (fgIsPType(arg)) || \
                                       (fgIsIType(arg)))
#define fgIsNonRefPType(arg) ((!(arg & REF_PIC)) && (fgIsPType(arg)))
#define fgIsH264RefType(arg)  ((arg & REF_PIC)>0)
...
#define fgIsH264FileDataGopEntry(arg)  (fgIsH264FileDataIType(arg))
...
typedef enum {
    ASP_UNKNOW = 0,    // 0
    ASP_1_1,           // 1
    ASP_4_3,           // 2 4:3 PAN-SCAN (NORMAL)
    ASP_16_9,          // 3 16:9 FULL
    ASP_221_1,         // 4
    ASP_4_3_LB,        // 5 4:3 Letter Box
    ASP_16_9_NORMAL,   // 6 16:9 NORMAL
    ASP_UNDEFINED,     // 7
    ASP_16_9_PAN_SCAN, // 8 16:9 pan scan
    ASP_4_3_FULL,      // 9 4:3 full 
    ASP_MAX_ASPECT_RATIO // 10
} TV_ASPECT_RATIO_T;
/*! @} */
...
#define TIMESTAMP_OVERFLOW  (0x200000000LL)
...
/* name Pic Flag Info: extension flag */
#define FBG_FLG_EXT_CROSSFADE               (0x1 << 0)    ///< Cross fade frame
...
*/
#if CONFIG_DRV_3D_256_SUPPORT
#define DSP_RESERVED_AUDIO_MAX_SZ               0  //24k byte  /*!< (Legacy Playback Special) */
#define DSP_RESERVED_AUDIO_LPCM_SZ              0  //24k byte
#define DSP_RESERVED_AUDIO_AC_3_SZ              0  //24k byte
#define DSP_RESERVED_AUDIO_DTS_SZ               0  //24k byte
#define DSP_RESERVED_AUDIO_DOLBY_LOSSLESS_SZ    0  //24k byte
#define DSP_RESERVED_AUDIO_DD_PLUS_PRI_SZ       0  //24k byte
#define DSP_RESERVED_AUDIO_DTS_HD_NO_XLL_SZ     0  //24k byte
#define DSP_RESERVED_AUDIO_DTS_HD_XLL_SZ        0  //24k byte
#define DSP_RESERVED_AUDIO_DD_PLUS_SEC_SZ       0  //24k byte
#define DSP_RESERVED_AUDIO_DTS_HD_LBR_SZ        0  //24k byte
#define DSP_RESERVED_AUDIO_MPEG_SZ              0  //24k byte
#define DSP_RESERVED_AUDIO_DOLBY_TRUE_HD_COMPATIBLE_MODE_SZ 0  //24k byte
#else
...
#define SRC_SIZE_SD_1 720*480
#define SRC_SIZE_SD_2 720*576
#define SRC_SIZE_HD_1 1280*736
#define SRC_SIZE_HD_2 1920*1088
