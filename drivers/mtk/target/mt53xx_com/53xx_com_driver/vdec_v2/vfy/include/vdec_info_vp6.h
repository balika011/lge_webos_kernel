...
typedef struct _VDEC_INFO_VP6_FRM_HDR_T_
{
    ...
    // Patch
    UINT32 u4ShiftBitsCnt;
    UINT32 u4BoolShiftBitsCnt;
    //~Patch
...
{
    BOOL     fgPpEnable; /* Always is FALSE ? Verification never set TRUE. */
    UINT8    u1PpLevel;
    UINT8    au1MBqp[4];
    UINT32  u4PpYBufSa;
    UINT32  u4PpCBufSa;
...
{    
    ...
    VDEC_INFO_VP6_BS_INIT_PRM_T *prVp6BSInitPrm; // patch
