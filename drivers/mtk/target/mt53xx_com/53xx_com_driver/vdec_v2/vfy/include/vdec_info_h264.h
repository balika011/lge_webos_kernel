...
typedef struct _VDEC_INFO_SEI_FRM_PACK_ARRANGE_T_
{
    UINT32  u4FramePackingArrangementId;
    BOOL     fgFramePackingArrangementCancelFlag;
    UINT32  u4FramePackingArrangementType;    
    BOOL    fgQuincunxSamplingFlag;    
    UINT32  u4ContentInterpretationType;    
    BOOL    fgSpatialFlippingFlag;    
    BOOL    fgFrame0FlippedFlag;    
    BOOL    fgFieldViewsFlag;    
    BOOL    fgCurrentFrameIsFrame0Flag;    
    BOOL    fgFrame0SelfContainedFlag;    
    BOOL    fgFrame1SelfContainedFlag;    
    UINT32  u4Frame0GridPositionX;    
    UINT32  u4Frame0GridPositionY;    
    UINT32  u4Frame1GridPositionX;    
    UINT32  u4Frame1GridPositionY;    
    UINT32  u4FramePackingArrangementReservedByte;    
    UINT32  u4FramePackingArrangementRepetitionPeriod;    
    BOOL    fgFramePackingArrangementExtensionFlag;    
}VDEC_INFO_SEI_FRM_PACK_ARRANGE_T;
...
typedef struct _VDEC_INFO_H264_SEI_T_
{
    ...
    VDEC_INFO_SEI_FRM_PACK_ARRANGE_T   rFramePackingInfo;
...
#endif
#ifdef VDEC_MVC_SUPPORT
    H264_DPB_STATUS_OUT_ON_REF,
#endif
}H264_DPB_COND_T;
...
typedef struct _VDEC_INFO_H264_B_REF_PRM_T_
{
	...
	UINT32  u4YStartAddr1;
	UINT32	u4CStartAddr1;
	UINT32	u4YLenOffset1;
	UINT32	u4CLenOffset1; 
...
{    
	...
	BOOL	fgIsUFOMode;
	BOOL	fgIs16BitMode;
	BOOL	fgIsCompactMode;
	BOOL	fgIsReorderMode;
    ...
    UINT32   u4OffsetBeforeDec;
    UINT32	u4LAEInfoBufAddr;
	UINT32	u4LAEETBufAddr;
...
#if (VDEC_DRV_MV_BUFF_REDUCE || CONFIG_DRV_VERIFY_SUPPORT)
