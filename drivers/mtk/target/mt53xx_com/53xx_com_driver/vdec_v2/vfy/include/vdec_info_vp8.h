...
#define VP8_MB_ROW_MODE_SUPPORT 1
#define VP8_MULTI_RING_BUFFER 1 //The macro must be open when row mode is open
#else
#define VP8_MB_ROW_MODE_SUPPORT 0
#define VP8_MULTI_RING_BUFFER 0
#endif
...
typedef enum
{
  ...
  VP8PARAM_WEBP_MCUROW_MODE, //TV is VP8PARAM_WEBP_MODE
  VP8PARAM_WEBP_MODE,
