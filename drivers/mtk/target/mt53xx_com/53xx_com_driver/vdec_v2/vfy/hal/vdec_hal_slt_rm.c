  ...
  for (y = 0; y < u4Height; y++)
  {
    for (x = 0; x < u4Width; x += 4)
    {
      ...
      if (u4ErrVal != u4GolVal)
      {
        ...
        //{
          u4ErrCntY+=2;
          UTIL_Printf("Check Golden Y Fail /n");
        //  x_thread_delay(5);
        //}
      }
    }
  ...
  for (y = 0; y < u4Height/2; y++)
  {
    for (x = 0; x < u4Width/2; x += 4)
    {
      ...
      if (u4ErrVal != u4GolVal)
      {
        ...
        //while (1);
        //{
          UTIL_Printf("Check Golden U/V Fail /n");
        //  x_thread_delay(1);
          u4ErrCntY+=3;
        //}
      }
...
//Check Golden Data
    ...
    {
      UTIL_Printf("[RM SLT] Golden Check Fail \n");
      break;
    }
  ...
  {
    UTIL_Printf("RM SLT Pass \n");
    SLTSendResult(SLT_ITEMS_RM, SLT_STATUS_PASS); 
  }
  else
  {
    UTIL_Printf("RM SLT Fail \n");
