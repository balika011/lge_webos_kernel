...
#if DUMP_DRAM_BUFFER
#define CRC_GEN 14
#define DP_TOTAL_DRAM 12
#define DP_CUR_YBUFFER 0
#define DP_CUR_CBUFFER 1
#define DP_PREVFW_Y 2
#define DP_PREVFW_C 3
#define DP_FWREF_Y 4
#define DP_FWREF_C 5
#define DP_BWREF_Y 6
#define DP_BWREF_C 7
...
#define DP_MV2 9
#define DP_PRED 13
#define DP_YBUFFER_BEFORE_TRIGHW 10
#define DP_CBUFFER_BEFORE_TRIGHW 11
	
extern BOOL fgAVSPlusDumpMem( UINT32 u4InstID, UCHAR* ucAddr, UINT32 u4Size , UINT32  u4Field_Num , UINT32 u4Type);
#endif
...
VOID vVdecAvsDumpReg(
    UINT32 u4InstID,
    UINT32 u4BeoforeTrigger
);
#if AVS_ESA_MEASURE
VOID vVdecMeasureAVSESA(
    UINT32 u4VDecID
);
#endif
