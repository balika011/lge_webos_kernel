...
#ifdef CC_MT5890
#define UARTHT_FIFO_SIZE            ((UINT32)32 - 1)
#define UARTBT_FIFO_SIZE            ((UINT32)32 - 1)
#endif
// *********************************************************************
...
#ifdef CC_MT5890
#define UART_HT_BASE                (UINT32)(0x844)
#define UART_BT_BASE                (UINT32)(0x880)
#endif
...
#ifdef CC_MT5890
#define REG_SERHT_PORT				(UINT32)0x844	// Data port for port 3 (HT)
#define REG_SERBT_PORT				(UINT32)0x880	// Data port for port 4 (BT)
#endif

#define REG_SER_CTL                 (UINT32)0x04
#define REG_SERPD_CTL               (UINT32)(UART_PD_BASE + 0x04)
#ifdef CC_MT5890
#define REG_SERHT_CTL               (UINT32)(UART_HT_BASE + 0x04)
#define REG_SERBT_CTL               (UINT32)(UART_BT_BASE + 0x04)
#endif
...
// Communication control register for port 0, port 1 and port 2 (port PD), port 3 (port HT), port 4 (port BT).
#define REG_SER_CTR                 (UINT32)0x48
#define REG_SER01_CTR               (UINT32)0xc8
#define REG_SERPD_CTR               (UINT32)(UART_PD_BASE + 0x30)
#ifdef CC_MT5890
#define REG_SERHT_CTR               (UINT32)(UART_HT_BASE + 0x2c)
#define REG_SERBT_CTR               (UINT32)(UART_BT_BASE + 0x30)
#endif
...
// Buffer status register for port 0, port 1 and port 2 (port PD), port 3 (port HT), port 4 (port BT).
#define REG_SER_STATUS              (UINT32)0x4c
#define REG_SER01_STATUS            (UINT32)0xcc
#define REG_SERPD_STATUS            (UINT32)(UART_PD_BASE + 0x34)
#ifdef CC_MT5890
#define REG_SERHT_STATUS            (UINT32)(UART_HT_BASE + 0x30)
#define REG_SERBT_STATUS            (UINT32)(UART_BT_BASE + 0x34)
#endif
...
#ifdef CC_MT5890
#define REG_SERHT_BUF_CTL           (UINT32)((UART_HT_BASE) + 0x34)
#define REG_SERBT_BUF_CTL           (UINT32)((UART_BT_BASE) + 0x38)
#endif
...
#ifdef CC_MT5890
#define REG_SERHT_INT_EN            (UINT32)(UART_HT_BASE + 0x08)
#define REG_SERHT_INT_STATUS        (UINT32)(UART_HT_BASE + 0x0C)
#define REG_SERBT_INT_EN            (UINT32)(UART_BT_BASE + 0x0c)
#define REG_SERBT_INT_STATUS        (UINT32)(UART_BT_BASE + 0x10)
#endif
...
#ifdef CC_MT5890
#define REG_HT_NROMAL_MODE_BUF_SZ   (UINT32)(UART_HT_BASE + 0x18)
#define REG_BT_NROMAL_MODE_BUF_SZ   (UINT32)(UART_BT_BASE + 0x1c)
#endif
