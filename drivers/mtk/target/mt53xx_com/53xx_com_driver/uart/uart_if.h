...
#define UART_PORT_2                     (UINT8)2 // no use. to del.
#define UART_PORT_PD                    (UINT8)2
#ifdef CC_MT5890
#define UART_PORT_HT                    (UINT8)3
#define UART_PORT_BT                    (UINT8)4
#endif
...
extern void UART_ModemCtr(BOOL fgEnable);
#endif
