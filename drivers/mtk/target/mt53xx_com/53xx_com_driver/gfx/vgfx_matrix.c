...
unsigned int fnum_converter (float in)
{
  ...
  unsigned int sign = fnum_in.i & ORG_SIGN;
  //NAN or INF
  ...
  int exp_tmp  = (((int)(fnum_in.i) & ORG_EXP) >> 23) - 96; //old bias 127, new bias31
  ...
  unsigned int man = fnum_in.i & ORG_MAN;
