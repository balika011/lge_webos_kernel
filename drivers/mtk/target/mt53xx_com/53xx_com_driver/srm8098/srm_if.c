...
static UINT8 _u1ForcePOPMode = 0;
...
defined(CC_MT5389) || defined(CC_MT5398) || defined(CC_MT5880)              
...
defined(CC_MT5398) || defined(CC_MT5880)
...
VOID SRM_ForcePOPMode(UINT8 u1Mode)
{
    _u1ForcePOPMode = u1Mode;
    LOG(5, "[SRM] Force POP mode %d\n", u1Mode);
}
...
{
    SRM_TV_MODE_T mode = SRM_GetTvMode();
    
    if((SRM_TV_MODE_TYPE_POP==mode)
        ||(TRUE==_u1ForcePOPMode))
    {
    	return 1;
    }
    else
