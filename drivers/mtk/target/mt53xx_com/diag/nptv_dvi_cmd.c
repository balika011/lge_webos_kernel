...
static INT32 _u1vDVISetVportch(INT32 i4Argc, const CHAR **szArgv);
...
extern void vSetVPortch(void);

extern void vCCIRSetAvStart(UINT16 wStart);
extern UINT16 wCCIRGetAvStart(void);
extern void vCCIRSetAvWidth(UINT16 wWidth);
extern UINT16 wCCIRGetAvWidth(void);
extern void vCCIRSetVsStart(UINT16 wStart);
extern UINT16 wCCIRGetVsStart(void);
extern void vCCIRSetVsWidth(UINT16 wStart);
extern UINT16 wCCIRGetVsWidth(void);
...
CLI_EXEC_T arDVICmdTbl[] = {
  ...
  {"set v portch", "vp", _u1vDVISetVportch, NULL, "DVI set V potch", CLI_SUPERVISOR},
...
INT32 _u1vDVISetVportch(INT32 i4Argc, const CHAR **szArgv)
{
	vSetVPortch();
	return 0;
}
...
static INT32 _u1vCCIRSetAvStart(INT32 i4Argc, const CHAR **szArgv)
{
	...
	vCCIRSetAvStart((UINT16)StrToInt(szArgv[1]));
...
static INT32 _u1vCCIRSetAvWidth(INT32 i4Argc, const CHAR **szArgv)
{
	...
	vCCIRSetAvWidth((UINT16)StrToInt(szArgv[1]));
...
static INT32 _u1vCCIRSetVsStart(INT32 i4Argc, const CHAR **szArgv)
{
	...
	vCCIRSetVsStart((UINT16)StrToInt(szArgv[1]));
...
static INT32 _u1vCCIRSetVsWidth(INT32 i4Argc, const CHAR **szArgv)
{
	...
	vCCIRSetVsWidth((UINT16)StrToInt(szArgv[1]));
