...
CLI_EXEC_T arPatgenCmdTbl[] = {
    ...
    {"Pat DI",          "di",    _i4PatDI,            NULL, "De-interlace output pattern", CLI_SUPERVISOR},
    {"Pat DS Input",    "ds",    _ScposSetDSPtnCmd,   NULL, "Down-scaler input pattern",   CLI_SUPERVISOR},
    {"Pat US Input",    "us",    _ScposSetUSPtnCmd,   NULL, "Up-scaler input pattern",     CLI_SUPERVISOR},
