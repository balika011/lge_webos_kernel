...
static INT32 _vDRVTVDPVdelay(INT32 i4Argc, const CHAR **szArgv);
...
CLI_EXEC_T arTvdCmdTbl[] = {
  ...
  {"TVD_PVDelay", "pv_delay",  _vDRVTVDPVdelay,   NULL,  "TVD PV Delay (VPorch)",    CLI_GUEST},
...
static INT32 _vDRVTVDAVdelay(INT32 i4Argc, const CHAR **szArgv)
{
  if (i4Argc != 2)
  {
    Printf("Usage:TVD AV Delay (BYTE) default HPORCH value:\n");
		
	Printf("PAL_N=0xC4,PAL=0xB8,PAL_M=0xBA.\n");
	
    Printf("NTSC_358=0xB9,SECAM=0xA7,PAL60=0xAE,NTSC_443=0xAD.\n");
...
static INT32 _vDRVTVDPVdelay(INT32 i4Argc, const CHAR **szArgv)
{
  if (i4Argc != 2)
  {
    Printf("Usage:TVD PV Delay (BYTE) default VPORCH value:\n");
    
    Printf("PAL_N=0x0,PAL=0x0,PAL_M=0x0.\n");
    
    Printf("NTSC_358=0x41,SECAM=0x41,PAL60=0x41,NTSC_443=0x41.\n");
	    	   
    Printf("when the picture need up,the value is from 0x0 to 0x3f.\n");
	
    Printf("when the picture need down,the value is from 0x40 to 0x7f.\n");
		   
    return 0;
  }

  vTVDPVDelay((UINT8)StrToInt(szArgv[1]));
