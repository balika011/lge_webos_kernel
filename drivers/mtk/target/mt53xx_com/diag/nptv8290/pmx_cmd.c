...
static INT32 _PmxVOPLLAnalogTestCmd(INT32 i4Argc, const CHAR **szArgv);
static INT32 _PmxDVOPLLLockCheck(INT32 i4Argc, const CHAR **szArgv);
#ifndef CC_MTK_LOADER
static INT32 _PmxDVOPLLLockRegion(INT32 i4Argc, const CHAR **szArgv);
#endif
...
static INT32 _VByOneLaneSwapForTest(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneSingleLanePadEn(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneVPLLBandwidthSet(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneOSDCRCChk (INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneOSDOn (INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneOSDOff (INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneGMQuery(INT32 i4Argc, const CHAR ** szArgv);
static INT32 _VByOneGMSetting(INT32 i4Argc, const CHAR ** szArgv);
static INT32 _VByOneOSDUHDQuery(INT32 i4Argc, const CHAR ** szArgv);
static INT32 _VByOneOSDUHDSetting(INT32 i4Argc, const CHAR ** szArgv);
static INT32 _VByOneOSDFormat(INT32 i4Argc, const CHAR ** szArgv);
static INT32 _VByOnePreEmphasisOnOff(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOnePreEmphasisSet(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneINXI2CCmd(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOnePLLRst(INT32 i4Argc, const CHAR **szArgv);
static INT32 _VByOneES3RegisterMapping(INT32 i4Argc, const CHAR **szArgv);
...
#endif
static INT32 _PmxGetScanningDbgLevel(INT32 i4Argc, const CHAR **szArgv);
static INT32 _PmxLVDSToGPIOInit(INT32 i4Argc, const CHAR **szArgv);
static INT32 _PmxSetLVDSToGPO(INT32 i4Argc, const CHAR **szArgv);
static INT32 _PmxSetLVDSToGPI(INT32 i4Argc, const CHAR **szArgv);
...
#endif 	 	
	{"scanDbgLevel", "scandl",  _PmxGetScanningDbgLevel, NULL, "Set scanning debug log level", CLI_SUPERVISOR},
	{"ESDfg", NULL, _PmxSetCmdESDProtectFg, NULL, "ESDProtectflag", CLI_SUPERVISOR},
	{"portB to GPIO init", "gpioi",  _PmxLVDSToGPIOInit, NULL, "portB to GPIO init", CLI_SUPERVISOR},
	{"portB pin to GPO", "gpo",  _PmxSetLVDSToGPO, NULL, "set portB pin to GPO", CLI_SUPERVISOR},
	{"portB pin to GPI", "gpi",  _PmxSetLVDSToGPI, NULL, "set portB pin to GPI", CLI_SUPERVISOR},
...
static CLI_EXEC_T _arPmxVOPLLCmdTbl[] =
{
    ...
    {"Analog test", "at", _PmxVOPLLAnalogTestCmd, NULL, "VOPLL Analog test", CLI_SUPERVISOR},
    {NULL, NULL, NULL, NULL, NULL, CLI_SUPERVISOR}
};
...
#ifndef CC_MTK_LOADER    
    {"scan", "scan", _PmxDVOPLLLockRegion, NULL, "dvopll scan lock region", CLI_SUPERVISOR},        
#endif    
    {NULL, NULL, NULL, NULL, NULL, CLI_SUPERVISOR}
};
...
static CLI_EXEC_T _arPmxVB1CmdTbl[] =
{
    ...
    {"vbone_panle", "p", _PmxSetCmdVb1, NULL, "Set Panel vb1 flag", CLI_GUEST},
    ...
    {"VByOne_On", "on", _VByOneOn, NULL, "Set VB1 on", CLI_GUEST},      
    {"VByOne_Off", "off", _VByOneOff, NULL, "Set VB1 on", CLI_GUEST},          
    {"VByOne_swap_test", "swapt", _VByOneLaneSwapForTest, NULL, "VByOne swap for test", CLI_SUPERVISOR},
    {"VByOne_1lane_en", "sap", _VByOneSingleLanePadEn, NULL, "VByOne analog single pad enable", CLI_SUPERVISOR},
    {"VByOne_VPLLBandwidth", "vbw", _VByOneVPLLBandwidthSet, NULL, "VByOne VPLL bandwidth set", CLI_SUPERVISOR},
    {"Pre-emphasis on/off","preoo", _VByOnePreEmphasisOnOff,       NULL,   "Pre-emphasis on/off",  CLI_GUEST},
    {"Pre-emphasis setting","pre", _VByOnePreEmphasisSet,       NULL,   "Pre-emphasis setting",  CLI_GUEST},
    {"INX VB1 I2C cmd","inx", _VByOneINXI2CCmd,       NULL,   "INX VB1 I2C cmd",  CLI_GUEST},
    {"PLL RST for FIB","prst", _VByOnePLLRst,       NULL,   "PLL RST cmd",  CLI_GUEST},
    {"ES3 Register","es3", _VByOneES3RegisterMapping,       NULL,   "ES3 Register mapping",  CLI_GUEST},    
    {NULL, NULL, NULL, NULL, NULL, CLI_SUPERVISOR}
};

static CLI_EXEC_T _arPmxVB1OSDCmdTbl[] =
{
    {"GraphMode_CRC","crc", _VByOneOSDCRCChk,       NULL,           "GraphMode_CRC_chk",  CLI_SUPERVISOR},       
    {"GraphMode_On", "on", _VByOneOSDOn, NULL, "GraphMode_On", CLI_SUPERVISOR},      
    {"GraphMode_Off", "off", _VByOneOSDOff, NULL, "GraphMode_Off", CLI_SUPERVISOR},          
    {"Table_query","q", _VByOneGMQuery,       NULL,           "GraphMode_Table_query",  CLI_GUEST},       
    {"Resolution_setting", "gm", _VByOneGMSetting, NULL, "GraphMode Resolution setting", CLI_GUEST },		
    {"UHD_status","s", _VByOneOSDUHDQuery,       NULL,           "GraphMode_UHD query",  CLI_GUEST},           
	{"UHD_Mode","m", _VByOneOSDUHDSetting,		 NULL,			 "GraphMode_UHD_Mode_setting",  CLI_GUEST},			
	{"format","f", _VByOneOSDFormat,		 NULL,			 "GraphMode_Mode_format",  CLI_GUEST},				
    {NULL, NULL, NULL, NULL, NULL, CLI_SUPERVISOR}
};
...
static CLI_EXEC_T _arPmxCmdTbl[] =
{
	...
	{"graph", "graph",NULL, _arPmxVB1OSDCmdTbl, "v by one graph path", CLI_GUEST},			
	{"uhd", "u",NULL, _arPmxUHDCmdTbl, "uhd", CLI_GUEST},			  	
	{"pll", "pll",NULL, _arPmxPLLCmdTbl, "pll check", CLI_SUPERVISOR},			  		
...
static INT32 _PmxSetCmdBacklt(INT32 i4Argc, const CHAR ** szArgv)
{
    ...
    CHK_NUM_MIN_PARAM(4, "scanPWMSrc(1~8) start(permillage) duty(permillage) freq(Hz)");
...
static INT32 _PmxSetCmdDrivingCurrent(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    CHK_NUM_MIN_PARAM(1, "value(0~15) 0:0(1mA), 1:0(1mA), 2:0x2(2mA), 3:0x4(3mA), 4:0x6(4mA), 5:0x8(5mA), 6:0xA(6mA), 7:0xC(7mA), 8:0xE(8mA)");
...
static INT32 _PmxVOPLLAnalogTestCmd(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc != 2)
	{
		Printf("pmx.vopll.at <mode>\n");
		Printf("mode: 1~4  Off: 0\n");	
		Printf("mode=1: 74.25M DDDS OpenLoop\n");
		Printf("mode=2: 148.5M DDDS OpenLoop\n");
		Printf("mode=3: 81M XSTAL\n");
		Printf("mode=4: 162M XSTAL\n");
		return 0;
	}
	u1mode = (UINT8)StrToInt(szArgv[1]);

	vDrvLvdsVOPLLAnalogTest(u1mode);
...
static INT32 _PmxDVOPLLLockRegion(INT32 i4Argc, const CHAR **szArgv)
{
	...
	{
    	Printf("pmx.dvopll.scan 175 675,satrt(KHz*10), end(KHz*10), step(KHz*10)\n");
	}
	else
	{
	    if (i4Argc == 3)
	    {
	    	Printf("[3]\n");
			vScanGoodDclkRegion(PARAM(0), PARAM(1),10);
	    }
		else if (i4Argc == 4)
	    {
	    	Printf("[4]\n");	    
			vScanGoodDclkRegion(PARAM(0), PARAM(1),PARAM(2));
	    }	
	}
		  return 0;	
}
...
static INT32 _PmxPLLTestModeCmd(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc != 2)
	{
		...
		Printf("[1]APLL2 VCO Control voltage\n");
		Printf("[2]DMUXPLL VCO Control voltage\n");
		Printf("[3]G3DPLL VCO Control voltage\n");
		Printf("[4]syspll VCO Control voltage\n");
		Printf("[5]VDECPLL VCO Control voltage\n");
		Printf("[6]ARMCPLL VCO Control voltage\n");
		Printf("[7]HPCPLL VCO Control voltage\n");
		Printf("[8]IFPLL VCO Control voltage\n");
		Printf("[9]LPCPLL VCO Control voltage\n");		
		return 0;
	}
...
static INT32 _VByOneScript (INT32 i4Argc, const CHAR **szArgv)
{
  ...
  { 
    ...
    Printf("load 8 bits 8 lanes done\n");
  }
  else if(x_strcmp(szArgv[1], "1") ==0 )
  {
    vVByOneLane4_10bit_script();
    Printf("load 10 bits 8 lanes done\n");
  }
  else
  {
    vVByOneLane4_12bit_script();
    Printf("load 12 bits 8 lanes done\n");
  }
...
static INT32 _VByOneLaneSwapForTest(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc < 2)
  	{
    	Printf("Usage: swapt <mode> \n");
    	Printf("mode=1: lane4567-->lane0123, OSDlane0123-->lane0123\n");
		Printf("mode=0: resume\n");
        return 1;
  	}
	
	u1mode = (UINT8)StrToInt(szArgv[1]);
	Printf("test_mode=%d\n", u1mode);
	vVByOneLaneSwapForTest(u1mode);
...
static INT32 _VByOneSingleLanePadEn(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc < 2)
  	{
    	Printf("Usage: sap <lane> \n");
    	Printf("lane=1~12: just enable the current lane\n");
		Printf("lane=0: 12 lanes are enabled!!!\n");
        return 1;
  	}
	
	u1Lane = (UINT8)StrToInt(szArgv[1]);
	vVByOneSingleLanePadEn(u1Lane);
...
static INT32 _VByOneVPLLBandwidthSet(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc < 2)
  	{
    	Printf("Usage: vbw <mode> \n");
    	Printf("mode=1: bandwidth=0.5MHz\n");
		Printf("mode=2: bandwidth=1MHz\n");
		Printf("mode=0: bandwidth=default\n");
        return 1;
  	}
	
	u1mode = (UINT8)StrToInt(szArgv[1]);
	vVByOneVPLLBandwidthSet(u1mode);
...
static INT32 _VByOneGMSetting(INT32 i4Argc, const CHAR ** szArgv)
{
    ...
    if (i4Argc == 13)
    {
        UINT32 u4Target = PARAM(0);    
        UINT32 u4DispClk = PARAM(1);
        UINT32 u4HTotal = PARAM(2);		
        UINT32 u4DispWidth = PARAM(3);
        UINT32 u4HSyncFp = PARAM(4);		
        UINT32 u4HSyncWidth = PARAM(5);
        UINT32 u4HSyncBp = PARAM(6);			
        UINT32 u4VTotal = PARAM(7);
        UINT32 u4DispHeight = PARAM(8);
        UINT32 u4VSyncFp = PARAM(9);		
        UINT32 u4VSyncWidth = PARAM(10);
        UINT32 u4VSyncBp = PARAM(11);		
		...
		Printf("u4Target = %d, u4DispClk=%d\n",u4Target, u4DispClk);

        if (u4DispClk > 0)
        {
        	Printf("u4Target = %d, u4DispClk=%d\n",u4Target, u4DispClk);
			GRAPHMODE_SetPixelClkByTiming(u4Target,u4DispClk);
        }

        if (u4HTotal > 0)
        {
			GRAPHMODE_SetHtotalByTiming(u4Target,u4HTotal);
        }

        if (u4DispWidth > 0)
        {
			GRAPHMODE_SetPanelWidth(u4DispWidth);
        }

        if (u4HSyncFp > 0)
        {
			GRAPHMODE_SetHSyncFpByTiming(u4Target, u4HSyncFp);
        }

        if (u4HSyncWidth > 0)
        {
			GRAPHMODE_SetHSyncWidthByTiming(u4Target, u4HSyncWidth);
        }

        if (u4HSyncBp > 0)
        {
			GRAPHMODE_SetHSyncBpByTiming(u4Target, u4HSyncBp);
        }

        if (u4VTotal > 0)
        {
        	Printf("u4Target = %d, u4VTotal=%d\n",u4Target, u4VTotal);
			GRAPHMODE_SetVtotalByTiming(u4Target,u4VTotal);
        }	

        if (u4DispHeight > 0)
        {
            GRAPHMODE_SetPanelHeight(u4DispHeight);
        }
		
        if (u4VSyncFp > 0)
        {
			GRAPHMODE_SetVSyncFpByTiming(u4Target, u4VSyncFp);
        }

        if (u4VSyncWidth > 0)
        {
			GRAPHMODE_SetVSyncWidthByTiming(u4Target, u4VSyncWidth);
        }

        if (u4VSyncBp > 0)
        {
			GRAPHMODE_SetVSyncBpByTiming(u4Target, u4VSyncBp);
        }
...
{
	#if defined(SUPPORT_PANEL_GRAPH_MODE)
    UINT8 u1Mode = PARAM(0);	
    CHK_NUM_MIN_PARAM(1, "u1Mode(2:GraphMode_4K1K, 3:GraphMode_4K2K)");

    if (i4Argc == 2)
    {
	    vDrvSwitchGFXTiming(u1Mode);
    }
	#endif
    return 0;
}
...
{
	#if defined(SUPPORT_PANEL_GRAPH_MODE)
    UINT32 u4ControlWord= PARAM(0);
    UINT8 u1Format= PARAM(0);	

    CHK_NUM_MIN_PARAM(1, "u1Mode(0:GM_FORMAT_CASE0_SMODE1, 1:GM_FORMAT_CASE1_SMODE0 2: GM_FORMAT_CASE2_MMODE0  3:GM_FORMAT_CASE3_INHOUSE)");

    u4ControlWord = GraphMode_GetControlWord();
    u4ControlWord = (u4ControlWord & 0xFFFFFFFC) | u1Format;
	
    if(i4Argc == 2)
    {
    GraphMode_SetControlWord(u4ControlWord);
...
static INT32 _VByOnePreEmphasisOnOff(INT32 i4Argc, const CHAR **szArgv)
{
	...
	u1OnOff = (UINT8)PARAM(0);
	vVByOnePreEmphasisOnOff(u1OnOff);
	return 0;
}

static INT32 _VByOnePreEmphasisSet(INT32 i4Argc, const CHAR **szArgv)
{
	UINT32 u4Current =(UINT32)vVByOneGetPreEmphasis();
    if (i4Argc == 1)
    {
        Printf("current value=%d\n", u4Current);
    }

    CHK_NUM_MIN_PARAM(1, "value(0~7) 0:0(1mA), 1:1(1.5mA), 2:0x2(2mA), 3:0x3(2.5mA), 4:0x4(3mA), 5:0x5(3.5mA), 6:0x6(4mA), 7:0x7(4.5mA)");
    u4Current = PARAM(0) & 0x7;
    vVByOnePreEmphasisSet(u4Current);
...
static UINT8 _au1cmiMst4K2K30VB1Buf[] = {
                                            ...
                                            0x33, 0x1c, 0x13, 0x00, 0x04, 0x40, 0x40,  //reset
                                            0x33, 0x1c, 0x13, 0x00, 0x04, 0x00, 0x40};											
static UINT8 _au1cmiMst2SectionVB1Buf[] = {
...
static INT32 _VByOneINXI2CCmd(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc < 2)
    {
		...
		Printf("<cmd type> 1:FHD60; 2:FHD120; 3:4K2K30; 4:4K2K60 5:2-Section\n");
        return 1;
    }
	else
	{
	    ...
	    switch(u1CmdType)
	    {
			...
			case 4:  // 4K2K60
				...
				break;
			case 5:  // 2-Section
				Printf("[INX VB1] 2-Section cmd\n");
				pTmp = _au1cmiMst2SectionVB1Buf;
				u2Len = sizeof(_au1cmiMst2SectionVB1Buf);
				break;
			case 2:  // FHD120
			case 0:
			default:
		...
		for(k=0; k < u2Len ; k=k+u1CmdLen)
		{
			...
			Printf("\n[INX VB1] I2c Data :");
			{
			 ...
			 Printf("\n");
		     iret = SIF_X_Write(2, 0x100 , 0x38, 0 ,0, pTmp, u1CmdLen);
		     if(iret <=0)
		     {
...
static INT32 _PmxSetScanningPWM(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    CHK_NUM_MIN_PARAM(4, "scanPWMSrc(1~8) start(0%~100%) duty(0~100%) freq(Hz)");
...
extern UINT8 _bScanPWMDbgLogLev;
static INT32 _PmxGetScanningDbgLevel(INT32 i4Argc, const CHAR **szArgv)
{
	if (i4Argc<2)
	{
		Printf("Usage: %s <DbgLevel>\n", szArgv[0]);
		Printf("_bScanPWMDbgLogLev=%d\n", _bScanPWMDbgLogLev);
		return 1;
	}
	else
	{
		_bScanPWMDbgLogLev=PARAM(0);
		Printf("_bScanPWMDbgLogLev=%d\n", _bScanPWMDbgLogLev);
		return 0;
	}
}
...
static INT32 _PmxSetLVDSToGPO(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc<3)
	{
		...
		Printf("Pin: 13~0  BOCKP BOCKN BO5P BO5N BO4P BO4N BO3P BO3N BO2P BO2N BO1P BO1N BO0P BO0N\n");
		Printf("Pin: 29~16 BECKP BECKN BE5P BE5N BE4P BE4N BE3P BE3N BE2P BE2N BE1P BE1N BE0P BE0N\n");
		return 1;
	}
	else
	{
		u1Pin = PARAM(0);
		u1OnOff = PARAM(1);
		vDrvSetLVDSToGPO(u1Pin,u1OnOff);
		return 0;
	}
}
...
static INT32 _PmxSetLVDSToGPI(INT32 i4Argc, const CHAR **szArgv)
{
	...
	else
	{
		u1Pin = PARAM(0);
		u1OnOff = PARAM(1);
		vDrvSetLVDSToGPI(u1Pin,u1OnOff);
		return 0;
	}
}
...
static INT32 _PmxTXIFAnalogPadSet(INT32 i4Argc, const CHAR **szArgv)
{
	...
	else if (i4Argc < 3)
	{
		...
		else
		{
			...
			Printf("If want to set the reg, please input: pmx.if.apen 2 0x****, 0, 0x****, 0x****\n");
		#else
			Printf("If want to set the reg, please input: pmx.if.apen 2 0x****, 0\n");
		#endif
		}
	}
#if (!defined(CC_MT5890))
...
static INT32 _PmxUHDSetting(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    else
    {
         ...
         Printf("==== Panel4K2K Type === \n");
         Printf("PANEL_TYPE_720P_120   = 0 \n");
         Printf("PANEL_TYPE_2K1K_60    = 1 \n");
         Printf("PANEL_TYPE_2K1K_120   = 2 \n");
         Printf("PANEL_TYPE_1920_540P  = 3 \n");
         Printf("PANEL_TYPE_4K1K_60    = 4 \n");
         Printf("PANEL_TYPE_4K2K_30    = 5 \n");
		 Printf("PANEL_TYPE_4K2K_60    = 6 \n");
		 Printf("PANEL_TYPE_2K2K_60    = 7 \n");
		 Printf("PANEL_TYPE_MAX        = 8 \n");
    }
