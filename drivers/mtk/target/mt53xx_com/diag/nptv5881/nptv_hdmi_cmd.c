...
static INT32 _u1vHDMIEqSettingScan(INT32 i4Argc, const CHAR **szArgv);
#ifdef __MODEL_slt__
static INT32 _u1vMHLAUDTEST(INT32 i4Argc, const CHAR **szArgv);
#endif
...
CLI_EXEC_T arHDMICmdTbl[] = {
  ...
  {"HDMI EQ Setting Scan", "ss", _u1vHDMIEqSettingScan, NULL, "HDMI EQ Setting Scan", CLI_GUEST},
#ifdef __MODEL_slt__
  {"MHL slt audio test", "audtest", _u1vMHLAUDTEST, NULL, "MHL slt audio test", CLI_GUEST},
#endif
...
static INT32 _u1vHDMIEqSettingScan(INT32 i4Argc, const CHAR **szArgv)
{
	...
	UNUSED(fgHDMIEQSettingScan((UINT8)StrToInt(szArgv[1])));
