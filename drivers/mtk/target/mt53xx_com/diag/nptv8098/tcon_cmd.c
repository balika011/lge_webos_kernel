...
static INT32 _i32CliTconOffOn(INT32 i4Argc, const CHAR **szArgv)
{
	...
	i4Ret = (INT32)u1DrvTconOffOn(eTconPowSeq,  val);
...
static INT32 _i32CliTconPanelSet(INT32 i4Argc, const CHAR **szArgv)
{
	...
	if (i4Argc != 2)
	{
		...
		Printf("Usage: [case] \n" \
			   ...
			   "Case  1: 148500000 DUAL_PORT   TCLK_PCLK_RATION_2\n" \
			   "Case  2: 148500000 DUAL_PORT   TCLK_PCLK_RATION_1\n" \
			   "Case  3:  74250000 SINGLE_PORT TCLK_PCLK_RATION_1\n" \
			   "Case  4: 170000000 DUAL_PORT   TCLK_PCLK_RATION_2\n" \
			   "Case  5: 170000000 DUAL_PORT   TCLK_PCLK_RATION_1\n" \
			   "Case  6:  85000000 SINGLE_PORT TCLK_PCLK_RATION_1\n" \
			   "Case  7:  85000000 SINGLE_PORT TCLK_PCLK_RATION_2\n" \
			   "Case  8:  85000000 SINGLE_PORT TCLK_PCLK_RATION_4\n" \
			   "Case 9:  85000000 SINGLE_PORT TCLK_PCLK_RATION_1P5\n" \
			   "Case 10:  85000000 SINGLE_PORT TCLK_PCLK_RATION_3\n" \
			   "Case 11:  85000000 SINGLE_PORT TCLK_PCLK_RATION_0P75\n" \
			   "Case 12: 170000000 DUAL_PORT   TCLK_PCLK_RATION_0P75\n",szArgv[0]);
	#else
		Printf("Usage: [case] \n" \
			   "[Case]: [Freq] [PORT] [Ration] \n" \
	...
	u1arg1 = (UINT8)StrToInt(szArgv[1]);
	#ifdef CC_MT5565
		if (u1arg1==1) u1DrvTconMLDSVOPLLFreqSet(148500000,  DUAL_PORT,TCLK_PCLK_RATION_2);
		...
		else if (u1arg1==4) u1DrvTconMLDSVOPLLFreqSet(170000000,  DUAL_PORT,TCLK_PCLK_RATION_2);
	    ...
	    else if (u1arg1==7) u1DrvTconMLDSVOPLLFreqSet( 85000000,SINGLE_PORT,TCLK_PCLK_RATION_2);
	    else if (u1arg1==8) u1DrvTconMLDSVOPLLFreqSet( 85000000,SINGLE_PORT,TCLK_PCLK_RATION_4);
	    else if (u1arg1==9) u1DrvTconMLDSVOPLLFreqSet( 85000000,SINGLE_PORT,TCLK_PCLK_RATION_1P5);
	    else if (u1arg1==10) u1DrvTconMLDSVOPLLFreqSet( 85000000,SINGLE_PORT,TCLK_PCLK_RATION_3);
	    else if (u1arg1==11) u1DrvTconMLDSVOPLLFreqSet( 85000000,SINGLE_PORT,TCLK_PCLK_RATION_0P75);
	    else if (u1arg1==12) u1DrvTconMLDSVOPLLFreqSet(170000000,  DUAL_PORT,TCLK_PCLK_RATION_0P75);
