...
static INT32 _u4SRM_ForcePOPMode(INT32 i4Argc, const CHAR **szArgv);
...
extern VOID SRM_ForcePOPMode(UINT8 u1Mode);
#endif
...
CLI_EXEC_T arSrmCmdTbl[] = {
  ...
  {"forcepop", "fpop", _u4SRM_ForcePOPMode, NULL, "force POP mode", CLI_GUEST},  
#endif
...
static INT32 _u4SRM_ForcePOPMode(INT32 i4Argc, const CHAR **szArgv)
{
    ...
    {
    	//Printf("_u4SRM_SetPscanMode!!\n");
        SRM_ForcePOPMode(StrToInt(szArgv[1]));
    }
