...
*/
...
#ifdef TIME_SHIFT_SUPPORT
    #define N_DRVC_PVRCTRL   PVR_CTRL_COMP_NUM
#else
    ...
    #if ! defined( N_DRVC_VID_ENC )
        #define N_DRVC_VID_ENC      VENC_COMP_NS
    #endif
#else
    #define N_DRVC_VID_ENC      0
#endif

#ifdef CC_SUPPORT_MUXER
    #if ! defined( N_DRVC_MUXER )
            #define N_DRVC_MUXER         MUXER_COMP_NS
    #endif
#else
    #define N_DRVC_MUXER         0
#endif
...
#if ! defined( N_GRP_RECORDAV )
#define N_GRP_RECORDAV \
    (\
        N_DRVC_ANATUNER + \
        N_DRVC_TUNER + \
        N_DRVC_AUD + \
...
*************************************************/
    ...
    #define N_DRVC_ALL \
        ...
        N_DRVC_VID_ENC + N_DRVC_MUXER +\
        N_DRVC_VIDEO_OUT + N_DRVC_TVE)

    #define N_GRP_ALL \
        (N_GRP_MAIN + N_GRP_SUB + N_GRP_AUX + N_GRP_AUX_SUND +  N_GRP_TRD_SUND + N_GRP_TRD_THUMB +\
         N_GRP_TVBYPASS + N_GRP_MONITORBYPASS + N_GRP_RECORDAV)
#else
    #define N_DRVC_ALL \
        (N_DRVC_TUNER + N_DRVC_PCR + N_DRVC_PES +\
        N_DRVC_PES_MEM + \
    ...
    #define N_GRP_ALL \
        (N_GRP_MAIN + N_GRP_SUB + N_GRP_AUX + N_GRP_AUX_SUND +  N_GRP_TRD_SUND + N_GRP_TRD_THUMB + N_GRP_RECORDAV)
