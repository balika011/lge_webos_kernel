...
INT32 MW_VdoOutInit(void)
{
    ...
    for(u4Idx=0;u4Idx<VDO_OUT_COMP_NS;u4Idx++)
    {
        ...
        MTTVE_SetDacMuteMask(u4Idx, MTTVE_DAC_MUTE_MASK_DRV, TRUE);
    }
                              ...
                              SIZE_T z_disc_info_len)
{
    ...
    DBG_LOG_PRINT(("*** Disconnect VdoOut%d tick=%u***\r\n",
                     pt_comp_id->ui2_id, x_os_get_sys_tick()));

    MTTVE_SetDacMuteMask(u1DacIdx, MTTVE_DAC_MUTE_MASK_DRV, TRUE);
                       ...
                       const VOID * pv_set_info, SIZE_T z_set_info_len)
{
    ...
    if((_u1VdoOutFlag[pt_comp_id->ui2_id] & 
        ...
        (VDO_OUT_MODE_NORMAL_BIT_MASK|VDO_OUT_CTRL_ENABLE_BIT_MASK))
    {
        MTTVE_SetDacMuteMask(u1DacIdx, MTTVE_DAC_MUTE_MASK_MW, FALSE);
    }
    else
    {
        MTTVE_SetDacMuteMask(u1DacIdx, MTTVE_DAC_MUTE_MASK_MW, TRUE);
    }
