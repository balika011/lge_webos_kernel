...
(DRV_COMP_ID_T* ptCompId, DRV_GET_TYPE_T eType, VOID* pvData, SIZE_T* pzSize)
{
    INT32 i4Ret = RMR_OK;
    INT32 i4_value;
	MM_SRC_TYPE_T eMMSrcType = MM_SRC_TYPE_UNKNOWN;
    ...
    case STC_CTRL_GET_TYPE_STC:
        ...
        MTSTC_GetStcValue(ptCompId->ui2_id,(UINT32*)(pvData));
#else
        *(UINT32*)pvData = MTSTC_GetStcValue();
#endif
        MTSWDMX_GetInfo ( 0, MTSWDMX_GET_MM_SRC_TYPE, (UINT32 *)(&eMMSrcType), 0, 0 );
		if( eMMSrcType != MM_SRC_TYPE_UNKNOWN && eMMSrcType != MM_SRC_TYPE_NETWORK_NETFLIX)
		{
...
(DRV_COMP_ID_T* ptCompId, DRV_SET_TYPE_T eType, const VOID* pvData, SIZE_T zSize)
{
    ...
    case STC_CTRL_SET_TYPE_CTRL:
        ...
        {
#ifdef CC_53XX_SWDMX_V2
            MTSTC_StartStc((UINT8)ptCompId->ui2_id);
#else
            MTSTC_StartStc();
#endif
        }
        ...
        {
#ifdef CC_53XX_SWDMX_V2
            MTSTC_StopStc((UINT8)ptCompId->ui2_id);
#else
            MTSTC_StopStc();
#endif
        }
...
#ifdef CC_53XX_SWDMX_V2
        MTSTC_SetStcValue((UINT8)ptCompId->ui2_id, (UINT32)pvData);
#else
        MTSTC_SetStcValue((UINT32)pvData);
#endif
        break;
    ...
    case STC_CTRL_SET_TYPE_AV_SYNC_MODE:
        ...
        {
#ifdef CC_53XX_SWDMX_V2
            MTSTC_SetSyncMode((UINT8)ptCompId->ui2_id, 0, 0, MTSTC_AV_SYNC_MODE_AUDIO_MASTER);
#else
            MTSTC_SetSyncMode(MTSTC_AV_SYNC_MODE_AUDIO_MASTER);
#endif
        }
        else if (_aeStcAvSyncMode[ptCompId->ui2_id] == STC_AV_SYNC_MODE_VIDEO_MASTER)
        {
#ifdef CC_53XX_SWDMX_V2
            MTSTC_SetSyncMode((UINT8)ptCompId->ui2_id, 0, 0, MTSTC_AV_SYNC_MODE_VIDEO_MASTER);
#else
            MTSTC_SetSyncMode(MTSTC_AV_SYNC_MODE_VIDEO_MASTER);
#endif
        }
        else if (_aeStcAvSyncMode[ptCompId->ui2_id] == STC_AV_SYNC_MODE_SYSTEM_MASTER)
        {
#ifdef CC_53XX_SWDMX_V2
            MTSTC_SetSyncMode((UINT8)ptCompId->ui2_id, 0, 0, MTSTC_AV_SYNC_MODE_SYSTEM_MASTER);
#else
            MTSTC_SetSyncMode(MTSTC_AV_SYNC_MODE_SYSTEM_MASTER);
#endif
        }
        else
        {
...
#ifdef CC_53XX_SWDMX_V2
            MTSTC_SetSyncMode((UINT8)ptCompId->ui2_id, 0, 0, MTSTC_AV_SYNC_MODE_NONE);
#else
            MTSTC_SetSyncMode(MTSTC_AV_SYNC_MODE_NONE);
#endif
        }
        break;
