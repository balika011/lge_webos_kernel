...
#define DRV_VDO_QTYMSK_ETI                      (1<<DRV_VDO_QTY_ETI)
...
#define DRV_VDO_VGA_HPOS                        4
#define DRV_VDO_VGA_VPOS                        5
...
#define DRV_VDO_VGAMSK_HPOS                     (1<<DRV_VDO_VGA_HPOS)
#define DRV_VDO_VGAMSK_VPOS                     (1<<DRV_VDO_VGA_VPOS)
...
typedef enum
{
    DRV_VDO_3D_2D_ONLY,
    DRV_VDO_3D_WO_FORCE,
    DRV_VDO_3D_FORCE_2D_L, 
    DRV_VDO_3D_FORCE_2D_R
} DRV_VDO_3DTV_STATUS_T;
...
{                               
    ...
    DRV_AUD_CT_LPCM,   // 20    
    DRV_AUD_CT_FMRDO,           
    DRV_AUD_CT_FMRDO_DET,       
    DRV_AUD_CT_SBCDEC,          
    DRV_AUD_CT_SBCENC,          
    DRV_AUD_CT_MP3ENC,   // 25  
    DRV_AUD_CT_G711DEC,  // 26  
    DRV_AUD_CT_G711ENC,  // 27  
    DRV_AUD_CT_DRA,
    DRV_AUD_CT_AUTO                  
...
typedef enum
{
    TUNER_MSG_TYPE_SETFREQ,                           ///< PSI message
    TUNER_MSG_TYPE_SEARCH                            ///< PES message
} TUNER_MSG_TYPE_T;

/// Tuner frame data (section or PES) structure
typedef struct
{
    BOOL fgLock;
    UINT32 u4Freq;
...
/// Tuner message structure
typedef struct
{
    TUNER_MSG_TYPE_T      eType;                  ///< Message type
    UINT8               u1Id;                   ///< Filter id or PID id
    DRV_TUNER_DATA_T      rData;                  ///< Type specific data
    void*               pvNotifyTag;            ///< User tag value
} DRV_TUNER_MSG_T;
...
typedef struct
{
    ...
    DRV_IR_TYPE_T           rIrType;
    PFN_DRV_CALLBACK        pfnBtnEvent;
} DRV_IR_PARAM_T;
#else
...
// Video and display
//
extern DRV_ERR_CODE_T DRV_VDO_Init(void);
...
extern DRV_ERR_CODE_T DRV_VDO_SetOverScanRatio(UINT8 u1VideoIndex,
    UINT32 t, UINT32 b, UINT32 l, UINT32 r);
...
extern DRV_ERR_CODE_T DRV_VDO_Set3DTV(UINT8 u1VideoIndex, 
    DRV_VDO_3DTV_STATUS_T r3DStatus);
...
extern DRV_ERR_CODE_T DRV_VDO_GetScartFs (UINT8 u1VideoIndex, 
    DRV_VDO_SCART_FS_T* prScartFs, INT32 i4Tag);
    
extern DRV_ERR_CODE_T DRV_VDO_SetPtsNfy(UINT8 u1VideoIndex, 
	UINT64 u8Pts);

extern DRV_ERR_CODE_T DRV_VDO_GetMessage(INT32 i4Tag);
    
extern DRV_ERR_CODE_T DRV_VDO_Auto(UINT8 u1VideoIndex);

extern DRV_ERR_CODE_T DRV_VDO_Autocolor(UINT8 u1VideoIndex);
    
extern DRV_ERR_CODE_T DRV_VDO_GetStc(UINT8 u1VideoIndex, 
	UINT64* pu8Stc);
extern DRV_ERR_CODE_T DRV_VDO_SetScrambleChgNfy(void* pvScrambleChgNfy);

extern DRV_ERR_CODE_T DRV_TVE_CTRL_Enable(UINT8 bEnable);
//
// Audio
//
extern DRV_ERR_CODE_T DRV_AUD_Init(void);
...
extern DRV_ERR_CODE_T DRV_AUD_SetScrambleChgNfy(void* pvScrambleChgNfy);
...
extern DRV_ERR_CODE_T DRV_OSD_SetPlaneSwitchOrder(UINT32 u4TopPlane, UINT32 u4MidPlane, UINT32 u4BotPlane);
#endif
...
extern DRV_ERR_CODE_T DRV_OSD_RGN_SetAlphaMode(UINT32 u4RgnID, DRV_OSD_BLEND_MODE_T eMode);
    
//
// Graphics
//
extern DRV_ERR_CODE_T DRV_GFX_Init(void);

extern DRV_ERR_CODE_T DRV_GFX_BitBlt(DRV_COLOR_MODE_T rColorMode,
    DRV_GFX_BLIT_T* prBlit);

extern DRV_ERR_CODE_T DRV_GFX_StretchBlt(DRV_COLOR_MODE_T rColorMode,
    DRV_GFX_STRETCHBLIT_T* prBlit);
...
// Demux
//
extern DRV_ERR_CODE_T DRV_DMX_SetPid(UINT8 u1Pidx, UINT32 u4Flags, const DMX_PID_T* prPid);
...
// Tuner
//
extern DRV_ERR_CODE_T DRV_TUNER_Init(void);
...
extern DRV_ERR_CODE_T DRV_TUNER_Search(UINT32* pu4Freq, DRV_TUNER_CONN_TYPE_T rType, 
    DRV_TV_SYS_T rTvSys, UINT32 u4EndFreq, void* pvTag);
...
extern DRV_ERR_CODE_T DRV_TUNER_GetMessage(UINT8 u1MsgId, DRV_TUNER_MSG_T* prMsg);

extern DRV_ERR_CODE_T DRV_TUNER_SetBreak(void);
...
// System related
//
extern DRV_ERR_CODE_T DRV_SYS_Init(void);
...
extern DRV_ERR_CODE_T DRV_SYS_GetTime(UINT64 *pu8Utc);
...
extern UINT32 DRV_SYS_AllocDmaMemory(UINT32 u4Size);

extern UINT32 DRV_SYS_AllocAlignedDmaMemory(UINT32 u4Size,
    UINT32 u4Alignment);

extern BOOL DRV_SYS_FreeDmaMemory(UINT32 uUserAddr);

extern BOOL DRV_SYS_FreeAlignedDmaMemory(UINT32 uUserAddr);

extern void DRV_SYS_FlushInvalidateCache(void);

EXTERN DRV_ERR_CODE_T DRV_TVE_Init(void);
EXTERN DRV_ERR_CODE_T DRV_TVE_SetSource(UINT8 u1ScartIdx, UINT8 u1Source);
EXTERN DRV_ERR_CODE_T DRV_TVE_Start(UINT8 u1ScartIdx);
EXTERN DRV_ERR_CODE_T DRV_TVE_Stop(UINT8 u1ScartIdx);
EXTERN void _TveNotifySigChg(UINT8 bPath, UINT8 u1SigState);
EXTERN void _TveNotifyUnmute(UINT8 bPath);
#endif  // X_DRV_IF_H
