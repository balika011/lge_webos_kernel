...
export OBJ_DIR=$(OBJ_ROOT)/tz_secure/sfbm/$(COMP_PATH)

include $(SFBM_MAK)/files.mak
DRV_ROOT=$(PROJECT_ROOT)/target/$(TARGET_IC)
include $(SFBM_MAK)/target.mak
