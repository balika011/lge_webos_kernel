...
#define ERR_CRYPTO_CRYPTO               (ERR_CRYPTO_BASE|8) /* any other crypto err */
    ...
    /*========================================================================*/
    /**
     * @brief  Initializes CRYPTO context
     *
     * Initializes the crypto handle with cipher type, cipher operation,
     * padding mode, Initial Vector and key data
     *
     * @param[out] out_crypto crypto handle
     * @param[in] in_type cipher type (AES) |
     *                         direction (ENC, DEC, CTR) |
     *                         encryption mode (ECB, CBC, CTR) |
     *                         padding mode (NONE, PKCS5, NULL, SPACE)
     * @param[in] in_modedata  Intitial data specific to the mode used. This is either
     *                         the initialization vector in the case of CBC or initial
     *                         counter value for CTR. For ECB it is not required.
     * @param[in] in_modedata_len initial mode data length
     * @param[in] in_saltBuf salt value used in AES counter mode
     * @param[in] in_keyBuf key data
     * @param[in] in_keyLen key length
     *
     * @return ::ERR_OK                             <br>succesful completion
     ...
     * @return ::ERR_CRYPTO_STATUS                  <br>If the parameters in crypto handle are not valid
     * @return ::ERR_CRYPTO_KEY                     <br>If there is an error in key expansion
     * @return ::ERR_CRYPTO_INIT                    <br>If there is an error in crypto initialization
     * @return ::ERR_CRYPTO_CRYPTO                  <br>If some crypto error has happened
     */
    /*========================================================================*/
    retcode_t
    crypto_Init(
        crypto_handle_t     *out_crypto,
        u_int32_t            in_type,
    ...
    /*========================================================================*/
    /**
     * @brief  Finalizes CRYPTO context
     *
     * Destroys crypto handle
     *
     * @param[in] in_crypto crypto handle
     *
     * @return ::ERR_OK                             <br>succesful completion
     * @return ::ERR_ILLEGALARGS                    <br>The input arguments are incorrect. Arguments cannot be NULL
     * @return ::ERR_INTERNALERROR                  <br>An unrecoverable error has occurred in Nautilus
    ...
    /*========================================================================*/
    /**
     * @brief  Encrypts the input plain text
     *
     * Performs the encryption using the information available in
     * crypto handle
     *
     ...
     * @return ::ERR_INTERNALERROR                  <br>An unrecoverable error has occurred in Nautilus
     * @return ::ERR_CRYPTO_STATUS                  <br>If the parameters in crypto handle are not valid
     * @return ::ERR_CRYPTO_ENCRYPT                 <br>If there is an error in encryption
     * @return ::ERR_CRYPTO_CRYPTO                  <br>If some other crypto error has happened
     */
    /*========================================================================*/
    retcode_t
    crypto_Encrypt(
    ...
    /*========================================================================*/
    /**
     * @brief  Decrypts the input cipher text
     *
     * Performs the decryption using the information available in
     * crypto handle
     *
     ...
     * @return ::ERR_CRYPTO_STATUS                  <br>If the parameters in crypto handle are not valid
     * @return ::ERR_CRYPTO_ENCRYPT                 <br>If there is an error in encryption
     * @return ::ERR_CRYPTO_DECRYPT                 <br>If there is an error in decryption
     * @return ::ERR_CRYPTO_CRYPTO                  <br>If some crypto error has happened
     */
    /*========================================================================*/
    retcode_t
    ...
    /*========================================================================*/
    /**
     * @brief  Gets the counter value for AES CTR mode Encryption/Decryption
     *
     * @param[in]  in_crypto     crypto handle
     * @param[in]  in_buflen     size of the output buffer (must be the AES block size)
     * @param[out] out_buf       destination buffer for the counter
     *
     * @return ::ERR_OK                             <br>Succesful completion
     * @return ::ERR_ILLEGALHANDLE                  <br>The crypto handle is incorrect
     * @return ::ERR_ILLEGALARGS                    <br>The input arguments are incorrect.
     */
    /*========================================================================*/
    retcode_t
    ...
    /*========================================================================*/
    /**
     * @brief  Encrypts n blocks with AES128-CBC mode/PKCS5 padding
     *
     * Encrypts multi block plain text using AES algorithm in CBC mode
     *
     * @param[in] in_ivBuf  Initial Vector
     * @param[in] in_keyBuf Initial Vector Length
     * @param[in] in_plainBuf plain text buffer
     * @param[in] in_plainLen plain text Length
     * @param[out] out_cipherBuf cipher text buffer
     * @param[out] io_cipherLen  cipher text Length
     *
     * @return ::ERR_OK                             <br>succesful completion
     * @return ::ERR_NOMEM                          <br>A resource failure has occurred
     * @return ::ERR_ILLEGALARGS                    <br>The input arguments are incorrect. Arguments cannot be NULL
    ...
    */
    ...
    /*========================================================================*/
    /**
     * @brief  Decrypts n blocks with AES128-CBC mode/PKCS5 padding
     *
     * Decrypts multi block plain text using AES algorithm in CBC mode
     *
     * @param[in] in_ivBuf Initial Vector
     * @param[in] in_keyBuf Initial Vector Length
     * @param[in] in_cipherBuf cipher text buffer
     * @param[in] in_cipherLen cipher text Length
     * @param[out] out_plainBuf plain text buffer
     * @param[out] io_plainLen plain text Length
     *
     * @return ::ERR_OK                             <br>succesful completion
     * @return ::ERR_NOMEM                          <br>A resource failure has occurred
     * @return ::ERR_ILLEGALARGS                    <br>The input arguments are incorrect. Arguments cannot be NULL
     ...
     *
     * Decrypts single block plain text using AES algorithm
     *
     * @param[in] in_keyBuf Initial Vector
     * @param[in] in_cipherBuf cipher text buffer
     * @param[out] out_plainBuf plain text buffer
     *
     * @return ::ERR_OK                             <br>succesful completion
     ...
     * @return ::ERR_AES_KEY_MAT                    <br>If invalid key length is supplied
     * @return ::ERR_CRYPTO_STATUS                  <br>If the parameters in crypto handle are not valid
     * @return ::ERR_CRYPTO_ENCRYPT                 <br>If there is an error in decryption
     * @return ::ERR_CRYPTO_DECRYPT                 <br>If there is an error in decryption
     * @return ::ERR_CRYPTO_KEY                     <br>If there is an error in key expansion
     * @return ::ERR_CRYPTO_INIT                    <br>If there is an error in crypto initialization
     * @return ::ERR_CRYPTO_CRYPTO                  <br>If some crypto error has happened
