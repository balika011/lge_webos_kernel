/*------------------------------------------------------------------------------
  ...
  Last Updated  : 2012-03-28 09:40:32
...
/*------------------------------------------------------------------------------
  Common functions
------------------------------------------------------------------------------*/
INT32 sony_Convert2SComplement(UINT32 value, UINT32 bitlen);
UINT32 sony_BitSplitFromByteArray(UINT8 *pArray, UINT32 startBit, UINT32 bitNum);
/*------------------------------------------------------------------------------
  Trace
------------------------------------------------------------------------------*/
/*
...
/**
 ...
 @return SONY_RESULT_OK is succesful.
*/
sony_result_t sony_stopwatch_sleep (sony_stopwatch_t * pStopwatch, UINT32 ms);
...
*/
sony_result_t sony_stopwatch_elapsed (sony_stopwatch_t * pStopwatch, UINT32* pElapsed);
