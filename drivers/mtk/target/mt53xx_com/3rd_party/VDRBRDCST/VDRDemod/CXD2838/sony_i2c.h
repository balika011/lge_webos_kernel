...
typedef struct sony_i2c_t {
    ...
    */
    sony_result_t (*Read)(struct sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8* pData, UINT32 size, UINT8 mode);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
    sony_result_t (*Write)(struct sony_i2c_t* pI2c, UINT8 deviceAddress, const UINT8 *pData, UINT32 size, UINT8 mode);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
    sony_result_t (*ReadRegister)(struct sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, UINT8* pData, UINT32 size);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
    sony_result_t (*WriteRegister)(struct sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, const UINT8 *pData, UINT32 size);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
    sony_result_t (*WriteOneRegister)(struct sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, UINT8 data);
...
*/
sony_result_t sony_i2c_CommonReadRegister(sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, UINT8* pData, UINT32 size);
/**
 ...
 @return SONY_RESULT_OK if successful.
*/
sony_result_t sony_i2c_CommonWriteRegister(sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, const UINT8* pData, UINT32 size);
/**
 ...
 @return SONY_RESULT_OK if successful.
*/
sony_result_t sony_i2c_CommonWriteOneRegister(sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, UINT8 data);
...
*/
sony_result_t sony_i2c_SetRegisterBits(sony_i2c_t* pI2c, UINT8 deviceAddress, UINT8 subAddress, UINT8 data, UINT8 mask);
