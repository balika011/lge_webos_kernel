...
static INT8 Adjust_Si2158_i4Power_rec_val = 0;
...
UINT32 Si2158_GetSSI(ITUNER_CTX_T* pTunerCtx) 
{
	...
	if(pTunerCtx->sSSIPara.i2Bw == SAW_BW_8M)
	{
        ...
        i4Power_rec = i4Power_rec - Adjust_Si2158_i4Power_rec_val - 2;   
    }
    else
    {
        mcDBG_MSG_L2(("DVBT:7M Real_i4Power_rec = %d\n",i4Power_rec));
        i4Power_rec = i4Power_rec - Adjust_Si2158_i4Power_rec_val + 1;
    }
