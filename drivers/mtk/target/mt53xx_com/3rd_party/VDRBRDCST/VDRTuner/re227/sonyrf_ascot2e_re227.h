...
------------------------------------------------------------------------------*/
#ifndef SONYRF_ASCOT2E_RE227_H
#define SONYRF_ASCOT2E_RE227_H
...
/*------------------------------------------------------------------------------
  Global variables
------------------------------------------------------------------------------*/
extern uint32_t g_TrapThresholdFrequencyDigital;
extern uint32_t g_TrapThresholdFrequencyAnalog;
