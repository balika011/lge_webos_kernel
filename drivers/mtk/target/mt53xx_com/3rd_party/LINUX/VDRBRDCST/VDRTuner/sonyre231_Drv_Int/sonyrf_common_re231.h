...
/*------------------------------------------------------------------------------
  Common functions
------------------------------------------------------------------------------*/
int32_t sonyrf_Convert2SComplement_re231(uint32_t value, uint32_t bitlen);
...
#define SONYRF_TRACE_ENTER(func) sonyrf_trace_log_enter_re231((func), __FILE__, __LINE__)
#define SONYRF_TRACE_RETURN(result) do{sonyrf_trace_log_return_re231((result), __FILE__, __LINE__); return (result);}while(0)
...
#define SONYRF_TRACE_I2C_ENTER(func) sonyrf_trace_i2c_log_enter_re231((func), __FILE__, __LINE__)
#define SONYRF_TRACE_I2C_RETURN(result) do{sonyrf_trace_i2c_log_return_re231((result), __FILE__, __LINE__); return (result);}while(0)
