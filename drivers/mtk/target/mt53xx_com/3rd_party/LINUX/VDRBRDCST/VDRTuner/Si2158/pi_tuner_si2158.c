 ...
 * $Author: p4admin $
 * $Date: 2015/02/15 $
 * $RCSfile: pi_tuner_SI2158.c,v $
 * $Revision: #1 $
 *
 *---------------------------------------------------------------------------*/
/* Silabs version 0C build 5  4/2012 */
// changes tagged with Silabs_120425
/** @file pi_tuner_Si2158.c
 *  Tuner control for SS SI2158
 */
...
#include "Si2158_firmware_0_C_build_8.h"  //Silabs_120425 - new firmware version 0Cb5
#include "Si2158_firmware_0_E_build_15.h"  //Silabs_120820 - new firmware version 0Eb15 (Si2158-A0E)
// Currently Si2158-A20 boots from NVM with no patch requirement.   A dummy patch (no download) is implemented for easy replacement in the future.
#include "Si2158_firmware_2_0_build_x.h"  //Silabs_120820 dummy patch for ROM33         (Si2158-A20)

#include "Si2158_i2c_api.h"
#include "eq_script_si2158.h"
#ifdef CC_GPIO_RESET_TUNER
#include "x_gpio.h"
...
#define SI2158_ENABLE_EXTERNAL_ATV_AGC_CONTROL 1//for SI2158 ATV AGC source selection, 0 for internal, 1 for external
#define SI2158_ENABLE_EXTERNAL_DTV_AGC_CONTROL 1//for SI2158 DTV AGC source selection, 0 for internal, 1 for external

//-----------------------------------------------------------------------------
// Constant definitions
//-----------------------------------------------------------------------------
//Frequency boundary .Get from tuner spec
#define C_Si2158_FREQ_DBOUND_UPPER   859*1000*1000
#define C_Si2158_FREQ_DBOUND_LOWER    48*1000*1000
#define C_Si2158_FREQ_DBOUND_UPPER_Ana     875*1000*1000
#define C_Si2158_FREQ_DBOUND_LOWER_Ana    45*1000*1000
...
#define C_Si2158_PF_TO_CF_SHIFT_BG_7M 2250 /*KHZ*/  //PF to CF is 2250 when 7M B
#define C_Si2158_PF_TO_CF_SHIFT_BG_8M 2750 /*KHZ*/  //PF to CF is 2750 when 8M G
...
#define C_Si2158_IF_CENTER_BG 5000 /*KHZ*/
...
#define C_Si2158_IF_FREQUENCY          ((UINT16)  5000)  /* kHz */
#define C_Si2158_LO_ADDRESS           ((UINT8)  0xC0)

#define C_Si2158_LO_DIVIDER_STEP       ((UINT32) 1000)  /* Hz */
#define C_Si2158_LO_DIVIDER_STEP_ANA   ((UINT16)  1000)  /* Hz */
#define C_SILABS_Si2158_STR            "SILABS_Si2158-A20\n 2012-08-03\n v1.0 \n"

#define C_Si2158_TOP_SET             ((UINT8)   0x02) 
#define C_Si2158_TOP_SET_DVBC        ((UINT8)   0x04) 
#define C_Si2158_TOP_SET_ANA         ((UINT8)   0x0A) 
#define C_Si2158_SAW_BW              SAW_BW_8M 

#if SI2158_ENABLE_EXTERNAL_DTV_AGC_CONTROL
#define C_Si2158_AGC_IF_SLP           0.19
#define C_Si2158_AGC_IF_INT           -0.24
#define C_Si2158_AGC_IF_MAX           0.52
#define C_Si2158_AGC_IF_MIN           -1
#else
#define C_Si2158_AGC_IF_SLP           0.125	
#define C_Si2158_AGC_IF_INT           0.5   
#define C_Si2158_AGC_IF_MAX           0.499  // 0.5 will overflow  //0v
#define C_Si2158_AGC_IF_MIN          0.0  
#endif
#define C_Si2158_AGC_IF_SLP_SGN  (INT8)((C_Si2158_AGC_IF_SLP>0)?1:-1) 
#define C_Si2158_AGC_IF_LVL_MAX      0.4774    //-90dBm    127/256
#define C_Si2158_AGC_IF_LVL_MIN      0.08203125   //-60dBm  21/256
...
#define C_Si2158_MAX_IF_GAIN_SET       -0.12   
#define C_Si2158_MIN_IF_GAIN_SET       -0.38   
#define C_Si2158_MAX_RF_GAIN_SET        cALC_ADC_BIAS *2   // Volt
#define C_Si2158_MIN_RF_GAIN_SET        cALC_ADC_BIAS *2   // Volt
#define C_Si2158_MAX_IF_GAIN_POW       -100    // dBm
#define C_Si2158_MIN_IF_GAIN_POW		-50     // dBm
#define C_Si2158_MAX_RF_GAIN_POW		 C_Si2158_MIN_IF_GAIN_POW
#define C_Si2158_MIN_RF_GAIN_POW		-20     // dBm
#define C_Si2158_POWER_CALIBRATE        26     // dBm

#define C_Si2158_AGC_COEF			((UINT8)   0xBD)
#define C_Si2158_DEMOD_INPUT_POWER	cIF_TARGET_LEVEL_0CCC_0D36

// ********************************************* //

#define C_U8_Si2158_AGC_IF_SLP         (INT8)(C_Si2158_AGC_IF_SLP *64 )  // MT5135(S(1, -6)), -0.125*64 = -8 (0xF8), -8/64 = -1/8
#define C_U8_Si2158_AGC_IF_INT         (INT8)(C_Si2158_AGC_IF_INT *16 ) // MT5135(S(3, -4))  0.5*16 = 8, 8/16 =0.5
#define C_U8_Si2158_AGC_IF_MAX         (INT8)(C_Si2158_AGC_IF_MAX *128)    //0.499*256 = 0x7F
#define C_U8_Si2158_AGC_IF_MIN         (INT8)(C_Si2158_AGC_IF_MIN *128)    //0
#define C_U8_Si2158_AGC_IF_LVL_MAX        (INT8)(C_Si2158_AGC_IF_LVL_MAX *256)
#define C_U8_Si2158_AGC_IF_LVL_MIN         (INT8)(C_Si2158_AGC_IF_LVL_MIN *256)

#define C_U8_Si2158_MAX_IF_GAIN_SET	(INT8)(C_Si2158_MAX_IF_GAIN_SET *256)
#define C_U8_Si2158_MIN_IF_GAIN_SET	(INT8)(C_Si2158_MIN_IF_GAIN_SET *256)
#define C_U8_Si2158_MAX_RF_GAIN_SET	(INT8)((C_Si2158_MAX_RF_GAIN_SET /2 -cALC_ADC_BIAS) /cALC_ADC_INPUT_SWING *256)
#define C_U8_Si2158_MIN_RF_GAIN_SET	(INT8)((C_Si2158_MIN_RF_GAIN_SET /2 -cALC_ADC_BIAS) /cALC_ADC_INPUT_SWING *256)
#define C_U8_Si2158_IF_GAIN_RANGE      (INT8)(C_Si2158_MIN_IF_GAIN_POW - C_Si2158_MAX_IF_GAIN_POW)
#define C_U8_Si2158_RF_GAIN_RANGE      (INT8)(C_Si2158_MIN_RF_GAIN_POW - C_Si2158_MAX_RF_GAIN_POW)

static UINT8* pSi2158[MOD_ANA_TYPE_END - MOD_ANA_TYPE_BEGIN] = {NULL};
static UINT8* pSi2158EqWeak[MOD_ANA_TYPE_END - MOD_ANA_TYPE_BEGIN] = {NULL};

static ATD_TUNER_REL_REG_T arrAtdRelReg[]={
#if !(defined(CC_MT5365) || defined(CC_MT5395))
    #if SI2158_ENABLE_EXTERNAL_ATV_AGC_CONTROL
	{0x794,0x2a},
	{0x7a4,0x2a},
	{0x7d4,0x04},
	{0x7d5,0xfb},
...
#else
static unsigned char DVBT_IF_AMP=21;//Si2158_DTV_LIF_OUT_PROP_AMP_DEFAULT;
static unsigned char DVBT2_IF_AMP=21;
static unsigned char DVBC_IF_AMP=26;//Si2158_DTV_LIF_OUT_PROP_AMP_DEFAULT;
static unsigned char ATSC_8VSB_IF_AMP = 21;
static unsigned char ATSC_QAM_IF_AMP = 21;

#endif

static unsigned char NO_L_ANALOG_IF_AMP=160;//Si2158_ATV_LIF_OUT_PROP_AMP_DEFAULT;  //100 -->1Vpp RMS
static unsigned char L_ANALOG_IF_AMP=100;//SECAML/L1


static unsigned char NO_L_DIGITAL_IF_AMP=Si2158_DTV_LIF_OUT_PROP_AMP_DEFAULT;
static BOOL TunerInited = FALSE;
#ifdef CC_GPIO_RESET_TUNER
static BOOL GpioReseted = FALSE;
#endif

#ifdef    Si2158_GET_PROPERTY_STRING
static unsigned int aui2Si2158Properties[] = {
	Si2158_ATV_AFC_RANGE_PROP_CODE,
	Si2158_ATV_AGC_SPEED_PROP_CODE,
	Si2158_ATV_CONFIG_IF_PORT_PROP_CODE,
	Si2158_ATV_EXT_AGC_PROP_CODE,
	Si2158_ATV_IEN_PROP_CODE,
	Si2158_ATV_INT_SENSE_PROP_CODE,
	Si2158_ATV_LIF_FREQ_PROP_CODE,
	Si2158_ATV_LIF_OUT_PROP_CODE,
	Si2158_ATV_RF_TOP_PROP_CODE,
	Si2158_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE,
	Si2158_ATV_VIDEO_MODE_PROP_CODE,
	Si2158_ATV_VSNR_CAP_PROP_CODE,
	Si2158_CRYSTAL_TRIM_PROP_CODE,
	Si2158_DTV_AGC_SPEED_PROP_CODE,
	Si2158_DTV_CONFIG_IF_PORT_PROP_CODE,
	Si2158_DTV_EXT_AGC_PROP_CODE,
	Si2158_DTV_FILTER_SELECT_PROP_CODE,
	Si2158_DTV_IEN_PROP_CODE,
	Si2158_DTV_INITIAL_AGC_SPEED_PROP_CODE,
	Si2158_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE,
	Si2158_DTV_INT_SENSE_PROP_CODE,
	Si2158_DTV_LIF_FREQ_PROP_CODE,
	Si2158_DTV_LIF_OUT_PROP_CODE,
	Si2158_DTV_MODE_PROP_CODE,
	Si2158_DTV_RF_TOP_PROP_CODE,
	Si2158_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE,
	Si2158_MASTER_IEN_PROP_CODE,
	Si2158_TUNER_BLOCKED_VCO_PROP_CODE,
	Si2158_TUNER_IEN_PROP_CODE,
	Si2158_TUNER_INT_SENSE_PROP_CODE,
	Si2158_TUNER_LO_INJECTION_PROP_CODE
	};
static char acSi2158ProMsg[100];
#endif
...
//-----------------------------------------------------------------------------
//-------------------------------------------------------------static  variable----------------------------------------------------------------------------------------------------------------------
L1_Si2158_Context api_context={0};
L1_Si2158_Context *api;
UINT8 VideoStandard;
...
static INT8 Adjust_Si2158_i4Power_rec = 0;
		...
		case MOD_PAL_BG:  /*wenming 11-12-2: BG PC to Center is by 7M or 8M BW*/
			{
				...
				{
					cf = pc + C_Si2158_PF_TO_CF_SHIFT_BG_8M*1000;
				...
				else
				{
					...
					{
						cf = pc + C_Si2158_PF_TO_CF_SHIFT_BG_7M*1000;
			...
			break;
		case MOD_PAL_DK:
			cf = pc + C_Si2158_PF_TO_CF_SHIFT_DK*1000;
			break;
		case MOD_PAL_I:
			cf = pc + C_Si2158_PF_TO_CF_SHIFT_I*1000;
			break;
		case MOD_NTSC_M:
            cf = pc + C_Si2158_PF_TO_CF_SHIFT_M*1000;
            break;
        case MOD_SECAM_L:
            cf = pc + C_Si2158_PF_TO_CF_SHIFT_L*1000;
            break;
        case MOD_SECAM_L1:
            cf = pc - C_Si2158_PF_TO_CF_SHIFT_L1*1000;
            break;
	}
	return cf;
}
...
int Si2158_LoadFirmware_16        (L1_Si2158_Context *api, firmware_struct fw_table[], int nbLines)
{
    ...
    mcDBG_MSG_L2 (("Si2158_LoadFirmware_16 starting...\n"));
    mcDBG_MSG_L2 (("Si2158_LoadFirmware_16 nbLines %d\n", nbLines));
    ...
    for (line = 0; line < nbLines; line++)
    {
		if (fw_table[line].firmware_len > 0)  /* don't download if length is 0 , e.g. dummy firmware */
		{
			...
			{
			  mcDBG_MSG_ERR(("Si2158_LoadFirmware_16 error 0x%02x patching line %d: %s\n", return_code, line, Si2158_L1_API_ERROR_TEXT(return_code) ));
			  if (line == 0) {
    ...
    mcDBG_MSG_L2 (("Si2158_LoadFirmware_16 complete...\n"));
...
int Si2158_LoadFirmware        (L1_Si2158_Context *api, unsigned char fw_table[], int nbLines)
{
   ...
   mcDBG_MSG_L2(("Si2158_LoadFirmware starting...\n"));
    mcDBG_MSG_L2 (("Si2158_LoadFirmware nbLines %d\n", nbLines));
    ...
    for (line = 0; line < nbLines; line++)
    {
        ...
        {
          mcDBG_MSG_ERR(("Si2158_LoadFirmware error 0x%02x patching line %d: %s\n", return_code, line, Si2158_L1_API_ERROR_TEXT(return_code) ));
          if (line == 0) {
          mcDBG_MSG_L2(("The firmware is incompatible with the part!\n"));
          }
          return ERROR_Si2158_LOADING_FIRMWARE;
    ...
    mcDBG_MSG_L2(("traces resume"));
    mcDBG_MSG_L2 (("Si2158_LoadFirmware complete...\n"));
    return NO_Si2158_ERROR;
}
//Silabs_120425 added Si2158_LoadVideofilter() for future use of video filter option.
/************************************************************************************************************************
...
int Si2158_Configure           (L1_Si2158_Context *api)
{
    ...
    api->prop->tuner_ien.tcien = Si2158_TUNER_IEN_PROP_TCIEN_ENABLE;
    api->prop->tuner_ien.rssilien = Si2158_TUNER_IEN_PROP_RSSILIEN_DISABLE;
    api->prop->tuner_ien.rssihien = Si2158_TUNER_IEN_PROP_RSSIHIEN_DISABLE;
    if ((return_code=Si2158_L1_SetProperty2(api,Si2158_TUNER_IEN_PROP)) != 0)
    {
       SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
       return return_code;
    }
    api->prop->dtv_ien.chlien = Si2158_DTV_IEN_PROP_CHLIEN_ENABLE;
    if ((return_code=Si2158_L1_SetProperty2(api,Si2158_DTV_IEN_PROP)) != 0)
    {
       SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
       return return_code;
    }
     api->prop->atv_ien.chlien = Si2158_ATV_IEN_PROP_CHLIEN_ENABLE;
     api->prop->atv_ien.pclien = Si2158_ATV_IEN_PROP_PCLIEN_DISABLE;
    if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_IEN_PROP)) != 0)
    {
       SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
       return return_code;
    }
    ...
    if ((return_code=Si2158_L1_SetProperty2(api,Si2158_DTV_MODE_PROP)) != 0)
    {
       SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
       return return_code;
    }
    ...
    api->prop->atv_video_mode.invert_spectrum= Si2158_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_NORMAL;
     // Silabs_120425 Removed. api->prop->atv_video_mode.trans = Si2158_ATV_VIDEO_MODE_PROP_TRANS_TERRESTRIAL;
    api->prop->atv_video_mode.video_sys = Si2158_ATV_VIDEO_MODE_PROP_VIDEO_SYS_GH;
   if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_VIDEO_MODE_PROP)) != 0)
    {
       SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
       return return_code;
    }
	api->prop->atv_agc_speed.if_agc_speed= Si2158_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_185; 
	   if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_AGC_SPEED_PROP)) != 0)
		{
		   SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
		   return return_code;
		}
	...
	api->prop->atv_config_if_port.atv_agc_source=Si2158_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_AGC1_3DB; 
	api->prop->atv_ext_agc.max_10mv = 200;
	api->prop->atv_ext_agc.min_10mv = 50;
    if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_EXT_AGC_PROP)) != 0)
		{
		   SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
		   return return_code;
		}	
	...
	#else
	api->prop->atv_config_if_port.atv_agc_source = Si2158_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_INTERNAL;
	#endif
	api->prop->atv_config_if_port.atv_out_type=Si2158_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LIF_DIFF_IF1;
	   if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_CONFIG_IF_PORT_PROP)) != 0)
		{
		   SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
		   return return_code;
		}
    ...
    // Silabs_120425 was DTV_AGC_3DB	(renamed to AGC2_3DB)
	   api->prop->dtv_config_if_port.dtv_agc_source=Si2158_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_AGC1_3DB;
		api->prop->dtv_ext_agc.max_10mv = 200;
	api->prop->dtv_ext_agc.min_10mv = 50;
	 if ((return_code=Si2158_L1_SetProperty2(api,Si2158_DTV_EXT_AGC_PROP)) != 0)
		{
		   SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
		   return return_code;
		}	
	#else
	api->prop->dtv_config_if_port.dtv_agc_source = Si2158_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_INTERNAL;
	#endif
	   api->prop->dtv_config_if_port.dtv_out_type=Si2158_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LIF_IF1;
		  if ((return_code=Si2158_L1_SetProperty2(api,Si2158_DTV_CONFIG_IF_PORT_PROP)) != 0)
		   {
			  SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
			  return return_code;
		   }
	...
	if((return_code = Si2158_L1_CONFIG_PINS (api,             
	...
	{
		SiTRACE ("Si2158_L1_CONFIG_PINS error 0x%02x\n", return_code);
		return return_code;
	}
	//end FEF config
...
int Si2158_PowerUpWithPatch    (L1_Si2158_Context *api)
{
   ...
   if ((return_code = Si2158_L1_POWER_UP (api,
	...
	if (api->rsp->part_info.romid == 0x31) {
		...
		if ((return_code = Si2158_LoadFirmware(api, Si2158_FW_0_Cb8, FIRMWARE_LINES_0_Cb8)) != NO_Si2158_ERROR) {
    ...
    else if (api->rsp->part_info.romid == 0x33) /* if Si2158-A20 part load firmware patch (currently a dummy patch , 20bx) */
    {
		...
		SiTRACE("Testlog:Now is loading the A4 dummy firmware!\n");
    }
    else
    {
...
/** Si2158_TunerInit
 *  Tuner initialzation forSi2158.
 *  @param  pTCtx       Pointer of pi tuner driver context.
 *  @retval void
 */

//-----------------------------------------------------------------------------
VOID Si2158_TunerInit(
    ITUNER_CTX_T *pTCtx
    )
{    ITUNER_CTX_T *psTunerCtx = pTCtx;
   ...
   // #else
    ...
    psTunerCtx->I2cAddress = C_Si2158_LO_ADDRESS;
    psTunerCtx->u2IF_Freq = C_Si2158_IF_FREQUENCY;
	psTunerCtx->u2IF_Freq_A = 0; // C_Si2158_IF_FREQUENCY_ANA;//analog if frequency for ATD
    ...
    //ATD patch selection
    psTunerCtx->u1AtdPatchSwitch =0x09;//MASK_PATCH_CR|MASK_PATCH_SENS|MASK_PATCH_CCI|MASK_PATCH_SELECTIVITY
	...
	pEUCtx->m_SAW_BW  = C_Si2158_SAW_BW;
    pEUCtx->m_Ana_Top = C_Si2158_TOP_SET_ANA;	
	//#ifdef DTD_INCLUDE
		pUSCtx->u2LO_Step = 1000; //*1KHZ
		pUSCtx->m_aucPara_SLD[2] = (U8)C_U8_Si2158_AGC_IF_SLP;
		pUSCtx->m_aucPara_SLD[3] = (U8)C_U8_Si2158_AGC_IF_INT;
		pUSCtx->m_aucPara_SLD[4] = (U8)C_U8_Si2158_AGC_IF_MAX;
		pUSCtx->m_aucPara_SLD[5] = (U8)C_U8_Si2158_AGC_IF_MIN;
	//#else
	
	//Tuner frequency range
		pEUCtx->m_s4FreqBoundUpper = C_Si2158_FREQ_DBOUND_UPPER;
		pEUCtx->m_s4FreqBoundLower = C_Si2158_FREQ_DBOUND_LOWER;
		pEUCtx->m_s4AnaFreqBoundUpper = C_Si2158_FREQ_DBOUND_UPPER_Ana;
		pEUCtx->m_s4AnaFreqBoundLower = C_Si2158_FREQ_DBOUND_LOWER_Ana;
	// for Signal Level display
		pEUCtx->m_ifAgc_lvl_max = (UINT8)C_U8_Si2158_AGC_IF_LVL_MAX;
		pEUCtx->m_ifAgc_lvl_min = (UINT8)C_U8_Si2158_AGC_IF_LVL_MIN;
		
		pEUCtx->m_SigLvTh = 0;
		pEUCtx->m_SigLvScan = 0;
		
		pEUCtx->m_aucPara[0] = C_Si2158_TOP_SET;
		pEUCtx->m_aucPara[1] = 0;
		
		pEUCtx->m_aucPara[2] = (UINT8)C_U8_Si2158_AGC_IF_SLP;
		pEUCtx->m_aucPara[3] = (UINT8)C_U8_Si2158_AGC_IF_INT;
		pEUCtx->m_aucPara[4] = (UINT8)C_U8_Si2158_AGC_IF_MAX;
		pEUCtx->m_aucPara[5] = (UINT8)C_U8_Si2158_AGC_IF_MIN;
		
		pEUCtx->m_aucPara[6] = C_Si2158_AGC_COEF;
		pEUCtx->m_aucPara[7] = C_Si2158_DEMOD_INPUT_POWER;
		
		pEUCtx->m_aucPara[ 8] = (UINT8)C_U8_Si2158_MAX_IF_GAIN_SET;
		pEUCtx->m_aucPara[ 9] = (UINT8)C_U8_Si2158_MIN_IF_GAIN_SET;
		pEUCtx->m_aucPara[10] = (UINT8)C_U8_Si2158_MAX_RF_GAIN_SET;
		pEUCtx->m_aucPara[11] = (UINT8)C_U8_Si2158_MIN_RF_GAIN_SET;
		pEUCtx->m_aucPara[12] = (UINT8)C_U8_Si2158_IF_GAIN_RANGE;
		pEUCtx->m_aucPara[13] = (UINT8)C_U8_Si2158_RF_GAIN_RANGE;
		pEUCtx->m_aucPara[14] = C_Si2158_POWER_CALIBRATE;
	//#endif
		
	//IF MAX setting!
		pEUCtx->m_aucPara[21] = 0x7F;
		pSi2158[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]   = EQSi2158BG;
		pSi2158[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]   = EQSi2158DK;
		pSi2158[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]    = EQSi2158I;
		pSi2158[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN]  = EQSi2158L;	
		pSi2158[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN] = EQSi2158L1;
		pSi2158[MOD_NTSC_M- MOD_ANA_TYPE_BEGIN]    = EQSi2158M;

		pSi2158EqWeak[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]   = EQSi2158BG;
		pSi2158EqWeak[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]   = EQSi2158DK;
		pSi2158EqWeak[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]    = EQSi2158I;
		pSi2158EqWeak[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN]  = EQSi2158L;	
		pSi2158EqWeak[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN] = EQSi2158L1;
		pSi2158EqWeak[MOD_NTSC_M- MOD_ANA_TYPE_BEGIN]	= EQSi2158M;
#ifdef CC_GPIO_RESET_TUNER
        //GPIO reset
        if(!GpioReseted)
        {
            UINT32 TunerReset = 0;
            DRVCUST_OptQuery(eDemodResetGpio,&TunerReset);
            mcDBG_MSG_L1(("TunerReset is %d!\n",TunerReset));
		...
		if(!TunerInited)
	 	{
			mcDBG_MSG_L1(("Init " C_SILABS_Si2158_STR "(Cust tuner)\n"));
		 	api = &api_context;
...
void SetIfDemod(ITUNER_CTX_T *pTCtx,UINT8 subSysIdx,UINT32 Freq,UINT8 fgAutoSearch)
{
	...
	api->prop->dtv_agc_freeze_input.level=Si2158_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_LOW;
	api->prop->dtv_agc_freeze_input.pin=Si2158_DTV_AGC_FREEZE_INPUT_PROP_PIN_NONE;
	 if (Si2158_L1_SetProperty2(api, Si2158_DTV_AGC_FREEZE_INPUT_PROP) != 0)
	{
		mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_DTV_AGC_FREEZE_INPUT_PROP\n"));
	}
    switch (subSysIdx)
    {	   
        case MOD_PAL_BG:
            ...
            // Silabs_120425 Removed. api->prop->atv_video_mode.trans = Si2158_ATV_VIDEO_MODE_PROP_TRANS_CABLE;
            if (Si2158_L1_SetProperty2(api, Si2158_ATV_VIDEO_MODE_PROP) != 0)
            {
                mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_ATV_VIDEO_MODE_PROP\n"));
            }
            api->prop->atv_lif_freq.offset = C_Si2158_IF_CENTER_BG;
            if (Si2158_L1_SetProperty2(api, Si2158_ATV_LIF_FREQ_PROP) != 0)
            {
                mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_ATV_LIF_FREQ_PROP\n"));
            }   
              api->prop->atv_lif_out.offset = Si2158_ATV_LIF_OUT_PROP_OFFSET_DEFAULT;
              api->prop->atv_lif_out.amp = NO_L_ANALOG_IF_AMP;
            if (Si2158_L1_SetProperty2(api, Si2158_ATV_LIF_OUT_PROP) != 0)
            {
                mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_ATV_LIF_FREQ_PROP\n"));
            }
            break;
       ...
       case MOD_DVBT:
            ...
            {
                mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_DTV_MODE_PROP\n"));
            }
            api->prop->dtv_lif_freq.offset=C_Si2158_IF_FREQUENCY;
            if (Si2158_L1_SetProperty2(api, Si2158_DTV_LIF_FREQ_PROP) != 0)
            {
                mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_DTV_LIF_FREQ_PROP\n"));
            }
			api->prop->dtv_lif_out.offset = Si2158_DTV_LIF_OUT_PROP_OFFSET_DEFAULT; 
			...
			api->prop->dtv_rf_top.dtv_rf_top= Si2158_DTV_RF_TOP_PROP_DTV_RF_TOP_P6DB; //Silabs_120425 was M2DB
			 if (Si2158_L1_SetProperty2(api, Si2158_DTV_RF_TOP_PROP) != 0)
			{
				mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_DTV_RF_TOP_PROP\n"));
			}
      ...
      case MOD_ATSC_8VSB:
			...
			api->prop->dtv_rf_top.dtv_rf_top = Si2158_DTV_RF_TOP_PROP_DTV_RF_TOP_P6DB; //Silabs_120425 added
			 if (Si2158_L1_SetProperty2(api, Si2158_DTV_RF_TOP_PROP) != 0)
			{
				mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_DTV_RF_TOP_PROP\n"));
			}			
		...
		case MOD_J83B_64QAM:
            ...
            break;
        case MOD_DTMB:
            api->prop->dtv_mode.modulation = Si2158_DTV_MODE_PROP_MODULATION_DTMB;
            api->prop->dtv_mode.bw = Si2158_DTV_MODE_PROP_BW_BW_6MHZ;
            api->prop->dtv_mode.invert_spectrum = Si2158_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_INVERTED;
			...
			api->prop->dtv_lif_out.offset = Si2158_DTV_LIF_OUT_PROP_OFFSET_DEFAULT; 
			api->prop->dtv_lif_out.amp =Si2158_DTV_LIF_OUT_PROP_AMP_DEFAULT;
	        if (Si2158_L1_SetProperty2(api, Si2158_DTV_LIF_OUT_PROP) != 0)
			{
				mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_DTV_LIF_FREQ_PROP\n"));
			}
...
//-----------------------------------------------------------------------------
/** Si2158_TunerSetFreq
 *  Set Tuner PLL forSi2158/Si2158 to tune RF frequency.
 *  @param  pTCtx       Pointer of pi tuner driver context.
    ...
    )
{
 ...
 // SPECIFIC_MEMBER_EU_CTX* pEUCtx= &( pTunerCtx->specific_member.eu_ctx);
  mcDBG_MSG_L2 (("Si2158_TunerSetFreq freq = %d;Mode=%d\n", Freq,Mode ));
#if SI2158_ENABLE_EXTERNAL_ATV_AGC_CONTROL
 mcDBG_MSG_L2(("SI2158:Now is external ATV AGC control!!!\n"));
#endif
#if SI2158_ENABLE_EXTERNAL_DTV_AGC_CONTROL
 mcDBG_MSG_L2(("SI2158:Now is external DTV AGC control!!!\n"));
#endif
  if(!TunerInited)
  {
	  TunerInited=TRUE;
	  
	  Si2158_PowerUpWithPatch (api);
  ...
  if(Mode == MOD_PAL_BG) /*wenming 11-12-2: BG PC to Center is by 7M or 8M BW*/  
	{
		...
		{
			pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_BG+C_Si2158_PF_TO_CF_SHIFT_BG_8M;
		...
		else
		{
			if(Freq<300000)  //pal B system
			{
				pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_BG+C_Si2158_PF_TO_CF_SHIFT_BG_7M;
  ...
  if(Mode == MOD_PAL_DK)
  pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_DK+C_Si2158_PF_TO_CF_SHIFT_DK;
  if(Mode == MOD_PAL_I)
  pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_I+C_Si2158_PF_TO_CF_SHIFT_I;
  if(Mode == MOD_NTSC_M)
  pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_M+C_Si2158_PF_TO_CF_SHIFT_M;
  if(Mode == MOD_SECAM_L)
  pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_L+C_Si2158_PF_TO_CF_SHIFT_L;
  if(Mode == MOD_SECAM_L1)
  pTCtx->u2IF_Freq_A = C_Si2158_IF_CENTER_L1-C_Si2158_PF_TO_CF_SHIFT_L1;
     ...
     { tvMode=ANALOG_MODE;
       if(AutoSearch) //wenming 2012-7-19 to do: fine tune will be none-zero value, so AFC range will be 2000, should keep it or not?
           {api->prop->atv_afc_range.range_khz= 1000;
            if (Si2158_L1_SetProperty2(api, Si2158_ATV_AFC_RANGE_PROP) != 0)
            {mcDBG_MSG_ERR((" [Silabs]: ERROR_SETTING_PROPERTY Si2158_ATV_AFC_RANGE_PROP\n"));
            }
			else
				{mcDBG_MSG_L2(("[Silabs]:-->>> Si2158_L1_SetProperty2 set Si2158_ATV_AFC_RANGE_PROP OK\n"));}
			}
			else
			{api->prop->atv_afc_range.range_khz= 1000;
            if (Si2158_L1_SetProperty2(api, Si2158_ATV_AFC_RANGE_PROP) != 0)
  ...
  if (freqHz < Si2158_TUNER_TUNE_FREQ_CMD_FREQ_MIN || freqHz > Si2158_TUNER_TUNE_FREQ_CMD_FREQ_MAX)
	{
		...
		return ERROR_Si2158_PARAMETER_OUT_OF_RANGE; // =1
	}
if (tvMode==ANALOG_MODE)
	{
	 /* set Si2158_TUNER_LO_INJECTION_PROP property for ATV */
	 ...
	 if ((Si2158_L1_SetProperty2(api,Si2158_TUNER_LO_INJECTION_PROP)) != 0)
	    {
			 SiTRACE ("Si2158_L1_SetProperty2 Si2158_TUNER_LO_INJECTION_PROP error \n");
		}
	 else
	 	{mcDBG_MSG_L2(("[Silabs]:-->>> Si2158_L1_SetProperty2 set Si2158_TUNER_LO_INJECTION_PROP OK"));}
	 
	}
	else
	{
	 /* set Si2158_TUNER_LO_INJECTION_PROP property for DTV */
     api->prop->tuner_lo_injection.band_1  = Si2158_TUNER_LO_INJECTION_PROP_BAND_1_HIGH_SIDE;
   ...
   if (Si2158_L1_TUNER_TUNE_FREQ (api,(tvMode==ANALOG_MODE) ? Si2158_TUNER_TUNE_FREQ_CMD_MODE_ATV : Si2158_TUNER_TUNE_FREQ_CMD_MODE_DTV,  freqHz) != 0)
	{
	    mcDBG_MSG_ERR(("[Silabs]:Error Si2170_L1_TUNER_TUNE_FREQ\n"));
        return -1;
    }
   else
		   {mcDBG_MSG_L2(("[Silabs]:Si2158_L1_TUNER_TUNE_FREQ OK\n"));}
	 ...
	 while (( mcGET_TICK_PERIOD() * (mcGET_SYS_TICK() - u2TickTUNINTStart_eu)) < (timeout+5) ) //yuan add 5ms for cover "mcGET_SYS_TICK()" resolution
		 {
			 ...
			 {
				 mcDBG_MSG_ERR(("[Silabs]:Error Si2158_L1_CheckStatus\n"));
				 return ERROR_Si2158_SENDING_COMMAND;
			 }
	...
	mcDBG_MSG_L2(("[Silabs]:Si2158TunerSetFreq use time = (%3u ms) tun=%3u atv=%3u\n", (mcGET_SYS_TICK() - u2TickStart_eu) * mcGET_TICK_PERIOD(),TUNINT_duration,xTVINT_duration));
    return (0);
}


/* Get Status information from part */
UCHAR GetStatus( L1_Si2158_Context *api,TUNER_STATUSES status)
{
    int return_code;
    if (status==CHL)
    {
        if ((return_code=Si2158_L1_ATV_STATUS(api,Si2158_ATV_STATUS_CMD_INTACK_CLEAR))!=0) {
             SiTRACE ("Si2158_L1_ATV_STATUS error 0x%02x: %s\n", return_code, Si2158_L1_API_ERROR_TEXT(return_code) );
        }
        return api->rsp->atv_status.chl;
    }
    else if (status == DTV_CHL)
    {
        if ((return_code=Si2158_L1_DTV_STATUS(api,Si2158_DTV_STATUS_CMD_INTACK_CLEAR))!=0) {
         SiTRACE ("Si2158_L1_DTV_STATUS error 0x%02x: %s\n", return_code, Si2158_L1_API_ERROR_TEXT(return_code) );
        }
...
/* Get RSSI  from part */
CHAR GetSignalLevel(L1_Si2158_Context *api)
{
    int return_code;
    if ((return_code=Si2158_L1_TUNER_STATUS(api,Si2158_TUNER_STATUS_CMD_INTACK_CLEAR))!=0) {
     SiTRACE ("Si2158_L1_TUNER_STATUS error 0x%02x: %s\n", return_code, Si2158_L1_API_ERROR_TEXT(return_code) );
 ...
 */
//-----------------------------------------------------------------------------
static VOID Si2158_SetSawBw(ITUNER_CTX_T * pTCtx, UINT8 sawbw)
{
  pTCtx->specific_member.eu_ctx.m_SAW_BW=sawbw;
  mcDBG_MSG_L2(("Si2158_SetSawBw=%d\n",sawbw));
}
 ...
 */
//-----------------------------------------------------------------------------
static CHAR *Si2158_TunerGetVer(VOID)
{
    return ((CHAR*)C_SILABS_Si2158_STR);
}



UINT32 Si2158_GetSSI(ITUNER_CTX_T* pTunerCtx) 
{
    INT16 Power_Ref[] =
    {
        -93,
	...
	if(pTunerCtx->sSSIPara.i2Bw == SAW_BW_8M)
	{
        ...
        i4Power_rec = i4Power_rec - Adjust_Si2158_i4Power_rec - 2;   
    }
    else
    {
        mcDBG_MSG_L2(("DVBT:7M Real_i4Power_rec = %d\n",i4Power_rec));
        i4Power_rec = i4Power_rec - Adjust_Si2158_i4Power_rec + 1;
    }
...
UINT32 Si2158_GetSSI_T2(ITUNER_CTX_T* pTunerCtx) 
{
    INT16 Power_Ref[] =
    {
        -930,
...
//----------------------------------------------------------------------------- 
/** Si2158_SetSSICondition
 *  Set SSI Condition for TH2603
 *  @param  
 *  @retval void
 */
//-----------------------------------------------------------------------------
void Si2158_SetSSICondition(ITUNER_CTX_T* pTunerCtx, VOID * pInOutVal)
{
 ...
 */
//-----------------------------------------------------------------------------
INT16 Si2158_TunerOP(ITUNER_CTX_T * pTCtx, ITUNEROP_T eOperation, UINT8 SetVal,  VOID * pInOutVal){
    ...
    switch(eOperation){
    case itSetSSICond:
        Si2158_SetSSICondition(pTCtx, pInOutVal);
        break;
    case itGetEqScriptNormal: 
        *(UINT8**)pInOutVal = pSi2158[SetVal];;
        break;
    case itGetEqScriptWeak: 
        *(UINT8**)pInOutVal = pSi2158EqWeak[SetVal];
        break;
	...
	case itGetTop:
          if (SetVal >= MOD_ANA_TYPE_BEGIN)
             {
              if ((return_code=Si2158_L1_GetProperty2(api,Si2158_ATV_RF_TOP_PROP))!=0)
               {
                    SiTRACE ("Si2158_L1_GetProperty2 error 0x%02x\n", return_code);
             ...
             {
              if ((return_code=Si2158_L1_GetProperty2(api,Si2158_DTV_RF_TOP_PROP))!=0)
               {
                    SiTRACE ("Si2158_L1_GetProperty2 error 0x%02x\n", return_code);
                    return ITUNER_NOT_OK;
               }
    ...
    case itSetTop:
     {
          if(VideoStandard >= MOD_ANA_TYPE_BEGIN)
          {
            ...
            if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_RF_TOP_PROP)) != 0)
            {
               SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
               return ITUNER_NOT_OK;
            }
          ...
          else
          {
            ...
            if ((return_code=Si2158_L1_SetProperty2(api,Si2158_DTV_RF_TOP_PROP)) != 0)
            {
               SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
               return ITUNER_NOT_OK;
            }
	 ...
	 case itSetSawBw://Set Channel Bandwidth
	  ...
	  case itGetSSIIndex: // Get RSSI
            *(INT32 *)pInOutVal = Si2158_GetSSI(pTCtx);//(INT16)GetSignalLevel(api);
			//SiTRACE("Si2158_GetSSI= %d\n",(GetSignalLevel(api)));
			break;
	  case itGetSSIIndex_T2: // Get RSSI
            *(INT32 *)pInOutVal = Si2158_GetSSI_T2(pTCtx);//(INT16)GetSignalLevel(api);
			//SiTRACE("Si2158_GetSignalLevel= %d\n",(GetSignalLevel(api)));
	  break;
          ...
          if (VideoStandard >= MOD_ANA_TYPE_BEGIN)
             {
                ...
                if ((return_code=Si2158_L1_SetProperty2(api,Si2158_ATV_LIF_FREQ_PROP)) != 0)
                {
                   SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
                   return ITUNER_NOT_OK;
                }
             ...
             else
            {
                ...
                if ((return_code=Si2158_L1_SetProperty2(api,Si2158_DTV_LIF_FREQ_PROP)) != 0)
                {
                   SiTRACE ("Si2158_L1_SetProperty2 error 0x%02x\n", return_code);
                   return ITUNER_NOT_OK;
                }
	...
	case itGetTunerAFCKhz:
		...
		case itGetReg:
		{
			...
			SiTRACE ("Si2158_itGetReg ...........\n");
			
			ucDumpSettingCount = sizeof(aui2Si2158Properties)/sizeof(unsigned int);
			mcDBG_MSG_L1(("\n"));
			for(ucTemp=0;ucTemp<ucDumpSettingCount;ucTemp++)
			{
				Si2158_L1_GetPropertyString(api,aui2Si2158Properties[ucTemp],(char*)"\n",acSi2158ProMsg);
				mcDBG_MSG_L1(("%s\n",acSi2158ProMsg));
			}
		}
	    break;
  	...
  	case itGetAnaFreqBound:
		   {
		     ...
		     psTunerAnaAttribute->ui4_lower_bound_freq = C_Si2158_FREQ_DBOUND_LOWER_Ana;
		     psTunerAnaAttribute->ui4_upper_bound_freq = C_Si2158_FREQ_DBOUND_UPPER_Ana;
		   }
	 break;
