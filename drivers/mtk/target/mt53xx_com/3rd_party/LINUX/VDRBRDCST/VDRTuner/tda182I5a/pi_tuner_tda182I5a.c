 ...
 * $Author: p4admin $
 * $Date: 2015/02/15 $
 * $RCSfile: pi_tuner_TDA182I5a.c,v $
 * $Revision: #1 $
 *
 *---------------------------------------------------------------------------*/

/** @file pi_tuner_TDA182I5a.c
 *  Tuner control for NXP TDA182I5a
 */
...
#include "eq_script_tda182I5a.h"
//#include "pi_def_dvbt.h"
//-----------------------------------------------------------------------------
// Constant definitions
//-----------------------------------------------------------------------------
//Frequency boundary .Get from tuner spec
#define C_TDA182I5a_FREQ_DBOUND_UPPER   870*1000*1000     
#define C_TDA182I5a_FREQ_DBOUND_LOWER    42*1000*1000 
#define C_TDA182I5a_FREQ_DBOUND_UPPER_Ana     870*1000*1000
#define C_TDA182I5a_FREQ_DBOUND_LOWER_Ana    42*1000*1000

//PLL lock check parameters
#define C_NXP_TDA182I5a_PLL_POLL_INTERVAL      10 //ms
#define C_NXP_TDA182I5a_PLL_POLL_TIMETOUT      100 //ms
#define C_NXP_TDA182I5a_PLL_POLL_CNT           C_NXP_TDA182I5a_PLL_POLL_TIMETOUT/C_NXP_TDA182I5a_PLL_POLL_INTERVAL //counter
#define C_TDA182I5a_I2C_CLK_DIV         0x100
#define C_TDA182I5a_PLL_LOCK_BIT        6

#define NXP_TDA182I5a_ADDRESS           ((UINT8)  0xC0)


#define C_TDA182I5a_IF_FREQUENCY          ((UINT16)  3250)  /* kHz */
//#define C_TDA182I5a_IF_FREQUENCY_ANA      ((UINT16)  38900)  /* kHz */
//#define C_TDA182I5a_IF_FREQUENCY_L1       ((UINT16)  33900)  /* kHz */
#define C_TDA182I5a_LO_DIVIDER_STEP       ((UINT32) 1000)  /* Hz */
#define C_TDA182I5a_LO_DIVIDER_STEP_ANA   ((UINT16)  1000)  /* Hz */
#define C_NXP_TDA182I5a_STR                        "NXP_TDA182I5a 2010-01-01\n 2013-02-04\n v1.16"

#define C_TDA182I5a_IF_FREQUENCY_PAL_B    ((UINT16)  6250)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_PAL_G    ((UINT16)  6750)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_PAL_DK   ((UINT16)  6850)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_PAL_I    ((UINT16)  7250)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_NTSC_M   ((UINT16)  5400)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_SECAM_L  ((UINT16)  6750)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_SECAM_L1 ((UINT16)  1250)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_DVBT_6M        ((UINT16)  4000)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_DVBT_7M        ((UINT16)  4500)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_DVBT_8M        ((UINT16)  5000)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_ATSC        ((UINT16)  5250)  /* kHz */  
#define C_TDA182I5a_IF_FREQUENCY_DVBC        ((UINT16)  5000)  /* kHz */
#define C_TDA182I5a_IF_FREQUENCY_ATSC_64QAM  ((UINT16)  4000) /*kHz*/  
#define C_TDA182I5a_IF_FREQUENCY_ISDBT    	((UINT16)  3250) /*kHz*/  
#define C_TDA182I5a_IF_FREQUENCY_DTMB 		((UINT16)  5000) /*kHz*/  

#define C_TDA182I5a_SAW_BW              SAW_BW_8M
#define C_TDA182I5a_TOP_SET_ANA         ((UINT8)   0x0A)

//for display signal level
#define C_U8_TDA182I5a_AGC_IF_LVL_MAX     0xc2  //no signal
#define C_U8_TDA182I5a_AGC_IF_LVL_MIN     0xa8  //-70dbm input

#define C_TDA182I5a_CHANNEL_SCAN_JUMP_SMALL_STEP ((UINT16) 250)
#define C_TDA182I5a_CHANNEL_SCAN_JUMP_MIDDLE_STEP_UP ((UINT16) 1500)
#define C_TDA182I5a_CHANNEL_SCAN_JUMP_MIDDLE_STEP_DOWN ((UINT16) 500)

//MT5135 PRA 
#define C_TDA182I5a_AGC_IF_SLP             0.125 
#define C_TDA182I5a_AGC_IF_INT             -0.5
#define C_TDA182I5a_AGC_IF_MAX             0
#define C_TDA182I5a_AGC_IF_MIN            -1


#define C_U8_TDA182I5a_AGC_IF_SLP          (INT8)(C_TDA182I5a_AGC_IF_SLP *64 )
#define C_U8_TDA182I5a_AGC_IF_INT          (INT8)(C_TDA182I5a_AGC_IF_INT *16 )
#define C_U8_TDA182I5a_AGC_IF_MAX          (INT8)(C_TDA182I5a_AGC_IF_MAX *128)
#define C_U8_TDA182I5a_AGC_IF_MIN          (INT8)(C_TDA182I5a_AGC_IF_MIN *128)




static UINT8* pTDA182I5aEqNormal[MOD_ANA_TYPE_END - MOD_ANA_TYPE_BEGIN] = {NULL};
static UINT8* pTDA182I5aEqWeak[MOD_ANA_TYPE_END - MOD_ANA_TYPE_BEGIN]= {NULL};
...
/** TDA182I5a_TunerInit
 *  Tuner initialzation forTDA182I5a.
 *  @param  pTCtx       Pointer of pi tuner driver context.
 *  @retval void
 */

//-----------------------------------------------------------------------------
VOID TDA182I5a_TunerInit(
    ITUNER_CTX_T *pTCtx
    )
{
    ...
    psTunerCtx->I2cAddress = NXP_TDA182I5a_ADDRESS;
    psTunerCtx->u2IF_Freq = C_TDA182I5a_IF_FREQUENCY;
	//psTunerCtx->u2IF_Freq_A = C_TDA182I5a_IF_FREQUENCY_ANA;//analog if frequency for ATD
	...
	pEUCtx->m_SAW_BW  = C_TDA182I5a_SAW_BW;
    pEUCtx->m_Ana_Top = C_TDA182I5a_TOP_SET_ANA;

	//for display signal level
	pEUCtx->m_ifAgc_lvl_max = (UINT8)C_U8_TDA182I5a_AGC_IF_LVL_MAX;
	pEUCtx->m_ifAgc_lvl_min = (UINT8)C_U8_TDA182I5a_AGC_IF_LVL_MIN;

	//Tuner frequency range
    pEUCtx->m_s4FreqBoundUpper = C_TDA182I5a_FREQ_DBOUND_UPPER;
    pEUCtx->m_s4FreqBoundLower = C_TDA182I5a_FREQ_DBOUND_LOWER;
    pEUCtx->m_s4AnaFreqBoundUpper = C_TDA182I5a_FREQ_DBOUND_UPPER_Ana;
    pEUCtx->m_s4AnaFreqBoundLower = C_TDA182I5a_FREQ_DBOUND_LOWER_Ana;
	
	pEUCtx->m_Small_Step = C_TDA182I5a_CHANNEL_SCAN_JUMP_SMALL_STEP;
    pEUCtx->m_Middle_Step_Up = C_TDA182I5a_CHANNEL_SCAN_JUMP_MIDDLE_STEP_UP;
    pEUCtx->m_Middle_Step_Down = C_TDA182I5a_CHANNEL_SCAN_JUMP_MIDDLE_STEP_DOWN;

	pEUCtx->m_aucPara[2]= (UINT8)C_U8_TDA182I5a_AGC_IF_SLP; 
	pEUCtx->m_aucPara[3]= (UINT8)C_U8_TDA182I5a_AGC_IF_INT;
    pEUCtx->m_aucPara[4]= (UINT8)C_U8_TDA182I5a_AGC_IF_MAX;
	pEUCtx->m_aucPara[5]= (UINT8)C_U8_TDA182I5a_AGC_IF_MIN;
	...
	pUSCtx->m_aucPara_SLD[2] = (UINT8)C_U8_TDA182I5a_AGC_IF_SLP; 
    pUSCtx->m_aucPara_SLD[3] = (UINT8)C_U8_TDA182I5a_AGC_IF_INT;
    pUSCtx->m_aucPara_SLD[4] = (UINT8)C_U8_TDA182I5a_AGC_IF_MAX;
    pUSCtx->m_aucPara_SLD[5] = (UINT8)C_U8_TDA182I5a_AGC_IF_MIN;
	#endif
	pUSCtx->u2LO_Step = 100;  //*10 = 1KHz

#ifdef CC_SUPPORT_ATV_DESCRAMBLE
	#if defined(CC_MT5880)//for descrambler
	psTunerCtx->sTunerDescramblePara.u2CVBSDelay=0x02bb;
	#endif
#endif	

  	pTDA182I5aEqNormal[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aB;
	pTDA182I5aEqNormal[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aDK;
	pTDA182I5aEqNormal[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aI;
	pTDA182I5aEqNormal[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aL;
	pTDA182I5aEqNormal[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aL1;
	pTDA182I5aEqNormal[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aM;

	pTDA182I5aEqWeak[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aBGWeak;
	pTDA182I5aEqWeak[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aDKWeak;
	pTDA182I5aEqWeak[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aIWeak;
	pTDA182I5aEqWeak[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aLWeak;
	pTDA182I5aEqWeak[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aL1Weak;
	pTDA182I5aEqWeak[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]=EQTDA182I5aMWeak;
	
	mcDBG_MSG_L2(("TDA182I5a_TunerInit\n"));

 } 


//----------------------------------------------------------------------------- 
/** TDA182I5a_TunerSetFreq
 *  Set Tuner PLL forTDA182I5a/TDA182I5a to tune RF frequency.
 *  @param  pTCtx       Pointer of pi tuner driver context.
    ...
    )
{
   ...
   tmTDA182I5aStandardMode_t stdMode = TDA182I5a_ANLG_DK;
   tmErrorCode_t err = TM_OK;	
 ...
 //  TuningParam.m_BandWidth = pTCtx->specific_member.eu_ctx.m_SAW_BW;
   ...
   mcDBG_MSG_L2((C_NXP_TDA182I5a_STR " Set Freq %d Hz\n",Freq));
  ...
  if(!fgTunerInit)
  {
   ...
   /* TDA182I5a Driver initialization  */
    ...
    if(err == TM_OK)
   		{   
   		mcDBG_MSG_INFO(("tmbslTDA182I5a_Open OK\n"));
		/* TDA182I5a Hardware initialization */
		err = tmbslTDA182I5a_HwInit(0);
   		}
   	 else
   	 	{
		mcDBG_MSG_INFO(("tmbslTDA182I5a_Open failed\n"));
   	 	}
	  if(err == TM_OK)
	  	{
	  	mcDBG_MSG_INFO(("tmbslTDA182I5a_HwInit OK\n"));
	  	err=tmbslTDA182I5a_SetPowerState(0,TRUE);
	  	}
	  else
	  	{
	  	mcDBG_MSG_INFO(("tmbslTDA182I5a_HwInit failed\n"));
	  	}
   	 if(err == TM_OK)
   		{
   		mcDBG_MSG_INFO(("tmbslTDA182I5a_SetPowerState OK\n"));
		/* TDA182I5a standard mode selection */
		err = tmbslTDA182I5a_SetStandardMode(0, TDA182I5a_ANLG_DK);
   		}   
  	 else
  	 	{
		mcDBG_MSG_INFO(("tmbslTDA182I5a_SetPowerState failed\n"));
  	 	}
	 if(err == TM_OK)
	 	{ 	
		mcDBG_MSG_INFO(("tmbslTDA182I5a_SetStandardMode OK\n"));
		err=tmbslTDA182I5a_Write(0,&gTDA182I5a_Reg_Reference_Byte__Xtout,0x00,Bus_NoRead);//disable 16MHZ XOUT 
	 	}
	 else
	 	{
	   mcDBG_MSG_INFO(("tmbslTDA182I5a_SetStandardMode fail\n"));
	 	}
	 if(err == TM_OK)
	 	{
	 	mcDBG_MSG_INFO(("TDA182I5a disable 16MHZ XOUT OK\n"));
	 	}
	 else
	 	{
	    mcDBG_MSG_INFO(("TDA182I5a disable 16MHZ XOUT fail\n"));
	 	}
	 fgTunerInit=TRUE;
...
if (Freq < (C_TDA182I5a_FREQ_DBOUND_LOWER) || 
				Freq > (C_TDA182I5a_FREQ_DBOUND_UPPER))
	{
 ...
 if( Mode == MOD_ATSC_8VSB) //digital reception
   {
     stdMode = TDA182I5a_ATSC_6MHz;
	  pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_ATSC;
	 
   }		
 else if((Mode==MOD_J83B_64QAM)||(Mode==MOD_J83B_256QAM)||(Mode==MOD_J83B_AUTO_QAM))
	{ stdMode=TDA182I5a_QAM_6MHz;
	  pTCtx->u2IF_Freq=C_TDA182I5a_IF_FREQUENCY_ATSC_64QAM;   //Set the Demod IF freq (KHz)
	}
 else if(Mode==MOD_DVBT)
   { 
 	//if(TuningParam.m_BandWidth == SAW_BW_7M)
 	if(pTunerCtx->m_SAW_BW==SAW_BW_6M)
	{ stdMode =TDA182I5a_DVBT_6MHz;
	 pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_DVBT_6M;}
    else if(pTunerCtx->m_SAW_BW==SAW_BW_7M)
	{ stdMode =TDA182I5a_DVBT_7MHz;
	  pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_DVBT_7M;}
	else 
	{ stdMode =TDA182I5a_DVBT_8MHz;
	  pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_DVBT_8M;}
   }
 ...
 else if(Mode ==MOD_DVBC)
   {
	...
	pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_DVBC;
   }
 else if(Mode ==MOD_ISDBT)
   {
	stdMode = TDA182I5a_ISDBT_6MHz;
	pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_ISDBT;
   }
 else if(Mode ==MOD_DTMB)
   {
	stdMode = TDA182I5a_DMBT_8MHz;
	pTCtx->u2IF_Freq =C_TDA182I5a_IF_FREQUENCY_DTMB;
   }
 ...
 else  if( Mode == MOD_PAL_BG) 
   {
    if(Freq<300000000)
	 {
	  stdMode = TDA182I5a_ANLG_B;
      pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_PAL_B;
 	 }
    else
	 {
	  stdMode = TDA182I5a_ANLG_GH;
	  pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_PAL_G;
	 }
   }
 else  if( Mode == MOD_PAL_DK) 
   {
	stdMode = TDA182I5a_ANLG_DK;
	pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_PAL_DK;

   }
 else  if( Mode == MOD_PAL_I) 
   {
	stdMode = TDA182I5a_ANLG_I;
	pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_PAL_I;
   }
 else  if( Mode == MOD_SECAM_L) 
   {
	stdMode = TDA182I5a_ANLG_L;
	pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_SECAM_L;
   }
 else  if( Mode == MOD_SECAM_L1) 
   {
	stdMode = TDA182I5a_ANLG_LL;
	pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_SECAM_L1;
   }
 else  if( Mode == MOD_NTSC_M) 
   {
	stdMode = TDA182I5a_ANLG_MN;
	pTCtx->u2IF_Freq_A =C_TDA182I5a_IF_FREQUENCY_NTSC_M;
   }
 
	if(tmbslTDA182I5a_SetStandardMode(0, stdMode) != TM_OK)
		{
		mcDBG_MSG_ERR(("SetStandardMode fail!\n"));
		return -1;
		}
   	if(tmbslTDA182I5a_SetRF(0, Freq) != TM_OK)
	{
	...
	for(ii=0;ii<C_NXP_TDA182I5a_PLL_POLL_CNT;ii++)
	{
		x_thread_delay(C_NXP_TDA182I5a_PLL_POLL_INTERVAL);
		tmbslTDA182I5a_GetLockStatus(0, &PLLLock);
		if(PLLLock == tmbslFrontEndStateLocked)
			break;
	}
	
	if(ii<C_NXP_TDA182I5a_PLL_POLL_CNT)
	{
...
//----------------------------------------------------------------------------- 
/** TDA182I5a_TunerGetVer
 *  Get Tuner type version
 *  @param  pTCtx       Pointer of pi tuner driver context.
 *  @retval tuner model name
 */
//-----------------------------------------------------------------------------
static CHAR *TDA182I5a_TunerGetVer(VOID)
{
    return (C_NXP_TDA182I5a_STR);
 ...
 */
//-----------------------------------------------------------------------------
static VOID  TDA182I5a_SetSawBw(ITUNER_CTX_T * pTCtx, UINT8 sawbw)
{
 pTCtx->specific_member.eu_ctx.m_SAW_BW=sawbw;
 mcDBG_MSG_L2(("TDA182I5a_SetSawBw=%d\n",sawbw));
...
UINT32 TDA182I5a_GetSSI_DVBT(ITUNER_CTX_T* pTunerCtx)
{
    INT16 Power_Ref[] =
    {
        -93,
    ...
    /* Get Power_Rec Value */
	tmbslTDA182I5a_GetPowerLevel(0, &ucPower_rec_dbuv); /*wenming 11-12-9:api return in 0.5 dbuv term*/
...
UINT32 TDA182I5a_GetSSI_DVBC(ITUNER_CTX_T* pTunerCtx)
{
    INT16 Power_Ref[] =
    {
        -82,//16QAM
...
//-----------------------------------------------------------------------------
/** TDA182I5a_SetSSICondition
 *  Set SSI Condition for TH2603
 *  @param
 *  @retval void
 */
//-----------------------------------------------------------------------------
void TDA182I5a_SetSSICondition(ITUNER_CTX_T* pTunerCtx, VOID * pInOutVal)
{
 ...
 */
//-----------------------------------------------------------------------------
INT16 TDA182I5a_TunerOP(ITUNER_CTX_T * pTCtx, ITUNEROP_T eOperation, UINT8 SetVal,  VOID * pInOutVal){
         
    switch(eOperation){
    case itGetVer:
        {
        CHAR ** RetStr=(CHAR **)pInOutVal;
        *RetStr=TDA182I5a_TunerGetVer();
        }
        break;
    ...
    case itGetEqScriptNormal:
		...
		if((MOD_PAL_BG - MOD_ANA_TYPE_BEGIN) == SetVal)
		{
			...
			{ 
				pTDA182I5aEqNormal[SetVal] = EQTDA182I5aB;
			}
			else /*PAL G system*/
			{
				pTDA182I5aEqNormal[SetVal] = EQTDA182I5aG;
			}
		}
        *(UINT8**)pInOutVal = pTDA182I5aEqNormal[SetVal];
        break;
    case itGetEqScriptWeak: 
        *(UINT8**)pInOutVal = pTDA182I5aEqWeak[SetVal];
        break;
	case itSetSawBw:
		{
		TDA182I5a_SetSawBw(pTCtx,SetVal);
		}
		break;
    case itSetIF:
    	break;
	...
	case itSetSSICond:
    TDA182I5a_SetSSICondition(pTCtx, pInOutVal);
    break;
	case itGetSSIIndex:   /*wenming 11-12-9:0 for DVBT SSI, 1 for DVBC SSI*/
	{ if (SetVal==0)
		*((INT32*)pInOutVal) = TDA182I5a_GetSSI_DVBT(pTCtx);
     else
		 *((INT32*)pInOutVal) = TDA182I5a_GetSSI_DVBC(pTCtx);
	}
	 break;
	case itSetFineRF:
		{
		//call new api do fine-tune for nxp18275
		INT8 step=*(INT8* )pInOutVal;
		if(TM_OK!=tmbslTDA182I5a_SetFineRF(0,step))
		{
	...
	case itGetSignalLevel:
	{
	 ...
	 tmbslTDA182I5a_GetPowerLevel(0, &ucPower_rec_dbuv);
	 u1signallevl=ucPower_rec_dbuv/2+3;	 
   ...
   case itGetPGAIdx://Get PGA register setting
   	...
   	break;
    default:
        mcDBG_MSG_L2(("NO case !Not implement in NXP18275 Tuner.\n"));
...
UInt32 ReadLen, UInt8* pData)
{
    ...
    /* ...*/
		...
		if(ucSPIRead(NXP_TDA182I5a_ADDRESS, *pAddr, pData, ReadLen) == 0)   /*wenming 110920*/
#else// tuner use i2c 
		if(ucI2cRead(NXP_TDA182I5a_ADDRESS, *pAddr, pData, ReadLen) == 0)   /*wenming 110920*/
#endif
		{
			return TM_OK;
		}
		...
		UINT32 wordAddr = 0;
		UINT8 tnflg=0xFE;
		UINT8 targAddr=NXP_TDA182I5a_ADDRESS;  //Tuner I2C  address
...
#ifdef TUNER_USE_SPI //spi-i2c control tuner 		
	if(ucSPIWriteOnly(NXP_TDA182I5a_ADDRESS,acBuffer,WriteLen+1)==0)
#else
	if(ucI2cWrite(NXP_TDA182I5a_ADDRESS,acBuffer[0],acBuffer+1,WriteLen)==0) 
#endif
