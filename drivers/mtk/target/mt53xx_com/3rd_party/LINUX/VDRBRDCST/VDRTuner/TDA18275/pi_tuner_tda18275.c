 ...
 * $Author: p4admin $
 * $Date: 2015/02/15 $
 * $RCSfile: pi_tuner_TDA18275.c,v $
 * $Revision: #1 $
 *
 *---------------------------------------------------------------------------*/

/** @file pi_tuner_TDA18275.c
 *  Tuner control for NXP TDA18275
 */
...
#include "eq_script_tda18275.h"
//#include "pi_def_dvbt.h"
//-----------------------------------------------------------------------------
// Constant definitions
//-----------------------------------------------------------------------------
//Frequency boundary .Get from tuner spec
#define C_TDA18275_FREQ_DBOUND_UPPER   870*1000*1000     
#define C_TDA18275_FREQ_DBOUND_LOWER    42*1000*1000 
#define C_TDA18275_FREQ_DBOUND_UPPER_Ana     870*1000*1000
#define C_TDA18275_FREQ_DBOUND_LOWER_Ana    42*1000*1000

//PLL lock check parameters
#define C_NXP_TDA18275_PLL_POLL_INTERVAL      10 //ms
#define C_NXP_TDA18275_PLL_POLL_TIMETOUT      100 //ms
#define C_NXP_TDA18275_PLL_POLL_CNT           C_NXP_TDA18275_PLL_POLL_TIMETOUT/C_NXP_TDA18275_PLL_POLL_INTERVAL //counter
#define C_TDA18275_I2C_CLK_DIV         0x100
#define C_TDA18275_PLL_LOCK_BIT        6

#define NXP_TDA18275_ADDRESS           ((UINT8)  0xC0)


#define C_TDA18275_IF_FREQUENCY          ((UINT16)  3250)  /* kHz */
//#define C_TDA18275_IF_FREQUENCY_ANA      ((UINT16)  38900)  /* kHz */
//#define C_TDA18275_IF_FREQUENCY_L1       ((UINT16)  33900)  /* kHz */
#define C_TDA18275_LO_DIVIDER_STEP       ((UINT32) 1000)  /* Hz */
#define C_TDA18275_LO_DIVIDER_STEP_ANA   ((UINT16)  1000)  /* Hz */
#define C_NXP_TDA18275_STR                        "NXP_TDA18275 2010-01-01\n 2013-02-04\n v1.16"

#define C_TDA18275_IF_FREQUENCY_PAL_B    ((UINT16)  6250)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_PAL_G    ((UINT16)  6750)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_PAL_DK   ((UINT16)  6850)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_PAL_I    ((UINT16)  7250)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_NTSC_M   ((UINT16)  5400)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_SECAM_L  ((UINT16)  6750)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_SECAM_L1 ((UINT16)  1250)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_DVBT_6M        ((UINT16)  4000)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_DVBT_7M        ((UINT16)  4500)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_DVBT_8M        ((UINT16)  5000)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_ATSC        ((UINT16)  5250)  /* kHz */  
#define C_TDA18275_IF_FREQUENCY_DVBC        ((UINT16)  5000)  /* kHz */
#define C_TDA18275_IF_FREQUENCY_ATSC_64QAM  ((UINT16)  4000) /*kHz*/  
#define C_TDA18275_IF_FREQUENCY_ISDBT    	((UINT16)  3683) /*kHz*/  
#define C_TDA18275_IF_FREQUENCY_DTMB 		((UINT16)  5000) /*kHz*/  

#define C_TDA18275_SAW_BW              SAW_BW_8M
#define C_TDA18275_TOP_SET_ANA         ((UINT8)   0x0A)

//for display signal level
#define C_U8_TDA18275_AGC_IF_LVL_MAX     0xc2  //no signal
#define C_U8_TDA18275_AGC_IF_LVL_MIN     0xa8  //-70dbm input

#define C_TDA18275_CHANNEL_SCAN_JUMP_SMALL_STEP ((UINT16) 250)
#define C_TDA18275_CHANNEL_SCAN_JUMP_MIDDLE_STEP_UP ((UINT16) 1500)
#define C_TDA18275_CHANNEL_SCAN_JUMP_MIDDLE_STEP_DOWN ((UINT16) 500)

//MT5135 PRA 
#define C_TDA18275_AGC_IF_SLP             0.125 
#define C_TDA18275_AGC_IF_INT             -0.5
#define C_TDA18275_AGC_IF_MAX             0
#define C_TDA18275_AGC_IF_MIN            -1


#define C_U8_TDA18275_AGC_IF_SLP          (INT8)(C_TDA18275_AGC_IF_SLP *64 )
#define C_U8_TDA18275_AGC_IF_INT          (INT8)(C_TDA18275_AGC_IF_INT *16 )
#define C_U8_TDA18275_AGC_IF_MAX          (INT8)(C_TDA18275_AGC_IF_MAX *128)
#define C_U8_TDA18275_AGC_IF_MIN          (INT8)(C_TDA18275_AGC_IF_MIN *128)




static UINT8* pTDA18275EqNormal[MOD_ANA_TYPE_END - MOD_ANA_TYPE_BEGIN] = {NULL};
static UINT8* pTDA18275EqWeak[MOD_ANA_TYPE_END - MOD_ANA_TYPE_BEGIN]= {NULL};
...
/** TDA18275_TunerInit
 *  Tuner initialzation forTDA18275.
 *  @param  pTCtx       Pointer of pi tuner driver context.
 *  @retval void
 */

//-----------------------------------------------------------------------------
VOID TDA18275_TunerInit(
    ITUNER_CTX_T *pTCtx
    )
{
    ...
    psTunerCtx->I2cAddress = NXP_TDA18275_ADDRESS;
    psTunerCtx->u2IF_Freq = C_TDA18275_IF_FREQUENCY;
	//psTunerCtx->u2IF_Freq_A = C_TDA18275_IF_FREQUENCY_ANA;//analog if frequency for ATD
	...
	pEUCtx->m_SAW_BW  = C_TDA18275_SAW_BW;
    pEUCtx->m_Ana_Top = C_TDA18275_TOP_SET_ANA;

	//for display signal level
	pEUCtx->m_ifAgc_lvl_max = (UINT8)C_U8_TDA18275_AGC_IF_LVL_MAX;
	pEUCtx->m_ifAgc_lvl_min = (UINT8)C_U8_TDA18275_AGC_IF_LVL_MIN;

	//Tuner frequency range
    pEUCtx->m_s4FreqBoundUpper = C_TDA18275_FREQ_DBOUND_UPPER;
    pEUCtx->m_s4FreqBoundLower = C_TDA18275_FREQ_DBOUND_LOWER;
    pEUCtx->m_s4AnaFreqBoundUpper = C_TDA18275_FREQ_DBOUND_UPPER_Ana;
    pEUCtx->m_s4AnaFreqBoundLower = C_TDA18275_FREQ_DBOUND_LOWER_Ana;
	
	pEUCtx->m_Small_Step = C_TDA18275_CHANNEL_SCAN_JUMP_SMALL_STEP;
    pEUCtx->m_Middle_Step_Up = C_TDA18275_CHANNEL_SCAN_JUMP_MIDDLE_STEP_UP;
    pEUCtx->m_Middle_Step_Down = C_TDA18275_CHANNEL_SCAN_JUMP_MIDDLE_STEP_DOWN;

	pEUCtx->m_aucPara[2]= (UINT8)C_U8_TDA18275_AGC_IF_SLP; 
	pEUCtx->m_aucPara[3]= (UINT8)C_U8_TDA18275_AGC_IF_INT;
    pEUCtx->m_aucPara[4]= (UINT8)C_U8_TDA18275_AGC_IF_MAX;
	pEUCtx->m_aucPara[5]= (UINT8)C_U8_TDA18275_AGC_IF_MIN;
	...
	pUSCtx->m_aucPara_SLD[2] = (UINT8)C_U8_TDA18275_AGC_IF_SLP; 
    pUSCtx->m_aucPara_SLD[3] = (UINT8)C_U8_TDA18275_AGC_IF_INT;
    pUSCtx->m_aucPara_SLD[4] = (UINT8)C_U8_TDA18275_AGC_IF_MAX;
    pUSCtx->m_aucPara_SLD[5] = (UINT8)C_U8_TDA18275_AGC_IF_MIN;
	#endif
	...
	psTunerCtx->sTunerDescramblePara.u2CVBSDelay=0x02bb;
  	...
  	pTDA18275EqNormal[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]=EQTDA18275B;
	pTDA18275EqNormal[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]=EQTDA18275DK;
	pTDA18275EqNormal[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]=EQTDA18275I;
	pTDA18275EqNormal[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN]=EQTDA18275L;
	pTDA18275EqNormal[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN]=EQTDA18275L1;
	pTDA18275EqNormal[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]=EQTDA18275M;

	pTDA18275EqWeak[MOD_PAL_BG - MOD_ANA_TYPE_BEGIN]=EQTDA18275BGWeak;
	pTDA18275EqWeak[MOD_PAL_DK - MOD_ANA_TYPE_BEGIN]=EQTDA18275DKWeak;
	pTDA18275EqWeak[MOD_PAL_I - MOD_ANA_TYPE_BEGIN]=EQTDA18275IWeak;
	pTDA18275EqWeak[MOD_SECAM_L - MOD_ANA_TYPE_BEGIN]=EQTDA18275LWeak;
	pTDA18275EqWeak[MOD_SECAM_L1 - MOD_ANA_TYPE_BEGIN]=EQTDA18275L1Weak;
	pTDA18275EqWeak[MOD_NTSC_M - MOD_ANA_TYPE_BEGIN]=EQTDA18275MWeak;
	
	mcDBG_MSG_L2(("TDA18275_TunerInit\n"));

 } 


//----------------------------------------------------------------------------- 
/** TDA18275_TunerSetFreq
 *  Set Tuner PLL forTDA18275/TDA18275 to tune RF frequency.
 *  @param  pTCtx       Pointer of pi tuner driver context.
    ...
    )
{
   ...
   tmTDA18275StandardMode_t stdMode = TDA18275_ANLG_DK;
   tmErrorCode_t err = TM_OK;	
 ...
 //  TuningParam.m_BandWidth = pTCtx->specific_member.eu_ctx.m_SAW_BW;
   ...
   mcDBG_MSG_L2((C_NXP_TDA18275_STR " Set Freq %d Hz\n",Freq));
  ...
  if(!fgTunerInit)
  {
   ...
   /* TDA18275 Driver initialization  */
    ...
    if(err == TM_OK)
   		{   
   		mcDBG_MSG_INFO(("tmbslTDA18275_Open OK\n"));
		/* TDA18275 Hardware initialization */
		err = tmbslTDA18275_HwInit(0);
   		}
   	 else
   	 	{
		mcDBG_MSG_INFO(("tmbslTDA18275_Open failed\n"));
   	 	}
	  if(err == TM_OK)
	  	{
	  	mcDBG_MSG_INFO(("tmbslTDA18275_HwInit OK\n"));
	  	err=tmbslTDA18275_SetPowerState(0,TRUE);
	  	}
	  else
	  	{
	  	mcDBG_MSG_INFO(("tmbslTDA18275_HwInit failed\n"));
	  	}
   	 if(err == TM_OK)
   		{
   		mcDBG_MSG_INFO(("tmbslTDA18275_SetPowerState OK\n"));
		/* TDA18275 standard mode selection */
		err = tmbslTDA18275_SetStandardMode(0, TDA18275_ANLG_DK);
   		}   
  	 else
  	 	{
		mcDBG_MSG_INFO(("tmbslTDA18275_SetPowerState failed\n"));
  	 	}
	 if(err == TM_OK)
	 	{ 	
		mcDBG_MSG_INFO(("tmbslTDA18275_SetStandardMode OK\n"));
		err=tmbslTDA18275_Write(0,&gTDA18275_Reg_Reference_Byte__XTout,0x00,Bus_NoRead);//disable 16MHZ XOUT 
	 	}
	 else
	 	{
	   mcDBG_MSG_INFO(("tmbslTDA18275_SetStandardMode fail\n"));
	 	}
	 if(err == TM_OK)
	 	{
	 	mcDBG_MSG_INFO(("TDA18275 disable 16MHZ XOUT OK\n"));
	 	}
	 else
	 	{
	    mcDBG_MSG_INFO(("TDA18275 disable 16MHZ XOUT fail\n"));
	 	}
	 fgTunerInit=TRUE;
...
if (Freq < (C_TDA18275_FREQ_DBOUND_LOWER) || 
				Freq > (C_TDA18275_FREQ_DBOUND_UPPER))
	{
 ...
 if( Mode == MOD_ATSC_8VSB) //digital reception
   {
     stdMode = TDA18275_ATSC_6MHz;
	  pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_ATSC;
	 
   }		
 else if((Mode==MOD_J83B_64QAM)||(Mode==MOD_J83B_256QAM)||(Mode==MOD_J83B_AUTO_QAM))
	{ stdMode=TDA18275_QAM_6MHz;
	  pTCtx->u2IF_Freq=C_TDA18275_IF_FREQUENCY_ATSC_64QAM;   //Set the Demod IF freq (KHz)
	}
 else if(Mode==MOD_DVBT)
   { 
 	//if(TuningParam.m_BandWidth == SAW_BW_7M)
 	if(pTunerCtx->m_SAW_BW==SAW_BW_6M)
	{ stdMode =TDA18275_DVBT_6MHz;
	 pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_DVBT_6M;}
    else if(pTunerCtx->m_SAW_BW==SAW_BW_7M)
	{ stdMode =TDA18275_DVBT_7MHz;
	  pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_DVBT_7M;}
	else 
	{ stdMode =TDA18275_DVBT_8MHz;
	  pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_DVBT_8M;}
   }
   ...
   {
	stdMode = TDA18275_QAM_8MHz;
	pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_DVBC;
   }
 else if(Mode ==MOD_ISDBT)
   {
	stdMode = TDA18275_ISDBT_6MHz;
	pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_ISDBT;
   }
 else if(Mode ==MOD_DTMB)
   {
	stdMode = TDA18275_DMBT_8MHz;
	pTCtx->u2IF_Freq =C_TDA18275_IF_FREQUENCY_DTMB;
   }
 ...
 else  if( Mode == MOD_PAL_BG) 
   {
    if(Freq<300000000)
	 {
	  stdMode = TDA18275_ANLG_B;
      pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_PAL_B;
 	 }
    else
	 {
	  stdMode = TDA18275_ANLG_GH;
	  pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_PAL_G;
	 }
   }
 else  if( Mode == MOD_PAL_DK) 
   {
	stdMode = TDA18275_ANLG_DK;
	pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_PAL_DK;

   }
 else  if( Mode == MOD_PAL_I) 
   {
	stdMode = TDA18275_ANLG_I;
	pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_PAL_I;
   }
 else  if( Mode == MOD_SECAM_L) 
   {
	stdMode = TDA18275_ANLG_L;
	pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_SECAM_L;
   }
 else  if( Mode == MOD_SECAM_L1) 
   {
	stdMode = TDA18275_ANLG_LL;
	pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_SECAM_L1;
   }
 else  if( Mode == MOD_NTSC_M) 
   {
	stdMode = TDA18275_ANLG_MN;
	pTCtx->u2IF_Freq_A =C_TDA18275_IF_FREQUENCY_NTSC_M;
   }
 
	if(tmbslTDA18275_SetStandardMode(0, stdMode) != TM_OK)
		{
		mcDBG_MSG_ERR(("SetStandardMode fail!\n"));
		return -1;
		}
   	if(tmbslTDA18275_SetRF(0, Freq) != TM_OK)
	{
	...
	for(ii=0;ii<C_NXP_TDA18275_PLL_POLL_CNT;ii++)
	{
		x_thread_delay(C_NXP_TDA18275_PLL_POLL_INTERVAL);
		tmbslTDA18275_GetLockStatus(0, &PLLLock);
		if(PLLLock == tmbslFrontEndStateLocked)
			break;
	}
	
	if(ii<C_NXP_TDA18275_PLL_POLL_CNT)
	{
...
//----------------------------------------------------------------------------- 
/** TDA18275_TunerGetVer
 *  Get Tuner type version
 *  @param  pTCtx       Pointer of pi tuner driver context.
 *  @retval tuner model name
 */
//-----------------------------------------------------------------------------
static CHAR *TDA18275_TunerGetVer(VOID)
{
    return (C_NXP_TDA18275_STR);
 ...
 */
//-----------------------------------------------------------------------------
static VOID  TDA18275_SetSawBw(ITUNER_CTX_T * pTCtx, UINT8 sawbw)
{
 pTCtx->specific_member.eu_ctx.m_SAW_BW=sawbw;
 mcDBG_MSG_L2(("TDA18275_SetSawBw=%d\n",sawbw));
...
UINT32 TDA18275_GetSSI_DVBT(ITUNER_CTX_T* pTunerCtx)
{
    INT16 Power_Ref[] =
    {
        -93,
    ...
    /* Get Power_Rec Value */
	tmbslTDA18275_GetPowerLevel(0, &ucPower_rec_dbuv); /*wenming 11-12-9:api return in 0.5 dbuv term*/
...
UINT32 TDA18275_GetSSI_DVBC(ITUNER_CTX_T* pTunerCtx)
{
    INT16 Power_Ref[] =
    {
        -82,//16QAM
...
//-----------------------------------------------------------------------------
/** TDA18275_SetSSICondition
 *  Set SSI Condition for TH2603
 *  @param
 *  @retval void
 */
//-----------------------------------------------------------------------------
void TDA18275_SetSSICondition(ITUNER_CTX_T* pTunerCtx, VOID * pInOutVal)
{
 ...
 */
//-----------------------------------------------------------------------------
INT16 TDA18275_TunerOP(ITUNER_CTX_T * pTCtx, ITUNEROP_T eOperation, UINT8 SetVal,  VOID * pInOutVal){
         
    switch(eOperation){
    case itGetVer:
        {
        CHAR ** RetStr=(CHAR **)pInOutVal;
        *RetStr=TDA18275_TunerGetVer();
        }
        break;
    ...
    case itGetEqScriptNormal:
		...
		if((MOD_PAL_BG - MOD_ANA_TYPE_BEGIN) == SetVal)
		{
			...
			{ 
				pTDA18275EqNormal[SetVal] = EQTDA18275B;
			}
			else /*PAL G system*/
			{
				pTDA18275EqNormal[SetVal] = EQTDA18275G;
			}
		}
        *(UINT8**)pInOutVal = pTDA18275EqNormal[SetVal];
        break;
    case itGetEqScriptWeak: 
        *(UINT8**)pInOutVal = pTDA18275EqWeak[SetVal];
        break;
	case itSetSawBw:
		{
		TDA18275_SetSawBw(pTCtx,SetVal);
		}
		break;
    case itSetIF:
    	break;
	...
	case itSetSSICond:
    TDA18275_SetSSICondition(pTCtx, pInOutVal);
    break;
	case itGetSSIIndex:   /*wenming 11-12-9:0 for DVBT SSI, 1 for DVBC SSI*/
	{ if (SetVal==0)
		*((INT32*)pInOutVal) = TDA18275_GetSSI_DVBT(pTCtx);
     else
		 *((INT32*)pInOutVal) = TDA18275_GetSSI_DVBC(pTCtx);
	}
	 break;
	case itSetFineRF:
		{
		...
		if(TM_OK!=tmbslTDA18275_SetFineRF(0,step))
		{
	...
	case itGetSignalLevel:
	{
	 ...
	 tmbslTDA18275_GetPowerLevel(0, &ucPower_rec_dbuv);
...
UInt32 ReadLen, UInt8* pData)
{
    ...
    /* ...*/
		...
		if(ucSPIRead(NXP_TDA18275_ADDRESS, *pAddr, pData, ReadLen) == 0)   /*wenming 110920*/
#else// tuner use i2c 
		if(ucI2cRead(NXP_TDA18275_ADDRESS, *pAddr, pData, ReadLen) == 0)   /*wenming 110920*/
#endif
		{
			return TM_OK;
		}
...
#ifdef TUNER_USE_SPI //spi-i2c control tuner 		
	if(ucSPIWriteOnly(NXP_TDA18275_ADDRESS,acBuffer,WriteLen+1)==0)
#else
	if(ucI2cWrite(NXP_TDA18275_ADDRESS,acBuffer[0],acBuffer+1,WriteLen)==0) 
#endif
