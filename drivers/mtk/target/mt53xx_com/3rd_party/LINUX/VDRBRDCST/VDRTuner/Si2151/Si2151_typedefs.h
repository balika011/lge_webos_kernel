...
//#define MAX_POSSIBLE_CHANNELS 160 /* Comment out for Mediatek platform porting */
...
typedef struct L1_Si2151_Context {
  Si2151_L0_Context          *i2c;    /* For Mediatek platform porting */
  Si2151_L0_Context           i2cObj; /* For Mediatek platform porting */
  Si2151_CmdObj              *cmd;
 ...
 /* Channel Scan Globals */
  ...
  //unsigned long ChannelList[MAX_POSSIBLE_CHANNELS]; /* Comment out for Mediatek platform porting */
  /* ChannelScanPal needs to store the PAL type also so allocate 4 chars each for that */
  //char ChannelType[MAX_POSSIBLE_CHANNELS][4]; /* Comment out for Mediatek platform porting */
  /* Number of found channels from a channel scan */
  //int ChannelListSize; /* Comment out for Mediatek platform porting */
