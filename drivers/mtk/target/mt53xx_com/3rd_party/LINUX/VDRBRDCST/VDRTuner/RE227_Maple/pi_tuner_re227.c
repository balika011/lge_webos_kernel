...
#define C_RE227_IF_FREQUENCY_DVBT2_1_7M      ((UINT16)  3500)  /* kHz */
...
#define C_RE227_IF_FREQUENCY_DVBC2_6M     	 ((UINT16)  3700)  /* kHz */
#define C_RE227_IF_FREQUENCY_DVBC2_8M     	 ((UINT16)  4900)  /* kHz */
...
#define C_SONY_RE227_STR		"SONY_RE227 ES2 2013-10-25\n v1.6"
    ...
    )
{
   ...
   // pEUCtx->m_aucPara[7] = C_RE227_DEMOD_INPUT_POWER;
    ...
    TunerInited = FALSE; //Reset the TunerInited to FALSE, for fastboot
    ...
    )
{
    ...
    if(!TunerInited)
    {
        ...
        if(sonyrf_result != SONYRF_RESULT_OK){
            mcDBG_MSG_L2(("RE227Tuner: sonyrf_ascot3_re227_Initialize is failed. (%d)\n", sonyrf_result));
        }
    }
    ...
    case MOD_DVBT2:
        ...
        case (UINT8)SAW_BW_1_7M:
            system = SONYRF_ASCOT2E_DTV_DVBT2_1_7;
			pTCtx->u2IF_Freq=C_RE227_IF_FREQUENCY_DVBT2_1_7M;
            break;
        }
        break;
    case MOD_DVBC:
    ...
    case MOD_DVBC2:
        switch(bandWidth){
        case (UINT8)SAW_BW_6M:
            system = SONYRF_ASCOT2E_DTV_DVBC2_6;
			pTCtx->u2IF_Freq=C_RE227_IF_FREQUENCY_DVBC2_6M;
            break;
        case (UINT8)SAW_BW_8M:
            system = SONYRF_ASCOT2E_DTV_DVBC2_8;
			pTCtx->u2IF_Freq=C_RE227_IF_FREQUENCY_DVBC2_8M;
            break;
        }
        break;
	case MOD_DTMB:
    ...
    pTuner->fgAutoSearch = param->fgAutoSearch;
