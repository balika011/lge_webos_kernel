...
sonyrf_result_t sonyrf_i2c_CommonReadRegister_re231(sonyrf_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t* pData, uint32_t size);
sonyrf_result_t sonyrf_i2c_CommonWriteRegister_re231(sonyrf_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, const uint8_t* pData, uint32_t size);
sonyrf_result_t sonyrf_i2c_CommonWriteOneRegister_re231(sonyrf_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t data);

/* For Read-Modify-Write */
sonyrf_result_t sonyrf_i2c_SetRegisterBits_re231(sonyrf_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t data, uint8_t mask);
