...
#define C_MXL_MXL601_STR                "2013-06-24  MXL_MXL601 SW_v8 \n"
...
// Work mode, bandwidth, IF path selection, IF_Freq, IF_Invert, gain_SelfAgc,gain_CloseAgc, AGC_Sel, AGC_Type, AGC_SetPoint   
  ...
  {MOD_DTMB,         DIG_TERR_BW_8MHz,  MXL601_DVB_T_IF_PATH_SELECTION,   IF_5MHz,   MXL_ENABLE,13,13,AGC1,AGC_EXTERNAL, 66},
            ...
            switch(SetVal)
                {
                    ...
                    case MOD_DVBT:
                    case MOD_DVBC:
		 case  MOD_DTMB:	//for internal DTMB/5175			
                        *(UINT32 *)pInOutVal=0x06;
                        break;
                    ...
                    case MOD_PAL_I:
                    case MOD_NTSC_M:
                        *(UINT32 *)pInOutVal=0x05 ;//06 also OK
                        break;
                    case MOD_SECAM_L:
                    case MOD_SECAM_L1:
