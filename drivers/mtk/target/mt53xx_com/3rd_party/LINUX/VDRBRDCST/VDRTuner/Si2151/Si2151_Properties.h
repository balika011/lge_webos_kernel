...
/* Si2151 TUNER_BLOCKED_VCO_CONFIG property definition */
#define   Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP 0x050a

#ifdef    Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP
  #define Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_CODE 0x00050a


    typedef struct { /* Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_struct */
      unsigned char   distance_target;
   } Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_struct;

   /* TUNER_BLOCKED_VCO_CONFIG property, DISTANCE_TARGET field definition (NO TITLE)*/
   #define  Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_LSB         0
   #define  Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_MASK        0xff
   #define  Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_DEFAULT    100
    #define Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_DISTANCE_TARGET_MIN  0
    #define Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_DISTANCE_TARGET_MAX  255
...
#define   Si2151_TUNER_RETURN_LOSS_PROP 0x0507
  ...
  #define Si2151_TUNER_RETURN_LOSS_PROP_CODE 0x000507
   ...
   #define  Si2151_TUNER_RETURN_LOSS_PROP_MODE_MASK        0xff
...
#define   Si2151_XOUT_PROP 0x0404
  ...
  typedef struct {
    ...
    #endif /* Si2151_TUNER_BLOCKED_VCO3_PROP */
    #ifdef    Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP
              Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_struct      tuner_blocked_vco_config;
    #endif /* Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP */
    #ifdef    Si2151_TUNER_LO_INJECTION_PROP
