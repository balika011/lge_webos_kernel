...
*/
static const sonyrf_ascot2e_adjust_param_t g_param_table[SONYRF_ASCOT2E_TV_SYSTEM_NUM] = {
    /*
    IF_OUT_SEL   MIX_OLL    IF_BPF_GC          BW_OFFSET        RF_OLDET
      |   AGC_SEL |   RF_GAIN |    FIF_OFFSET   |          BW     |   IF_BPF_F0
      |     |     |     |     |     |           |           |     |     |       */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(0),  OFFSET(0),  BW_6, 0x09, 0x00}, /**< SONYRF_ASCOT2E_TV_SYSTEM_UNKNOWN */
    /* Analog */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(0),  OFFSET(0),  BW_6, 0x09, 0x00}, /**< SONYRF_ASCOT2E_ATV_MN_EIAJ  (System-M (Japan)) */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(0),  OFFSET(0),  BW_6, 0x09, 0x00}, /**< SONYRF_ASCOT2E_ATV_MN_SAP   (System-M (US)) */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(3),  OFFSET(0),  BW_6, 0x09, 0x00}, /**< SONYRF_ASCOT2E_ATV_MN_A2    (System-M (Korea)) */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(11), OFFSET(8),  BW_7, 0x09, 0x00}, /**< SONYRF_ASCOT2E_ATV_BG       (System-B/G) */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(2),  OFFSET(0),  BW_8, 0x09, 0x00}, /**< SONYRF_ASCOT2E_ATV_I        (System-I) */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(2),  OFFSET(0),  BW_8, 0x09, 0x00}, /**< SONYRF_ASCOT2E_ATV_DK       (System-D/K) */
    {AUTO, AUTO, 0x05, AUTO, 0x01, OFFSET(2),  OFFSET(0),  BW_8, 0x0A, 0x00}, /**< SONYRF_ASCOT2E_ATV_L        (System-L) */
    {AUTO, AUTO, 0x05, AUTO, 0x01, OFFSET(-1), OFFSET(7),  BW_8, 0x0A, 0x00}, /**< SONYRF_ASCOT2E_ATV_L_DASH   (System-L DASH) */
    /* Digital */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-6), OFFSET(-6), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_8VSB     (ATSC 8VSB) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-6), OFFSET(-6), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_QAM      (US QAM) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-9), OFFSET(-7), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_ISDBT_6  (ISDB-T 6MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-7), OFFSET(-5), BW_7, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_ISDBT_7  (ISDB-T 7MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-5), OFFSET(-3), BW_8, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_ISDBT_8  (ISDB-T 8MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT_5   (DVB-T 5MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT_6   (DVB-T 6MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-6), OFFSET(-4), BW_7, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT_7   (DVB-T 7MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-4), OFFSET(-2), BW_8, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT_8   (DVB-T 8MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-10),OFFSET(-16),BW_1_7,0x0B,0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT2_1_7(DVB-T2 1.7MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT2_5  (DVB-T2 5MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT2_6  (DVB-T2 6MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-6), OFFSET(-4), BW_7, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT2_7  (DVB-T2 7MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-4), OFFSET(-2), BW_8, 0x0B, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBT2_8  (DVB-T2 8MHzBW) */
    {AUTO, AUTO, 0x02, AUTO, 0x03, OFFSET(-2), OFFSET(-1), BW_8, 0x09, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBC     (DVB-C) */
    {AUTO, AUTO, 0x03, AUTO, 0x01, OFFSET(-6), OFFSET(-4), BW_6, 0x09, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBC2_6  (DVB-C2 6MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x01, OFFSET(-2), OFFSET(2),  BW_8, 0x09, 0x00}, /**< SONYRF_ASCOT2E_DTV_DVBC2_8  (DVB-C2 8MHzBW) */
    {AUTO, AUTO, 0x03, AUTO, 0x02, OFFSET(2),  OFFSET(3),  BW_8, 0x0B, 0x00}  /**< SONYRF_ASCOT2E_DTV_DTMB     (DTMB) */
};
...
*/
static sonyrf_result_t X_pon(sonyrf_ascot2e_t *pTuner);
/**
 @brief Configure the ASCOT2E tuner for specified broadcasting system.
*/
static sonyrf_result_t X_init(sonyrf_ascot2e_t *pTuner, uint32_t frequencykHz, sonyrf_ascot2e_tv_system_t tvSystem);
/**
 @brief Configure the ASCOT2E tuner to Active state.
*/
static sonyrf_result_t X_tune(sonyrf_ascot2e_t *pTuner, uint32_t frequencykHz, sonyrf_ascot2e_tv_system_t tvSystem, uint8_t vcoCal);
/**
 @brief The last part of tuning sequence.
*/
static sonyrf_result_t X_tune_end(sonyrf_ascot2e_t *pTuner);
/**
 @brief Configure the ASCOT2E tuner to Sleep state.
*/
static sonyrf_result_t X_fin(sonyrf_ascot2e_t *pTuner);
/**
 @brief Reading gain information to calculate IF and RF gain levels.
*/
static sonyrf_result_t X_read_ss(sonyrf_ascot2e_t *pTuner, uint8_t *pAGCReg, uint8_t *pRFAGCReg);

/*------------------------------------------------------------------------------
 Implementation of public functions.
------------------------------------------------------------------------------*/

sonyrf_result_t sonyrf_ascot2e_Create(sonyrf_ascot2e_t *pTuner, uint32_t xtalFreqMHz,
    uint8_t i2cAddress, sonyrf_i2c_t *pI2c, uint32_t flags)
{
    SONYRF_TRACE_ENTER("sonyrf_ascot2e_Create");
    ...
    if((xtalFreqMHz == 41) && !(flags & SONYRF_ASCOT2E_CONFIG_EXT_REF)){
        SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_NOSUPPORT);
    }

    pTuner->state = SONYRF_ASCOT2E_STATE_UNKNOWN; /* Chip is not accessed for now */
    pTuner->xtalFreqMHz = xtalFreqMHz;
    pTuner->pI2c = pI2c;
    pTuner->i2cAddress = i2cAddress;
    pTuner->flags = flags;
    pTuner->frequencykHz = 0;
    pTuner->tvSystem = SONYRF_ASCOT2E_TV_SYSTEM_UNKNOWN;
    pTuner->rfagcreg = 0;
    pTuner->rfagcValid = 0;
...
sonyrf_result_t sonyrf_ascot2e_Initialize(sonyrf_ascot2e_t *pTuner)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_Initialize");
    ...
    pTuner->state = SONYRF_ASCOT2E_STATE_SLEEP;
    pTuner->frequencykHz = 0;
    pTuner->tvSystem = SONYRF_ASCOT2E_TV_SYSTEM_UNKNOWN;
...
sonyrf_result_t sonyrf_ascot2e_Tune(sonyrf_ascot2e_t *pTuner, uint32_t frequencykHz, sonyrf_ascot2e_tv_system_t tvSystem)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_Tune");
    ...
    if(!SONYRF_ASCOT2E_IS_ATV(tvSystem) && !SONYRF_ASCOT2E_IS_DTV(tvSystem)){
        SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_ARG);
    }

    /* State check */
    if((pTuner->state != SONYRF_ASCOT2E_STATE_SLEEP) && (pTuner->state != SONYRF_ASCOT2E_STATE_ACTIVE)){
        SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_SW_STATE);
    }

    if(pTuner->state == SONYRF_ASCOT2E_STATE_SLEEP){
        /* Set system to "Unknown". (for safe) */
        pTuner->tvSystem = SONYRF_ASCOT2E_TV_SYSTEM_UNKNOWN;
    }

    /* In digital tuning, step size is 25kHz. (+ rounding) */
    if(SONYRF_ASCOT2E_IS_DTV(tvSystem)){
    ...
    pTuner->state = SONYRF_ASCOT2E_STATE_ACTIVE;
    pTuner->frequencykHz = frequencykHz;
    pTuner->tvSystem = tvSystem;

    /* Previous rfagcreg value should not be used for sonyrf_ascot2e_ReadGain calculation. */
    pTuner->rfagcValid = 0;

    SONYRF_TRACE_RETURN(SONYRF_RESULT_OK);
}

sonyrf_result_t sonyrf_ascot2e_TuneEnd(sonyrf_ascot2e_t *pTuner)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_TuneEnd");

    if((!pTuner) || (!pTuner->pI2c)){
        SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_ARG);
    }

    if(pTuner->state != SONYRF_ASCOT2E_STATE_ACTIVE){
        SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_SW_STATE);
    }
...
sonyrf_result_t sonyrf_ascot2e_ShiftFRF(sonyrf_ascot2e_t *pTuner, uint32_t frequencykHz)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_ShiftFRF");
    ...
    /* In digital tuning, step size is 25kHz. (+ rounding) */
    if(SONYRF_ASCOT2E_IS_DTV(pTuner->tvSystem)){
        frequencykHz = ((frequencykHz + 25/2) / 25) * 25;
    }
...
sonyrf_result_t sonyrf_ascot2e_Sleep(sonyrf_ascot2e_t *pTuner)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_Sleep");
...
sonyrf_result_t sonyrf_ascot2e_SetGPO(sonyrf_ascot2e_t *pTuner, uint8_t id, uint8_t val)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_SetGPO");
    ...
    switch(id){
    case 0:
        result = sonyrf_i2c_SetRegisterBits(pTuner->pI2c, pTuner->i2cAddress, 0x05, (uint8_t)(val ? 0x01 : 0x00), 0x01);
        if(result != SONYRF_RESULT_OK){ SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_I2C); }
        break;
    case 1:
        result = sonyrf_i2c_SetRegisterBits(pTuner->pI2c, pTuner->i2cAddress, 0x05, (uint8_t)(val ? 0x02 : 0x00), 0x02);
        if(result != SONYRF_RESULT_OK){ SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_I2C); }
        break;
    default:
        SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_ARG);
...
sonyrf_result_t sonyrf_ascot2e_SetRfExtCtrl(sonyrf_ascot2e_t *pTuner, uint8_t enable)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_SetRfExtCtrl");
...
sonyrf_result_t sonyrf_ascot2e_ReadGain(sonyrf_ascot2e_t *pTuner, int32_t *pIFGain, int32_t *pRFGain, uint8_t forceRFAGCRead)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;
    uint8_t agcreg = 0;
    uint8_t rfagcreg = 0;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_ReadGain");
...
sonyrf_result_t sonyrf_ascot2e_RFFilterConfig(sonyrf_ascot2e_t *pTuner, uint8_t coeff, uint8_t offset)
{
    sonyrf_result_t result = SONYRF_RESULT_OK;

    SONYRF_TRACE_ENTER("sonyrf_ascot2e_RFFilterConfig");
...
static sonyrf_result_t X_pon(sonyrf_ascot2e_t *pTuner)
{
...
#ifndef SONYRF_ASCOT2E_IGNORE_NVM_ERROR /* For no NVM tuner evaluation */
        if((rdata[1] & 0x3F) != 0x00){
            SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_HW_STATE); /* CPU_ERR[5:0] != 0x00 (NVM Error) */
        }
#endif /* SONYRF_ASCOT2E_IGNORE_NVM_ERROR */
    }

    /* Xtal oscillator current control setting */
    if(!(pTuner->flags & SONYRF_ASCOT2E_CONFIG_EXT_REF)){
    ...
    /* XOSC_SEL setting */
    {
        ...
        if(pTuner->flags & SONYRF_ASCOT2E_CONFIG_EXT_REF){ /* Use external Xtal */
            /* XOSC_SEL=0(disable) */
            data = 0x00;
        }else{
            /* XOSC_SEL=100uA */
...
static sonyrf_result_t X_init(sonyrf_ascot2e_t *pTuner, uint32_t frequencykHz, sonyrf_ascot2e_tv_system_t tvSystem)
{
    ...
    /* IF_OUT_SEL / AGC_SEL setting */
    {
        ...
        if(pTuner->pParamTable[tvSystem].AGC_SEL == AUTO){
            ...
            if(SONYRF_ASCOT2E_IS_ATV(tvSystem)){
                /* Analog */
                if(pTuner->flags & SONYRF_ASCOT2E_CONFIG_AGC2_ATV){
                    data |= 0x08;
                }
            }else{
                /* Digital */
                if(pTuner->flags & SONYRF_ASCOT2E_CONFIG_AGC2_DTV){
                    data |= 0x08;
                }
            }
        }else{
        ...
        if(pTuner->pParamTable[tvSystem].IF_OUT_SEL == AUTO){
            ...
            if(SONYRF_ASCOT2E_IS_ATV(tvSystem)){
                /* Analog */
                if(pTuner->flags & SONYRF_ASCOT2E_CONFIG_IF2_ATV){
                    data |= 0x04;
                }
            }else{
                /* Digital */
                if(pTuner->flags & SONYRF_ASCOT2E_CONFIG_IF2_DTV){
                    data |= 0x04;
                }
            }
        }else{
        ...
        /* Set bit[4:2] only */
        result = sonyrf_i2c_SetRegisterBits(pTuner->pI2c, pTuner->i2cAddress, 0x05, data, 0x1C);
        if(result != SONYRF_RESULT_OK){ SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_I2C); }
    }
    ...
    /* 0x06 - 0x0F */
    {
        ...
        /* REF_R setting (0x06) */
        if(SONYRF_ASCOT2E_IS_ATV(tvSystem) || (tvSystem == SONYRF_ASCOT2E_DTV_DVBC)){
...
static sonyrf_result_t X_tune(sonyrf_ascot2e_t *pTuner, uint32_t frequencykHz, sonyrf_ascot2e_tv_system_t tvSystem, uint8_t vcoCal)
{
    ...
    /* RFAGC fast mode / RFAGC auto control enable (set bit[7], bit[5:4] only) */
    {
        ...
        result = sonyrf_i2c_SetRegisterBits(pTuner->pI2c, pTuner->i2cAddress, 0x0C, data, 0xB0);
        if(result != SONYRF_RESULT_OK){ SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_I2C); }
    }
    ...
    /* 0x10 - 0x14 */
    {
        ...
        if(tvSystem == SONYRF_ASCOT2E_ATV_L_DASH){
...
static sonyrf_result_t X_tune_end(sonyrf_ascot2e_t *pTuner)
{
    ...
    result = sonyrf_i2c_SetRegisterBits(pTuner->pI2c, pTuner->i2cAddress, 0x0C, 0x00, 0x30);
    if(result != SONYRF_RESULT_OK){ SONYRF_TRACE_RETURN(SONYRF_RESULT_ERROR_I2C); }
