...
unsigned char Si2151_L1_SetProperty2        (L1_Si2151_Context *api, unsigned int prop_code) {
  ...
  //  char msg[1000];
    ...
    if (res != NO_Si2151_ERROR) {
      mcDBG_MSG_ERR(("Si2151_L1_SetProperty2: %s 0x%04x!\n\n", Si2151_L1_API_ERROR_TEXT(res), prop_code));
      return res;
    }
...
unsigned char Si2151_L1_GetProperty2        (L1_Si2151_Context *api, unsigned int prop_code) {
  ...
  if (res != NO_Si2151_ERROR) {
    mcDBG_MSG_ERR(("Si2151_L1_GetProperty2: %s 0x%04x\n", Si2151_L1_API_ERROR_TEXT(res), prop_code));
    return res;
  }
...
int  Si2151_downloadATVProperties         (L1_Si2151_Context *api) {
  mcDBG_MSG_L2(("Si2151_downloadATVProperties\n"));
...
int  Si2151_downloadCOMMONProperties      (L1_Si2151_Context *api) {
  mcDBG_MSG_L2(("Si2151_downloadCOMMONProperties\n"));
...
int  Si2151_downloadDTVProperties         (L1_Si2151_Context *api) {
  mcDBG_MSG_L2(("Si2151_downloadDTVProperties\n"));
...
int  Si2151_downloadTUNERProperties       (L1_Si2151_Context *api) {
  mcDBG_MSG_L2(("Si2151_downloadTUNERProperties\n"));
  ...
  if (Si2151_L1_SetProperty2(api, Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_CODE    ) != NO_Si2151_ERROR) {return ERROR_Si2151_SENDING_COMMAND;}
...
unsigned char Si2151_PackProperty            (Si2151_PropObj   *prop, unsigned int prop_code, int *data) {
    ...
    #endif /*     Si2151_TUNER_BLOCKED_VCO3_PROP */
    #ifdef        Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP
     case         Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_CODE:
      *data = (prop->tuner_blocked_vco_config.distance_target & Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_MASK) << Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_LSB ;
     break;
    #endif /*     Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP */
    #ifdef        Si2151_TUNER_LO_INJECTION_PROP
...
unsigned char Si2151_UnpackProperty          (Si2151_PropObj   *prop, unsigned int prop_code, int  data) {
    ...
    #ifdef        Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP
     case         Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_CODE:
               prop->tuner_blocked_vco_config.distance_target = (data >> Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_LSB) & Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_DISTANCE_TARGET_MASK;
     break;
    #endif /*     Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP */
    #ifdef        Si2151_TUNER_LO_INJECTION_PROP
     case         Si2151_TUNER_LO_INJECTION_PROP_CODE:
...
void          Si2151_storePropertiesDefaults (Si2151_PropObj   *prop) {
  mcDBG_MSG_L2(("Si2151_storePropertiesDefaults\n"));
#ifdef    Si2151_ATV_AGC_SPEED_PROP
...
unsigned char Si2151_L1_PropertyText          (Si2151_PropObj   *prop, unsigned int prop_code, const char *separator, char *msg) {
    ...
    #ifdef        Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP
     case         Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP_CODE:
      sprintf(msg,"TUNER_BLOCKED_VCO_CONFIG");
       strcat(msg,separator); strcat(msg,"-DISTANCE_TARGET "); sprintf(msg,"%s%d", msg, prop->tuner_blocked_vco_config.distance_target);
     break;
    #endif /*     Si2151_TUNER_BLOCKED_VCO_CONFIG_PROP */
    #ifdef        Si2151_TUNER_LO_INJECTION_PROP
     case         Si2151_TUNER_LO_INJECTION_PROP_CODE:
