...
// CUSTOMER_SPECIFIC_SETTING_4 is used for certain customer application while 
//   under DVB-T/DTMB mode in order to improve performance. 
#define CUSTOMER_SPECIFIC_SETTING_4   1 
