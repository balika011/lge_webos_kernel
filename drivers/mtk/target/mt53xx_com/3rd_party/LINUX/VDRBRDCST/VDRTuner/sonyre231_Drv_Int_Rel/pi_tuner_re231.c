...
#define C_RE231_IF_FREQUENCY_ISDBT_6M        ((UINT16)  3550)  /* kHz */
#define C_RE231_IF_FREQUENCY_ISDBT_7M        ((UINT16)  4150)  /* kHz */
#define C_RE231_IF_FREQUENCY_ISDBT_8M        ((UINT16)  4750)  /* kHz */
...
#define C_RE231_IF_FREQUENCY_ISDBT_7M        ((UINT16)  4150)  /* kHz */
#define C_RE231_IF_FREQUENCY_ISDBT_8M        ((UINT16)  4750)  /* kHz */
#define C_RE231_IF_FREQUENCY_ATSC     ((UINT16)  3700)  /* kHz */  
#define C_RE231_IF_FREQUENCY_QAM 	  ((UINT16)  3700)/* kHz */  
...
#define C_SONY_RE231_STR        "SONY_RE231 2013-10-15-Xiaohong\n v1.4"
...
#if  defined(CC_SONYDEMOD_CXD2840)|| defined(CC_SONY_DISABLE_I2C_REPEATER)
	fgTunerNormal_GW_re231 = 1; // I2C gateway
	sonyrf_i2c_MTK_CreateI2cGw_re231(pI2c, psTunerCtx->u1DemodI2cAddress_Drv, 0x09); // I2C gateway
#else
        fgTunerNormal_GW_re231 = 0; // I2C repeater
       sonyrf_i2c_MTK_CreateI2c_re231(pI2c); // Normal (via I2C repeater)
#endif
  ...
  //  mcDBG_MSG_ERR(("Hello Maple! \n"));
    ...
    /* Digital */
     case MOD_ATSC_8VSB:
    	system = SONYRF_ASCOT3_DTV_8VSB;
            pTCtx->u2IF_Freq=C_RE231_IF_FREQUENCY_ATSC;
    break;
       case MOD_J83B_64QAM:
       case MOD_J83B_256QAM:
       case MOD_J83B_AUTO_QAM:
    	system = SONYRF_ASCOT3_DTV_QAM;
    	pTCtx->u2IF_Freq=C_RE231_IF_FREQUENCY_QAM;
     break;	
    case MOD_DVBT:
        switch(bandWidth){
    ...
    case MOD_ISDBT:
        ...
        case (UINT8)SAW_BW_6M:
            ...
            pTCtx->u2IF_Freq=C_RE231_IF_FREQUENCY_ISDBT_6M;
            break;
        case (UINT8)SAW_BW_7M:
            system = SONYRF_ASCOT3_DTV_ISDBT_7;
            pTCtx->u2IF_Freq=C_RE231_IF_FREQUENCY_ISDBT_7M;
	//xiaohong		
            //pTCtx->u2IF_Freq=C_RE231_IF_FREQUENCY_ISDBT_6M;
            break;
        case (UINT8)SAW_BW_8M:
			...
			//xiaohong
            pTCtx->u2IF_Freq=C_RE231_IF_FREQUENCY_ISDBT_8M;
