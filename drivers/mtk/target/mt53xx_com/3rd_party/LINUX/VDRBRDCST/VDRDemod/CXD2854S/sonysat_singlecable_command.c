                                                   ...
                                                   sonysat_singlecable_num_of_ub_slots_t numberOfUBSlots)
{
    ...
    static const struct{
        ...
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_2, 0x10},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_4, 0x11},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_6, 0x12},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_8, 0x13},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_2, 0x14},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_4, 0x15},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_6, 0x16},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_1, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_8, 0x17},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_2, 0x18},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_4, 0x19},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_6, 0x1A},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_STANDARD,  SONYSAT_SINGLECABLE_NUM_OF_UB_8, 0x1B},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_2, 0x1C},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_4, 0x1D},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_6, 0x1E},
        {SONYSAT_SINGLECABLE_NUM_OF_SAT_POS_2, SONYSAT_SINGLECABLE_RF_BAND_WIDE,      SONYSAT_SINGLECABLE_NUM_OF_UB_8, 0x1F}
    };
                                                       ...
                                                       uint8_t pin)
{
    ...
    result = sonysat_singlecable_command_ODU_Config (pMessage, address, ubSlot, numberOfSatPos, rfBand, numberOfUBSlots);
    if (result != SONYSAT_RESULT_OK) {SONYSAT_TRACE_RETURN (result);}
