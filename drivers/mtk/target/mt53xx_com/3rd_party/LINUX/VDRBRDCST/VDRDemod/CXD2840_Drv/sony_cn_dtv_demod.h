...
typedef enum {
    ...
    SONY_CN_DTV_DEMOD_STATE_SHUTDOWN,
...
typedef enum {
    ...
    SONY_CN_DTV_DEMOD_TS_OUTPUT_SERIAL_0,     /* SERIAL output from TSDATA0 pin */
    SONY_CN_DTV_DEMOD_TS_OUTPUT_SERIAL_7      /* SERIAL output from TSDATA7 pin */
...
/*--------------------------------------------------------------------
  preset data for fast synchronizaion
--------------------------------------------------------------------*/
typedef struct {
...
typedef struct {
    ...
    uint8_t                             isPreset;      /* PresetInfo exists or not for DTMB */
