...
sony_result_t sony_i2c_MTK_CreateI2c_DTMB(sony_i2c_t* pI2c, UINT8 busID);
#ifdef SONY_I2C_SUPPORT_GW /* I2C Gateway is for Sony demodulator */
sony_result_t sony_i2c_MTK_CreateI2cGw_DTMB(sony_i2c_t* pI2c, uint8_t gwAddress, uint8_t gwSub, UINT8 busID);
#endif
