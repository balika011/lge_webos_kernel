...
------------------------------------------------------------------------------*/
/**
 @file    sonysat_demod_dvbs_s2_blindscan.h

          This file provides functions to control demodulator for BlindScan/TuneSRS.
*/
/*----------------------------------------------------------------------------*/
#ifndef SONYSAT_DEMOD_DVBS_S2_BLINDSCAN_H
#define SONYSAT_DEMOD_DVBS_S2_BLINDSCAN_H
...
#endif /* SONYSAT_DEMOD_DVBS_S2_BLINDSCAN_H */
