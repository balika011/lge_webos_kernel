...
*/
#elif defined SONYSAT_DEMOD_SUPPORT_SAT /* Devices supporting Terrestrial or Cable and Satellite systems */
/**
 @brief Construct the driver.
...
/**
 @brief This API is called from ::sonysat_integ_XXX APIs to check that
        cancellation request by ::sonysat_integ_Cancel API is exist or not.
        The user can change this API code to check their system dependent
        cancellation request.

 @param pInteg The driver instance.

 @return SONYSAT_RESULT_OK if there is no cancellation request.
         SONYSAT_RESULT_ERROR_CANCEL if cancellation request exists.
*/
