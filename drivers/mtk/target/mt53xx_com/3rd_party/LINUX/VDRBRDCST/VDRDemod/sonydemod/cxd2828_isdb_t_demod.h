...
typedef enum cxd2828_isdb_t_demod_config_t{
    ...
    CXD2828_ISDB_T_DEMOD_CONFIG_SHARED_IF                 /* Shared IF (0: Disable(default) 1: Enable) */
...
typedef struct cxd2828_isdb_t_demod_t{
    ...
    UINT8                     tunerSpectrumSense;  /* 0:Not inverted, 1:Inverted */
    UINT8                     isSharedIf;          /* SharedIF or NOT */
