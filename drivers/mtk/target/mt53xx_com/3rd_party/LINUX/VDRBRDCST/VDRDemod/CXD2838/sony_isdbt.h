...
typedef struct sony_isdbt_tmcc_group_param_t {
    UINT8 isPartial;                   /**< 0:No partial reception, 1:Partial reception available */
...
typedef struct sony_isdbt_tmcc_info_t {
    ...
    UINT8                       countDownIndex; /**< Indicator of transmission-parameter switching */
    UINT8                       ewsFlag;        /**< Start flag for emergency-alarm broadcasting */
...
typedef struct sony_isdbt_aceew_area_t {
    UINT8 data[11];                             /**< Area data defined by ISDB-T specification */
...
typedef struct sony_isdbt_demod_aceew_epicenter_t {
    UINT8 data[11];                             /**< Epicenter data defined by ISDB-T specification */
...
typedef struct sony_isdbt_aceew_info_t {
    UINT8 startEndFlag;                         /**< Start/End flag (B17-B18) */
    UINT8 updateFlag;                           /**< Update flag (B19-B20) */
    UINT8 signalId;                             /**< Signal indentification (B21-B23) */
