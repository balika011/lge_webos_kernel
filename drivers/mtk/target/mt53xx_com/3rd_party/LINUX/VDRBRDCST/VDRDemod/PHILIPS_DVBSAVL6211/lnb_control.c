...
#define LNB_CHIP_MP8216 1
#define LNB_CHIP_ADDR 0x10

EXTERN INT32 AVL_DVBS2_SetGPIOPin60(UINT8 isHigh);
EXTERN INT32 AVL_DVBS2_SetGPIOPin59(UINT8 isHigh);
...
static void LNBC_RT5007LNBOutPut(enum LNBC_OUT_VOLTAGE eVoltageType)
{
	...
	while(jj--)
	{
		for(ii=1;ii<=3;ii++)
		{
			 ...
			 ucI2cWriteOnly(LNB_CHIP_ADDR, 0x00, 1);//select the register 0x00
...
#endif
#ifdef LNB_CHIP_MP8216
        AVL_DVBS2_SetGPIOPin60(0);
        AVL_DVBS2_SetGPIOPin59(0);
#endif
