...
typedef struct {
    ...
    uint8_t enableMDUMode;                  /**< Enable/Disable MDU mode for single cable tune sequence. */
    uint8_t PINCode;                        /**< The valid Pin Code for MDU commands for single cable tune sequence. */
...
*/
typedef enum {
    SONYSAT_INTEG_SAT_DEVICE_CTRL_DETECT_YES_NO_RESULT_YES,      /**< Detected YES Signal for Detect YES/NO. */
    SONYSAT_INTEG_SAT_DEVICE_CTRL_DETECT_YES_NO_RESULT_NO,       /**< Detected NO Signal for Detect YES/NO. */
    SONYSAT_INTEG_SAT_DEVICE_CTRL_DETECT_YES_NO_RESULT_NOTDETECT,/**< Could not detect any YES/NO signal. */
} sonysat_integ_sat_device_ctrl_detect_yes_no_result_t;
...
/**
 ...
 @param targetUB The user band ID.
