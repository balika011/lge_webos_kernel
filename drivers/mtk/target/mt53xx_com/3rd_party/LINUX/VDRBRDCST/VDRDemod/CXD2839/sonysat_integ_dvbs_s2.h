...
/**
 @brief This function returns the estimated RF level based on demodulator gain measurements
        ...
        has been optimised for the Sony evaluation board, and may require modifications for your
        own HW integration.  Please contact Sony support for advice on characterising your
        own implementation.
