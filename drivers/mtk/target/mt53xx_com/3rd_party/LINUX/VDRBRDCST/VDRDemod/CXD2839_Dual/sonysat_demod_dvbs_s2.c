                               ...
                               uint32_t symbolRateKSps)
{
     ...
     * <SLV-T>    ABh     98h     [3:0]   8'h01       8'h03        OCFRL_FMAX_HS[11:8]
     * <SLV-T>    ABh     99h     [7:0]   8'hF9       8'hAB        OCFRL_FMAX_HS[7:0]
     * <SLV-T>    ABh     9Ah     [3:0]   8'h0E       8'h0C        OCFRL_FMIN_HS[11:8]
     * <SLV-T>    ABh     9Bh     [7:0]   8'h07       8'h55        OCFRL_FMIN_HS[7:0]
    ...
    if (pDemod->pI2c->WriteOneRegister (pDemod->pI2c, pDemod->i2cAddressSLVT, 0x81, 0x00) != SONYSAT_RESULT_OK){
        SONYSAT_TRACE_RETURN (SONYSAT_RESULT_ERROR_I2C);
    }
