...
------------------------------------------------------------------------------*/
/**
 @file    sonysat_demod_sat_device_ctrl_find1ub_seq.h

          This file provides definitions for Find1UB sequence function.
*/
/*----------------------------------------------------------------------------*/
#ifndef SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_SEQ_H
#define SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_SEQ_H
...
*/
#define SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_SEARCH_RANGE_MHZ    1220
...
/**
 ...
 User can get the maximum used data size by sonysat_demod_dvbs_s2_blindscan_data_storage_t::maxUsedCount.
 If the driver returns SONYSAT_RESULT_ERROR_OVERFLOW, please increase this value.
*/
//#define SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_DATA_MAX           10000

/**
 @brief Definition of array size used in this driver.

 This value is calculated by SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_SEARCH_RANGE_MHZ.
 So user doesn't need to change this value directly.
*/
#define SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_POWER_MAX ((SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_SEARCH_RANGE_MHZ + 45) * 2)
...
*/
#define SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_ODU_TX_WAIT 300
...
} sonysat_demod_sat_device_ctrl_find1ub_seq_state_t;
...
typedef struct {
    ...
    */
    ...
    sonysat_demod_sat_device_ctrl_find1ub_seq_state_t seqState; /**< State of Find1UB sequence. */
    ...
    sonysat_diseqc_message_t message; /**< Single cable command data */
    sonysat_singlecable_ub_slot_t targetUB; /**< Target user band to detect */
    uint32_t ubFreqKHz; /**< Frequency of target UB */
    ...
    */
    sonysat_demod_dvbs_s2_blindscan_power_t powerArray[SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_POWER_MAX];
    /**
     @brief Data for storage.
    */
    sonysat_demod_dvbs_s2_blindscan_data_t dataArray[1];

} sonysat_demod_sat_device_ctrl_find1ub_seq_t;
...
/**
 ...
 @param targetUB Target user band which user want to find.

 @return SONYSAT_RESULT_OK if successful.
*/
sonysat_result_t sonysat_demod_sat_device_ctrl_find1ub_seq_Initialize (sonysat_demod_sat_device_ctrl_find1ub_seq_t * pSeq,
...
/**
 ...
 @return SONYSAT_RESULT_OK if successful.
*/
sonysat_result_t sonysat_demod_sat_device_ctrl_find1ub_seq_Sequence (sonysat_demod_sat_device_ctrl_find1ub_seq_t * pSeq);

#endif /* SONYSAT_DEMOD_SAT_DEVICE_CTRL_FIND1UB_SEQ_H */
