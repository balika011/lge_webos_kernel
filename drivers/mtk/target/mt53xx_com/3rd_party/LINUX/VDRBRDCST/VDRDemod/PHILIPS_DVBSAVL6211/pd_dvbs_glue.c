...
#define DVBS_Vendor_Driver_Ver "2013-04-07 SDK 1.0.21 patch 1.0.29	"
...
{	
#ifdef CC_COBRA_DEMOD_RESET
	UINT32 u4ResetGpionum;

    u4ResetGpionum=88;//xiongfeng add for cobra need reset gpio 88,if you want to reset demod GPIO to other IC,please mark this line
...
static void AVL_ResendDiseqcCmmd(DISEQC_BUS_CMD_T *diseqc_cmd)
{
	...
	//mcDELAY_MS(20);
		...
		{//apply you code
			...
			mcDELAY_MS(20);
			mcDBG_MSG_L2(("[AVL_ResendDiseqcCmmd]After set cmd,delay 20ms,delay>15ms\n"));
    		}
		...
		case TUNER_GET_TYPE_SAT_DIG:
			{	/*maybe return Last_program_channel*/
				...
				if(AVL_DVBS2_CheckTP_IsLocked())
					...
					pAttri0->e_dvb_s_s2_mode=AVL_DVBS2_Get_SYSTEM();
	       	 	}
				 else
			 	{
