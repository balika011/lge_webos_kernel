...
------------------------------------------------------------------------------*/
/**
 @file    sonysat_demod_sat_device_ctrl_detect_cw_seq.h

          This file provides definitions for DetectCW sequence function.
*/
/*----------------------------------------------------------------------------*/
#ifndef SONYSAT_DEMOD_SAT_DEVICE_CTRL_DETECT_CW_SEQ_H
#define SONYSAT_DEMOD_SAT_DEVICE_CTRL_DETECT_CW_SEQ_H
...
} sonysat_demod_sat_device_ctrl_detect_cw_seq_state_t;
...
typedef struct {
    ...
    */
    ...
    sonysat_demod_sat_device_ctrl_detect_cw_seq_state_t seqState; /**< State of DetectCW sequence. */
    ...
    */
    sonysat_demod_dvbs_s2_blindscan_power_t powerArray[1];
...
} sonysat_demod_sat_device_ctrl_detect_cw_seq_t;
...
#endif /* SONYSAT_DEMOD_SAT_DEVICE_CTRL_DETECT_CW_SEQ_H */
