...
uint32_t sony_math_log2_DTMB (uint32_t x)
{
    uint8_t count = 0;
    uint8_t index = 0;
    uint32_t xval = x;
...
uint32_t sony_math_log10_DTMB (uint32_t x)
{
    /* log10(x) = log2 (x) / log2 (10) */
    /* Note uses: logN (x) = logM (x) / logM (N) */
    return ((100 * sony_math_log2_DTMB (x) + LOG2_10_100X / 2) / LOG2_10_100X);
}

uint32_t sony_math_log_DTMB (uint32_t x)
{
    /* ln (x) = log2 (x) / log2(e) */
    return ((100 * sony_math_log2_DTMB (x) + LOG2_E_100X / 2) / LOG2_E_100X);
}
