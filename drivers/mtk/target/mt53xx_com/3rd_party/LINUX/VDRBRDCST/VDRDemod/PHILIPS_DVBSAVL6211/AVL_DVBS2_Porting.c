...
INT32 AVL_DVBS2_SetGPIOPin60(UINT8 isHigh)
{
    struct AVL_DVBSx_Chip * pAVLChip=&AVL_DVBSxChip;
    AVL_uchar fgisHigh=(AVL_uchar)isHigh;
    AVL_DVBSx_IDiseqc_SetLNB1Out(fgisHigh,pAVLChip);
    return DRVAPI_TUNER_OK;
}

INT32 AVL_DVBS2_SetGPIOPin59(UINT8 isHigh)
{
    struct AVL_DVBSx_Chip * pAVLChip=&AVL_DVBSxChip;
    AVL_uchar fgisHigh=(AVL_uchar)isHigh;
    AVL_DVBSx_IDiseqc_SetLNBOut(fgisHigh,pAVLChip);
    return DRVAPI_TUNER_OK;
}
