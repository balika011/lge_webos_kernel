...
*/
static sony_result_t SLTtoAT_24MHzXtalSetting (sony_demod_t * pDemod);
...
static sony_result_t SLTtoAT(sony_demod_t * pDemod)
{
     ...
     * slave     Bank    Addr   Bit     default    Value      Name
     * --------------------------------------------------------------------------------------------------------
     * <SLV-T>   18h     36h    [2:0]   8'h44      8'h40      OREG_RSD_BER_SEL[2:0],1'b0,OREG_RSD_BERN_SEL[2:0] (For 2k12 Generation Demod Chips)
     * <SLV-T>   18h     36h    [2:0]   8'h40      8'h40      OREG_RSD_BER_SEL[2:0],1'b0,OREG_RSD_BERN_SEL[2:0] (For 2k14 Generation Demod Chips)
     */
    ...
    if (pDemod->xtalFreq == SONY_DEMOD_XTAL_24000KHz) {
        result = SLTtoAT_24MHzXtalSetting(pDemod);
        if (result != SONY_RESULT_OK) {
            SONY_TRACE_RETURN (result);
        }
    }
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("SLTtoAT_24MHzXtalSetting");
    ...
    {
        uint8_t data[3] = {0xDC, 0x6C, 0x00};

        /* Slave     Bank    Addr   Bit     Default    Value      Name
         * ----------------------------------------------------------------------------------
         * <SLV-T>   18h     24h    [7:0]   8'h71      8'hDC      OREG_BER_MAXCLKCNT[23:16]
         * <SLV-T>   18h     25h    [7:0]   8'h9C      8'h6C      OREG_BER_MAXCLKCNT[15:8]
         * <SLV-T>   18h     26h    [7:0]   8'h40      8'h00      OREG_BER_MAXCLKCNT[7:0]
         */
...
static sony_result_t SLTtoAT_BandSetting(sony_demod_t * pDemod)
{
    ...
    case SONY_DTV_BW_8_MHZ:
...

        {
             ...
             * --------------------------------------------------------------------
             * (For 2k12 Generation Demod Chips)
             * <SLV-T>   10h     D9h    [5:0]     8'h01     OREG_CDRB_GTDOFST[13:8]
             * <SLV-T>   10h     DAh    [7:0]     8'hE0     OREG_CDRB_GTDOFST[7:0]
             * (For 2k14 Generation Demod Chips)
             * <SLV-T>   10h     D9h    [5:0]     8'h00     OREG_CDRB_GTDOFST[13:8]
             * <SLV-T>   10h     DAh    [7:0]     8'hBC     OREG_CDRB_GTDOFST[7:0]
             */
