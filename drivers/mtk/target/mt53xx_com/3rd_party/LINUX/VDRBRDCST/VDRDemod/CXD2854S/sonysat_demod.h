...
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
...
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2844 /* DVB-T/T2/C/S/S2 Demodulator */
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2846 /* DVB-T/T2/C/C2/S/S2 Demodulator */
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#define SONYSAT_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2853 /* DVB-T/C/S/S2 Demodulator */
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2854 /* DVB-T/T2/C/C2/S/S2 Demodulator, ISDB-T/S */
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#define SONYSAT_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#define SONYSAT_DEMOD_SUPPORT_ISDBT               /**< Driver supports ISDBT. */
#define SONYSAT_DEMOD_SUPPORT_ISDBS               /**< Driver supports ISDBS. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2855 /* DVB-T/T2/C Demodulator, ISDB-T */
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_ISDBT               /**< Driver supports ISDBT. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2856 /* DVB-T/C/C2/S/S2 Demodulator */
#define SONYSAT_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#define SONYSAT_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONYSAT_DRIVER_BUILD_OPTION_CXD2857 /* DVB-C/C2 */
#define SONYSAT_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONYSAT_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#else
...
#if (defined SONYSAT_DEMOD_SUPPORT_DVBT) || (defined SONYSAT_DEMOD_SUPPORT_DVBT2) || (defined SONYSAT_DEMOD_SUPPORT_DVBC) || (defined SONYSAT_DEMOD_SUPPORT_DVBC2) || (defined SONYSAT_DEMOD_SUPPORT_ISDBT)
#define SONYSAT_DEMOD_SUPPORT_TERR_OR_CABLE  /**< Enable common terrestial and cable code */
#endif

#if (defined SONYSAT_DEMOD_SUPPORT_DVBS_S2) || (defined SONYSAT_DEMOD_SUPPORT_ISDBS) 
#define SONYSAT_DEMOD_SUPPORT_SAT  /**< Enable common satellite code */
#endif
/*------------------------------------------------------------------------------
  Includes
------------------------------------------------------------------------------*/
...
#include "sonysat_isdbt.h"
#endif

#ifdef SONYSAT_DEMOD_SUPPORT_ISDBS
#include "sonysat_isdbs.h"
#endif
/*------------------------------------------------------------------------------
  Defines
------------------------------------------------------------------------------*/
...
*/
#define SONYSAT_DEMOD_MAKE_IFFREQ_CONFIG(xTal, iffreq) ((xTal == SONYSAT_DEMOD_XTAL_24000KHz)? ((uint32_t)(((iffreq)/48.0)*16777216.0 + 0.5)) : ((uint32_t)(((iffreq)/41.0)*16777216.0 + 0.5)))
#endif
...
/**
 @brief This macro is used to determine that 2k12 Generation Demod chip is used.
*/
#define SONYSAT_DEMOD_CHIP_ID_2k12_GENERATION(chipId) ((chipId == SONYSAT_DEMOD_CHIP_ID_CXD2837) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2839) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2841) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2842) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2843))

/**
 @brief This macro is used to determine that 2k14 Generation Demod chip is used.
*/
#define SONYSAT_DEMOD_CHIP_ID_2k14_GENERATION(chipId) ((chipId == SONYSAT_DEMOD_CHIP_ID_CXD2844) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2846) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2853) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2854) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2855) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2856) || \
                                                    (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2857))

/**
 @brief This macro is used to determine that Demod chip supports T/C.
*/
#define SONYSAT_DEMOD_CHIP_ID_SUPPORT_TERR_OR_CABLE(chipId) ((chipId == SONYSAT_DEMOD_CHIP_ID_CXD2837) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2841) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2842) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2843) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2844) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2846) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2853) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2854) || \
                                                          (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2855) || \
...
/**
 @brief This macro is used to determine that Demod chip supports S/S2.
*/
#define SONYSAT_DEMOD_CHIP_ID_SUPPORT_SAT(chipId) ((chipId == SONYSAT_DEMOD_CHIP_ID_CXD2839) || \
                                                (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2841) || \
                                                (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2842) || \
                                                (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2844) || \
                                                (chipId == SONYSAT_DEMOD_CHIP_ID_CXD2846) || \
...
typedef enum {
    ...
    SONYSAT_DEMOD_XTAL_24000KHz,           /**< 24 MHz */
...
typedef enum {
    ...
    SONYSAT_DEMOD_CHIP_ID_CXD2844 = 0xC5,  /**< CXD2844  DVB-T/T2/C/S/S2 */
    SONYSAT_DEMOD_CHIP_ID_CXD2846 = 0xC7,  /**< CXD2846  DVB-T/T2/C/C2/S/S2 */
    SONYSAT_DEMOD_CHIP_ID_CXD2853 = 0xC9,  /**< CXD2853  DVB-T/C/S/S2 */
    SONYSAT_DEMOD_CHIP_ID_CXD2854 = 0xC1,  /**< CXD2854  DVB-T/T2/C/C2/S/S2. ISDB-T/S */
    SONYSAT_DEMOD_CHIP_ID_CXD2855 = 0xC3,  /**< CXD2855  DVB-T/T2/C. ISDB-T */
    SONYSAT_DEMOD_CHIP_ID_CXD2856 = 0xCA,  /**< CXD2856  DVB-T/C/C2/S/S2 */
    SONYSAT_DEMOD_CHIP_ID_CXD2857 = 0xCC,  /**< CXD2857  DVB-C/C2 */
...
typedef enum {
    ...
    SONYSAT_DEMOD_STATE_SLEEP_T_C,         /**< Chip is in Sleep state for DVB-T / T2 / C / C2 and ISDB-T. */
    SONYSAT_DEMOD_STATE_SLEEP_S,           /**< Chip is in Sleep state for DVB-S / S2 and ISDB-S. */
    SONYSAT_DEMOD_STATE_ACTIVE_T_C,        /**< Chip is in Active state for DVB-T / T2 / C / C2 and ISDB-T. */
    SONYSAT_DEMOD_STATE_ACTIVE_S,          /**< Chip is in Active state for DVB-S / S2 and ISDB-S. */
...
/**
 @brief Demodulator software sub state for ISDB-T.
        ...
        This state is effective only when sonysat_demod_state_t is ACTIVE_T_C.
*/
typedef enum {
    SONYSAT_DEMOD_ISDBT_STATE_NORMAL = 0,   /**< Normal state.  TS output is enabled */
    SONYSAT_DEMOD_ISDBT_STATE_EWS           /**< EWS state.  TS output is disabled */
} sonysat_demod_isdbt_ews_state_t;
...
#endif /* SONYSAT_DEMOD_SUPPORT_TERR_OR_CABLE */
...
#endif /* SONYSAT_DEMOD_SUPPORT_SAT */
...
typedef enum {
    ...
    */
    SONYSAT_DEMOD_CONFIG_PARALLEL_TSCLK_MANUAL,
    ...
    */
    SONYSAT_DEMOD_CONFIG_ISDBT_BERPER_PERIOD,
    ...
    /**
     @brief Configure which type of Emergency Warning flags is to be output to GPIO (ISDB-T only).
            ...
            - 2: EWS or AC EEW
    */
    SONYSAT_DEMOD_CONFIG_GPIO_EWS_FLAG,
#endif
    ...
    */
    SONYSAT_DEMOD_CONFIG_DVBSS2_BER_PER_MES,
    ...
    /**
     @brief Measurement period for Pre-BCH BER(DVB-S2) and Post-BCH FER(DVB-S2).
            ...
            - Valid range is 0 <= value <= 15.
    */
    SONYSAT_DEMOD_CONFIG_DVBS2_BER_FER_MES,
    ...
    /**
     @brief Measurement period for Pre-Viterbi BER(DVB-S).
            ...
            - Valid range is 0 <= value <= 15.
    */
    SONYSAT_DEMOD_CONFIG_DVBS_VBER_MES,
    ...
    /**
     @brief Measurement period for Pre-LDPC BER(DVB-S2).
            ...
            - Valid range is 0 <= value <= 15.
    */
    SONYSAT_DEMOD_CONFIG_DVBS2_LBER_MES,

    /**
     @brief Spectrum mode for BlindScan and TuneSRS.

            - 0: Normal (default)
            - 1: Calculate average.
    */
    SONYSAT_DEMOD_CONFIG_DVBSS2_SPECTRUM_MODE,

    /**
     @brief Count for calculate average at scan power spectrum in BlindScan and TuneSRS.

            This is enable when SONYSAT_DEMOD_CONFIG_DVBSS2_SPECTRUM_MODE = 1.
            The valid value is 1, 2, 4, 8, 16, 32, 64.
    */
    SONYSAT_DEMOD_CONFIG_DVBSS2_SPECTRUM_COUNT,
    ...
    */
    SONYSAT_DEMOD_CONFIG_ISDBS_BERNUMCONF,
    ...
    */
    ...
    /**
     @brief Measurement period for Pre-RS BER(ISDB-S) and Post-RS PER(ISDB-S)  at transmission mode 2.
            ...
            - Valid range is 0 <= value <= 15.
    */
    SONYSAT_DEMOD_CONFIG_ISDBS_BER_PERIOD2,
    ...
    */
    SONYSAT_DEMOD_CONFIG_ISDBS_BER_PERIODT,
...
typedef enum {
    ...
    */
    ...
    /** @brief GPIO pin is configured to EWS flag (ISDB-T/S Only) */
    SONYSAT_DEMOD_GPIO_MODE_EWS_FLAG = 0x06,
...
typedef struct sonysat_demod_t {
    ...
    */
    sonysat_dtv_bandwidth_t bandwidth;
    ...
    */
    ...
    /**
     @brief This flag indicates whether the current ISDB-T sub state is in EWS mode or normal mode.
            ...
            SONYSAT_DEMOD_STATE_ACTIVE_T_C state.
    */    
    sonysat_demod_isdbt_ews_state_t isdbtEwsState;
    ...
    */
    ...
    /**
     @brief The method to get power spectrum in BlindScan and TuneSRS.
            This is configured using ::sonysat_demod_SetConfig with the
            SONYSAT_DEMOD_CONFIG_DVBSS2_SPECTRUM_MODE option.
    */
    ...
    /**
     @brief The count of calculation for power spectrum calculation in BlindScan and TuneSRS.
            This is configured using ::sonysat_demod_SetConfig with the
            SONYSAT_DEMOD_CONFIG_DVBSS2_SPECTRUM_COUNT option.
            It is valid only if spectrumMode == 1.
            Default value is 4.

            If spectrumMode == 0, this parameter is invalid.
            If spectrumMode == 1, 0,1,2,4,8,16,32,64 are valid.
    */
    uint8_t spectrumCount;
    ...
    /**
     @brief The parallel TS clock Manual setting option for all active states. 
            This is configured using ::sonysat_demod_SetConfig with the 
            SONYSAT_DEMOD_CONFIG_PARALLEL_TSCLK_MANUAL option.
    */
    ...
    */
    ...
    /**
     @brief TS backwards compatible mode state. This is configured using
            ::sonysat_demod_SetConfig with the SONYSAT_DEMOD_CONFIG_TS_BACKWARDS_COMPATIBLE.
    */
...
/**
 ...
 @return SONYSAT_RESULT_OK if pDigitalAGCOut is valid.
*/
