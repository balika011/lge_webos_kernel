...
/**
 @brief Number of Input Banks definition.
*/
typedef enum {
    SONYSAT_SINGLECABLE_NUM_OF_INPUT_BANKS_2,   /**< 2 Input Banks */
    SONYSAT_SINGLECABLE_NUM_OF_INPUT_BANKS_4,   /**< 4 Input Banks */
    SONYSAT_SINGLECABLE_NUM_OF_INPUT_BANKS_8    /**< 8 Input Banks */
} sonysat_singlecable_num_of_input_banks_t;
...
typedef struct {
    ...
    sonysat_singlecable_num_of_input_banks_t numberOfInputBanks; /**< Number of Input Banks. */
...
/**
 ...
 @param numberOfInputBanks The number of input banks.
