...
------------------------------------------------------------------------------*/
/**
 @file    sonysat_horus3a.h

          This file provides the HORUS3A tuner control interface.
*/
/*----------------------------------------------------------------------------*/

#ifndef SONYSAT_HORUS3A_H
#define SONYSAT_HORUS3A_H
...
*/
#define SONYSAT_HORUS3A_VERSION     "1.0.3.0"

/**
 @brief Default I2C slave address of the HORUS3A tuner.
*/
#define SONYSAT_HORUS3A_ADDRESS     0xC0
...
*/
typedef enum {
    SONYSAT_HORUS3A_STATE_UNKNOWN,
    SONYSAT_HORUS3A_STATE_SLEEP,
    SONYSAT_HORUS3A_STATE_ACTIVE
} sonysat_horus3a_state_t;

/**
 @brief Satellite broadcasting system definitions supported by HORUS3A.
*/
typedef enum {
    SONYSAT_HORUS3A_TV_SYSTEM_UNKNOWN,
    SONYSAT_HORUS3A_STV_ISDBS,     /**< ISDB-S */
    SONYSAT_HORUS3A_STV_DVBS,      /**< DVB-S */
    SONYSAT_HORUS3A_STV_DVBS2      /**< DVB-S2 */
} sonysat_horus3a_tv_system_t;
...
*/
typedef struct sonysat_horus3a_t {
    ...
    uint32_t                 flags;          /**< ORed value of SONYSAT_HORUS3A_CONFIG_XXXX */

    /* For saving current setting */
    sonysat_horus3a_state_t     state;          /**< The driver operating state. */
    uint32_t                 frequencykHz;   /**< Currently RF frequency(kHz) tuned. */
    sonysat_horus3a_tv_system_t tvSystem;       /**< Current broadcasting system tuned. */
...
*/
#define SONYSAT_HORUS3A_CONFIG_REFOUT_OFF              0x80000000
...
*/
#define SONYSAT_HORUS3A_CONFIG_POWERSAVE_ENABLEXTAL    0x40000000

/**
 @brief Use external Xtal
        Should be used for slave HORUS3A in Xtal shared system.
*/
#define SONYSAT_HORUS3A_CONFIG_EXT_REF                 0x20000000

/**
 @brief Internal LNA enable
*/
#define SONYSAT_HORUS3A_CONFIG_LNA_ENABLE              0x10000000

/**
 @brief Stop internal LNA in power save state.
        This flag is ignored if SONYSAT_HORUS3A_CONFIG_LNA_ENABLE is not used.
*/
#define SONYSAT_HORUS3A_CONFIG_POWERSAVE_STOPLNA       0x08000000
...
*/
/**@{*/
#define SONYSAT_HORUS3A_CONFIG_IQOUT_DIFFERENTIAL      0x00000000  /**< IQ Output is Differential */
#define SONYSAT_HORUS3A_CONFIG_IQOUT_SINGLEEND         0x01000000  /**< IQ Output is Single-Ended (+4.4dB) */
#define SONYSAT_HORUS3A_CONFIG_IQOUT_SINGLEEND_LOWGAIN 0x02000000  /**< IQ Output is Single-Ended (-2.4dB) */
#define SONYSAT_HORUS3A_CONFIG_IQOUT_MASK              0x03000000  /**< DON'T set this value. (Internal use only) */
/**@}*/
...
/**
 @brief Set up the HORUS3A tuner driver.
        ...
        This MUST be called before calling sonysat_horus3a_Initialize.
 ...
 @param flags       Configuration flags. It should be ORed value of SONYSAT_HORUS3A_CONFIG_XXXX.

 @return SONYSAT_RESULT_OK if successful.
*/
sonysat_result_t sonysat_horus3a_Create(sonysat_horus3a_t *pTuner, uint32_t xtalFreqMHz,
    uint8_t i2cAddress, sonysat_i2c_t *pI2c, uint32_t flags);

/**
 @brief Initialize the HORUS3A tuner.
        
        This MUST be called before calling sonysat_horus3a_Tune.

 @param pTuner       The HORUS3A tuner instance.

 @return SONYSAT_RESULT_OK if successful.
*/
sonysat_result_t sonysat_horus3a_Initialize(sonysat_horus3a_t *pTuner);
...
*/
sonysat_result_t sonysat_horus3a_Tune(sonysat_horus3a_t *pTuner, uint32_t frequencykHz,
    sonysat_horus3a_tv_system_t tvSystem, uint32_t symbolRateksps);

/**
 @brief Put the HORUS3A tuner into Sleep state.
 
        From this state the tuner can be directly tuned by calling sonysat_horus3a_Tune.

 @param pTuner       The HORUS3A tuner instance.

 @return SONYSAT_RESULT_OK if successful.
*/
sonysat_result_t sonysat_horus3a_Sleep(sonysat_horus3a_t *pTuner);
...
/**
 ...
 @return SONYSAT_RESULT_OK if successful.
*/
sonysat_result_t sonysat_horus3a_SetGPO(sonysat_horus3a_t *pTuner, uint8_t output);

#endif /* SONYSAT_HORUS3A_H */
