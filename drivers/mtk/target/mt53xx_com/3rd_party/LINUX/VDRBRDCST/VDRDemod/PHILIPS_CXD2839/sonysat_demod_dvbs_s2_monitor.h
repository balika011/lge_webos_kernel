...
/**
 @brief Monitor the symbol rate of the currently tuned channel in KSps.
 
 @param pDemod The demodulator instance.
 @param pSymbolRateKSps The symbol rate in KSps.

 @return SONYSAT_RESULT_OK if pSymbolRateKSps is valid.
*/
sonysat_result_t sonysat_demod_dvbs_s2_monitor_SymbolRate (sonysat_demod_t * pDemod,
                                                     uint32_t * pSymbolRateKSps);
