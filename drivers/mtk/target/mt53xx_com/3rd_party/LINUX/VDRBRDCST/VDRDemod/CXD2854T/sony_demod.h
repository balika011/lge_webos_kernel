...
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2844 /* DVB-T/T2/C/S/S2 Demodulator */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2846 /* DVB-T/T2/C/C2/S/S2 Demodulator */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#define SONY_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2853 /* DVB-T/C/S/S2 Demodulator */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2854 /* DVB-T/T2/C/C2/S/S2 Demodulator, ISDB-T/S */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
...
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2855 /* DVB-T/T2/C Demodulator, ISDB-T */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBT2               /**< Driver supports DVBT2. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_ISDBT               /**< Driver supports ISDBT. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2856 /* DVB-T/C/C2/S/S2 Demodulator */
#define SONY_DEMOD_SUPPORT_DVBT                /**< Driver supports DVBT. */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#define SONY_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */
#elif defined SONY_DRIVER_BUILD_OPTION_CXD2857 /* DVB-C/C2 */
#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC. */
#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2. */
#else
...
#if (defined SONY_DEMOD_SUPPORT_DVBT) || (defined SONY_DEMOD_SUPPORT_DVBT2) || (defined SONY_DEMOD_SUPPORT_DVBC) || (defined SONY_DEMOD_SUPPORT_DVBC2) || (defined SONY_DEMOD_SUPPORT_ISDBT)
#define SONY_DEMOD_SUPPORT_TERR_OR_CABLE  /**< Enable common terrestial and cable code */
#endif

#if (defined SONY_DEMOD_SUPPORT_DVBS_S2) || (defined SONY_DEMOD_SUPPORT_ISDBS) 
...
*/
#define SONY_DEMOD_CHIP_ID_SUPPORT_TERR_OR_CABLE(chipId) ((chipId == SONY_DEMOD_CHIP_ID_CXD2837) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2841) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2842) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2843) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2844) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2846) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2853) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2854) || \
                                                          (chipId == SONY_DEMOD_CHIP_ID_CXD2855) || \
...
*/
#define SONY_DEMOD_CHIP_ID_SUPPORT_SAT(chipId) ((chipId == SONY_DEMOD_CHIP_ID_CXD2839) || \
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD2841) || \
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD2842) || \
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD2844) || \
                                                (chipId == SONY_DEMOD_CHIP_ID_CXD2846) || \
...
typedef enum {
    ...
    SONY_DEMOD_STATE_SLEEP_T_C,         /**< Chip is in Sleep state for DVB-T / T2 / C / C2 and ISDB-T. */
    SONY_DEMOD_STATE_SLEEP_S,           /**< Chip is in Sleep state for DVB-S / S2 and ISDB-S. */
    SONY_DEMOD_STATE_ACTIVE_T_C,        /**< Chip is in Active state for DVB-T / T2 / C / C2 and ISDB-T. */
    SONY_DEMOD_STATE_ACTIVE_S,          /**< Chip is in Active state for DVB-S / S2 and ISDB-S. */
...
typedef struct sony_demod_t {
    ...
    */
    ...
    /**
     @brief This flag indicates whether the current ISDB-T sub state is in EWS mode or normal mode.
            ...
            SONY_DEMOD_STATE_ACTIVE_T_C state.
    */    
    ...
    */
    ...
    /**
     @brief I2C repeater ON/OFF enable (For MTK)
    */
...
sony_result_t sony_demod_ReinitializeT_C (sony_demod_t * pDemod); /* For MTK */

sony_result_t sony_demod_ForceShutdown (sony_demod_t * pDemod); /* For MTK */
