...
#define VENDOR_DRIVER_VER            "CXD2854 (DVB-S/S2) v0.04 (2014-03-18)"
 ...
 */
//-------------------------------------------------------------------------
INT32 DVBS_TunerOpen_c1(PTD_CTX ptTDCtx, TUNER_CONFIG_T * ptTunerCfgInfo, PTD_SPECIFIC_CTX* pptTDSpecificCtx)
{
    sonysat_result_t sonysat_result = SONYSAT_RESULT_OK;
    sonysat_integ_t *pInteg = &g_sonysat_demod_ctx.integ;
    sonysat_demod_t *pDemod = &g_sonysat_demod_ctx.demod;
 ...
 */
//-------------------------------------------------------------------------
INT32 DVBS_TunerOpen_c2(PTD_CTX ptTDCtx, TUNER_CONFIG_T * ptTunerCfgInfo, PTD_SPECIFIC_CTX* pptTDSpecificCtx)
{
    sonysat_result_t sonysat_result = SONYSAT_RESULT_OK;
    sonysat_integ_t *pInteg = &g_sonysat_demod_ctx.integ;
    sonysat_demod_t *pDemod = &g_sonysat_demod_ctx.demod;
