...
typedef enum {
    ...
    SONYSAT_RESULT_ERROR_TIMEOUT,   /**< Timeout occured */
    ...
    SONYSAT_RESULT_ERROR_CANCEL,    /**< The operation is canceled */
    SONYSAT_RESULT_ERROR_OTHER,     /**< Inspecific error */
...
typedef sonysat_result_t (*SAT_STOPWATCH_ELAPSED_FCT) (sonysat_stopwatch_t * pStopwatch, uint32_t* pElapsed);
...
/**
 ...
 @return SONYSAT_RESULT_OK is succesful.
*/
...
#if 0 //MTK_Dual_Tuner: Mark for use function pointer
/**
