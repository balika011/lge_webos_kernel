...
#if 0 //Denny 2012/12/07 mark for compile error
#ifndef memcpy
...
#define MHL_GPIO_RST 204 //40 //Denny 2012/05/29
...
#define DEVICE_ID_L             0x03 // For TPV's Device ID (Product ID)
...
#define GPIO_CTRL_VBUS //Denny 2012/11/09 add
...
void fgSil_NTF_CBUS_Connected(void); //Denny 2013/01/07 add for SiI's code

void fgSil_NTF_CBUS_Disconnected(void); //Denny 2013/01/07 add for SiI's code

void fgSil_NTF_3D_Communicated(void); //Denny 2013/01/07 add for SiI's code
extern VOID fgSil_MHL_Enable_MLoop(BOOL bEnterMloop); //Denny 2012/11/12 add
extern VOID fgSil_Force_MHL_Mode(VOID); //Denny 2012/11/29 add
extern void vMHLVBusEnable(void); //Denny 2012/12/03 add
extern void vMHLVBusDisable(void); //Denny 2012/12/03 add
extern BOOL fgSil_RecoveryMHLCable(void); //Denny 2012/12/07 add
extern void SiISetTermainationFlag(BOOL bOn); //Denny 2013/01/10 add
extern void fgSiI_SetFlag_gEnterTvStandby(BOOL bOn); //Denny 2013/01/11 add
extern BOOL fgSiI_GetFlag_gEnterTvStandby(void); //Denny 2013/01/11 add
#endif
