...
#define LOG_ERROR_TYPE  Printf("<Error type> 0 - 12V_AMP Error\n");         \
                        ...
                        Printf("             10 -Panel I2C Error\n");       \
                        Printf("             11 -Tuner Error\n");           \
                        Printf("             12 -SubWoofer Error\n");           \
                        Printf("             13 -TouchSnr Error\n");           \
                        Printf("             14 -CarBattery Error\n");           \
                        Printf("             15 - All Error\n");               
...
#define DUMP_ERROR_TYPE(SelfDiagTbl)                                        \
	...
	Printf(" 10 - Panel I2C Error	: %d\n", SelfDiagTbl.u2PanelNIMError);	\
    Printf(" 11 - Tuner Error       : %d\n", SelfDiagTbl.u2TunerError);     \
    Printf(" 12 - SubWoofer Error		: %d\n", SelfDiagTbl.u2SubWooferError); 	\
    Printf(" 13 - TouchSnr Error		: %d\n", SelfDiagTbl.u2TouchSnrError); 	\
    Printf(" 14 - CarBattery Error		: %d\n", SelfDiagTbl.u2CarBatteryError); 
#else
#define LOG_ERROR_TYPE  Printf("<Error type> 0 - 12V_AMP Error\n");         \
                        Printf("             1 - 12V_SW Error\n");          \
                        Printf("             2 - 24V Error\n");             \
...
#define DUMP_ERROR_TYPE(SelfDiagTbl)                                        \
	...
	Printf(" 10 - Panel I2C Error	: %d\n", SelfDiagTbl.u2PanelNIMError);	\
    Printf(" 11 - Tuner Error       : %d\n", SelfDiagTbl.u2TunerError);     \
    Printf(" 12 - RTC Error		: %d\n", SelfDiagTbl.u2RtcError); 	\
    Printf(" 13 - TouchSnr Error		: %d\n", SelfDiagTbl.u2TouchSnrError); 	\
    Printf(" 14 - CarBattery Error		: %d\n", SelfDiagTbl.u2CarBatteryError); 	
#endif
...
#define SET_ERROR_BIT(SelfDiagTbl, ErrorType, SetBit)                       \
	...
	case D_PANEL_NVM_ERROR :												\
		SelfDiagTbl.u2PanelNIMError = SetBit;		break;					\
    case D_SUBWOOFER_ERROR :												\
		SelfDiagTbl.u2SubWooferError = SetBit;		break;					\
    case D_TOUCHSNR_ERR:                                                    \
        SelfDiagTbl.u2TouchSnrError = SetBit;    break;                     \
    case D_CAR_BATTERY:                                                     \
        SelfDiagTbl.u2CarBatteryError = SetBit;    break;                   \
	default :												\
		break;	 			\
    }
#else
#define SET_ERROR_BIT(SelfDiagTbl, ErrorType, SetBit)                       \
	...
	case D_PANEL_NVM_ERROR :												\
		SelfDiagTbl.u2PanelNIMError = SetBit;		break;					\
    case D_RTC_ERROR :												        \
		SelfDiagTbl.u2RtcError = SetBit;		break;					    \
    case D_TOUCHSNR_ERR:                                                    \
        SelfDiagTbl.u2TouchSnrError = SetBit;    break;                     \
    case D_CAR_BATTERY:                                                     \
        SelfDiagTbl.u2CarBatteryError = SetBit;    break;                   \
...
#define DUMP_ERROR_COUNTER(ShutdownCounter)                                 \
	...
	Printf("Panel I2C Shutdown Counter	  : %d\n", ShutdownCounter[10]);	\
    Printf("Tuner Shutdown Counter        : %d\n", ShutdownCounter[11]);    \
    Printf("SubWoofer Shutdown Counter    : %d\n", ShutdownCounter[12]);    \
    Printf("TOUCHSNR Shutdown Counter    : %d\n", ShutdownCounter[13]);    \
    Printf("Car Barttery Shutdown Counter    : %d\n", ShutdownCounter[14]);    \
    Printf("\n");
#else
#define DUMP_ERROR_COUNTER(ShutdownCounter)                                 \
    Printf("12V_AMP Shutdown Counter      : %d\n", ShutdownCounter[0]);     \
...
#define DUMP_COUNTER_CLEAN_CLI_USEAGE         Printf("Usage: %s <Counter type>\n", szArgv[0]);  \
	    ...
	    Printf("				10 - Panel I2C Shutdown Counter\n");							\
        Printf("                11 - Tuner Shutdown Counter\n");                                \
        Printf("                12 - SubWoofer Shutdown Counter\n");                                \
        Printf("\n");                                                                           \
        Printf("               13 - Shutdown Retry Counter\n");                                 \
        Printf("               14 - Boot Counter\n");                                           \
        Printf("               15 - All Counters\n");
#else
#define DUMP_COUNTER_CLEAN_CLI_USEAGE         Printf("Usage: %s <Counter type>\n", szArgv[0]);  \
        Printf("<Counter type>  0 - 12V_AMP Shutdown Counter\n");                               \
        Printf("                1 - 12V_SW Shutdown Counter\n");                                \
	    ...
	    Printf("				10 - Panel I2C Shutdown Counter\n");							\
        Printf("                11 - Tuner Shutdown Counter\n");                                \
        Printf("                12 - Tuner Shutdown Counter\n");                                \
        Printf("\n");                                                                           \
        Printf("               13 - Shutdown Retry Counter\n");                                 \
        Printf("               14 - Boot Counter\n");                                           \
        Printf("               15 - All Counters\n");
...
#define SET_ERROR_TYPE_NVM_ADDR(offset, ErrorType)                       \
            ...
            case D_PANEL_NVM_ERROR:                                     \
                ...
                break;                                                  \
            case D_SUBWOOFER_ERROR:                                     \
                offset += SELF_DIAG_SUBWOOFER_ERR_OFFSET;               \
                break;                                                  \
            default:                                                    \
                return 0;                                               \
            }
    ...
    #define SET_ERROR_TYPE_NVM_ADDR(offset, ErrorType)                       \
            ...
            case D_PANEL_NVM_ERROR:                                     \
                ...
                break;                                                  \
            case D_RTC_ERROR:                                           \
                offset += SELF_DIAG_RTC_ERR_OFFSET;                     \
                break;                                                  \
            default:                                                    \
                return 0;                                               \
            }
