...
#ifdef PCB_2K12
#define SELF_DIAG_12V_AMP_DROP_DET              GPIO(50)     // ADIN4
#define SELF_DIAG_12V_SW_DROP_DET               ADIN(3)     // ADIN3 
#define SELF_DIAG_V_DROP_DET                    GPIO(211)    // DEMOD_TSCLK
#define SELF_DIAG_PANEL_V_DROP_DET              GPIO(48)    // DEMOD_TSVAL
#define SELF_DIAG_TUNER_PWR_DROP_DET            OPCTRL(10)  // VGA_SCL
#define SELF_DIAG_TCON_ERR_DET                  GPIO(51)//
#define SELF_DIAG_AUD_AMP_ERROR_DET 			GPIO(112)    // RXVP
#define SELF_DIAG_USB_ERROR_DET 			    GPIO(118)    //SD_CMD  USB_ERR
#define SELF_DIAG_LAMP_DET                      GPIO(119)//ADIN(1)//ServoADC ch1

#else
#define SELF_DIAG_12V_AMP_DROP_DET              0xffffffff
#define SELF_DIAG_12V_SW_DROP_DET               GPIO(47)
#define SELF_DIAG_V_DROP_DET                    GPIO(46)
#define SELF_DIAG_PANEL_V_DROP_DET              0xffffffff
#if defined(FIJI_COL_BOARD) || defined(FIJI_SA_BOARD) || defined(FIJI_CHD_BOARD)
#define SELF_DIAG_TUNER_PWR_DROP_DET            GPIO(44)
#endif
#define SELF_DIAG_TCON_ERR_DET                  GPIO(51)
#define SELF_DIAG_AUD_AMP_ERROR_DET             GPIO(49)    
#define SELF_DIAG_USB_ERROR_DET                 0xffffffff
#define SELF_DIAG_LAMP_DET                      GPIO(122)
#endif
...
#define SELF_DIAG_TUNER_DET_TIME                600        // 600 ms
...
#define SELF_DIAG_TUNER_RESET_TIME              500
...
/*							    SELF_DIAG_FUNCTION_ENABLE(D_USB_ERROR)		  |   */\
                                                    0)
#elif defined(FIJI_COL_BOARD) || defined(FIJI_SA_BOARD) || defined(FIJI_CHD_BOARD)
#define DEFAULT_SELF_DIAG_ENABLED_ITEMS         (                                              \
/*                                                    SELF_DIAG_FUNCTION_ENABLE(D_12V_AMP_ERROR)      |   */\
                                                    SELF_DIAG_FUNCTION_ENABLE(D_12V_SW_ERROR)       |   \
/*                                                  SELF_DIAG_FUNCTION_ENABLE(D_24V_PWR_ERROR)      |*/ \
