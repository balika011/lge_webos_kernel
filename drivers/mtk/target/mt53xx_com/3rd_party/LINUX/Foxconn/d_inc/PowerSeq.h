...
#define POWER_SEQ_BASE_ADDR                 (0x2B00)
...
#ifdef PCB_2K12
#define SIGNAL_AC_DET                       OPCTRL(8)//GPIO(2)     // GPIO 2
#else
#define SIGNAL_AC_DET                       OPCTRL(1)
#endif
#define AC_DETECT_NORMAL                    1
#define AC_DETECT_ERROR                     0
#define SET_AC_DETECT_STANDBY()				vIO32Write4B(PDWNC_RESRV1, 0xacdeacde)
#define CLR_AC_DETECT_STANDBY()				vIO32Write4B(PDWNC_RESRV1, 0)
#define IS_AC_DETECT_STANDBY()				(u4IO32Read4B(PDWNC_RESRV1) == 0xacdeacde) ? 1 : 0


// Panel format select pin definition
//#define SIGNAL_LVDS_SEL                     GPIO(3)     // GPIO 3

//#define SIGNAL_X_U_RST                      GPIO(122)   // HDMI_SDA
