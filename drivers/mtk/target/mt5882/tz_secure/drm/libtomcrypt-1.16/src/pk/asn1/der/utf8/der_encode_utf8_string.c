...
/**
  ...
  @param in       The array of UTF8 to store (one per unsigned wchar)
  @param inlen    The number of bytes (4x the number of wchars)
                           ...
                           unsigned char *out, unsigned long *outlen)
{
   ...
   /* convert length to number of unsigned longs */
   inlen /= sizeof(unsigned long);
