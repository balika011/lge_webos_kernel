...
INT32 GCPU_EMU_VCPSHash()
{
    ...
    _GCPU_VCPS_CmdEx(0, GCPU_VCPS_HASH, &rParam, TRUE);
...
INT32 GCPU_EMU_VCPSDPAK()
{
    ...
    for (i = 0; i < u4PacketNum; i++)
    {
        ...
        _GCPU_VCPS_CmdEx(0, GCPU_VCPS_DPAK, &rParam, TRUE);
    }
...
INT32 GCPU_EMU_VCPSEPAK()
{
    ...
    for (i = 0; i < u4PacketNum; i++)
    {
        ...
        _GCPU_VCPS_CmdEx(0, GCPU_VCPS_EPAK, &rParam, TRUE);
    }
...
INT32 GCPU_EMU_VCPSDKBH()
{
    ...
    _GCPU_VCPS_CmdEx(0, GCPU_VCPS_DKBH, &rParam, TRUE);
...
INT32 GCPU_EMU_VCPSDHDK()
{
    ...
    _GCPU_VCPS_CmdEx(0, GCPU_VCPS_DHDK, &rParam, TRUE);
    ...
    _GCPU_AES_CmdEx(0, GCPU_AES_E, &rAesParam, TRUE);
...
INT32 GCPU_EMU_VCPSDCBC()
{
    ...
    _GCPU_VCPS_CmdEx(0, GCPU_VCPS_DCBC, &rParam, TRUE);
...
INT32 GCPU_EMU_VCPSECBC()
{
    ...
    _GCPU_VCPS_CmdEx(0, GCPU_VCPS_ECBC, &rParam, TRUE);
