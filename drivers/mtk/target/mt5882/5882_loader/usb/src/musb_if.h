...
typedef enum
{
    ...
    USB_STATUS_SERIAL_READY,                       // USB Serial device is connected
    USB_STATUS_SERIAL_ABSENT,                      // USB Serail device is removed
...
#if defined(CONFIG_ARCH_MT85XX)
/** Otg port */
#define USB_PORT_TYPE_OTG		(3)
/* For IC Verification only */
#define USB_DIAG_MAX_LUN_NUM    (12)
#endif

#if !defined(CONFIG_ARCH_MT85XX)
#define FIND_MUSB_NONE                                (0)
#define FIND_CLASS_MASS_STORAGE              (1)
#define FIND_CLASS_HUB                                 (2)

extern void MUSB_SetDeviceOnHubFlag(UINT32 u4flag);
extern UINT32 MUSB_GetDeviceOnHubFlag(VOID);

extern void MUSB_SetMassOnHubFlag(UINT32 u4Massflag);
extern UINT32 MUSB_GetMassOnHubFlag(VOID);
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
EXTERN INT32 MUSB_ReadEx(UINT32 u4Lun, UINT64 u8Offset, UINT32 u4MemPtr, UINT32 u4MemLen);
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
EXTERN INT32 MUSB_WriteEx(UINT32 u4Lun, UINT64 u4Offset, UINT32 u4MemPtr, UINT32 u4MemLen);
EXTERN CHAR *MUSB_GetModelEx(UINT32 u4Lun);
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
EXTERN INT32 MUSB_GetBlockSizeEx(UINT32 u4Lun);
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
EXTERN UINT32 MUSB_GetTotalLunEx(UINT32 u4Lun);
#endif
...
*/
//-------------------------------------------------------------------------
EXTERN INT32 MUSB_Pdwnc(uint32_t port, uint32_t powerState);
#endif
//-------------------------------------------------------------------------
...
#if defined(CONFIG_ARCH_MT85XX)
/** i4UsbHostInit
 *  Initial USB as host mode function.
 *  @param  void
 *  @retval  0 	SUCCESS.
 *  @retval  -1	FAIL. 
 */
//-------------------------------------------------------------------------
EXTERN INT32 i4UsbHostInit(void);
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
EXTERN void MUSB_InitTimeMonitorEx(UINT32 u4Lun);
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
EXTERN UINT64 MUSB_GetTimeMonitorEx(UINT32 u4Lun);
#endif
...
//-------------------------------------------------------------------------
/** MUSB_fgIsInit
 *  Get the initialization status of USB controller.
 *  @param  void.
 *  @retval TRUE 	USB controller has been initialed.
 *  @retval FALSE   USB controller has NOT been initialed. 
 */
//-------------------------------------------------------------------------
#if defined(CONFIG_ARCH_MT85XX)
extern BOOL MUSB_fgIsInit(void);
extern BOOL fgUsbVbusEnable(uint8_t bPortNum, BOOL fgEnable);
#endif
 ...
 */
//-------------------------------------------------------------------------
extern void MUSB_TurnOnVBus(void);
...
extern BOOL MUSB_Uart_Cli_Support(void);
extern UINT32 MUSB_Uart_Read(UINT8 *pBuffer, UINT32 u4NumToRead);
extern void MUSB_Uart_PutChar(UINT8 u1Char);
#endif
