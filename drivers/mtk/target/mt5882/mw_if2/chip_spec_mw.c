        ...
        case  CHIPSPEC_GET_TYPE_CHIP_BOND:
            {
                ...
                switch (((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->e_chip_bond)
                {
                    case CHIPSPEC_IS_CHIP_BOND_MHEG5:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_MHEG5);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_CIPLUS:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_CIPLUS);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_TCON:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_TCON);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_CHINATV:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_CHINATV);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_MHEGHD:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_MHEGHD);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_OPERA:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_OPERA);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_JVM:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_JVM);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_ARIB:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_ARIB);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_GINGA:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_GINGA);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_MHP:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_MHP);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_DMBT:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_DMBT);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_ATSC:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_ATSC);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_BRAZIL:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_BRAZIL);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_DVB:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond = 
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_DVB);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_HBBTV:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_HBBTV);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_ANDROID:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_ANDROID);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_CINEMA:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_CINEMA);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_QJY:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_QJY);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_IPTV:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_IPTV);
                        break;
                    case CHIPSPEC_IS_CHIP_BOND_PLAYRDY:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_PLAYRDY);
                        break;     
                    case CHIPSPEC_IS_CHIP_BOND_MSS:
                        ((CHIPSPEC_CHIP_BOND_INFO_T *)pv_get_info)->b_is_chip_bond =
                                            MTDRVCUST_IsSupport(MTCHIP_SPEC_MSS);
                        break;                                                
                    default:
                        return RMR_DRV_INV_GET_INFO;
                }
