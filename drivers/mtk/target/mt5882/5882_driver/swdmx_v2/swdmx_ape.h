 ...
 * $Author: p4admin $
 * $Date: 2015/02/15 $
 * $RCSfile: swdmx_ape.h,v $
 * $Revision: #1 $
 *---------------------------------------------------------------------------*/

/** @file swdmx_ape.h
 *  This header file declares exported APIs of APE.
 */
...
SWDMX_HDR_PRS_STATE_T _SWDMX_ApeHeaderParse(UINT8 u1SrcId, SWDMX_RANGE_LIST_T* prRangeList,SWDMX_CUR_CMD_T* prCmd);
