...
#define FRAME_TRACK_MODE_DDDS_BY_FNTSCALER   (1 << 1)
#define FRAME_TRACK_MODE_DDDS_BY_PSTSCALER   (1 << 2)
#define FRAME_TRACK_MODE_VTOTAL_BY_MJC    (1 << 3)
#define FRAME_TRACK_MODE_VTOTAL_BY_FNTSCALER (1 << 4)
#define FRAME_TRACK_MODE_VTOTAL_BY_PSTSCALER (1 << 5)
#define FRAME_TRACK_MODE_SW_DDDS          (1 << 6)
...
EXTERN void vDumpFrameTrackStatus(void);
