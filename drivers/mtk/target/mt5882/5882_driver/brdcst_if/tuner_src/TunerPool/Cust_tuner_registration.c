...
EXTERN ITUNER_FCT_T* GetCustTunerFuncTable(UINT16 id);

INT32 ITunerRegistration(UINT16 id)
{ 
  if (TRUE == IPhysicalTunerRegistration(GetCustTunerFuncTable(id)))
    {
        mcSHOW_USER_MSG(("Find corresponding tuner for registration.\n"));
