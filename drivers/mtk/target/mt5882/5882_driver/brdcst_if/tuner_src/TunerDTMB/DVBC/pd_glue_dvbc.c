...
#define DVBC_LOCK_TIME_OUT               1200
                    ...
                    void* pvArg)
{
    ...
    //Convert QAM mode
	//pt_tuner_info->e_mod = MOD_UNKNOWN;  //temp used it , refine in feature , Mingsheng 1201
	...
	{
	//    mcDELAY_MS(5000);
		mcSHOW_DBG_MSG(("Delay 0ms\n"));
	}

	
	// set agc parameters
	DVBC_SetIF(psDvbcDemodCtx); 	// set IF when FW switch	
    DigTunerBypassI2C(FALSE);
...
{   
    ...
    #if defined(CC_MT5135DVBC)||(defined (CC_MT5175) &&( defined(CC_MT5396)||defined(CC_MT5398)||defined(CC_MT5880)||defined(CC_MT5881)||defined(CC_MT5399)))//LL for 5175+5881
		DVBC_TunerI2c(psDvbcDemodCtx, bSwitchOn);
    #endif
