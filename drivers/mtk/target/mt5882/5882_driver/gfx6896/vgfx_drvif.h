...
extern void _VGFX_SetMatrixCoef_Emu(UINT32 u4MatrixA, UINT32 u4MatrixB,
...
extern void _VGFX_SetAlphaEdgeRGB0(UINT32 u4AlEdgeRGB0,
        UINT32 u4AlEdgeThresHold);
extern void _VGFX_SetFilterType(UINT32 u4FilterType);

extern void _VGFX_SetReflect(UINT32 u4RefEn, UINT32 u4RefOnly,
        UINT32 u4TextTureHeight, UINT32 u4RefRatioInit, UINT32 u4RatioLineStep,
        UINT32 u4RefAAEn);

extern void _VGFX_SetTextureArgbOrder(UINT32 u4Aorder, UINT32 u4Rorder,
        UINT32 u4Gorder, UINT32 u4Border);
