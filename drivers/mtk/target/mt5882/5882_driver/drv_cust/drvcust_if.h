...
#define FBM_FEEDER_TVP_SIZE FBM_FEEDER1_SIZE
#else
#define FBM_FEEDER_TVP_SIZE 0
#endif
#define FBM_SIZE_FORMULAR(x)    (x  + FBM_SECURE_FEEDER_2K_SIZE + FBM_FEEDER_TVP_SIZE + FBM_DMX1_SIZE + FBM_SCPOS_MAIN_SIZE + FBM_MPEG_Y_SIZE  + FBM_PQ_TOOL_POOL_SIZE + FBM_HW_DEMOD_SIZE + FBM_OD_SIZE + FBM_JPEVDP_POOL_SIZE + FBM_DMX_PID_BUF_SIZE + FBM_VENC_SIZE  + FBM_TWO_FBP_SIZE + FBM_FD_SIZE + FBM_PVR_SIZE + FBM_SWDMX_SIZE + FBM_VSS_SIZE + FBM_DRM_BUF_SIZE + FBM_MUXER_SIZE + FBM_IMGRZ_3D_KR_BUF + FBM_SLT_EXTRA_SIZE + FBM_PNG_POOL_SIZE + FBM_TDCAV_POOL_SIZE   + FBM_DMX_ADD_SIZE + FBM_EXTRA_FOR_4K2K_FEEDER_DMX + FBM_DSP_BIN_POOL_SIZE + FBM_TVE_POOL_FBM_SIZE  +  FBM_JPEG_SIZE + FBM_DSP_POOL_SIZE - FBM_REDUCE_FBM_DMX_SIZE)
...
#if defined(CC_FBM_TWO_FBP)
#define FBM_TWO_FBP_SIZE        (0x500000 + FBM_MPEG_2_SIZE + FBM_EXTRA_FOR_4K2K_VIDEO)
#else
#define FBM_TWO_FBP_SIZE        (0)
#endif

#if defined(CC_FBM_3D_OSD)||defined(CC_MHP_SUPPORT)
#define FBM_JPEVDP_POOL_SIZE (0x800000)
