...
/* FUNCTION                                                              */
/*                                                                       */
/*      NU_Create_Binary_Semaphore                                       */
/*                                                                       */
/* DESCRIPTION                                                           */
/*                                                                       */
/*      This function creates a binary semaphore and then places it on   */
/*      the list of created semaphores.                                  */
/*                                                                       */
/* CALLED BY                                                             */
/*                                                                       */
/*      Application                                                      */
...
/*        DATE                    REMARKS                                */
/*                                                                       */
/*      03-25-2005      Created initial version 1.0                      */
/*                                                                       */
/*************************************************************************/
STATUS  NU_Create_Binary_Semaphore(NU_SEMAPHORE *semaphore_ptr, CHAR *name,
                           UNSIGNED initial_count, OPTION suspend_type)
{
...
/*                                                                       */
/*************************************************************************/
STATUS  NU_Release_Binary_Semaphore(NU_SEMAPHORE *semaphore_ptr)
{
...
NU_SUPERV_USER_VARIABLES
    ...
    else
    {
        ...
        /* Increment the semaphore instance counter.  */
        semaphore -> sm_semaphore_count = 1;
