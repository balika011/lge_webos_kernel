...
BOOL _PLAYMGR_Mp4Start(VOID* pvMediaInfo)
{
        ...
        (prMp4Info->u2AudIdx < 3))
    {
        ...
        prSrcInfo->t_es_map[prMp4Info->u2AudIdx].b_is_cur_strm_codec_spt = 
...
BOOL _PLAYMGR_OpenMp4MediaInfo(PLAYMGR_STATUS_T* prMediaStatus, VOID* pvMediaInfo)
{
    ...
    x_memcpy(&prSrcInfo->t_mp4_extra_info,&prMp4Info->rPlayerIdxInfo.t_mp4_extra_info,sizeof(MP4_MINFO_EXTRA_INFO_T));
