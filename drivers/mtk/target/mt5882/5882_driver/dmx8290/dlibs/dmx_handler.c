...
//H265 Picture start codes
#define H265_PIC_START_CODE_1               0x00
#define H265_PIC_START_CODE_2               0x00
#define H265_PIC_START_CODE_3               0x01

#define H265_PIC_START_CODE_SLICE_TRAIL_N    0x00
#define H265_PIC_START_CODE_SLICE_TRAIL_R    0x01
#define H265_PIC_START_CODE_SLICE_TSA_N   	 0x02
#define H265_PIC_START_CODE_SLICE_TSA_R   	 0x03
#define H265_PIC_START_CODE_SLICE_STSA_N   	 0x04
#define H265_PIC_START_CODE_SLICE_STSA_R   	 0x05
#define H265_PIC_START_CODE_SLICE_RADL_N   	 0x06
#define H265_PIC_START_CODE_SLICE_RADL_R   	 0x07
#define H265_PIC_START_CODE_SLICE_RASL_N   	 0x08
#define H265_PIC_START_CODE_SLICE_RASL_R   	 0x09
#define H265_PIC_START_CODE_SLICE_BLA_W_LP   0x10
#define H265_PIC_START_CODE_SLICE_BLA_W_RADL 0x11
#define H265_PIC_START_CODE_SLICE_BLA_N_LP   0x12
#define H265_PIC_START_CODE_SLICE_IDR_W_RADL 0x13
#define H265_PIC_START_CODE_SLICE_IDR_N_LP   0x14
#define H265_PIC_START_CODE_SLICE_TRAIL_CRA  0x15

#define H265_PIC_START_CODE_VPS             0x40
#define H265_PIC_START_CODE_SPS             0x42
#define H265_PIC_START_CODE_PPS             0x44
#define H265_PIC_START_CODE_EOB             0x4A
#define H265_PIC_START_CODE_AUD             0x46
#define H265_PIC_START_CODE_EOS             0x48
#define H265_PIC_START_CODE_FD              0x4C
#define H265_PIC_START_CODE_PRESEI          0x4E
#define H265_PIC_START_CODE_SUFSEI          0x50
...
static BOOL _DmxDispatchPesMessage(const DMX_PES_MSG_T* prPes)
{
    ...
    {
        //Printf("%s, phy=0x%x, vir=0x%x, size=0x%x\n", __FUNCTION__, 
            //prPes->u4BufStart, VIRTUAL(prPes->u4BufStart), prPes->u4BufEnd - prPes->u4BufStart);
    ...
    UINT32 u4BufEnd, UINT8 *pu1PicInfo)
{
    ...
    {
        LOG(3, "Invalid picture address 0x%08x\n", u4Addr);
 ...
 */
//-----------------------------------------------------------------------------
static UINT32 _DmxDetectH265PictureType(UINT32 u4Addr, UINT32 u4BufStart,
    UINT32 u4BufEnd, UINT8 *pu1PicInfo)
{
    UINT32 u4PicType;
    UINT8* p = NULL;
    ...
    if ((p[0] != H265_PIC_START_CODE_1) || (p[1] != H265_PIC_START_CODE_2) ||
        (p[2] != H265_PIC_START_CODE_3))
    {
        u4PicType = PIC_TYPE_UNKNOWN;
        //goto _exit;
    }
    ...
    //LOG(2, "start code: 0x%02x %02x %02x %02x %02x %02x\n", p[0], p[1], p[2],p[3],p[4],p[5]);
    switch (u1Type & 0xFF)
    {   
        case H265_PIC_START_CODE_VPS:
            u4PicType = H265_PIC_TYPE_VPS;
            break;
        case H265_PIC_START_CODE_SPS:
            u4PicType = H265_PIC_TYPE_SPS;
            break;
        case H265_PIC_START_CODE_PPS:
            u4PicType = H265_PIC_TYPE_PPS;
            break;
        case H265_PIC_START_CODE_EOB: 
            u4PicType = H265_PIC_TYPE_EOB;
            break;
        case H265_PIC_START_CODE_AUD: 
            u4PicType = H265_PIC_TYPE_AUD;
            break;
        case H265_PIC_START_CODE_EOS:
            u4PicType = H265_PIC_TYPE_EOS;
            break;
        case H265_PIC_START_CODE_FD:
            u4PicType = H265_PIC_TYPE_FD;
            break;
        case H265_PIC_START_CODE_PRESEI: 
            u4PicType = H265_PIC_TYPE_PRESEI;
            break;
        case H265_PIC_START_CODE_SUFSEI:
            u4PicType = H265_PIC_TYPE_SUFSEI;
            break;

        default:

        {
            switch((u1Type & 0x7E) >> 1)
            {
                case H265_PIC_START_CODE_SLICE_TRAIL_N:
                     u4PicType = H265_SLICE_TRAIL_N;
                     break;
                case H265_PIC_START_CODE_SLICE_TRAIL_R:
                     u4PicType = H265_SLICE_TRAIL_R;
                     break;
                case H265_PIC_START_CODE_SLICE_TSA_N:
                     u4PicType = H265_SLICE_TSA_N;
                     break;
                case H265_PIC_START_CODE_SLICE_TSA_R:
                    u4PicType = H265_SLICE_TSA_R;
                     break;
                case H265_PIC_START_CODE_SLICE_STSA_N:
                    u4PicType = H265_SLICE_STSA_N;
                     break;
                case H265_PIC_START_CODE_SLICE_STSA_R:
                    u4PicType = H265_SLICE_STSA_R;
                     break;
                case H265_PIC_START_CODE_SLICE_RADL_N:
                    u4PicType = H265_SLICE_RADL_N;
                     break;
                case H265_PIC_START_CODE_SLICE_RADL_R:
                    u4PicType = H265_SLICE_RADL_R;
                     break;
                case H265_PIC_START_CODE_SLICE_RASL_N:
                    u4PicType = H265_SLICE_RASL_N;
                     break;
                case H265_PIC_START_CODE_SLICE_RASL_R:
                    u4PicType = H265_SLICE_RASL_R;
                     break;
                case H265_PIC_START_CODE_SLICE_BLA_W_LP:  
                    u4PicType = H265_SLICE_BLA_W_LP;
                     break;
                case H265_PIC_START_CODE_SLICE_BLA_W_RADL: 
                    u4PicType = H265_SLICE_BLA_W_RADL;
                     break;
                case H265_PIC_START_CODE_SLICE_BLA_N_LP:   
                    u4PicType = H265_SLICE_BLA_N_LP;
                     break;
                case H265_PIC_START_CODE_SLICE_IDR_W_RADL: 
                    u4PicType = H265_SLICE_IDR_W_RADL;
                     break;
                case H265_PIC_START_CODE_SLICE_IDR_N_LP: 
                    u4PicType = H265_SLICE_IDR_N_LP;
                     break;
                case H265_PIC_START_CODE_SLICE_TRAIL_CRA:  
                    u4PicType = H265_SLICE_TRAIL_CRA;
                     break;

                default:
                    LOG(3, "unknown u1Type\n");
                    break;
            }
 ...
 */
//-----------------------------------------------------------------------------
static BOOL _DmxGetPicHeader(UINT32 u4Addr, UINT32 u4BufStart, UINT32 u4BufEnd,UINT8 *pu1Buf,
UINT32 u4Size, DMX_VIDEO_TYPE_T eVideoType)
{
...
static UINT32 _DmxDetectPictureType(DMX_VIDEO_TYPE_T eVideoType, UINT32 u4Addr, UINT32 u4BufStart, UINT32 u4BufEnd, UINT8 *pu1PicInfo)
{
    ...
    case DMX_VIDEO_H265:
        u4Type = _DmxDetectH265PictureType(u4Addr, u4BufStart, u4BufEnd, pu1PicInfo);   
        break;
...
//-----------------------------------------------------------------------------
static BOOL _DMX_SendH265PictureHeader(DMX_PES_MSG_T* prPes)
{
    UINT8 u1Pidx;
    BOOL fgRet = FALSE;
    static UINT32 u4PreWp = 0;
    ...
    prPes->eVideoType = DMX_VIDEO_H265;

    //Clear the PTS/DTS values when a new pes pkt come
    if(prPes->u4Wp != u4PreWp)
    {
        _afgSeqHeaderPtsDts[u1Pidx] = FALSE;
        _au4SeqHeaderPts[u1Pidx] = 0;
        _au4SeqHeaderDts[u1Pidx]= 0;
    ...
    // Clear the PTS/DTS values when a slice picture is found.
    if ((prPes->u4FrameType == H265_SLICE_TRAIL_N) ||
      (prPes->u4FrameType == H265_SLICE_TRAIL_R) ||
      (prPes->u4FrameType == H265_SLICE_TSA_N) ||
      (prPes->u4FrameType == H265_SLICE_TSA_R) ||
      (prPes->u4FrameType == H265_SLICE_STSA_N) ||
      (prPes->u4FrameType == H265_SLICE_STSA_R) ||
      (prPes->u4FrameType == H265_SLICE_RADL_N) ||
      (prPes->u4FrameType == H265_SLICE_RADL_R) ||
      (prPes->u4FrameType == H265_SLICE_RASL_N) ||
      (prPes->u4FrameType == H265_SLICE_RASL_R) ||
      (prPes->u4FrameType == H265_SLICE_BLA_W_LP) ||
      (prPes->u4FrameType == H265_SLICE_BLA_W_RADL) ||
      (prPes->u4FrameType == H265_SLICE_BLA_N_LP) ||
      (prPes->u4FrameType == H265_SLICE_IDR_W_RADL) ||
      (prPes->u4FrameType == H265_SLICE_IDR_N_LP) ||
      (prPes->u4FrameType == H265_SLICE_TRAIL_CRA) )
    {
        _afgSeqHeaderPtsDts[u1Pidx] = FALSE;
        _au4SeqHeaderPts[u1Pidx] = 0;
        _au4SeqHeaderDts[u1Pidx]= 0;
    ...
    switch (prPes->u4FrameType)
    {
        case H265_SLICE_TRAIL_N:
        case H265_SLICE_TRAIL_R:
        case H265_SLICE_TSA_N:
        case H265_SLICE_TSA_R:
        case H265_SLICE_STSA_N:
        case H265_SLICE_STSA_R:
        case H265_SLICE_RADL_N:
        case H265_SLICE_RADL_R:
        case H265_SLICE_RASL_N:
        case H265_SLICE_RASL_R:
        ...
        case H265_PIC_TYPE_VPS:
        case H265_PIC_TYPE_SPS:
        case H265_PIC_TYPE_PPS:
        case H265_PIC_TYPE_EOB:
        case H265_PIC_TYPE_AUD:
        case H265_PIC_TYPE_EOS:
        case H265_PIC_TYPE_FD:
        case H265_PIC_TYPE_PRESEI:
        case H265_PIC_TYPE_SUFSEI:  
            fgRet = TRUE;
            break;
        default:
        // Todo: count invalid picture headers
...
static BOOL _DmxProcessPictureHeader(DMX_PES_MSG_T* prPes)
{
	...
	case DMX_VIDEO_H265:
		fgRet = _DMX_SendH265PictureHeader(prPes);
        break;
    ...
    while (1)
    {
        ...
        case DMX_PES_MSG_TYPE_PES:
            if (!rPes.fgEOS && !rPes.fgMoveComplete && (prPidStruct->ePidType == DMX_PID_TYPE_ES_VIDEO))
            {
                ...
                {
                    LOG(6, "Ignore pesMsg, videoType=%d, u4FrameType=%d, 0x%x 0x%x 0x%x 0x%x\n", rPes.eVideoType, rPes.u4FrameType, 
                            rPes.au1PicInfo[0], rPes.au1PicInfo[1], rPes.au1PicInfo[2], rPes.au1PicInfo[3]);
                }
