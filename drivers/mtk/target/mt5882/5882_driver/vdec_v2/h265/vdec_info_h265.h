...
//#define VDEC_H265_Performance

#define MAX_ES_NUM VDEC_MAX_ES
#define H265_MAX_SPS_NUM 16
#define H265_MAX_PPS_NUM 64
#define H265_MAX_FB_NUM 17
#define H265_MAX_RPS_NUM 64
...
#define SCALING_LIST_UNIT_SIZE  4096

#define HEVC_8BIT_MODE    0
...
typedef struct _H265_RPS_Data_
{
  ...
  UINT32     u4DeltaRPS; 
  UINT32     u4NumRefIdc; 
  UINT32     u4RefIdc[MAX_NUM_REF_PICS + 1];
...
typedef struct _H265_SPS_Data_ 
{
        ...
        //[notice] spec conflict u4MaxDecPicBufferingMinux1? u4MaxLatencyIncreasePlus1?
         ...
         H265_RPS_Data  *pShortTermRefPicSets[64];            //RPS pointer array
...
typedef struct _H265_Slice_Hdr_Data_
{
    ...
    H265_RPS_Data  *pShortTermRefPicSets;            
...
typedef struct _VDEC_INFO_H265_LAST_INFO_T_
{
    ...
    INT32   i4LastSarWidth;
    INT32   i4LastSarHeight;
    UINT32  u4AspRatInf;
    UINT32  u4DAR;
    UINT32  u4LastBandwidthRatio;
    UINT32  u4LastMCBandwidth;
...
typedef struct _VDEC_INFO_LAE_H265_T_
{
    UINT32 u4LaeCabacAddr;
    UINT32 u4LaeEcAddr;
}VDEC_INFO_LAE_H265_T;

typedef struct _VDEC_INFO_STILL_IMAGE_T_
{
    UINT32 u4StillImgSaoAddr;
    UINT32 u4StillImgDbkAddr;
    UINT32 u4StillImgPredAddr;
    UINT32 u4StillImgIPAddr;
    UINT32 u4StillImgVBAddr;
    
}VDEC_INFO_STILL_IMAGE_T;
...
{    
    ...
    UINT32   u4PicW;
    UINT32   u4PicH;
    INT32    i4ReadyOutCntDPB;
    UINT32   u4DecodeOkCnt;
    UINT32   u4DecodeErrCnt;
    UINT32   u4DumpFrameCnt;
    UCHAR    ucDecFBufId;
    BOOL     fgH265NotSupport;
    BOOL     fgWaitFirstIFrm;
    UCHAR    ucSemlessSPSIdx;
    //Current Pic FBM info
    UCHAR    ucFbgId;
    UCHAR    ucFbId;
    UCHAR    ucPreFbId;
    UINT32   u4WaitFbTime;
    ...
    VDEC_INFO_STILL_IMAGE_T rStillImgInfo;
    VDEC_LAE_DecPrm    rLaeInfo;
    VDEC_INFO_H265_PIC_INFO_T *prPicInfo;
    VDEC_INFO_H265_FBUF_INFO_T *prFBufInfo;

    HAL_TIME_T rTimeS;
    HAL_TIME_T rTimeRcvES;
    ...
    UINT32 u4PicCnt;
    UINT32 u4PicSize;
    UINT32 u4Bitrate;//kbps
    //QP
    UINT32 u4SliceQP;
    UINT32 u4QPInterval;
    UINT32 u4ISliceInterval;
}VDEC_INFO_H265_DEC_PRM_T;

typedef struct _H265_DRV_INFO_T_
{
    ...
    VDEC_INFO_H265_PIC_INFO_T rH265PicInfo;
    ...
    VDEC_INFO_H265_DEC_PRM_T rH265DecParam;
}H265_DRV_INFO_T;
