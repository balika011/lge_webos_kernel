...
// **********************************************************************
// VDEC SubModule Base Address
// **********************************************************************
#if defined (CC_MT5890)
#define VLD_REG_OFST     (IO_VIRT + 0x80000 )
#define MC_REG_OFST      (IO_VIRT + 0x81000 )
#define WMV_MV_REG_OFST        (IO_VIRT + 0x83000)
#define CRC_REG_OFST           (IO_VIRT + 0x85000)
#define WMV_DCAC_REG_OFST      (IO_VIRT + 0x84700)
// 5368/5396 add start
#define VLD_TOP_OFST              (IO_VIRT + 0x80800)
#else
...
#define WO_PDN_CON_SPEC2       (CRC_REG_OFST + 0x178)

#if defined(VDEC_IS_POST_MT5398)
#if defined(VDEC_IS_POST_MT5882)
#define PDN_CON_MODULE_W78       0x7E6A1108
#define PDN_CON_MODULE_W9A       0x7E6A1108
#define PDN_CON_SPEC_WMV         0x1FB
#define PDN_CON_SPEC_94          0x7B

//below is for oryxEs3
#define PDN_CON_MODULE_W78_E3       0x7E6A1108
#define PDN_CON_MODULE_W9A_E3       0x7E6A1108
#define PDN_CON_SPEC_WMV_E3         0xFFFB
#define PDN_CON_SPEC_94_E3          0xFFFFFFFB
#else
#define PDN_CON_MODULE_W78       0x3E6A1108
#define PDN_CON_MODULE_W9A       0x3E6A1108
