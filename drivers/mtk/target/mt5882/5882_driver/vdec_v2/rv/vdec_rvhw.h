...
#define RV_VLD_REG_OFST      (IO_VIRT + 0x82c00)
#define RV_PP_REG_OFST       (IO_VIRT + 0x84000)
#define AVC_MV_REG_OFST      (IO_VIRT + 0x83000)
#define VLD_TOP_BASE         (IO_VIRT + 0x80800)
#define VLD_BASE             (IO_VIRT + 0x80000)
#define VLD_REG_OFST          VLD_BASE
#define MC_BASE              (IO_VIRT + 0x81000)
#define MC_REG_OFST           MC_BASE
...
//VOID _VDEC_UpdateVldRVWPtr(UINT32 u4WPtr); //no used in current flow
