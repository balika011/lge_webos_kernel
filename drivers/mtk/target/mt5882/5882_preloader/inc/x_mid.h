...
#define MID_BASE				0x200
#define REGION					0x10

#define UPADDR					0x0
#define LOWADDR					0x4
#define AGENT					0x8
#define EN_MODE_RWPRT					0xC

#define MID_ENABLE				(((UINT32)1) << 31)
#define MID_MODE				(((UINT32)1) << 30)
#define MID_WRITEABLE			(((UINT32)1) << 29)
#define MID_READPROTECT			(((UINT32)1) << 28)
...
#define MID_FLAG_PROTRD     (1U << 3)
#define MID_FLAG_PROTWR     (1U << 4)
 
typedef void (*PFN_MID_CALLBACK)(UINT32 u4Region, MID_AGENT_ID_T eAgentId,
    UINT32 u4Addr);
struct AGENT_PRIORITY
{
    UINT32 u4prityL;                //priority agent0~7  group 1
	UINT32 u4prityH;                //priority agent8~15  group 1
	UINT32 u4prityjumpL;			//priority jump mode agent0~7  group 1
	UINT32 u4prityjumpH;			//priority jump mode agent8~15  group 1
};
...
EXTERN UINT32 MID_QueryIntrusionStatus(void);
...
EXTERN UINT32 MID_WarmBootRegionProtect(UINT32 onoff);

EXTERN UINT32 MID_ReturnIntrusionStatus(void);

EXTERN void DMARB_Dynamic_Priority_Enable(BOOL u4Enable);
EXTERN void DMARB_Dynamic_Priority_Init(void);
EXTERN UINT32 DMARB_Dynamic_Priority_Set(struct AGENT_PRIORITY u4priority);
EXTERN UINT32 DMARB_Dynamic_Priority_Reset(void);
/*
