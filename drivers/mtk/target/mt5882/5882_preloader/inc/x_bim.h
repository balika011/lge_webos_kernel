...
#define GICD_READ8(offset)           IO_READ8(GIC_DIST_BASE, offset)
#define GICD_READ16(offset)          IO_READ16(GIC_DIST_BASE, offset)
#define GICD_READ32(offset)          IO_READ32(GIC_DIST_BASE, offset)

#define GICD_WRITE8(offset, value)   IO_WRITE8(GIC_DIST_BASE, offset, (value))
#define GICD_WRITE16(offset, value)  IO_WRITE16(GIC_DIST_BASE, offset, (value))
#define GICD_WRITE32(offset, value)  IO_WRITE32(GIC_DIST_BASE, offset, (value))

#define GICC_READ8(offset)           IO_READ8(GIC_CPU_BASE, offset)
#define GICC_READ16(offset)          IO_READ16(GIC_CPU_BASE, offset)
#define GICC_READ32(offset)          IO_READ32(GIC_CPU_BASE, offset)

#define GICC_WRITE8(offset, value)   IO_WRITE8(GIC_CPU_BASE, offset, (value))
#define GICC_WRITE16(offset, value)  IO_WRITE16(GIC_CPU_BASE, offset, (value))
#define GICC_WRITE32(offset, value)  IO_WRITE32(GIC_CPU_BASE, offset, (value))
...
// Interrupt vectors
    ...
    #define VECTOR_TCON     23          //TCON interrupt
	...
	#define VECTOR_POD          (VECTOR_MISC_BASE+2)
	...
	#define VECTOR_SCALER       (VECTOR_MISC_BASE+7)          //7. Scaler interrupt
    ...
    #define VECTOR_GCPU			(VECTOR_MISC_BASE+12)		   // 12. GCPU interrupt
    #define VECTOR_TCON_EH      (VECTOR_MISC_BASE+13)           // 13. TCON error
    #define VECTOR_TCON_TCH     (VECTOR_MISC_BASE+14)          // 14. TCON Timing control
    ...
    #define VECTOR_GFX3D_PP     (VECTOR_MISC_BASE+22)          // useless
    #define VECTOR_GFX3D_PMU    (VECTOR_MISC_BASE+23)          // useless
    #define VECTOR_GFX3D_GPMMU  (VECTOR_MISC_BASE+24)          // useless
    #define VECTOR_GFX3D_PPMMU  (VECTOR_MISC_BASE+25)          // useless
	...
	#define VECTOR_MMU_VDEC     (VECTOR_MISC2_BASE+12)
	#define VECTOR_MMU_DDI      (VECTOR_MISC2_BASE+13)
	#define VECTOR_MMU_DMX      (VECTOR_MISC2_BASE+14)
	#define VECTOR_USB3_1       (VECTOR_MISC2_BASE+15)
	#define VECTOR_RS232_1      (VECTOR_MISC2_BASE+16)
    ...
    #define VECTOR_ABIM_0        (26+VECTOR_MISC2_BASE)
    #define VECTOR_ABIM_1        (27+VECTOR_MISC2_BASE)
    #define VECTOR_ABIM_2        (28+VECTOR_MISC2_BASE)
    #define VECTOR_ABIM_3        (29+VECTOR_MISC2_BASE)
    ...
    #define MAX_IRQ_VECTOR		VECTOR_G1D_IRQ_GPMMU_3
// Interrupt bits
...
#define REG_LZHS_RAMCK      0x01d0
    #define LZHS_BUSCK_SEL  (1U << 6)   // LZHS SRAM clock selection indicator
...
#define REG_PL310_SRAM_CTL  0x04C8
...
#define TRNG_TIME            0x04
#define TRNG_DATA            0x08
#define TRNG_CONF            0x0c
#define TRNG_INT_SET         0x10
#define TRNG_INT_CLR         0x14
...
EXTERN UINT32 BIM_GetCurTime(void);
#endif
