...
extern char		init_thread_name[16];
...
INT32 Tuner_Init(void)
{
    ...
    for (i=0;i<tTunerCfgTbl.TunerNum;i++){
		...
		if (ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_ANA){
            ...
            if (InitializeStateInfo(ptTunerCtx, ptStateInfo_SAT_ANA, DRVT_TUNER_SAT_ANA)
                != DRVAPI_TUNER_OK){
                goto TUNER_INIT_ERROR_HANDLER;
            }
		...
		if ((ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_ANA)
            ...
            res = x_rm_reg_comp_excl_list (&ptStateInfo_SAT_ANA->t_tuner_comp_reg,
                                &ptStateInfo_CAB_ANA->t_tuner_comp_reg,
                                1);
            if (res != RMR_OK)
            {
		...
		if ((ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_ANA)
            ...
            res = x_rm_reg_comp_excl_list (&ptStateInfo_SAT_ANA->t_tuner_comp_reg,
                                &ptStateInfo_TER_ANA->t_tuner_comp_reg,
                                1);
            if (res != RMR_OK)
            {
                mcSHOW_DRVERR_MSG(("x_rm_reg_comp_excl_list failure!\n"));
		 ...
		 if (ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_ANA_SCART_OUT){
            ...
            // Initialize StateInfo
            if (InitializeStateInfo(ptTunerCtx, ptStateInfo_SAT_ANA_SCART_OUT, DRVT_TUNER_SAT_ANA_SCART_OUT)
                != DRVAPI_TUNER_OK){
                goto TUNER_INIT_ERROR_HANDLER;
            }
		...
		if ((ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_ANA_SCART_OUT)
            ...
            res = x_rm_reg_comp_excl_list (&ptStateInfo_SAT_ANA_SCART_OUT->t_tuner_comp_reg,
                                &ptStateInfo_CAB_ANA_SCART_OUT->t_tuner_comp_reg,
                                1);
            if (res != RMR_OK)
            {
		...
		if ((ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_ANA_SCART_OUT)
            ...
            res = x_rm_reg_comp_excl_list (&ptStateInfo_SAT_ANA_SCART_OUT->t_tuner_comp_reg,
                                &ptStateInfo_TER_ANA_SCART_OUT->t_tuner_comp_reg,
                                1);
            if (res != RMR_OK)
            {
                mcSHOW_DRVERR_MSG(("x_rm_reg_comp_excl_list 2 failure!\n"));
		...
		if (ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_DIG){
            ...
            // Initialize StateInfo
            if (InitializeStateInfo(ptTunerCtx, ptStateInfo_SAT, DRVT_TUNER_SAT_DIG)
                != DRVAPI_TUNER_OK){
                goto TUNER_INIT_ERROR_HANDLER;
            }
		...
		if ((ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_DIG)
            ...
            res = x_rm_reg_comp_excl_list (&ptStateInfo_SAT->t_tuner_comp_reg,
                                &ptStateInfo_CAB->t_tuner_comp_reg,
                                1);
            if (res != RMR_OK)
            {
		...
		if ((ptTunerCtx->tTunerCfg.i2TunerCapability & cWITH_DRVT_TUNER_SAT_DIG)
            ...
            res = x_rm_reg_comp_excl_list (&ptStateInfo_SAT->t_tuner_comp_reg,
                                &ptStateInfo_TER->t_tuner_comp_reg,
                                1);
            if (res != RMR_OK)
            {
                mcSHOW_DRVERR_MSG(("x_rm_reg_comp_excl_list failure!\n"));
