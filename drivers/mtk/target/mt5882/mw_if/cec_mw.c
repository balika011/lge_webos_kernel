...
void _CECMWNfyTxResult(UINT8 result,UINT8 opcode, void *txtag)
{
    CEC_NFY_T cec_nfy;
...
void _CECMWNfy5VStatus(UINT8 bSwitch, BOOL fgIs5VOn,void *arg)
{
#if 1
...
INT32 MW_CEC_Init(void)
{
    ...
    CEC_SetRxCallback(_CECMWNfyDataArrival,(void*)0);
    CEC_SetTxCallback(_CECMWNfyTxResult,(void*)0);

#ifdef CECNFY5VSTATUS

    CEC_Set5VCallback(_CECMWNfy5VStatus,(void*)0);
#endif
