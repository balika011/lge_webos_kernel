...
INLINE_CHIP_FUNC(GET_EFUSE_CHIPID_EX, 0)
#else /* CC_ALL_BOND_ENABLE */
INLINE_CHIP_FUNC(GET_EFUSE_CHIPID, (BIM_READ32(REG_EFUSE_BONDING) & BONDING_MASK))
INLINE_CHIP_FUNC(GET_EFUSE_CHIPID_EX, (BIM_READ32(REG_EFUSE_BONDING_EX) & BONDING_MASK_EX))
#endif /* CC_ALL_BOND_ENABLE */
//INLINE_CHIP_FUNC(_IS_RDES_EX, (GET_EFUSE_CHIPID_EX() == 0))
INLINE_CHIP_FUNC(_IS_RDES, (GET_EFUSE_CHIPID() == 0) && (GET_EFUSE_CHIPID_EX() == 0))
INLINE_CHIP_FUNC(IS_Support4KDisplay, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_4KDISPLAY_BIT) == BOND_4KDISPLAY_BIT))
...
INLINE_CHIP_FUNC(IS_SupportVP9, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_VP9_BIT) == BOND_VP9_BIT))
...
INLINE_CHIP_FUNC(IS_SupportAudioARM11, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_AUD_ARM11_BIT) == BOND_AUD_ARM11_BIT))
...
INLINE_CHIP_FUNC(IS_SupportHighSpeedSPINor, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_SPI_HL_BIT) == BOND_SPI_HL_BIT))
INLINE_CHIP_FUNC(IS_SupportTripleGPU, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_GPU_NO_BIT) == BOND_GPU_NO_BIT))
INLINE_CHIP_FUNC(IS_Support4K60Decode, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_4K60_BIT) == BOND_4K60_BIT))
INLINE_CHIP_FUNC(IS_Support4KDecode, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_4KDEC_BIT) == BOND_4KDEC_BIT))
INLINE_CHIP_FUNC(IS_SupportHEVC, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_HEVC_BIT) == BOND_HEVC_BIT))
INLINE_CHIP_FUNC(IS_SupportHDMI20, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_HDMI20_BIT) == BOND_HDMI20_BIT))
INLINE_CHIP_FUNC(IS_Support4KDD, _IS_RDES() || ((GET_EFUSE_CHIPID_EX() & BOND_4KDD_BIT) == BOND_4KDD_BIT))
...
INLINE_CHIP_FUNC(IS_SupportIPTV, 1)
INLINE_CHIP_FUNC(IS_SupportCPU1G, 1)
INLINE_CHIP_FUNC(IS_SupportJVM, 1)
