...
/* Debug, the BSP exported function to show error message */

void (*g_pfnBspPrintf)(const char* msg) = NU_NULL;
...
/*                                                                       */
/*************************************************************************/
VOID  INC_Initialize(VOID  *first_available_memory, void(*pfnBspPrintf)(const char*))
{
    g_pfnBspPrintf = pfnBspPrintf;
