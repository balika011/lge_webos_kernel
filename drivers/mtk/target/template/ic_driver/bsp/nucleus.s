...
INT_IRQ_Vectors
    ...
    DCD     INT_Interrupt_Shell         ; Vector 6:  External Ethernet DMA
    DCD     INT_Interrupt_Shell         ; Vector 7:  LZHS
    ...
    DCD     INT_Interrupt_Shell         ; Vector 11: Smart Card
    ...
    DCD     INT_Interrupt_Shell         ; Vector 18: PVR
    DCD     INT_Interrupt_Shell         ; Vector 19: POD
    ...
    DCD     INT_Interrupt_Shell         ; Vector 23: MJC
    ...
    DCD     INT_Interrupt_Shell         ; Vector 28: USB1
    DCD     INT_Interrupt_Shell         ; Vector 29: SDIO
    DCD     INT_Interrupt_Shell         ; Vector 30: DDI
...
INT_FIQ_Vectors
    ...
    DCD     INT_FIQ_Shell               ; Vector 6:  External Ethernet DMA
    DCD     INT_FIQ_Shell               ; Vector 7:  LZHS
    ...
    DCD     INT_FIQ_Shell               ; Vector 11: Smart Card
    ...
    DCD     INT_FIQ_Shell               ; Vector 28: USB1
    DCD     INT_FIQ_Shell               ; Vector 29: SDIO
    DCD     INT_FIQ_Shell               ; Vector 30: DDI
...
SaveCPUAddr         EQU     0x2B000040
ABT_STACK_PTR       EQU     0x2B001000
...
_BimInit
    ...
    ; Set DRAM_B base address and offset (before remapping)
    LDR     r0, =REG_RW_DBBA
    LDR     r1, =INIT_DRAM_B_BASE
    STR     r1, [r0, #0]
    LDR     r0, =REG_RW_DBOA
    LDR     r1, =DRAM_B_OFFSET
    STR     r1, [r0, #0]

    ; Set PBI_B base address (before remapping)
    LDR     r0, =REG_RW_PBIBBA
    LDR     r1, =INIT_PBI_B_BASE
    STR     r1, [r0, #0]

    ; Set PBI Configuration register
    LDR     r0, =REG_RW_PBICFG
    LDR     r1, =PBICFG_DEFAULT
    STR     r1, [r0, #0]

    ; Set Address Enable register
    LDR     r0, =REG_RW_ADDREN
    LDR     r1, =BIT_ADDREN_ALL
    STR     r1, [r0, #0]
    ...
    ; Set DTCM first.
;    LDR     r0, =0x60000005             ; enable DTCM
;    MCR     p15, 0, r0, c9, c1, 0       ; Write back control register
...
;    BCC     DTCMZeroLoop
    ...
    ; Set Stack
    LDR     r2, =0x2B000000         ; setup DTCM at 0x60000000
    ...
    LDR     sp, =0x2B001000             ; Setup DTCM stack
