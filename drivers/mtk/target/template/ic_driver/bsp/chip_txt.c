...
UINT32 CHIP_GetStack()
{
...
#ifdef CC_ROM_BOOT
    return 0x2B001800;  // LZHS buffer, use by NOR boot.
#else /* CC_ROM_BOOT */
    return 0x00001800;  // DMX SRAM, use by NAND boot.
#endif /* CC_ROM_BOOT */
#else
    return 0x20018000;  // DMX SRAM, use by NAND boot.
#endif
#else /* CC_NAND_BOOT */
    if (!(BIM_READ32(REG_RW_REMAP)))
    {
        ...
        return 0x2B001800;  // LZHS buffer, use by NOR boot.
#else /* CC_ROM_BOOT */
        return 0x2B000000;  // LZHS buffer, use by NOR boot.
#endif /* CC_ROM_BOOT */
    }
    else
    {
    ...
    return 0x00cf0000;    // DRAM ready, loader use 12.75MB as stack.
#else /* CC_5391_LOADER */
    return 0x2B000000;  // TV image, use LZHS buffer as stack, but TV image won't call this function. ha!
