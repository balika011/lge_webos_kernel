...
#define TOTAL_PINMUX_BITS       128
#define TOTAL_GPIO_NUM          106
#define TOTAL_GPIO_IDX          ((TOTAL_GPIO_NUM + 31) >> 5)
#define GPIO_INDEX_MASK         ((1 << 5) - 1)
#define GPIO_TO_INDEX(gpio)     (((UINT32)(gpio)) >> 5)

#define GPIO_EDGE_INTR_NUM      14
...
typedef enum {
    GPIO_TYPE_NONE = 0,
    GPIO_TYPE_INTR_FALL,        /* Only GPIO 0 ~ 23 */
    GPIO_TYPE_INTR_RISE,        /* Only GPIO 0 ~ 23 */
    GPIO_TYPE_INTR_BOTH,        /* Only GPIO 0 ~ 23 */
    GPIO_TYPE_INTR_LEVEL,       /* Polarity only for gpio 0 ~ 158 */
...
EXTERN INT32 GPIO_Enable(INT32 i4GpioNum, const INT32 *pfgSet);
EXTERN INT32 GPIO_Input(INT32 i4GpioNum);
EXTERN INT32 GPIO_Intrq(INT32 i4GpioNum, const INT32 *pfgSet);
