...
#define REG_VOPLL_CFG0          0x0140      // VPLL Configuration 0
    ...
    #define VPLL_PD             (1 << 21)
    #define VPLL_LVDS_CLK_DIV2  (1 << 18)
...
#define REG_SYSPLL_CFG0         (0x0160)
    #define RG_SYSPLL_432MHZ_EN (1U << 24)  // On is set 432MHZ.
...
#define REG_CPU_CKCFG           (0x0208)
    #define BUS_CK_DIV_MASK     (7U << 8)
    #define BUS_CK_DIV_FAST     (1U << 8)
    #define BUS_CK_DIV_SLOW     (0U << 8)
    #define CPU_CK_SEL_MASK     (0xfU << 0)
    #define CPU_CK_200MHZ       (6U << 0)
