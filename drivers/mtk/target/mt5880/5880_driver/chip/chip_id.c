...
INLINE_CHIP_FUNC(IS_SupportIPTV_DLNA, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_IPTV_DLNA_BIT) == BOND_IPTV_DLNA_BIT))
...
INLINE_CHIP_FUNC(IS_SupportCPUSpeed, ((GET_EFUSE_CHIPID() & BOND_CPUSPEED_BIT) == BOND_CPUSPEED_BIT))
INLINE_CHIP_FUNC(IS_SupportGPUSpeed, ((GET_EFUSE_CHIPID() & BOND_GPUSPEED_BIT) == BOND_GPUSPEED_BIT))//for python
...
INLINE_CHIP_FUNC(IS_SupportDualGPU, 1)
INLINE_CHIP_FUNC(IS_SupportJVM, 0)


#ifdef CC_NETWORK_BOND_TEST
#ifdef CC_NETWORK_BOND_ENABLE
INLINE_CHIP_FUNC(IS_SupportPlayRDY, 1)
INLINE_CHIP_FUNC(IS_SupportIPTV, 1)
#else
INLINE_CHIP_FUNC(IS_SupportPlayRDY, 0)
INLINE_CHIP_FUNC(IS_SupportIPTV, 0)
#endif
#endif
