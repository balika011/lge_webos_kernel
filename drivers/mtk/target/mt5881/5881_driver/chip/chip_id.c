...
INLINE_CHIP_FUNC(IS_Support2GMCM, ((GET_EFUSE_CHIPID() & BOND_2GMCM_BIT) == BOND_2GMCM_BIT))
INLINE_CHIP_FUNC(IS_SupportWXGAOnly, ((GET_EFUSE_CHIPID() & BOND_WXGAONLY_BIT) == BOND_WXGAONLY_BIT))
INLINE_CHIP_FUNC(IS_SupportTsIn, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_TSIN_BIT) == BOND_TSIN_BIT))
INLINE_CHIP_FUNC(IS_SupportIPTV, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_IPTV_BIT) == BOND_IPTV_BIT))
INLINE_CHIP_FUNC(IS_Support3D, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_3D_BIT) == BOND_3D_BIT))
//CIPlus/MHEG5 are just for EU, depend on DVB efuse bit
INLINE_CHIP_FUNC(IS_SupportCIPlus, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_DVB_BIT) == BOND_DVB_BIT))
INLINE_CHIP_FUNC(IS_MHEG5Support, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_DVB_BIT) == BOND_DVB_BIT))
...
//CHINATV depends on DTMB efuse bit
INLINE_CHIP_FUNC(IS_SupportCHINATV, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_DMBT_BIT) == BOND_DMBT_BIT))
...
INLINE_CHIP_FUNC(IS_SupportNETWORK, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_NETWORK_BIT) == BOND_NETWORK_BIT))
...
//Divx/DivXHD check same efuse bit
INLINE_CHIP_FUNC(IS_SupportDivX, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_DIVXHD_BIT) == BOND_DIVXHD_BIT))
INLINE_CHIP_FUNC(IS_SupportDivXHD, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_DIVXHD_BIT) == BOND_DIVXHD_BIT))
INLINE_CHIP_FUNC(IS_SupportVP8, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_VP8_BIT) == BOND_VP8_BIT))
INLINE_CHIP_FUNC(IS_SupportBC12, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_BC12_BIT) == BOND_BC12_BIT))
INLINE_CHIP_FUNC(IS_SupportMHL, _IS_RDES() || ((GET_EFUSE_CHIPID() & BOND_MHL_BIT) == BOND_MHL_BIT))
...
INLINE_CHIP_FUNC(IS_SupportQJY, 0)
INLINE_CHIP_FUNC(IS_SupportAndroid, 0)
INLINE_CHIP_FUNC(IS_SupportDimming, 0)
INLINE_CHIP_FUNC(IS_Support120HZ, 0)
INLINE_CHIP_FUNC(IS_SupportH264EN, 0)
INLINE_CHIP_FUNC(IS_SupportOPERA, 0)
INLINE_CHIP_FUNC(IS_SupportDualGPU, 0)
INLINE_CHIP_FUNC(IS_SupportCPUSpeed, 0)	//cpu low speed
INLINE_CHIP_FUNC(IS_Support3DGPU, 0)
INLINE_CHIP_FUNC(IS_SupportCINEMA, 0)
INLINE_CHIP_FUNC(IS_SupportPlayRDY, 0)
INLINE_CHIP_FUNC(IS_SupportMSS, 0)

INLINE_CHIP_FUNC(IS_SupportJVM, 0)

	
//EAC3/AC3/DDCO/MS10, DSP code SW config, depend on dolby efuse bit
