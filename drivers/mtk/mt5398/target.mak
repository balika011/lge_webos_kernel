...
ifndef PRJ_ROOT
	...
	export PRJ_ROOT =$(DRV_SRC_ROOT)drivers/mtk/mt5398
endif
...
ifeq "$(findstring 5398_MT5112EE,$(BRDCST_IF))" "5398_MT5112EE"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
DEFINES += -DCC_FEDTD
endif
ifeq "$(findstring 5398_MT5135,$(BRDCST_IF))" "5398_MT5135"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
DEFINES += -DCC_FEDVBT
endif
ifeq "$(findstring 5398DUAL,$(BRDCST_IF))" "5398DUAL"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
endif
ifeq "$(findstring 5398DVBTC,$(BRDCST_IF))" "5398DVBTC"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
...
DEFINES += -D_CPU_LITTLE_ENDIAN_ -DCC_MT5398 -DCC_DRIVER_PROGRAM
