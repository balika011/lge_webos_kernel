...
ifndef PRJ_ROOT
	...
	export PRJ_ROOT =$(DRV_SRC_ROOT)drivers/mtk/mt5880
endif
...
DMX_ROOT =  $(DRV_ROOT)/$(DRIVER_DIR)/dmx9880
DMX_INC = -I$(DMX_ROOT) -I$(DMX_ROOT)/include -I$(DMX_ROOT)/iram/gcpu -I$(DMX_ROOT)/cypher/aes -I$(DMX_ROOT)/drm/mtk_skb_driver/ -I$(DMX_ROOT)/drm/libtomcrypt-1.16/src/headers -I$(DMX_ROOT)/drm/libtommath-0.41
...
ifeq "$(findstring 5880_MT5112EE,$(BRDCST_IF))" "5880_MT5112EE"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
DEFINES += -DCC_FEDTD
endif
ifeq "$(findstring 5880_MT5135,$(BRDCST_IF))" "5880_MT5135"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
DEFINES += -DCC_FEDVBT
endif
ifeq "$(findstring 5880DUAL,$(BRDCST_IF))" "5880DUAL"
TUNER_INC += -I$(TUNER_ROOT)/TunerDTD
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogNA
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
TUNER_INC += -I$(TUNER_ROOT)/TunerAnalogEU
endif
ifeq "$(findstring 5880DVBTC,$(BRDCST_IF))" "5880DVBTC"
TUNER_INC += -I$(TUNER_ROOT)/TunerDVBT
...
NPTV_ROOT = $(DRV_ROOT)/$(DRIVER_DIR)/nptv8098
...
VDP_ROOT = $(DRV_ROOT)/$(DRIVER_DIR)/vdp8098
...
DEFINES += -D_CPU_LITTLE_ENDIAN_ -DCC_MT5880 -DCC_DRIVER_PROGRAM
